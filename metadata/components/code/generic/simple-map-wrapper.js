/**
 * SimpleMap — Thin React wrapper around the MapCore engine.
 *
 * This file contains ONLY the React component UI and lifecycle logic.
...
function SimpleMap({
    ...
    React.useEffect(function () {
        if (engineRef.current) {
            ...
            // Engine not ready yet — try to initialize, then render
            initializeEngine();
        }
    }, [data, renderMode]);
