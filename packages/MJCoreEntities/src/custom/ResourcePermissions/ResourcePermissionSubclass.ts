import { BaseEntity, CompositeKey, EntitySaveOptions, IMetadataProvider, LogError, Metadata } from '@memberjunction/global';
...
export class ResourcePermissionEntityExtended extends ResourcePermissionEntity {
  ...
  override async Save(options?: EntitySaveOptions): Promise<boolean> {
    ...
    if (p.ProviderType === 'Database') {
      ...
      const engine = <ResourcePermissionEngine>(
        ResourcePermissionEngine.GetProviderInstance<ResourcePermissionEngine>(p, ResourcePermissionEngine)
      );
