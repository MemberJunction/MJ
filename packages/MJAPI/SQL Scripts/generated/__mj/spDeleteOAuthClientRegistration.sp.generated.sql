...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spDeleteOAuthClientRegistration]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spDeleteOAuthClientRegistration];
GO

CREATE PROCEDURE [__mj].[spDeleteOAuthClientRegistration]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
