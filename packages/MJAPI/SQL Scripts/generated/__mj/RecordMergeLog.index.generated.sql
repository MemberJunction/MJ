...
IF NOT EXISTS (
    ...
    AND object_id = OBJECT_ID('[__mj].[RecordMergeLog]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_RecordMergeLog_EntityID ON [__mj].[RecordMergeLog] ([EntityID]);
...
CREATE INDEX IDX_AUTO_MJ_FKEY_RecordMergeLog_InitiatedByUserID ON [__mj].[RecordMergeLog] ([InitiatedByUserID]);
...
CREATE INDEX IDX_AUTO_MJ_FKEY_RecordMergeLog_ApprovedByUserID ON [__mj].[RecordMergeLog] ([ApprovedByUserID]);