...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spDeleteKnowledgeHubSavedSearch]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spDeleteKnowledgeHubSavedSearch];
GO

CREATE PROCEDURE [__mj].[spDeleteKnowledgeHubSavedSearch]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
