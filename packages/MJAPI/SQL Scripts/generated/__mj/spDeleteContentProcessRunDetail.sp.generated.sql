...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spDeleteContentProcessRunDetail]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spDeleteContentProcessRunDetail];
GO

CREATE PROCEDURE [__mj].[spDeleteContentProcessRunDetail]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
