...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spCreateAIPromptRunMedia]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spCreateAIPromptRunMedia];
GO

CREATE PROCEDURE [__mj].[spCreateAIPromptRunMedia]
...
BEGIN
    ...
    SELECT * FROM [__mj].[vwAIPromptRunMedias] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [__mj].[spCreateAIPromptRunMedia] TO [cdp_Developer], [cdp_Integration]
