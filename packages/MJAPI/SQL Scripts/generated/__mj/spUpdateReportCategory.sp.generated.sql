...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spUpdateReportCategory]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spUpdateReportCategory];
GO
...
BEGIN
    ...
    IF @@ROWCOUNT = 0
        ...
        SELECT TOP 0 * FROM [__mj].[vwReportCategories] WHERE 1=0
    ELSE
...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[trgUpdateReportCategory]', 'TR') IS NOT NULL
