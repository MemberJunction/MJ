...
IF NOT EXISTS (
    ...
    AND object_id = OBJECT_ID('[__mj].[ActionExecutionLog]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_ActionExecutionLog_ActionID ON [__mj].[ActionExecutionLog] ([ActionID]);
...
CREATE INDEX IDX_AUTO_MJ_FKEY_ActionExecutionLog_UserID ON [__mj].[ActionExecutionLog] ([UserID]);