...
IF NOT EXISTS (
    ...
    AND object_id = OBJECT_ID('[__mj].[AIAgentType]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentType_SystemPromptID ON [__mj].[AIAgentType] ([SystemPromptID]);
...
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentType_DefaultStorageAccountID ON [__mj].[AIAgentType] ([DefaultStorageAccountID]);