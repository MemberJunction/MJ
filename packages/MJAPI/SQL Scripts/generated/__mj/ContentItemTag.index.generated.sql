...
IF NOT EXISTS (
    ...
    AND object_id = OBJECT_ID('[__mj].[ContentItemTag]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_ContentItemTag_ItemID ON [__mj].[ContentItemTag] ([ItemID]);
...
CREATE INDEX IDX_AUTO_MJ_FKEY_ContentItemTag_TagID ON [__mj].[ContentItemTag] ([TagID]);