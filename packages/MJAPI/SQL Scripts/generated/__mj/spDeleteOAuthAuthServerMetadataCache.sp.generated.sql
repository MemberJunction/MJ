...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spDeleteOAuthAuthServerMetadataCache]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spDeleteOAuthAuthServerMetadataCache];
GO

CREATE PROCEDURE [__mj].[spDeleteOAuthAuthServerMetadataCache]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
