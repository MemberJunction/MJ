...
IF NOT EXISTS (
    ...
    AND object_id = OBJECT_ID('[__mj].[DuplicateRunDetail]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_DuplicateRunDetail_DuplicateRunID ON [__mj].[DuplicateRunDetail] ([DuplicateRunID]);