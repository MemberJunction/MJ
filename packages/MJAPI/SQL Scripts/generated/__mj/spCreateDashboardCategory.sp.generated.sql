...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spCreateDashboardCategory]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spCreateDashboardCategory];
GO
...
END
GO
GRANT EXECUTE ON [__mj].[spCreateDashboardCategory] TO [cdp_Developer], [cdp_Integration], [cdp_UI]
