...
------------------------------------------------------------
IF OBJECT_ID('[__mj].[spDeleteInstanceConfiguration]', 'P') IS NOT NULL
    DROP PROCEDURE [__mj].[spDeleteInstanceConfiguration];
GO

CREATE PROCEDURE [__mj].[spDeleteInstanceConfiguration]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
