...
import { ActivityEntity, CompanyEntity, CompanyTagEntity, ContactTagEntity, ContactEntity, DealProductEntity, DealTagEntity, DealEntity, PipelineStageEntity, PipelineEntity, ProductEntity, TagEntity } from 'mj_generatedentities';
...
export class samplecrmCompany_ {
    ...
    Deals_CompanyIDArray: samplecrmDeal_[]; // Link to Deals
    
    @Field(() => [samplecrmContact_])
    Contacts_CompanyIDArray: samplecrmContact_[]; // Link to Contacts
    
    @Field(() => [samplecrmCompanyTag_])
    CompanyTags_CompanyIDArray: samplecrmCompanyTag_[]; // Link to CompanyTags
    
    @Field(() => [samplecrmActivity_])
    Activities_CompanyIDArray: samplecrmActivity_[]; // Link to Activities
...
export class samplecrmCompanyResolver extends ResolverBase {
    ...
    async Deals_CompanyIDArray(@Root() samplecrmcompany_: samplecrmCompany_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
    ...
    async Contacts_CompanyIDArray(@Root() samplecrmcompany_: samplecrmCompany_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
    ...
    async CompanyTags_CompanyIDArray(@Root() samplecrmcompany_: samplecrmCompany_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
    ...
    async Activities_CompanyIDArray(@Root() samplecrmcompany_: samplecrmCompany_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Activities', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
...
export class samplecrmContact_ {
    ...
    @Field(() => [samplecrmContactTag_])
    ContactTags_ContactIDArray: samplecrmContactTag_[]; // Link to ContactTags
    
    @Field(() => [samplecrmContact_])
    Contacts_ReportsToContactIDArray: samplecrmContact_[]; // Link to Contacts
    
    @Field(() => [samplecrmDeal_])
    Deals_ContactIDArray: samplecrmDeal_[]; // Link to Deals
    
    @Field(() => [samplecrmActivity_])
    Activities_ContactIDArray: samplecrmActivity_[]; // Link to Activities
...
export class samplecrmContactResolver extends ResolverBase {
    ...
    async ContactTags_ContactIDArray(@Root() samplecrmcontact_: samplecrmContact_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Contact Tags', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
    ...
    @FieldResolver(() => [samplecrmContact_])
    async Contacts_ReportsToContactIDArray(@Root() samplecrmcontact_: samplecrmContact_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Contacts', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
    ...
    @FieldResolver(() => [samplecrmDeal_])
    async Deals_ContactIDArray(@Root() samplecrmcontact_: samplecrmContact_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Deals', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
    ...
    @FieldResolver(() => [samplecrmActivity_])
    async Activities_ContactIDArray(@Root() samplecrmcontact_: samplecrmContact_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Activities', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
...
export class samplecrmDeal_ {
    ...
    @Field(() => [samplecrmActivity_])
    Activities_DealIDArray: samplecrmActivity_[]; // Link to Activities
    
    @Field(() => [samplecrmDealTag_])
    DealTags_DealIDArray: samplecrmDealTag_[]; // Link to DealTags
    
    @Field(() => [samplecrmDealProduct_])
    DealProducts_DealIDArray: samplecrmDealProduct_[]; // Link to DealProducts
...
export class samplecrmDealResolver extends ResolverBase {
    ...
    @FieldResolver(() => [samplecrmActivity_])
    async Activities_DealIDArray(@Root() samplecrmdeal_: samplecrmDeal_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Activities', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
    ...
    async DealTags_DealIDArray(@Root() samplecrmdeal_: samplecrmDeal_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Deal Tags', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
    ...
    async DealProducts_DealIDArray(@Root() samplecrmdeal_: samplecrmDeal_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Deal Products', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
...
export class samplecrmPipeline_ {
    ...
    @Field(() => [samplecrmPipelineStage_])
    PipelineStages_PipelineIDArray: samplecrmPipelineStage_[]; // Link to PipelineStages
...
export class samplecrmPipelineResolver extends ResolverBase {
    ...
    async PipelineStages_PipelineIDArray(@Root() samplecrmpipeline_: samplecrmPipeline_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Pipeline Stages', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
...
export class samplecrmProduct_ {
    ...
    @Field(() => [samplecrmDealProduct_])
    DealProducts_ProductIDArray: samplecrmDealProduct_[]; // Link to DealProducts
...
export class samplecrmProductResolver extends ResolverBase {
    ...
    @FieldResolver(() => [samplecrmDealProduct_])
    async DealProducts_ProductIDArray(@Root() samplecrmproduct_: samplecrmProduct_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Deal Products', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
...
export class samplecrmTag_ {
    ...
    @Field(() => [samplecrmCompanyTag_])
    CompanyTags_TagIDArray: samplecrmCompanyTag_[]; // Link to CompanyTags
    
    @Field(() => [samplecrmContactTag_])
    ContactTags_TagIDArray: samplecrmContactTag_[]; // Link to ContactTags
    
    @Field(() => [samplecrmDealTag_])
    DealTags_TagIDArray: samplecrmDealTag_[]; // Link to DealTags
...
export class samplecrmTagResolver extends ResolverBase {
    ...
    @FieldResolver(() => [samplecrmCompanyTag_])
    async CompanyTags_TagIDArray(@Root() samplecrmtag_: samplecrmTag_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Company Tags', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
    ...
    @FieldResolver(() => [samplecrmContactTag_])
    async ContactTags_TagIDArray(@Root() samplecrmtag_: samplecrmTag_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Contact Tags', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
    ...
    @FieldResolver(() => [samplecrmDealTag_])
    async DealTags_TagIDArray(@Root() samplecrmtag_: samplecrmTag_, @Ctx() { dataSources, userPayload, providers }: AppContext, @PubSub() pubSub: PubSubEngine) {
        this.CheckUserReadPermissions('Deal Tags', userPayload);
        const provider = GetReadOnlyProvider(providers, { allowFallbackToReadWrite: true });
        const connPool = GetReadOnlyDataSource(dataSources, { allowFallbackToReadWrite: true });
