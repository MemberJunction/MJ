/* SQL generated to create new entity MJ: RSU Audit Logs */
      ...
      VALUES (
         'd6bca9dc-f23b-4aa2-b7da-90cc4a45f0d1',
         'MJ: RSU Audit Logs',
         'RSU Audit Logs',
         NULL,
         NULL,
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', 'd6bca9dc-f23b-4aa2-b7da-90cc4a45f0d1', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: RSU Audit Logs for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('d6bca9dc-f23b-4aa2-b7da-90cc4a45f0d1', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: RSU Audit Logs for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('d6bca9dc-f23b-4aa2-b7da-90cc4a45f0d1', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: RSU Audit Logs for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('d6bca9dc-f23b-4aa2-b7da-90cc4a45f0d1', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '12011e41-8c33-4539-9fd1-d4e87a095706' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'ID')) BEGIN
         ...
         VALUES
         (
            '12011e41-8c33-4539-9fd1-d4e87a095706',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100001,
            'ID',
            'ID',
            NULL,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2f9fe522-47b1-4738-afa8-d002dcc83743' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '2f9fe522-47b1-4738-afa8-d002dcc83743',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100002,
            'Description',
            'Description',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2382aaa1-51f9-4af9-ac25-5211048f7bf8' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'AffectedTables')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '2382aaa1-51f9-4af9-ac25-5211048f7bf8',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100003,
            'AffectedTables',
            'Affected Tables',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '988221b9-aa7d-4921-b24c-3c3bc5ee08ef' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'Success')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '988221b9-aa7d-4921-b24c-3c3bc5ee08ef',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100004,
            'Success',
            'Success',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd3782308-3fa1-4b3b-a8f4-ceb085958a05' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'APIRestarted')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'd3782308-3fa1-4b3b-a8f4-ceb085958a05',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100005,
            'APIRestarted',
            'API Restarted',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '707021be-8229-4623-bfa3-da27b1e7e95c' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'GitCommitSuccess')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '707021be-8229-4623-bfa3-da27b1e7e95c',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100006,
            'GitCommitSuccess',
            'Git Commit Success',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a8e4a74c-7894-4f93-94d9-890e65a1f4da' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'BranchName')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a8e4a74c-7894-4f93-94d9-890e65a1f4da',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100007,
            'BranchName',
            'Branch Name',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a5003525-0274-455a-b2fb-10e1fd3572d6' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'MigrationFilePath')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a5003525-0274-455a-b2fb-10e1fd3572d6',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100008,
            'MigrationFilePath',
            'Migration File Path',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7524a981-ae7c-423c-9a4f-7d5988addcfe' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'ErrorMessage')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7524a981-ae7c-423c-9a4f-7d5988addcfe',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100009,
            'ErrorMessage',
            'Error Message',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1e391fae-7398-40ca-9a9d-294da6c6cf8d' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'ErrorStep')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '1e391fae-7398-40ca-9a9d-294da6c6cf8d',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100010,
            'ErrorStep',
            'Error Step',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '0f312d3f-a071-43d6-97c7-6f38d04d4d86' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'StepsJSON')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '0f312d3f-a071-43d6-97c7-6f38d04d4d86',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100011,
            'StepsJSON',
            'Steps JSON',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '035a7c6a-64ec-496c-9a50-225118612508' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'TotalDurationMs')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '035a7c6a-64ec-496c-9a50-225118612508',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100012,
            'TotalDurationMs',
            'Total Duration Ms',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '589ca99d-7e22-4d90-9c3d-cec3c6cc2da1' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = 'RunAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '589ca99d-7e22-4d90-9c3d-cec3c6cc2da1',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100013,
            'RunAt',
            'Run At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4eeff8f6-2121-4836-9971-6d5f690f953f' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '4eeff8f6-2121-4836-9971-6d5f690f953f',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100014,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e43f77ba-afe7-49ea-acef-0569a9f6e5c5' OR (EntityID = 'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e43f77ba-afe7-49ea-acef-0569a9f6e5c5',
            'D6BCA9DC-F23B-4AA2-B7DA-90CC4A45F0D1', -- Entity: MJ: RSU Audit Logs
            100015,
            '__mj_UpdatedAt',
            'Updated At',
