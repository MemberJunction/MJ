/* SQL generated to create new entity Contacts */
      ...
      VALUES (
         '94365e45-a9d6-442d-9003-b1e04e5941de',
         'Contacts',
         NULL,
...
INSERT INTO [${flyway:defaultSchema}].[Application] (ID, Name, Description, SchemaAutoAddNewEntities, Path, AutoUpdatePath)
                       VALUES ('7a0f1f56-48f9-4da6-804d-72a3b6ef94fc', 'hubspot', 'Generated for schema', 'hubspot', 'hubspot', 1);
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationRole]
                                 ...
                                 ('7a0f1f56-48f9-4da6-804d-72a3b6ef94fc', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0);

/* Adding role Developer to application hubspot */
INSERT INTO [${flyway:defaultSchema}].[ApplicationRole]
                                 ([ApplicationID], [RoleID], [CanAccess], [CanAdmin]) VALUES
                                 ('7a0f1f56-48f9-4da6-804d-72a3b6ef94fc', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1);

/* Adding role Integration to application hubspot */
INSERT INTO [${flyway:defaultSchema}].[ApplicationRole]
                                 ([ApplicationID], [RoleID], [CanAccess], [CanAdmin]) VALUES
                                 ('7a0f1f56-48f9-4da6-804d-72a3b6ef94fc', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0);

/* SQL generated to add new entity Contacts to application ID: '7a0f1f56-48f9-4da6-804d-72a3b6ef94fc' */
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('7a0f1f56-48f9-4da6-804d-72a3b6ef94fc', '94365e45-a9d6-442d-9003-b1e04e5941de', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = '7a0f1f56-48f9-4da6-804d-72a3b6ef94fc'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Contacts for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('94365e45-a9d6-442d-9003-b1e04e5941de', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Contacts for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('94365e45-a9d6-442d-9003-b1e04e5941de', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Contacts for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('94365e45-a9d6-442d-9003-b1e04e5941de', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '172e4de3-237c-4882-9bae-ef84b18d6fea' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = 'properties')) BEGIN
         ...
         VALUES
         (
            '172e4de3-237c-4882-9bae-ef84b18d6fea',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100001,
            'properties',
            'properties',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4d5ba541-26d1-4bb2-a4bf-9f943bc33c76' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = 'archivedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '4d5ba541-26d1-4bb2-a4bf-9f943bc33c76',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100002,
            'archivedAt',
            'archived At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3fc679d4-7256-4ef5-8703-c1e2df1d121b' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = 'updatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '3fc679d4-7256-4ef5-8703-c1e2df1d121b',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100003,
            'updatedAt',
            'updated At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '692167ba-c39b-4ab9-953e-98a5525c77f4' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = 'id')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '692167ba-c39b-4ab9-953e-98a5525c77f4',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100004,
            'id',
            'id',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd47ce665-780a-446e-9e10-9c14280ecf3f' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = 'url')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'd47ce665-780a-446e-9e10-9c14280ecf3f',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100005,
            'url',
            'url',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '9f2e7686-7867-4d59-ac26-70d952c92082' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = 'createdAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '9f2e7686-7867-4d59-ac26-70d952c92082',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100006,
            'createdAt',
            'created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '00b5083a-caed-4d00-a74d-b1bc556f459d' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = 'archived')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '00b5083a-caed-4d00-a74d-b1bc556f459d',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100007,
            'archived',
            'archived',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '05aac24d-23cc-4dfa-92ed-6a8759d34c23' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_SyncStatus')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '05aac24d-23cc-4dfa-92ed-6a8759d34c23',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100008,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1f0a33d5-10aa-486c-8b72-a0f9f127761d' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '__mj_integration_LastSyncedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '1f0a33d5-10aa-486c-8b72-a0f9f127761d',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100009,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b8841790-d3ba-4b81-af93-24df4882d4f7' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_LastSyncedSnapshot')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'b8841790-d3ba-4b81-af93-24df4882d4f7',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100010,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ed90bb06-5532-4ce2-8662-aacecb877e5b' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_SyncMessage')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ed90bb06-5532-4ce2-8662-aacecb877e5b',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100011,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'aecc9002-fc3d-4330-8a29-146a811496ff' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_ContentHash')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'aecc9002-fc3d-4330-8a29-146a811496ff',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100012,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a7208fcc-79c0-44f5-885d-90137fdacfed' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_CustomOverflow')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a7208fcc-79c0-44f5-885d-90137fdacfed',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100013,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'edb3f7a8-d227-4382-b18d-7f2717db88bf' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_ExternalVersion')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'edb3f7a8-d227-4382-b18d-7f2717db88bf',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100014,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6ea7c88e-ea90-43b0-9a80-8544152574ce' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_LastSeenModifiedValue')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '6ea7c88e-ea90-43b0-9a80-8544152574ce',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100015,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a69b2e21-4415-4d4c-a309-fa72c096eb97' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '__mj_integration_LastReconciledAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a69b2e21-4415-4d4c-a309-fa72c096eb97',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100016,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '416846f4-e283-4b94-969d-dcebfb9b7fbb' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_LastWriterDirection')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '416846f4-e283-4b94-969d-dcebfb9b7fbb',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100017,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b67b4d31-b453-48bd-824c-fe0d500a2265' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '${flyway:defaultSchema}_integration_IsTombstoned')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'b67b4d31-b453-48bd-824c-fe0d500a2265',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100018,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1c22e154-bb61-4dd8-bc4f-3bc2ada2e7e4' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '__mj_integration_DeletedDetectedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '1c22e154-bb61-4dd8-bc4f-3bc2ada2e7e4',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100019,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4b1eff98-ffe3-4801-9329-16bca2a8f8e2' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '4b1eff98-ffe3-4801-9329-16bca2a8f8e2',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100020,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '9d3fef91-3dfe-4297-b330-8f06b06b39f0' OR (EntityID = '94365E45-A9D6-442D-9003-B1E04E5941DE' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '9d3fef91-3dfe-4297-b330-8f06b06b39f0',
            '94365E45-A9D6-442D-9003-B1E04E5941DE', -- Entity: Contacts
            100021,
            '__mj_UpdatedAt',
            'Updated At',
