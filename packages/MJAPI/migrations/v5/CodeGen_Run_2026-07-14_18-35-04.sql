/* SQL generated to create new entity MJ: RSU Audit Logs */
      ...
      VALUES (
         '2153f2e2-af09-42e4-bacc-9ba5bab8d7fe',
         'MJ: RSU Audit Logs',
         'RSU Audit Logs',
         NULL,
         NULL,
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '2153f2e2-af09-42e4-bacc-9ba5bab8d7fe', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: RSU Audit Logs for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('2153f2e2-af09-42e4-bacc-9ba5bab8d7fe', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: RSU Audit Logs for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('2153f2e2-af09-42e4-bacc-9ba5bab8d7fe', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: RSU Audit Logs for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('2153f2e2-af09-42e4-bacc-9ba5bab8d7fe', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '210f7e0a-b155-44c8-ba6b-b931c8f09065' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'ID')) BEGIN
         ...
         VALUES
         (
            '210f7e0a-b155-44c8-ba6b-b931c8f09065',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100001,
            'ID',
            'ID',
            NULL,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '88458135-0067-4942-b77a-55771400ce92' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '88458135-0067-4942-b77a-55771400ce92',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100002,
            'Description',
            'Description',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ae460841-8000-493e-8ad3-85b6fbdd9867' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'AffectedTables')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ae460841-8000-493e-8ad3-85b6fbdd9867',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100003,
            'AffectedTables',
            'Affected Tables',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4855dd48-5672-4508-a7ff-c17cdcc03b2a' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'Success')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '4855dd48-5672-4508-a7ff-c17cdcc03b2a',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100004,
            'Success',
            'Success',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '72eb38f6-3565-49e8-a8d6-28fe525e6232' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'APIRestarted')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '72eb38f6-3565-49e8-a8d6-28fe525e6232',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100005,
            'APIRestarted',
            'API Restarted',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '69102649-c705-4af0-97ca-5c2bcae94bd7' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'GitCommitSuccess')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '69102649-c705-4af0-97ca-5c2bcae94bd7',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100006,
            'GitCommitSuccess',
            'Git Commit Success',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1df6ffec-286d-4ed7-b7bd-1ec5665045c7' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'BranchName')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '1df6ffec-286d-4ed7-b7bd-1ec5665045c7',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100007,
            'BranchName',
            'Branch Name',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ddd59c12-5eb8-40c2-9b60-6d5dca50c43f' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'MigrationFilePath')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ddd59c12-5eb8-40c2-9b60-6d5dca50c43f',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100008,
            'MigrationFilePath',
            'Migration File Path',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ebaab660-09ea-4a4a-90e9-dcfad9aa4590' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'ErrorMessage')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ebaab660-09ea-4a4a-90e9-dcfad9aa4590',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100009,
            'ErrorMessage',
            'Error Message',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '0d8ce176-044c-4276-aa3b-ee9e3f239be6' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'ErrorStep')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '0d8ce176-044c-4276-aa3b-ee9e3f239be6',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100010,
            'ErrorStep',
            'Error Step',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2f3bf434-03b4-47eb-9c02-003ad09672cb' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'StepsJSON')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '2f3bf434-03b4-47eb-9c02-003ad09672cb',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100011,
            'StepsJSON',
            'Steps JSON',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '292d4d71-6493-4dbf-9b40-c9a76e86d5cf' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'TotalDurationMs')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '292d4d71-6493-4dbf-9b40-c9a76e86d5cf',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100012,
            'TotalDurationMs',
            'Total Duration Ms',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '92a0cdc3-e0f1-4656-85b1-8bb307e05bcc' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = 'RunAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '92a0cdc3-e0f1-4656-85b1-8bb307e05bcc',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100013,
            'RunAt',
            'Run At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e58c028a-ac5b-42f7-9bc6-75fa8ebe6f2c' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e58c028a-ac5b-42f7-9bc6-75fa8ebe6f2c',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100014,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '79b507b9-02ec-4bad-b299-944f1a2373ad' OR (EntityID = '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '79b507b9-02ec-4bad-b299-944f1a2373ad',
            '2153F2E2-AF09-42E4-BACC-9BA5BAB8D7FE', -- Entity: MJ: RSU Audit Logs
            100015,
            '__mj_UpdatedAt',
            'Updated At',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '4FC3AE81-29EB-4C7F-BDC3-BD0B1ECD157A' AND [Name] = 'email_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '7FBACAEC-E33F-49AE-9348-1C71E3C36AF0' AND [Name] = 'encoded_account_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '0C4AC0BA-105E-40AD-BFE5-66C0241FF671' AND [Name] = 'privilege_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '4E7EA629-3A71-4EA7-9C63-7A31E0666A29' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = 'A38D6960-2CCE-4E6A-BC00-A4527FC5E1F1' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '8196B7E7-356C-4C93-8E85-25EE1692C6A7' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '02661F07-A41F-44F2-826B-92253E1F07BC' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '4533B38B-405E-437A-B9CE-05B591B48DD1' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '764ECEDB-6E9F-45BC-BE8D-28DB3840AE63' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '20B7C9BE-F2C0-49BF-93C3-2A4977EDE434' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '94854DBB-4866-4530-B3BD-2D2B3DBEFC63' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '35C91982-5B3F-4972-8A92-0738A5385451' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '4470DAAB-0905-4D89-8C00-640E42E58B5D' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '5E33993D-B7F7-4B71-8D93-980BAFE930FF' AND [Name] = 'activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '816C4589-7966-422A-90D2-109E45E3AF03' AND [Name] = 'custom_field_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '7CD2EAFD-CBF4-46D6-8098-70104288B3DD' AND [Name] = 'list_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '58788B6C-4956-4668-9D49-8A6963687099' AND [Name] = 'list_id';

/* Set soft FK for constant_contact.contact_lists_xrefs.list_id → contact_lists.list_id */
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [RelatedEntityID] = '7CD2EAFD-CBF4-46D6-8098-70104288B3DD',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '8635A5E6-A8D1-44B4-AFA7-C496DE5543A6' AND [Name] = 'campaign_activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [RelatedEntityID] = '48EE848F-4A93-4D52-8A37-AFCCDB7D6472',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '4FFCAC53-B5A9-440D-A08B-C56DF8580E96' AND [Name] = 'contact_id';

/* Set soft FK for constant_contact.contact_reports_open_and_click_rates.contact_id → contacts.contact_id */
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [RelatedEntityID] = 'D130D78E-C5F0-4EA4-B0FF-7A60AEA004F0',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '24C8A88D-FBCD-4A45-A582-669C3B2D4CC2' AND [Name] = 'tag_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = 'D130D78E-C5F0-4EA4-B0FF-7A60AEA004F0' AND [Name] = 'contact_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '926C83C1-E02F-4A8F-A2A5-F74384F2B56A' AND [Name] = 'contact_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '7C6FD175-F6A4-418C-A81D-B75A01C2634C' AND [Name] = 'contact_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '48EE848F-4A93-4D52-8A37-AFCCDB7D6472' AND [Name] = 'campaign_activity_id';

/* Set soft FK for constant_contact.email_campaign_activities.campaign_id → emails.campaign_id */
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [RelatedEntityID] = '7F555C22-D515-4DF5-B0F4-8A5F5D872CB0',
                                    [RelatedEntityFieldName] = 'campaign_id',
                                    [IsSoftForeignKey] = 1
                                WHERE [EntityID] = '48EE848F-4A93-4D52-8A37-AFCCDB7D6472' AND [Name] = 'campaign_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '5B563400-80B3-49A1-964F-F8FBA2FDB37C' AND [Name] = 'resend_request_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '91966D64-9C2D-4018-98C1-3BAA4B5F088B' AND [Name] = 'campaign_activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '155474C9-611E-46CC-B2A4-EA075C2601BC' AND [Name] = 'send_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '8E297D9E-36D8-4D27-805C-C0775B93A2EA' AND [Name] = 'url_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    ...
                                    [RelatedEntityFieldName] = 'list_id',
                                    [IsSoftForeignKey] = 1
                                WHERE [EntityID] = '8E297D9E-36D8-4D27-805C-C0775B93A2EA' AND [Name] = 'list_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '89BCF11E-98AC-4BFA-8160-C787450F25A2' AND [Name] = 'campaign_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '7F555C22-D515-4DF5-B0F4-8A5F5D872CB0' AND [Name] = 'campaign_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '00DF4B34-F852-47C1-AA00-E333E8247BD1' AND [Name] = 'campaign_activity_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    ...
                                    [RelatedEntityFieldName] = 'campaign_id',
                                    [IsSoftForeignKey] = 1
                                WHERE [EntityID] = '00DF4B34-F852-47C1-AA00-E333E8247BD1' AND [Name] = 'campaign_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '7BFCE18E-20C7-4E93-9882-6421EA4F9398' AND [Name] = 'event_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    ...
                                    [RelatedEntityFieldName] = 'campaign_id',
                                    [IsSoftForeignKey] = 1
                                WHERE [EntityID] = '7BFCE18E-20C7-4E93-9882-6421EA4F9398' AND [Name] = 'campaign_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '9C01F297-E136-488E-BAD2-737CC0DA4236' AND [Name] = 'event_id';

/* Set soft FK for constant_contact.events_copy.event_id → events.event_id */
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [RelatedEntityID] = '7BFCE18E-20C7-4E93-9882-6421EA4F9398',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    ...
                                    [RelatedEntityFieldName] = 'campaign_id',
                                    [IsSoftForeignKey] = 1
                                WHERE [EntityID] = '9C01F297-E136-488E-BAD2-737CC0DA4236' AND [Name] = 'campaign_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '91944C90-4AD8-4F03-A1F3-9972A71588F5' AND [Name] = 'registration_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    ...
                                    [RelatedEntityFieldName] = 'contact_id',
                                    [IsSoftForeignKey] = 1
                                WHERE [EntityID] = '91944C90-4AD8-4F03-A1F3-9972A71588F5' AND [Name] = 'contact_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = 'DD8D6F62-65CD-451B-9E75-3DCDE63F828A' AND [Name] = 'segment_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '23E2CD0D-47E0-45B9-966F-29FCDAB8A657' AND [Name] = 'hashtag_group_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '981C3C1D-8392-49A5-BB05-755752F4211D' AND [Name] = 'campaign_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '2D9BE19A-9787-48F1-9AD5-59229CCE9FF1' AND [Name] = 'profile_id';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = '951F68BC-EE90-41D4-BE95-817404A32C30' AND [Name] = 'ID';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = 'F9C9ACBA-67F5-43F0-9F64-336C9324605E' AND [Name] = 'ID';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
                                SET [__mj_UpdatedAt]=GETUTCDATE(),
                                    [IsPrimaryKey] = 1,
                                    [IsSoftPrimaryKey] = 1
                                WHERE [EntityID] = 'D75651C4-D6B4-41D1-A288-3ACAA54777CD' AND [Name] = 'ID';
