 ...
 */
@RegisterClass(BaseLintRule, 'runview-runquery-valid-properties')
export class RunviewRunqueryValidPropertiesRule extends BaseLintRule {
  get Name() { return 'runview-runquery-valid-properties'; }
