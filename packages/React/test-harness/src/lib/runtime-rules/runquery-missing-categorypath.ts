 ...
 */
@RegisterClass(BaseLintRule, 'runquery-missing-categorypath')
export class RunqueryMissingCategorypathRule extends BaseLintRule {
  get Name() { return 'runquery-missing-categorypath'; }
