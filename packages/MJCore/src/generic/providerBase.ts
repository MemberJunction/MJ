...
export abstract class ProviderBase implements IMetadataProvider, IRunViewProvider, IRunQueryProvider, IRemoteOperationProvider {
    ...
    private ensureInflightViewInvalidation(): void {
        ...
        MJGlobal.Instance.GetEventListener(false).subscribe((event) => {
            ...
            if (entityName) {
                ...
                this.handleMetadataMemberEntityEvent(entityName, entityEvent);
            }
        });
    }
     ...
     * dataset result, and wires this instance's write-invalidation event subscription so writes to any
    ...
    /**
     * Write-invalidation callback: a BaseEntity save/delete (or a remote-invalidate from another
