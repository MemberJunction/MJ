...
- 00997ee: Fixed e-sign field placement: contract, 3 providers, drag-drop UI, verified.
...
- 9ddea03: fix(esignature): SignatureRequest display field renamed Title → Name so the related-entity name field generates correctly in child views/entities/GraphQL
