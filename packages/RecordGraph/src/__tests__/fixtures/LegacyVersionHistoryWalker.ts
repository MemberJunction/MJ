/**
 * Verbatim copy of VersionHistory's DependencyGraphWalker as it was before the record-graph
 * extraction (packages/VersionHistory/src/DependencyGraphWalker.ts on next @ 94e49a5f0c), with its imports
 * pointed at record-graph and the class renamed. Test-only: the characterization test runs it and
 * the extracted walker over the same data to prove the default walk did not change.
 */
...
/** The walk options VersionHistory's walker took. */
 ...
 */
export class LegacyVersionHistoryWalker {
