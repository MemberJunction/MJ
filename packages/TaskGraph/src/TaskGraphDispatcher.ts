...
import { BuildConditionContext, DecideGate, IsDataAbsence, ParseConditionOutput, TERMINAL_FOR_CONDITIONS } from './condition-gate';
    ...
    private async propagateAndRollup(provider: IMetadataProvider, graphIDs?: readonly string[]): Promise<void> {
        ...
        for (const parentID of graphs) {
            ...
            if (rollup.outcome === 'settled') {
                ...
                // workflow the server has ever seen rather than with anything live.
