...
// Side-effect import of installed Open Apps' client bootstrap (generated by `mj app
// install`; an empty stub is ensured at prebuild). Pulls each app's client package
// into the bundle so its @RegisterClass decorators run and its components render (B2).
import './generated/open-app-bootstrap.generated';
