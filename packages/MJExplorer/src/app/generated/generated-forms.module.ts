...
import { CuisineTypeFormComponent, LoadCuisineTypeFormComponent } from "./Entities/CuisineType/cuisinetype.form.component";
...
import { GroupVisitMemberFormComponent, LoadGroupVisitMemberFormComponent } from "./Entities/GroupVisitMember/groupvisitmember.form.component";
import { GroupVisitFormComponent, LoadGroupVisitFormComponent } from "./Entities/GroupVisit/groupvisit.form.component";
...
import { Member__FoodieFormComponent, LoadMember__FoodieFormComponent } from "./Entities/Member__Foodie/member__foodie.form.component";
...
import { RestaurantTagFormComponent, LoadRestaurantTagFormComponent } from "./Entities/RestaurantTag/restauranttag.form.component";
import { RestaurantVisitFormComponent, LoadRestaurantVisitFormComponent } from "./Entities/RestaurantVisit/restaurantvisit.form.component";
import { RestaurantFormComponent, LoadRestaurantFormComponent } from "./Entities/Restaurant/restaurant.form.component";
import { SegmentFormComponent, LoadSegmentFormComponent } from "./Entities/Segment/segment.form.component";
import { WishListFormComponent, LoadWishListFormComponent } from "./Entities/WishList/wishlist.form.component";
...
declarations: [
    ...
    GroupVisitMemberFormComponent,
    GroupVisitFormComponent,
...
export function LoadGeneratedForms() {
    ...
    LoadGroupVisitMemberFormComponent();
    LoadGroupVisitFormComponent();
    ...
    LoadMember__FoodieFormComponent();
    ...
    LoadRestaurantTagFormComponent();
    LoadRestaurantVisitFormComponent();
    LoadRestaurantFormComponent();
    LoadSegmentFormComponent();
    LoadWishListFormComponent();
}
