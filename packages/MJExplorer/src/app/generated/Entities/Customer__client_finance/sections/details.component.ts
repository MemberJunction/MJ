...
@RegisterClass(BaseFormSectionComponent, 'Customers__client_finance.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-customer__client_finance-form-details',
...
export class Customer__client_financeDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: Customer__client_financeEntity;
    @Input() override EditMode: boolean = false;
}

export function LoadCustomer__client_financeDetailsComponent() {
