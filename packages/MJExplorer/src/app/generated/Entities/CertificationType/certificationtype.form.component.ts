...
export class CertificationTypeFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'accreditationEligibility', sectionName: 'Accreditation & Eligibility', isExpanded: true },
            { sectionKey: 'timingCredits', sectionName: 'Timing & Credits', isExpanded: false },
            { sectionKey: 'assessmentCost', sectionName: 'Assessment & Cost', isExpanded: false },
