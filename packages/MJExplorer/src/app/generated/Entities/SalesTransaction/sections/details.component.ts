...
@RegisterClass(BaseFormSectionComponent, 'Sales Transactions.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-salestransaction-form-details',
...
export class SalesTransactionDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: SalesTransactionEntity;
    @Input() override EditMode: boolean = false;
}

export function LoadSalesTransactionDetailsComponent() {
