...
export class AssociationDemoCompetitionJudgeFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            { sectionKey: 'competitionContext', sectionName: 'Competition Context', isExpanded: true },
            { sectionKey: 'judgeProfile', sectionName: 'Judge Profile', isExpanded: true },
            { sectionKey: 'professionalBackground', sectionName: 'Professional Background', isExpanded: false },
            { sectionKey: 'assignmentDetails', sectionName: 'Assignment Details', isExpanded: false },
