...
@RegisterClass(BaseFormSectionComponent, 'Items__client_membership.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-item__client_membership-form-details',
...
export class Item__client_membershipDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: Item__client_membershipEntity;
    @Input() override EditMode: boolean = false;
}

export function LoadItem__client_membershipDetailsComponent() {
