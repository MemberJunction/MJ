...
@RegisterClass(BaseFormSectionComponent, 'Customer Address__client_finance.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-customeraddress__client_finance-form-details',
...
export class CustomerAddress__client_financeDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: CustomerAddress__client_financeEntity;
    @Input() override EditMode: boolean = false;
}

export function LoadCustomerAddress__client_financeDetailsComponent() {
