...
@RegisterClass(BaseFormSectionComponent, 'Customers__client_membership.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-customer__client_membership-form-details',
...
export class Customer__client_membershipDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: Customer__client_membershipEntity;
    @Input() override EditMode: boolean = false;
}

export function LoadCustomer__client_membershipDetailsComponent() {
