...
@RegisterClass(BaseFormSectionComponent, 'Items__client_finance.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-item__client_finance-form-details',
...
export class Item__client_financeDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: Item__client_financeEntity;
    @Input() override EditMode: boolean = false;
}

export function LoadItem__client_financeDetailsComponent() {
