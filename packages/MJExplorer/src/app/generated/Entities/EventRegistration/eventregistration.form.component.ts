...
export class EventRegistrationFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            { sectionKey: 'registrationInformation', sectionName: 'Registration Information', isExpanded: true },
            { sectionKey: 'attendanceCredits', sectionName: 'Attendance & Credits', isExpanded: true },
            { sectionKey: 'cancellationFinance', sectionName: 'Cancellation & Finance', isExpanded: false },
