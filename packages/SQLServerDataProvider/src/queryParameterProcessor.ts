import { QueryInfo, QueryParameterInfo, RunQuerySQLFilterManager } from '@memberjunction/global';
...
export class QueryParameterProcessor {
   ...
   */
  public static processQueryTemplate(query: QueryInfo, parameters: Record<string, any> | undefined): QueryProcessingResult {
    try {
