 ...
 *
 * This action runs the same `EntitySchemaValidationService` that the agent
 * path (`EntityDesignerSchemaValidator`) uses, ensuring both paths are
...
export class ValidateEntitySchemaAction extends BaseEntityDesignerAction {
