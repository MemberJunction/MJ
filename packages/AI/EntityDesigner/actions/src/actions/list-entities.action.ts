 ...
 * @description Returns a summary list of entities created via the Entity Designer.
 *
...
import { UDT_SETTINGS, escapeSqlLiteral } from '@memberjunction/entity-designer-core';

import { BaseEntityDesignerAction } from './base-entity-designer.action.js';
...
/**
 * Lists all entities created by the current user via the Entity Designer.
 *
...
export class ListMyEntitiesAction extends BaseEntityDesignerAction {
