 ...
 * whether to modify it, or for display in the Entity Designer UI.
 */
...
import { escapeSqlLiteral } from '@memberjunction/entity-designer-core';
...
export class DescribeEntityAction extends BaseEntityDesignerAction {
