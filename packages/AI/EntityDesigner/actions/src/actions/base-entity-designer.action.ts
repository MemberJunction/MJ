/**
 * @module base-entity-designer.action
 * @description Abstract base for all Entity Designer actions.
 *
...
export abstract class BaseEntityDesignerAction extends BaseAction {
    ...
    protected handleUnexpected(error: unknown, operation: string): ActionResultSimple {
        ...
        LogError(`EntityDesigner action '${operation}' threw: ${msg}`);
        return {
            Success: false,
...
export { EntityDesignerPipelineExecutor };
