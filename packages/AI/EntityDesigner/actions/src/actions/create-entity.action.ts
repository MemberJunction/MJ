 ...
 *
 * This action does NOT run the full conversational Entity Designer flow.
...
import { EntityDesignerPipelineExecutor, UDT_SETTINGS } from '@memberjunction/entity-designer-core';
...
export class CreateEntityAction extends BaseEntityDesignerAction {
    protected async InternalRunAction(params: RunActionParams): Promise<ActionResultSimple> {
        try {
            ...
            const execResult = await EntityDesignerPipelineExecutor.CreateEntity(
                td!,
                params.ContextUser,
                options
            );
