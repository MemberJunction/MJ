...
vi.mock('@memberjunction/entity-designer-core', () => ({
    EntitySchemaValidationService: vi.fn().mockImplementation(function(this: unknown) {
        return {
...
import { AUTHORIZATIONS } from '@memberjunction/entity-designer-core';
