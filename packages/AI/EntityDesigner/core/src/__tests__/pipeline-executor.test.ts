...
import { EntityDesignerPipelineExecutor } from '../pipeline-executor.js';
...
describe('EntityDesignerPipelineExecutor', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    ...
    describe('CreateEntity — happy path', () => {
        ...
        it('returns Success=true when pipeline succeeds', async () => {
            const result = await EntityDesignerPipelineExecutor.CreateEntity(
        ...
        it('writes MJ:UDT:Owner EntitySettings with contextUser.ID', async () => {
            await EntityDesignerPipelineExecutor.CreateEntity(
                VALID_TABLE_DEFINITION, CONTEXT_USER
            );
        ...
        it('writes MJ:UDT:Source EntitySettings defaulting to EntityDesigner', async () => {
            await EntityDesignerPipelineExecutor.CreateEntity(
                VALID_TABLE_DEFINITION, CONTEXT_USER
            );
