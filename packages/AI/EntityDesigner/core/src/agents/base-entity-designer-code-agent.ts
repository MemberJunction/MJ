/**
 * @module base-entity-designer-code-agent
 *
 * Abstract base class for all **code-based** (non-LLM) Entity Designer
 ...
 *
 * ```typescript
 * \@RegisterClass(BaseAgent, 'MyEntityDesignerAgent')
 * export class MyEntityDesignerAgent extends BaseEntityDesignerCodeAgent {
...
export abstract class BaseEntityDesignerCodeAgent extends BaseAgent {
     ...
     *   `EntityDesignerResult.Success = false` before returning Failed so
