...
@RegisterClass(BaseAgent, 'EntityDesignerSchemaDesigner')
export class EntityDesignerSchemaDesigner extends BaseAgent {
    ...
    protected override async validateSuccessNextStep<P>(
        ...
        const payload = currentPayload as EntityDesignerPayload;
    ...
    private collectTableDefinitionErrors(
        tableDefinition: EntityDesignerPayload['SchemaDesign']['TableDefinition'] | undefined
    ): string[] {
        const errors: string[] = [];
