import { UserInfo, RunView, LogStatus, RunViewResult } from '@memberjunction/global';
...
export class EntityDocumentCache {
  ...
  public GetDocumentTypeByName(EntityDocumentTypeName: string): EntityDocumentTypeEntity | null {
    ...
    let documentType: EntityDocumentTypeEntity = Object.values(this._typeCache).find(
      (edt: EntityDocumentTypeEntity) => edt.Name.trim().toLowerCase() === toLower
    );
