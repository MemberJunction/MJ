/**
 * Shared native-tool-calling conformance suite applied to GroqLLM.
 *
 * Unlike groq.test.ts (which mocks @memberjunction/ai to unit-test request mapping), this runs
 ...
 *
 * Worth having beyond the general contract: Groq serves GPT-OSS-120B, the single most-deployed
...
/** Builds an OpenAI-shaped completion body — the format Groq speaks. */
