...
export class MemoryCleanupAgent extends BaseAgent {
     ...
     */
    private async queryExpiredNotes(now: string, contextUser: UserInfo): Promise<AIAgentNoteEntity[]> {
     ...
     */
    private async queryExpiredExamples(now: string, contextUser: UserInfo): Promise<AIAgentExampleEntity[]> {
        const rv = new RunView();
