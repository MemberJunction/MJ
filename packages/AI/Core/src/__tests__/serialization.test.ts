...
import { toJSONSafe } from '../generic/serialization';
...
describe('toJSONSafe', () => {
  ...
  it('stringifies BigInt usage counters (which JSON.stringify would otherwise throw on)', () => {
  ...
  it('produces an object safe for a downstream JSON.stringify (the prompt-run persistence path)', () => {
