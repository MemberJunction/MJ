...
/** @deprecated Use {@link BuildProtectedResourceMetadata}. */
export function buildProtectedResourceMetadata(
  options: ProtectedResourceMetadataOptions
): ProtectedResourceMetadata {
  return BuildProtectedResourceMetadata(options);
}
...
/** @deprecated Use {@link ExtractAuthorizationServers}. */
export function extractAuthorizationServers(
  providers: Array<{ issuer?: string }>
): string[] {
  return ExtractAuthorizationServers(providers);
}
