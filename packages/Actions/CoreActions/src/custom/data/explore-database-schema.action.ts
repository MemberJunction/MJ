...
import { Metadata, EntityInfo, EntityFieldInfo, EntityRelationshipInfo } from '@memberjunction/global';
...
export class ExploreDatabaseSchemaAction extends BaseAction {
  ...
  private groupBySchema(entities: Record<string, any>[]): Record<string, any>[] {
    ...
    return Object.values(schemaMap).sort((a, b) => a.SchemaName.localeCompare(b.SchemaName));
  }
   ...
   */
  private calculateSummary(formattedEntities: Record<string, any>[]): Record<string, any> {
