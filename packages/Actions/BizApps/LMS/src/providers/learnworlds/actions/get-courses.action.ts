...
export class GetLearnWorldsCoursesAction extends LearnWorldsBaseAction {
  ...
  private extractGetCoursesParams(params: ActionParam[]): GetCoursesParams {
    return {
      ...
      CategoryID: this.getParamValue(params, 'CategoryID') as string | undefined,
      Level: this.getParamValue(params, 'Level') as string | undefined,
      Language: this.getParamValue(params, 'Language') as string | undefined,
      OnlyFree: this.getParamValue(params, 'OnlyFree') as boolean | undefined,
      MinPrice: this.getParamValue(params, 'MinPrice') as number | undefined,
      MaxPrice: this.getParamValue(params, 'MaxPrice') as number | undefined,
      Tags: this.getParamValue(params, 'Tags') as string | undefined,
      InstructorID: this.getParamValue(params, 'InstructorID') as string | undefined,
      ...
      IncludeEnrollmentStats: this.getParamValue(params, 'IncludeEnrollmentStats') as boolean | undefined,
