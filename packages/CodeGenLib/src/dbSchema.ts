...
export function generateDBSchemaJSONOutput(entities: EntityInfo[], outputDir: string): boolean {
...
export function generateDBSchemaJSON(entities: EntityInfo[], excludeEntities: string[], schemaName: string, simpleVersion: boolean): string {
    let sOutput: string = `{
