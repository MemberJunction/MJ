...
export const DEFAULT_CODEGEN_CONFIG: Partial<ConfigInfo> = {
  ...
  advancedGeneration: {
    ...
    features: [
      ...
      {
        name: 'DefaultInViewFields',
        description: 'Use AI to determine which fields should be shown by default in views',
        enabled: false,
      },
      {
        name: 'EntityDescriptions',
        description: 'Use AI to generate descriptions for entities',
        enabled: false,
      },
      {
        name: 'EntityFieldDescriptions',
        description: 'Use AI to generate descriptions for fields',
        enabled: false,
      },
      {
        name: 'FormLayout',
        description: 'Use AI to generate better layouts for forms',
        enabled: false,
      },
      {
        name: 'FormTabs',
        description: 'Use AI to decide which relationships should have visible tabs',
        enabled: false,
      },
    ],
  },
