...
GO${permissions}
    ...
    protected generateSPCreate(entity: EntityInfo): string {
        ...
        const efString: string = this.createEntityFieldsParamString(entity.Fields, !entity.PrimaryKey.AutoIncrement);
...
GO${permissions}
    ...
    protected createEntityFieldsParamString(entityFields: EntityFieldInfo[], isUpdate: boolean, log?: boolean): string {
