 ...
 * - JSONTypeDefinition emission above entity class
 * - Typed getter/setter generation for JSONType fields (JSON.parse/stringify)
 * - JSONType annotation in JSDoc comments
...
describe('EntitySubClassGeneratorBase - JSONType', () => {
    ...
    describe('generateEntitySubClass - JSONType getter/setter', () => {
        it('should generate JSON.parse getter for field with JSONType', async () => {
            const fields = [
                makePrimaryKeyField(),
                makeField({
                    Name: 'Config',
            ...
            expect(result).toContain("get Config(): IMyConfig | null");
            expect(result).toContain("JSON.parse(this.Get('Config'))");
        });

        it('should generate JSON.stringify setter for field with JSONType', async () => {
            const fields = [
                makePrimaryKeyField(),
                makeField({
                    Name: 'Config',
            ...
            expect(result).toContain("set Config(value: IMyConfig | null)");
            expect(result).toContain("JSON.stringify(value)");
        });

        it('should generate array type when JSONTypeIsArray is true', async () => {
            const fields = [
                makePrimaryKeyField(),
                makeField({
                    Name: 'Items',
            ...
            expect(result).toContain("get Items(): IItem[] | null");
            expect(result).toContain("set Items(value: IItem[] | null)");
        });

        it('should not include | null when AllowsNull is false', async () => {
            const fields = [
                makePrimaryKeyField(),
                makeField({
                    Name: 'Config',
            ...
            expect(result).toContain("get Config(): IMyConfig {");
            expect(result).not.toContain("get Config(): IMyConfig | null");
        });

        it('should include JSON Type annotation in JSDoc comment', async () => {
            const fields = [
                makePrimaryKeyField(),
                makeField({
                    Name: 'Config',
            ...
            expect(result).toContain('JSON Type: IMyConfig[]');
        });
    ...
    describe('generateEntitySubClass - JSONTypeDefinition emission', () => {
        it('should emit JSONTypeDefinition above the class', async () => {
            ...
            // The interface should appear before the class definition
            const interfaceIndex = result.indexOf('export interface IMyConfig');
        ...
        it('should deduplicate identical JSONTypeDefinitions', async () => {
            ...
            // Should appear exactly once despite two fields having the same definition
            const matches = result.match(/export interface IShared/g);
            expect(matches).toHaveLength(1);
        });

        it('should emit multiple different JSONTypeDefinitions', async () => {
            const fields = [
                makePrimaryKeyField(),
                makeField({
                    Name: 'Config',
            ...
            expect(result).toContain('export interface IConfigA');
            expect(result).toContain('export interface IConfigB');
        });
        ...
        it('should handle JSONType without JSONTypeDefinition', async () => {
            ...
            // Should use the type name in getter/setter even without definition block
            expect(result).toContain("get Config(): IExternalType | null");
            expect(result).toContain("set Config(value: IExternalType | null)");
            // Should NOT emit any definition block
            expect(result).not.toContain('export interface IExternalType');
        });
    ...
    describe('GenerateSchemaAndType - JSONType Zod schema', () => {
        ...
        it('should include JSON Type annotation in Zod description', () => {
            const fields = [
                makePrimaryKeyField(),
                makeField({
                    Name: 'Config',
