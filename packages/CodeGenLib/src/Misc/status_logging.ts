...
import { LogError, LogStatus, SeverityType, FormatFileMessage, FormatConsoleMessage } from '@memberjunction/global';
 ...
 * The default behavior in the base class is to use the LogError/LogStatus functions from the @memberjunction/global package to log to the console and to a log file if configured in the config.json file.
 *
 * Supports two modes:
