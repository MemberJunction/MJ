...
import { MJBootstrapModule, MJBootstrapComponent, MJInitializationService } from '../public-api';
...
describe('@memberjunction/ng-bootstrap', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(MJBootstrapModule).toBeTypeOf('function');
    expect(MJBootstrapComponent).toBeTypeOf('function');
    expect(MJInitializationService).toBeTypeOf('function');
  });
});
