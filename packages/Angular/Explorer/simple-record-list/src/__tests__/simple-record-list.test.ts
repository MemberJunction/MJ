...
import { SimpleRecordListModule, SimpleRecordListComponent } from '../public-api';
 ...
 */
describe('@memberjunction/ng-simple-record-list', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(SimpleRecordListModule).toBeTypeOf('function');
    expect(SimpleRecordListComponent).toBeTypeOf('function');
  });
});
