...
import { EntityField, LogError } from '@memberjunction/global';
...
export class WebLink extends BaseLink implements OnInit {
  ...
  ngOnInit() {
    ...
    else LogError('Entity Field must have ExtendedType of URL to use the mjWebLink directive. Field:' + this.field.Name);
  }
}
