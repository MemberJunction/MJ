  ...
  test: {
    projects: [
      mergeConfig(
        nodeSharedConfig,
        defineConfig({
          test: { name: 'core-entity-forms (node)', environment: 'node', exclude: ['**/*.dom.test.ts'] },
        }),
      ),
      mergeConfig(
        domSharedConfig,
        defineConfig({
          ...
          test: { name: 'core-entity-forms (dom)', include: ['src/**/*.dom.test.ts'], exclude: ['**/__tests__/**', '**/!(*.dom).test.ts'] },
        }),
      ),
    ],
  },
