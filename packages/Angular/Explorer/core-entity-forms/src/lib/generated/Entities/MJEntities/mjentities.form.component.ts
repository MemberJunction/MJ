...
import { MJEntitiesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjentities-form',
    templateUrl: './mjentities.form.component.html'
})
export class MJEntitiesFormComponent extends BaseFormComponent {
    public record!: MJEntitiesEntity;
