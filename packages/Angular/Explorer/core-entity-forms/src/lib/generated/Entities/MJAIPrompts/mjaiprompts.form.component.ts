...
import { MJAIPromptsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaiprompts-form',
    templateUrl: './mjaiprompts.form.component.html'
})
export class MJAIPromptsFormComponent extends BaseFormComponent {
    public record!: MJAIPromptsEntity;
