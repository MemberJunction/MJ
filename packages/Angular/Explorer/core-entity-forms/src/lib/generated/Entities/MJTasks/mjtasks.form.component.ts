...
import { MJTasksEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjtasks-form',
    templateUrl: './mjtasks.form.component.html'
})
export class MJTasksFormComponent extends BaseFormComponent {
    public record!: MJTasksEntity;
