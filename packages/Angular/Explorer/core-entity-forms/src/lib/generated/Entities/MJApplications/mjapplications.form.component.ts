...
import { MJApplicationsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjapplications-form',
    templateUrl: './mjapplications.form.component.html'
})
export class MJApplicationsFormComponent extends BaseFormComponent {
    public record!: MJApplicationsEntity;
