...
export class MJEntityFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'mJEntityAIActionsEntityID', sectionName: 'AI Actions', isExpanded: false },
            ...
            { sectionKey: 'mJEntityAIActionsOutputEntityID', sectionName: 'Entity AI Actions (Output Entity ID)', isExpanded: false },
