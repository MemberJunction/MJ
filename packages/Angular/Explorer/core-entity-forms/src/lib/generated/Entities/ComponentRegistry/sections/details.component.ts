...
@Component({
    selector: 'gen-componentregistry-form-details',
...
export class ComponentRegistryDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: ComponentRegistryEntity;
