...
import { MJAIActionsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaiactions-form',
    templateUrl: './mjaiactions.form.component.html'
})
export class MJAIActionsFormComponent extends BaseFormComponent {
    public record!: MJAIActionsEntity;
