...
import { MJEntityFieldsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjentityfields-form',
    templateUrl: './mjentityfields.form.component.html'
})
export class MJEntityFieldsFormComponent extends BaseFormComponent {
    public record!: MJEntityFieldsEntity;
