...
@Component({
    selector: 'gen-componentlibrarylink-form-details',
...
export class ComponentLibraryLinkDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: ComponentLibraryLinkEntity;
