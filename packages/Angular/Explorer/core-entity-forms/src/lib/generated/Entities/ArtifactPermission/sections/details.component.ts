...
@Component({
    selector: 'gen-artifactpermission-form-details',
...
export class ArtifactPermissionDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: ArtifactPermissionEntity;
