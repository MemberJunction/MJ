...
import { MJActionsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjactions-form',
    templateUrl: './mjactions.form.component.html'
})
export class MJActionsFormComponent extends BaseFormComponent {
    public record!: MJActionsEntity;
