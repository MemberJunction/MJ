...
@Component({
    selector: 'gen-taskdependency-form-details',
...
export class TaskDependencyDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: TaskDependencyEntity;
