...
import { MJReportsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjreports-form',
    templateUrl: './mjreports.form.component.html'
})
export class MJReportsFormComponent extends BaseFormComponent {
    public record!: MJReportsEntity;
