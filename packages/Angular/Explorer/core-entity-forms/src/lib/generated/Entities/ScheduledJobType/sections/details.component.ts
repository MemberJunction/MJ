...
@Component({
    selector: 'gen-scheduledjobtype-form-details',
...
export class ScheduledJobTypeDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: ScheduledJobTypeEntity;
