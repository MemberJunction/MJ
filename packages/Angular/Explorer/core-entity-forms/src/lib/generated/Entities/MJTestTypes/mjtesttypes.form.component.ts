...
import { MJTestTypesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjtesttypes-form',
    templateUrl: './mjtesttypes.form.component.html'
})
export class MJTestTypesFormComponent extends BaseFormComponent {
    public record!: MJTestTypesEntity;
