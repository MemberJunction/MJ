...
import { MJTestRunsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjtestruns-form',
    templateUrl: './mjtestruns.form.component.html'
})
export class MJTestRunsFormComponent extends BaseFormComponent {
    public record!: MJTestRunsEntity;
