...
import { MJAIPromptModelsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaipromptmodels-form',
    templateUrl: './mjaipromptmodels.form.component.html'
})
export class MJAIPromptModelsFormComponent extends BaseFormComponent {
    public record!: MJAIPromptModelsEntity;
