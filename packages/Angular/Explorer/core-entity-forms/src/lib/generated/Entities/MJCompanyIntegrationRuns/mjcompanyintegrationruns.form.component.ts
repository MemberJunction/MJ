...
import { MJCompanyIntegrationRunsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjcompanyintegrationruns-form',
    templateUrl: './mjcompanyintegrationruns.form.component.html'
})
export class MJCompanyIntegrationRunsFormComponent extends BaseFormComponent {
    public record!: MJCompanyIntegrationRunsEntity;
