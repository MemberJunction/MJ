...
import { MJAPIApplicationsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjapiapplications-form',
    templateUrl: './mjapiapplications.form.component.html'
})
export class MJAPIApplicationsFormComponent extends BaseFormComponent {
    public record!: MJAPIApplicationsEntity;
