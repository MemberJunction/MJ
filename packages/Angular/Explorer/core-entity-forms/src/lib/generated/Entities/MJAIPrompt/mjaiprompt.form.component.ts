...
export class MJAIPromptFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'mJAIPromptRunsChildPromptID', sectionName: 'AI Prompt Runs (Child Prompt ID)', isExpanded: false },
            { sectionKey: 'mJAIPromptRunsJudgeID', sectionName: 'AI Prompt Runs (Judge ID)', isExpanded: false },
