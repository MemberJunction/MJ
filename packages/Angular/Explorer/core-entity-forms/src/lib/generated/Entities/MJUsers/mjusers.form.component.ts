...
import { MJUsersEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjusers-form',
    templateUrl: './mjusers.form.component.html'
})
export class MJUsersFormComponent extends BaseFormComponent {
    public record!: MJUsersEntity;
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'companies', sectionName: 'Companies', isExpanded: false },
