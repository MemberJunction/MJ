...
import { MJAIAgentDataSourcesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaiagentdatasources-form',
    templateUrl: './mjaiagentdatasources.form.component.html'
})
export class MJAIAgentDataSourcesFormComponent extends BaseFormComponent {
    public record!: MJAIAgentDataSourcesEntity;
