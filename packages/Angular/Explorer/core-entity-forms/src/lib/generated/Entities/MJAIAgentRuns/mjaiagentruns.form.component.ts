...
import { MJAIAgentRunsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaiagentruns-form',
    templateUrl: './mjaiagentruns.form.component.html'
})
export class MJAIAgentRunsFormComponent extends BaseFormComponent {
    public record!: MJAIAgentRunsEntity;
