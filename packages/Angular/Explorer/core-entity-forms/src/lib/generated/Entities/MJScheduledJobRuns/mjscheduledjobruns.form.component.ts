...
import { MJScheduledJobRunsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjscheduledjobruns-form',
    templateUrl: './mjscheduledjobruns.form.component.html'
})
export class MJScheduledJobRunsFormComponent extends BaseFormComponent {
    public record!: MJScheduledJobRunsEntity;
