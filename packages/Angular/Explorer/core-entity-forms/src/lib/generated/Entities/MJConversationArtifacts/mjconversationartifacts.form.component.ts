...
import { MJConversationArtifactsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjconversationartifacts-form',
    templateUrl: './mjconversationartifacts.form.component.html'
})
export class MJConversationArtifactsFormComponent extends BaseFormComponent {
    public record!: MJConversationArtifactsEntity;
