...
import { MJAIAgentTypesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaiagenttypes-form',
    templateUrl: './mjaiagenttypes.form.component.html'
})
export class MJAIAgentTypesFormComponent extends BaseFormComponent {
    public record!: MJAIAgentTypesEntity;
