...
@Component({
    selector: 'gen-scheduledjobrun-form-details',
...
export class ScheduledJobRunDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: ScheduledJobRunEntity;
