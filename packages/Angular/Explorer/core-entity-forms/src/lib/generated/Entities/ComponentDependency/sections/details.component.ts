...
@Component({
    selector: 'gen-componentdependency-form-details',
...
export class ComponentDependencyDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: ComponentDependencyEntity;
