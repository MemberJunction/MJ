...
import { MJTestsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjtests-form',
    templateUrl: './mjtests.form.component.html'
})
export class MJTestsFormComponent extends BaseFormComponent {
    public record!: MJTestsEntity;
