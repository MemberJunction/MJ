...
import { MJFileCategoriesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjfilecategories-form',
    templateUrl: './mjfilecategories.form.component.html'
})
export class MJFileCategoriesFormComponent extends BaseFormComponent {
    public record!: MJFileCategoriesEntity;
