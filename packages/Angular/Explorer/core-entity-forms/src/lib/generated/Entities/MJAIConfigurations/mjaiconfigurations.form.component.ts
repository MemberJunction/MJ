...
import { MJAIConfigurationsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaiconfigurations-form',
    templateUrl: './mjaiconfigurations.form.component.html'
})
export class MJAIConfigurationsFormComponent extends BaseFormComponent {
    public record!: MJAIConfigurationsEntity;
