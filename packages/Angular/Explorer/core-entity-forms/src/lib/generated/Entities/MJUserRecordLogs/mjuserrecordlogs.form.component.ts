...
import { MJUserRecordLogsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjuserrecordlogs-form',
    templateUrl: './mjuserrecordlogs.form.component.html'
})
export class MJUserRecordLogsFormComponent extends BaseFormComponent {
    public record!: MJUserRecordLogsEntity;
