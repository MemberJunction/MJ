...
import { MJEntityRelationshipsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjentityrelationships-form',
    templateUrl: './mjentityrelationships.form.component.html'
})
export class MJEntityRelationshipsFormComponent extends BaseFormComponent {
    public record!: MJEntityRelationshipsEntity;
