...
export class MJUserFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'mJRecordMergeLogsApprovedByUserID', sectionName: 'Record Merge Logs', isExpanded: false },
            ...
            { sectionKey: 'mJContentItemDuplicates', sectionName: 'Content Item Duplicates', isExpanded: false },
            ...
            { sectionKey: 'mJDuplicateRunsApprovedByUserID', sectionName: 'Duplicate Runs (Approved By User ID)', isExpanded: false },
