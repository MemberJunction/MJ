...
export class MJUserFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'mJRecordMergeLogsInitiatedByUserID', sectionName: 'Record Merge Logs', isExpanded: false },
            ...
            { sectionKey: 'mJDuplicateRunsApprovedByUserID', sectionName: 'Duplicate Runs (Approved By User)', isExpanded: false },
            ...
            { sectionKey: 'mJRecordMergeLogsApprovedByUserID', sectionName: 'Record Merge Logs (Approved By User)', isExpanded: false },
