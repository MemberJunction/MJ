...
import { MJEntityActionsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjentityactions-form',
    templateUrl: './mjentityactions.form.component.html'
})
export class MJEntityActionsFormComponent extends BaseFormComponent {
    public record!: MJEntityActionsEntity;
