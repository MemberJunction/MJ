...
import { MJRecordChangesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjrecordchanges-form',
    templateUrl: './mjrecordchanges.form.component.html'
})
export class MJRecordChangesFormComponent extends BaseFormComponent {
    public record!: MJRecordChangesEntity;
