...
import { MJConversationDetailsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjconversationdetails-form',
    templateUrl: './mjconversationdetails.form.component.html'
})
export class MJConversationDetailsFormComponent extends BaseFormComponent {
    public record!: MJConversationDetailsEntity;
