...
import { MJEnvironmentsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjenvironments-form',
    templateUrl: './mjenvironments.form.component.html'
})
export class MJEnvironmentsFormComponent extends BaseFormComponent {
    public record!: MJEnvironmentsEntity;
