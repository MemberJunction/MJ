...
import { MJAIVendorsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaivendors-form',
    templateUrl: './mjaivendors.form.component.html'
})
export class MJAIVendorsFormComponent extends BaseFormComponent {
    public record!: MJAIVendorsEntity;
