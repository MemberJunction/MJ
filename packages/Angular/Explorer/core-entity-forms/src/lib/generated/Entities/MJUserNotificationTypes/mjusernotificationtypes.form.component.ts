...
import { MJUserNotificationTypesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjusernotificationtypes-form',
    templateUrl: './mjusernotificationtypes.form.component.html'
})
export class MJUserNotificationTypesFormComponent extends BaseFormComponent {
    public record!: MJUserNotificationTypesEntity;
