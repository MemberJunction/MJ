...
import { MJTemplateContentsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjtemplatecontents-form',
    templateUrl: './mjtemplatecontents.form.component.html'
})
export class MJTemplateContentsFormComponent extends BaseFormComponent {
    public record!: MJTemplateContentsEntity;
