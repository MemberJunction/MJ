...
@RegisterClass(BaseFormSectionComponent, 'MJ: AI Agent Run Steps.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-aiagentrunstep-form-details',
...
export class AIAgentRunStepDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: AIAgentRunStepEntity;
