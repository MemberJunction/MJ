...
export class flyway_schema_historyDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: flyway_schema_historyEntity;
    @Input() override EditMode: boolean = false;
}

export function Loadflyway_schema_historyDetailsComponent() {
