...
import { MJProjectsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjprojects-form',
    templateUrl: './mjprojects.form.component.html'
})
export class MJProjectsFormComponent extends BaseFormComponent {
    public record!: MJProjectsEntity;
