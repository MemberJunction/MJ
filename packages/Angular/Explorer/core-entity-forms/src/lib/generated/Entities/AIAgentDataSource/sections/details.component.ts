...
@Component({
    selector: 'gen-aiagentdatasource-form-details',
...
export class AIAgentDataSourceDetailsComponent extends BaseFormSectionComponent {
    @Input() override record!: AIAgentDataSourceEntity;
