...
import { MJAIPromptRunsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaipromptruns-form',
    templateUrl: './mjaipromptruns.form.component.html'
})
export class MJAIPromptRunsFormComponent extends BaseFormComponent {
    public record!: MJAIPromptRunsEntity;
