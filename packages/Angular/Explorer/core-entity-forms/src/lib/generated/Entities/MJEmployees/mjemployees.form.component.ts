...
import { MJEmployeesEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjemployees-form',
    templateUrl: './mjemployees.form.component.html'
})
export class MJEmployeesFormComponent extends BaseFormComponent {
    public record!: MJEmployeesEntity;
