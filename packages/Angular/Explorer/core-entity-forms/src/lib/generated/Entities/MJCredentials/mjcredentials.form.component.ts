...
import { MJCredentialsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjcredentials-form',
    templateUrl: './mjcredentials.form.component.html'
})
export class MJCredentialsFormComponent extends BaseFormComponent {
    public record!: MJCredentialsEntity;
