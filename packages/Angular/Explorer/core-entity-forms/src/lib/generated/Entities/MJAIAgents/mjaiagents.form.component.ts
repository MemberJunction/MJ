...
import { MJAIAgentsEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjaiagents-form',
    templateUrl: './mjaiagents.form.component.html'
})
export class MJAIAgentsFormComponent extends BaseFormComponent {
    public record!: MJAIAgentsEntity;
