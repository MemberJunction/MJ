...
import { MJMCPServersEntity } from '@memberjunction/core-entities';
...
@Component({
    standalone: false,
    selector: 'gen-mjmcpservers-form',
    templateUrl: './mjmcpservers.form.component.html'
})
export class MJMCPServersFormComponent extends BaseFormComponent {
    public record!: MJMCPServersEntity;
