...
import { RunView, CompositeKey } from '@memberjunction/global';
...
export class FlowAgentFormSectionComponent extends BaseFormSectionComponent implements OnInit, OnDestroy {
  ...
  public get filteredPaths(): AIAgentStepPathEntity[] {
    ...
    return this.paths.filter((p) => p.OriginStepID === this.selectedStepId || p.DestinationStepID === this.selectedStepId);
  }
