...
import { MJUserEntity, UserInfoEngine } from '@memberjunction/core-entities';
            ...
            <div class="mj-entity-hero-header">
                <div class="mj-hero-top">
                    <div class="mj-hero-identity">
                        <div class="mj-hero-avatar" style="background: linear-gradient(135deg, #0ea5e9, #0369a1);">
                            <i class="fa-solid fa-user-gear"></i>
                        </div>
                        <div>
                            <h1 class="mj-hero-title">{{ User.Name || User.Email || 'MemberJunction User' }}</h1>
                ...
                @if (!IsCollapsed) {
                    <div class="mj-hero-metrics-row">
                        <div class="mj-hero-metric">
                            <span class="mj-hero-metric-label">User ID</span>
                            <span class="mj-hero-metric-val">{{ User.ID?.substring(0, 8) }}</span>
                        </div>
                        <div class="mj-hero-metric">
                            <span class="mj-hero-metric-label">Account Status</span>
                            <span class="mj-hero-metric-val" [style.color]="User.IsActive ? '#10b981' : '#f43f5e'">
...
export class UserHeaderPanel extends BaseFormPanel<MJUserEntity> {
