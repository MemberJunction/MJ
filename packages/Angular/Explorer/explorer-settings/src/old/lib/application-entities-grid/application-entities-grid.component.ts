...
export class ApplicationEntitiesGridComponent implements OnInit, OnChanges {
  ...
  async Refresh() {
    ...
    if (this.Mode === 'Entities')
      if (!this.EntityID || !this.EntityRecord) throw new Error("EntityID and EntityRecord are required when Mode is 'Entities'");
