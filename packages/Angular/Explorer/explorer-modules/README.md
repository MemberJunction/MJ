...
Consolidated module bundle that re-exports all MemberJunction Explorer modules in a single import. Replaces 20+ individual module imports with one.

## Overview

Explorer Modules provides `MJExplorerModulesBundle`, a convenience NgModule that aggregates all commonly needed MJ Explorer modules. Instead of importing each module individually in your application, import this single bundle to get the complete set of MJ functionality.
...
|---|---|---|
| `MJExplorerModulesBundle` | NgModule | Consolidated bundle of all Explorer modules |
