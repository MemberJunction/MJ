 ...
 * @description Per-wizard state management for the Entity Designer create/modify flow.
 *
 * ### Lifecycle
 ...
 * private readonly designerService = inject(EntityDesignerService);
 ...
 * - Server round-trips (validateSchema, submit) delegated to EntityDesignerService
 *
 * No component layout, no templates, no Angular DI lifecycle.
 */

import { BehaviorSubject, Observable } from 'rxjs';
import { EntityDesignerService } from './entity-designer.service.js';
import type {
    EntityTableSpec,
    BasicsStepValue,
    ColumnSpec,
    ...
    WizardStep,
} from '../entity-designer.types.js';

export class EntityWizardStateService {

    constructor(private readonly designerService: EntityDesignerService) {}
