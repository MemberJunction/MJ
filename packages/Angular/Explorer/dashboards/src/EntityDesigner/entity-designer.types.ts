/**
 * @module entity-designer.types
 * @description Shared client-side type contracts for the Entity Designer Angular UI.
 *
 * These types mirror server-side interfaces from `@memberjunction/entity-designer-core`
...
/**
 * Client-side column specification for the Entity Designer wizard.
...
/**
 * Client-side table specification sent to Entity Designer actions.
...
/**
 * Lightweight entity row shown in the Entity Designer entity list.
 * Loaded by `EntityDesignerEngine.loadAccessibleEntities()`.
 */
...
/** Validation outcome returned by `EntityDesignerService.validateEntitySchema()`. */
...
/** Result returned by `EntityDesignerService.createEntity()` and `modifyEntity()`. */
...
/** Result returned by `EntityDesignerService.describeEntity()`. */
