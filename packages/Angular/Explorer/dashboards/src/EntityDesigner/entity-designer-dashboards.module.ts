/**
 * EntityDesignerDashboardsModule
 *
 * Feature module for the Entity Designer dashboard area.  Declares the main
...
import { EntityDesignerDashboardComponent } from './components/entity-designer-dashboard.component';
...
import { EntityCreateWizardComponent } from './components/create-wizard/entity-create-wizard.component';
...
import { EntityModifyComponent } from './components/modify/entity-modify.component';
import { EntityDesignerService } from './services/entity-designer.service';

@NgModule({
    declarations: [
        EntityDesignerDashboardComponent,
        EntityListComponent,
        // Phase 5c: shared UI
...
export class EntityDesignerDashboardsModule {}
