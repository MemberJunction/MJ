 ...
 *
 * Loaded from `EntityDesignerEngine.Instance.loadAccessibleEntities()` —
...
import { EntityDesignerEngine } from '../services/entity-designer.engine.js';
import type { AccessibleEntity } from '../entity-designer.types.js';
...
@Component({
    standalone: false,
    selector: 'mj-entity-designer-list',
...
export class EntityListComponent implements OnInit, OnDestroy {
    ...
    public OnRefresh(): void {
        EntityDesignerEngine.Instance.invalidateCache();
        this.loadEntities();
    }
    ...
    private async loadEntities(): Promise<void> {
        ...
        try {
            this._allEntities = await EntityDesignerEngine.Instance.loadAccessibleEntities();
