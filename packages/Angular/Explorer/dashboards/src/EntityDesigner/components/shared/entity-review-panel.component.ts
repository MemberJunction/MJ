 ...
 * Entity Designer agent produces in chat.  Used in wizard Step 4 (Review) and
...
import type { EntityTableSpec, ColumnSpec, ForeignKeySpec } from '../../entity-designer.types.js';
...
@Component({
    standalone: false,
    selector: 'mj-entity-review-panel',
