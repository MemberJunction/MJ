...
import { EntityDesignerService } from '../../services/entity-designer.service.js';
import type {
    EntityTableSpec,
...
@Component({
    standalone: false,
    selector: 'mj-entity-pipeline-panel',
...
export class EntityPipelinePanelComponent implements AfterViewInit {
    ...
    private readonly service = inject(EntityDesignerService);
