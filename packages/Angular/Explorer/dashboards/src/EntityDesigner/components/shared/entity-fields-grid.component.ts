 ...
 * @description Inline field editor for the Entity Designer wizard (Step 2) and
...
import type { ColumnSpec, FieldTypeOption } from '../../entity-designer.types.js';
import { FIELD_TYPE_OPTIONS } from '../../entity-designer.types.js';
...
@Component({
    standalone: false,
    selector: 'mj-entity-fields-grid',
