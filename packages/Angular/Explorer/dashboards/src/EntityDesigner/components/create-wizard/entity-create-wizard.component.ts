/**
 * @module entity-create-wizard.component
 * @description Multi-step wizard for creating a new Entity Designer entity.
 *
...
@Component({
    standalone: false,
    selector: 'mj-entity-create-wizard',
    templateUrl: './entity-create-wizard.component.html',
    styleUrls: ['./entity-create-wizard.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EntityCreateWizardComponent implements OnDestroy {
    ...
    public get AvailableSchemas() {
        return EntityDesignerEngine.Instance.getAvailableSchemas();
    }
