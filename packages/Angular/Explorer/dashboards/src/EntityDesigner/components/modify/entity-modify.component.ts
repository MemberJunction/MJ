/**
 * @module entity-modify.component
 * @description Slide-over view for modifying an existing Entity Designer entity.
 *
 ...
 * The pipeline panel then calls `EntityDesignerService.modifyEntity()`.
 */
...
import type { AccessibleEntityDetail, ColumnSpec, EntityTableSpec, EntityPipelineResult } from '../../entity-designer.types.js';

type ModifyTab = 'fields' | 'review' | 'apply';

@Component({
    standalone: false,
    selector: 'mj-entity-modify',
    templateUrl: './entity-modify.component.html',
    styleUrls: ['./entity-modify.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EntityModifyComponent implements OnInit, OnDestroy {
    ...
    private async loadEntityDetail(): Promise<void> {
        ...
        try {
            this.EntityDetail = await EntityDesignerEngine.Instance.loadEntityDetail(this._entityId);
