/**
 * @module entity-designer-dashboard.component
 * @description Root dashboard for the Entity Designer feature area.
 *
 * Registered as 'EntityDesignerDashboard' via `@RegisterClass(BaseDashboard, ...)`.
 ...
 *  - `loadData()` — delegate to EntityDesignerEngine singleton; pass result to EntityListComponent
 *
...
import { EntityModifyComponent } from './modify/entity-modify.component.js';
import type { AccessibleEntity } from '../entity-designer.types.js';

@Component({
    standalone: false,
    selector: 'mj-entity-designer-dashboard',
    templateUrl: './entity-designer-dashboard.component.html',
    styleUrls: ['./entity-designer-dashboard.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
@RegisterClass(BaseResourceComponent, 'EntityDesignerDashboard')
export class EntityDesignerDashboardComponent extends BaseDashboard {

    // ─── Injected services ─────────────────────────────────────────────────

    /** Angular DI: write operations (create, modify, validate). */
    protected readonly designerService = inject(EntityDesignerService);
    ...
    @ViewChild(EntityModifyComponent) private modifyRef?: EntityModifyComponent;
    ...
    protected async loadData(): Promise<void> {
        ...
        try {
            this.Entities = await EntityDesignerEngine.Instance.loadAccessibleEntities();
...
export function LoadEntityDesignerDashboard(): void { /* noop — forces import */ }
