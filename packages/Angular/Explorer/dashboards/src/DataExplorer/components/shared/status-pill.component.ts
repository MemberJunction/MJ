...
/**
 * Pill Component - displays any enumerated/categorical values as colored pills
 ...
 */
@Component({
  selector: 'mj-status-pill',  // Keep selector for backward compatibility
  template: `
    <span class="status-pill" [class]="'pill-' + colorType">
      {{ displayValue }}
    </span>
  `,
  styles: [`
