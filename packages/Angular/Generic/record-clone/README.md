...
|---|---|---|
| `mj-clone-scope-controls` | `Presets`, `SelectedPreset`, `MaxDepth`, `MaxRecords`, `Subtypes`, `Hierarchy`, `SoftLinks`, `EntityActions`, `ConfiguredScope`, `EntityName`, `CanOverrideScope` | `ScopeChanged: RecordClonePlanOptions`, `ResetToDefaults` |
