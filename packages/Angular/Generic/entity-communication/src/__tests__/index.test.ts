...
import { EntityCommunicationsModule, EntityCommunicationsPreviewComponent, EntityCommunicationsPreviewWindowComponent } from '../public-api';
...
describe('@memberjunction/ng-entity-communications', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(EntityCommunicationsModule).toBeTypeOf('function');
    expect(EntityCommunicationsPreviewComponent).toBeTypeOf('function');
    expect(EntityCommunicationsPreviewWindowComponent).toBeTypeOf('function');
  });
});
