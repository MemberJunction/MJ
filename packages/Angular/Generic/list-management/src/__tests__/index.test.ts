...
import { ListManagementModule, AudienceSourcePickerComponent, ListManagementService } from '../public-api';
...
describe('@memberjunction/ng-list-management', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(ListManagementModule).toBeTypeOf('function');
    expect(AudienceSourcePickerComponent).toBeTypeOf('function');
    expect(ListManagementService).toBeTypeOf('function');
  });
});
