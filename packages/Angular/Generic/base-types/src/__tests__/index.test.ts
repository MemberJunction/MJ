...
import { BaseAngularComponent, BaseFormComponentEvent, FormEditingCompleteEvent } from '../public-api';
...
describe('@memberjunction/ng-base-types', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(BaseAngularComponent).toBeTypeOf('function');
    expect(BaseFormComponentEvent).toBeTypeOf('function');
    expect(FormEditingCompleteEvent).toBeTypeOf('function');
  });
});
