...
import { ContainerDirectivesModule, FillContainer, Container } from '../public-api';
...
describe('@memberjunction/ng-container-directives', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(ContainerDirectivesModule).toBeTypeOf('function');
    expect(FillContainer).toBeTypeOf('function');
