...
import { NgTasksModule, TaskComponent, SimpleTaskViewerComponent } from '../public-api';
...
describe('@memberjunction/ng-tasks', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(NgTasksModule).toBeTypeOf('function');
    expect(TaskComponent).toBeTypeOf('function');
    expect(SimpleTaskViewerComponent).toBeTypeOf('function');
  });
});
