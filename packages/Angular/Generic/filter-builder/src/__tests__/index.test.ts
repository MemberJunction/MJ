...
import { FilterBuilderModule, FilterBuilderComponent, FilterGroupComponent } from '../public-api';
...
describe('@memberjunction/ng-filter-builder', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(FilterBuilderModule).toBeTypeOf('function');
    expect(FilterBuilderComponent).toBeTypeOf('function');
    expect(FilterGroupComponent).toBeTypeOf('function');
  });
});
