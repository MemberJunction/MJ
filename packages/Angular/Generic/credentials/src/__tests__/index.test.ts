...
import { CredentialsModule, CredentialEditPanelComponent, CredentialDialogService } from '../public-api';
...
describe('@memberjunction/ng-credentials', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(CredentialsModule).toBeTypeOf('function');
    expect(CredentialEditPanelComponent).toBeTypeOf('function');
    expect(CredentialDialogService).toBeTypeOf('function');
  });
});
