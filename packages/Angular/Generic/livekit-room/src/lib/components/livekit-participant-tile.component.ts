...
@Component({
  ...
  template: `
    <div class="lk-tile" [class.lk-tile--speaking]="ShowActiveSpeakerRing && Participant?.IsSpeaking" [class.lk-tile--agent]="Participant?.Role === 'agent'">
    ...
    `
      ...
      .lk-tile--agent {
        background: linear-gradient(
          160deg,
          color-mix(in srgb, var(--mj-brand-primary, #0076b6) 22%, var(--mj-bg-surface-sunken, #0f172a)),
          var(--mj-bg-surface-sunken, #0f172a)
        );
      }
      .lk-tile__video {
        width: 100%;
