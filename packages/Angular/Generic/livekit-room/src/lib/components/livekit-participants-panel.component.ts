                ...
                @for (p of Participants; track p.Identity) {
                    <li class="lk-roster__item" [class.lk-roster__item--speaking]="p.IsSpeaking">
                        ...
                        <span class="lk-roster__name">
                            {{ p.DisplayName }}
                            @if (p.IsLocal) { <em class="lk-roster__tag">you</em> }
                            @if (p.Role === 'agent') { <em class="lk-roster__tag lk-roster__tag--agent">AI</em> }
                        </span>
                        <span class="lk-roster__icons">
                            ...
                            @if (p.HasVideo) { <i class="fa-solid fa-video"></i> }
                            @if (p.IsScreenSharing) { <i class="fa-solid fa-display"></i> }
                        </span>
                    </li>
                }
            </ul>
