...
import { MJReactModule, MJReactComponent, ScriptLoaderService } from '../public-api';
...
describe('@memberjunction/ng-react', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(MJReactModule).toBeTypeOf('function');
    expect(MJReactComponent).toBeTypeOf('function');
    expect(ScriptLoaderService).toBeTypeOf('function');
  });
});
