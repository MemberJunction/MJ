...
import { ActionGalleryModule, ActionGalleryComponent, ActionGalleryDialogService } from '../public-api';
...
describe('@memberjunction/ng-action-gallery', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(ActionGalleryModule).toBeTypeOf('function');
    expect(ActionGalleryComponent).toBeTypeOf('function');
    expect(ActionGalleryDialogService).toBeTypeOf('function');
  });
});
