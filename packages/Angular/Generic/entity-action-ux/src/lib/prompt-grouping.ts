...
/** @deprecated Use {@link GroupPromptsByCategory}. */
export function groupPromptsByCategory(prompts: PromptOption[]): PromptGroup[] {
    return GroupPromptsByCategory(prompts);
}
...
/** @deprecated Use {@link FilterPromptGroups}. */
export function filterPromptGroups(groups: PromptGroup[], query: string): PromptGroup[] {
    return FilterPromptGroups(groups, query);
}
