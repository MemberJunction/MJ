...
/**
 * A centered modal dialog that wraps the SkillPermissionsPanel.
...
@Component({
  standalone: false,
    selector: 'mj-skill-permissions-dialog',
    template: `
        <!-- Backdrop -->
        ...
        <div class="apd-dialog" [class.apd-visible]="IsVisible">
          ...
          <div class="apd-header">
            <div class="apd-title-group">
              ...
              <div>
                <h2 class="apd-title">Manage Skill Permissions</h2>
                @if (Skill) {
                  <p class="apd-subtitle">{{ Skill.Name }}</p>
                }
              </div>
            </div>
...
export class SkillPermissionsDialogComponent {
