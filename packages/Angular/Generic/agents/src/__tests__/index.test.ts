...
import { AgentsModule, AgentPermissionsPanelComponent, AgentPermissionsService } from '../public-api';
...
describe('@memberjunction/ng-agents', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(AgentsModule).toBeTypeOf('function');
    expect(AgentPermissionsPanelComponent).toBeTypeOf('function');
    expect(AgentPermissionsService).toBeTypeOf('function');
  });
});
