...
import { RecordSelectorModule, RecordSelectorComponent, RecordSelectorDialogComponent } from '../public-api';
...
describe('@memberjunction/ng-record-selector', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(RecordSelectorModule).toBeTypeOf('function');
    expect(RecordSelectorComponent).toBeTypeOf('function');
    expect(RecordSelectorDialogComponent).toBeTypeOf('function');
  });
});
