...
import { QueryViewerModule, QueryDataGridComponent, QueryParameterFormComponent } from '../public-api';
...
describe('@memberjunction/ng-query-viewer', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(QueryViewerModule).toBeTypeOf('function');
    expect(QueryDataGridComponent).toBeTypeOf('function');
    expect(QueryParameterFormComponent).toBeTypeOf('function');
  });
});
