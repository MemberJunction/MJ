...
import { DataContextModule, DataContextDialogComponent, DataContextComponent } from '../public-api';
...
describe('@memberjunction/ng-data-context', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(DataContextModule).toBeTypeOf('function');
    expect(DataContextDialogComponent).toBeTypeOf('function');
    expect(DataContextComponent).toBeTypeOf('function');
  });
});
