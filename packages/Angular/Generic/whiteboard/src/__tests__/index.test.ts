...
import { WhiteboardModule, RealtimeWhiteboardBoardComponent, WhiteboardState } from '../public-api';
 ...
 */
describe('@memberjunction/ng-whiteboard', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(WhiteboardModule).toBeTypeOf('function');
    expect(RealtimeWhiteboardBoardComponent).toBeTypeOf('function');
    expect(WhiteboardState).toBeTypeOf('function');
  });
});
