...
import { SchedulingModule, ScheduledJobEditorComponent, ScheduledJobService } from '../public-api';
...
describe('@memberjunction/ng-scheduling', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(SchedulingModule).toBeTypeOf('function');
    expect(ScheduledJobEditorComponent).toBeTypeOf('function');
    expect(ScheduledJobService).toBeTypeOf('function');
  });
});
