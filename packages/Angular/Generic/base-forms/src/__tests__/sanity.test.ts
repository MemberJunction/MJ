...
import { BaseFormsModule, MjEntityFormHostComponent, FormResolverService } from '../public-api';
 ...
 */
describe('@memberjunction/ng-base-forms', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(BaseFormsModule).toBeTypeOf('function');
    expect(MjEntityFormHostComponent).toBeTypeOf('function');
    expect(FormResolverService).toBeTypeOf('function');
  });
});
