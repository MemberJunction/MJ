...
import { DeepDiffModule, DeepDiffComponent, DeepDiffDialogComponent } from '../public-api';
...
describe('@memberjunction/ng-deep-diff', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(DeepDiffModule).toBeTypeOf('function');
    expect(DeepDiffComponent).toBeTypeOf('function');
    expect(DeepDiffDialogComponent).toBeTypeOf('function');
  });
});
