...
import { FlowEditorModule, FlowEditorComponent, FlowStateService } from '../public-api';
...
describe('@memberjunction/ng-flow-editor', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(FlowEditorModule).toBeTypeOf('function');
    expect(FlowEditorComponent).toBeTypeOf('function');
    expect(FlowStateService).toBeTypeOf('function');
  });
});
