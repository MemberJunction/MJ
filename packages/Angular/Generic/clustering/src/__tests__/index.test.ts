...
import { ClusteringModule, ClusterScatterComponent, ClusteringService } from '../public-api';
 ...
 */
describe('@memberjunction/ng-clustering', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(ClusteringModule).toBeTypeOf('function');
    expect(ClusterScatterComponent).toBeTypeOf('function');
    expect(ClusteringService).toBeTypeOf('function');
  });
});
