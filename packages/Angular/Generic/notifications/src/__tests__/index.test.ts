...
import { MJNotificationsModule, MJNotificationService } from '../public-api';
...
describe('@memberjunction/ng-notifications', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(MJNotificationsModule).toBeTypeOf('function');
    expect(MJNotificationService).toBeTypeOf('function');
  });
});
