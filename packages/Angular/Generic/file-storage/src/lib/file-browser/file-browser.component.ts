 ...
 *
 * Layout:
 * - Left sidebar: Storage provider selection
...
export class FileBrowserComponent implements OnInit {
  ...
  /**
   * Controls visibility of the providers sidebar on mobile devices.
   */
  public isSidebarVisible: boolean = true;

  /**
   * Currently selected storage provider.
   */
  ...
  /**
   * Toggles the visibility of the providers sidebar.
  ...
  /**
   * Handles storage provider selection from the sidebar.
   *
   * @param provider - The selected storage provider entity
   */
  public onProviderSelected(provider: FileStorageProviderEntity): void {
    this.selectedProvider = provider;
    this.selectedFolderPath = '/'; // Reset to root when switching providers
  }
