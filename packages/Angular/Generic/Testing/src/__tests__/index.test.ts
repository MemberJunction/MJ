...
import { TestingModule, TestFeedbackDialogComponent, TestingDialogService } from '../public-api';
...
describe('@memberjunction/ng-testing', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(TestingModule).toBeTypeOf('function');
    expect(TestFeedbackDialogComponent).toBeTypeOf('function');
    expect(TestingDialogService).toBeTypeOf('function');
  });
});
