...
import { NgTreesModule, TreeComponent, TreeDropdownComponent } from '../public-api';
...
describe('@memberjunction/ng-trees', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(NgTreesModule).toBeTypeOf('function');
    expect(TreeComponent).toBeTypeOf('function');
    expect(TreeDropdownComponent).toBeTypeOf('function');
  });
});
