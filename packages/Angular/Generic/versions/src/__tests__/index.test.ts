...
import { VersionsModule, MjRecordMicroViewComponent, MjLabelCreateComponent } from '../public-api';
...
describe('@memberjunction/ng-versions', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(VersionsModule).toBeTypeOf('function');
    expect(MjRecordMicroViewComponent).toBeTypeOf('function');
    expect(MjLabelCreateComponent).toBeTypeOf('function');
  });
});
