...
import { GenericDialogModule, GenericDialogComponent } from '../public-api';
...
describe('@memberjunction/ng-generic-dialog', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(GenericDialogModule).toBeTypeOf('function');
    expect(GenericDialogComponent).toBeTypeOf('function');
  });
});
