            ...
            <div class="mj-lk-agents__panel">
              ...
              @for (a of agentsInRoom; track a.SessionBridgeID) {
                <div class="mj-lk-agents__row">
                  ...
                  <button type="button" class="mj-lk-agents__remove" title="Remove agent" aria-label="Remove agent"
              ...
              @if (availableToAdd.length) {
                <div class="mj-lk-agents__add">
                  ...
                  <button type="button" class="mj-lk-agents__addbtn" title="Add selected agent" aria-label="Add selected agent" [disabled]="!addTargetId || addingAgent" (click)="AddAgent()">
