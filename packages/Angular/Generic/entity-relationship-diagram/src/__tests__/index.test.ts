...
import { EntityRelationshipDiagramModule, ERDDiagramComponent, MJEntityERDComponent } from '../public-api';
...
describe('@memberjunction/ng-entity-relationship-diagram', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(EntityRelationshipDiagramModule).toBeTypeOf('function');
    expect(ERDDiagramComponent).toBeTypeOf('function');
    expect(MJEntityERDComponent).toBeTypeOf('function');
  });
});
