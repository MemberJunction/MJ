...
import { AITestHarnessModule, AITestHarnessComponent, TestHarnessWindowService } from '../public-api';
...
describe('@memberjunction/ng-ai-test-harness', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(AITestHarnessModule).toBeTypeOf('function');
    expect(AITestHarnessComponent).toBeTypeOf('function');
    expect(TestHarnessWindowService).toBeTypeOf('function');
  });
});
