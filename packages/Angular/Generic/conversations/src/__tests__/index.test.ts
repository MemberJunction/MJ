...
import { ConversationsModule, ConversationWorkspaceComponent, DataCacheService } from '../public-api';
...
describe('@memberjunction/ng-conversations', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(ConversationsModule).toBeTypeOf('function');
    expect(ConversationWorkspaceComponent).toBeTypeOf('function');
    expect(DataCacheService).toBeTypeOf('function');
  });
});
