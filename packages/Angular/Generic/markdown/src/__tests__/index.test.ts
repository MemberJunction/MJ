...
import { MarkdownModule, MarkdownComponent, MarkdownService } from '../public-api';
...
describe('@memberjunction/ng-markdown', () => {
  ...
  it('exports its load-bearing classes as constructors', () => {
    expect(MarkdownModule).toBeTypeOf('function');
    expect(MarkdownComponent).toBeTypeOf('function');
    expect(MarkdownService).toBeTypeOf('function');
  });
});
