...
- @memberjunction/markdown-core@6.1.3
...
- @memberjunction/markdown-core@6.1.1
...
- 10cbc60: Markdown renderer: close the cross-site scripting vectors found by the first full CodeQL scan, with sanitization moved to the service so every consumer gets it.
