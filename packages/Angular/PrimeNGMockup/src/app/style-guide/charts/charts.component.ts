...
export class ChartsComponent implements OnInit, OnDestroy {
    ...
    RadarData!: object;
    RadarOptions!: object;
    PolarAreaData!: object;
    PolarAreaOptions!: object;
    ...
    private BuildSharedScaleOptions(textSecondary: string, gridColor: string): object {
        return {
            x: {
    ...
    private BuildSharedPluginOptions(textSecondary: string): object {
        return {
            legend: {
