...
| OrgA | Real-world client | 36 | 1807 | None (qualitative only) | ✅ Complete — 35 PKs, 193 FKs |
| OrgB | Real-world client | 125 | 2347 | None (qualitative only) | 🟡 Running |
...
- **Client databases** (OrgA, OrgB): NO ground truth. Any constraints found in the database were from prior AutoDoc runs, not human-verified. Evaluation is qualitative only — PK/FK coverage, description quality, domain understanding.
