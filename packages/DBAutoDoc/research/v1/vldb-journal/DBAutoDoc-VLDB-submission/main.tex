% DBAutoDoc — The VLDB Journal (Springer Nature) Format
% Template: sn-jnl (Springer Nature journal class)
%
% To compile:
%   pdflatex main
%   bibtex main
...
\title[DBAutoDoc]{DBAutoDoc: Automated Discovery and Documentation of Undocumented Database Schemas via Statistical Analysis and Iterative LLM Refinement}

\author*[1]{\fnm{Amith} \sur{Nagarajan}}\email{amith@bluecypress.io}

\author[2]{\fnm{Thomas} \sur{Altman}}\email{thomas@tasio.co}

\affil*[1]{\orgname{Blue Cypress}, \orgaddress{\city{New Orleans}, \state{LA}, \country{USA}}}

\affil[2]{\orgname{Tasio Labs (a Blue Cypress company)}, \orgaddress{\city{Tuscaloosa}, \state{AL}, \country{USA}}}
...
%% REFERENCES
%% ============================================================
%% sn-basic bibliography style is set by the documentclass option
