...
-- =============================================================================
-- INCREMENTAL CHANGES (run separately to test delta sync)
-- =============================================================================
-- This section simulates incremental changes that arrive after the initial load.
-- It adds new records, updates existing records, and simulates soft deletes.
-- Run this section independently (or as apply_incremental_changes.sql) to test
...
-- ---------------------------------------------------------------------------
-- Salesforce: ADD 3 new contacts (need sf-style Id values and a valid AccountId)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- UPDATE existing rows to simulate modifications detected by watermark sync
-- ---------------------------------------------------------------------------
