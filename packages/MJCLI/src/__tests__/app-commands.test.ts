...
describe('app command modules load cleanly', () => {
    ...
    }, 180_000); // these imports pull the whole open-app transitive graph; cold CI transform can
                 // exceed the default timeout (passes in ~2.5s locally with built dists)
});
