...
- 44fca09: Applying a `MaxRows` cap no longer rewrites the caller's SQL on PostgreSQL.
...
- e26c866: Fix keyset (`AfterKey`) pagination returning duplicate rows and silently skipping others.
