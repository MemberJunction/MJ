...
export {
  VerifyHostAssertion, verifyHostAssertion,
  ExtractHostIdentity, extractHostIdentity,
...
export { CreateWidgetHandler, createWidgetHandler, WIDGET_MOUNT_PATH } from './WidgetRouter.js';
