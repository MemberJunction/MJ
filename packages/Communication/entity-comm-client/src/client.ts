import { LogError, Metadata, RunViewParams } from '@memberjunction/global';
import {
...
export class EntityCommunicationsEngineClient extends EntityCommunicationsEngineBase {
   ...
   */
  public override async Config(
    forceRefresh?: boolean,
    contextUser?: import('@memberjunction/global').UserInfo,
    provider?: import('@memberjunction/global').IMetadataProvider
  ): Promise<void> {
