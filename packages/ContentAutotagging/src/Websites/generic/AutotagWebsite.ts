...
export class AutotagWebsite extends AutotagBase {
  ...
  public async SetContentItemsToProcess(contentSources: ContentSourceEntity[]): Promise<ContentItemEntity[]> {
    ...
    for (const contentSource of contentSources) {
      ...
      try {
        ...
        const contentItems: ContentItemEntity[] = await this.SetNewAndModifiedContentItems(
          allContentItemLinks,
          contentSourceParams,
          this.contextUser
        );
   ...
   * @returns
   */
  protected async SetNewAndModifiedContentItems(
    contentItemLinks: string[],
   ...
   * @returns
   */
  protected async getLowerLevelLinks(
    url: string,
    rootURL: string,
    crawlDepth: number,
