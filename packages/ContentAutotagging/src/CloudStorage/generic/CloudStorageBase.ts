...
export abstract class CloudStorageBase extends AutotagBase {
   ...
   */
  public abstract SetNewAndModifiedContentItems(
  ...
  public async Autotag(contextUser: UserInfo): Promise<void> {
    ...
    const contentSources: ContentSourceEntity[] =
      (await this.engine.getAllContentSources(this.contextUser, this.contentSourceTypeID)) || [];
