...
export class ReportListComponent implements OnInit   {
  constructor(public auth: AuthService, private router: Router, private sharedService: SharedService, private elementRef: ElementRef) {}
  ...
  public async Refresh(refreshFromDatabase: boolean = true) {
