...
export const AdvocacyActionSchema = z.object({
    ...
    *   * Testimony`),
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    LegislativeIssue: z.string().describe(`
        * * Field Name: LegislativeIssue
        * * Display Name: Legislative Issue
        * * SQL Data Type: nvarchar(500)`),
    Member: z.string().nullable().describe(`
        ...
        * * Display Name: Member
        * * SQL Data Type: nvarchar(255)`),
    GovernmentContact: z.string().nullable().describe(`
        * * Field Name: GovernmentContact
        * * Display Name: Government Contact
        * * SQL Data Type: nvarchar(100)`),
});
...
export const BoardMemberSchema = z.object({
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    BoardPosition: z.string().describe(`
        * * Field Name: BoardPosition
        * * Display Name: Board Position
        * * SQL Data Type: nvarchar(100)`),
...
export const CertificationRequirementSchema = z.object({
    ...
    *   * Training`),
    ...
    CertificationType: z.string().describe(`
        ...
        * * Display Name: Certification Type Name
        * * SQL Data Type: nvarchar(255)`),
});
...
export const CertificationTypeSchema = z.object({
    ...
    *   * Specialty`),
    ...
    AccreditingBody: z.string().describe(`
        ...
        * * Display Name: Accrediting Body Name
        * * SQL Data Type: nvarchar(255)`),
});
...
export const CommitteeSchema = z.object({
    ...
    *   * Task Force
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    ChairMember: z.string().nullable().describe(`
        * * Field Name: ChairMember
        * * Display Name: Chair Member
        * * SQL Data Type: nvarchar(255)`),
});
...
export const ContinuingEducationSchema = z.object({
    ...
    *   * Rejected`),
    ...
    Member: z.string().describe(`
        ...
        * * Display Name: Member
        * * SQL Data Type: nvarchar(255)`),
    Certification: z.string().nullable().describe(`
        * * Field Name: Certification
        * * Display Name: Certification
        * * SQL Data Type: nvarchar(255)`),
});
...
export const CourseSchema = z.object({
    ...
    *   * Intermediate
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    PrerequisiteCourse: z.string().nullable().describe(`
        * * Field Name: PrerequisiteCourse
        * * Display Name: Prerequisite Course
        * * SQL Data Type: nvarchar(255)`),
...
/**
 * zod schema definition for the entity Cuisine Types
 */
export const CuisineTypeSchema = z.object({
    ID: z.string().describe(`
        ...
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newsequentialid()
        * * Description: Unique identifier for the cuisine type`),
    Name: z.string().describe(`
        * * Field Name: Name
        * * Display Name: Name
        * * SQL Data Type: nvarchar(50)
        * * Description: Name of the cuisine type`),
    Description: z.string().nullable().describe(`
        * * Field Name: Description
        * * Display Name: Description
        * * SQL Data Type: nvarchar(255)
...
export type CuisineTypeEntityType = z.infer<typeof CuisineTypeSchema>;
...
export const EmailClickSchema = z.object({
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    EmailSend: z.string().nullable().describe(`
        * * Field Name: EmailSend
        * * Display Name: Email Send
        * * SQL Data Type: nvarchar(500)`),
});
...
export const ForumCategorySchema = z.object({
    ...
    ParentCategory: z.string().nullable().describe(`
        ...
        * * SQL Data Type: nvarchar(255)`),
    LastPostAuthor: z.string().nullable().describe(`
        * * Field Name: LastPostAuthor
        * * Display Name: Last Post Author
        * * SQL Data Type: nvarchar(255)`),
...
export const ForumModerationSchema = z.object({
    ...
    *   * Reviewing`),
    ...
    ReportedBy: z.string().describe(`
        ...
        * * Display Name: Reported By
        * * SQL Data Type: nvarchar(255)`),
    ModeratedBy: z.string().nullable().describe(`
        * * Field Name: ModeratedBy
        * * Display Name: Moderated By
        * * SQL Data Type: nvarchar(255)`),
});
...
export const ForumPostSchema = z.object({
    ...
    *   * Published`),
    ...
    Thread: z.string().describe(`
        ...
        * * Display Name: Thread
        * * SQL Data Type: nvarchar(500)`),
    ParentPost: z.string().nullable().describe(`
        * * Field Name: ParentPost
        * * Display Name: Parent Post
        * * SQL Data Type: nvarchar(MAX)`),
    Author: z.string().describe(`
        ...
        * * Display Name: Author
        * * SQL Data Type: nvarchar(255)`),
    EditedBy: z.string().nullable().describe(`
        * * Field Name: EditedBy
        * * Display Name: Edited By
        * * SQL Data Type: nvarchar(255)`),
...
export const ForumThreadSchema = z.object({
    ...
    *   * Deleted`),
    ...
    Author: z.string().describe(`
        ...
        * * Display Name: Author
        * * SQL Data Type: nvarchar(255)`),
    LastReplyAuthor: z.string().nullable().describe(`
        * * Field Name: LastReplyAuthor
        * * Display Name: Last Reply Author
        * * SQL Data Type: nvarchar(255)`),
});
...
/**
 * zod schema definition for the entity Group Visit Members
 */
export const GroupVisitMemberSchema = z.object({
    ID: z.string().describe(`
        * * Field Name: ID
        * * Display Name: ID
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newsequentialid()
        * * Description: Unique identifier for the group visit member record`),
    GroupVisitID: z.string().describe(`
        * * Field Name: GroupVisitID
        * * Display Name: Group Visit
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Group Visits (vwGroupVisits.ID)
        * * Description: Foreign key to the GroupVisit table`),
    MemberID: z.string().describe(`
        * * Field Name: MemberID
        * * Display Name: Member
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Members__Foodie (vwMembers__Foodie.ID)
        * * Description: Foreign key to the Member table`),
    AmountPaid: z.number().nullable().describe(`
        * * Field Name: AmountPaid
        * * Display Name: Amount Paid
        * * SQL Data Type: decimal(10, 2)
        * * Description: Amount paid by this member for the group visit`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    GroupVisit: z.string().describe(`
        * * Field Name: GroupVisit
        * * Display Name: Group Visit Name
        * * SQL Data Type: nvarchar(100)`),
    Member: z.string().describe(`
        * * Field Name: Member
...
export type GroupVisitMemberEntityType = z.infer<typeof GroupVisitMemberSchema>;

/**
 * zod schema definition for the entity Group Visits
 */
export const GroupVisitSchema = z.object({
    ID: z.string().describe(`
        ...
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newsequentialid()
        * * Description: Unique identifier for the group visit`),
    Name: z.string().describe(`
        * * Field Name: Name
        * * Display Name: Visit Name
        * * SQL Data Type: nvarchar(100)
        * * Description: Name or description of the group visit event`),
    RestaurantID: z.string().describe(`
        * * Field Name: RestaurantID
        * * Display Name: Restaurant
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Restaurants (vwRestaurants.ID)
        * * Description: Foreign key to the Restaurant table`),
    VisitDate: z.date().describe(`
        * * Field Name: VisitDate
        * * Display Name: Visit Date
        * * SQL Data Type: datetime
        * * Description: Date and time of the group visit`),
    TotalCost: z.number().nullable().describe(`
        * * Field Name: TotalCost
        * * Display Name: Total Cost
        * * SQL Data Type: decimal(10, 2)
        * * Description: Total cost of the group visit`),
    GroupRating: z.number().nullable().describe(`
        * * Field Name: GroupRating
        * * Display Name: Group Rating
        * * SQL Data Type: int
        * * Description: Overall group consensus rating from 1 to 5 stars`),
    Notes: z.string().nullable().describe(`
        * * Field Name: Notes
        * * Display Name: Notes
        * * SQL Data Type: nvarchar(MAX)
        * * Description: Notes about the group visit`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    Restaurant: z.string().describe(`
        * * Field Name: Restaurant
        * * Display Name: Restaurant Name
        * * SQL Data Type: nvarchar(100)`),
});

export type GroupVisitEntityType = z.infer<typeof GroupVisitSchema>;
...
/**
 * zod schema definition for the entity Members__Foodie
 */
export const Member__FoodieSchema = z.object({
    ID: z.string().describe(`
        * * Field Name: ID
        * * Display Name: ID
        * * SQL Data Type: uniqueidentifier
    ...
    JoinDate: z.date().describe(`
        ...
        * * SQL Data Type: datetime
        * * Default Value: getdate()
        * * Description: Date when the member joined the tracking system`),
    DietaryRestrictions: z.string().nullable().describe(`
...
export type Member__FoodieEntityType = z.infer<typeof Member__FoodieSchema>;
...
export const ProductAwardSchema = z.object({
    ...
    Competition: z.string().nullable().describe(`
        ...
        * * Display Name: Competition
        * * SQL Data Type: nvarchar(255)`),
    CompetitionEntry: z.string().nullable().describe(`
        * * Field Name: CompetitionEntry
        * * Display Name: Competition Entry
        * * SQL Data Type: nvarchar(50)`),
});
...
/**
 * zod schema definition for the entity Restaurant Tags
 */
export const RestaurantTagSchema = z.object({
    ID: z.string().describe(`
        ...
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newsequentialid()
        * * Description: Unique identifier for the tag record`),
    RestaurantID: z.string().describe(`
        * * Field Name: RestaurantID
        * * Display Name: Restaurant
        * * SQL Data Type: uniqueidentifier
    ...
    TagName: z.string().describe(`
        ...
        * * Display Name: Tag Name
        * * SQL Data Type: nvarchar(50)
        * * Description: Name of the tag (e.g., Casual Dining, Outdoor Seating, Good for Groups)`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
export type RestaurantTagEntityType = z.infer<typeof RestaurantTagSchema>;

/**
 * zod schema definition for the entity Restaurant Visits
 */
export const RestaurantVisitSchema = z.object({
    ...
    VisitDate: z.date().describe(`
        ...
        * * Display Name: Visit Date
        * * SQL Data Type: datetime
        * * Description: Date and time of the restaurant visit`),
    ...
    Comments: z.string().nullable().describe(`
        ...
        * * SQL Data Type: nvarchar(MAX)
        * * Description: Member comments and review of the visit`),
    DishesOrdered: z.string().nullable().describe(`
        * * Field Name: DishesOrdered
        * * Display Name: Dishes Ordered
        * * SQL Data Type: nvarchar(MAX)
        * * Description: Description of dishes ordered during the visit`),
    WouldReturn: z.boolean().nullable().describe(`
        * * Field Name: WouldReturn
        * * Display Name: Would Return
        * * SQL Data Type: bit
        * * Description: Indicates whether the member would return to this restaurant`),
    PhotoURLs: z.string().nullable().describe(`
        * * Field Name: PhotoURLs
        * * Display Name: Photo URLs
        * * SQL Data Type: nvarchar(MAX)
        * * Description: Comma-separated URLs to photos from the visit`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
export type RestaurantVisitEntityType = z.infer<typeof RestaurantVisitSchema>;

/**
 * zod schema definition for the entity Restaurants
 */
export const RestaurantSchema = z.object({
    ...
    StreetAddress: z.string().nullable().describe(`
    ...
    CuisineTypeID: z.string().nullable().describe(`
        * * Field Name: CuisineTypeID
        * * Display Name: Cuisine Type
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Cuisine Types (vwCuisineTypes.ID)
        * * Description: Foreign key to the CuisineType table`),
    PriceRange: z.union([z.literal('$'), z.literal('$$'), z.literal('$$$'), z.literal('$$$$')]).nullable().describe(`
    ...
    *   * $$$$
    ...
    HoursOfOperation: z.string().nullable().describe(`
        * * Field Name: HoursOfOperation
        * * Display Name: Hours of Operation
        * * SQL Data Type: nvarchar(500)
        * * Description: Hours of operation text (e.g., Mon-Fri 11am-10pm)`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    CuisineType: z.string().nullable().describe(`
        * * Field Name: CuisineType
        * * Display Name: Cuisine
        * * SQL Data Type: nvarchar(50)`),
});

export type RestaurantEntityType = z.infer<typeof RestaurantSchema>;
...
/**
 * zod schema definition for the entity Wish Lists
 */
export const WishListSchema = z.object({
    ID: z.string().describe(`
        ...
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newsequentialid()
        * * Description: Unique identifier for the wishlist entry`),
    RestaurantID: z.string().describe(`
        * * Field Name: RestaurantID
        * * Display Name: Restaurant
        * * SQL Data Type: uniqueidentifier
    ...
    *   * Low
    *   * Medium
        * * Description: Priority level for trying this restaurant (Low, Medium, High)`),
    SuggestedBy: z.string().nullable().describe(`
        * * Field Name: SuggestedBy
        * * Display Name: Suggested By
        * * SQL Data Type: nvarchar(100)
        * * Description: Name of the person who suggested this restaurant`),
    Notes: z.string().nullable().describe(`
        * * Field Name: Notes
        * * Display Name: Notes
        * * SQL Data Type: nvarchar(500)
        * * Description: Additional notes about why this restaurant is on the wishlist`),
    AddedDate: z.date().describe(`
        * * Field Name: AddedDate
        * * Display Name: Added Date
        * * SQL Data Type: datetime
        * * Default Value: getdate()
        * * Description: Date when the restaurant was added to the wishlist`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
export type WishListEntityType = z.infer<typeof WishListSchema>;
...
export class AdvocacyActionEntity extends BaseEntity<AdvocacyActionEntityType> {
    ...
    * * SQL Data Type: nvarchar(500)
    */
    get LegislativeIssue(): string {
        return this.Get('LegislativeIssue');
    }
    ...
    * * SQL Data Type: nvarchar(100)
    */
    get GovernmentContact(): string | null {
        return this.Get('GovernmentContact');
    }
}
...
export class CommitteeEntity extends BaseEntity<CommitteeEntityType> {
    ...
    * * SQL Data Type: nvarchar(255)
    */
    get ChairMember(): string | null {
        return this.Get('ChairMember');
    }
}
...
export class CourseEntity extends BaseEntity<CourseEntityType> {
    ...
    * * SQL Data Type: nvarchar(255)
    */
    get PrerequisiteCourse(): string | null {
        return this.Get('PrerequisiteCourse');
    }
...
/**
 * Cuisine Types - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: CuisineType
 * * Base View: vwCuisineTypes
 * * @description Stores types of cuisine (Italian, Mexican, Japanese, etc.)
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Cuisine Types')
export class CuisineTypeEntity extends BaseEntity<CuisineTypeEntityType> {
    /**
    * Loads the Cuisine Types record from the database
    * @param ID: string - primary key value to load the Cuisine Types record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof CuisineTypeEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
...
export class EmailClickEntity extends BaseEntity<EmailClickEntityType> {
    ...
    * * SQL Data Type: nvarchar(500)
    */
    get EmailSend(): string | null {
        return this.Get('EmailSend');
    }
}
...
export class EnrollmentEntity extends BaseEntity<EnrollmentEntityType> {
    ...
    * * ProgressPercentage: Progress percentage must be between 0 and 100 (inclusive) whenever a value is provided. This ensures recorded progress stays within a valid range and prevents impossible percentages.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * Progress percentage must be between 0 and 100 (inclusive) whenever a value is provided. This ensures recorded progress stays within a valid range and prevents impossible percentages.
...
export class ForumCategoryEntity extends BaseEntity<ForumCategoryEntityType> {
    ...
    * * SQL Data Type: nvarchar(255)
    */
    get LastPostAuthor(): string | null {
        return this.Get('LastPostAuthor');
    }
...
export class ForumPostEntity extends BaseEntity<ForumPostEntityType> {
    ...
    * * SQL Data Type: nvarchar(MAX)
    */
    get ParentPost(): string | null {
        return this.Get('ParentPost');
    }
...
export class ForumThreadEntity extends BaseEntity<ForumThreadEntityType> {
    ...
    */
    get LastReplyAuthor(): string | null {
        return this.Get('LastReplyAuthor');
    }
}
...
/**
 * Group Visit Members - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: GroupVisitMember
 * * Base View: vwGroupVisitMembers
 * * @description Junction table linking members to group visits with payment tracking
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Group Visit Members')
export class GroupVisitMemberEntity extends BaseEntity<GroupVisitMemberEntityType> {
    /**
    * Loads the Group Visit Members record from the database
    * @param ID: string - primary key value to load the Group Visit Members record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof GroupVisitMemberEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    * * Description: Foreign key to the GroupVisit table
    */
    get GroupVisitID(): string {
        return this.Get('GroupVisitID');
    }
    set GroupVisitID(value: string) {
        this.Set('GroupVisitID', value);
    }
    ...
    * * SQL Data Type: nvarchar(100)
    */
    get GroupVisit(): string {
        return this.Get('GroupVisit');
    }
...
/**
 * Group Visits - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: GroupVisit
 * * Base View: vwGroupVisits
 * * @description Stores information about group visits to restaurants
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Group Visits')
export class GroupVisitEntity extends BaseEntity<GroupVisitEntityType> {
    /**
    * Loads the Group Visits record from the database
    * @param ID: string - primary key value to load the Group Visits record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof GroupVisitEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    /**
    * Validate() method override for Group Visits entity. This is an auto-generated method that invokes the generated validators for this entity for the following fields:
    * * GroupRating: If a group rating is entered, it must be a whole number between 1 and 5, ensuring ratings stay within the allowed scale.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateGroupRatingRange(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * If a group rating is entered, it must be a whole number between 1 and 5, ensuring ratings stay within the allowed scale.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateGroupRatingRange(result: ValidationResult) {
    ...
    */
    ...
    set VisitDate(value: Date) {
        this.Set('VisitDate', value);
    }
    ...
    * * Description: Overall group consensus rating from 1 to 5 stars
    */
    get GroupRating(): number | null {
        return this.Get('GroupRating');
    }
    set GroupRating(value: number | null) {
        this.Set('GroupRating', value);
    }
...
/**
 * Members__Foodie - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: Member
 * * Base View: vwMembers__Foodie
 * * @description Stores information about members who track restaurants
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Members__Foodie')
export class Member__FoodieEntity extends BaseEntity<Member__FoodieEntityType> {
    /**
    * Loads the Members__Foodie record from the database
    * @param ID: string - primary key value to load the Members__Foodie record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof Member__FoodieEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    */
    ...
    set DietaryRestrictions(value: string | null) {
        this.Set('DietaryRestrictions', value);
    }
...
export class ProductAwardEntity extends BaseEntity<ProductAwardEntityType> {
    ...
    * * SQL Data Type: nvarchar(50)
    */
    get CompetitionEntry(): string | null {
        return this.Get('CompetitionEntry');
    }
}
...
export class ResourceRatingEntity extends BaseEntity<ResourceRatingEntityType> {
    ...
    * * Rating: Each review's Rating must be a whole number from 1 to 5; values lower than 1 or higher than 5 are not allowed, ensuring only valid rating scores are stored.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * Each review's Rating must be a whole number from 1 to 5; values lower than 1 or higher than 5 are not allowed, ensuring only valid rating scores are stored.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
/**
 * Restaurant Tags - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: RestaurantTag
 * * Base View: vwRestaurantTags
 * * @description Stores tags and categories for restaurants (casual dining, outdoor seating, etc.)
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Restaurant Tags')
export class RestaurantTagEntity extends BaseEntity<RestaurantTagEntityType> {
    /**
    * Loads the Restaurant Tags record from the database
    * @param ID: string - primary key value to load the Restaurant Tags record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof RestaurantTagEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
...
/**
 * Restaurant Visits - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: RestaurantVisit
 * * Base View: vwRestaurantVisits
 * * @description Stores individual member visits to restaurants with ratings and reviews
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Restaurant Visits')
export class RestaurantVisitEntity extends BaseEntity<RestaurantVisitEntityType> {
    /**
    * Loads the Restaurant Visits record from the database
    * @param ID: string - primary key value to load the Restaurant Visits record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof RestaurantVisitEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    /**
    * Validate() method override for Restaurant Visits entity. This is an auto-generated method that invokes the generated validators for this entity for the following fields:
    * * Rating: Rating must be a value from 1 to 5 if a rating is provided. This ensures that every recorded rating stays within the allowed 1‑to‑5 scale.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * Rating must be a value from 1 to 5 if a rating is provided. This ensures that every recorded rating stays within the allowed 1‑to‑5 scale.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    ...
    * * Description: Description of dishes ordered during the visit
    */
    get DishesOrdered(): string | null {
        return this.Get('DishesOrdered');
    }
    set DishesOrdered(value: string | null) {
        this.Set('DishesOrdered', value);
    }
    ...
    * * Description: Indicates whether the member would return to this restaurant
    */
    get WouldReturn(): boolean | null {
        return this.Get('WouldReturn');
    }
    set WouldReturn(value: boolean | null) {
        this.Set('WouldReturn', value);
    }
    ...
    * * Description: Comma-separated URLs to photos from the visit
    */
    get PhotoURLs(): string | null {
        return this.Get('PhotoURLs');
    }
    set PhotoURLs(value: string | null) {
...
/**
 * Restaurants - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: Restaurant
 * * Base View: vwRestaurants
...
export class RestaurantEntity extends BaseEntity<RestaurantEntityType> {
    /**
    * Loads the Restaurants record from the database
    * @param ID: string - primary key value to load the Restaurants record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    ...
    */
    ...
    set StreetAddress(value: string | null) {
    ...
    * * Description: Foreign key to the CuisineType table
    */
    get CuisineTypeID(): string | null {
        return this.Get('CuisineTypeID');
    }
    set CuisineTypeID(value: string | null) {
        this.Set('CuisineTypeID', value);
    }
    ...
    * * Description: Hours of operation text (e.g., Mon-Fri 11am-10pm)
    */
    get HoursOfOperation(): string | null {
        return this.Get('HoursOfOperation');
    }
    set HoursOfOperation(value: string | null) {
        this.Set('HoursOfOperation', value);
    }
...
/**
 * Wish Lists - strongly typed entity sub-class
 * * Schema: Foodie
 * * Base Table: WishList
 * * Base View: vwWishLists
 * * @description Stores restaurants that members want to try in the future
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Wish Lists')
export class WishListEntity extends BaseEntity<WishListEntityType> {
    /**
    * Loads the Wish Lists record from the database
    * @param ID: string - primary key value to load the Wish Lists record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof WishListEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    * * Description: Name of the person who suggested this restaurant
    */
    get SuggestedBy(): string | null {
        return this.Get('SuggestedBy');
    }
    set SuggestedBy(value: string | null) {
        this.Set('SuggestedBy', value);
    }
