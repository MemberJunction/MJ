...
/**
 * zod schema definition for the entity Listening Histories
 */
export const ListeningHistorySchema = z.object({
    ...
    UserID: z.string().describe(`
        ...
        * * Description: User who listened to the song.`),
    SongID: z.string().describe(`
        * * Field Name: SongID
        * * Display Name: Song ID
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Songs (vwSongs.ID)
        * * Description: Song that was listened to.`),
    ListenedAt: z.date().describe(`
        * * Field Name: ListenedAt
        * * Display Name: Listened At
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()
        * * Description: Timestamp when the song was listened to.`),
    PlayDuration: z.number().nullable().describe(`
        * * Field Name: PlayDuration
        * * Display Name: Play Duration
        * * SQL Data Type: int
        * * Description: How long the user listened in seconds (may be less than song duration).`),
    CompletionPercentage: z.number().nullable().describe(`
        * * Field Name: CompletionPercentage
        * * Display Name: Completion Percentage
        * * SQL Data Type: decimal(5, 2)
        * * Description: Percentage of the song that was played (0-100).`),
    Source: z.union([z.literal('Desktop'), z.literal('Mobile'), z.literal('Other'), z.literal('Web')]).nullable().describe(`
        * * Field Name: Source
        * * Display Name: Source
        * * SQL Data Type: nvarchar(50)
    * * Value List Type: List
    ...
    *   * Other
    *   * Web
        * * Description: Platform where the song was played (Web, Mobile, Desktop, Other).`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
export type ListeningHistoryEntityType = z.infer<typeof ListeningHistorySchema>;
...
/**
 * zod schema definition for the entity Playlist Songs
 */
export const PlaylistSongSchema = z.object({
    ...
    SequenceNumber: z.number().describe(`
        * * Field Name: SequenceNumber
        * * Display Name: Sequence Number
        * * SQL Data Type: int
        * * Description: Order of the song in the playlist (starting from 1).`),
    AddedFromWeb: z.boolean().describe(`
        * * Field Name: AddedFromWeb
        * * Display Name: Added From Web
        * * SQL Data Type: bit
        * * Default Value: 0
        * * Description: Whether this song was discovered via web search by an AI agent.`),
    PopularityReason: z.string().nullable().describe(`
        * * Field Name: PopularityReason
        * * Display Name: Popularity Reason
        * * SQL Data Type: nvarchar(500)
        * * Description: Reason why this song was included (e.g., "Currently #3 on Billboard Hot 100").`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
export type PlaylistSongEntityType = z.infer<typeof PlaylistSongSchema>;

/**
 * zod schema definition for the entity Playlists
 */
export const PlaylistSchema = z.object({
    ...
    Description: z.string().nullable().describe(`
        ...
        * * Display Name: Description
        * * SQL Data Type: nvarchar(MAX)
        * * Description: Optional description of the playlist theme or purpose.`),
    Genre: z.string().nullable().describe(`
        * * Field Name: Genre
        * * Display Name: Genre
        * * SQL Data Type: nvarchar(100)
        * * Description: Primary genre of songs in this playlist.`),
    CreatedByAI: z.boolean().describe(`
        * * Field Name: CreatedByAI
        * * Display Name: Created By AI
        * * SQL Data Type: bit
        * * Default Value: 1
        * * Description: Indicates whether this playlist was created by an AI agent.`),
    AIGenerationNotes: z.string().nullable().describe(`
        * * Field Name: AIGenerationNotes
        * * Display Name: AI Generation Notes
        * * SQL Data Type: nvarchar(MAX)
        * * Description: Notes from the AI agent about how the playlist was curated.`),
    IsPublic: z.boolean().describe(`
        * * Field Name: IsPublic
        * * Display Name: Is Public
        * * SQL Data Type: bit
        * * Default Value: 0
        * * Description: Whether this playlist is visible to other users.`),
    TotalDuration: z.number().nullable().describe(`
...
export type PlaylistEntityType = z.infer<typeof PlaylistSchema>;
...
/**
 * zod schema definition for the entity Song Journals
 */
export const SongJournalSchema = z.object({
    ID: z.string().describe(`
        * * Field Name: ID
        * * Display Name: ID
        * * SQL Data Type: uniqueidentifier
    ...
    UserID: z.string().describe(`
        ...
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Users (vwUsers.ID)
        * * Description: User who wrote the journal entry`),
    SongID: z.string().describe(`
        * * Field Name: SongID
        * * Display Name: Song
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Songs (vwSongs.ID)
        * * Description: Song the journal entry is about`),
    JournalEntry: z.string().describe(`
        * * Field Name: JournalEntry
        * * Display Name: Journal Entry
        * * SQL Data Type: nvarchar(MAX)
        * * Description: User written reflection describing how the song made them feel`),
    ReflectionYear: z.number().describe(`
        * * Field Name: ReflectionYear
        * * Display Name: Reflection Year
        * * SQL Data Type: int
        * * Description: Year the song was most listened to (e.g., 2024)`),
    ReflectionMonth: z.number().describe(`
        * * Field Name: ReflectionMonth
        * * Display Name: Reflection Month
        * * SQL Data Type: int
        * * Description: Month the song was most listened to (1-12)`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    DetectedEmotion: z.string().nullable().describe(`
        * * Field Name: DetectedEmotion
        * * Display Name: Detected Emotion
        * * SQL Data Type: nvarchar(100)
        * * Description: AI-detected emotion from the journal entry (e.g., Joy, Nostalgia, Melancholy, Energy, Peace, Love)`),
    User: z.string().describe(`
        * * Field Name: User
...
export type SongJournalEntityType = z.infer<typeof SongJournalSchema>;

/**
 * zod schema definition for the entity Songs
 */
export const SongSchema = z.object({
    ...
    Artist: z.string().describe(`
        * * Field Name: Artist
        * * Display Name: Artist
        * * SQL Data Type: nvarchar(255)
        * * Description: Name of the artist or band.`),
    Album: z.string().nullable().describe(`
        * * Field Name: Album
        * * Display Name: Album
        * * SQL Data Type: nvarchar(255)
    ...
    ReleaseYear: z.number().nullable().describe(`
        * * Field Name: ReleaseYear
        * * Display Name: Release Year
        * * SQL Data Type: int
        * * Description: Year the song was released.`),
    SpotifyID: z.string().nullable().describe(`
        * * Field Name: SpotifyID
        * * Display Name: Spotify ID
        * * SQL Data Type: nvarchar(100)
        * * Description: Spotify unique identifier for the track.`),
    AlbumArtURL: z.string().nullable().describe(`
...
export type SongEntityType = z.infer<typeof SongSchema>;

/**
 * zod schema definition for the entity User Year Summaries
 */
export const UserYearSummarySchema = z.object({
    ID: z.string().describe(`
        * * Field Name: ID
        * * Display Name: ID
        * * SQL Data Type: uniqueidentifier
    ...
    Year: z.number().describe(`
        ...
        * * Display Name: Year
        * * SQL Data Type: int
        * * Description: Year this summary covers.`),
    TotalListens: z.number().describe(`
        * * Field Name: TotalListens
        * * Display Name: Total Listens
        * * SQL Data Type: int
        * * Default Value: 0
        * * Description: Total number of songs listened to during the year.`),
    TotalMinutesListened: z.number().describe(`
        * * Field Name: TotalMinutesListened
        * * Display Name: Total Minutes Listened
        * * SQL Data Type: int
        * * Default Value: 0
        * * Description: Total minutes spent listening to music during the year.`),
    UniqueArtists: z.number().describe(`
        * * Field Name: UniqueArtists
        * * Display Name: Unique Artists
        * * SQL Data Type: int
        * * Default Value: 0
        * * Description: Number of different artists listened to during the year.`),
    UniqueSongs: z.number().describe(`
        * * Field Name: UniqueSongs
        * * Display Name: Unique Songs
        * * SQL Data Type: int
        * * Default Value: 0
        * * Description: Number of different songs listened to during the year.`),
    TopGenre: z.string().nullable().describe(`
        * * Field Name: TopGenre
        * * Display Name: Top Genre
        * * SQL Data Type: nvarchar(100)
        * * Description: Most frequently listened to genre during the year.`),
    TopArtist: z.string().nullable().describe(`
        * * Field Name: TopArtist
        * * Display Name: Top Artist
        * * SQL Data Type: nvarchar(255)
        * * Description: Most frequently listened to artist during the year.`),
    TopSong: z.string().nullable().describe(`
        * * Field Name: TopSong
        * * Display Name: Top Song
        * * SQL Data Type: nvarchar(255)
        * * Description: Most frequently listened to song during the year.`),
    SummaryData: z.string().nullable().describe(`
        * * Field Name: SummaryData
        * * Display Name: Summary Data
        * * SQL Data Type: nvarchar(MAX)
        * * Description: JSON blob containing additional summary data and statistics.`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
export type UserYearSummaryEntityType = z.infer<typeof UserYearSummarySchema>;
...
export class EnrollmentEntity extends BaseEntity<EnrollmentEntityType> {
    ...
    * * ProgressPercentage: Progress percentage, when provided, must be a value from 0 to 100. This ensures progress tracking stays within a realistic range and prevents invalid negative or overly large percentages.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * Progress percentage, when provided, must be a value from 0 to 100. This ensures progress tracking stays within a realistic range and prevents invalid negative or overly large percentages.
...
/**
 * Listening Histories - strongly typed entity sub-class
 * * Schema: spotify
 * * Base Table: ListeningHistory
 * * Base View: vwListeningHistories
 * * @description Tracks each time a user listens to a song.
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Listening Histories')
export class ListeningHistoryEntity extends BaseEntity<ListeningHistoryEntityType> {
    /**
    * Loads the Listening Histories record from the database
    * @param ID: string - primary key value to load the Listening Histories record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof ListeningHistoryEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    /**
    * Validate() method override for Listening Histories entity. This is an auto-generated method that invokes the generated validators for this entity for the following fields:
    * * CompletionPercentage: Completion percentage must be between 0 and 100 when provided, ensuring the recorded listening progress is valid.
    * * PlayDuration: Play duration must be zero or greater; negative values are not allowed when a duration is recorded.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateCompletionPercentageRange(result);
        this.ValidatePlayDurationNonNegative(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * Completion percentage must be between 0 and 100 when provided, ensuring the recorded listening progress is valid.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateCompletionPercentageRange(result: ValidationResult) {
    ...
    /**
    * Play duration must be zero or greater; negative values are not allowed when a duration is recorded.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidatePlayDurationNonNegative(result: ValidationResult) {
    ...
    */
    get ListenedAt(): Date {
        return this.Get('ListenedAt');
    }
    set ListenedAt(value: Date) {
        this.Set('ListenedAt', value);
    }
    ...
    * * Description: How long the user listened in seconds (may be less than song duration).
    */
    get PlayDuration(): number | null {
        return this.Get('PlayDuration');
    }
    set PlayDuration(value: number | null) {
        this.Set('PlayDuration', value);
    }
    ...
    */
    get CompletionPercentage(): number | null {
        return this.Get('CompletionPercentage');
    }
    set CompletionPercentage(value: number | null) {
        this.Set('CompletionPercentage', value);
    }
    ...
    * * Description: Platform where the song was played (Web, Mobile, Desktop, Other).
    */
    get Source(): 'Desktop' | 'Mobile' | 'Other' | 'Web' | null {
        return this.Get('Source');
    }
    set Source(value: 'Desktop' | 'Mobile' | 'Other' | 'Web' | null) {
...
/**
 * Playlist Songs - strongly typed entity sub-class
 * * Schema: spotify
 * * Base Table: PlaylistSong
 * * Base View: vwPlaylistSongs
 * * @description Junction table linking playlists to songs with ordering.
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Playlist Songs')
export class PlaylistSongEntity extends BaseEntity<PlaylistSongEntityType> {
    /**
    * Loads the Playlist Songs record from the database
    * @param ID: string - primary key value to load the Playlist Songs record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof PlaylistSongEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    * * Description: Whether this song was discovered via web search by an AI agent.
    */
    get AddedFromWeb(): boolean {
        return this.Get('AddedFromWeb');
    }
    set AddedFromWeb(value: boolean) {
        this.Set('AddedFromWeb', value);
    }
    ...
    * * Description: Reason why this song was included (e.g., "Currently #3 on Billboard Hot 100").
    */
    get PopularityReason(): string | null {
        return this.Get('PopularityReason');
    }
    set PopularityReason(value: string | null) {
        this.Set('PopularityReason', value);
    }
...
/**
 * Playlists - strongly typed entity sub-class
 * * Schema: spotify
 * * Base Table: Playlist
 * * Base View: vwPlaylists
 * * @description Stores user-created or AI-generated music playlists.
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Playlists')
export class PlaylistEntity extends BaseEntity<PlaylistEntityType> {
    /**
    * Loads the Playlists record from the database
    * @param ID: string - primary key value to load the Playlists record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof PlaylistEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    * * Description: Indicates whether this playlist was created by an AI agent.
    */
    get CreatedByAI(): boolean {
        return this.Get('CreatedByAI');
    }
    set CreatedByAI(value: boolean) {
        this.Set('CreatedByAI', value);
    }
    ...
    * * Description: Notes from the AI agent about how the playlist was curated.
    */
    get AIGenerationNotes(): string | null {
        return this.Get('AIGenerationNotes');
    }
    set AIGenerationNotes(value: string | null) {
        this.Set('AIGenerationNotes', value);
    }
    ...
    */
    ...
    set TotalDuration(value: number | null) {
        this.Set('TotalDuration', value);
    }
...
export class ResourceRatingEntity extends BaseEntity<ResourceRatingEntityType> {
    ...
    * * Rating: Rating must be a whole number from 1 (lowest) to 5 (highest) for each review, ensuring consistent scoring.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * Rating must be a whole number from 1 (lowest) to 5 (highest) for each review, ensuring consistent scoring.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
/**
 * Song Journals - strongly typed entity sub-class
 * * Schema: spotify
 * * Base Table: SongJournal
 * * Base View: vwSongJournals
 * * @description User journal entries reflecting on emotional connection to songs
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
...
export class SongJournalEntity extends BaseEntity<SongJournalEntityType> {
    /**
    * Loads the Song Journals record from the database
    * @param ID: string - primary key value to load the Song Journals record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof SongJournalEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    /**
    * Validate() method override for Song Journals entity. This is an auto-generated method that invokes the generated validators for this entity for the following fields:
    * * ReflectionMonth: Reflection month must be a valid month number between 1 and 12. This ensures that each reflection is recorded for an actual calendar month and prevents invalid month values from being stored.
    * * ReflectionYear: Reflection year must be between 2020 and 2100 inclusive, ensuring that reflections are recorded only for realistic years and preventing future or overly old dates.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateReflectionMonthRange(result);
        this.ValidateReflectionYearRange(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * Reflection month must be a valid month number between 1 and 12. This ensures that each reflection is recorded for an actual calendar month and prevents invalid month values from being stored.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateReflectionMonthRange(result: ValidationResult) {
    ...
    /**
    * Reflection year must be between 2020 and 2100 inclusive, ensuring that reflections are recorded only for realistic years and preventing future or overly old dates.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateReflectionYearRange(result: ValidationResult) {
    ...
    */
    ...
    set JournalEntry(value: string) {
        this.Set('JournalEntry', value);
    }
    ...
    * * Description: Year the song was most listened to (e.g., 2024)
    */
    get ReflectionYear(): number {
        return this.Get('ReflectionYear');
    }
    set ReflectionYear(value: number) {
        this.Set('ReflectionYear', value);
    }
    ...
    * * Description: Month the song was most listened to (1-12)
    */
    get ReflectionMonth(): number {
        return this.Get('ReflectionMonth');
    }
    set ReflectionMonth(value: number) {
        this.Set('ReflectionMonth', value);
    }
    ...
    * * Description: AI-detected emotion from the journal entry (e.g., Joy, Nostalgia, Melancholy, Energy, Peace, Love)
    */
    get DetectedEmotion(): string | null {
        return this.Get('DetectedEmotion');
    }
    set DetectedEmotion(value: string | null) {
        this.Set('DetectedEmotion', value);
    }
...
/**
 * Songs - strongly typed entity sub-class
 * * Schema: spotify
 * * Base Table: Song
 * * Base View: vwSongs
 * * @description Stores information about songs in the music library.
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Songs')
export class SongEntity extends BaseEntity<SongEntityType> {
    /**
    * Loads the Songs record from the database
    * @param ID: string - primary key value to load the Songs record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    ...
    */
    ...
    /**
    * Validate() method override for Songs entity. This is an auto-generated method that invokes the generated validators for this entity for the following fields:
    * * Duration: Duration must be greater than zero, ensuring each track has a positive length.
    * * ReleaseYear: Release year must be a realistic value: if a year is provided, it must be between 1900 and 2100 inclusive.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateDurationGreaterThanZero(result);
        this.ValidateReleaseYearRange(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * Duration must be greater than zero, ensuring each track has a positive length.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateDurationGreaterThanZero(result: ValidationResult) {
    	if (this.Duration <= 0) {
    		result.Errors.push(new ValidationErrorInfo(
    			"Duration",
    ...
    /**
    * Release year must be a realistic value: if a year is provided, it must be between 1900 and 2100 inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateReleaseYearRange(result: ValidationResult) {
    ...
    */
    ...
    set ReleaseYear(value: number | null) {
        this.Set('ReleaseYear', value);
    }
    ...
    */
    get SpotifyID(): string | null {
        return this.Get('SpotifyID');
    }
    set SpotifyID(value: string | null) {
        this.Set('SpotifyID', value);
    }
    ...
    * * Description: URL to the album artwork image.
    */
    get AlbumArtURL(): string | null {
        return this.Get('AlbumArtURL');
    }
    set AlbumArtURL(value: string | null) {
        this.Set('AlbumArtURL', value);
    }
...
/**
 * User Year Summaries - strongly typed entity sub-class
 * * Schema: spotify
 * * Base Table: UserYearSummary
 * * Base View: vwUserYearSummaries
 * * @description Stores annual "Wrapped" summary statistics for each user.
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'User Year Summaries')
export class UserYearSummaryEntity extends BaseEntity<UserYearSummaryEntityType> {
    /**
    * Loads the User Year Summaries record from the database
    * @param ID: string - primary key value to load the User Year Summaries record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof UserYearSummaryEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateTotalListensNonNegative(result);
        this.ValidateTotalMinutesListenedGreaterThanOrEqualZero(result);
        this.ValidateUniqueArtistsGreaterOrEqualZero(result);
        this.ValidateUniqueSongsNonNegative(result);
        this.ValidateYearRange(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    * @method
    */
    public ValidateTotalListensNonNegative(result: ValidationResult) {
    ...
    /**
    * Total minutes listened must be zero or more; negative values are not allowed.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateTotalMinutesListenedGreaterThanOrEqualZero(result: ValidationResult) {
    ...
    * @method
    */
    public ValidateUniqueArtistsGreaterOrEqualZero(result: ValidationResult) {
    ...
    /**
    * UniqueSongs must be zero or a positive number, ensuring the count of distinct songs a user has cannot be negative, which keeps the listening statistics logically correct
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateUniqueSongsNonNegative(result: ValidationResult) {
    ...
    /**
    * Year must be between 2020 and 2100 inclusive, ensuring that only valid reporting years are recorded in the system
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateYearRange(result: ValidationResult) {
    ...
    * * Description: Total number of songs listened to during the year.
    */
    get TotalListens(): number {
        return this.Get('TotalListens');
    }
    set TotalListens(value: number) {
        this.Set('TotalListens', value);
    }
    ...
    * * Description: Total minutes spent listening to music during the year.
    */
    get TotalMinutesListened(): number {
        return this.Get('TotalMinutesListened');
    }
    set TotalMinutesListened(value: number) {
        this.Set('TotalMinutesListened', value);
    }
    ...
    */
    get UniqueArtists(): number {
        return this.Get('UniqueArtists');
    }
    set UniqueArtists(value: number) {
        this.Set('UniqueArtists', value);
    }
    ...
    * * Description: Number of different songs listened to during the year.
    */
    get UniqueSongs(): number {
        return this.Get('UniqueSongs');
    }
    set UniqueSongs(value: number) {
        this.Set('UniqueSongs', value);
    }
    ...
    */
    get TopGenre(): string | null {
        return this.Get('TopGenre');
    }
    set TopGenre(value: string | null) {
        this.Set('TopGenre', value);
    }
    ...
    */
    get TopArtist(): string | null {
        return this.Get('TopArtist');
    }
    set TopArtist(value: string | null) {
        this.Set('TopArtist', value);
    }
    ...
    */
    get TopSong(): string | null {
        return this.Get('TopSong');
    }
    set TopSong(value: string | null) {
        this.Set('TopSong', value);
    }
    ...
    * * Description: JSON blob containing additional summary data and statistics.
    */
    get SummaryData(): string | null {
        return this.Get('SummaryData');
    }
    set SummaryData(value: string | null) {
        this.Set('SummaryData', value);
    }
