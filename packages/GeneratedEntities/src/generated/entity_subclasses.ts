...
export class AccountInsightEntity extends BaseEntity<AccountInsightEntityType> {
    ...
    * * Priority: This rule ensures that if a priority is provided, it must be either 'Low', 'Medium', or 'High'. It can also be left blank.
    * * Sentiment: This rule ensures that if a sentiment is specified, it must be one of the following values: 'Mixed', 'Neutral', 'Negative', or 'Positive'. The sentiment field may also be left empty.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that if a priority is provided, it must be either 'Low', 'Medium', or 'High'. It can also be left blank.
    ...
    */
    public ValidatePriorityAllowedValues(result: ValidationResult) {
    	if (this.Priority != null && this.Priority !== "Low" && this.Priority !== "Medium" && this.Priority !== "High") {
    		result.Errors.push(new ValidationErrorInfo("Priority", "Priority must be either 'Low', 'Medium', or 'High'.", this.Priority, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that if a sentiment is specified, it must be one of the following values: 'Mixed', 'Neutral', 'Negative', or 'Positive'. The sentiment field may also be left empty.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateSentimentAllowedValues(result: ValidationResult) {
    	if (this.Sentiment != null 
    		...
    		result.Errors.push(new ValidationErrorInfo("Sentiment", "If a sentiment is provided, it must be either 'Mixed', 'Neutral', 'Negative', or 'Positive'.", this.Sentiment, ValidationErrorType.Failure));
    	}
    }
...
export class AccountEntity extends BaseEntity<AccountEntityType> {
    ...
    * * Exchange: This rule ensures that if an exchange is specified, it must be one of the allowed values: 'Other', 'SSE', 'HKEX', 'TSE', 'LSE', 'AMEX', 'NASDAQ', or 'NYSE'. If the exchange is not set, it can be left blank.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateExchangeAllowedValues(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if an exchange is specified, it must be one of the allowed values: 'Other', 'SSE', 'HKEX', 'TSE', 'LSE', 'AMEX', 'NASDAQ', or 'NYSE'. If the exchange is not set, it can be left blank.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateExchangeAllowedValues(result: ValidationResult) {
    	const allowed = ["Other", "SSE", "HKEX", "TSE", "LSE", "AMEX", "NASDAQ", "NYSE"];
    	if (this.Exchange != null && allowed.indexOf(this.Exchange) === -1) {
    		result.Errors.push(new ValidationErrorInfo("Exchange", "Exchange must be one of: Other, SSE, HKEX, TSE, LSE, AMEX, NASDAQ, NYSE.", this.Exchange, ValidationErrorType.Failure));
    	}
    }
...
export class ContactRelationshipEntity extends BaseEntity<ContactRelationshipEntityType> {
    ...
    * * Table-Level: This rule ensures that if an end date is provided, it must be the same as or come after the start date. If no end date is given, this rule does not apply.
    * * Table-Level: This rule ensures that the Primary Contact and the Related Contact cannot be the same person.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that if an end date is provided, it must be the same as or come after the start date. If no end date is given, this rule does not apply.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    ...
    /**
    * This rule ensures that the Primary Contact and the Related Contact cannot be the same person.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidatePrimaryContactIDNotEqualRelatedContactID(result: ValidationResult) {
    	if (this.PrimaryContactID === this.RelatedContactID) {
    		result.Errors.push(new ValidationErrorInfo("PrimaryContactID", "The primary contact and the related contact must be different.", this.PrimaryContactID, ValidationErrorType.Failure));
    	}
    }
...
export class DealProductEntity extends BaseEntity<DealProductEntityType> {
    ...
    * * Discount: This rule ensures that if a discount is specified, it must be between 0 and 100 percent.
    * * Quantity: This rule ensures that the quantity for each record must be greater than zero.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that if a discount is specified, it must be between 0 and 100 percent.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    ...
    /**
    * This rule ensures that the quantity for each record must be greater than zero.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class DealEntity extends BaseEntity<DealEntityType> {
    ...
    * * Probability: This rule ensures that, if specified, the Probability value must be between 0 and 100, inclusive.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateProbabilityBetween0And100(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that, if specified, the Probability value must be between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateProbabilityBetween0And100(result: ValidationResult) {
...
export class EventEntity extends BaseEntity<EventEntityType> {
    ...
    * * BaselinePassingScore: This rule ensures that if a baseline passing score is specified, it must be a number between 0 and 100.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateBaselinePassingScoreBetweenZeroAndHundred(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if a baseline passing score is specified, it must be a number between 0 and 100.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateBaselinePassingScoreBetweenZeroAndHundred(result: ValidationResult) {
...
export class InvoiceLineItemEntity extends BaseEntity<InvoiceLineItemEntityType> {
    ...
    * * Discount: This rule ensures that if a discount is specified for an invoice item, it must be a value between 0 and 100, inclusive.
    * * Quantity: This rule ensures that the quantity value must always be greater than zero for every record.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that if a discount is specified for an invoice item, it must be a value between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateDiscountBetween0And100(result: ValidationResult) {
    	if (this.Discount != null && (this.Discount < 0 || this.Discount > 100)) {
    		result.Errors.push(new ValidationErrorInfo("Discount", "The discount must be between 0 and 100 percent.", this.Discount, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the quantity value must always be greater than zero for every record.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class InvoiceEntity extends BaseEntity<InvoiceEntityType> {
    ...
    * * TaxRate: This rule ensures that if a tax rate is specified, it must be between 0 and 100 inclusive.
    * * Table-Level: This rule ensures that the due date for an invoice cannot be earlier than the invoice date.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        ...
        this.ValidateDueDateNotEarlierThanInvoiceDate(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if a tax rate is specified, it must be between 0 and 100 inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    ...
    /**
    * This rule ensures that the due date for an invoice cannot be earlier than the invoice date.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateDueDateNotEarlierThanInvoiceDate(result: ValidationResult) {
    	if (this.DueDate < this.InvoiceDate) {
    		result.Errors.push(new ValidationErrorInfo("DueDate", "The due date cannot be earlier than the invoice date.", this.DueDate, ValidationErrorType.Failure));
    	}
    }
...
export class ProductEntity extends BaseEntity<ProductEntityType> {
    ...
    * * RecurringBillingPeriod: This rule ensures that if a recurring billing period is entered, it must be either 'Biannual', 'Annual', 'Quarterly', or 'Monthly'. The field can also be left blank.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that if a recurring billing period is entered, it must be either 'Biannual', 'Annual', 'Quarterly', or 'Monthly'. The field can also be left blank.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateRecurringBillingPeriodAllowedValues(result: ValidationResult) {
    	if (this.RecurringBillingPeriod != null &&
    		...
    		result.Errors.push(new ValidationErrorInfo("RecurringBillingPeriod", "Recurring billing period, if specified, must be one of: 'Biannual', 'Annual', 'Quarterly', or 'Monthly'.", this.RecurringBillingPeriod, ValidationErrorType.Failure));
    	}
    }
...
export class SpeakerEntity extends BaseEntity<SpeakerEntityType> {
    ...
    * * CredibilityScore: This rule ensures that the Credibility Score, if provided, must be between 0 and 100.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateCredibilityScoreIsWithinRange(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that the Credibility Score, if provided, must be between 0 and 100.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateCredibilityScoreIsWithinRange(result: ValidationResult) {
...
export class SubmissionReviewEntity extends BaseEntity<SubmissionReviewEntityType> {
    ...
    * * QualityScore: This rule ensures that if a quality score is entered, it must be a number between 0 and 10, inclusive.
    * * RelevanceScore: This rule ensures that if a relevance score is provided, it must be a number between 0 and 10, inclusive.
    * * SpeakerExperienceScore: This rule ensures that if a score for speaker experience is provided, it must be between 0 and 10.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateOverallScoreBetween0And10(result);
        this.ValidateQualityScoreBetweenZeroAndTen(result);
        this.ValidateRelevanceScoreInRange(result);
        this.ValidateSpeakerExperienceScoreWithinRange(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    * @method
    */
    public ValidateOverallScoreBetween0And10(result: ValidationResult) {
    	if (this.OverallScore != null && (this.OverallScore < 0 || this.OverallScore > 10)) {
    		result.Errors.push(new ValidationErrorInfo("OverallScore", "Overall Score must be between 0 and 10 if provided.", this.OverallScore, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that if a quality score is entered, it must be a number between 0 and 10, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    ...
    /**
    * This rule ensures that if a relevance score is provided, it must be a number between 0 and 10, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateRelevanceScoreInRange(result: ValidationResult) {
    ...
    /**
    * This rule ensures that if a score for speaker experience is provided, it must be between 0 and 10.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateSpeakerExperienceScoreWithinRange(result: ValidationResult) {
...
export class SubmissionEntity extends BaseEntity<SubmissionEntityType> {
    ...
    * * AIEvaluationScore: This rule ensures that if there is an AI Evaluation Score, it must be a number between 0 and 100, inclusive.
    * * FinalDecision: This rule ensures that the final decision for a submission can only be "Waitlisted", "Rejected", "Accepted", or left blank (no decision recorded).
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        ...
        this.ValidateFinalDecisionWithinAllowedValues(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if there is an AI Evaluation Score, it must be a number between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    ...
    /**
    * This rule ensures that the final decision for a submission can only be "Waitlisted", "Rejected", "Accepted", or left blank (no decision recorded).
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateFinalDecisionWithinAllowedValues(result: ValidationResult) {
    	if (this.FinalDecision != null && this.FinalDecision !== "Waitlisted" && this.FinalDecision !== "Rejected" && this.FinalDecision !== "Accepted") {
    		result.Errors.push(new ValidationErrorInfo("FinalDecision", "Final decision must be either 'Waitlisted', 'Rejected', 'Accepted', or left blank.", this.FinalDecision, ValidationErrorType.Failure));
    	}
    }
