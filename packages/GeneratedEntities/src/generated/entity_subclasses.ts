...
export class AccountInsightEntity extends BaseEntity<AccountInsightEntityType> {
    ...
    * * Priority: This rule ensures that the 'Priority' field, if provided, must be either 'Low', 'Medium', or 'High', or it can be left blank.
    * * Sentiment: This rule ensures that if a sentiment value is provided, it can only be 'Mixed', 'Neutral', 'Negative', or 'Positive'. The sentiment can also be left empty.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        ...
        this.ValidatePriorityAllowedValues(result);
        this.ValidateSentimentAllowedValues(result);
    ...
    /**
    * This rule ensures that the 'Priority' field, if provided, must be either 'Low', 'Medium', or 'High', or it can be left blank.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidatePriorityAllowedValues(result: ValidationResult) {
    	if (this.Priority != null && this.Priority !== "Low" && this.Priority !== "Medium" && this.Priority !== "High") {
    		result.Errors.push(new ValidationErrorInfo("Priority", "Priority must be 'Low', 'Medium', or 'High' if provided.", this.Priority, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that if a sentiment value is provided, it can only be 'Mixed', 'Neutral', 'Negative', or 'Positive'. The sentiment can also be left empty.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateSentimentAllowedValues(result: ValidationResult) {
    	if (this.Sentiment != null && this.Sentiment !== "Mixed" && this.Sentiment !== "Neutral" && this.Sentiment !== "Negative" && this.Sentiment !== "Positive") {
    		result.Errors.push(new ValidationErrorInfo("Sentiment", "Sentiment must be one of the following values: 'Mixed', 'Neutral', 'Negative', or 'Positive' if provided.", this.Sentiment, ValidationErrorType.Failure));
    	}
    }
...
export class AccountEntity extends BaseEntity<AccountEntityType> {
    ...
    * * Exchange: This rule ensures that if an exchange is specified, it must be one of the allowed values: Other, SSE, HKEX, TSE, LSE, AMEX, NASDAQ, or NYSE. If the exchange is not specified, it can be left empty.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateExchangeMustBeAllowedValue(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if an exchange is specified, it must be one of the allowed values: Other, SSE, HKEX, TSE, LSE, AMEX, NASDAQ, or NYSE. If the exchange is not specified, it can be left empty.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateExchangeMustBeAllowedValue(result: ValidationResult) {
    	const allowed = ["Other", "SSE", "HKEX", "TSE", "LSE", "AMEX", "NASDAQ", "NYSE"];
    	if (this.Exchange != null && allowed.indexOf(this.Exchange) === -1) {
    		result.Errors.push(new ValidationErrorInfo("Exchange", "If provided, Exchange must be one of: Other, SSE, HKEX, TSE, LSE, AMEX, NASDAQ, or NYSE.", this.Exchange, ValidationErrorType.Failure));
    	}
    }
...
export class ContactRelationshipEntity extends BaseEntity<ContactRelationshipEntityType> {
    ...
    * * Table-Level: This rule ensures that if there is an end date, it cannot be earlier than the start date. If no end date is specified, there is no restriction.
    * * Table-Level: This rule ensures that the Primary Contact and Related Contact are not the same person. Each relationship must involve two different contacts.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that if there is an end date, it cannot be earlier than the start date. If no end date is specified, there is no restriction.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateEndDateNotBeforeStartDate(result: ValidationResult) {
    	if (this.EndDate != null && this.StartDate != null && this.EndDate < this.StartDate) {
    		result.Errors.push(new ValidationErrorInfo("EndDate", "End date cannot be before the start date.", this.EndDate, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the Primary Contact and Related Contact are not the same person. Each relationship must involve two different contacts.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidatePrimaryContactIDNotEqualRelatedContactID(result: ValidationResult) {
    	if (this.PrimaryContactID === this.RelatedContactID) {
    		result.Errors.push(new ValidationErrorInfo("PrimaryContactID", "Primary Contact and Related Contact cannot be the same.", this.PrimaryContactID, ValidationErrorType.Failure));
    	}
    }
...
export class DealProductEntity extends BaseEntity<DealProductEntityType> {
    ...
    * * Discount: This rule makes sure that if a discount is provided, it must be a value between 0 and 100 percent.
    * * Quantity: This rule ensures that the quantity must be greater than zero.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateDiscountWithinPercentRange(result);
    ...
    /**
    * This rule makes sure that if a discount is provided, it must be a value between 0 and 100 percent.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateDiscountWithinPercentRange(result: ValidationResult) {
    ...
    /**
    * This rule ensures that the quantity must be greater than zero.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class DealEntity extends BaseEntity<DealEntityType> {
    ...
    * * Probability: This rule ensures that if a probability is provided, it must be a number between 0 and 100, inclusive.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateProbabilityIsBetween0And100(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if a probability is provided, it must be a number between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateProbabilityIsBetween0And100(result: ValidationResult) {
...
export class EventEntity extends BaseEntity<EventEntityType> {
    ...
    * * BaselinePassingScore: This rule ensures that if a baseline passing score is provided, it must be between 0 and 100, inclusive.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateBaselinePassingScoreBetween0And100(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if a baseline passing score is provided, it must be between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateBaselinePassingScoreBetween0And100(result: ValidationResult) {
...
export class InvoiceLineItemEntity extends BaseEntity<InvoiceLineItemEntityType> {
    ...
    * * Discount: This rule ensures that if a discount is specified, it must be a value from 0 to 100 percent (inclusive).
    * * Quantity: This rule ensures that the quantity entered must be greater than zero.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateDiscountBetween0And100(result);
        this.ValidateQuantityGreaterThanZero(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if a discount is specified, it must be a value from 0 to 100 percent (inclusive).
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateDiscountBetween0And100(result: ValidationResult) {
    	if (this.Discount != null && (this.Discount < 0 || this.Discount > 100)) {
    		result.Errors.push(new ValidationErrorInfo("Discount", "Discount must be between 0 and 100 percent if provided.", this.Discount, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the quantity entered must be greater than zero.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class InvoiceEntity extends BaseEntity<InvoiceEntityType> {
    ...
    * * TaxRate: This rule makes sure that if a tax rate is provided, it must be a value between 0 and 100, inclusive.
    * * Table-Level: This rule ensures that the due date on the invoice must be the same as or later than the invoice date. An invoice cannot be due before it is issued.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateTaxRateBetweenZeroAndHundred(result);
    ...
    /**
    * This rule makes sure that if a tax rate is provided, it must be a value between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateTaxRateBetweenZeroAndHundred(result: ValidationResult) {
    	if (this.TaxRate != null && (this.TaxRate < 0 || this.TaxRate > 100)) {
    		result.Errors.push(new ValidationErrorInfo("TaxRate", "Tax rate must be between 0 and 100.", this.TaxRate, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the due date on the invoice must be the same as or later than the invoice date. An invoice cannot be due before it is issued.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class PaymentEntity extends BaseEntity<PaymentEntityType> {
    ...
    * * Amount: This rule ensures that the payment amount must be greater than zero. You cannot record a payment with a zero or negative amount.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that the payment amount must be greater than zero. You cannot record a payment with a zero or negative amount.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateAmountGreaterThanZero(result: ValidationResult) {
    	if (this.Amount <= 0) {
    		result.Errors.push(new ValidationErrorInfo("Amount", "Payment amount must be greater than zero.", this.Amount, ValidationErrorType.Failure));
    	}
    }
...
export class ProductEntity extends BaseEntity<ProductEntityType> {
    ...
    * * RecurringBillingPeriod: This rule ensures that if the Recurring Billing Period is set, it must be either 'Biannual', 'Annual', 'Quarterly', or 'Monthly'. Otherwise, the field must be empty.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that if the Recurring Billing Period is set, it must be either 'Biannual', 'Annual', 'Quarterly', or 'Monthly'. Otherwise, the field must be empty.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateRecurringBillingPeriodAllowedValues(result: ValidationResult) {
    	if (
    		...
    		result.Errors.push(new ValidationErrorInfo(
    			...
    			"RecurringBillingPeriod must be one of: 'Biannual', 'Annual', 'Quarterly', 'Monthly' if specified.",
...
export class SpeakerEntity extends BaseEntity<SpeakerEntityType> {
    ...
    * * CredibilityScore: This rule ensures that if a credibility score is provided, it must be between 0 and 100, inclusive.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateCredibilityScoreWithin0And100(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that if a credibility score is provided, it must be between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateCredibilityScoreWithin0And100(result: ValidationResult) {
    	if (this.CredibilityScore != null && (this.CredibilityScore < 0 || this.CredibilityScore > 100)) {
    		result.Errors.push(new ValidationErrorInfo("CredibilityScore", "Credibility score must be between 0 and 100, inclusive.", this.CredibilityScore, ValidationErrorType.Failure));
    	}
    }
...
export class SubmissionReviewEntity extends BaseEntity<SubmissionReviewEntityType> {
    ...
    * * OverallScore: This rule ensures that the overall score, if entered, must be between 0 and 10.
    * * QualityScore: This rule ensures that the QualityScore, if provided, must be between 0 and 10 inclusive.
    * * RelevanceScore: This rule ensures that if a relevance score is provided, it must be between 0 and 10.
    * * SpeakerExperienceScore: This rule ensures that if a score for speaker experience is provided, it must be between 0 and 10, inclusive.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateOverallScoreWithinRange(result);
        this.ValidateQualityScoreBetweenZeroAndTen(result);
        this.ValidateRelevanceScoreBetweenZeroAndTen(result);
    ...
    /**
    * This rule ensures that the overall score, if entered, must be between 0 and 10.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateOverallScoreWithinRange(result: ValidationResult) {
    	if (this.OverallScore != null && (this.OverallScore < 0 || this.OverallScore > 10)) {
    		result.Errors.push(new ValidationErrorInfo("OverallScore", "The overall score must be between 0 and 10.", this.OverallScore, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the QualityScore, if provided, must be between 0 and 10 inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateQualityScoreBetweenZeroAndTen(result: ValidationResult) {
    	if (this.QualityScore != null && (this.QualityScore < 0 || this.QualityScore > 10)) {
    		result.Errors.push(new ValidationErrorInfo("QualityScore", "QualityScore must be between 0 and 10.", this.QualityScore, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that if a relevance score is provided, it must be between 0 and 10.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateRelevanceScoreBetweenZeroAndTen(result: ValidationResult) {
    	if (this.RelevanceScore != null && (this.RelevanceScore < 0 || this.RelevanceScore > 10)) {
    		result.Errors.push(new ValidationErrorInfo("RelevanceScore", "Relevance score must be between 0 and 10 if specified.", this.RelevanceScore, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that if a score for speaker experience is provided, it must be between 0 and 10, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class SubmissionEntity extends BaseEntity<SubmissionEntityType> {
    ...
    * * FinalDecision: This rule ensures that the final decision for a submission can only be "Waitlisted", "Rejected", "Accepted", or left empty (no decision entered).
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateAIEvaluationScoreBetween0And100(result);
        this.ValidateFinalDecisionAllowedValues(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    * @method
    */
    public ValidateAIEvaluationScoreBetween0And100(result: ValidationResult) {
    ...
    /**
    * This rule ensures that the final decision for a submission can only be "Waitlisted", "Rejected", "Accepted", or left empty (no decision entered).
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateFinalDecisionAllowedValues(result: ValidationResult) {
    	if (this.FinalDecision != null && this.FinalDecision !== "Waitlisted" && this.FinalDecision !== "Rejected" && this.FinalDecision !== "Accepted") {
    		result.Errors.push(new ValidationErrorInfo("FinalDecision", "Final decision must be 'Waitlisted', 'Rejected', 'Accepted', or be left empty.", this.FinalDecision, ValidationErrorType.Failure));
    	}
    }
