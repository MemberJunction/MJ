...
export class AssociationDemoEnrollmentEntity extends BaseEntity<AssociationDemoEnrollmentEntityType> {
    ...
    * * ProgressPercentage: Progress percentage must be between 0 and 100 to ensure that the completion status is recorded within a valid range.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * Progress percentage must be between 0 and 100 to ensure that the completion status is recorded within a valid range.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateProgressPercentageRange(result: ValidationResult) {
    	// Check if ProgressPercentage is within the valid range of 0 to 100
...
export class AssociationDemoResourceRatingEntity extends BaseEntity<AssociationDemoResourceRatingEntityType> {
    ...
    * * Rating: Ratings must be between 1 and 5 to ensure that all reviews provide a valid score within the accepted range.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * Ratings must be between 1 and 5 to ensure that all reviews provide a valid score within the accepted range.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
