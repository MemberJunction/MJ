...
/**
 * zod schema definition for the entity Legislative Findings
 */
export const LegislativeFindingsSchema = z.object({
    ID: z.string().describe(`
        * * Field Name: ID
        * * Display Name: ID
        * * SQL Data Type: uniqueidentifier
    ...
    Category: z.string().nullable().describe(`
        ...
        * * SQL Data Type: nvarchar(100)`),
    PriorityLevel: z.string().nullable().describe(`
    ...
    Notes: z.string().nullable().describe(`
        ...
        * * Display Name: Notes
        * * SQL Data Type: nvarchar(MAX)`),
    ActionItems: z.string().nullable().describe(`
...
export type LegislativeFindingsEntityType = z.infer<typeof LegislativeFindingsSchema>;
...
export class AccountInsightEntity extends BaseEntity<AccountInsightEntityType> {
    ...
    * * Priority: This rule ensures that the priority can only be set to 'Low', 'Medium', 'High', or left empty.
    * * Sentiment: This rule ensures the sentiment field can only be set to 'Mixed', 'Neutral', 'Negative', 'Positive', or left blank.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        ...
        this.ValidateSentimentInAllowedValues(result);
    ...
    /**
    * This rule ensures that the priority can only be set to 'Low', 'Medium', 'High', or left empty.
    ...
    */
    public ValidatePriorityAgainstAllowedValues(result: ValidationResult) {
    	if (
    		...
    		result.Errors.push(new ValidationErrorInfo("Priority", "Priority must be one of: 'Low', 'Medium', 'High', or left empty.", this.Priority, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures the sentiment field can only be set to 'Mixed', 'Neutral', 'Negative', 'Positive', or left blank.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateSentimentInAllowedValues(result: ValidationResult) {
    	const allowed = ["Mixed", "Neutral", "Negative", "Positive", null];
    	if (!allowed.includes(this.Sentiment)) {
    		result.Errors.push(new ValidationErrorInfo("Sentiment", "The sentiment must be one of: 'Mixed', 'Neutral', 'Negative', 'Positive', or left blank.", this.Sentiment, ValidationErrorType.Failure));
    	}
    }
...
export class AccountEntity extends BaseEntity<AccountEntityType> {
    ...
    * * Exchange: This rule ensures that the value of the Exchange field is either empty or set to one of the approved stock exchange codes: Other, SSE, HKEX, TSE, LSE, AMEX, NASDAQ, or NYSE.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateExchangeAgainstApprovedList(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that the value of the Exchange field is either empty or set to one of the approved stock exchange codes: Other, SSE, HKEX, TSE, LSE, AMEX, NASDAQ, or NYSE.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateExchangeAgainstApprovedList(result: ValidationResult) {
    	const allowedExchanges = ["Other", "SSE", "HKEX", "TSE", "LSE", "AMEX", "NASDAQ", "NYSE", null];
    	if (!allowedExchanges.includes(this.Exchange)) {
    		result.Errors.push(new ValidationErrorInfo(
    			"Exchange",
    			"The exchange must be one of the following values: Other, SSE, HKEX, TSE, LSE, AMEX, NASDAQ, NYSE, or left blank.",
    			this.Exchange,
...
export class ContactRelationshipEntity extends BaseEntity<ContactRelationshipEntityType> {
    ...
    * * Table-Level: This rule ensures that the end date is either not given, or if it is provided, it cannot be before the start date.
    * * Table-Level: This rule ensures that the Primary Contact and Related Contact fields cannot have the same value. In other words, they must refer to different people.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that the end date is either not given, or if it is provided, it cannot be before the start date.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateEndDateNotBeforeStartDate(result: ValidationResult) {
    	if (this.EndDate !== null && this.EndDate < this.StartDate) {
    		result.Errors.push(new ValidationErrorInfo("EndDate", "End date cannot be before start date.", this.EndDate, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the Primary Contact and Related Contact fields cannot have the same value. In other words, they must refer to different people.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidatePrimaryContactIDDifferentFromRelatedContactID(result: ValidationResult) {
    	if (this.PrimaryContactID === this.RelatedContactID) {
    		result.Errors.push(new ValidationErrorInfo("PrimaryContactID", "Primary Contact and Related Contact must be different.", this.PrimaryContactID, ValidationErrorType.Failure));
    	}
    }
...
export class DealProductEntity extends BaseEntity<DealProductEntityType> {
    ...
    * * Discount: This rule ensures that the discount value must be between 0 and 100, inclusive.
    * * Quantity: This rule ensures that the quantity for this item must be greater than zero.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateDiscountRange(result);
    ...
    /**
    * This rule ensures that the discount value must be between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateDiscountRange(result: ValidationResult) {
    	if (this.Discount < 0 || this.Discount > 100) {
    		result.Errors.push(new ValidationErrorInfo("Discount", "The discount must be between 0 and 100, inclusive.", this.Discount, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the quantity for this item must be greater than zero.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class DealEntity extends BaseEntity<DealEntityType> {
    ...
    * * Probability: This rule ensures that the probability value must always be between 0 and 100, inclusive.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateProbabilityWithinZeroToHundred(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that the probability value must always be between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateProbabilityWithinZeroToHundred(result: ValidationResult) {
...
export class EventEntity extends BaseEntity<EventEntityType> {
    ...
    * * BaselinePassingScore: This rule ensures that the baseline passing score must be between 0 and 100, inclusive.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that the baseline passing score must be between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateBaselinePassingScoreWithinRange(result: ValidationResult) {
    	if (this.BaselinePassingScore < 0 || this.BaselinePassingScore > 100) {
    		result.Errors.push(new ValidationErrorInfo("BaselinePassingScore", "The baseline passing score must be between 0 and 100.", this.BaselinePassingScore, ValidationErrorType.Failure));
    	}
    }
...
export class InvoiceLineItemEntity extends BaseEntity<InvoiceLineItemEntityType> {
    ...
    * * Discount: This rule ensures that the discount value must be between 0 and 100, inclusive.
    * * Quantity: This rule ensures that the quantity must be greater than zero. In other words, the quantity cannot be zero or negative.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateDiscountWithinAllowedRange(result);
        this.ValidateQuantityGreaterThanZero(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    * @method
    */
    public ValidateDiscountWithinAllowedRange(result: ValidationResult) {
    	if (this.Discount < 0 || this.Discount > 100) {
    		result.Errors.push(new ValidationErrorInfo("Discount", "Discount must be between 0 and 100 percent.", this.Discount, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the quantity must be greater than zero. In other words, the quantity cannot be zero or negative.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class InvoiceEntity extends BaseEntity<InvoiceEntityType> {
    ...
    * * TaxRate: This rule ensures that the tax rate is between 0 and 100, inclusive.
    ...
    */
    ...
    /**
    * This rule ensures that the tax rate is between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateTaxRateBetween0And100(result: ValidationResult) {
    	if (this.TaxRate < 0 || this.TaxRate > 100) {
    		result.Errors.push(new ValidationErrorInfo("TaxRate", "Tax rate must be between 0 and 100, inclusive.", this.TaxRate, ValidationErrorType.Failure));
    	}
    }
...
/**
 * Legislative Findings - strongly typed entity sub-class
 * * Schema: demo
 * * Base Table: LegislativeFindings
 * * Base View: vwLegislativeFindings
 * * Primary Key: ID
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Legislative Findings')
export class LegislativeFindingsEntity extends BaseEntity<LegislativeFindingsEntityType> {
    /**
    * Loads the Legislative Findings record from the database
    * @param ID: string - primary key value to load the Legislative Findings record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof LegislativeFindingsEntity
    * @method
    * @override
    */
    public async Load(ID: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
    ...
    * * SQL Data Type: nvarchar(50)
    */
    get ItemNumber(): string | null {
        return this.Get('ItemNumber');
    }
    set ItemNumber(value: string | null) {
    ...
    * * SQL Data Type: nvarchar(20)
    */
    get PriorityLevel(): string | null {
        return this.Get('PriorityLevel');
    }
    set PriorityLevel(value: string | null) {
        this.Set('PriorityLevel', value);
    }
    ...
    * * SQL Data Type: nvarchar(MAX)
    */
    get ActionItems(): string | null {
        return this.Get('ActionItems');
    }
    set ActionItems(value: string | null) {
        this.Set('ActionItems', value);
    }
...
export class PaymentEntity extends BaseEntity<PaymentEntityType> {
    ...
    * * Amount: This rule ensures that the payment amount must be greater than zero. Negative or zero payment amounts are not allowed.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that the payment amount must be greater than zero. Negative or zero payment amounts are not allowed.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
...
export class ProductEntity extends BaseEntity<ProductEntityType> {
    ...
    * * RecurringBillingPeriod: This rule ensures that the billing period for a recurring product can only be 'Biannual', 'Annual', 'Quarterly', 'Monthly', or left blank (no value). No other values are allowed.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * This rule ensures that the billing period for a recurring product can only be 'Biannual', 'Annual', 'Quarterly', 'Monthly', or left blank (no value). No other values are allowed.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateRecurringBillingPeriodAllowedValues(result: ValidationResult) {
    	...
    	// If value is not in allowed values (including null), trigger an error
    	if (!allowedValues.includes(this.RecurringBillingPeriod)) {
    		result.Errors.push(new ValidationErrorInfo(
    			"RecurringBillingPeriod",
    			"Recurring billing period must be Biannual, Annual, Quarterly, Monthly, or left blank.",
...
export class SpeakerEntity extends BaseEntity<SpeakerEntityType> {
    ...
    * * CredibilityScore: This rule ensures that the Credibility Score must be between 0 and 100, inclusive. Scores below 0 or above 100 are not allowed.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateCredibilityScoreWithinAllowedRange(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule ensures that the Credibility Score must be between 0 and 100, inclusive. Scores below 0 or above 100 are not allowed.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateCredibilityScoreWithinAllowedRange(result: ValidationResult) {
    	if (this.CredibilityScore < 0 || this.CredibilityScore > 100) {
    		result.Errors.push(new ValidationErrorInfo("CredibilityScore", "The Credibility Score must be between 0 and 100.", this.CredibilityScore, ValidationErrorType.Failure));
    	}
    }
...
export class SubmissionReviewEntity extends BaseEntity<SubmissionReviewEntityType> {
    ...
    * * OverallScore: This rule ensures that the overall score must be a number between 0 and 10, inclusive.
    * * QualityScore: This rule ensures that the Quality Score provided is between 0 and 10, inclusive.
    * * RelevanceScore: This rule ensures that the relevance score must be a number between 0 and 10, inclusive.
    * * SpeakerExperienceScore: This rule ensures that the Speaker Experience Score can only be set to values between 0 and 10, inclusive. Scores below 0 or above 10 are not allowed.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateOverallScoreWithinZeroAndTen(result);
        this.ValidateQualityScoreWithinZeroAndTen(result);
        this.ValidateRelevanceScoreWithinAllowedRange(result);
    ...
    /**
    * This rule ensures that the overall score must be a number between 0 and 10, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateOverallScoreWithinZeroAndTen(result: ValidationResult) {
    	if (this.OverallScore < 0 || this.OverallScore > 10) {
    		result.Errors.push(new ValidationErrorInfo("OverallScore", "Overall score must be between 0 and 10.", this.OverallScore, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the Quality Score provided is between 0 and 10, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateQualityScoreWithinZeroAndTen(result: ValidationResult) {
    	if (this.QualityScore < 0 || this.QualityScore > 10) {
    		result.Errors.push(new ValidationErrorInfo("QualityScore", "Quality Score must be between 0 and 10.", this.QualityScore, ValidationErrorType.Failure));
    	}
    }

    /**
    * This rule ensures that the relevance score must be a number between 0 and 10, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateRelevanceScoreWithinAllowedRange(result: ValidationResult) {
    	if (this.RelevanceScore < 0 || this.RelevanceScore > 10) {
    ...
    /**
    * This rule ensures that the Speaker Experience Score can only be set to values between 0 and 10, inclusive. Scores below 0 or above 10 are not allowed.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateSpeakerExperienceScoreBetween0And10(result: ValidationResult) {
    	if (this.SpeakerExperienceScore < 0 || this.SpeakerExperienceScore > 10) {
    		result.Errors.push(new ValidationErrorInfo("SpeakerExperienceScore", "The Speaker Experience Score must be between 0 and 10.", this.SpeakerExperienceScore, ValidationErrorType.Failure));
    	}
    }
...
export class SubmissionEntity extends BaseEntity<SubmissionEntityType> {
    ...
    * * AIEvaluationScore: This rule makes sure that the AI Evaluation Score is always between 0 and 100, inclusive.
    * * FinalDecision: This rule ensures that the final decision for a submission can only be set to 'Waitlisted', 'Rejected', 'Accepted', or left blank (no value provided).
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateAIEvaluationScoreBetweenZeroAndHundred(result);
        this.ValidateFinalDecisionAgainstAllowedValues(result);
        result.Success = result.Success && (result.Errors.length === 0);
    ...
    /**
    * This rule makes sure that the AI Evaluation Score is always between 0 and 100, inclusive.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateAIEvaluationScoreBetweenZeroAndHundred(result: ValidationResult) {
    ...
    /**
    * This rule ensures that the final decision for a submission can only be set to 'Waitlisted', 'Rejected', 'Accepted', or left blank (no value provided).
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateFinalDecisionAgainstAllowedValues(result: ValidationResult) {
    	const allowed = ["Waitlisted", "Rejected", "Accepted"];
    	// If FinalDecision is not null/undefined and not in allowed values, raise an error
    	if (this.FinalDecision !== null && this.FinalDecision !== undefined && !allowed.includes(this.FinalDecision)) {
    		result.Errors.push(new ValidationErrorInfo("FinalDecision", "FinalDecision must be either \"Waitlisted\", \"Rejected\", \"Accepted\", or left blank.", this.FinalDecision, ValidationErrorType.Failure));
    	}
    }
