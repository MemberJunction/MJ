...
/**
 * zod schema definition for the entity Bikes
 */
export const BikeSchema = z.object({
    bike_id: z.string().describe(`
        * * Field Name: bike_id
        * * Display Name: bike _id
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newid()
        * * Description: Unique identifier for the bike`),
    rider_id: z.string().describe(`
        * * Field Name: rider_id
        * * Display Name: rider _id
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Riders (vwRiders.rider_id)
        * * Description: Foreign key to the rider who owns this bike`),
    name: z.string().describe(`
        * * Field Name: name
        * * Display Name: name
        * * SQL Data Type: nvarchar(100)
        * * Description: User-defined name for the bike`),
    bike_type: z.union([z.literal('bmx'), z.literal('cyclocross'), z.literal('electric'), z.literal('gravel'), z.literal('hybrid'), z.literal('mountain'), z.literal('road'), z.literal('touring')]).nullable().describe(`
        * * Field Name: bike_type
        * * Display Name: bike _type
    ...
    *   * road
    *   * touring
        * * Description: Type of bicycle: road, mountain, gravel, hybrid, bmx, electric, touring, or cyclocross`),
    weight_kg: z.number().nullable().describe(`
        * * Field Name: weight_kg
        * * Display Name: weight _kg
        * * SQL Data Type: decimal(5, 2)
        * * Description: Weight of the bike in kilograms (0-50)`),
    wheel_size_in: z.number().nullable().describe(`
        * * Field Name: wheel_size_in
        * * Display Name: wheel _size _in
        * * SQL Data Type: decimal(4, 2)
        * * Description: Wheel diameter in inches (12-36)`),
    total_distance_m: z.number().describe(`
        * * Field Name: total_distance_m
        * * Display Name: total _distance _m
        * * SQL Data Type: decimal(12, 2)
        * * Default Value: 0
        * * Description: Total distance traveled on this bike in meters`),
    last_serviced: z.date().nullable().describe(`
        * * Field Name: last_serviced
        * * Display Name: last _serviced
        * * SQL Data Type: datetime2
        * * Description: Date and time of the last service or maintenance`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
export type BikeEntityType = z.infer<typeof BikeSchema>;
...
export const LocationSchema = z.object({
    location_id: z.string().describe(`
        * * Field Name: location_id
        * * Display Name: location _id
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newid()
    ...
    rider_id: z.string().describe(`
        ...
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Riders (vwRiders.rider_id)
        * * Description: Foreign key to the rider who discovered/saved this location`),
    name: z.string().describe(`
        * * Field Name: name
        * * Display Name: name
    ...
    latitude: z.number().describe(`
        ...
        * * Description: Geographic latitude coordinate (-90 to 90 degrees)`),
    longitude: z.number().describe(`
        * * Field Name: longitude
        * * Display Name: longitude
        * * SQL Data Type: decimal(9, 6)
        * * Description: Geographic longitude coordinate (-180 to 180 degrees)`),
    elevation_m: z.number().nullable().describe(`
        * * Field Name: elevation_m
        * * Display Name: elevation _m
        * * SQL Data Type: decimal(7, 2)
        * * Description: Elevation above sea level in meters (-500 to 9000)`),
    terrain_type: z.union([z.literal('doubletrack'), z.literal('gravel'), z.literal('mountain'), z.literal('paved_trail'), z.literal('road'), z.literal('singletrack'), z.literal('urban')]).nullable().describe(`
        * * Field Name: terrain_type
        * * Display Name: terrain _type
        * * SQL Data Type: nvarchar(20)
    * * Value List Type: List
    * * Possible Values 
    *   * doubletrack
    ...
    *   * singletrack
    *   * urban
        * * Description: Type of terrain: road, gravel, singletrack, doubletrack, paved_trail, urban, or mountain`),
    surface_condition: z.union([z.literal('dry'), z.literal('icy'), z.literal('loose'), z.literal('muddy'), z.literal('packed'), z.literal('sandy'), z.literal('wet')]).nullable().describe(`
        * * Field Name: surface_condition
        * * Display Name: surface _condition
        * * SQL Data Type: nvarchar(20)
    * * Value List Type: List
    * * Possible Values 
    *   * dry
    ...
    *   * sandy
    *   * wet
        * * Description: Current surface condition: dry, wet, muddy, icy, sandy, loose, or packed`),
    difficulty_rating: z.number().nullable().describe(`
        * * Field Name: difficulty_rating
        * * Display Name: difficulty _rating
        * * SQL Data Type: decimal(3, 1)
        * * Description: Difficulty rating for the location (1.0 to 10.0)`),
    visit_count: z.number().describe(`
        * * Field Name: visit_count
        * * Display Name: visit _count
        * * SQL Data Type: int
        * * Default Value: 0
        * * Description: Number of times the rider has visited this location`),
    first_visited: z.date().describe(`
        * * Field Name: first_visited
        * * Display Name: first _visited
        * * SQL Data Type: datetime2
        * * Default Value: getutcdate()
        * * Description: UTC timestamp when the location was first visited`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
/**
 * zod schema definition for the entity Rider _ Stats
 */
export const Rider_StatsSchema = z.object({
    stats_id: z.string().describe(`
        * * Field Name: stats_id
        * * Display Name: stats _id
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newid()
        * * Description: Unique identifier for the stats record`),
    rider_id: z.string().describe(`
        * * Field Name: rider_id
        * * Display Name: rider _id
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Riders (vwRiders.rider_id)
        * * Description: Foreign key to the rider who recorded these stats`),
    location_id: z.string().nullable().describe(`
        * * Field Name: location_id
        * * Display Name: location _id
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Locations (vwLocations.location_id)
        * * Description: Foreign key to the location where the ride took place (optional)`),
    bike_id: z.string().nullable().describe(`
        * * Field Name: bike_id
        * * Display Name: bike _id
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Bikes (vwBikes.bike_id)
        * * Description: Foreign key to the bike used for the ride (optional)`),
    avg_speed_mps: z.number().nullable().describe(`
        * * Field Name: avg_speed_mps
        * * Display Name: avg _speed _mps
        * * SQL Data Type: decimal(6, 2)
        * * Description: Average speed during the ride in meters per second (0-50)`),
    max_speed_mps: z.number().nullable().describe(`
        * * Field Name: max_speed_mps
        * * Display Name: max _speed _mps
        * * SQL Data Type: decimal(6, 2)
        * * Description: Maximum speed during the ride in meters per second (0-80, must be >= avg_speed)`),
    avg_heart_rate_bpm: z.number().nullable().describe(`
        * * Field Name: avg_heart_rate_bpm
        * * Display Name: avg _heart _rate _bpm
        * * SQL Data Type: int
        * * Description: Average heart rate during the ride in beats per minute (30-250)`),
    max_heart_rate_bpm: z.number().nullable().describe(`
        * * Field Name: max_heart_rate_bpm
        * * Display Name: max _heart _rate _bpm
        * * SQL Data Type: int
        * * Description: Maximum heart rate during the ride in beats per minute (30-250, must be >= avg_heart_rate)`),
    cadence_rpm: z.number().nullable().describe(`
        * * Field Name: cadence_rpm
        * * Display Name: cadence _rpm
        * * SQL Data Type: int
        * * Description: Pedaling cadence in revolutions per minute (0-200)`),
    power_watts: z.number().nullable().describe(`
        * * Field Name: power_watts
        * * Display Name: power _watts
        * * SQL Data Type: int
        * * Description: Power output in watts (0-2500)`),
    distance_m: z.number().describe(`
        * * Field Name: distance_m
        * * Display Name: distance _m
        * * SQL Data Type: decimal(12, 2)
        * * Description: Total distance covered in meters`),
    elevation_gain_m: z.number().nullable().describe(`
        * * Field Name: elevation_gain_m
        * * Display Name: elevation _gain _m
        * * SQL Data Type: decimal(8, 2)
        * * Description: Total elevation gained during the ride in meters (0-10000)`),
    duration_seconds: z.number().describe(`
        * * Field Name: duration_seconds
        * * Display Name: duration _seconds
        * * SQL Data Type: int
        * * Description: Total duration of the ride in seconds (must be > 0)`),
    calories_burned: z.number().nullable().describe(`
        * * Field Name: calories_burned
        * * Display Name: calories _burned
        * * SQL Data Type: int
        * * Description: Estimated calories burned during the ride (0-20000)`),
    effort_rating: z.number().nullable().describe(`
        * * Field Name: effort_rating
        * * Display Name: effort _rating
        * * SQL Data Type: int
        * * Description: Self-reported perceived effort rating (1-10)`),
    recorded_at: z.date().describe(`
        * * Field Name: recorded_at
        * * Display Name: recorded _at
        * * SQL Data Type: datetime2
        * * Default Value: getutcdate()
        * * Description: UTC timestamp when the ride stats were recorded`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    location_id_Virtual: z.string().nullable().describe(`
        * * Field Name: location_id_Virtual
        * * Display Name: location _id _ Virtual
        * * SQL Data Type: nvarchar(150)`),
    bike_id_Virtual: z.string().nullable().describe(`
        * * Field Name: bike_id_Virtual
        * * Display Name: bike _id _ Virtual
        * * SQL Data Type: nvarchar(100)`),
});

export type Rider_StatsEntityType = z.infer<typeof Rider_StatsSchema>;

/**
 * zod schema definition for the entity Riders
 */
export const RiderSchema = z.object({
    ...
    username: z.string().describe(`
        ...
        * * SQL Data Type: nvarchar(50)
        * * Description: Unique username for the rider account`),
    email: z.string().describe(`
        * * Field Name: email
        * * Display Name: email
        * * SQL Data Type: nvarchar(255)
    ...
    weight_kg: z.number().nullable().describe(`
        ...
        * * Display Name: weight _kg
        * * SQL Data Type: decimal(5, 2)
        * * Description: Rider body weight in kilograms (0-300)`),
    fitness_level: z.number().nullable().describe(`
        * * Field Name: fitness_level
        * * Display Name: fitness _level
        * * SQL Data Type: int
        * * Description: Self-reported fitness level on a scale of 1-10`),
    preferred_terrain: z.union([z.literal('gravel'), z.literal('mixed'), z.literal('mountain'), z.literal('road'), z.literal('urban')]).nullable().describe(`
        * * Field Name: preferred_terrain
        * * Display Name: preferred _terrain
        * * SQL Data Type: nvarchar(20)
    * * Value List Type: List
    * * Possible Values 
    *   * gravel
    ...
    *   * road
    *   * urban
        * * Description: Preferred riding terrain: road, gravel, mountain, urban, or mixed`),
    lifetime_stats: z.string().nullable().describe(`
        * * Field Name: lifetime_stats
        * * Display Name: lifetime _stats
        * * SQL Data Type: nvarchar(MAX)
        * * Description: JSON object containing aggregated lifetime statistics`),
    created_at: z.date().describe(`
        * * Field Name: created_at
        * * Display Name: created _at
        * * SQL Data Type: datetime2
        * * Default Value: getutcdate()
        * * Description: UTC timestamp when the rider account was created`),
    __mj_CreatedAt: z.date().describe(`
        * * Field Name: __mj_CreatedAt
        * * Display Name: Created At
        * * SQL Data Type: datetimeoffset
...
/**
 * zod schema definition for the entity Weathers
 */
export const WeatherSchema = z.object({
    weather_id: z.string().describe(`
        * * Field Name: weather_id
        * * Display Name: weather _id
        * * SQL Data Type: uniqueidentifier
        * * Default Value: newid()
    ...
    location_id: z.string().describe(`
        ...
        * * SQL Data Type: uniqueidentifier
        * * Related Entity/Foreign Key: Locations (vwLocations.location_id)
        * * Description: Foreign key to the location where weather was observed`),
    temperature_c: z.number().nullable().describe(`
        * * Field Name: temperature_c
        * * Display Name: temperature _c
        * * SQL Data Type: decimal(5, 2)
        * * Description: Temperature in Celsius (-90 to 60)`),
    humidity_pct: z.number().nullable().describe(`
        * * Field Name: humidity_pct
        * * Display Name: humidity _pct
        * * SQL Data Type: decimal(5, 2)
        * * Description: Relative humidity percentage (0-100)`),
    wind_speed_mps: z.number().nullable().describe(`
        * * Field Name: wind_speed_mps
        * * Display Name: wind _speed _mps
        * * SQL Data Type: decimal(6, 2)
        * * Description: Wind speed in meters per second (0-120)`),
    wind_direction_deg: z.number().nullable().describe(`
        * * Field Name: wind_direction_deg
        * * Display Name: wind _direction _deg
        * * SQL Data Type: decimal(5, 2)
        * * Description: Wind direction in degrees from north (0-360)`),
    precipitation_type: z.union([z.literal('drizzle'), z.literal('fog'), z.literal('hail'), z.literal('heavy_rain'), z.literal('none'), z.literal('rain'), z.literal('sleet'), z.literal('snow')]).nullable().describe(`
        * * Field Name: precipitation_type
        * * Display Name: precipitation _type
        * * SQL Data Type: nvarchar(20)
    * * Value List Type: List
    * * Possible Values 
    *   * drizzle
    ...
    *   * sleet
    *   * snow
        * * Description: Type of precipitation: none, drizzle, rain, heavy_rain, snow, sleet, hail, or fog`),
    cloud_cover_pct: z.number().nullable().describe(`
        * * Field Name: cloud_cover_pct
        * * Display Name: cloud _cover _pct
        * * SQL Data Type: int
        * * Description: Cloud cover percentage (0-100)`),
    visibility_km: z.number().nullable().describe(`
        * * Field Name: visibility_km
        * * Display Name: visibility _km
        * * SQL Data Type: decimal(6, 2)
        * * Description: Visibility in kilometers (0-100)`),
    observed_at: z.date().describe(`
        * * Field Name: observed_at
        * * Display Name: observed _at
        * * SQL Data Type: datetime2
        * * Default Value: getutcdate()
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    location_id_Virtual: z.string().describe(`
        * * Field Name: location_id_Virtual
        * * Display Name: location _id _ Virtual
        * * SQL Data Type: nvarchar(150)`),
});

export type WeatherEntityType = z.infer<typeof WeatherSchema>;
...
/**
 * Bikes - strongly typed entity sub-class
 * * Schema: MJ_Biking_App
 * * Base Table: Bike
 * * Base View: vwBikes
 * * @description Stores bicycles owned by riders
 * * Primary Key: bike_id
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Bikes')
export class BikeEntity extends BaseEntity<BikeEntityType> {
    /**
    * Loads the Bikes record from the database
    * @param bike_id: string - primary key value to load the Bikes record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    ...
    * @override
    */
    public async Load(bike_id: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
        const compositeKey: CompositeKey = new CompositeKey();
        compositeKey.KeyValuePairs.push({ FieldName: 'bike_id', Value: bike_id });
        return await super.InnerLoad(compositeKey, EntityRelationshipsToLoad);
    }
    ...
    */
    get bike_id(): string {
        return this.Get('bike_id');
    }
    set bike_id(value: string) {
        this.Set('bike_id', value);
    }
    ...
    * * Description: Type of bicycle: road, mountain, gravel, hybrid, bmx, electric, touring, or cyclocross
    */
    get bike_type(): 'bmx' | 'cyclocross' | 'electric' | 'gravel' | 'hybrid' | 'mountain' | 'road' | 'touring' | null {
        return this.Get('bike_type');
    }
    set bike_type(value: 'bmx' | 'cyclocross' | 'electric' | 'gravel' | 'hybrid' | 'mountain' | 'road' | 'touring' | null) {
        this.Set('bike_type', value);
    }
    ...
    */
    get weight_kg(): number | null {
        return this.Get('weight_kg');
    }
    set weight_kg(value: number | null) {
        this.Set('weight_kg', value);
    }
    ...
    * * Description: Wheel diameter in inches (12-36)
    */
    get wheel_size_in(): number | null {
        return this.Get('wheel_size_in');
    }
    set wheel_size_in(value: number | null) {
        this.Set('wheel_size_in', value);
    }
    ...
    * * Description: Total distance traveled on this bike in meters
    */
    get total_distance_m(): number {
        return this.Get('total_distance_m');
    }
    set total_distance_m(value: number) {
        this.Set('total_distance_m', value);
    }
    ...
    * * Description: Date and time of the last service or maintenance
    */
    get last_serviced(): Date | null {
        return this.Get('last_serviced');
    }
    set last_serviced(value: Date | null) {
        this.Set('last_serviced', value);
    }
 ...
 * * @description Stores geographic points of interest visited by riders
...
export class LocationEntity extends BaseEntity<LocationEntityType> {
    ...
    * @param location_id: string - primary key value to load the Locations record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    ...
    * @override
    */
    public async Load(location_id: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
        const compositeKey: CompositeKey = new CompositeKey();
        compositeKey.KeyValuePairs.push({ FieldName: 'location_id', Value: location_id });
        return await super.InnerLoad(compositeKey, EntityRelationshipsToLoad);
    }
    ...
    * * Description: Elevation above sea level in meters (-500 to 9000)
    */
    get elevation_m(): number | null {
        return this.Get('elevation_m');
    }
    set elevation_m(value: number | null) {
        this.Set('elevation_m', value);
    }
    ...
    * * Description: Type of terrain: road, gravel, singletrack, doubletrack, paved_trail, urban, or mountain
    */
    get terrain_type(): 'doubletrack' | 'gravel' | 'mountain' | 'paved_trail' | 'road' | 'singletrack' | 'urban' | null {
        return this.Get('terrain_type');
    }
    set terrain_type(value: 'doubletrack' | 'gravel' | 'mountain' | 'paved_trail' | 'road' | 'singletrack' | 'urban' | null) {
        this.Set('terrain_type', value);
    }
    ...
    * * Description: Current surface condition: dry, wet, muddy, icy, sandy, loose, or packed
    */
    get surface_condition(): 'dry' | 'icy' | 'loose' | 'muddy' | 'packed' | 'sandy' | 'wet' | null {
        return this.Get('surface_condition');
    }
    set surface_condition(value: 'dry' | 'icy' | 'loose' | 'muddy' | 'packed' | 'sandy' | 'wet' | null) {
        this.Set('surface_condition', value);
    }
    ...
    * * Description: Difficulty rating for the location (1.0 to 10.0)
    */
    get difficulty_rating(): number | null {
        return this.Get('difficulty_rating');
    }
    set difficulty_rating(value: number | null) {
        this.Set('difficulty_rating', value);
    }
    ...
    */
    get visit_count(): number {
        return this.Get('visit_count');
    }
    set visit_count(value: number) {
        this.Set('visit_count', value);
    }
    ...
    * * Description: UTC timestamp when the location was first visited
    */
    get first_visited(): Date {
        return this.Get('first_visited');
    }
    set first_visited(value: Date) {
        this.Set('first_visited', value);
    }
...
/**
 * Rider _ Stats - strongly typed entity sub-class
 * * Schema: MJ_Biking_App
 * * Base Table: Rider_Stats
 * * Base View: vwRider_Stats
 * * @description Stores performance metrics and physiological data from ride sessions
 * * Primary Key: stats_id
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Rider _ Stats')
export class Rider_StatsEntity extends BaseEntity<Rider_StatsEntityType> {
    /**
    * Loads the Rider _ Stats record from the database
    * @param stats_id: string - primary key value to load the Rider _ Stats record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof Rider_StatsEntity
    * @method
    * @override
    */
    public async Load(stats_id: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
        const compositeKey: CompositeKey = new CompositeKey();
        compositeKey.KeyValuePairs.push({ FieldName: 'stats_id', Value: stats_id });
        return await super.InnerLoad(compositeKey, EntityRelationshipsToLoad);
    }
    ...
    */
    get stats_id(): string {
        return this.Get('stats_id');
    }
    set stats_id(value: string) {
        this.Set('stats_id', value);
    }
    ...
    */
    ...
    set location_id(value: string | null) {
        this.Set('location_id', value);
    }
    ...
    * * Description: Foreign key to the bike used for the ride (optional)
    */
    get bike_id(): string | null {
        return this.Get('bike_id');
    }
    set bike_id(value: string | null) {
        this.Set('bike_id', value);
    }
    ...
    * * Description: Average speed during the ride in meters per second (0-50)
    */
    get avg_speed_mps(): number | null {
        return this.Get('avg_speed_mps');
    }
    set avg_speed_mps(value: number | null) {
        this.Set('avg_speed_mps', value);
    }
    ...
    * * Description: Maximum speed during the ride in meters per second (0-80, must be >= avg_speed)
    */
    get max_speed_mps(): number | null {
        return this.Get('max_speed_mps');
    }
    set max_speed_mps(value: number | null) {
        this.Set('max_speed_mps', value);
    }
    ...
    * * Description: Average heart rate during the ride in beats per minute (30-250)
    */
    get avg_heart_rate_bpm(): number | null {
        return this.Get('avg_heart_rate_bpm');
    }
    set avg_heart_rate_bpm(value: number | null) {
        this.Set('avg_heart_rate_bpm', value);
    }
    ...
    * * Description: Maximum heart rate during the ride in beats per minute (30-250, must be >= avg_heart_rate)
    */
    get max_heart_rate_bpm(): number | null {
        return this.Get('max_heart_rate_bpm');
    }
    set max_heart_rate_bpm(value: number | null) {
        this.Set('max_heart_rate_bpm', value);
    }
    ...
    * * Description: Pedaling cadence in revolutions per minute (0-200)
    */
    get cadence_rpm(): number | null {
        return this.Get('cadence_rpm');
    }
    set cadence_rpm(value: number | null) {
        this.Set('cadence_rpm', value);
    }
    ...
    * * Description: Power output in watts (0-2500)
    */
    get power_watts(): number | null {
        return this.Get('power_watts');
    }
    set power_watts(value: number | null) {
        this.Set('power_watts', value);
    }
    ...
    */
    get distance_m(): number {
        return this.Get('distance_m');
    }
    set distance_m(value: number) {
        this.Set('distance_m', value);
    }
    ...
    * * Description: Total elevation gained during the ride in meters (0-10000)
    */
    get elevation_gain_m(): number | null {
        return this.Get('elevation_gain_m');
    }
    set elevation_gain_m(value: number | null) {
        this.Set('elevation_gain_m', value);
    }
    ...
    * * Description: Estimated calories burned during the ride (0-20000)
    */
    get calories_burned(): number | null {
        return this.Get('calories_burned');
    }
    set calories_burned(value: number | null) {
        this.Set('calories_burned', value);
    }
    ...
    * * Description: Self-reported perceived effort rating (1-10)
    */
    get effort_rating(): number | null {
        return this.Get('effort_rating');
    }
    set effort_rating(value: number | null) {
        this.Set('effort_rating', value);
    }
    ...
    */
    get recorded_at(): Date {
        return this.Get('recorded_at');
    }
    set recorded_at(value: Date) {
        this.Set('recorded_at', value);
    }
    ...
    * * SQL Data Type: nvarchar(150)
    */
    get location_id_Virtual(): string | null {
        return this.Get('location_id_Virtual');
    }
    ...
    * * SQL Data Type: nvarchar(100)
    */
    get bike_id_Virtual(): string | null {
        return this.Get('bike_id_Virtual');
    }
}


/**
 * Riders - strongly typed entity sub-class
 * * Schema: MJ_Biking_App
 * * Base Table: Rider
 * * Base View: vwRiders
 * * @description Stores cyclist profile information and preferences for the Trailbloom app
 * * Primary Key: rider_id
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Riders')
export class RiderEntity extends BaseEntity<RiderEntityType> {
    /**
    * Loads the Riders record from the database
    * @param rider_id: string - primary key value to load the Riders record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof RiderEntity
    * @method
    * @override
    */
    public async Load(rider_id: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
        const compositeKey: CompositeKey = new CompositeKey();
        compositeKey.KeyValuePairs.push({ FieldName: 'rider_id', Value: rider_id });
        return await super.InnerLoad(compositeKey, EntityRelationshipsToLoad);
    }
    ...
    * * Description: Self-reported fitness level on a scale of 1-10
    */
    get fitness_level(): number | null {
        return this.Get('fitness_level');
    }
    set fitness_level(value: number | null) {
        this.Set('fitness_level', value);
    }
    ...
    * * Description: Preferred riding terrain: road, gravel, mountain, urban, or mixed
    */
    get preferred_terrain(): 'gravel' | 'mixed' | 'mountain' | 'road' | 'urban' | null {
        return this.Get('preferred_terrain');
    }
    set preferred_terrain(value: 'gravel' | 'mixed' | 'mountain' | 'road' | 'urban' | null) {
        this.Set('preferred_terrain', value);
    }
    ...
    * * Description: JSON object containing aggregated lifetime statistics
    */
    get lifetime_stats(): string | null {
        return this.Get('lifetime_stats');
    }
    set lifetime_stats(value: string | null) {
        this.Set('lifetime_stats', value);
    }
...
/**
 * Weathers - strongly typed entity sub-class
 * * Schema: MJ_Biking_App
 * * Base Table: Weather
 * * Base View: vwWeathers
 * * @description Stores weather condition snapshots at locations
 * * Primary Key: weather_id
 * @extends {BaseEntity}
 * @class
 * @public
 */
@RegisterClass(BaseEntity, 'Weathers')
export class WeatherEntity extends BaseEntity<WeatherEntityType> {
    /**
    * Loads the Weathers record from the database
    * @param weather_id: string - primary key value to load the Weathers record.
    * @param EntityRelationshipsToLoad - (optional) the relationships to load
    * @returns {Promise<boolean>} - true if successful, false otherwise
    * @public
    * @async
    * @memberof WeatherEntity
    * @method
    * @override
    */
    public async Load(weather_id: string, EntityRelationshipsToLoad?: string[]) : Promise<boolean> {
        const compositeKey: CompositeKey = new CompositeKey();
        compositeKey.KeyValuePairs.push({ FieldName: 'weather_id', Value: weather_id });
        return await super.InnerLoad(compositeKey, EntityRelationshipsToLoad);
    }
    ...
    * * Description: Unique identifier for the weather record
    */
    get weather_id(): string {
        return this.Get('weather_id');
    }
    set weather_id(value: string) {
        this.Set('weather_id', value);
    }
    ...
    * * Description: Temperature in Celsius (-90 to 60)
    */
    get temperature_c(): number | null {
        return this.Get('temperature_c');
    }
    set temperature_c(value: number | null) {
        this.Set('temperature_c', value);
    }
    ...
    * * Description: Relative humidity percentage (0-100)
    */
    get humidity_pct(): number | null {
        return this.Get('humidity_pct');
    }
    set humidity_pct(value: number | null) {
        this.Set('humidity_pct', value);
    }
    ...
    * * Description: Wind speed in meters per second (0-120)
    */
    get wind_speed_mps(): number | null {
        return this.Get('wind_speed_mps');
    }
    set wind_speed_mps(value: number | null) {
        this.Set('wind_speed_mps', value);
    }
    ...
    * * Description: Wind direction in degrees from north (0-360)
    */
    get wind_direction_deg(): number | null {
        return this.Get('wind_direction_deg');
    }
    set wind_direction_deg(value: number | null) {
        this.Set('wind_direction_deg', value);
    }
    ...
    * * Description: Type of precipitation: none, drizzle, rain, heavy_rain, snow, sleet, hail, or fog
    */
    get precipitation_type(): 'drizzle' | 'fog' | 'hail' | 'heavy_rain' | 'none' | 'rain' | 'sleet' | 'snow' | null {
        return this.Get('precipitation_type');
    }
    set precipitation_type(value: 'drizzle' | 'fog' | 'hail' | 'heavy_rain' | 'none' | 'rain' | 'sleet' | 'snow' | null) {
        this.Set('precipitation_type', value);
    }
    ...
    * * Description: Cloud cover percentage (0-100)
    */
    get cloud_cover_pct(): number | null {
        return this.Get('cloud_cover_pct');
    }
    set cloud_cover_pct(value: number | null) {
        this.Set('cloud_cover_pct', value);
    }
    ...
    * * Description: Visibility in kilometers (0-100)
    */
    get visibility_km(): number | null {
        return this.Get('visibility_km');
    }
    set visibility_km(value: number | null) {
        this.Set('visibility_km', value);
    }
    ...
    * * Description: UTC timestamp when the weather observation was recorded
    */
    get observed_at(): Date {
        return this.Get('observed_at');
    }
    set observed_at(value: Date) {
        this.Set('observed_at', value);
    }
    ...
    * * SQL Data Type: nvarchar(150)
    */
    get location_id_Virtual(): string {
        return this.Get('location_id_Virtual');
    }
}
