...
// Not exported to avoid invalid imports from being generated
// IRL, your class should be exported
@RegisterClass(BaseEntity, 'Contacts', 1)
class ContactDemoEntity extends ContactBaseEntityStub /*here you would change this to sub-class the real base class from ../generated/entity_subclasses */  {
    get FirstName(): string {
