...
-- Add CompletionTime column to track when AI response processing was completed
ALTER TABLE [${flyway:defaultSchema}].[ConversationDetail]
ADD [CompletionTime] DATETIMEOFFSET NULL;
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Timestamp when the final AI response was completed and recorded for this conversation detail. Typically set when the Analysis Complete response is received by MJAPI.',
    @level0type = N'Schema', @level0name = N'${flyway:defaultSchema}',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (
         ...
         WHERE ID = 'e260b250-b168-4896-9757-cbd178b5ee2c'  OR 
      ...
      BEGIN
         ...
         VALUES
         (
            'e260b250-b168-4896-9757-cbd178b5ee2c',
            '12248F34-2837-EF11-86D4-6045BDEE16E6', -- Entity: Conversation Details
            17,
            'CompletionTime',
            'Completion Time',
            'Timestamp when the final AI response was completed and recorded for this conversation detail. Typically set when the Analysis Complete response is received by MJAPI.',
            'datetimeoffset',
            10,
            34,
            7,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (
         SELECT 1 FROM [${flyway:defaultSchema}].EntityField 
         WHERE ID = '8800e637-3355-42ad-ab75-49ba6e36f775'  OR 
      ...
      BEGIN
         ...
         VALUES
         (
            '8800e637-3355-42ad-ab75-49ba6e36f775',
...
INSERT INTO [${flyway:defaultSchema}].EntityFieldValue
                                    ...
                                    VALUES
                                       ('8800E637-3355-42AD-AB75-49BA6E36F775', 1, 'Processing', 'Processing')

/* SQL text to insert entity field values */
INSERT INTO [${flyway:defaultSchema}].EntityFieldValue
                                       (EntityFieldID, Sequence, Value, Code)
                                    VALUES
                                       ('8800E637-3355-42AD-AB75-49BA6E36F775', 2, 'Available', 'Available')

/* SQL text to update ValueListType for entity field ID 8800E637-3355-42AD-AB75-49BA6E36F775 */
UPDATE [${flyway:defaultSchema}].EntityField SET ValueListType='List' WHERE ID='8800E637-3355-42AD-AB75-49BA6E36F775'
