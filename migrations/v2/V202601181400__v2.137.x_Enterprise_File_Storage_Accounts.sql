...
CREATE TABLE [${flyway:defaultSchema}].[FileStorageAccount] (
    ...
    [__mj_CreatedAt] DATETIMEOFFSET NOT NULL CONSTRAINT [DF_FileStorageAccount___mj_CreatedAt] DEFAULT SYSDATETIMEOFFSET(),
    [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL CONSTRAINT [DF_FileStorageAccount___mj_UpdatedAt] DEFAULT SYSDATETIMEOFFSET(),
...
-- =============================================
-- The CodeGen output will be appended below this comment block after running:
-- 1. Apply this migration to a clean MJ 2.133.0 database
-- 2. Run CodeGen against the updated database
-- 3. Append the generated SQL to the end of this file
-- =============================================
