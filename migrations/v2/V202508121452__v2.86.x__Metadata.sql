-- SQL Logging Session
-- Session ID: a67a229b-e2d4-4386-9e98-f1f27adbabea
-- Started: 2025-08-12T19:50:55.137Z
-- Description: MetadataSync push operation
-- Format: Migration-ready with Flyway schema placeholders
-- Generated by MemberJunction SQLServerDataProvider

-- Save MJ: AI Agent Types (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateAIAgentType @Name = N'Loop',
@Description = N'Basic Agentic Loop Agent Type',
@SystemPromptID = 'FF7D441F-36E1-458A-B548-0FC2208923BE',
@IsActive = 1,
@AgentPromptPlaceholder = N'agentSpecificPrompt',
@DriverClass = N'LoopAgentType',
...
-- Save MJ: AI Agent Types (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateAIAgentType @Name = N'Flow',
@Description = N'Deterministic flow-based agent execution using a graph of predefined steps and conditional paths. Ideal for structured workflows with clear decision points.',
@SystemPromptID = NULL,
@IsActive = 1,
@AgentPromptPlaceholder = NULL,
@DriverClass = N'FlowAgentType',
@UIFormSectionKey = N'FlowAgentSection',
@UIFormKey = NULL,
@UIFormSectionExpandedByDefault = 1,
@ID = '4F6A189B-C068-4736-9F23-3FF540B40FDD';

-- Save MJ: Component Libraries (core SP call only)
EXEC [${flyway:defaultSchema}].spCreateComponentLibrary @ID = 'a56b41f5-2b8b-4ffc-85dd-89bd5e950c00',
@Name = N'dayjs',
@DisplayName = N'Day.js',
@Version = N'1.11.10',
@GlobalVariable = N'dayjs',
@Category = N'utility',
@CDNUrl = N'https://unpkg.com/dayjs@1.11.10/dayjs.min.js',
@CDNCssUrl = NULL,
@Description = N'Fast 2KB alternative to Moment.js with the same modern API';

-- Save MJ: Component Libraries (core SP call only)
EXEC [${flyway:defaultSchema}].spCreateComponentLibrary @ID = 'd5be17f8-a4f4-420c-80f0-cc8cbf38b49c',
@Name = N'antd',
@DisplayName = N'Ant Design',
@Version = N'5.20.2',
@GlobalVariable = N'antd',
@Category = N'ui',
@CDNUrl = N'https://unpkg.com/antd@5.20.2/dist/antd.min.js',
@CDNCssUrl = N'https://unpkg.com/antd@5.20.2/dist/reset.css',
@Description = N'Enterprise-class UI design language and React components';

-- Save MJ: Component Libraries (core SP call only)
EXEC [${flyway:defaultSchema}].spCreateComponentLibrary @ID = '2f89dfd3-fe02-4b9d-92ed-6fda0317632b',
@Name = N'd3',
@DisplayName = N'D3.js',
@Version = N'7.8.5',
@GlobalVariable = N'd3',
@Category = N'charting',
@CDNUrl = N'https://unpkg.com/d3@7.8.5/dist/d3.min.js',
@CDNCssUrl = NULL,
@Description = N'Data visualization library for creating custom charts';

-- Save MJ: Component Libraries (core SP call only)
EXEC [${flyway:defaultSchema}].spCreateComponentLibrary @ID = '198f2348-1bc4-4553-aac4-7042c501cfa6',
@Name = N'chart.js',
@DisplayName = N'Chart.js',
@Version = N'4.4.1',
@GlobalVariable = N'Chart',
@Category = N'charting',
@CDNUrl = N'https://unpkg.com/chart.js@4.4.1/dist/chart.umd.js',
@CDNCssUrl = NULL,
@Description = N'Simple yet flexible JavaScript charting library';

-- Save MJ: Components (core SP call only)
EXEC [${flyway:defaultSchema}].spCreateComponent @ID = '57066c89-06ef-4ab9-927e-4dfc59139f05',
@Namespace = NULL,
@Name = N'Entity Browser',
@Version = N'1.0.0',
@VersionSequence = 1,
@Title = N'Entity Browser',
@Description = N'A comprehensive multi-panel dashboard component for browsing and exploring entities in a data system. Features a three-panel layout with collapsible filters, main entity list (grid/card view), and sliding details panel.',
@Type = N'Dashboard',
@Status = N'Published',
@DeveloperName = NULL,
@DeveloperEmail = NULL,
  ...
  "dataRequirements": {
    ...
    "entities": [
      ...
      },
      {
        ...
        "displayFields": ["RelatedEntityName", "Type", "DisplayName", "ForeignKeyField"],
        "filterFields": ["EntityID"],
        "sortFields": ["Sequence", "RelatedEntityName"],
        "fieldMetadata": [
          {
            "name": "EntityID",
            "sequence": 1,
...
@FunctionalRequirements = N'## Entity Browser Requirements
...
- Visual feedback for hover and selection states
- Maintain scroll position when switching between entities',
@TechnicalDesign = N'## Technical Architecture
...
-- Session ID: a67a229b-e2d4-4386-9e98-f1f27adbabea
-- Completed: 2025-08-12T19:51:12.648Z
-- Duration: 17511ms
-- Total Statements: 7
...
-- SQL Logging Session
-- Session ID: 2b1bfe09-e1b6-4642-ad45-9ded58b2a889
-- Started: 2025-08-12T19:54:28.006Z
-- Description: MetadataSync push operation
-- Format: Migration-ready with Flyway schema placeholders
-- Generated by MemberJunction SQLServerDataProvider

-- Save MJ: Components (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateComponent @Namespace = NULL,
@Name = N'Entity Browser',
@Version = N'1.0.0',
@VersionSequence = 1,
@Title = N'Entity Browser',
...
-- End of SQL Logging Session
-- Session ID: 2b1bfe09-e1b6-4642-ad45-9ded58b2a889
-- Completed: 2025-08-12T19:54:44.844Z
-- Duration: 16838ms
-- Total Statements: 1
