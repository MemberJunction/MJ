...
EXEC [__mj].spUpdateAction @CategoryID = '15E03732-607E-4125-86F4-8C846EE88749',
...
-- Save Actions (core SP call only)
EXEC [__mj].spUpdateAction @CategoryID = '65E048AA-5220-4E4D-920A-A3D9349902A7',
...
-- Save Actions (core SP call only)
EXEC [__mj].spUpdateAction @CategoryID = 'B51957C7-990F-4CA7-BBFF-93ED507CE466',
@Name = 'Get Weather',
...
-- Save Actions (core SP call only)
EXEC [__mj].spUpdateAction @CategoryID = 'E959A850-7842-456D-AB51-F232DF12E709',
...
-- Save Actions (core SP call only)
EXEC [__mj].spUpdateAction @CategoryID = '095EC184-0AAB-4122-A9B9-B64F0215F7DA',
@Name = 'Web Search',
...
-- Save Actions (core SP call only)
EXEC [__mj].spUpdateAction @CategoryID = '0AC137DD-7E2F-4A57-AFE3-688D097B594F',
@Name = 'Create Agent',
...
EXEC [__mj].spUpdateAIPromptModel @PromptID = '96BCAE1C-B1F0-4FC4-9988-54B067BC962A',
...
EXEC [__mj].spUpdateAIAgent @Name = 'Demo Loop Agent',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Marketing Agent',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Copywriter Agent',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'SEO AIEO Specialist Agent',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Editor Agent',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Brand Guardian Agent',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Publisher Agent',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Agent Manager',
...
EXEC [__mj].spCreateAIAgentAction @ID = '9e6e5ca6-f357-45e0-b8fa-05a4e1967ea2',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = 'cdad6d7f-a1a2-40e4-a34c-a133b6dcba1e',
@AgentID = 'E1691AE0-00BB-4414-A74D-F7F36D348A06',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = 'b9848425-ae9e-4d55-944d-721a2d3bea06',
@AgentID = 'E1691AE0-00BB-4414-A74D-F7F36D348A06',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = 'd9c16645-1c1b-4b2f-ab38-c6bd00f2eff6',
@AgentID = 'E1691AE0-00BB-4414-A74D-F7F36D348A06',
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Requirements Analyst Agent',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = '2ea67fad-e5f5-45b7-9cb0-574f2084ad55',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = '80761138-b0da-4a63-94b4-ec89b45e6f2e',
@AgentID = 'A15E6AC3-CE68-4D08-A52A-505019BB2099',
@ActionID = '82169F64-8566-4AE7-9C87-190A885C98A9',
@Status = 'Active';
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = 'c34dcd7b-1172-4eeb-96ff-6f91bccef826',
@AgentID = 'A15E6AC3-CE68-4D08-A52A-505019BB2099',
@ActionID = '81F96534-03F5-49E9-81B0-D8902A7645A3',
@Status = 'Active';
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Planning Designer Agent',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = 'ab097138-fc39-439b-add4-ea0a8f7bbb24',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = '658b7296-90d7-4c2f-beff-1485e981e46b',
@AgentID = '644674DB-7791-44C4-8360-3914111C0E10',
@ActionID = '82169F64-8566-4AE7-9C87-190A885C98A9',
@Status = 'Active';
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = '11b2d45a-fd00-47b1-bf61-62b9f9d27f91',
@AgentID = '644674DB-7791-44C4-8360-3914111C0E10',
@ActionID = '81F96534-03F5-49E9-81B0-D8902A7645A3',
@Status = 'Active';
...
-- Save AI Agents (core SP call only)
EXEC [__mj].spUpdateAIAgent @Name = 'Prompt Designer Agent',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = '0a8acfee-6c1e-448b-857e-4f027e1a45cd',
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = '5a60fae6-500f-4e3c-98c9-47cdbe4db1e8',
@AgentID = '82323658-FD6D-4F06-BAE5-39A0945C9DC0',
@ActionID = '82169F64-8566-4AE7-9C87-190A885C98A9',
@Status = 'Active';
...
-- Save AI Agent Actions (core SP call only)
EXEC [__mj].spCreateAIAgentAction @ID = 'c5d131bd-064f-497d-ad70-461f6a626573',
@AgentID = '82323658-FD6D-4F06-BAE5-39A0945C9DC0',
@ActionID = '81F96534-03F5-49E9-81B0-D8902A7645A3',
@Status = 'Active';
