-- SQL Logging Session
-- Session ID: b7d9433d-55b2-49e1-9ffc-a127ab3ad45b
-- Started: 2025-06-29T14:02:10.084Z
...
@Description = N'Number of sub-agents available to the agent; controls conditional rendering of sub-agent-related instructions and capabilities',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
...
@Description = N'Name of the parent agent to determine if current agent is top-level or sub-agent',
@Type = N'Scalar',
@DefaultValue = N'',
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Details about available sub-agents to display to the user',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Agent-specific instructions or specialized prompt content to include in the system prompt',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'agentName',
@Description = N'Name of the current AI agent, used for specialization details',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Details of available actions to display to the user',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Description of the AI agent''s role or capabilities',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'actionCount',
@Description = N'Number of available actions that the agent can perform, controls conditional rendering of action-related sections',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
-- Session ID: b7d9433d-55b2-49e1-9ffc-a127ab3ad45b
-- Completed: 2025-06-29T14:02:28.308Z
-- Duration: 18224ms
-- Total Statements: 13
