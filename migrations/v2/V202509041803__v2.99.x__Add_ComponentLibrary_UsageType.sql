-- Add UsageType column to Component Libraries for controlling library access
-- UsageType values:
--   'Direct' = Can be used directly by components
--   'Dependency' = Only loaded as a dependency of other libraries
--   'Both' = Can be used either directly or as a dependency (default)

-- Add UsageType column with default value
ALTER TABLE [${flyway:defaultSchema}].[ComponentLibrary]
ADD UsageType NVARCHAR(50) NOT NULL DEFAULT 'Both';
GO
-- Add check constraint to ensure valid values
ALTER TABLE [${flyway:defaultSchema}].[ComponentLibrary]
ADD CONSTRAINT CK_ComponentLibrary_UsageType 
CHECK (UsageType IN ('Direct', 'Dependency', 'Both'));
GO
-- Add extended property for documentation
EXEC sp_addextendedproperty 
    @name = N'MS_Description',
    @value = N'Controls how the library can be used: Direct (by components), Dependency (only as dependency), or Both',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = 'ComponentLibrary',
    @level2type = N'COLUMN', @level2name = 'UsageType';
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (
         ...
         WHERE ID = 'fd030e2a-3a2e-427f-971c-9d1caed65a8b'  OR 
               (EntityID = '2264AA9A-2197-48E2-BB3D-A498006B37A5' AND Name = 'UsageType')
      ...
      BEGIN
         ...
         VALUES
         (
            'fd030e2a-3a2e-427f-971c-9d1caed65a8b',
            '2264AA9A-2197-48E2-BB3D-A498006B37A5', -- Entity: MJ: Component Libraries
            100015,
            'UsageType',
            'Usage Type',
            'Controls how the library can be used: Direct (by components), Dependency (only as dependency), or Both',
            'nvarchar',
            100,
            0,
            0,
...
/* SQL text to delete entity field value ID 10FC453E-F36B-1410-8DC3-00021F8B792E */
DELETE FROM [${flyway:defaultSchema}].EntityFieldValue WHERE ID='10FC453E-F36B-1410-8DC3-00021F8B792E'

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].EntityFieldValue SET Sequence=7 WHERE ID='C0FC453E-F36B-1410-8DC3-00021F8B792E'

/* SQL text to delete entity field value ID 1FFC453E-F36B-1410-8DC3-00021F8B792E */
DELETE FROM [${flyway:defaultSchema}].EntityFieldValue WHERE ID='1FFC453E-F36B-1410-8DC3-00021F8B792E'
...
/* SQL text to update entity field related entity name field map for entity field ID B6F5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='B6F5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ResourceType'

/* SQL text to update entity field related entity name field map for entity field ID C6F5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='C6F5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='Role'

/* SQL text to update entity field related entity name field map for entity field ID CAF5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='CAF5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='User'

/* SQL text to update entity field related entity name field map for entity field ID 08F6453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='08F6453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='User'

/* SQL text to update entity field related entity name field map for entity field ID 0FF6453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='0FF6453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ResourceType'
...
/* SQL text to update entity field related entity name field map for entity field ID 9AF4453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='9AF4453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='Source'

/* SQL text to update entity field related entity name field map for entity field ID B5F4453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='B5F4453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentType'

/* SQL text to update entity field related entity name field map for entity field ID B8F4453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='B8F4453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentSourceType'

/* SQL text to update entity field related entity name field map for entity field ID BBF4453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='BBF4453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentFileType'

/* SQL text to update entity field related entity name field map for entity field ID CAF4453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='CAF4453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentSource'

/* SQL text to update entity field related entity name field map for entity field ID 09F5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='09F5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='AIModel'

/* SQL text to update entity field related entity name field map for entity field ID 3FF5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='3FF5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentSource'

/* SQL text to update entity field related entity name field map for entity field ID 63F5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='63F5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentItem'

/* SQL text to update entity field related entity name field map for entity field ID 75F5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='75F5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='Item'

/* SQL text to update entity field related entity name field map for entity field ID 48F5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='48F5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentType'

/* SQL text to update entity field related entity name field map for entity field ID 4BF5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='4BF5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentSourceType'

/* SQL text to update entity field related entity name field map for entity field ID 4EF5453E-F36B-1410-8DC3-00021F8B792E */
EXEC [${flyway:defaultSchema}].spUpdateEntityFieldRelatedEntityNameFieldMap
         @EntityFieldID='4EF5453E-F36B-1410-8DC3-00021F8B792E',
         @RelatedEntityNameFieldMap='ContentFileType'

/* Generated Validation Functions for MJ: Component Libraries */
-- CHECK constraint for MJ: Component Libraries: Field: UsageType was newly set or modified since the last generation of the validation function, the code was regenerated and updating the GeneratedCode table with the new generated validation function
INSERT INTO [${flyway:defaultSchema}].[GeneratedCode] (CategoryID, GeneratedByModelID, GeneratedAt, Language, Status, Source, Code, Description, Name, LinkedEntityID, LinkedRecordPrimaryKey)
                      VALUES ((SELECT ID FROM ${flyway:defaultSchema}.vwGeneratedCodeCategories WHERE Name='CodeGen: Validators'), '287E317F-BF26-F011-A770-AC1A3D21423D', GETUTCDATE(), 'TypeScript','Approved', '([UsageType]=''Both'' OR [UsageType]=''Dependency'' OR [UsageType]=''Direct'' OR [UsageType] IS NULL)', 'public ValidateUsageTypeAgainstAllowedValues(result: ValidationResult) {
	if (
		this.UsageType !== null &&
		this.UsageType !== "Both" &&
		this.UsageType !== "Dependency" &&
		this.UsageType !== "Direct"
	) {
		result.Errors.push(new ValidationErrorInfo("UsageType", "UsageType, if provided, must be \"Both\", \"Dependency\", or \"Direct\".", this.UsageType, ValidationErrorType.Failure));
	}
}', 'This rule ensures that the UsageType field, if specified, can only be set to "Both", "Dependency", or "Direct". Alternatively, it can be left blank.', 'ValidateUsageTypeAgainstAllowedValues', 'DF238F34-2837-EF11-86D4-6045BDEE16E6', 'FD030E2A-3A2E-427F-971C-9D1CAED65A8B');
...
INSERT INTO [${flyway:defaultSchema}].EntityFieldValue
                                    ...
                                    VALUES
                                       ('FD030E2A-3A2E-427F-971C-9D1CAED65A8B', 1, 'Direct', 'Direct')

/* SQL text to insert entity field values */
INSERT INTO [${flyway:defaultSchema}].EntityFieldValue
                                       (EntityFieldID, Sequence, Value, Code)
                                    VALUES
                                       ('FD030E2A-3A2E-427F-971C-9D1CAED65A8B', 2, 'Dependency', 'Dependency')

/* SQL text to insert entity field values */
INSERT INTO [${flyway:defaultSchema}].EntityFieldValue
                                       (EntityFieldID, Sequence, Value, Code)
                                    VALUES
                                       ('FD030E2A-3A2E-427F-971C-9D1CAED65A8B', 3, 'Both', 'Both')

/* SQL text to update ValueListType for entity field ID FD030E2A-3A2E-427F-971C-9D1CAED65A8B */
UPDATE [${flyway:defaultSchema}].EntityField SET ValueListType='List' WHERE ID='FD030E2A-3A2E-427F-971C-9D1CAED65A8B'
