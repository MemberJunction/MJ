-- SQL Logging Session
-- Session ID: f735b583-1133-4132-8ae1-98f0b0be44a3
-- Started: 2025-07-07T11:50:54.885Z
...
@Description = N'Number of sub-agents available to this agent; used to determine availability and messaging of sub-agents',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
...
@Description = N'Name of the parent agent if this agent is a sub-agent; used to determine role and messaging',
@Type = N'Scalar',
@DefaultValue = N'',
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Details of sub-agents available, rendered safely as HTML or formatted content',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Specialized prompt details or instructions specific to the agent, safely rendered',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'agentName',
@Description = N'Name of the agent persona currently executing the template',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Details of actions that the agent can perform, outputted safely for display',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Description of the agent persona; rendered safely to preserve formatting',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'actionCount',
@Description = N'Number of actions available to this agent; influences capability messaging and control flow',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
-- Session ID: f735b583-1133-4132-8ae1-98f0b0be44a3
-- Completed: 2025-07-07T11:51:30.425Z
-- Duration: 35540ms
-- Total Statements: 10
