-- SQL Logging Session
-- Session ID: 5fec2971-a393-4372-a13e-f19c6d500d28
-- Started: 2025-07-01T01:40:41.438Z
...
@Description = N'Details of sub-agents available to this agent, rendered as safe HTML or formatted text',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Specific specialization instructions and details for the agent',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'agentName',
@Description = N'The name of the agent persona executing the prompt',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Details of actions available to this agent, rendered as safe HTML or formatted text',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Represents the current state of the agent''s payload, rendered as a safely dumped string',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '7793EEDE-21DC-459E-A17F-E6E80F9D0590';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'agentDescription',
@Description = N'Description of the agent persona and its specialized instructions',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
-- Session ID: 5fec2971-a393-4372-a13e-f19c6d500d28
-- Completed: 2025-07-01T01:41:11.944Z
-- Duration: 30506ms
-- Total Statements: 12
