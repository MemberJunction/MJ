-- SQL Logging Session
-- Session ID: 3a008c60-5b99-4a91-b955-b3d1ba05fcc9
-- Started: 2025-07-08T17:00:46.988Z
...
@Description = N'Number of sub-agents available to this agent, controlling conditional sections and displayed counts',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
...
@Description = N'Name of the parent agent, used to determine if this agent is top-level or a sub-agent',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Details about the sub-agents available, shown as HTML or safe text',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Agent-specific specialization instructions or prompts, shown with safe filter',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'agentName',
@Description = N'The name of the current agent, used for display in the specialization section',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Details about the available actions, shown as HTML or safe text',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@Description = N'Description of the current agent''s role and capabilities, shown with safe filter',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '8E5F83E5-837B-4C53-9171-08272BF605A4',
@Name = N'actionCount',
@Description = N'Number of actions available to the agent, controlling conditional sections and displayed counts',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'IsChildAction',
@Description = N'Flag indicating whether the action to create is a child action',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '16D65BC5-D2B3-4ABF-9888-084E1750E997';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'resultCodes',
@Description = N'List of result codes that the action should be able to return',
@Type = N'Array',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '88DD9EC0-C8E6-4B1B-8606-1A6B44FBE819';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'userPrompt',
@Description = N'User request description that guides code generation',
@Type = N'Scalar',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '5FE2390C-8C2F-4070-AEA1-2F19B9DB5B5A';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'actionParams',
@Description = N'Parameters available to the action to receive and use',
@Type = N'Array',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '33EA249E-A9E6-43E2-9C13-792A1DB23017';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'parentAction',
@Description = N'The parent action details including Category, Name, and ID used to invoke the parent action',
@Type = N'Object',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '48964DAC-F239-49D3-BCC6-A6BCE2EF3039';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'ChildActionInfo',
@Description = N'Context information about the parent action for the child action',
@Type = N'Object',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '3561CB95-B4D9-4CCE-A8C6-B1ED771A045C';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'availableLibraries',
@Description = N'List of optional libraries available to the action for use if needed',
@Type = N'Array',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = 'CBAC6588-6718-411A-9F15-C89E324DBCB7';

-- Save Template Params (core SP call only)
EXEC [${flyway:defaultSchema}].spUpdateTemplateParam @TemplateID = '2F4D341A-CDE0-4473-9CAC-2E2E9220FEE1',
@Name = N'entityInfo',
@Description = N'Information about system entities including tables and columns',
@Type = N'Object',
@DefaultValue = NULL,
@IsRequired = 0,
@LinkedParameterName = NULL,
...
@OrderBy = NULL,
@TemplateContentID = NULL,
@ID = '196C383F-3475-49C9-BBD9-FAACE2DF58DE';
...
-- Session ID: 3a008c60-5b99-4a91-b955-b3d1ba05fcc9
-- Completed: 2025-07-08T17:01:28.083Z
-- Duration: 41095ms
-- Total Statements: 20
