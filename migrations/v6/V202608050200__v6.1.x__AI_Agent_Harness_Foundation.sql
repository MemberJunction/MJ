...
-- deployment-specific (a sandbox image with `codex` installed and one without
...
CREATE TABLE [${flyway:defaultSchema}].[AIAgentHarness] (
    [ID]                 UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_AIAgentHarness_ID] DEFAULT (newsequentialid()),
    [Name]               NVARCHAR(100)    NOT NULL,
    [Description]        NVARCHAR(MAX)    NULL,
    [DriverClass]        NVARCHAR(255)    NOT NULL,
    [ExecutablePath]     NVARCHAR(500)    NULL,
    [AIVendorID]         UNIQUEIDENTIFIER NULL,
    [DefaultModel]       NVARCHAR(255)    NULL,
    [CapabilitySettings] NVARCHAR(MAX)    NULL,
    [Status]             NVARCHAR(20)     NOT NULL CONSTRAINT [DF_AIAgentHarness_Status] DEFAULT (N'Active'),
    CONSTRAINT [PK_AIAgentHarness] PRIMARY KEY CLUSTERED ([ID]),
    CONSTRAINT [FK_AIAgentHarness_AIVendor] FOREIGN KEY ([AIVendorID]) REFERENCES [${flyway:defaultSchema}].[AIVendor]([ID]),
    CONSTRAINT [CK_AIAgentHarness_Status] CHECK ([Status] IN (N'Active', N'Inactive')),
...
CREATE TABLE [${flyway:defaultSchema}].[AIAgentCredential] (
    [ID]              UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_AIAgentCredential_ID] DEFAULT (newsequentialid()),
    [AgentID]         UNIQUEIDENTIFIER NOT NULL,
    [CredentialID]    UNIQUEIDENTIFIER NOT NULL,
    [Purpose]         NVARCHAR(50)     NOT NULL,
    [EnvVariableName] NVARCHAR(100)    NULL,
    [Priority]        INT              NOT NULL CONSTRAINT [DF_AIAgentCredential_Priority] DEFAULT (0),
    [Status]          NVARCHAR(20)     NOT NULL CONSTRAINT [DF_AIAgentCredential_Status] DEFAULT (N'Active'),
    CONSTRAINT [PK_AIAgentCredential] PRIMARY KEY CLUSTERED ([ID]),
    CONSTRAINT [FK_AIAgentCredential_Agent]      FOREIGN KEY ([AgentID])      REFERENCES [${flyway:defaultSchema}].[AIAgent]([ID]),
    CONSTRAINT [FK_AIAgentCredential_Credential] FOREIGN KEY ([CredentialID]) REFERENCES [${flyway:defaultSchema}].[Credential]([ID]),
    CONSTRAINT [CK_AIAgentCredential_Purpose] CHECK ([Purpose] IN (N'HarnessLLM', N'Integration')),
    CONSTRAINT [CK_AIAgentCredential_Status]  CHECK ([Status] IN (N'Active', N'Revoked', N'Pending')),
...
ALTER TABLE [${flyway:defaultSchema}].[AIAgentRun]
    ADD [ExternalSessionID] NVARCHAR(255) NULL;
GO
...
EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Registry of external agent harnesses this installation can launch as the reasoning substrate for an MJ agent (Claude Code, Codex CLI, OpenCode, Pi, Cline). A row makes a harness AVAILABLE; an agent opts in by naming it in AIAgent.TypeConfiguration. Empty table = no agent can run on a harness, which is the pre-migration behaviour.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness';
GO

EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Unique name of the harness, e.g. Claude Code, Codex CLI, OpenCode, Pi, Cline. This is a LOOKUP KEY, not a label: an agent selects its harness by this name in AIAgent.TypeConfiguration ("harnessName"), so duplicates would make selection ambiguous at run time.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness',
...
EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Human-readable description of the harness - what it is good at, what it requires to be installed, and any deployment caveats.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness',
...
EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'ClassFactory registration key for the BaseHarnessAdapter subclass that drives this harness (e.g. ClaudeCodeAdapter, CodexAdapter, StdioJsonAdapter). Resolved at run time, so a customer can register a proprietary adapter without forking core - the same extension mechanism AI model vendor drivers use.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness',
...
EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Path to the harness CLI binary or entry point when the adapter shells out. NULL when the adapter embeds a vendor SDK and therefore launches nothing.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness',
 @level2type=N'COLUMN',@level2name=N'ExecutablePath';
GO

EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Default model passed to the harness where the harness supports being told which model to use. NULL leaves the harness on its own default.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness',
 @level2type=N'COLUMN',@level2name=N'DefaultModel';
GO

EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Strongly-typed JSON of what this harness can do (the IHarnessCapabilitySettings interface, bound via JSONType metadata): session continuity (SessionResume), turn-protocol support (StructuredOutput), in-sandbox permission interception (PermissionHooks), and whether the harness can act as an MCP client for the read-only loopback (McpClient). The runtime gates behaviour on these - when SessionResume is false the adapter must replay prior context into a fresh invocation each turn, which costs extra tokens and has to be budgeted for. Held as JSON so a new capability needs no schema migration, just an added property on the interface. NULL/omitted = not supported.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness',
 @level2type=N'COLUMN',@level2name=N'CapabilitySettings';
GO

EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Whether this harness may be launched. Inactive keeps the row and its history for auditing while taking the harness out of service - preferable to deleting it, which would orphan agents configured to use it.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentHarness',
...
EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Environment variable the adapter sets inside the sandbox for this credential, e.g. ANTHROPIC_API_KEY or GITHUB_TOKEN. NULL lets the adapter choose, which is the normal case for HarnessLLM because the adapter knows its own vendor''s variable name.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentCredential',
 @level2type=N'COLUMN',@level2name=N'EnvVariableName';
GO

EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Failover ordering within a Purpose - lower runs first. Lets an agent carry a primary and a standby key for the same purpose without a schema change.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentCredential',
...
EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Whether this grant is live. Revoked withdraws the credential from future sessions while preserving the record that it was once granted, which is the point of auditing a credential grant at all. Pending stages a grant that is not yet in force.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentCredential',
 @level2type=N'COLUMN',@level2name=N'Status';
GO
...
EXEC sp_addextendedproperty @name=N'MS_Description',
 @value=N'Session identifier reported by the external harness backing this run. Kept for two reasons that outlive the run: resuming the session across turns, and correlating this run with the vendor''s own session logs when diagnosing behaviour INSIDE the sandbox, where MJ''s audit trail necessarily stops at the turn boundary. NULL for every run not backed by a harness.',
 @level0type=N'SCHEMA',@level0name=N'${flyway:defaultSchema}',
 @level1type=N'TABLE', @level1name=N'AIAgentRun',
 @level2type=N'COLUMN',@level2name=N'ExternalSessionID';
GO
...
-- ============================================================================
--
-- Produced by `mj codegen` run against MJ_6_1_0 at the repo's CURRENT migration
-- head with this migration's hand-written DDL applied and nothing else
-- outstanding.
--
-- WHAT IT CONTAINS
...
--   · Base views, spCreate / spUpdate / spDelete routines, and permission grants
...
--
-- HOW THIS BLOCK GOES SILENTLY WRONG (both failure modes hit in this repo
-- before — see V202607290900__v5.50.x__Scoped_Search_Dimensional_Bounds.sql):
--
...
--      name" from inside the update trigger. VERIFIED NOT THE CASE HERE: the
--      ALTERs for both AIAgentCredential and AIAgentHarness are present below.
...
-- (metadata/CLAUDE.md rule 1b). The CodeGen pass that followed that push
-- emitted no additional SQL, because the binding changes TypeScript generation
-- rather than schema.
-- ============================================================================
...
/* SQL generated to create new entity MJ: AI Agent Harnesses */
      ...
      VALUES (
         'eadec5c5-a09e-4fbc-b81a-a537a51b83a2',
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', 'eadec5c5-a09e-4fbc-b81a-a537a51b83a2', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Harnesses for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('eadec5c5-a09e-4fbc-b81a-a537a51b83a2', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Harnesses for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('eadec5c5-a09e-4fbc-b81a-a537a51b83a2', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Harnesses for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('eadec5c5-a09e-4fbc-b81a-a537a51b83a2', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
/* SQL generated to create new entity MJ: AI Agent Credentials */
      ...
      VALUES (
         'bd38c743-5c21-4fa3-9240-28e561c06e7b',
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', 'bd38c743-5c21-4fa3-9240-28e561c06e7b', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Credentials for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('bd38c743-5c21-4fa3-9240-28e561c06e7b', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Credentials for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('bd38c743-5c21-4fa3-9240-28e561c06e7b', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Credentials for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('bd38c743-5c21-4fa3-9240-28e561c06e7b', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentCredential] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
UPDATE [${flyway:defaultSchema}].[AIAgentCredential] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentCredential] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentCredential] ADD CONSTRAINT [DF___mj_AIAgentCredential___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt];
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentCredential] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
UPDATE [${flyway:defaultSchema}].[AIAgentCredential] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentCredential] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentCredential */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentCredential] ADD CONSTRAINT [DF___mj_AIAgentCredential___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt];
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentHarness] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
UPDATE [${flyway:defaultSchema}].[AIAgentHarness] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentHarness] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentHarness] ADD CONSTRAINT [DF___mj_AIAgentHarness___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt];
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentHarness] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
UPDATE [${flyway:defaultSchema}].[AIAgentHarness] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentHarness] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentHarness */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentHarness] ADD CONSTRAINT [DF___mj_AIAgentHarness___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt];
GO

/* SQL text to insert 21 new entity field(s) */

      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '36818ec4-4a54-4a84-95ef-702517f32492' OR (EntityID = '5190AF93-4C39-4429-BDAA-0AEB492A0256' AND Name = 'ExternalSessionID')) BEGIN
         ...
         VALUES
         (
            '36818ec4-4a54-4a84-95ef-702517f32492',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3706190e-df70-4873-8242-1c76368bc7c8' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '3706190e-df70-4873-8242-1c76368bc7c8',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100001,
            'ID',
            'ID',
            NULL,
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5f0bf439-6ee8-469f-9d5a-e871f0d28c0d' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'AgentID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '5f0bf439-6ee8-469f-9d5a-e871f0d28c0d',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100002,
            'AgentID',
            'Agent ID',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '19432288-4e78-4c77-a466-e7eab051dda1' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'CredentialID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '19432288-4e78-4c77-a466-e7eab051dda1',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100003,
            'CredentialID',
            'Credential ID',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '03da5fcf-e03d-4a30-9f74-a9d6c620c3eb' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'Purpose')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '03da5fcf-e03d-4a30-9f74-a9d6c620c3eb',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100004,
            'Purpose',
            'Purpose',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '641f156d-4244-4ed6-ad24-2accd5c2cffa' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'EnvVariableName')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '641f156d-4244-4ed6-ad24-2accd5c2cffa',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100005,
            'EnvVariableName',
            'Env Variable Name',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6dae8a18-50ae-48d2-b56c-088a9b9ba260' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'Priority')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '6dae8a18-50ae-48d2-b56c-088a9b9ba260',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100006,
            'Priority',
            'Priority',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '66a535fa-febf-41ec-9c16-9f2fcc933b6e' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'Status')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '66a535fa-febf-41ec-9c16-9f2fcc933b6e',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100007,
            'Status',
            'Status',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '248bba77-a9b3-47b5-9cd3-cb9878132707' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '248bba77-a9b3-47b5-9cd3-cb9878132707',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100008,
            '__mj_CreatedAt',
            'Created At',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a39f8496-ba72-4f6d-839f-0d73835742db' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a39f8496-ba72-4f6d-839f-0d73835742db',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100009,
            '__mj_UpdatedAt',
            'Updated At',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b44d2284-3a80-4783-ab5b-a7aec8a9997f' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'b44d2284-3a80-4783-ab5b-a7aec8a9997f',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100001,
            'ID',
            'ID',
            NULL,
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7aaa8bde-29c6-4ebd-85a2-c1c133ab67ed' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7aaa8bde-29c6-4ebd-85a2-c1c133ab67ed',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100002,
            'Name',
            'Name',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'dd4179f7-87df-4216-80dd-7249d072bb56' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'dd4179f7-87df-4216-80dd-7249d072bb56',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100003,
            'Description',
            'Description',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4ee2c6bb-ec38-44c7-b416-0b54fff69c41' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'DriverClass')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '4ee2c6bb-ec38-44c7-b416-0b54fff69c41',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100004,
            'DriverClass',
            'Driver Class',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a81759ea-cff3-4ede-89a8-2e32b215d681' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'ExecutablePath')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a81759ea-cff3-4ede-89a8-2e32b215d681',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100005,
            'ExecutablePath',
            'Executable Path',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a4164168-f4b7-4993-b615-a611509b96d6' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'AIVendorID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a4164168-f4b7-4993-b615-a611509b96d6',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100006,
            'AIVendorID',
            'AI Vendor ID',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6873039c-5300-4ba8-9d41-b3fad5569690' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'DefaultModel')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '6873039c-5300-4ba8-9d41-b3fad5569690',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100007,
            'DefaultModel',
            'Default Model',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e5c5ce1f-3ee9-486e-92f7-f05dddc59474' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'CapabilitySettings')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e5c5ce1f-3ee9-486e-92f7-f05dddc59474',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100008,
            'CapabilitySettings',
            'Capability Settings',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '68e7ea99-dfaa-4b91-a230-b3dbb0acc13b' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'Status')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '68e7ea99-dfaa-4b91-a230-b3dbb0acc13b',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100009,
            'Status',
            'Status',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1a124386-664a-4e7a-af69-a5b3c4e5d5fc' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '1a124386-664a-4e7a-af69-a5b3c4e5d5fc',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100010,
            '__mj_CreatedAt',
            'Created At',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '52789d4c-fffb-41f9-9c79-e97ad2310a4a' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '52789d4c-fffb-41f9-9c79-e97ad2310a4a',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100011,
            '__mj_UpdatedAt',
            'Updated At',
...
/* SQL text to insert entity field value with ID 4a5afa54-60e7-408c-915b-1a7f8884f5ba */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('4a5afa54-60e7-408c-915b-1a7f8884f5ba', '68E7EA99-DFAA-4B91-A230-B3DBB0ACC13B', 1, 'Active', 'Active', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 766fc69a-0c3f-4a70-9891-e9287acb1dce */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('766fc69a-0c3f-4a70-9891-e9287acb1dce', '68E7EA99-DFAA-4B91-A230-B3DBB0ACC13B', 2, 'Inactive', 'Inactive', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID 68E7EA99-DFAA-4B91-A230-B3DBB0ACC13B */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='68E7EA99-DFAA-4B91-A230-B3DBB0ACC13B';

/* SQL text to insert entity field value with ID c536342e-8ac0-44fb-bc5a-bcc145cf3254 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('c536342e-8ac0-44fb-bc5a-bcc145cf3254', '03DA5FCF-E03D-4A30-9F74-A9D6C620C3EB', 1, 'HarnessLLM', 'HarnessLLM', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 3eabcee1-cb8d-4e9b-8981-00fe6df577e1 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('3eabcee1-cb8d-4e9b-8981-00fe6df577e1', '03DA5FCF-E03D-4A30-9F74-A9D6C620C3EB', 2, 'Integration', 'Integration', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID 03DA5FCF-E03D-4A30-9F74-A9D6C620C3EB */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='03DA5FCF-E03D-4A30-9F74-A9D6C620C3EB';

/* SQL text to insert entity field value with ID 017e2f14-c9ac-41e4-9c78-4cf940c60c11 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('017e2f14-c9ac-41e4-9c78-4cf940c60c11', '66A535FA-FEBF-41EC-9C16-9F2FCC933B6E', 1, 'Active', 'Active', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 74f97aec-eb13-4da0-9bbf-d1f0f7ac620f */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('74f97aec-eb13-4da0-9bbf-d1f0f7ac620f', '66A535FA-FEBF-41EC-9C16-9F2FCC933B6E', 2, 'Pending', 'Pending', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 043e8929-f7aa-40ca-9a87-49f95eaad5a5 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('043e8929-f7aa-40ca-9a87-49f95eaad5a5', '66A535FA-FEBF-41EC-9C16-9F2FCC933B6E', 3, 'Revoked', 'Revoked', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID 66A535FA-FEBF-41EC-9C16-9F2FCC933B6E */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='66A535FA-FEBF-41EC-9C16-9F2FCC933B6E';


/* Create Entity Relationship: MJ: AI Vendors -> MJ: AI Agent Harnesses (One To Many via AIVendorID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '58df242b-dae1-4921-9e46-cc41bf88b869'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('58df242b-dae1-4921-9e46-cc41bf88b869', 'D95A17EE-5750-4218-86AD-10F06E4DFBCA', 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', 'AIVendorID', 'One To Many', 1, 1, 10, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: AI Agents -> MJ: AI Agent Credentials (One To Many via AgentID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '8e1e4b26-c4ee-411d-88c3-21b0be2244fb'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('8e1e4b26-c4ee-411d-88c3-21b0be2244fb', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', 'BD38C743-5C21-4FA3-9240-28E561C06E7B', 'AgentID', 'One To Many', 1, 1, 38, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: Credentials -> MJ: AI Agent Credentials (One To Many via CredentialID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'bf60d52a-1f8c-4489-bd25-70b6747f18d9'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('bf60d52a-1f8c-4489-bd25-70b6747f18d9', '7E023DDF-82C6-4B0C-9650-8D35699B9FD0', 'BD38C743-5C21-4FA3-9240-28E561C06E7B', 'CredentialID', 'One To Many', 1, 1, 10, GETUTCDATE(), GETUTCDATE())
   END;

/* Index for Foreign Keys for AIAgentCredential */
-----------------------------------------------------------------
-- SQL Code Generation
...
-----------------------------------------------------------------
-- Index for foreign key AgentID in table AIAgentCredential
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_AIAgentCredential_AgentID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentCredential]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentCredential_AgentID ON [${flyway:defaultSchema}].[AIAgentCredential] ([AgentID]);

-- Index for foreign key CredentialID in table AIAgentCredential
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_AIAgentCredential_CredentialID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentCredential]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentCredential_CredentialID ON [${flyway:defaultSchema}].[AIAgentCredential] ([CredentialID]);

/* SQL text to update entity field related entity name field map for entity field ID 5F0BF439-6EE8-469F-9D5A-E871F0D28C0D */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='5F0BF439-6EE8-469F-9D5A-E871F0D28C0D', @RelatedEntityNameFieldMap='Agent';

/* SQL text to update entity field related entity name field map for entity field ID 19432288-4E78-4C77-A466-E7EAB051DDA1 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='19432288-4E78-4C77-A466-E7EAB051DDA1', @RelatedEntityNameFieldMap='Credential';

/* Base View SQL for MJ: AI Agent Credentials */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Credentials
-- Item: vwAIAgentCredentials
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- BASE VIEW FOR ENTITY:      MJ: AI Agent Credentials
-----               SCHEMA:      ${flyway:defaultSchema}
-----               BASE TABLE:  AIAgentCredential
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[vwAIAgentCredentials]', 'V') IS NOT NULL
    DROP VIEW [${flyway:defaultSchema}].[vwAIAgentCredentials];
GO

CREATE VIEW [${flyway:defaultSchema}].[vwAIAgentCredentials]
AS
SELECT
    a.*,
...
FROM
    [${flyway:defaultSchema}].[AIAgentCredential] AS a
INNER JOIN
...
GO
GRANT SELECT ON [${flyway:defaultSchema}].[vwAIAgentCredentials] TO [cdp_UI], [cdp_Developer], [cdp_Integration];
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spCreateAIAgentCredential]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentCredential];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentCredential]
    @ID uniqueidentifier = NULL,
    @AgentID uniqueidentifier,
    @CredentialID uniqueidentifier,
    @Purpose nvarchar(50),
    @EnvVariableName_Clear bit = 0,
    @EnvVariableName nvarchar(100) = NULL,
    @Priority int = NULL,
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO [${flyway:defaultSchema}].[AIAgentCredential]
            (
                [ID],
                [AgentID],
                [CredentialID],
        ...
        VALUES
            (
                ...
                @CredentialID,
                @Purpose,
                CASE WHEN @EnvVariableName_Clear = 1 THEN NULL ELSE ISNULL(@EnvVariableName, NULL) END,
                ISNULL(@Priority, 0),
    ...
    SELECT * FROM [${flyway:defaultSchema}].[vwAIAgentCredentials] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spCreateAIAgentCredential] TO [cdp_Developer], [cdp_Integration];
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spUpdateAIAgentCredential]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentCredential];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentCredential]
    @ID uniqueidentifier,
...
BEGIN
    SET NOCOUNT ON;
    UPDATE
        [${flyway:defaultSchema}].[AIAgentCredential]
    SET
        [AgentID] = ISNULL(@AgentID, [AgentID]),
        [CredentialID] = ISNULL(@CredentialID, [CredentialID]),
        [Purpose] = ISNULL(@Purpose, [Purpose]),
        [EnvVariableName] = CASE WHEN @EnvVariableName_Clear = 1 THEN NULL ELSE ISNULL(@EnvVariableName, [EnvVariableName]) END,
    ...
    IF @@ROWCOUNT = 0
        ...
        SELECT TOP 0 * FROM [${flyway:defaultSchema}].[vwAIAgentCredentials] WHERE 1=0
    ELSE
        -- Return the updated record so the caller can see the updated values and any calculated fields
        SELECT
                                        *
                                    FROM
                                        [${flyway:defaultSchema}].[vwAIAgentCredentials]
                                    WHERE
                                        [ID] = @ID
...
GRANT EXECUTE ON [${flyway:defaultSchema}].[spUpdateAIAgentCredential] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the AIAgentCredential table
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[trgUpdateAIAgentCredential]', 'TR') IS NOT NULL
    DROP TRIGGER [${flyway:defaultSchema}].[trgUpdateAIAgentCredential];
GO
CREATE TRIGGER [${flyway:defaultSchema}].trgUpdateAIAgentCredential
ON [${flyway:defaultSchema}].[AIAgentCredential]
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM
        [${flyway:defaultSchema}].[AIAgentCredential] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spDeleteAIAgentCredential]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spDeleteAIAgentCredential];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spDeleteAIAgentCredential]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spDeleteAIAgentCredential] TO [cdp_Developer], [cdp_Integration];
...
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_AIAgentHarness_AIVendorID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentHarness]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentHarness_AIVendorID ON [${flyway:defaultSchema}].[AIAgentHarness] ([AIVendorID]);

/* SQL text to update entity field related entity name field map for entity field ID A4164168-F4B7-4993-B615-A611509B96D6 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='A4164168-F4B7-4993-B615-A611509B96D6', @RelatedEntityNameFieldMap='AIVendor';

/* Base View SQL for MJ: AI Agent Harnesses */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Harnesses
-- Item: vwAIAgentHarnesses
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- BASE VIEW FOR ENTITY:      MJ: AI Agent Harnesses
-----               SCHEMA:      ${flyway:defaultSchema}
-----               BASE TABLE:  AIAgentHarness
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[vwAIAgentHarnesses]', 'V') IS NOT NULL
    DROP VIEW [${flyway:defaultSchema}].[vwAIAgentHarnesses];
GO

CREATE VIEW [${flyway:defaultSchema}].[vwAIAgentHarnesses]
AS
SELECT
    a.*,
    MJAIVendor_AIVendorID.[Name] AS [AIVendor]
FROM
    [${flyway:defaultSchema}].[AIAgentHarness] AS a
LEFT OUTER JOIN
    [${flyway:defaultSchema}].[AIVendor] AS MJAIVendor_AIVendorID
  ON
    [a].[AIVendorID] = MJAIVendor_AIVendorID.[ID]
GO
GRANT SELECT ON [${flyway:defaultSchema}].[vwAIAgentHarnesses] TO [cdp_UI], [cdp_Developer], [cdp_Integration];
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spCreateAIAgentHarness]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentHarness];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentHarness]
    @ID uniqueidentifier = NULL,
    @Name nvarchar(100),
    @Description_Clear bit = 0,
    @Description nvarchar(MAX) = NULL,
    @DriverClass nvarchar(255),
    @ExecutablePath_Clear bit = 0,
    @ExecutablePath nvarchar(500) = NULL,
    @AIVendorID_Clear bit = 0,
    @AIVendorID uniqueidentifier = NULL,
    @DefaultModel_Clear bit = 0,
    @DefaultModel nvarchar(255) = NULL,
    @CapabilitySettings_Clear bit = 0,
    @CapabilitySettings nvarchar(MAX) = NULL,
    @Status nvarchar(20) = NULL
AS
BEGIN
    ...
    BEGIN
        -- User provided a value, use it
        INSERT INTO [${flyway:defaultSchema}].[AIAgentHarness]
            (
                [ID],
                [Name],
                [Description],
        ...
        VALUES
            (
                ...
                @DriverClass,
                CASE WHEN @ExecutablePath_Clear = 1 THEN NULL ELSE ISNULL(@ExecutablePath, NULL) END,
                CASE WHEN @AIVendorID_Clear = 1 THEN NULL ELSE ISNULL(@AIVendorID, NULL) END,
                CASE WHEN @DefaultModel_Clear = 1 THEN NULL ELSE ISNULL(@DefaultModel, NULL) END,
                CASE WHEN @CapabilitySettings_Clear = 1 THEN NULL ELSE ISNULL(@CapabilitySettings, NULL) END,
                ISNULL(@Status, 'Active')
            )
    END
    ELSE
    ...
    END
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [${flyway:defaultSchema}].[vwAIAgentHarnesses] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spCreateAIAgentHarness] TO [cdp_Developer], [cdp_Integration];
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spUpdateAIAgentHarness]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentHarness];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentHarness]
    @ID uniqueidentifier,
...
BEGIN
    SET NOCOUNT ON;
    UPDATE
        [${flyway:defaultSchema}].[AIAgentHarness]
    SET
        [Name] = ISNULL(@Name, [Name]),
        [Description] = CASE WHEN @Description_Clear = 1 THEN NULL ELSE ISNULL(@Description, [Description]) END,
        [DriverClass] = ISNULL(@DriverClass, [DriverClass]),
        [ExecutablePath] = CASE WHEN @ExecutablePath_Clear = 1 THEN NULL ELSE ISNULL(@ExecutablePath, [ExecutablePath]) END,
        [AIVendorID] = CASE WHEN @AIVendorID_Clear = 1 THEN NULL ELSE ISNULL(@AIVendorID, [AIVendorID]) END,
        [DefaultModel] = CASE WHEN @DefaultModel_Clear = 1 THEN NULL ELSE ISNULL(@DefaultModel, [DefaultModel]) END,
        [CapabilitySettings] = CASE WHEN @CapabilitySettings_Clear = 1 THEN NULL ELSE ISNULL(@CapabilitySettings, [CapabilitySettings]) END,
        [Status] = ISNULL(@Status, [Status])
    WHERE
        [ID] = @ID
    ...
    IF @@ROWCOUNT = 0
        -- Nothing was updated, return no rows, but column structure from base view intact, semantically correct this way.
        SELECT TOP 0 * FROM [${flyway:defaultSchema}].[vwAIAgentHarnesses] WHERE 1=0
    ELSE
        -- Return the updated record so the caller can see the updated values and any calculated fields
        SELECT
                                        *
                                    FROM
                                        [${flyway:defaultSchema}].[vwAIAgentHarnesses]
                                    WHERE
                                        [ID] = @ID
...
GRANT EXECUTE ON [${flyway:defaultSchema}].[spUpdateAIAgentHarness] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the AIAgentHarness table
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[trgUpdateAIAgentHarness]', 'TR') IS NOT NULL
    DROP TRIGGER [${flyway:defaultSchema}].[trgUpdateAIAgentHarness];
GO
CREATE TRIGGER [${flyway:defaultSchema}].trgUpdateAIAgentHarness
ON [${flyway:defaultSchema}].[AIAgentHarness]
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SET
        __mj_UpdatedAt = GETUTCDATE()
    FROM
        [${flyway:defaultSchema}].[AIAgentHarness] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
        _organicTable.[ID] = I.[ID];
END;
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spDeleteAIAgentHarness]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spDeleteAIAgentHarness];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spDeleteAIAgentHarness]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spDeleteAIAgentHarness] TO [cdp_Developer], [cdp_Integration];
...
/* SQL text to insert 3 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '509667a0-a298-426d-8d3f-0283b1694c64' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'Agent')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '509667a0-a298-426d-8d3f-0283b1694c64',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100019,
            'Agent',
            'Agent',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f0e127c2-b60d-42ee-9607-4f60742a261b' OR (EntityID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B' AND Name = 'Credential')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'f0e127c2-b60d-42ee-9607-4f60742a261b',
            'BD38C743-5C21-4FA3-9240-28E561C06E7B', -- Entity: MJ: AI Agent Credentials
            100020,
            'Credential',
            'Credential',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'aa50e5f4-0e08-4548-bbc4-47f8c2271c12' OR (EntityID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2' AND Name = 'AIVendor')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'aa50e5f4-0e08-4548-bbc4-47f8c2271c12',
            'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', -- Entity: MJ: AI Agent Harnesses
            100023,
            'AIVendor',
            'AI Vendor',
...
/* Set field properties for entity */
               ...
               SET DefaultInView = 1
               WHERE ID = 'A81759EA-CFF3-4EDE-89A8-2E32B215D681'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '68E7EA99-DFAA-4B91-A230-B3DBB0ACC13B'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'AA50E5F4-0E08-4548-BBC4-47F8C2271C12'
               AND AutoUpdateDefaultInView = 1;

            UPDATE [${flyway:defaultSchema}].[Entity]
            SET AllowUserSearchAPI = 0
            WHERE ID = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2'
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET IsNameField = 1
               WHERE ID = '03DA5FCF-E03D-4A30-9F74-A9D6C620C3EB'
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '641F156D-4244-4ED6-AD24-2ACCD5C2CFFA'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '6DAE8A18-50AE-48D2-B56C-088A9B9BA260'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '66A535FA-FEBF-41EC-9C16-9F2FCC933B6E'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '509667A0-A298-426D-8D3F-0283B1694C64'
               AND AutoUpdateDefaultInView = 1;

            UPDATE [${flyway:defaultSchema}].[Entity]
            SET AllowUserSearchAPI = 0
            WHERE ID = 'BD38C743-5C21-4FA3-9240-28E561C06E7B'
            AND AutoUpdateAllowUserSearchAPI = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '3706190E-DF70-4873-8242-1C76368BC7C8' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '5F0BF439-6EE8-469F-9D5A-E871F0D28C0D' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '509667A0-A298-426D-8D3F-0283B1694C64' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '19432288-4E78-4C77-A466-E7EAB051DDA1' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'F0E127C2-B60D-42EE-9607-4F60742A261B' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '03DA5FCF-E03D-4A30-9F74-A9D6C620C3EB' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '641F156D-4244-4ED6-AD24-2ACCD5C2CFFA' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '6DAE8A18-50AE-48D2-B56C-088A9B9BA260' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '66A535FA-FEBF-41EC-9C16-9F2FCC933B6E' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '248BBA77-A9B3-47B5-9CD3-CB9878132707' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'A39F8496-BA72-4F6D-839F-0D73835742DB' AND AutoUpdateCategory = 1;
...
/* Insert FieldCategoryInfo setting for entity */
               ...
               VALUES ('2e1a10f0-6674-4969-8ec6-4c2c0d4ed90e', 'BD38C743-5C21-4FA3-9240-28E561C06E7B', 'FieldCategoryInfo', '{"Credential Assignment":{"icon":"fa fa-link","description":"Links between agents and the credentials granted to them"},"Configuration Details":{"icon":"fa fa-sliders-h","description":"Settings for how the credential is used within the sandbox environment"},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit and tracking fields"}}', GETUTCDATE(), GETUTCDATE());

/* Insert FieldCategoryIcons setting (legacy) */

               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('afc2d902-d3ff-4174-9931-cf2627e5ce65', 'BD38C743-5C21-4FA3-9240-28E561C06E7B', 'FieldCategoryIcons', '{"Credential Assignment":"fa fa-link","Configuration Details":"fa fa-sliders-h","System Metadata":"fa fa-cog"}', GETUTCDATE(), GETUTCDATE());

/* Set DefaultForNewUser=true for NEW entity (category: supporting, confidence: high) */

         UPDATE [${flyway:defaultSchema}].[ApplicationEntity]
         SET [DefaultForNewUser] = 1, [__mj_UpdatedAt] = GETUTCDATE()
         WHERE [EntityID] = 'BD38C743-5C21-4FA3-9240-28E561C06E7B';
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'B44D2284-3A80-4783-AB5B-A7AEC8A9997F' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '7AAA8BDE-29C6-4EBD-85A2-C1C133AB67ED' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'DD4179F7-87DF-4216-80DD-7249D072BB56' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '68E7EA99-DFAA-4B91-A230-B3DBB0ACC13B' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '4EE2C6BB-EC38-44C7-B416-0B54FFF69C41' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'A81759EA-CFF3-4EDE-89A8-2E32B215D681' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = 'Other'
WHERE 
   ID = 'E5C5CE1F-3EE9-486E-92F7-F05DDDC59474' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'A4164168-F4B7-4993-B615-A611509B96D6' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'AA50E5F4-0E08-4548-BBC4-47F8C2271C12' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '6873039C-5300-4BA8-9D41-B3FAD5569690' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '1A124386-664A-4E7A-AF69-A5B3C4E5D5FC' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '52789D4C-FFFB-41F9-9C79-E97AD2310A4A' AND AutoUpdateCategory = 1;
...
/* Insert FieldCategoryInfo setting for entity */
               ...
               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('468171a6-884a-4661-970c-9c2f584e4a07', 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', 'FieldCategoryInfo', '{"Harness Configuration":{"icon":"fa fa-sliders-h","description":"Core identification and operational status of the agent harness"},"Technical Implementation":{"icon":"fa fa-code","description":"Low-level technical details including driver classes and execution paths"},"Vendor Integration":{"icon":"fa fa-building","description":"Vendor-specific settings and model defaults"},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit and tracking fields"}}', GETUTCDATE(), GETUTCDATE());

/* Insert FieldCategoryIcons setting (legacy) */

               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('839c970c-5d9a-49f8-8472-05e1f7d5df92', 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2', 'FieldCategoryIcons', '{"Harness Configuration":"fa fa-sliders-h","Technical Implementation":"fa fa-code","Vendor Integration":"fa fa-building","System Metadata":"fa fa-cog"}', GETUTCDATE(), GETUTCDATE());

/* Set DefaultForNewUser=false for NEW entity (category: reference, confidence: high) */

         UPDATE [${flyway:defaultSchema}].[ApplicationEntity]
         SET [DefaultForNewUser] = 0, [__mj_UpdatedAt] = GETUTCDATE()
         WHERE [EntityID] = 'EADEC5C5-A09E-4FBC-B81A-A537A51B83A2';
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '36818EC4-4A54-4A84-95EF-702517F32492' AND AutoUpdateCategory = 1;
