...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '0dca1987-4d89-4c8f-81b3-b47a8019af97', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Usage Types for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('0dca1987-4d89-4c8f-81b3-b47a8019af97', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Usage Types for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('0dca1987-4d89-4c8f-81b3-b47a8019af97', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Usage Types for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('0dca1987-4d89-4c8f-81b3-b47a8019af97', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
UPDATE [${flyway:defaultSchema}].[EntityField]
       ...
       WHERE [EntityID] = '0DCA1987-4D89-4C8F-81B3-B47A8019AF97'
         AND [Sequence] < 100000
         AND NOT EXISTS (
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd071ee59-a846-4e9b-95dd-9552fb1747aa' OR (EntityID = '0DCA1987-4D89-4C8F-81B3-B47A8019AF97' AND Name = 'ID')) BEGIN
         ...
         VALUES
         (
            'd071ee59-a846-4e9b-95dd-9552fb1747aa',
            '0DCA1987-4D89-4C8F-81B3-B47A8019AF97', -- Entity: MJ: AI Usage Types
            1,
            'ID',
            'ID',
            NULL,
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '8918992e-f73d-40ce-b21f-46bb97b54c2f' OR (EntityID = '0DCA1987-4D89-4C8F-81B3-B47A8019AF97' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '8918992e-f73d-40ce-b21f-46bb97b54c2f',
            '0DCA1987-4D89-4C8F-81B3-B47A8019AF97', -- Entity: MJ: AI Usage Types
            2,
            'Name',
            'Name',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a18a5508-54ba-4cbb-a72f-1c3ff14bf891' OR (EntityID = '0DCA1987-4D89-4C8F-81B3-B47A8019AF97' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a18a5508-54ba-4cbb-a72f-1c3ff14bf891',
            '0DCA1987-4D89-4C8F-81B3-B47A8019AF97', -- Entity: MJ: AI Usage Types
            3,
            'Description',
            'Description',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '20b8ec37-b56c-49de-9cc9-3e324ad40e63' OR (EntityID = '0DCA1987-4D89-4C8F-81B3-B47A8019AF97' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '20b8ec37-b56c-49de-9cc9-3e324ad40e63',
            '0DCA1987-4D89-4C8F-81B3-B47A8019AF97', -- Entity: MJ: AI Usage Types
            4,
            '__mj_CreatedAt',
            'Created At',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ae142d13-998c-4475-a00a-38496aea7551' OR (EntityID = '0DCA1987-4D89-4C8F-81B3-B47A8019AF97' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ae142d13-998c-4475-a00a-38496aea7551',
            '0DCA1987-4D89-4C8F-81B3-B47A8019AF97', -- Entity: MJ: AI Usage Types
            5,
            '__mj_UpdatedAt',
            'Updated At',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '80751109-3d30-4fa2-afb5-670ccc940d5f' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'InputUnitsUsed')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '80751109-3d30-4fa2-afb5-670ccc940d5f',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '403e5f99-370b-4d05-ab5a-e35dedf41e27' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'OutputUnitsUsed')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '403e5f99-370b-4d05-ab5a-e35dedf41e27',
            '7C1C98D0-3978-4CE8-8E3F-C90301E59767', -- Entity: MJ: AI Prompt Runs
            90,
            'OutputUnitsUsed',
            'Output Units Used',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b6567fd4-c231-4679-8520-35d64c42ecee' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'UsageTypeID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'b6567fd4-c231-4679-8520-35d64c42ecee',
            '7C1C98D0-3978-4CE8-8E3F-C90301E59767', -- Entity: MJ: AI Prompt Runs
            91,
            'UsageTypeID',
            'Usage Type ID',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a83b3d6e-8dc5-47bc-b229-dcbcb0df1ad6' OR (EntityID = '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21' AND Name = 'UsageTypeID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a83b3d6e-8dc5-47bc-b229-dcbcb0df1ad6',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3673cbaf-ed88-4821-ad64-8b1defaec033' OR (EntityID = '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21' AND Name = 'UnitsPerBillingUnit')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '3673cbaf-ed88-4821-ad64-8b1defaec033',
            '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21', -- Entity: MJ: AI Model Price Unit Types
            8,
            'UnitsPerBillingUnit',
...
/* Create Entity Relationship: MJ: AI Usage Types -> MJ: AI Model Price Unit Types (One To Many via UsageTypeID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '95857194-e744-44ff-b50d-5bffa0a1afde'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('95857194-e744-44ff-b50d-5bffa0a1afde', '0DCA1987-4D89-4C8F-81B3-B47A8019AF97', '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21', 'UsageTypeID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;
                    
/* Create Entity Relationship: MJ: AI Usage Types -> MJ: AI Prompt Runs (One To Many via UsageTypeID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'e8032b41-c779-40d7-8cce-94199a2e4aa4'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('e8032b41-c779-40d7-8cce-94199a2e4aa4', '0DCA1987-4D89-4C8F-81B3-B47A8019AF97', '7C1C98D0-3978-4CE8-8E3F-C90301E59767', 'UsageTypeID', 'One To Many', 1, 1, 2, GETUTCDATE(), GETUTCDATE())
   END;
...
/* SQL text to update entity field related entity name field map for entity field ID A83B3D6E-8DC5-47BC-B229-DCBCB0DF1AD6 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='A83B3D6E-8DC5-47BC-B229-DCBCB0DF1AD6', @RelatedEntityNameFieldMap='UsageType';
...
/* SQL text to update entity field related entity name field map for entity field ID B6567FD4-C231-4679-8520-35D64C42ECEE */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='B6567FD4-C231-4679-8520-35D64C42ECEE', @RelatedEntityNameFieldMap='UsageType';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'dc346a80-a4d5-4636-93f3-35b847fa9dce' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'UsageType')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'dc346a80-a4d5-4636-93f3-35b847fa9dce',
            '7C1C98D0-3978-4CE8-8E3F-C90301E59767', -- Entity: MJ: AI Prompt Runs
            103,
            'UsageType',
            'Usage Type',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '8e136f98-fc1f-4e2d-b274-1bc5a142a304' OR (EntityID = '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21' AND Name = 'UsageType')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '8e136f98-fc1f-4e2d-b274-1bc5a142a304',
            '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21', -- Entity: MJ: AI Model Price Unit Types
            9,
            'UsageType',
            'Usage Type',
