...
CREATE TABLE [${flyway:defaultSchema}].[AIAgentHarness] (
    ...
    CONSTRAINT [FK_AIAgentHarness_AIModel]  FOREIGN KEY ([AIModelID])  REFERENCES [${flyway:defaultSchema}].[AIModel]([ID]),
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '82d34eec-685a-490e-b26b-897836709026', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Harnesses for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('82d34eec-685a-490e-b26b-897836709026', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Harnesses for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('82d34eec-685a-490e-b26b-897836709026', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Harnesses for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('82d34eec-685a-490e-b26b-897836709026', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '12193852-f824-416b-9269-ec5d71122959', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Credentials for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('12193852-f824-416b-9269-ec5d71122959', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Credentials for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('12193852-f824-416b-9269-ec5d71122959', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Credentials for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('12193852-f824-416b-9269-ec5d71122959', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
/* SQL text to insert 22 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a86ffa34-d554-498a-b2a0-e8973bd86d75' OR (EntityID = '5190AF93-4C39-4429-BDAA-0AEB492A0256' AND Name = 'ExternalSessionID')) BEGIN
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c7b0d037-fa2f-4de0-970d-9c7a6e549531' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '03f07955-3e4a-4b5f-8772-75b6cee0bcc9' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3c6ab5e8-4d7f-4c21-9f8c-ef31ded93b55' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '257cb867-8c0b-4805-82ee-ce29ffff45b3' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'DriverClass')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f8e651df-be45-45f0-8cea-883cc75f3577' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'ExecutablePath')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2f2ae4e4-49fb-412a-8e86-fe0b178d156d' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'AIVendorID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a4f91e08-3cb8-44ae-9fce-ae07f5188ecc' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'AIModelID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '96624aa2-e8b8-48a2-9274-8457df59f4c1' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'DefaultModel')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1629fdd1-f550-4ee5-88cb-594781612a5d' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'CapabilitySettings')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e63cf6fe-32fe-4b63-af9e-1f78a048c813' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'Status')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4e1db126-38df-4ec9-a43c-a3223096d68e' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '700e0e68-607d-44ab-a256-f8f28f253d60' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3bb97009-691f-4c50-acbf-9ee7458d066c' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b72932f4-0bc6-4bbf-af9f-c7994d77f8cc' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'AgentID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6f5b1cb3-f389-4c66-8d35-6a3e7f36a21d' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'CredentialID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1e4326f0-4c2d-405d-ad5b-9769f82b9be1' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'Purpose')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '42c6656c-d0ee-4e1f-8c13-e714cc7ad015' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'EnvVariableName')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '295abffc-e13e-4936-9ae7-e3bfe3c3c5ad' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'Priority')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c1119f25-457d-472a-8ee2-1b056ca099d9' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'Status')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '36292ad6-7431-4162-8ebe-0ef9108af443' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f27f4b9e-d05d-4702-a243-3469d39d54c6' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert entity field value with ID 0420b6ae-eb5b-4b5b-a03c-f1c314e1ef87 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('0420b6ae-eb5b-4b5b-a03c-f1c314e1ef87', 'E63CF6FE-32FE-4B63-AF9E-1F78A048C813', 1, 'Active', 'Active', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 7c33530c-798f-4b15-b6b2-83681cc072af */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('7c33530c-798f-4b15-b6b2-83681cc072af', 'E63CF6FE-32FE-4B63-AF9E-1F78A048C813', 2, 'Inactive', 'Inactive', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID E63CF6FE-32FE-4B63-AF9E-1F78A048C813 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='E63CF6FE-32FE-4B63-AF9E-1F78A048C813';

/* SQL text to insert entity field value with ID cbbf73bf-6fb5-4cd5-b0d3-1329ff72ce5a */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('cbbf73bf-6fb5-4cd5-b0d3-1329ff72ce5a', '1E4326F0-4C2D-405D-AD5B-9769F82B9BE1', 1, 'HarnessLLM', 'HarnessLLM', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID e4058fd2-8e66-4087-8387-2b63a7f7b1e5 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('e4058fd2-8e66-4087-8387-2b63a7f7b1e5', '1E4326F0-4C2D-405D-AD5B-9769F82B9BE1', 2, 'Integration', 'Integration', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID 1E4326F0-4C2D-405D-AD5B-9769F82B9BE1 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='1E4326F0-4C2D-405D-AD5B-9769F82B9BE1';

/* SQL text to insert entity field value with ID 9e152f0b-43df-495b-80cb-9476a58abd84 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('9e152f0b-43df-495b-80cb-9476a58abd84', 'C1119F25-457D-472A-8EE2-1B056CA099D9', 1, 'Active', 'Active', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 452bfbb3-8be6-46b2-a928-2ba6d8665bac */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('452bfbb3-8be6-46b2-a928-2ba6d8665bac', 'C1119F25-457D-472A-8EE2-1B056CA099D9', 2, 'Pending', 'Pending', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 25455413-c96e-43c9-85b0-08e5a918309f */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('25455413-c96e-43c9-85b0-08e5a918309f', 'C1119F25-457D-472A-8EE2-1B056CA099D9', 3, 'Revoked', 'Revoked', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID C1119F25-457D-472A-8EE2-1B056CA099D9 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='C1119F25-457D-472A-8EE2-1B056CA099D9';


/* Create Entity Relationship: MJ: AI Vendors -> MJ: AI Agent Harnesses (One To Many via AIVendorID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '26b8e164-015a-40ab-b557-77fe955cdec6'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('26b8e164-015a-40ab-b557-77fe955cdec6', 'D95A17EE-5750-4218-86AD-10F06E4DFBCA', '82D34EEC-685A-490E-B26B-897836709026', 'AIVendorID', 'One To Many', 1, 1, 10, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: AI Agents -> MJ: AI Agent Credentials (One To Many via AgentID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '965ce44e-82b7-477f-8a06-89a96ae9eab3'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('965ce44e-82b7-477f-8a06-89a96ae9eab3', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', '12193852-F824-416B-9269-EC5D71122959', 'AgentID', 'One To Many', 1, 1, 38, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: AI Models -> MJ: AI Agent Harnesses (One To Many via AIModelID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '48b580d3-f76c-4e65-a87a-7ec4bae3f415'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('48b580d3-f76c-4e65-a87a-7ec4bae3f415', 'FD238F34-2837-EF11-86D4-6045BDEE16E6', '82D34EEC-685A-490E-B26B-897836709026', 'AIModelID', 'One To Many', 1, 1, 27, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: Credentials -> MJ: AI Agent Credentials (One To Many via CredentialID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'bb1061a4-47d7-4f3a-a862-8871d35c7f02'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('bb1061a4-47d7-4f3a-a862-8871d35c7f02', '7E023DDF-82C6-4B0C-9650-8D35699B9FD0', '12193852-F824-416B-9269-EC5D71122959', 'CredentialID', 'One To Many', 1, 1, 10, GETUTCDATE(), GETUTCDATE())
   END;
...
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='B72932F4-0BC6-4BBF-AF9F-C7994D77F8CC', @RelatedEntityNameFieldMap='Agent';

/* SQL text to update entity field related entity name field map for entity field ID 6F5B1CB3-F389-4C66-8D35-6A3E7F36A21D */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='6F5B1CB3-F389-4C66-8D35-6A3E7F36A21D', @RelatedEntityNameFieldMap='Credential';
...
-- Index for foreign key AIModelID in table AIAgentHarness
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_AIAgentHarness_AIModelID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentHarness]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentHarness_AIModelID ON [${flyway:defaultSchema}].[AIAgentHarness] ([AIModelID]);

/* SQL text to update entity field related entity name field map for entity field ID 2F2AE4E4-49FB-412A-8E86-FE0B178D156D */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='2F2AE4E4-49FB-412A-8E86-FE0B178D156D', @RelatedEntityNameFieldMap='AIVendor';

/* SQL text to update entity field related entity name field map for entity field ID A4F91E08-3CB8-44AE-9FCE-AE07F5188ECC */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='A4F91E08-3CB8-44AE-9FCE-AE07F5188ECC', @RelatedEntityNameFieldMap='AIModel';
...
/* SQL text to insert 4 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b063bf06-8905-42b7-919e-4c6f25fb4d47' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'AIVendor')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1dc05dc0-579a-498d-a0da-c48add441543' OR (EntityID = '82D34EEC-685A-490E-B26B-897836709026' AND Name = 'AIModel')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c4e8b0a2-5aa5-4f5a-95d2-45c5d2d210a1' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'Agent')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '645b0e47-e2fb-4dba-a7df-6fead36d4945' OR (EntityID = '12193852-F824-416B-9269-EC5D71122959' AND Name = 'Credential')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '3BB97009-691F-4C50-ACBF-9EE7458D066C' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'B72932F4-0BC6-4BBF-AF9F-C7994D77F8CC' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'C4E8B0A2-5AA5-4F5A-95D2-45C5D2D210A1' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '6F5B1CB3-F389-4C66-8D35-6A3E7F36A21D' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '645B0E47-E2FB-4DBA-A7DF-6FEAD36D4945' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '1E4326F0-4C2D-405D-AD5B-9769F82B9BE1' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '42C6656C-D0EE-4E1F-8C13-E714CC7AD015' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '295ABFFC-E13E-4936-9AE7-E3BFE3C3C5AD' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'C1119F25-457D-472A-8EE2-1B056CA099D9' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '36292AD6-7431-4162-8EBE-0EF9108AF443' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'F27F4B9E-D05D-4702-A243-3469D39D54C6' AND AutoUpdateCategory = 1;
...
/* Insert FieldCategoryInfo setting for entity */
               ...
               VALUES ('b9f77bc0-bcbb-44cf-9c76-c9b331470a67', '12193852-F824-416B-9269-EC5D71122959', 'FieldCategoryInfo', '{"Credential Assignment":{"icon":"fa fa-link","description":"Links between agents and credentials being granted"},"Configuration":{"icon":"fa fa-sliders-h","description":"Settings defining how credentials are injected and prioritized"},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit and tracking fields"}}', GETUTCDATE(), GETUTCDATE());

/* Insert FieldCategoryIcons setting (legacy) */

               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('aa0580f2-21c3-4d0c-8d82-97da2a5f835a', '12193852-F824-416B-9269-EC5D71122959', 'FieldCategoryIcons', '{"Credential Assignment":"fa fa-link","Configuration":"fa fa-sliders-h","System Metadata":"fa fa-cog"}', GETUTCDATE(), GETUTCDATE());
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'C7B0D037-FA2F-4DE0-970D-9C7A6E549531' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '03F07955-3E4A-4B5F-8772-75B6CEE0BCC9' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '3C6AB5E8-4D7F-4C21-9F8C-EF31DED93B55' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '257CB867-8C0B-4805-82EE-CE29FFFF45B3' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'F8E651DF-BE45-45F0-8CEA-883CC75F3577' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'E63CF6FE-32FE-4B63-AF9E-1F78A048C813' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '2F2AE4E4-49FB-412A-8E86-FE0B178D156D' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'A4F91E08-3CB8-44AE-9FCE-AE07F5188ECC' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'B063BF06-8905-42B7-919E-4C6F25FB4D47' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '1DC05DC0-579A-498D-A0DA-C48ADD441543' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '96624AA2-E8B8-48A2-9274-8457DF59F4C1' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = 'Other'
WHERE 
   ID = '1629FDD1-F550-4EE5-88CB-594781612A5D' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '4E1DB126-38DF-4EC9-A43C-A3223096D68E' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '700E0E68-607D-44AB-A256-F8F28F253D60' AND AutoUpdateCategory = 1;
...
/* Insert FieldCategoryIcons setting (legacy) */
               ...
               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('c6cf644d-651a-4501-8957-367f4b369dff', '82D34EEC-685A-490E-B26B-897836709026', 'FieldCategoryIcons', '{"Harness Configuration":"fa fa-sliders-h","Model Association":"fa fa-brain","Advanced Settings":"fa fa-cogs","System Metadata":"fa fa-database"}', GETUTCDATE(), GETUTCDATE());
