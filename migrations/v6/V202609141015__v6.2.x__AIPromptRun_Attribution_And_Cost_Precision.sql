...
--
--   8. Query materialization columns:
--      * Query.MaterializationRefreshSchedule NVARCHAR(255) NULL
--      * Query.MaterializationIntendedWorkload NVARCHAR(MAX) NULL
-- =============================================================================
...
ALTER TABLE [${flyway:defaultSchema}].[Query]
    ADD [MaterializationRefreshSchedule] NVARCHAR(255) NULL,
        [MaterializationIntendedWorkload] NVARCHAR(MAX) NULL;
GO

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Cron expression specifying the schedule for background refresh of this query when materialized.',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'Query',
    @level2type = N'COLUMN', @level2name = N'MaterializationRefreshSchedule';
GO

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Intended workload for materialization storage (e.g. OLAP, Hybrid, InvertedIndex).',
    @level0type = N'SCHEMA', @level0name = N'${flyway:defaultSchema}',
    @level1type = N'TABLE',  @level1name = N'Query',
    @level2type = N'COLUMN', @level2name = N'MaterializationIntendedWorkload';
GO
...
/* SQL text to insert 2 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'bad6ff87-686b-4670-aefc-004f92db79e2' OR (EntityID = '1B248F34-2837-EF11-86D4-6045BDEE16E6' AND Name = 'MaterializationRefreshSchedule')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'bad6ff87-686b-4670-aefc-004f92db79e2',
            ...
            'MaterializationRefreshSchedule',
            'Materialization Refresh Schedule',
            'Cron expression specifying the schedule for background refresh of this query when materialized.',
            'nvarchar',
            510,
            0,
            0,
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7079ce79-b60a-47ff-8565-be7abfb67299' OR (EntityID = '1B248F34-2837-EF11-86D4-6045BDEE16E6' AND Name = 'MaterializationIntendedWorkload')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7079ce79-b60a-47ff-8565-be7abfb67299',
            '1B248F34-2837-EF11-86D4-6045BDEE16E6', -- Entity: MJ: Queries
            (SELECT COALESCE(MAX([Sequence]), 0) + 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE [EntityID] = '1B248F34-2837-EF11-86D4-6045BDEE16E6'),
            'MaterializationIntendedWorkload',
            'Materialization Intended Workload',
            'Intended workload for materialization storage (e.g. OLAP, Hybrid, InvertedIndex).',
            'nvarchar',
            -1,
            0,
            0,
...
CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateQuery]
    ...
    @MaterializationRefreshSchedule_Clear bit = 0,
    @MaterializationRefreshSchedule nvarchar(255) = NULL,
    @MaterializationIntendedWorkload_Clear bit = 0,
    @MaterializationIntendedWorkload nvarchar(MAX) = NULL
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        ...
        VALUES
            (
                ...
                CASE WHEN @MaterializationRefreshSchedule_Clear = 1 THEN NULL ELSE ISNULL(@MaterializationRefreshSchedule, NULL) END,
                CASE WHEN @MaterializationIntendedWorkload_Clear = 1 THEN NULL ELSE ISNULL(@MaterializationIntendedWorkload, NULL) END
            )
    END
    ELSE
    BEGIN
...
BEGIN
    ...
    SET
        ...
        [MaterializationRefreshSchedule] = CASE WHEN @MaterializationRefreshSchedule_Clear = 1 THEN NULL ELSE ISNULL(@MaterializationRefreshSchedule, [MaterializationRefreshSchedule]) END,
        [MaterializationIntendedWorkload] = CASE WHEN @MaterializationIntendedWorkload_Clear = 1 THEN NULL ELSE ISNULL(@MaterializationIntendedWorkload, [MaterializationIntendedWorkload]) END
    WHERE
        [ID] = @ID
