...
/* ============================================================================================
   ...
   SQL Server database created empty, migrated by this branch, then given the repo's declarative
   metadata by `mj sync push` — MINUS the two directories this migration's own rows live in, since
   on a real upgrade those are pushed AFTER every migration has run). So it reflects only what the
   hand-written DDL above actually causes, against the metadata a real deployment already has —
   nothing inherited from a dev database's accumulated state.
   ...
   Contains:
     ...
     - Regenerated spCreate/spUpdate/spDelete for those three entities, so the new columns are
       writable through the same path everything else uses
...
/* SQL generated to create new entity MJ: AI Usage Types */
      ...
      VALUES (
         '0d78e58b-907c-4c78-bdfb-8541b22b950c',
         'MJ: AI Usage Types',
         'AI Usage Types',
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '0d78e58b-907c-4c78-bdfb-8541b22b950c', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Usage Types for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('0d78e58b-907c-4c78-bdfb-8541b22b950c', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Usage Types for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('0d78e58b-907c-4c78-bdfb-8541b22b950c', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Usage Types for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('0d78e58b-907c-4c78-bdfb-8541b22b950c', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());
...
UPDATE [${flyway:defaultSchema}].[EntityField]
       ...
       WHERE [EntityID] = '0D78E58B-907C-4C78-BDFB-8541B22B950C'
         AND [Sequence] < 100000;

      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'df350817-59b7-423c-a631-49fcaa8a7a84' OR (EntityID = '0D78E58B-907C-4C78-BDFB-8541B22B950C' AND Name = 'ID')) BEGIN
         ...
         VALUES
         (
            'df350817-59b7-423c-a631-49fcaa8a7a84',
            '0D78E58B-907C-4C78-BDFB-8541B22B950C', -- Entity: MJ: AI Usage Types
            1,
            'ID',
            'ID',
            NULL,
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'fe75914d-1c66-4dc8-a476-449efe6226bc' OR (EntityID = '0D78E58B-907C-4C78-BDFB-8541B22B950C' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'fe75914d-1c66-4dc8-a476-449efe6226bc',
            '0D78E58B-907C-4C78-BDFB-8541B22B950C', -- Entity: MJ: AI Usage Types
            2,
            'Name',
            'Name',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd3e4ffeb-0957-4637-9d39-1eb25abc30e7' OR (EntityID = '0D78E58B-907C-4C78-BDFB-8541B22B950C' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'd3e4ffeb-0957-4637-9d39-1eb25abc30e7',
            '0D78E58B-907C-4C78-BDFB-8541B22B950C', -- Entity: MJ: AI Usage Types
            3,
            'Description',
            'Description',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c71799b7-658a-45a8-b18a-6f9710fcad66' OR (EntityID = '0D78E58B-907C-4C78-BDFB-8541B22B950C' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'c71799b7-658a-45a8-b18a-6f9710fcad66',
            '0D78E58B-907C-4C78-BDFB-8541B22B950C', -- Entity: MJ: AI Usage Types
            4,
            '__mj_CreatedAt',
            'Created At',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '533868de-1e69-46be-8dfb-726c686543a8' OR (EntityID = '0D78E58B-907C-4C78-BDFB-8541B22B950C' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '533868de-1e69-46be-8dfb-726c686543a8',
            '0D78E58B-907C-4C78-BDFB-8541B22B950C', -- Entity: MJ: AI Usage Types
            5,
            '__mj_UpdatedAt',
            'Updated At',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c8709d76-b7a9-4da8-821d-5e92f6d12332' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'InputUnitsUsed')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'c8709d76-b7a9-4da8-821d-5e92f6d12332',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e5479dff-3e26-4dbc-9874-cdd28d690296' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'OutputUnitsUsed')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e5479dff-3e26-4dbc-9874-cdd28d690296',
            '7C1C98D0-3978-4CE8-8E3F-C90301E59767', -- Entity: MJ: AI Prompt Runs
            90,
            'OutputUnitsUsed',
            'Output Units Used',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '728cddeb-df2e-4b7e-b77d-331715e1632f' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'UsageTypeID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '728cddeb-df2e-4b7e-b77d-331715e1632f',
            '7C1C98D0-3978-4CE8-8E3F-C90301E59767', -- Entity: MJ: AI Prompt Runs
            91,
            'UsageTypeID',
            'Usage Type ID',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
         SET [Sequence] = [Sequence] + 100000
       WHERE [EntityID] = '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21'
         AND [Sequence] < 100000;

      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e579b2a9-dfa1-4872-8867-1440c16189e9' OR (EntityID = '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21' AND Name = 'UsageTypeID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e579b2a9-dfa1-4872-8867-1440c16189e9',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6abdc4c4-61d3-4cba-bb1a-00375525a72e' OR (EntityID = '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21' AND Name = 'UnitsPerBillingUnit')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '6abdc4c4-61d3-4cba-bb1a-00375525a72e',
            '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21', -- Entity: MJ: AI Model Price Unit Types
            8,
            'UnitsPerBillingUnit',
...
/* SQL text to insert entity field value with ID 6bbcd028-70c6-4d48-b643-cdd8d38f9e58 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('6bbcd028-70c6-4d48-b643-cdd8d38f9e58', 'F925BD99-4B5A-48A4-878A-385E8F2D87E7', 1, 'Claimed', 'Claimed', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 79d1ee8a-8404-4549-a6b9-27c4542ac134 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('79d1ee8a-8404-4549-a6b9-27c4542ac134', 'F925BD99-4B5A-48A4-878A-385E8F2D87E7', 2, 'Expired', 'Expired', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 73e32e1b-0641-44cd-b53b-4a60a1b2775e */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('73e32e1b-0641-44cd-b53b-4a60a1b2775e', 'F925BD99-4B5A-48A4-878A-385E8F2D87E7', 3, 'Pending', 'Pending', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID b5a5ef39-c485-4f34-845b-581a9b34019c */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('b5a5ef39-c485-4f34-845b-581a9b34019c', 'F925BD99-4B5A-48A4-878A-385E8F2D87E7', 4, 'Revoked', 'Revoked', GETUTCDATE(), GETUTCDATE());
...
/* Create Entity Relationship: MJ: Entities -> MJ: Identity Claims (One To Many via EntityID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '4f29b3b2-84fc-41fe-b25b-2aad16789d8b'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('4f29b3b2-84fc-41fe-b25b-2aad16789d8b', 'E0238F34-2837-EF11-86D4-6045BDEE16E6', '58C8C895-E3AA-48C2-BA68-808337235873', 'EntityID', 'One To Many', 1, 1, 78, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: Users -> MJ: Identity Claims (One To Many via ClaimedByUserID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '7b264feb-d3ce-4104-a90a-742448d78299'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('7b264feb-d3ce-4104-a90a-742448d78299', 'E1238F34-2837-EF11-86D4-6045BDEE16E6', '58C8C895-E3AA-48C2-BA68-808337235873', 'ClaimedByUserID', 'One To Many', 1, 1, 105, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: AI Usage Types -> MJ: AI Prompt Runs (One To Many via UsageTypeID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '073a94eb-9816-4a56-aae7-782c34d95e3d'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('073a94eb-9816-4a56-aae7-782c34d95e3d', '0D78E58B-907C-4C78-BDFB-8541B22B950C', '7C1C98D0-3978-4CE8-8E3F-C90301E59767', 'UsageTypeID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;
                    
/* Create Entity Relationship: MJ: AI Usage Types -> MJ: AI Model Price Unit Types (One To Many via UsageTypeID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '7fae0a69-f0e7-4ebd-95da-48d325d92b4d'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('7fae0a69-f0e7-4ebd-95da-48d325d92b4d', '0D78E58B-907C-4C78-BDFB-8541B22B950C', '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21', 'UsageTypeID', 'One To Many', 1, 1, 2, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: Identity Claim Types -> MJ: Identity Claims (One To Many via ClaimTypeID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '5f62a9c2-3cfa-434a-9014-1725ed28d013'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('5f62a9c2-3cfa-434a-9014-1725ed28d013', '38D9DE43-C0C2-45DA-81BB-A815B30F86FB', '58C8C895-E3AA-48C2-BA68-808337235873', 'ClaimTypeID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: MJ: Magic Link Invites -> MJ: Identity Claims (One To Many via MagicLinkInviteID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'f1e2d6a8-3d86-4be8-a5b6-4d2eef3dd372'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('f1e2d6a8-3d86-4be8-a5b6-4d2eef3dd372', 'E41A5DEE-C259-4B6E-A3C5-BB022BD5F10A', '58C8C895-E3AA-48C2-BA68-808337235873', 'MagicLinkInviteID', 'One To Many', 1, 1, 6, GETUTCDATE(), GETUTCDATE())
   END;
...
/* SQL text to update entity field related entity name field map for entity field ID E579B2A9-DFA1-4872-8867-1440C16189E9 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='E579B2A9-DFA1-4872-8867-1440C16189E9', @RelatedEntityNameFieldMap='UsageType';
...
CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateAIModelPriceUnitType]
    ...
    @UsageTypeID uniqueidentifier = NULL,
    @UnitsPerBillingUnit_Clear bit = 0,
    @UnitsPerBillingUnit decimal(19, 8) = NULL
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        ...
        VALUES
            (
                ...
                CASE WHEN @UnitsPerBillingUnit_Clear = 1 THEN NULL ELSE ISNULL(@UnitsPerBillingUnit, NULL) END
            )
    END
    ELSE
    BEGIN
...
BEGIN
    ...
    SET
        ...
        [UnitsPerBillingUnit] = CASE WHEN @UnitsPerBillingUnit_Clear = 1 THEN NULL ELSE ISNULL(@UnitsPerBillingUnit, [UnitsPerBillingUnit]) END
    WHERE
        [ID] = @ID
...
/* SQL text to update entity field related entity name field map for entity field ID 728CDDEB-DF2E-4B7E-B77D-331715E1632F */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='728CDDEB-DF2E-4B7E-B77D-331715E1632F', @RelatedEntityNameFieldMap='UsageType';
...
UPDATE [${flyway:defaultSchema}].[EntityField]
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b1d67a5d-68f4-45b8-8b72-ede76acc80d0' OR (EntityID = '7C1C98D0-3978-4CE8-8E3F-C90301E59767' AND Name = 'UsageType')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'b1d67a5d-68f4-45b8-8b72-ede76acc80d0',
            '7C1C98D0-3978-4CE8-8E3F-C90301E59767', -- Entity: MJ: AI Prompt Runs
            103,
            'UsageType',
            'Usage Type',
...
UPDATE [${flyway:defaultSchema}].[EntityField]
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2b5f1596-f2be-4b57-9494-65f57a48bb20' OR (EntityID = '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21' AND Name = 'UsageType')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '2b5f1596-f2be-4b57-9494-65f57a48bb20',
            '7815F891-EF05-4B4B-BB1C-DB60C1DF9C21', -- Entity: MJ: AI Model Price Unit Types
            9,
            'UsageType',
            'Usage Type',
