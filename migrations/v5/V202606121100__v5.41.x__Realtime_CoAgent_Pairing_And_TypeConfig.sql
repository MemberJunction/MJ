...
-- ********************************************
-- ********************************************
-- IMPORTANT: PRIOR 5.41 migrations had stuff altering AgentType so we need this refresh block before CodeGen output or we get errors
-- ********************************************
-- ********************************************
...
-- CODE GEN RUN 
/* SQL generated to create new entity MJ: AI Agent Paired Agents */
      ...
      VALUES (
         'a67e7115-5e16-4871-94cf-d2c4968081e6',
         'MJ: AI Agent Paired Agents',
         'AI Agent Paired Agents',
         'OPT-IN pairing between a Realtime-type co-agent and the underlying agents it can front in realtime sessions. A co-agent with NO rows is universal (fronts any single agent supplied at runtime — the zero-config default); rows restrict the co-agent to a prebuilt target list. The co-agent must be an Active agent of the Realtime type (enforced server-side).',
         NULL,
         'AIAgentPairedAgent',
         'vwAIAgentPairedAgents',
...
/* SQL generated to add new entity MJ: AI Agent Paired Agents to application ID: 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E' */
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', 'a67e7115-5e16-4871-94cf-d2c4968081e6', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Paired Agents for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('a67e7115-5e16-4871-94cf-d2c4968081e6', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Paired Agents for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('a67e7115-5e16-4871-94cf-d2c4968081e6', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity MJ: AI Agent Paired Agents for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('a67e7115-5e16-4871-94cf-d2c4968081e6', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentPairedAgent] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
UPDATE [${flyway:defaultSchema}].[AIAgentPairedAgent] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentPairedAgent] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentPairedAgent] ADD CONSTRAINT [DF___mj_AIAgentPairedAgent___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt];
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentPairedAgent] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
UPDATE [${flyway:defaultSchema}].[AIAgentPairedAgent] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentPairedAgent] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentPairedAgent */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentPairedAgent] ADD CONSTRAINT [DF___mj_AIAgentPairedAgent___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt];
GO

/* SQL text to insert new entity field */

      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'eadd24b3-2a06-4b60-a9eb-c29a75def795' OR (EntityID = 'CDB135CC-6D3C-480B-90AE-25B7805F82C1' AND Name = 'TypeConfiguration')) BEGIN
         ...
         VALUES
         (
            'eadd24b3-2a06-4b60-a9eb-c29a75def795',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'fa8ba1f8-ec55-40bc-b8c5-980a8e405715' OR (EntityID = '65CDC348-C4A6-4D00-A57B-2D489C56F128' AND Name = 'ConfigSchema')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'fa8ba1f8-ec55-40bc-b8c5-980a8e405715',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'edf69b3b-96c3-463a-aa5d-e41631e98512' OR (EntityID = '65CDC348-C4A6-4D00-A57B-2D489C56F128' AND Name = 'DefaultConfiguration')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'edf69b3b-96c3-463a-aa5d-e41631e98512',
            '65CDC348-C4A6-4D00-A57B-2D489C56F128', -- Entity: MJ: AI Agent Types
            100039,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6701c35e-a05e-4695-b02a-e1bb91abb156' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '6701c35e-a05e-4695-b02a-e1bb91abb156',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100001,
            'ID',
            'ID',
            NULL,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1218826b-0b17-4671-bc74-15bc83b8874c' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = 'CoAgentID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '1218826b-0b17-4671-bc74-15bc83b8874c',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100002,
            'CoAgentID',
            'Co Agent ID',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '09b7d658-8d32-4022-837c-e9d49f61cf10' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = 'TargetAgentID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '09b7d658-8d32-4022-837c-e9d49f61cf10',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100003,
            'TargetAgentID',
            'Target Agent ID',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2a175e19-f21c-493f-89ac-e8ac0ad8a860' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = 'IsDefault')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '2a175e19-f21c-493f-89ac-e8ac0ad8a860',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100004,
            'IsDefault',
            'Is Default',
            'When 1, this target is the co-agent''s default underlying agent — used when a session starts against the co-agent without an explicit runtime target. At most one default per co-agent is enforced server-side.',
            'bit',
            1,
            1,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5f5c914c-c62b-4bb0-955d-c6f174ca1817' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = 'Sequence')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '5f5c914c-c62b-4bb0-955d-c6f174ca1817',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100005,
            'Sequence',
            'Sequence',
            'Display/priority order of this pairing in target-agent pickers (ascending).',
            'int',
            4,
            10,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '55be7c04-711c-4079-abde-461fbb9673b3' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '55be7c04-711c-4079-abde-461fbb9673b3',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100006,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '779fcb1a-7d5a-4cad-b408-74f0bb09bdcd' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '779fcb1a-7d5a-4cad-b408-74f0bb09bdcd',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100007,
            '__mj_UpdatedAt',
            'Updated At',
...
/* Create Entity Relationship: MJ: AI Agents -> MJ: AI Agent Paired Agents (One To Many via CoAgentID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '97f95a17-dc0d-4800-9195-6488d2c909b9'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('97f95a17-dc0d-4800-9195-6488d2c909b9', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', 'A67E7115-5E16-4871-94CF-D2C4968081E6', 'CoAgentID', 'One To Many', 1, 1, 31, GETUTCDATE(), GETUTCDATE())
   END;
                    
/* Create Entity Relationship: MJ: AI Agents -> MJ: AI Agent Paired Agents (One To Many via TargetAgentID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '35577395-1588-490a-ad8d-cb86be0bb704'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('35577395-1588-490a-ad8d-cb86be0bb704', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', 'A67E7115-5E16-4871-94CF-D2C4968081E6', 'TargetAgentID', 'One To Many', 1, 1, 32, GETUTCDATE(), GETUTCDATE())
   END;
...
/* Index for Foreign Keys for AIAgentPairedAgent */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Paired Agents
-- Item: Index for Foreign Keys
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
-- Index for foreign key CoAgentID in table AIAgentPairedAgent
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_AIAgentPairedAgent_CoAgentID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentPairedAgent]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentPairedAgent_CoAgentID ON [${flyway:defaultSchema}].[AIAgentPairedAgent] ([CoAgentID]);

-- Index for foreign key TargetAgentID in table AIAgentPairedAgent
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_AIAgentPairedAgent_TargetAgentID' 
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentPairedAgent]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentPairedAgent_TargetAgentID ON [${flyway:defaultSchema}].[AIAgentPairedAgent] ([TargetAgentID]);

/* SQL text to update entity field related entity name field map for entity field ID 1218826B-0B17-4671-BC74-15BC83B8874C */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='1218826B-0B17-4671-BC74-15BC83B8874C', @RelatedEntityNameFieldMap='CoAgent';

/* SQL text to update entity field related entity name field map for entity field ID 09B7D658-8D32-4022-837C-E9D49F61CF10 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='09B7D658-8D32-4022-837C-E9D49F61CF10', @RelatedEntityNameFieldMap='TargetAgent';

/* Base View SQL for MJ: AI Agent Paired Agents */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Paired Agents
-- Item: vwAIAgentPairedAgents
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- BASE VIEW FOR ENTITY:      MJ: AI Agent Paired Agents
-----               SCHEMA:      ${flyway:defaultSchema}
-----               BASE TABLE:  AIAgentPairedAgent
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[vwAIAgentPairedAgents]', 'V') IS NOT NULL
    DROP VIEW [${flyway:defaultSchema}].[vwAIAgentPairedAgents];
GO

CREATE VIEW [${flyway:defaultSchema}].[vwAIAgentPairedAgents]
AS
SELECT
    a.*,
...
FROM
    [${flyway:defaultSchema}].[AIAgentPairedAgent] AS a
INNER JOIN
...
GO
GRANT SELECT ON [${flyway:defaultSchema}].[vwAIAgentPairedAgents] TO [cdp_UI], [cdp_Developer], [cdp_Integration];

/* Base View Permissions SQL for MJ: AI Agent Paired Agents */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Paired Agents
-- Item: Permissions for vwAIAgentPairedAgents
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
/* spCreate SQL for MJ: AI Agent Paired Agents */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Paired Agents
-- Item: spCreateAIAgentPairedAgent
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- CREATE PROCEDURE FOR AIAgentPairedAgent
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spCreateAIAgentPairedAgent]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentPairedAgent];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentPairedAgent]
    @ID uniqueidentifier = NULL,
    @CoAgentID uniqueidentifier,
    @TargetAgentID uniqueidentifier,
    @IsDefault bit = NULL,
    @Sequence int = NULL
AS
BEGIN
    ...
    BEGIN
        -- User provided a value, use it
        INSERT INTO [${flyway:defaultSchema}].[AIAgentPairedAgent]
            (
                [ID],
                [CoAgentID],
                [TargetAgentID],
    ...
    END
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [${flyway:defaultSchema}].[vwAIAgentPairedAgents] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spCreateAIAgentPairedAgent] TO [cdp_Developer], [cdp_Integration];

/* spCreate Permissions for MJ: AI Agent Paired Agents */

GRANT EXECUTE ON [${flyway:defaultSchema}].[spCreateAIAgentPairedAgent] TO [cdp_Developer], [cdp_Integration];

/* spUpdate SQL for MJ: AI Agent Paired Agents */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Paired Agents
-- Item: spUpdateAIAgentPairedAgent
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- UPDATE PROCEDURE FOR AIAgentPairedAgent
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spUpdateAIAgentPairedAgent]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentPairedAgent];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentPairedAgent]
    @ID uniqueidentifier,
...
BEGIN
    SET NOCOUNT ON;
    UPDATE
        [${flyway:defaultSchema}].[AIAgentPairedAgent]
    SET
        [CoAgentID] = ISNULL(@CoAgentID, [CoAgentID]),
        [TargetAgentID] = ISNULL(@TargetAgentID, [TargetAgentID]),
    ...
    IF @@ROWCOUNT = 0
        -- Nothing was updated, return no rows, but column structure from base view intact, semantically correct this way.
        SELECT TOP 0 * FROM [${flyway:defaultSchema}].[vwAIAgentPairedAgents] WHERE 1=0
    ELSE
        -- Return the updated record so the caller can see the updated values and any calculated fields
        SELECT
                                        *
                                    FROM
                                        [${flyway:defaultSchema}].[vwAIAgentPairedAgents]
                                    WHERE
                                        [ID] = @ID
...
GRANT EXECUTE ON [${flyway:defaultSchema}].[spUpdateAIAgentPairedAgent] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the AIAgentPairedAgent table
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[trgUpdateAIAgentPairedAgent]', 'TR') IS NOT NULL
    DROP TRIGGER [${flyway:defaultSchema}].[trgUpdateAIAgentPairedAgent];
GO
CREATE TRIGGER [${flyway:defaultSchema}].trgUpdateAIAgentPairedAgent
ON [${flyway:defaultSchema}].[AIAgentPairedAgent]
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SET
        __mj_UpdatedAt = GETUTCDATE()
    FROM
        [${flyway:defaultSchema}].[AIAgentPairedAgent] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
        _organicTable.[ID] = I.[ID];
END;
...
/* spUpdate Permissions for MJ: AI Agent Paired Agents */

GRANT EXECUTE ON [${flyway:defaultSchema}].[spUpdateAIAgentPairedAgent] TO [cdp_Developer], [cdp_Integration];

/* spDelete SQL for MJ: AI Agent Paired Agents */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Paired Agents
-- Item: spDeleteAIAgentPairedAgent
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- DELETE PROCEDURE FOR AIAgentPairedAgent
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spDeleteAIAgentPairedAgent]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spDeleteAIAgentPairedAgent];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spDeleteAIAgentPairedAgent]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spDeleteAIAgentPairedAgent] TO [cdp_Developer], [cdp_Integration];

/* spDelete Permissions for MJ: AI Agent Paired Agents */
...
BEGIN
    ...
    -- Cascade delete from AIAgentPairedAgent using cursor to call spDeleteAIAgentPairedAgent
    DECLARE @MJAIAgentPairedAgents_CoAgentIDID uniqueidentifier
    DECLARE cascade_delete_MJAIAgentPairedAgents_CoAgentID_cursor CURSOR FOR 
        SELECT [ID]
        FROM [${flyway:defaultSchema}].[AIAgentPairedAgent]
        WHERE [CoAgentID] = @ID
    
    OPEN cascade_delete_MJAIAgentPairedAgents_CoAgentID_cursor
    FETCH NEXT FROM cascade_delete_MJAIAgentPairedAgents_CoAgentID_cursor INTO @MJAIAgentPairedAgents_CoAgentIDID
    
    WHILE @@FETCH_STATUS = 0
    BEGIN
        EXEC [${flyway:defaultSchema}].[spDeleteAIAgentPairedAgent] @ID = @MJAIAgentPairedAgents_CoAgentIDID
        
        FETCH NEXT FROM cascade_delete_MJAIAgentPairedAgents_CoAgentID_cursor INTO @MJAIAgentPairedAgents_CoAgentIDID
    END
    
    CLOSE cascade_delete_MJAIAgentPairedAgents_CoAgentID_cursor
    DEALLOCATE cascade_delete_MJAIAgentPairedAgents_CoAgentID_cursor
    
    -- Cascade delete from AIAgentPairedAgent using cursor to call spDeleteAIAgentPairedAgent
    DECLARE @MJAIAgentPairedAgents_TargetAgentIDID uniqueidentifier
    DECLARE cascade_delete_MJAIAgentPairedAgents_TargetAgentID_cursor CURSOR FOR 
        SELECT [ID]
        FROM [${flyway:defaultSchema}].[AIAgentPairedAgent]
        WHERE [TargetAgentID] = @ID
    
    OPEN cascade_delete_MJAIAgentPairedAgents_TargetAgentID_cursor
    FETCH NEXT FROM cascade_delete_MJAIAgentPairedAgents_TargetAgentID_cursor INTO @MJAIAgentPairedAgents_TargetAgentIDID
    
    WHILE @@FETCH_STATUS = 0
    BEGIN
        EXEC [${flyway:defaultSchema}].[spDeleteAIAgentPairedAgent] @ID = @MJAIAgentPairedAgents_TargetAgentIDID
        
        FETCH NEXT FROM cascade_delete_MJAIAgentPairedAgents_TargetAgentID_cursor INTO @MJAIAgentPairedAgents_TargetAgentIDID
    END
    
    CLOSE cascade_delete_MJAIAgentPairedAgents_TargetAgentID_cursor
    DEALLOCATE cascade_delete_MJAIAgentPairedAgents_TargetAgentID_cursor
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c7394f54-833c-48b2-a1e9-fc6f427d2009' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = 'CoAgent')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'c7394f54-833c-48b2-a1e9-fc6f427d2009',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100015,
            'CoAgent',
            'Co Agent',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'db6b51dc-548a-4db8-b2a4-e8c4ab4231dd' OR (EntityID = 'A67E7115-5E16-4871-94CF-D2C4968081E6' AND Name = 'TargetAgent')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'db6b51dc-548a-4db8-b2a4-e8c4ab4231dd',
            'A67E7115-5E16-4871-94CF-D2C4968081E6', -- Entity: MJ: AI Agent Paired Agents
            100016,
            'TargetAgent',
            'Target Agent',
...
/* Set field properties for entity */
               ...
               SET IsNameField = 1
               WHERE ID = 'C7394F54-833C-48B2-A1E9-FC6F427D2009'
               AND AutoUpdateIsNameField = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET IsNameField = 1
               WHERE ID = 'DB6B51DC-548A-4DB8-B2A4-E8C4AB4231DD'
               AND AutoUpdateIsNameField = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '2A175E19-F21C-493F-89AC-E8AC0AD8A860'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '5F5C914C-C62B-4BB0-955D-C6F174CA1817'
               AND AutoUpdateDefaultInView = 1;
...
-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.ID 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '6701C35E-A05E-4695-B02A-E1BB91ABB156' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.CoAgentID 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   Category = 'Agent Pairing',
   GeneratedFormSection = 'Category',
   DisplayName = 'Co-Agent',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
   ID = '1218826B-0B17-4671-BC74-15BC83B8874C' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.TargetAgentID 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   Category = 'Agent Pairing',
   GeneratedFormSection = 'Category',
   ...
   CodeType = NULL
WHERE 
   ID = '09B7D658-8D32-4022-837C-E9D49F61CF10' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.CoAgent 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   Category = 'Agent Pairing',
   GeneratedFormSection = 'Category',
   ...
   CodeType = NULL
WHERE 
   ID = 'C7394F54-833C-48B2-A1E9-FC6F427D2009' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.TargetAgent 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   Category = 'Agent Pairing',
   GeneratedFormSection = 'Category',
   ...
   CodeType = NULL
WHERE 
   ID = 'DB6B51DC-548A-4DB8-B2A4-E8C4AB4231DD' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.IsDefault 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '2A175E19-F21C-493F-89AC-E8AC0AD8A860' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.Sequence 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   Category = 'Configuration',
   GeneratedFormSection = 'Category',
   ...
   CodeType = NULL
WHERE 
   ID = '5F5C914C-C62B-4BB0-955D-C6F174CA1817' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.__mj_CreatedAt 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   Category = 'System Metadata',
   GeneratedFormSection = 'Category',
   ...
   CodeType = NULL
WHERE 
   ID = '55BE7C04-711C-4079-ABDE-461FBB9673B3' AND AutoUpdateCategory = 1;

-- UPDATE Entity Field Category Info MJ: AI Agent Paired Agents.__mj_UpdatedAt 
UPDATE [${flyway:defaultSchema}].[EntityField]
SET 
   Category = 'System Metadata',
   GeneratedFormSection = 'Category',
   ...
   CodeType = NULL
WHERE 
   ID = '779FCB1A-7D5A-4CAD-B408-74F0BB09BDCD' AND AutoUpdateCategory = 1;

/* Set entity icon to fa fa-robot */

               UPDATE [${flyway:defaultSchema}].[Entity]
               SET [Icon] = 'fa fa-robot', [__mj_UpdatedAt] = GETUTCDATE()
               WHERE [ID] = 'A67E7115-5E16-4871-94CF-D2C4968081E6';

/* Insert FieldCategoryInfo setting for entity */

               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('182f7953-8a7e-40fa-94bf-af4ae2fcb702', 'A67E7115-5E16-4871-94CF-D2C4968081E6', 'FieldCategoryInfo', '{"Agent Pairing":{"icon":"fa fa-link","description":"Defines the relationship between co-agents and their underlying target agents."},"Configuration":{"icon":"fa fa-sliders-h","description":"Settings for agent behavior, defaults, and display order."},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit and tracking fields."}}', GETUTCDATE(), GETUTCDATE());

/* Insert FieldCategoryIcons setting (legacy) */

               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('8c6659dc-011d-4151-b552-9f0da2d76274', 'A67E7115-5E16-4871-94CF-D2C4968081E6', 'FieldCategoryIcons', '{"Agent Pairing":"fa fa-link","Configuration":"fa fa-sliders-h","System Metadata":"fa fa-cog"}', GETUTCDATE(), GETUTCDATE());

/* Set DefaultForNewUser=false for NEW entity (category: supporting, confidence: high) */

         UPDATE [${flyway:defaultSchema}].[ApplicationEntity]
         SET [DefaultForNewUser] = 0, [__mj_UpdatedAt] = GETUTCDATE()
         WHERE [EntityID] = 'A67E7115-5E16-4871-94CF-D2C4968081E6';
...
SET 
   ...
   CodeType = 'Other'
WHERE 
   ID = 'FA8BA1F8-EC55-40BC-B8C5-980A8E405715' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = 'Other'
WHERE 
   ID = 'EDF69B3B-96C3-463A-AA5D-E41631E98512' AND AutoUpdateCategory = 1;
...
/* Update FieldCategoryInfo setting for entity */
               ...
               SET [Value] = '{"Configuration Settings":{"icon":"fa fa-cogs","description":"Schemas and default JSON configurations for agent behavior"}}', [__mj_UpdatedAt] = GETUTCDATE()
               WHERE [EntityID] = '65CDC348-C4A6-4D00-A57B-2D489C56F128' AND [Name] = 'FieldCategoryInfo';

/* Update FieldCategoryIcons setting (legacy) */

               UPDATE [${flyway:defaultSchema}].[EntitySetting]
               SET [Value] = '{"Configuration Settings":"fa fa-cogs"}', [__mj_UpdatedAt] = GETUTCDATE()
...
SET 
   ...
   CodeType = 'Other'
WHERE 
   ID = 'EADD24B3-2A06-4B60-A9EB-C29A75DEF795' AND AutoUpdateCategory = 1;
...
SET 
   GeneratedFormSection = 'Category',
   DisplayName = 'Search Access',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
   ID = '948E9C24-C50E-47BF-8A93-D4ABAA0BBBBB' AND AutoUpdateCategory = 1;

/* Generated Validation Functions for MJ: AI Agent Paired Agents */
-- CHECK constraint for MJ: AI Agent Paired Agents @ Table Level was newly set or modified since the last generation of the validation function, the code was regenerated and updating the GeneratedCode table with the new generated validation function
INSERT INTO [${flyway:defaultSchema}].[GeneratedCode] ([CategoryID], [GeneratedByModelID], [GeneratedAt], [Language], [Status], [Source], [Code], [Description], [Name], [LinkedEntityID], [LinkedRecordPrimaryKey])
                      VALUES ((SELECT [ID] FROM [${flyway:defaultSchema}].[vwGeneratedCodeCategories] WHERE [Name]='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', GETUTCDATE(), 'TypeScript', 'Approved', '([CoAgentID]<>[TargetAgentID])', 'public ValidateCoAgentIDNotEqualToTargetAgentID(result: ValidationResult) {
...
}', 'The co-agent and the target agent must be different. An agent cannot be assigned as their own co-agent.', 'ValidateCoAgentIDNotEqualToTargetAgentID', 'E0238F34-2837-EF11-86D4-6045BDEE16E6', 'A67E7115-5E16-4871-94CF-D2C4968081E6');
