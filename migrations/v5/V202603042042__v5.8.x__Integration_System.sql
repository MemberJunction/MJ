...
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='6BEFB401-01DD-454A-BB34-D300E78AB97D', @RelatedEntityNameFieldMap='EntityMap'
...
FROM
    [${flyway:defaultSchema}].[CompanyIntegrationFieldMap] AS c
INNER JOIN
    [${flyway:defaultSchema}].[CompanyIntegrationEntityMap] AS MJCompanyIntegrationEntityMap_EntityMapID
  ON
...
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='846D8888-AF62-4D4B-AE06-A52C284377A7', @RelatedEntityNameFieldMap='EntityMap'
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c233a240-755e-4148-b635-fb22f47ecf5d' OR (EntityID = 'D5C4FEF3-21D0-4A41-893B-34F9527195F0' AND Name = 'EntityMap')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '0aebc08d-8462-4897-85bf-cc4dd6b7935a' OR (EntityID = 'FECA4EDD-74F9-4A1C-A284-E586E76B23FE' AND Name = 'EntityMap')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to update entity field related entity name field map for entity field ID 6BEFB401-01DD-454A-BB34-D300E78AB97D */
EXEC [__mj].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='6BEFB401-01DD-454A-BB34-D300E78AB97D', @RelatedEntityNameFieldMap='EntityMap'
...
END
GO
GRANT EXECUTE ON [__mj].[spDeleteCompanyIntegrationFieldMap] TO [cdp_Integration]
...
/* SQL text to update entity field related entity name field map for entity field ID 846D8888-AF62-4D4B-AE06-A52C284377A7 */
EXEC [__mj].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='846D8888-AF62-4D4B-AE06-A52C284377A7', @RelatedEntityNameFieldMap='EntityMap'
...
END
GO
GRANT EXECUTE ON [__mj].[spDeleteCompanyIntegrationSyncWatermark] TO [cdp_Integration]
