...
DECLARE @Name_f5f42028 NVARCHAR(255),
@CategoryID_f5f42028 UNIQUEIDENTIFIER,
@UserQuestion_f5f42028 NVARCHAR(MAX),
@Description_f5f42028 NVARCHAR(MAX),
@SQL_f5f42028 NVARCHAR(MAX),
@TechnicalDescription_f5f42028 NVARCHAR(MAX),
@OriginalSQL_f5f42028 NVARCHAR(MAX),
@Feedback_f5f42028 NVARCHAR(MAX),
@Status_f5f42028 NVARCHAR(15),
@QualityRank_f5f42028 INT,
@ExecutionCostRank_f5f42028 INT,
@UsesTemplate_f5f42028 BIT,
@AuditQueryRuns_f5f42028 BIT,
@CacheEnabled_f5f42028 BIT,
@CacheTTLMinutes_f5f42028 INT,
@CacheMaxSize_f5f42028 INT,
@EmbeddingVector_f5f42028 NVARCHAR(MAX),
@EmbeddingModelID_f5f42028 UNIQUEIDENTIFIER,
@CacheValidationSQL_f5f42028 NVARCHAR(MAX),
@ID_f5f42028 UNIQUEIDENTIFIER
SET
  @Name_f5f42028 = N'GetConversationsForMemoryManager'
SET
  @CategoryID_f5f42028 = '5609FBC7-381C-4F9C-9C74-04B52C1FF3DA'
SET
  @UserQuestion_f5f42028 = N'What conversations have new activity that need to be analyzed for memory extraction?'
SET
  @Description_f5f42028 = N'Returns all conversation data needed for memory extraction in a single query: conversations with new activity, their details with ratings, and linked agent runs for scope inheritance. Optimized to replace 4 separate sequential queries.'
SET
  @SQL_f5f42028 = N'-- Get Conversations for Memory Manager - Single optimized query
...
'
SET
  @TechnicalDescription_f5f42028 = N'Single-query optimization that replaces 4 separate RunView calls in Memory Manager (get conversations, get agent runs, get details, get ratings). Uses SQL Server FOR JSON PATH to aggregate conversation details with ratings as JSON arrays. Returns rating summary flags (HasPositiveRating, HasNegativeRating, IsUnrated) and most recent AgentRunID for scope inheritance. Reduces database round trips from 4 to 1.'
SET
  @Status_f5f42028 = N'Approved'
SET
  @QualityRank_f5f42028 = 9
SET
  @ExecutionCostRank_f5f42028 = 3
SET
  @UsesTemplate_f5f42028 = 1
SET
  @AuditQueryRuns_f5f42028 = 0
SET
  @CacheEnabled_f5f42028 = 0
SET
  @EmbeddingVector_f5f42028 = CAST(
...
SET
  @EmbeddingModelID_f5f42028 = '1D45AA65-41EC-4572-9ECD-AB2826C9B059'
SET
  @ID_f5f42028 = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
EXEC [${flyway:defaultSchema}].spUpdateQuery @Name = @Name_f5f42028,
  @CategoryID = @CategoryID_f5f42028,
  @UserQuestion = @UserQuestion_f5f42028,
  @Description = @Description_f5f42028,
  @SQL = @SQL_f5f42028,
  @TechnicalDescription = @TechnicalDescription_f5f42028,
  @OriginalSQL = @OriginalSQL_f5f42028,
  @Feedback = @Feedback_f5f42028,
  @Status = @Status_f5f42028,
  @QualityRank = @QualityRank_f5f42028,
  @ExecutionCostRank = @ExecutionCostRank_f5f42028,
  @UsesTemplate = @UsesTemplate_f5f42028,
  @AuditQueryRuns = @AuditQueryRuns_f5f42028,
  @CacheEnabled = @CacheEnabled_f5f42028,
  @CacheTTLMinutes = @CacheTTLMinutes_f5f42028,
  @CacheMaxSize = @CacheMaxSize_f5f42028,
  @EmbeddingVector = @EmbeddingVector_f5f42028,
  @EmbeddingModelID = @EmbeddingModelID_f5f42028,
  @CacheValidationSQL = @CacheValidationSQL_f5f42028,
  @ID = @ID_f5f42028;

-- Save MJ: Query Parameters (core SP call only)
DECLARE @QueryID_a2930ba2 UNIQUEIDENTIFIER,
@Name_a2930ba2 NVARCHAR(255),
@Type_a2930ba2 NVARCHAR(50),
@IsRequired_a2930ba2 BIT,
@DefaultValue_a2930ba2 NVARCHAR(MAX),
@Description_a2930ba2 NVARCHAR(MAX),
@SampleValue_a2930ba2 NVARCHAR(MAX),
@ValidationFilters_a2930ba2 NVARCHAR(MAX),
@DetectionMethod_a2930ba2 NVARCHAR(50),
@AutoDetectConfidenceScore_a2930ba2 DECIMAL(3, 2),
@ID_a2930ba2 UNIQUEIDENTIFIER
SET
  @QueryID_a2930ba2 = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_a2930ba2 = N'since'
SET
  @Type_a2930ba2 = N'date'
SET
  @IsRequired_a2930ba2 = 0
SET
  @Description_a2930ba2 = N'ISO date string - only include conversations with new activity after this date'
SET
  @SampleValue_a2930ba2 = N'2024-01-15T10:30:00Z'
SET
  @DetectionMethod_a2930ba2 = N'AI'
SET
  @ID_a2930ba2 = 'DF0E9F24-CD92-4C6C-BA18-13B443160DE5'
EXEC [${flyway:defaultSchema}].spUpdateQueryParameter @QueryID = @QueryID_a2930ba2,
  @Name = @Name_a2930ba2,
  @Type = @Type_a2930ba2,
  @IsRequired = @IsRequired_a2930ba2,
  @DefaultValue = @DefaultValue_a2930ba2,
  @Description = @Description_a2930ba2,
  @SampleValue = @SampleValue_a2930ba2,
  @ValidationFilters = @ValidationFilters_a2930ba2,
  @DetectionMethod = @DetectionMethod_a2930ba2,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_a2930ba2,
  @ID = @ID_a2930ba2;

-- Save MJ: Query Parameters (core SP call only)
DECLARE @QueryID_f1753d09 UNIQUEIDENTIFIER,
@Name_f1753d09 NVARCHAR(255),
@Type_f1753d09 NVARCHAR(50),
@IsRequired_f1753d09 BIT,
@DefaultValue_f1753d09 NVARCHAR(MAX),
@Description_f1753d09 NVARCHAR(MAX),
@SampleValue_f1753d09 NVARCHAR(MAX),
@ValidationFilters_f1753d09 NVARCHAR(MAX),
@DetectionMethod_f1753d09 NVARCHAR(50),
@AutoDetectConfidenceScore_f1753d09 DECIMAL(3, 2),
@ID_f1753d09 UNIQUEIDENTIFIER
SET
  @QueryID_f1753d09 = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_f1753d09 = N'agentIds'
SET
  @Type_f1753d09 = N'string'
SET
  @IsRequired_f1753d09 = 1
SET
  @Description_f1753d09 = N'Comma-separated list of agent IDs that have memory enabled'
SET
  @SampleValue_f1753d09 = N'''agent1'',''agent2'',''agent3'''
SET
  @DetectionMethod_f1753d09 = N'AI'
SET
  @ID_f1753d09 = 'AF4459A1-BEDA-4200-A739-4292E90EA6A1'
EXEC [${flyway:defaultSchema}].spUpdateQueryParameter @QueryID = @QueryID_f1753d09,
  @Name = @Name_f1753d09,
  @Type = @Type_f1753d09,
  @IsRequired = @IsRequired_f1753d09,
  @DefaultValue = @DefaultValue_f1753d09,
  @Description = @Description_f1753d09,
  @SampleValue = @SampleValue_f1753d09,
  @ValidationFilters = @ValidationFilters_f1753d09,
  @DetectionMethod = @DetectionMethod_f1753d09,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_f1753d09,
  @ID = @ID_f1753d09;

-- Save MJ: Query Fields (core SP call only)
DECLARE @QueryID_99318626 UNIQUEIDENTIFIER,
@Name_99318626 NVARCHAR(255),
@Description_99318626 NVARCHAR(MAX),
@Sequence_99318626 INT,
@SQLBaseType_99318626 NVARCHAR(50),
@SQLFullType_99318626 NVARCHAR(100),
@SourceEntityID_99318626 UNIQUEIDENTIFIER,
@SourceFieldName_99318626 NVARCHAR(255),
@IsComputed_99318626 BIT,
@ComputationDescription_99318626 NVARCHAR(MAX),
@IsSummary_99318626 BIT,
@SummaryDescription_99318626 NVARCHAR(MAX),
@DetectionMethod_99318626 NVARCHAR(50),
@AutoDetectConfidenceScore_99318626 DECIMAL(3, 2),
@ID_99318626 UNIQUEIDENTIFIER
SET
  @QueryID_99318626 = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_99318626 = N'HasPositiveRating'
SET
  @Description_99318626 = N'Flag indicating if conversation has at least one rating >= 8'
SET
  @Sequence_99318626 = 5
SET
  @SQLBaseType_99318626 = N'bit'
SET
  @SQLFullType_99318626 = N'bit'
SET
  @IsComputed_99318626 = 1
SET
  @ComputationDescription_99318626 = N'CASE expression checking EXISTS for ratings >= 8'
SET
  @IsSummary_99318626 = 0
SET
  @DetectionMethod_99318626 = N'Manual'
SET
  @ID_99318626 = 'ADC80F10-C778-46A7-AB21-1474FF3051BA'
EXEC [${flyway:defaultSchema}].spUpdateQueryField @QueryID = @QueryID_99318626,
  @Name = @Name_99318626,
  @Description = @Description_99318626,
  @Sequence = @Sequence_99318626,
  @SQLBaseType = @SQLBaseType_99318626,
  @SQLFullType = @SQLFullType_99318626,
  @SourceEntityID = @SourceEntityID_99318626,
  @SourceFieldName = @SourceFieldName_99318626,
  @IsComputed = @IsComputed_99318626,
  @ComputationDescription = @ComputationDescription_99318626,
  @IsSummary = @IsSummary_99318626,
  @SummaryDescription = @SummaryDescription_99318626,
  @DetectionMethod = @DetectionMethod_99318626,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_99318626,
  @ID = @ID_99318626;

-- Save MJ: Query Fields (core SP call only)
DECLARE @QueryID_04daae0e UNIQUEIDENTIFIER,
@Name_04daae0e NVARCHAR(255),
@Description_04daae0e NVARCHAR(MAX),
@Sequence_04daae0e INT,
@SQLBaseType_04daae0e NVARCHAR(50),
@SQLFullType_04daae0e NVARCHAR(100),
@SourceEntityID_04daae0e UNIQUEIDENTIFIER,
@SourceFieldName_04daae0e NVARCHAR(255),
@IsComputed_04daae0e BIT,
@ComputationDescription_04daae0e NVARCHAR(MAX),
@IsSummary_04daae0e BIT,
@SummaryDescription_04daae0e NVARCHAR(MAX),
@DetectionMethod_04daae0e NVARCHAR(50),
@AutoDetectConfidenceScore_04daae0e DECIMAL(3, 2),
@ID_04daae0e UNIQUEIDENTIFIER
SET
  @QueryID_04daae0e = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_04daae0e = N'UserID'
SET
  @Description_04daae0e = N'Unique identifier of the user associated with the conversation'
SET
  @Sequence_04daae0e = 2
SET
  @SQLBaseType_04daae0e = N'nvarchar'
SET
  @SQLFullType_04daae0e = N'nvarchar(MAX)'
SET
  @SourceEntityID_04daae0e = '13248F34-2837-EF11-86D4-6045BDEE16E6'
SET
  @SourceFieldName_04daae0e = N'UserID'
SET
  @IsComputed_04daae0e = 0
SET
  @IsSummary_04daae0e = 0
SET
  @DetectionMethod_04daae0e = N'Manual'
SET
  @ID_04daae0e = 'FC47BF02-BE51-4C7C-9132-1C20ADC4FEBD'
EXEC [${flyway:defaultSchema}].spUpdateQueryField @QueryID = @QueryID_04daae0e,
  @Name = @Name_04daae0e,
  @Description = @Description_04daae0e,
  @Sequence = @Sequence_04daae0e,
  @SQLBaseType = @SQLBaseType_04daae0e,
  @SQLFullType = @SQLFullType_04daae0e,
  @SourceEntityID = @SourceEntityID_04daae0e,
  @SourceFieldName = @SourceFieldName_04daae0e,
  @IsComputed = @IsComputed_04daae0e,
  @ComputationDescription = @ComputationDescription_04daae0e,
  @IsSummary = @IsSummary_04daae0e,
  @SummaryDescription = @SummaryDescription_04daae0e,
  @DetectionMethod = @DetectionMethod_04daae0e,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_04daae0e,
  @ID = @ID_04daae0e;

-- Save MJ: Query Fields (core SP call only)
DECLARE @QueryID_1d3b66fe UNIQUEIDENTIFIER,
@Name_1d3b66fe NVARCHAR(255),
@Description_1d3b66fe NVARCHAR(MAX),
@Sequence_1d3b66fe INT,
@SQLBaseType_1d3b66fe NVARCHAR(50),
@SQLFullType_1d3b66fe NVARCHAR(100),
@SourceEntityID_1d3b66fe UNIQUEIDENTIFIER,
@SourceFieldName_1d3b66fe NVARCHAR(255),
@IsComputed_1d3b66fe BIT,
@ComputationDescription_1d3b66fe NVARCHAR(MAX),
@IsSummary_1d3b66fe BIT,
@SummaryDescription_1d3b66fe NVARCHAR(MAX),
@DetectionMethod_1d3b66fe NVARCHAR(50),
@AutoDetectConfidenceScore_1d3b66fe DECIMAL(3, 2),
@ID_1d3b66fe UNIQUEIDENTIFIER
SET
  @QueryID_1d3b66fe = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_1d3b66fe = N'MessagesJSON'
SET
  @Description_1d3b66fe = N'Conversation details as JSON array with ratings included'
SET
  @Sequence_1d3b66fe = 4
SET
  @SQLBaseType_1d3b66fe = N'nvarchar'
SET
  @SQLFullType_1d3b66fe = N'nvarchar(MAX)'
SET
  @IsComputed_1d3b66fe = 1
SET
  @ComputationDescription_1d3b66fe = N'FOR JSON PATH subquery aggregating conversation details and ratings'
SET
  @IsSummary_1d3b66fe = 0
SET
  @DetectionMethod_1d3b66fe = N'Manual'
SET
  @ID_1d3b66fe = 'CB76A976-AE46-454B-B837-90A78B74ED50'
EXEC [${flyway:defaultSchema}].spUpdateQueryField @QueryID = @QueryID_1d3b66fe,
  @Name = @Name_1d3b66fe,
  @Description = @Description_1d3b66fe,
  @Sequence = @Sequence_1d3b66fe,
  @SQLBaseType = @SQLBaseType_1d3b66fe,
  @SQLFullType = @SQLFullType_1d3b66fe,
  @SourceEntityID = @SourceEntityID_1d3b66fe,
  @SourceFieldName = @SourceFieldName_1d3b66fe,
  @IsComputed = @IsComputed_1d3b66fe,
  @ComputationDescription = @ComputationDescription_1d3b66fe,
  @IsSummary = @IsSummary_1d3b66fe,
  @SummaryDescription = @SummaryDescription_1d3b66fe,
  @DetectionMethod = @DetectionMethod_1d3b66fe,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_1d3b66fe,
  @ID = @ID_1d3b66fe;

-- Save MJ: Query Fields (core SP call only)
DECLARE @QueryID_eb2e360e UNIQUEIDENTIFIER,
@Name_eb2e360e NVARCHAR(255),
@Description_eb2e360e NVARCHAR(MAX),
@Sequence_eb2e360e INT,
@SQLBaseType_eb2e360e NVARCHAR(50),
@SQLFullType_eb2e360e NVARCHAR(100),
@SourceEntityID_eb2e360e UNIQUEIDENTIFIER,
@SourceFieldName_eb2e360e NVARCHAR(255),
@IsComputed_eb2e360e BIT,
@ComputationDescription_eb2e360e NVARCHAR(MAX),
@IsSummary_eb2e360e BIT,
@SummaryDescription_eb2e360e NVARCHAR(MAX),
@DetectionMethod_eb2e360e NVARCHAR(50),
@AutoDetectConfidenceScore_eb2e360e DECIMAL(3, 2),
@ID_eb2e360e UNIQUEIDENTIFIER
SET
  @QueryID_eb2e360e = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_eb2e360e = N'AgentRunID'
SET
  @Description_eb2e360e = N'Most recent agent run ID for this conversation (for scope inheritance)'
SET
  @Sequence_eb2e360e = 3
SET
  @SQLBaseType_eb2e360e = N'nvarchar'
SET
  @SQLFullType_eb2e360e = N'nvarchar(MAX)'
SET
  @IsComputed_eb2e360e = 1
SET
  @ComputationDescription_eb2e360e = N'Scalar subquery selecting top 1 ID from AIAgentRuns ordered by StartedAt DESC'
SET
  @IsSummary_eb2e360e = 0
SET
  @DetectionMethod_eb2e360e = N'Manual'
SET
  @ID_eb2e360e = '4CAB47E1-C542-4CDD-9BEF-90BFC2786FF0'
EXEC [${flyway:defaultSchema}].spUpdateQueryField @QueryID = @QueryID_eb2e360e,
  @Name = @Name_eb2e360e,
  @Description = @Description_eb2e360e,
  @Sequence = @Sequence_eb2e360e,
  @SQLBaseType = @SQLBaseType_eb2e360e,
  @SQLFullType = @SQLFullType_eb2e360e,
  @SourceEntityID = @SourceEntityID_eb2e360e,
  @SourceFieldName = @SourceFieldName_eb2e360e,
  @IsComputed = @IsComputed_eb2e360e,
  @ComputationDescription = @ComputationDescription_eb2e360e,
  @IsSummary = @IsSummary_eb2e360e,
  @SummaryDescription = @SummaryDescription_eb2e360e,
  @DetectionMethod = @DetectionMethod_eb2e360e,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_eb2e360e,
  @ID = @ID_eb2e360e;

-- Save MJ: Query Fields (core SP call only)
DECLARE @QueryID_57c0eeaa UNIQUEIDENTIFIER,
@Name_57c0eeaa NVARCHAR(255),
@Description_57c0eeaa NVARCHAR(MAX),
@Sequence_57c0eeaa INT,
@SQLBaseType_57c0eeaa NVARCHAR(50),
@SQLFullType_57c0eeaa NVARCHAR(100),
@SourceEntityID_57c0eeaa UNIQUEIDENTIFIER,
@SourceFieldName_57c0eeaa NVARCHAR(255),
@IsComputed_57c0eeaa BIT,
@ComputationDescription_57c0eeaa NVARCHAR(MAX),
@IsSummary_57c0eeaa BIT,
@SummaryDescription_57c0eeaa NVARCHAR(MAX),
@DetectionMethod_57c0eeaa NVARCHAR(50),
@AutoDetectConfidenceScore_57c0eeaa DECIMAL(3, 2),
@ID_57c0eeaa UNIQUEIDENTIFIER
SET
  @QueryID_57c0eeaa = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_57c0eeaa = N'HasNegativeRating'
SET
  @Description_57c0eeaa = N'Flag indicating if conversation has at least one rating <= 3'
SET
  @Sequence_57c0eeaa = 6
SET
  @SQLBaseType_57c0eeaa = N'bit'
SET
  @SQLFullType_57c0eeaa = N'bit'
SET
  @IsComputed_57c0eeaa = 1
SET
  @ComputationDescription_57c0eeaa = N'CASE expression checking EXISTS for ratings <= 3'
SET
  @IsSummary_57c0eeaa = 0
SET
  @DetectionMethod_57c0eeaa = N'Manual'
SET
  @ID_57c0eeaa = '5A464544-F105-4F17-94F8-A0423F150812'
EXEC [${flyway:defaultSchema}].spUpdateQueryField @QueryID = @QueryID_57c0eeaa,
  @Name = @Name_57c0eeaa,
  @Description = @Description_57c0eeaa,
  @Sequence = @Sequence_57c0eeaa,
  @SQLBaseType = @SQLBaseType_57c0eeaa,
  @SQLFullType = @SQLFullType_57c0eeaa,
  @SourceEntityID = @SourceEntityID_57c0eeaa,
  @SourceFieldName = @SourceFieldName_57c0eeaa,
  @IsComputed = @IsComputed_57c0eeaa,
  @ComputationDescription = @ComputationDescription_57c0eeaa,
  @IsSummary = @IsSummary_57c0eeaa,
  @SummaryDescription = @SummaryDescription_57c0eeaa,
  @DetectionMethod = @DetectionMethod_57c0eeaa,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_57c0eeaa,
  @ID = @ID_57c0eeaa;

-- Save MJ: Query Fields (core SP call only)
DECLARE @QueryID_dc77f32e UNIQUEIDENTIFIER,
@Name_dc77f32e NVARCHAR(255),
@Description_dc77f32e NVARCHAR(MAX),
@Sequence_dc77f32e INT,
@SQLBaseType_dc77f32e NVARCHAR(50),
@SQLFullType_dc77f32e NVARCHAR(100),
@SourceEntityID_dc77f32e UNIQUEIDENTIFIER,
@SourceFieldName_dc77f32e NVARCHAR(255),
@IsComputed_dc77f32e BIT,
@ComputationDescription_dc77f32e NVARCHAR(MAX),
@IsSummary_dc77f32e BIT,
@SummaryDescription_dc77f32e NVARCHAR(MAX),
@DetectionMethod_dc77f32e NVARCHAR(50),
@AutoDetectConfidenceScore_dc77f32e DECIMAL(3, 2),
@ID_dc77f32e UNIQUEIDENTIFIER
SET
  @QueryID_dc77f32e = '574FD9D5-AB9E-4FA5-A36C-C25E7D3F63FC'
SET
  @Name_dc77f32e = N'IsUnrated'
SET
  @Description_dc77f32e = N'Flag indicating if conversation has no ratings'
SET
  @Sequence_dc77f32e = 7
SET
  @SQLBaseType_dc77f32e = N'bit'
SET
  @SQLFullType_dc77f32e = N'bit'
SET
  @IsComputed_dc77f32e = 1
SET
  @ComputationDescription_dc77f32e = N'CASE expression checking NOT EXISTS for any ratings'
SET
  @IsSummary_dc77f32e = 0
SET
  @DetectionMethod_dc77f32e = N'Manual'
SET
  @ID_dc77f32e = 'F11B7F22-EF85-418E-855A-AC0EDBEE014A'
EXEC [${flyway:defaultSchema}].spUpdateQueryField @QueryID = @QueryID_dc77f32e,
  @Name = @Name_dc77f32e,
  @Description = @Description_dc77f32e,
  @Sequence = @Sequence_dc77f32e,
  @SQLBaseType = @SQLBaseType_dc77f32e,
  @SQLFullType = @SQLFullType_dc77f32e,
  @SourceEntityID = @SourceEntityID_dc77f32e,
  @SourceFieldName = @SourceFieldName_dc77f32e,
  @IsComputed = @IsComputed_dc77f32e,
  @ComputationDescription = @ComputationDescription_dc77f32e,
  @IsSummary = @IsSummary_dc77f32e,
  @SummaryDescription = @SummaryDescription_dc77f32e,
  @DetectionMethod = @DetectionMethod_dc77f32e,
  @AutoDetectConfidenceScore = @AutoDetectConfidenceScore_dc77f32e,
  @ID = @ID_dc77f32e;

-- Save MJ: Applications (core SP call only)
DECLARE @Name_ae878754 NVARCHAR(100),
@Description_ae878754 NVARCHAR(MAX),
@Icon_ae878754 NVARCHAR(500),
@DefaultForNewUser_ae878754 BIT,
@SchemaAutoAddNewEntities_ae878754 NVARCHAR(MAX),
@Color_ae878754 NVARCHAR(20),
@DefaultNavItems_ae878754 NVARCHAR(MAX),
@ClassName_ae878754 NVARCHAR(255),
@DefaultSequence_ae878754 INT,
@Status_ae878754 NVARCHAR(20),
@NavigationStyle_ae878754 NVARCHAR(20),
@TopNavLocation_ae878754 NVARCHAR(30),
@HideNavBarIconWhenActive_ae878754 BIT,
@Path_ae878754 NVARCHAR(100),
@AutoUpdatePath_ae878754 BIT,
@ID_ae878754 UNIQUEIDENTIFIER
SET
  @Name_ae878754 = N'Chat'
SET
  @Description_ae878754 = N'Agent conversations, artifact collections, and tasks'
SET
  @Icon_ae878754 = N'fa-solid fa-comments'
SET
  @DefaultForNewUser_ae878754 = 1
SET
  @Color_ae878754 = N'#9c27b0'
SET
  @DefaultNavItems_ae878754 = N'[
  {
    "Label": "Conversations",
...
SET
  @DefaultSequence_ae878754 = 1
SET
  @Status_ae878754 = N'Active'
SET
  @NavigationStyle_ae878754 = N'Both'
SET
  @TopNavLocation_ae878754 = N'Left of User Menu'
SET
  @HideNavBarIconWhenActive_ae878754 = 1
SET
  @Path_ae878754 = N'chat'
SET
  @AutoUpdatePath_ae878754 = 1
SET
  @ID_ae878754 = '7A873E1A-692E-43FA-97F8-57D8161A985C'
EXEC [${flyway:defaultSchema}].spUpdateApplication @Name = @Name_ae878754,
  @Description = @Description_ae878754,
  @Icon = @Icon_ae878754,
  @DefaultForNewUser = @DefaultForNewUser_ae878754,
  @SchemaAutoAddNewEntities = @SchemaAutoAddNewEntities_ae878754,
  @Color = @Color_ae878754,
  @DefaultNavItems = @DefaultNavItems_ae878754,
  @ClassName = @ClassName_ae878754,
  @DefaultSequence = @DefaultSequence_ae878754,
  @Status = @Status_ae878754,
  @NavigationStyle = @NavigationStyle_ae878754,
  @TopNavLocation = @TopNavLocation_ae878754,
  @HideNavBarIconWhenActive = @HideNavBarIconWhenActive_ae878754,
  @Path = @Path_ae878754,
  @AutoUpdatePath = @AutoUpdatePath_ae878754,
  @ID = @ID_ae878754;

-- Save MJ: Applications (core SP call only)
DECLARE @Name_f2234c67 NVARCHAR(100),
@Description_f2234c67 NVARCHAR(MAX),
@Icon_f2234c67 NVARCHAR(500),
@DefaultForNewUser_f2234c67 BIT,
@SchemaAutoAddNewEntities_f2234c67 NVARCHAR(MAX),
@Color_f2234c67 NVARCHAR(20),
@DefaultNavItems_f2234c67 NVARCHAR(MAX),
@ClassName_f2234c67 NVARCHAR(255),
@DefaultSequence_f2234c67 INT,
@Status_f2234c67 NVARCHAR(20),
@NavigationStyle_f2234c67 NVARCHAR(20),
@TopNavLocation_f2234c67 NVARCHAR(30),
@HideNavBarIconWhenActive_f2234c67 BIT,
@Path_f2234c67 NVARCHAR(100),
@AutoUpdatePath_f2234c67 BIT,
@ID_f2234c67 UNIQUEIDENTIFIER
SET
  @Name_f2234c67 = N'Lists'
SET
  @Description_f2234c67 = N'Manage user defined collections of records across the system'
SET
  @Icon_f2234c67 = N'fa-solid fa-list-check'
SET
  @DefaultForNewUser_f2234c67 = 1
SET
  @Color_f2234c67 = N'#009688'
SET
  @DefaultNavItems_f2234c67 = N'[
  {
    "Label": "Lists",
...
SET
  @DefaultSequence_f2234c67 = 50
SET
  @Status_f2234c67 = N'Active'
SET
  @NavigationStyle_f2234c67 = N'App Switcher'
SET
  @TopNavLocation_f2234c67 = N'Left of User Menu'
SET
  @HideNavBarIconWhenActive_f2234c67 = 1
SET
  @Path_f2234c67 = N'lists'
SET
  @AutoUpdatePath_f2234c67 = 1
SET
  @ID_f2234c67 = '140166B9-4064-4C3F-ACF1-3EB7DB2C9BD0'
EXEC [${flyway:defaultSchema}].spUpdateApplication @Name = @Name_f2234c67,
  @Description = @Description_f2234c67,
  @Icon = @Icon_f2234c67,
  @DefaultForNewUser = @DefaultForNewUser_f2234c67,
  @SchemaAutoAddNewEntities = @SchemaAutoAddNewEntities_f2234c67,
  @Color = @Color_f2234c67,
  @DefaultNavItems = @DefaultNavItems_f2234c67,
  @ClassName = @ClassName_f2234c67,
  @DefaultSequence = @DefaultSequence_f2234c67,
  @Status = @Status_f2234c67,
  @NavigationStyle = @NavigationStyle_f2234c67,
  @TopNavLocation = @TopNavLocation_f2234c67,
  @HideNavBarIconWhenActive = @HideNavBarIconWhenActive_f2234c67,
  @Path = @Path_f2234c67,
  @AutoUpdatePath = @AutoUpdatePath_f2234c67,
  @ID = @ID_f2234c67;


-- End of SQL Logging Session
-- Session ID: c2f6072b-ba9f-4368-95ef-2afcedf07440
-- Completed: 2026-02-16T23:57:44.084Z
-- Duration: 99222ms
-- Total Statements: 11
