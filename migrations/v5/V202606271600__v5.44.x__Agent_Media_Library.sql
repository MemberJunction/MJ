...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'fb1433ba-3037-44c5-8ccb-f8e9e4dbb001' OR (EntityID = 'CDB135CC-6D3C-480B-90AE-25B7805F82C1' AND Name = 'DefaultMediaCollectionID')) BEGIN
         ...
         VALUES
         (
            'fb1433ba-3037-44c5-8ccb-f8e9e4dbb001',
            'CDB135CC-6D3C-480B-90AE-25B7805F82C1', -- Entity: MJ: AI Agents
            100156,
            'DefaultMediaCollectionID',
            'Default Media Collection ID',
            'OPTIONAL default media kit for this agent: a Collection of Artifacts the agent may show on the realtime Media channel during a conversation. Resolved per session as runtime-override > this agent default > none. When set, the agent is given a manifest (each item''s display name, media type, when-to-show ContextDescription and Preload flag) so it can surface items via the Media_ShowMedia tool. When NULL the agent has no curated kit (ad-hoc Media_ShowMedia still works).',
            'uniqueidentifier',
            16,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ea8dc5f1-5e59-4ffe-aaa2-54d32443790a' OR (EntityID = 'C754B94F-E7BC-4B8E-AD0B-4EC36C9DA111' AND Name = 'ContextDescription')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ea8dc5f1-5e59-4ffe-aaa2-54d32443790a',
            'C754B94F-E7BC-4B8E-AD0B-4EC36C9DA111', -- Entity: MJ: Collection Artifacts
            100017,
            'ContextDescription',
            'Context Description',
            'Agent-facing description of what this media item is and WHEN to show it during a conversation. Read by a realtime agent (alongside the artifact''s own name/type) to decide autonomously whether/when to surface the item. Per-membership: the same artifact can carry different guidance in different Collections (media kits).',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ccf6ff60-bd8c-4620-b143-f671b58f8aed' OR (EntityID = 'C754B94F-E7BC-4B8E-AD0B-4EC36C9DA111' AND Name = 'Preload')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ccf6ff60-bd8c-4620-b143-f671b58f8aed',
            'C754B94F-E7BC-4B8E-AD0B-4EC36C9DA111', -- Entity: MJ: Collection Artifacts
            100018,
            'Preload',
            'Preload',
            'Eager-load hint for a realtime media kit: when 1, the agent is told to show / the client to prefetch this item at session start rather than waiting until it is contextually relevant. Default 0 (lazy — surfaced only when the agent chooses).',
            'bit',
            1,
            1,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ac86b5e5-61be-4431-8a42-296f79b8ee10' OR (EntityID = '1A4DF72F-68E0-410C-B42C-815687BFE2D2' AND Name = 'ExperimentSessionIteration')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'ac86b5e5-61be-4431-8a42-296f79b8ee10',
...
/* Create Entity Relationship: MJ: Collections -> MJ: AI Agents (One To Many via DefaultMediaCollectionID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '0f6215be-3bdf-48ee-a70b-23f514342dc6'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('0f6215be-3bdf-48ee-a70b-23f514342dc6', 'FA0D11D1-4E8D-44D6-8C2B-55EEB3208E3E', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', 'DefaultMediaCollectionID', 'One To Many', 1, 1, 4, GETUTCDATE(), GETUTCDATE())
   END;
...
/* SQL text to update entity field related entity name field map for entity field ID FB1433BA-3037-44C5-8CCB-F8E9E4DBB001 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='FB1433BA-3037-44C5-8CCB-F8E9E4DBB001', @RelatedEntityNameFieldMap='DefaultMediaCollection';
...
CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateCollectionArtifact]
    ...
    @ContextDescription_Clear bit = 0,
    @ContextDescription nvarchar(MAX) = NULL,
    @Preload bit = NULL
AS
BEGIN
    ...
    BEGIN
        ...
        VALUES
            (
                ...
                ISNULL(@Sequence, 0),
                @ArtifactVersionID,
                CASE WHEN @ContextDescription_Clear = 1 THEN NULL ELSE ISNULL(@ContextDescription, NULL) END,
                ISNULL(@Preload, 0)
            )
    END
    ELSE
...
BEGIN
    ...
    SET
        ...
        [ContextDescription] = CASE WHEN @ContextDescription_Clear = 1 THEN NULL ELSE ISNULL(@ContextDescription, [ContextDescription]) END,
        [Preload] = ISNULL(@Preload, [Preload])
    WHERE
        [ID] = @ID
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6782d948-ae63-4a05-afff-066b97c2d865' OR (EntityID = 'CDB135CC-6D3C-480B-90AE-25B7805F82C1' AND Name = 'DefaultMediaCollection')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '6782d948-ae63-4a05-afff-066b97c2d865',
            'CDB135CC-6D3C-480B-90AE-25B7805F82C1', -- Entity: MJ: AI Agents
            100167,
...
/* Set field properties for entity */
               ...
               SET IsNameField = 0
               WHERE ID = '5B5F9A79-3E98-482F-BA2A-D879B4F5B08F'
               AND AutoUpdateIsNameField = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'CCF6FF60-BD8C-4620-B143-F671B58F8AED'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET IncludeInUserSearchAPI = 1
               WHERE ID = 'EA8DC5F1-5E59-4FFE-AAA2-54D32443790A'
               AND AutoUpdateIncludeInUserSearchAPI = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET IncludeInUserSearchAPI = 1
               WHERE ID = '06307A6D-4C93-4918-8AE0-823CEB584390'
               AND AutoUpdateIncludeInUserSearchAPI = 1;
            ...
            WHERE ID = 'C754B94F-E7BC-4B8E-AD0B-4EC36C9DA111'
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '8A05882F-6969-41EE-91A4-8606BFF23A8E'
               AND AutoUpdateDefaultInView = 1;
...
SET 
   GeneratedFormSection = 'Category',
   DisplayName = 'Compression Message Retention',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
...
SET 
   Category = 'Attachment Storage',
   GeneratedFormSection = 'Category',
   DisplayName = 'Recording Storage Provider Name',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
...
SET 
   Category = 'Runtime Limits & Execution Settings',
   GeneratedFormSection = 'Category',
   DisplayName = 'Default Media Collection Name',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'FD0FDA91-E6D5-4C76-B0EA-789739F66CCE' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '404DFDE1-20F7-4239-AE42-475923BB5937' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'E2D30555-1CE6-46B8-83E0-11F9D910A5E2' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '88187AFF-CF9F-44B4-95A9-A18A35F83D8C' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '06307A6D-4C93-4918-8AE0-823CEB584390' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '5B5F9A79-3E98-482F-BA2A-D879B4F5B08F' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'EA8DC5F1-5E59-4FFE-AAA2-54D32443790A' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'CCF6FF60-BD8C-4620-B143-F671B58F8AED' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '091494B6-7A14-4009-ACF8-A0399E167217' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'AB5B66C1-4DE2-4664-AD89-2398A327841A' AND AutoUpdateCategory = 1;
...
SET 
   GeneratedFormSection = 'Category',
   DisplayName = 'Resulting Model ID',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
...
SET 
   GeneratedFormSection = 'Category',
   DisplayName = 'Experiment Session Iteration ID',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'AC86B5E5-61BE-4431-8A42-296F79B8EE10' AND AutoUpdateCategory = 1;
