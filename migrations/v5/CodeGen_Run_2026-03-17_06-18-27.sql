...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'BAE3EC7E-17F9-4BF0-9CED-EA0001A32780'
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'CCB9E8D5-1D1E-4EFD-A33E-BDE2817325B1'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '9735EC7B-D1B9-4855-8276-CE5EBE7A94E1'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'FAB4182F-D0DA-4F64-AC28-E755B3E63BB5'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
            ...
            AND AutoUpdateIsNameField = 1
                  ...
                  UPDATE [${flyway:defaultSchema}].[EntityField]
                  SET IncludeInUserSearchAPI = 1
                  WHERE ID = 'A53AFA74-D6EE-48B5-8181-7DD2971218D7'
                  AND AutoUpdateIncludeInUserSearchAPI = 1
...
/* Set field properties for entity */
                  ...
                  UPDATE [${flyway:defaultSchema}].[EntityField]
                  SET IncludeInUserSearchAPI = 1
                  WHERE ID = '4C08CD5D-1957-4A6A-9EB7-642EEB49E972'
                  AND AutoUpdateIncludeInUserSearchAPI = 1
...
/* Set field properties for entity */
                  ...
                  UPDATE [${flyway:defaultSchema}].[EntityField]
                  SET IncludeInUserSearchAPI = 1
                  WHERE ID = '9ADF4CCB-915E-497F-9F6C-1B927259F39B'
                  AND AutoUpdateIncludeInUserSearchAPI = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '81AEB5C1-0D96-4C06-8B77-E01513331E65'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '153EC15B-D60B-46C4-A0D2-5DAB23912210'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '9F73B96A-C6B7-4D10-8D7C-2B3232224049'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'FB10A1AD-72CD-4FF3-B0CE-52FC49021AAB'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'CF2B6E83-9098-4BC3-A33E-4E77CD02153E'
               AND AutoUpdateDefaultInView = 1
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '3B7A8A3F-AA25-46BC-8DD5-305B55B16C07'
               AND AutoUpdateDefaultInView = 1
