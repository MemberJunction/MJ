...
/********** CODE GEN RUN #2 - after an mj sync *********/
/********** CODE GEN RUN #2 - after an mj sync *********/
/********** CODE GEN RUN #2 - after an mj sync *********/
/********** CODE GEN RUN #2 - after an mj sync *********/
/********** CODE GEN RUN #2 - after an mj sync *********/
...
/* SQL text to update entity field related entity name field map for entity field ID 657C631B-A990-4F3A-A881-8A06BAB643D4 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='657C631B-A990-4F3A-A881-8A06BAB643D4', @RelatedEntityNameFieldMap='ExperimentSessionIteration';
