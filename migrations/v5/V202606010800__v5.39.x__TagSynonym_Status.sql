...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f4286229-e5be-4a48-b147-5ec3d3cc89a5' OR (EntityID = 'FE0D485E-8C3F-4FE0-BD07-EF81E8F14CE0' AND Name = 'Status')) BEGIN
...
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                    ...
                                    VALUES
                                       ('2e4e215d-8156-4ede-b744-df072a8fe0a1', 'F4286229-E5BE-4A48-B147-5EC3D3CC89A5', 1, 'Active', 'Active', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 7d7dc497-6f31-4eb2-9ad3-16168aecb908 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('7d7dc497-6f31-4eb2-9ad3-16168aecb908', 'F4286229-E5BE-4A48-B147-5EC3D3CC89A5', 2, 'Pending', 'Pending', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID b567c8a1-3731-463d-8ef3-2f5285ea9346 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('b567c8a1-3731-463d-8ef3-2f5285ea9346', 'F4286229-E5BE-4A48-B147-5EC3D3CC89A5', 3, 'Rejected', 'Rejected', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID F4286229-E5BE-4A48-B147-5EC3D3CC89A5 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='F4286229-E5BE-4A48-B147-5EC3D3CC89A5';
...
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spDeleteTagSynonym] TO [cdp_Developer], [cdp_Integration];
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'F4286229-E5BE-4A48-B147-5EC3D3CC89A5' AND AutoUpdateCategory = 1;
