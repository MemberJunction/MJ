/* SQL generated to create new entity Organizations */
      ...
      VALUES (
         ...
         'Organizations',
         NULL,
         'Tenant root for the BLA agent. PromptComponents may be scoped to a specific Organization; rows with no OrganizationID match any organization (least-specific tier).',
         NULL,
         'Organization',
         'vwOrganizations',
         'betty',
...
/* SQL generated to create new application betty */
INSERT INTO [${flyway:defaultSchema}].[Application] (ID, Name, Description, SchemaAutoAddNewEntities, Path, AutoUpdatePath)
                       VALUES ('09a9f8ab-5f81-4839-ba5f-76bd2750d22e', 'betty', 'Generated for schema', 'betty', 'betty', 1);

/* Adding role UI to application betty */
INSERT INTO [${flyway:defaultSchema}].[ApplicationRole]
                                 ([ApplicationID], [RoleID], [CanAccess], [CanAdmin]) VALUES
                                 ('09a9f8ab-5f81-4839-ba5f-76bd2750d22e', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0);

/* Adding role Developer to application betty */
INSERT INTO [${flyway:defaultSchema}].[ApplicationRole]
                                 ([ApplicationID], [RoleID], [CanAccess], [CanAdmin]) VALUES
                                 ('09a9f8ab-5f81-4839-ba5f-76bd2750d22e', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1);

/* Adding role Integration to application betty */
INSERT INTO [${flyway:defaultSchema}].[ApplicationRole]
                                 ([ApplicationID], [RoleID], [CanAccess], [CanAdmin]) VALUES
                                 ('09a9f8ab-5f81-4839-ba5f-76bd2750d22e', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0);

/* SQL generated to add new entity Organizations to application ID: '09a9f8ab-5f81-4839-ba5f-76bd2750d22e' */
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('09a9f8ab-5f81-4839-ba5f-76bd2750d22e', '33429562-09ad-468a-a42d-72fc1885a1d4', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = '09a9f8ab-5f81-4839-ba5f-76bd2750d22e'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Organizations for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('33429562-09ad-468a-a42d-72fc1885a1d4', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Organizations for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('33429562-09ad-468a-a42d-72fc1885a1d4', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Organizations for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('33429562-09ad-468a-a42d-72fc1885a1d4', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to create new entity Instances */
      ...
      VALUES (
         '6a079386-83cf-4d46-9d5d-a86ec086067b',
         'Instances',
         NULL,
         'A deployment or environment within an Organization (e.g. dev, prod, customer-specific). InstanceID is always under exactly one OrganizationID; the BLA agent assumes this when narrowing PromptComponent matches.',
         NULL,
         'Instance',
         'vwInstances',
         'betty',
...
/* SQL generated to add new entity Instances to application ID: '09A9F8AB-5F81-4839-BA5F-76BD2750D22E' */
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('09A9F8AB-5F81-4839-BA5F-76BD2750D22E', '6a079386-83cf-4d46-9d5d-a86ec086067b', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = '09A9F8AB-5F81-4839-BA5F-76BD2750D22E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Instances for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('6a079386-83cf-4d46-9d5d-a86ec086067b', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Instances for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('6a079386-83cf-4d46-9d5d-a86ec086067b', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Instances for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('6a079386-83cf-4d46-9d5d-a86ec086067b', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL generated to create new entity Prompt Components */
      ...
      VALUES (
         'e0126be2-4d78-4cb4-9ddd-f190be0a8a27',
         'Prompt Components',
         NULL,
         'A single reusable text snippet for an AIPrompt, optionally scoped to an Organization and/or Instance. The BLA assemble-prompt action selects the most specific component per Name within the matching PromptID (Org+Instance > Org > none) and renders them by Sort + Role into a structured ChatMessage[] for AIPromptRunner.ExecutePrompt.',
         NULL,
         'PromptComponent',
         'vwPromptComponents',
         'betty',
...
/* SQL generated to add new entity Prompt Components to application ID: '09A9F8AB-5F81-4839-BA5F-76BD2750D22E' */
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('09A9F8AB-5F81-4839-BA5F-76BD2750D22E', 'e0126be2-4d78-4cb4-9ddd-f190be0a8a27', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = '09A9F8AB-5F81-4839-BA5F-76BD2750D22E'), GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Prompt Components for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('e0126be2-4d78-4cb4-9ddd-f190be0a8a27', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Prompt Components for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('e0126be2-4d78-4cb4-9ddd-f190be0a8a27', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 0, GETUTCDATE(), GETUTCDATE());

/* SQL generated to add new permission for entity Prompt Components for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('e0126be2-4d78-4cb4-9ddd-f190be0a8a27', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE());

/* SQL text to add special date field __mj_CreatedAt to entity betty.Organization */
ALTER TABLE [betty].[Organization] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.Organization */
UPDATE [betty].[Organization] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.Organization */
ALTER TABLE [betty].[Organization] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.Organization */
ALTER TABLE [betty].[Organization] ADD CONSTRAINT [DF_betty_Organization___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt];
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Organization */
ALTER TABLE [betty].[Organization] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Organization */
UPDATE [betty].[Organization] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Organization */
ALTER TABLE [betty].[Organization] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Organization */
ALTER TABLE [betty].[Organization] ADD CONSTRAINT [DF_betty_Organization___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt];
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.Instance */
ALTER TABLE [betty].[Instance] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.Instance */
UPDATE [betty].[Instance] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.Instance */
ALTER TABLE [betty].[Instance] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.Instance */
ALTER TABLE [betty].[Instance] ADD CONSTRAINT [DF_betty_Instance___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt];
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Instance */
ALTER TABLE [betty].[Instance] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Instance */
UPDATE [betty].[Instance] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Instance */
ALTER TABLE [betty].[Instance] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.Instance */
ALTER TABLE [betty].[Instance] ADD CONSTRAINT [DF_betty_Instance___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt];
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.PromptComponent */
ALTER TABLE [betty].[PromptComponent] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.PromptComponent */
UPDATE [betty].[PromptComponent] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.PromptComponent */
ALTER TABLE [betty].[PromptComponent] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_CreatedAt to entity betty.PromptComponent */
ALTER TABLE [betty].[PromptComponent] ADD CONSTRAINT [DF_betty_PromptComponent___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt];
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.PromptComponent */
ALTER TABLE [betty].[PromptComponent] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.PromptComponent */
UPDATE [betty].[PromptComponent] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.PromptComponent */
ALTER TABLE [betty].[PromptComponent] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL;
GO

/* SQL text to add special date field __mj_UpdatedAt to entity betty.PromptComponent */
ALTER TABLE [betty].[PromptComponent] ADD CONSTRAINT [DF_betty_PromptComponent___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt];
GO

/* SQL text to insert new entity field */

      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '14c5d86a-66eb-4b9a-b2ad-e9daeb61fc85' OR (EntityID = '33429562-09AD-468A-A42D-72FC1885A1D4' AND Name = 'ID')) BEGIN
         ...
         VALUES
         (
            '14c5d86a-66eb-4b9a-b2ad-e9daeb61fc85',
            '33429562-09AD-468A-A42D-72FC1885A1D4', -- Entity: Organizations
            100001,
            'ID',
            'ID',
            NULL,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '496e895f-8107-4c55-9f23-f116b986ecbd' OR (EntityID = '33429562-09AD-468A-A42D-72FC1885A1D4' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '496e895f-8107-4c55-9f23-f116b986ecbd',
            '33429562-09AD-468A-A42D-72FC1885A1D4', -- Entity: Organizations
            100002,
            'Name',
            'Name',
            'Human-readable name of the organization. Unique.',
            'nvarchar',
            510,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7467417f-add3-4994-b090-c0fe4f86e943' OR (EntityID = '33429562-09AD-468A-A42D-72FC1885A1D4' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7467417f-add3-4994-b090-c0fe4f86e943',
            '33429562-09AD-468A-A42D-72FC1885A1D4', -- Entity: Organizations
            100003,
            'Description',
            'Description',
            'Optional free-text description of the organization.',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '8201e571-4c40-44a3-a27c-f178c5cfdce9' OR (EntityID = '33429562-09AD-468A-A42D-72FC1885A1D4' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '8201e571-4c40-44a3-a27c-f178c5cfdce9',
            '33429562-09AD-468A-A42D-72FC1885A1D4', -- Entity: Organizations
            100004,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '89dd3138-d8d4-4ff4-bad6-5c11a496cd7e' OR (EntityID = '33429562-09AD-468A-A42D-72FC1885A1D4' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '89dd3138-d8d4-4ff4-bad6-5c11a496cd7e',
            '33429562-09AD-468A-A42D-72FC1885A1D4', -- Entity: Organizations
            100005,
            '__mj_UpdatedAt',
            'Updated At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7f27d9c9-3f74-4a5b-87a7-1e06379d8ac1' OR (EntityID = '6A079386-83CF-4D46-9D5D-A86EC086067B' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7f27d9c9-3f74-4a5b-87a7-1e06379d8ac1',
            '6A079386-83CF-4D46-9D5D-A86EC086067B', -- Entity: Instances
            100001,
            'ID',
            'ID',
            NULL,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '94a198a5-605f-4e94-ac60-ba1f7f427fe9' OR (EntityID = '6A079386-83CF-4D46-9D5D-A86EC086067B' AND Name = 'OrganizationID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '94a198a5-605f-4e94-ac60-ba1f7f427fe9',
            '6A079386-83CF-4D46-9D5D-A86EC086067B', -- Entity: Instances
            100002,
            'OrganizationID',
            'Organization ID',
            'FK to the parent Organization. Required.',
            'uniqueidentifier',
            16,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f37cf8e4-2a5d-475c-9f2d-3df1251f7568' OR (EntityID = '6A079386-83CF-4D46-9D5D-A86EC086067B' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'f37cf8e4-2a5d-475c-9f2d-3df1251f7568',
            '6A079386-83CF-4D46-9D5D-A86EC086067B', -- Entity: Instances
            100003,
            'Name',
            'Name',
            'Instance name. Unique within an Organization.',
            'nvarchar',
            510,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '8295620b-76a0-4d99-b7ef-4a8ddb9e5c4a' OR (EntityID = '6A079386-83CF-4D46-9D5D-A86EC086067B' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '8295620b-76a0-4d99-b7ef-4a8ddb9e5c4a',
            '6A079386-83CF-4D46-9D5D-A86EC086067B', -- Entity: Instances
            100004,
            'Description',
            'Description',
            'Optional free-text description of the instance.',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'bb935da2-69c5-4b71-abf5-6fb59adb4c9c' OR (EntityID = '6A079386-83CF-4D46-9D5D-A86EC086067B' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'bb935da2-69c5-4b71-abf5-6fb59adb4c9c',
            '6A079386-83CF-4D46-9D5D-A86EC086067B', -- Entity: Instances
            100005,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a407aee9-0049-421d-a7e3-57b900ed21bc' OR (EntityID = '6A079386-83CF-4D46-9D5D-A86EC086067B' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a407aee9-0049-421d-a7e3-57b900ed21bc',
            '6A079386-83CF-4D46-9D5D-A86EC086067B', -- Entity: Instances
            100006,
            '__mj_UpdatedAt',
            'Updated At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '6bedb7d2-d6d4-46b1-bf87-4ef95e47fbc9' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '6bedb7d2-d6d4-46b1-bf87-4ef95e47fbc9',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100001,
            'ID',
            'ID',
            NULL,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7603a819-644c-4ca8-9506-f8a0818c6503' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'PromptID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7603a819-644c-4ca8-9506-f8a0818c6503',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100002,
            'PromptID',
            'Prompt ID',
            'FK to the ${flyway:defaultSchema}.AIPrompt the component belongs to. Only components matching this PromptID are ever considered, regardless of any other scoping match.',
            'uniqueidentifier',
            16,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a3ece86b-3db1-4571-9674-3be091e3487c' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'a3ece86b-3db1-4571-9674-3be091e3487c',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100003,
            'Name',
            'Name',
            'Logical name of the component within the prompt (e.g. "persona", "task-rules", "few-shot-example"). The BLA selects at most one row per (PromptID, Name) at runtime, using the cascading specificity match.',
            'nvarchar',
            510,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'aaec0cff-aea1-4f0f-8c59-a914a44c507d' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'aaec0cff-aea1-4f0f-8c59-a914a44c507d',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100004,
            'Description',
            'Description',
            'Optional free-text description of the component''s intent. Not used at runtime.',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '77b314ef-0f17-4546-9b7f-f062b8148308' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Text')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '77b314ef-0f17-4546-9b7f-f062b8148308',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100005,
            'Text',
            'Text',
            'The actual text content rendered into a ChatMessage. May include template variables that downstream rendering substitutes.',
            'nvarchar',
            -1,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7eaef9f8-3c5b-4027-a470-4d7ee1fbdb68' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Sort')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7eaef9f8-3c5b-4027-a470-4d7ee1fbdb68',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100006,
            'Sort',
            'Sort',
            'Final-assembly ordering. Lower Sort renders earlier in the ChatMessage[] (after conversation history). NOT used for selection tie-breaking among same-tier matches — that uses a stable TOP 1 by ID.',
            'int',
            4,
            10,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '478ab97a-4898-4e8d-951d-37bdb3a85e02' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Role')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '478ab97a-4898-4e8d-951d-37bdb3a85e02',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100007,
            'Role',
            'Role',
            'Role of the rendered message in the final ChatMessage[]: System, User, or Assistant. Each component becomes its own message at the LLM API layer, so System -> User -> System -> User sequences are preserved.',
            'nvarchar',
            40,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '90f71417-e765-4f54-bb74-35c833a7bd82' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'OrganizationID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '90f71417-e765-4f54-bb74-35c833a7bd82',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100008,
            'OrganizationID',
            'Organization ID',
            'Optional FK to betty.Organization. NULL means "applies to any organization" (least-specific tier). When non-NULL, the component only matches at runtime if the caller-supplied OrganizationID equals this value.',
            'uniqueidentifier',
            16,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '69309d88-bd0c-48d2-890e-2be63a980185' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'InstanceID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '69309d88-bd0c-48d2-890e-2be63a980185',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100009,
            'InstanceID',
            'Instance ID',
            'Optional FK to betty.Instance. NULL means "applies to any instance within whatever Organization scope is set" (or any instance globally if OrganizationID is also NULL). When non-NULL, the component only matches at runtime if the caller-supplied InstanceID equals this value AND its Organization matches too.',
            'uniqueidentifier',
            16,
            0,
            0,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2144c2f2-b055-4d46-a9cd-a8b1be5ad534' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '2144c2f2-b055-4d46-a9cd-a8b1be5ad534',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100010,
            '__mj_CreatedAt',
            'Created At',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '58af43e8-096c-4427-ae0a-f007205833f9' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '58af43e8-096c-4427-ae0a-f007205833f9',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100011,
            '__mj_UpdatedAt',
            'Updated At',
...
/* SQL text to insert entity field value with ID 2835f586-1dc5-4e99-a856-6b8195e28e8d */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('2835f586-1dc5-4e99-a856-6b8195e28e8d', '478AB97A-4898-4E8D-951D-37BDB3A85E02', 1, 'Assistant', 'Assistant', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 2e59be3b-72c5-4549-8a91-18099e3c6c4a */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('2e59be3b-72c5-4549-8a91-18099e3c6c4a', '478AB97A-4898-4E8D-951D-37BDB3A85E02', 2, 'System', 'System', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID a32f1d38-a45c-4f09-bb42-14ee1ac9635b */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('a32f1d38-a45c-4f09-bb42-14ee1ac9635b', '478AB97A-4898-4E8D-951D-37BDB3A85E02', 3, 'User', 'User', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID 478AB97A-4898-4E8D-951D-37BDB3A85E02 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='478AB97A-4898-4E8D-951D-37BDB3A85E02';


/* Create Entity Relationship: MJ: AI Prompts -> Prompt Components (One To Many via PromptID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '603f337a-8fc1-4693-8737-46a99e266177'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('603f337a-8fc1-4693-8737-46a99e266177', '73AD0238-8B56-EF11-991A-6045BDEBA539', 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', 'PromptID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: Organizations -> Instances (One To Many via OrganizationID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '5f624fb7-c835-4277-b123-f1e62578da78'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('5f624fb7-c835-4277-b123-f1e62578da78', '33429562-09AD-468A-A42D-72FC1885A1D4', '6A079386-83CF-4D46-9D5D-A86EC086067B', 'OrganizationID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;
                    
/* Create Entity Relationship: Organizations -> Prompt Components (One To Many via OrganizationID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '070be0b2-03a4-4470-8d7b-8908f772099a'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('070be0b2-03a4-4470-8d7b-8908f772099a', '33429562-09AD-468A-A42D-72FC1885A1D4', 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', 'OrganizationID', 'One To Many', 1, 1, 2, GETUTCDATE(), GETUTCDATE())
   END;


/* Create Entity Relationship: Instances -> Prompt Components (One To Many via InstanceID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '14a363c8-48c0-479e-9bd2-d5e4321a3424'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('14a363c8-48c0-479e-9bd2-d5e4321a3424', '6A079386-83CF-4D46-9D5D-A86EC086067B', 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', 'InstanceID', 'One To Many', 1, 1, 3, GETUTCDATE(), GETUTCDATE())
   END;

/* Index for Foreign Keys for Instance */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Instances
...
-----------------------------------------------------------------
-- Index for foreign key OrganizationID in table Instance
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_Instance_OrganizationID' 
    AND object_id = OBJECT_ID('[betty].[Instance]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_Instance_OrganizationID ON [betty].[Instance] ([OrganizationID]);

/* SQL text to update entity field related entity name field map for entity field ID 94A198A5-605F-4E94-AC60-BA1F7F427FE9 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='94A198A5-605F-4E94-AC60-BA1F7F427FE9', @RelatedEntityNameFieldMap='Organization';

/* Base View SQL for Instances */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Instances
-- Item: vwInstances
...
------------------------------------------------------------
----- BASE VIEW FOR ENTITY:      Instances
-----               SCHEMA:      betty
-----               BASE TABLE:  Instance
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[betty].[vwInstances]', 'V') IS NOT NULL
    DROP VIEW [betty].[vwInstances];
GO

CREATE VIEW [betty].[vwInstances]
AS
SELECT
    i.*,
...
INNER JOIN
  ...
  ON
    [i].[OrganizationID] = bettyOrganization_OrganizationID.[ID]
GO
GRANT SELECT ON [betty].[vwInstances] TO [cdp_UI], [cdp_Developer], [cdp_Integration];

/* Base View Permissions SQL for Instances */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Instances
-- Item: Permissions for vwInstances
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
/* spCreate SQL for Instances */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Instances
-- Item: spCreateInstance
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
IF OBJECT_ID('[betty].[spCreateInstance]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spCreateInstance];
GO

CREATE PROCEDURE [betty].[spCreateInstance]
...
BEGIN
    ...
    SELECT * FROM [betty].[vwInstances] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [betty].[spCreateInstance] TO [cdp_Developer], [cdp_Integration];

/* spCreate Permissions for Instances */

GRANT EXECUTE ON [betty].[spCreateInstance] TO [cdp_Developer], [cdp_Integration];

/* spUpdate SQL for Instances */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Instances
-- Item: spUpdateInstance
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
IF OBJECT_ID('[betty].[spUpdateInstance]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spUpdateInstance];
GO

CREATE PROCEDURE [betty].[spUpdateInstance]
    @ID uniqueidentifier,
...
BEGIN
    ...
    IF @@ROWCOUNT = 0
        ...
        SELECT TOP 0 * FROM [betty].[vwInstances] WHERE 1=0
    ELSE
...
GRANT EXECUTE ON [betty].[spUpdateInstance] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the Instance table
------------------------------------------------------------
IF OBJECT_ID('[betty].[trgUpdateInstance]', 'TR') IS NOT NULL
    DROP TRIGGER [betty].[trgUpdateInstance];
GO
CREATE TRIGGER [betty].trgUpdateInstance
ON [betty].[Instance]
AFTER UPDATE
AS
BEGIN
    ...
    FROM
        [betty].[Instance] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
...
/* spUpdate Permissions for Instances */

GRANT EXECUTE ON [betty].[spUpdateInstance] TO [cdp_Developer], [cdp_Integration];

/* spDelete SQL for Instances */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Instances
-- Item: spDeleteInstance
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- DELETE PROCEDURE FOR Instance
------------------------------------------------------------
IF OBJECT_ID('[betty].[spDeleteInstance]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spDeleteInstance];
GO

CREATE PROCEDURE [betty].[spDeleteInstance]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [betty].[spDeleteInstance] TO [cdp_Integration];

/* spDelete Permissions for Instances */
...
/* Index for Foreign Keys for PromptComponent */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Prompt Components
-- Item: Index for Foreign Keys
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
-- Index for foreign key PromptID in table PromptComponent
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_PromptComponent_PromptID' 
    AND object_id = OBJECT_ID('[betty].[PromptComponent]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_PromptComponent_PromptID ON [betty].[PromptComponent] ([PromptID]);

-- Index for foreign key OrganizationID in table PromptComponent
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_PromptComponent_OrganizationID' 
    AND object_id = OBJECT_ID('[betty].[PromptComponent]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_PromptComponent_OrganizationID ON [betty].[PromptComponent] ([OrganizationID]);

-- Index for foreign key InstanceID in table PromptComponent
IF NOT EXISTS (
    SELECT 1
    FROM sys.indexes
    WHERE name = 'IDX_AUTO_MJ_FKEY_PromptComponent_InstanceID' 
    AND object_id = OBJECT_ID('[betty].[PromptComponent]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_PromptComponent_InstanceID ON [betty].[PromptComponent] ([InstanceID]);

/* SQL text to update entity field related entity name field map for entity field ID 7603A819-644C-4CA8-9506-F8A0818C6503 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='7603A819-644C-4CA8-9506-F8A0818C6503', @RelatedEntityNameFieldMap='Prompt';
...
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[betty].[vwOrganizations]', 'V') IS NOT NULL
    DROP VIEW [betty].[vwOrganizations];
GO

CREATE VIEW [betty].[vwOrganizations]
AS
SELECT
    o.*
FROM
    [betty].[Organization] AS o
GO
GRANT SELECT ON [betty].[vwOrganizations] TO [cdp_UI], [cdp_Developer], [cdp_Integration];
...
------------------------------------------------------------
IF OBJECT_ID('[betty].[spCreateOrganization]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spCreateOrganization];
GO

CREATE PROCEDURE [betty].[spCreateOrganization]
    @ID uniqueidentifier = NULL,
    @Name nvarchar(255),
    @Description_Clear bit = 0,
    @Description nvarchar(MAX) = NULL
...
BEGIN
    ...
    BEGIN
        -- User provided a value, use it
        INSERT INTO [betty].[Organization]
            (
                [ID],
                [Name],
                [Description]
    ...
    END
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [betty].[vwOrganizations] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [betty].[spCreateOrganization] TO [cdp_Developer], [cdp_Integration];
...
------------------------------------------------------------
IF OBJECT_ID('[betty].[spUpdateOrganization]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spUpdateOrganization];
GO

CREATE PROCEDURE [betty].[spUpdateOrganization]
    @ID uniqueidentifier,
    @Name nvarchar(255) = NULL,
    @Description_Clear bit = 0,
    @Description nvarchar(MAX) = NULL
...
BEGIN
    ...
    IF @@ROWCOUNT = 0
        -- Nothing was updated, return no rows, but column structure from base view intact, semantically correct this way.
        SELECT TOP 0 * FROM [betty].[vwOrganizations] WHERE 1=0
    ELSE
        -- Return the updated record so the caller can see the updated values and any calculated fields
        SELECT
                                        *
                                    FROM
                                        [betty].[vwOrganizations]
                                    WHERE
                                        [ID] = @ID
...
GRANT EXECUTE ON [betty].[spUpdateOrganization] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the Organization table
------------------------------------------------------------
IF OBJECT_ID('[betty].[trgUpdateOrganization]', 'TR') IS NOT NULL
    DROP TRIGGER [betty].[trgUpdateOrganization];
GO
CREATE TRIGGER [betty].trgUpdateOrganization
ON [betty].[Organization]
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SET
        __mj_UpdatedAt = GETUTCDATE()
    FROM
        [betty].[Organization] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
        _organicTable.[ID] = I.[ID];
END;
...
------------------------------------------------------------
IF OBJECT_ID('[betty].[spDeleteOrganization]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spDeleteOrganization];
GO

CREATE PROCEDURE [betty].[spDeleteOrganization]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [betty].[spDeleteOrganization] TO [cdp_Integration];

/* spDelete Permissions for Organizations */

GRANT EXECUTE ON [betty].[spDeleteOrganization] TO [cdp_Integration];

/* SQL text to update entity field related entity name field map for entity field ID 90F71417-E765-4F54-BB74-35C833A7BD82 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='90F71417-E765-4F54-BB74-35C833A7BD82', @RelatedEntityNameFieldMap='Organization';

/* SQL text to update entity field related entity name field map for entity field ID 69309D88-BD0C-48D2-890E-2BE63A980185 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='69309D88-BD0C-48D2-890E-2BE63A980185', @RelatedEntityNameFieldMap='Instance';

/* Base View SQL for Prompt Components */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Prompt Components
-- Item: vwPromptComponents
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- BASE VIEW FOR ENTITY:      Prompt Components
-----               SCHEMA:      betty
-----               BASE TABLE:  PromptComponent
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[betty].[vwPromptComponents]', 'V') IS NOT NULL
    DROP VIEW [betty].[vwPromptComponents];
GO

CREATE VIEW [betty].[vwPromptComponents]
AS
SELECT
    p.*,
    MJAIPrompt_PromptID.[Name] AS [Prompt],
    bettyOrganization_OrganizationID.[Name] AS [Organization],
    bettyInstance_InstanceID.[Name] AS [Instance]
FROM
    [betty].[PromptComponent] AS p
INNER JOIN
    [${flyway:defaultSchema}].[AIPrompt] AS MJAIPrompt_PromptID
  ON
    [p].[PromptID] = MJAIPrompt_PromptID.[ID]
LEFT OUTER JOIN
    [betty].[Organization] AS bettyOrganization_OrganizationID
  ON
    [p].[OrganizationID] = bettyOrganization_OrganizationID.[ID]
LEFT OUTER JOIN
    [betty].[Instance] AS bettyInstance_InstanceID
  ON
    [p].[InstanceID] = bettyInstance_InstanceID.[ID]
GO
GRANT SELECT ON [betty].[vwPromptComponents] TO [cdp_UI], [cdp_Developer], [cdp_Integration];

/* Base View Permissions SQL for Prompt Components */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Prompt Components
-- Item: Permissions for vwPromptComponents
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
/* spCreate SQL for Prompt Components */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Prompt Components
-- Item: spCreatePromptComponent
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- CREATE PROCEDURE FOR PromptComponent
------------------------------------------------------------
IF OBJECT_ID('[betty].[spCreatePromptComponent]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spCreatePromptComponent];
GO

CREATE PROCEDURE [betty].[spCreatePromptComponent]
    @ID uniqueidentifier = NULL,
...
BEGIN
    ...
    BEGIN
        -- User provided a value, use it
        INSERT INTO [betty].[PromptComponent]
            (
                [ID],
                [PromptID],
                [Name],
        ...
        VALUES
            (
                ...
                CASE WHEN @InstanceID_Clear = 1 THEN NULL ELSE ISNULL(@InstanceID, NULL) END
            )
    END
    ELSE
    BEGIN
    ...
    END
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [betty].[vwPromptComponents] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [betty].[spCreatePromptComponent] TO [cdp_Developer], [cdp_Integration];

/* spCreate Permissions for Prompt Components */

GRANT EXECUTE ON [betty].[spCreatePromptComponent] TO [cdp_Developer], [cdp_Integration];

/* spUpdate SQL for Prompt Components */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Prompt Components
-- Item: spUpdatePromptComponent
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- UPDATE PROCEDURE FOR PromptComponent
------------------------------------------------------------
IF OBJECT_ID('[betty].[spUpdatePromptComponent]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spUpdatePromptComponent];
GO

CREATE PROCEDURE [betty].[spUpdatePromptComponent]
    @ID uniqueidentifier,
...
BEGIN
    ...
    SET
        ...
        [InstanceID] = CASE WHEN @InstanceID_Clear = 1 THEN NULL ELSE ISNULL(@InstanceID, [InstanceID]) END
    WHERE
        [ID] = @ID
    ...
    IF @@ROWCOUNT = 0
        -- Nothing was updated, return no rows, but column structure from base view intact, semantically correct this way.
        SELECT TOP 0 * FROM [betty].[vwPromptComponents] WHERE 1=0
    ELSE
        -- Return the updated record so the caller can see the updated values and any calculated fields
        SELECT
                                        *
                                    FROM
                                        [betty].[vwPromptComponents]
                                    WHERE
                                        [ID] = @ID
...
GRANT EXECUTE ON [betty].[spUpdatePromptComponent] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the PromptComponent table
------------------------------------------------------------
IF OBJECT_ID('[betty].[trgUpdatePromptComponent]', 'TR') IS NOT NULL
    DROP TRIGGER [betty].[trgUpdatePromptComponent];
GO
CREATE TRIGGER [betty].trgUpdatePromptComponent
ON [betty].[PromptComponent]
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SET
        __mj_UpdatedAt = GETUTCDATE()
    FROM
        [betty].[PromptComponent] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
        _organicTable.[ID] = I.[ID];
END;
...
/* spUpdate Permissions for Prompt Components */

GRANT EXECUTE ON [betty].[spUpdatePromptComponent] TO [cdp_Developer], [cdp_Integration];

/* spDelete SQL for Prompt Components */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: Prompt Components
-- Item: spDeletePromptComponent
--
-- This was generated by the MemberJunction CodeGen tool.
-- This file should NOT be edited by hand.
-----------------------------------------------------------------
...
------------------------------------------------------------
----- DELETE PROCEDURE FOR PromptComponent
------------------------------------------------------------
IF OBJECT_ID('[betty].[spDeletePromptComponent]', 'P') IS NOT NULL
    DROP PROCEDURE [betty].[spDeletePromptComponent];
GO

CREATE PROCEDURE [betty].[spDeletePromptComponent]
    @ID uniqueidentifier
AS
BEGIN
    SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [betty].[spDeletePromptComponent] TO [cdp_Integration];

/* spDelete Permissions for Prompt Components */
...
BEGIN
    ...
    -- Cascade delete from PromptComponent using cursor to call spDeletePromptComponent
    DECLARE @bettyPromptComponents_PromptIDID uniqueidentifier
    DECLARE cascade_delete_bettyPromptComponents_PromptID_cursor CURSOR FOR 
        SELECT [ID]
        FROM [betty].[PromptComponent]
        WHERE [PromptID] = @ID
    
    OPEN cascade_delete_bettyPromptComponents_PromptID_cursor
    FETCH NEXT FROM cascade_delete_bettyPromptComponents_PromptID_cursor INTO @bettyPromptComponents_PromptIDID
    
    WHILE @@FETCH_STATUS = 0
    BEGIN
        EXEC [betty].[spDeletePromptComponent] @ID = @bettyPromptComponents_PromptIDID
        
        FETCH NEXT FROM cascade_delete_bettyPromptComponents_PromptID_cursor INTO @bettyPromptComponents_PromptIDID
    END
    
    CLOSE cascade_delete_bettyPromptComponents_PromptID_cursor
    DEALLOCATE cascade_delete_bettyPromptComponents_PromptID_cursor
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e09082ce-0989-4766-9313-73ce533418f0' OR (EntityID = '6A079386-83CF-4D46-9D5D-A86EC086067B' AND Name = 'Organization')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e09082ce-0989-4766-9313-73ce533418f0',
            '6A079386-83CF-4D46-9D5D-A86EC086067B', -- Entity: Instances
            100013,
            'Organization',
            'Organization',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'dab840f3-8f93-460a-98a1-d8bac4a74dde' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Prompt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'dab840f3-8f93-460a-98a1-d8bac4a74dde',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100023,
            'Prompt',
            'Prompt',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5caa4343-ffbd-4211-adac-fb66f0bf4641' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Organization')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '5caa4343-ffbd-4211-adac-fb66f0bf4641',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100024,
            'Organization',
            'Organization',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7e704f1e-74cc-49bf-8c9c-d5de4c2ea4e9' OR (EntityID = 'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27' AND Name = 'Instance')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '7e704f1e-74cc-49bf-8c9c-d5de4c2ea4e9',
            'E0126BE2-4D78-4CB4-9DDD-F190BE0A8A27', -- Entity: Prompt Components
            100025,
            'Instance',
            'Instance',
