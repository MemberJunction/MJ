...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5ab042d7-1e29-43f7-b9e6-fb565eca2d65' OR (EntityID = 'CDB135CC-6D3C-480B-90AE-25B7805F82C1' AND Name = 'AcceptUnregisteredFiles')) BEGIN
         ...
         VALUES
         (
            '5ab042d7-1e29-43f7-b9e6-fb565eca2d65',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '43df9dd6-c525-47a0-82cd-d0497535aa98' OR (EntityID = '91797885-7128-4B71-8C4B-81C5FEE24F38' AND Name = 'Priority')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '43df9dd6-c525-47a0-82cd-d0497535aa98',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'dc095d12-5d1c-484d-9bab-9f6cf42ee172' OR (EntityID = '91797885-7128-4B71-8C4B-81C5FEE24F38' AND Name = 'DefaultDeliveryMode')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'dc095d12-5d1c-484d-9bab-9f6cf42ee172',
            '91797885-7128-4B71-8C4B-81C5FEE24F38', -- Entity: MJ: Artifact Types
            100033,
            'DefaultDeliveryMode',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f7e0e159-2c90-49a6-bcb0-62a595ab2f77' OR (EntityID = '91797885-7128-4B71-8C4B-81C5FEE24F38' AND Name = 'SystemSupplied')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'f7e0e159-2c90-49a6-bcb0-62a595ab2f77',
            '91797885-7128-4B71-8C4B-81C5FEE24F38', -- Entity: MJ: Artifact Types
            100034,
            'SystemSupplied',
            'System Supplied',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3ad86664-e8f0-4e0f-b423-0c331f2df709' OR (EntityID = 'AEB408D2-162A-49AE-9DC2-DBE9A21A3C01' AND Name = 'ForceToolsOnly')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            '3ad86664-e8f0-4e0f-b423-0c331f2df709',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'e8bd1328-02b5-4d9e-9c2c-9c04a04ab311' OR (EntityID = '4EDC5656-949F-4FA4-B909-DFC61AD4E1C3' AND Name = 'ArtifactVersionID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'e8bd1328-02b5-4d9e-9c2c-9c04a04ab311',
...
/* SQL text to insert entity field value with ID 69858616-5b07-4f06-86a1-ff57d07dcc70 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('69858616-5b07-4f06-86a1-ff57d07dcc70', 'DC095D12-5D1C-484D-9BAB-9F6CF42EE172', 1, 'Inline', 'Inline', GETUTCDATE(), GETUTCDATE());

/* SQL text to insert entity field value with ID 4505c646-18ac-4b5e-8310-2a984c3bd76c */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('4505c646-18ac-4b5e-8310-2a984c3bd76c', 'DC095D12-5D1C-484D-9BAB-9F6CF42EE172', 2, 'ToolsOnly', 'ToolsOnly', GETUTCDATE(), GETUTCDATE());

/* SQL text to update ValueListType for entity field ID DC095D12-5D1C-484D-9BAB-9F6CF42EE172 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='DC095D12-5D1C-484D-9BAB-9F6CF42EE172';


/* Create Entity Relationship: MJ: Artifact Versions -> MJ: Conversation Detail Attachments (One To Many via ArtifactVersionID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'b21f6e75-1a47-4cf6-91dd-2f849ca8dd1b'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('b21f6e75-1a47-4cf6-91dd-2f849ca8dd1b', 'AEB408D2-162A-49AE-9DC2-DBE9A21A3C01', '4EDC5656-949F-4FA4-B909-DFC61AD4E1C3', 'ArtifactVersionID', 'One To Many', 1, 1, 5, GETUTCDATE(), GETUTCDATE())
   END;
...
/* SQL text to update entity field related entity name field map for entity field ID E8BD1328-02B5-4D9E-9C2C-9C04A04AB311 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='E8BD1328-02B5-4D9E-9C2C-9C04A04AB311', @RelatedEntityNameFieldMap='ArtifactVersion';
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd669b2c8-69ec-4e64-ba7d-ca840a98c8fc' OR (EntityID = '4EDC5656-949F-4FA4-B909-DFC61AD4E1C3' AND Name = 'ArtifactVersion')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         VALUES
         (
            'd669b2c8-69ec-4e64-ba7d-ca840a98c8fc',
            '4EDC5656-949F-4FA4-B909-DFC61AD4E1C3', -- Entity: MJ: Conversation Detail Attachments
            100041,
            'ArtifactVersion',
            'Artifact Version',
...
/* Set field properties for entity */
               ...
               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = '43DF9DD6-C525-47A0-82CD-D0497535AA98'
               AND AutoUpdateDefaultInView = 1;

               UPDATE [${flyway:defaultSchema}].[EntityField]
               SET DefaultInView = 1
               WHERE ID = 'F7E0E159-2C90-49A6-BCB0-62A595AB2F77'
               AND AutoUpdateDefaultInView = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '43DF9DD6-C525-47A0-82CD-D0497535AA98' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'DC095D12-5D1C-484D-9BAB-9F6CF42EE172' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'F7E0E159-2C90-49A6-BCB0-62A595AB2F77' AND AutoUpdateCategory = 1;
...
SET 
   GeneratedFormSection = 'Category',
   DisplayName = 'Conversation Detail Object',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'E8BD1328-02B5-4D9E-9C2C-9C04A04AB311' AND AutoUpdateCategory = 1;
...
SET 
   Category = 'Storage Details',
   GeneratedFormSection = 'Category',
   DisplayName = 'Artifact Version Object',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
   ID = 'D669B2C8-69EC-4E64-BA7D-CA840A98C8FC' AND AutoUpdateCategory = 1;
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '3AD86664-E8F0-4E0F-B423-0C331F2DF709' AND AutoUpdateCategory = 1;
...
SET 
   GeneratedFormSection = 'Category',
   DisplayName = 'Inline Threshold (Bytes)',
   ExtendedType = NULL,
   CodeType = NULL
WHERE 
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '5AB042D7-1E29-43F7-B9E6-FB565ECA2D65' AND AutoUpdateCategory = 1;
