...
-- =============================================================================
CREATE TABLE ${flyway:defaultSchema}.AIClientToolDefinition (
    ...
    DefaultTimeoutMs INT NULL DEFAULT 30000,
...
EXEC sp_addextendedproperty
    ...
    @value = N'Unique identifier for the client tool (e.g., NavigateToApp, NavigateToRecord). Used to match tool invocations from the LLM to registered handlers on the client.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIClientToolDefinition',
    @level2type = N'COLUMN', @level2name = N'Name';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Human-readable description of what the tool does. This text is injected into the LLM system prompt so it knows when and how to use the tool.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIClientToolDefinition',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Tool category for grouping and filtering (e.g., navigation, form, display, data).',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIClientToolDefinition',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'JSON Schema defining the input parameters the tool accepts. Included in the LLM prompt so it generates valid parameter objects.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIClientToolDefinition',
    @level2type = N'COLUMN', @level2name = N'InputSchemaJSON';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'JSON Schema describing the return value from the tool. Optional — used for documentation and LLM context.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIClientToolDefinition',
    @level2type = N'COLUMN', @level2name = N'OutputSchemaJSON';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Default timeout in milliseconds for this tool. Can be overridden per-invocation by the LLM or per-run by execution params. Default is 30000ms (30 seconds).',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIClientToolDefinition',
    @level2type = N'COLUMN', @level2name = N'DefaultTimeoutMs';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'When set, the client only sends this tool to the server when the user is in the specified context (e.g., entity-form, dashboard, search). Null means the tool is always available.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIClientToolDefinition',
    @level2type = N'COLUMN', @level2name = N'RequiresContextType';

-- =============================================================================
-- 2. Create MJ: AI Agent Client Tools junction table
-- =============================================================================
CREATE TABLE ${flyway:defaultSchema}.AIAgentClientTool (
    ID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWSEQUENTIALID(),
    AgentID UNIQUEIDENTIFIER NOT NULL,
    ClientToolDefinitionID UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT FK_AIAgentClientTool_ToolDefinition FOREIGN KEY (ClientToolDefinitionID)
        REFERENCES ${flyway:defaultSchema}.AIClientToolDefinition(ID),
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'When true, the agent expects this tool to always be available on the client. If the client has not registered a handler, agent execution may warn or fail depending on configuration.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIAgentClientTool',
    @level2type = N'COLUMN', @level2name = N'IsRequired';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Sort order for tool listing in prompts. Lower numbers appear first. Tools with the same priority are listed alphabetically.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIAgentClientTool',
    @level2type = N'COLUMN', @level2name = N'Priority';

-- =============================================================================
-- 3. Add AllowEphemeralClientTools column to AI Agents
-- =============================================================================
ALTER TABLE ${flyway:defaultSchema}.AIAgent
    ADD AllowEphemeralClientTools BIT NOT NULL DEFAULT 1;

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'When true (default), this agent accepts runtime-registered ephemeral client tools that are not defined in metadata. Set to false for agents that require strict tool governance.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'AIAgent',
    @level2type = N'COLUMN', @level2name = N'AllowEphemeralClientTools';
...
-- CODE GEN RUN
/* SQL generated to create new entity MJ: AI Client Tool Definitions */
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', 'ff24ff6c-8047-4fcb-a9e4-a737de7cb66b', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Client Tool Definitions for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('ff24ff6c-8047-4fcb-a9e4-a737de7cb66b', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Client Tool Definitions for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('ff24ff6c-8047-4fcb-a9e4-a737de7cb66b', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Client Tool Definitions for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('ff24ff6c-8047-4fcb-a9e4-a737de7cb66b', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE())
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ([ApplicationID], [EntityID], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '3838e9b7-875a-4e0d-b861-1c61c6ed5c1d', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Agent Client Tools for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('3838e9b7-875a-4e0d-b861-1c61c6ed5c1d', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Agent Client Tools for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('3838e9b7-875a-4e0d-b861-1c61c6ed5c1d', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Agent Client Tools for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('3838e9b7-875a-4e0d-b861-1c61c6ed5c1d', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE())

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentClientTool] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
UPDATE [${flyway:defaultSchema}].[AIAgentClientTool] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentClientTool] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentClientTool] ADD CONSTRAINT [DF___mj_AIAgentClientTool___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt]

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentClientTool] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
UPDATE [${flyway:defaultSchema}].[AIAgentClientTool] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentClientTool] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentClientTool */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentClientTool] ADD CONSTRAINT [DF___mj_AIAgentClientTool___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt]

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
ALTER TABLE [${flyway:defaultSchema}].[AIClientToolDefinition] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
UPDATE [${flyway:defaultSchema}].[AIClientToolDefinition] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
ALTER TABLE [${flyway:defaultSchema}].[AIClientToolDefinition] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
ALTER TABLE [${flyway:defaultSchema}].[AIClientToolDefinition] ADD CONSTRAINT [DF___mj_AIClientToolDefinition___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt]

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
ALTER TABLE [${flyway:defaultSchema}].[AIClientToolDefinition] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
UPDATE [${flyway:defaultSchema}].[AIClientToolDefinition] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
ALTER TABLE [${flyway:defaultSchema}].[AIClientToolDefinition] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIClientToolDefinition */
ALTER TABLE [${flyway:defaultSchema}].[AIClientToolDefinition] ADD CONSTRAINT [DF___mj_AIClientToolDefinition___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt]

/* SQL text to insert new entity field */

      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '532e35b2-4eef-4954-8fc8-969205b6387e' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = 'ID')) BEGIN
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '41f4c49f-915e-4907-8a6b-ddcc89426d22' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = 'AgentID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '0370d385-6f2e-40c6-8b74-58271001373f' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = 'ClientToolDefinitionID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '41acbb0f-b9bb-4a03-af18-34fac78f8c3f' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = 'IsRequired')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '33e2bfe7-6980-41e6-8c05-3083ba3ae5a6' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = 'Priority')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5acc94ff-4bd3-4605-bdd2-1195eb9b2304' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f8b2dd74-c22c-4d10-a4e1-046bb146485b' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '98be9ee9-a855-488e-9d97-441aeba2b34d' OR (EntityID = 'CDB135CC-6D3C-480B-90AE-25B7805F82C1' AND Name = 'AllowEphemeralClientTools')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2a3365a5-6d03-4da5-a1dc-2e612e6cbb0f' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'ID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '18a5f70a-6a72-4807-9961-a0d12389d9a0' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ad7ced6b-407b-485f-b0b0-5fd75a2222d7' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a65bd419-fc5c-4dbf-a501-f940957725e4' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'Category')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c990d33b-c345-46b4-963f-5a576c55062e' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'InputSchemaJSON')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '77226a92-4bcb-48a8-98aa-769c6299a9b5' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'OutputSchemaJSON')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'f73b5f0e-d168-4b38-8154-8f8b22d763d1' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'DefaultTimeoutMs')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4936c17e-03de-44e7-943c-9facf6a79853' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = 'RequiresContextType')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b579f76f-0f98-4b0f-9ef2-a51a324dd9c0' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5129a182-5463-465c-b775-c9e94c8eed03' OR (EntityID = 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* Create Entity Relationship: MJ: AI Agents -> MJ: AI Agent Client Tools (One To Many via AgentID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '977945f6-8d48-4e17-a444-7776be545979'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('977945f6-8d48-4e17-a444-7776be545979', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D', 'AgentID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;
                    


/* Create Entity Relationship: MJ: AI Client Tool Definitions -> MJ: AI Agent Client Tools (One To Many via ClientToolDefinitionID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '72726883-b7b9-4c0b-9b0e-95e144dee6a6'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('72726883-b7b9-4c0b-9b0e-95e144dee6a6', 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B', '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D', 'ClientToolDefinitionID', 'One To Many', 1, 1, 2, GETUTCDATE(), GETUTCDATE())
   END;
                    

/* Index for Foreign Keys for AIAgentClientTool */
-----------------------------------------------------------------
-- SQL Code Generation
...
IF NOT EXISTS (
    ...
    AND object_id = OBJECT_ID('[${flyway:defaultSchema}].[AIAgentClientTool]')
)
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentClientTool_AgentID ON [${flyway:defaultSchema}].[AIAgentClientTool] ([AgentID]);
...
CREATE INDEX IDX_AUTO_MJ_FKEY_AIAgentClientTool_ClientToolDefinitionID ON [${flyway:defaultSchema}].[AIAgentClientTool] ([ClientToolDefinitionID]);

/* SQL text to update entity field related entity name field map for entity field ID 41F4C49F-915E-4907-8A6B-DDCC89426D22 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='41F4C49F-915E-4907-8A6B-DDCC89426D22', @RelatedEntityNameFieldMap='Agent'

/* SQL text to update entity field related entity name field map for entity field ID 0370D385-6F2E-40C6-8B74-58271001373F */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='0370D385-6F2E-40C6-8B74-58271001373F', @RelatedEntityNameFieldMap='ClientToolDefinition'

/* Base View SQL for MJ: AI Agent Client Tools */
-----------------------------------------------------------------
-- SQL Code Generation
-- Entity: MJ: AI Agent Client Tools
...
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[vwAIAgentClientTools]', 'V') IS NOT NULL
    DROP VIEW [${flyway:defaultSchema}].[vwAIAgentClientTools];
GO

CREATE VIEW [${flyway:defaultSchema}].[vwAIAgentClientTools]
AS
SELECT
    a.*,
...
FROM
    [${flyway:defaultSchema}].[AIAgentClientTool] AS a
INNER JOIN
    [${flyway:defaultSchema}].[AIAgent] AS MJAIAgent_AgentID
  ON
    [a].[AgentID] = MJAIAgent_AgentID.[ID]
INNER JOIN
    [${flyway:defaultSchema}].[AIClientToolDefinition] AS MJAIClientToolDefinition_ClientToolDefinitionID
  ON
    [a].[ClientToolDefinitionID] = MJAIClientToolDefinition_ClientToolDefinitionID.[ID]
GO
GRANT SELECT ON [${flyway:defaultSchema}].[vwAIAgentClientTools] TO [cdp_UI], [cdp_Developer], [cdp_Integration]
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spCreateAIAgentClientTool]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentClientTool];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateAIAgentClientTool]
...
BEGIN
    ...
    SELECT * FROM [${flyway:defaultSchema}].[vwAIAgentClientTools] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spCreateAIAgentClientTool] TO [cdp_Developer], [cdp_Integration]
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spUpdateAIAgentClientTool]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentClientTool];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spUpdateAIAgentClientTool]
    @ID uniqueidentifier,
    @AgentID uniqueidentifier,
    @ClientToolDefinitionID uniqueidentifier,
    @IsRequired bit,
...
BEGIN
    ...
    SET
        [AgentID] = @AgentID,
        [ClientToolDefinitionID] = @ClientToolDefinitionID,
    ...
    IF @@ROWCOUNT = 0
        ...
        SELECT TOP 0 * FROM [${flyway:defaultSchema}].[vwAIAgentClientTools] WHERE 1=0
    ELSE
        -- Return the updated record so the caller can see the updated values and any calculated fields
        SELECT
                                        *
                                    FROM
                                        [${flyway:defaultSchema}].[vwAIAgentClientTools]
                                    WHERE
                                        [ID] = @ID
...
GRANT EXECUTE ON [${flyway:defaultSchema}].[spUpdateAIAgentClientTool] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the AIAgentClientTool table
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[trgUpdateAIAgentClientTool]', 'TR') IS NOT NULL
    DROP TRIGGER [${flyway:defaultSchema}].[trgUpdateAIAgentClientTool];
GO
CREATE TRIGGER [${flyway:defaultSchema}].trgUpdateAIAgentClientTool
ON [${flyway:defaultSchema}].[AIAgentClientTool]
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM
        [${flyway:defaultSchema}].[AIAgentClientTool] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
...
-----               PRIMARY KEY: ID
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[vwAIClientToolDefinitions]', 'V') IS NOT NULL
    DROP VIEW [${flyway:defaultSchema}].[vwAIClientToolDefinitions];
GO

CREATE VIEW [${flyway:defaultSchema}].[vwAIClientToolDefinitions]
AS
SELECT
    a.*
FROM
    [${flyway:defaultSchema}].[AIClientToolDefinition] AS a
GO
GRANT SELECT ON [${flyway:defaultSchema}].[vwAIClientToolDefinitions] TO [cdp_UI], [cdp_Developer], [cdp_Integration]
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spCreateAIClientToolDefinition]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spCreateAIClientToolDefinition];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateAIClientToolDefinition]
    @ID uniqueidentifier = NULL,
    @Name nvarchar(200),
    @Description nvarchar(MAX),
    @Category nvarchar(50),
    @InputSchemaJSON nvarchar(MAX),
    @OutputSchemaJSON nvarchar(MAX),
    @DefaultTimeoutMs int,
    @RequiresContextType nvarchar(100)
AS
BEGIN
    SET NOCOUNT ON;
    DECLARE @InsertedRow TABLE ([ID] UNIQUEIDENTIFIER)
    ...
    END
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [${flyway:defaultSchema}].[vwAIClientToolDefinitions] WHERE [ID] = (SELECT [ID] FROM @InsertedRow)
END
GO
GRANT EXECUTE ON [${flyway:defaultSchema}].[spCreateAIClientToolDefinition] TO [cdp_Developer], [cdp_Integration]
...
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[spUpdateAIClientToolDefinition]', 'P') IS NOT NULL
    DROP PROCEDURE [${flyway:defaultSchema}].[spUpdateAIClientToolDefinition];
GO

CREATE PROCEDURE [${flyway:defaultSchema}].[spUpdateAIClientToolDefinition]
    @ID uniqueidentifier,
    @Name nvarchar(200),
    @Description nvarchar(MAX),
    @Category nvarchar(50),
...
BEGIN
    ...
    SET
        ...
        [RequiresContextType] = @RequiresContextType
    WHERE
        [ID] = @ID
    ...
    IF @@ROWCOUNT = 0
        -- Nothing was updated, return no rows, but column structure from base view intact, semantically correct this way.
        SELECT TOP 0 * FROM [${flyway:defaultSchema}].[vwAIClientToolDefinitions] WHERE 1=0
    ELSE
        -- Return the updated record so the caller can see the updated values and any calculated fields
        SELECT
                                        *
                                    FROM
                                        [${flyway:defaultSchema}].[vwAIClientToolDefinitions]
                                    WHERE
                                        [ID] = @ID
...
GRANT EXECUTE ON [${flyway:defaultSchema}].[spUpdateAIClientToolDefinition] TO [cdp_Developer], [cdp_Integration]
GO

------------------------------------------------------------
----- TRIGGER FOR __mj_UpdatedAt field for the AIClientToolDefinition table
------------------------------------------------------------
IF OBJECT_ID('[${flyway:defaultSchema}].[trgUpdateAIClientToolDefinition]', 'TR') IS NOT NULL
    DROP TRIGGER [${flyway:defaultSchema}].[trgUpdateAIClientToolDefinition];
GO
CREATE TRIGGER [${flyway:defaultSchema}].trgUpdateAIClientToolDefinition
ON [${flyway:defaultSchema}].[AIClientToolDefinition]
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SET
        __mj_UpdatedAt = GETUTCDATE()
    FROM
        [${flyway:defaultSchema}].[AIClientToolDefinition] AS _organicTable
    INNER JOIN
        INSERTED AS I ON
        _organicTable.[ID] = I.[ID];
END;
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'c73142b2-acfa-408b-b130-d4ebdb0f678e' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = 'Agent')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '99f91411-463f-4f55-8cc5-b2a828e5df63' OR (EntityID = '3838E9B7-875A-4E0D-B861-1C61C6ED5C1D' AND Name = 'ClientToolDefinition')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '2A3365A5-6D03-4DA5-A1DC-2E612E6CBB0F' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '18A5F70A-6A72-4807-9961-A0D12389D9A0' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'AD7CED6B-407B-485F-B0B0-5FD75A2222D7' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'A65BD419-FC5C-4DBF-A501-F940957725E4' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = 'Other'
WHERE 
   ID = 'C990D33B-C345-46B4-963F-5A576C55062E' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = 'Other'
WHERE 
   ID = '77226A92-4BCB-48A8-98AA-769C6299A9B5' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'F73B5F0E-D168-4B38-8154-8F8B22D763D1' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '4936C17E-03DE-44E7-943C-9FACF6A79853' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'B579F76F-0F98-4B0F-9EF2-A51A324DD9C0' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '5129A182-5463-465C-B775-C9E94C8EED03' AND AutoUpdateCategory = 1
...
/* Insert FieldCategoryInfo setting for entity */
               ...
               VALUES ('05c302bf-d4e4-40e2-8018-145e69f4b222', 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B', 'FieldCategoryInfo', '{"Tool Definition":{"icon":"fa fa-info-circle","description":"Core identity and descriptive information used by the LLM to understand the tool''s purpose"},"Execution Configuration":{"icon":"fa fa-sliders-h","description":"Technical schemas, timeouts, and environmental constraints for tool execution"},"System Metadata":{"icon":"fa fa-cog","description":"System-managed identifiers and audit timestamps"}}', GETUTCDATE(), GETUTCDATE())
            

/* Insert FieldCategoryIcons setting (legacy) */

               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] (ID, EntityID, Name, Value, __mj_CreatedAt, __mj_UpdatedAt)
               VALUES ('a8a3afb4-0b29-4f5b-83db-9afcf8ba907e', 'FF24FF6C-8047-4FCB-A9E4-A737DE7CB66B', 'FieldCategoryIcons', '{"Tool Definition":"fa fa-info-circle","Execution Configuration":"fa fa-sliders-h","System Metadata":"fa fa-cog"}', GETUTCDATE(), GETUTCDATE())
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '532E35B2-4EEF-4954-8FC8-969205B6387E' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '41F4C49F-915E-4907-8A6B-DDCC89426D22' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'C73142B2-ACFA-408B-B130-D4EBDB0F678E' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '0370D385-6F2E-40C6-8B74-58271001373F' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '99F91411-463F-4F55-8CC5-B2A828E5DF63' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '41ACBB0F-B9BB-4A03-AF18-34FAC78F8C3F' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '33E2BFE7-6980-41E6-8C05-3083BA3AE5A6' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = '5ACC94FF-4BD3-4605-BDD2-1195EB9B2304' AND AutoUpdateCategory = 1
...
SET 
   ...
   CodeType = NULL
WHERE 
   ID = 'F8B2DD74-C22C-4D10-A4E1-046BB146485B' AND AutoUpdateCategory = 1

/* Set entity icon to fa fa-toolbox */

               UPDATE [${flyway:defaultSchema}].[Entity]
               SET Icon = 'fa fa-toolbox', __mj_UpdatedAt = GETUTCDATE()
