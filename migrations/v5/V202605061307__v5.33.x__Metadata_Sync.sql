-- SQL Logging Session
-- Session ID: 34f3cf67-ee0e-44c0-b017-7fd7f0d6b641
-- Started: 2026-05-06T17:57:46.025Z
...
DECLARE @ID_d49de17b UNIQUEIDENTIFIER,
@Name_d49de17b NVARCHAR(50),
@Description_d49de17b NVARCHAR(MAX),
@CredentialTypeID_d49de17b UNIQUEIDENTIFIER
SET
  @ID_d49de17b = 'd6518557-8f8c-446c-b913-b0aba451963f'
SET
  @Name_d49de17b = N'DeepSeek'
SET
  @Description_d49de17b = N'DeepSeek is a Chinese AI research company that develops large language models including the V-series (V4 Pro/Flash) and R-series (reasoning) families. Models are released under permissive open-source licenses (MIT) with full open weights. The DeepSeek API offers OpenAI-compatible and Anthropic-compatible interfaces.'
SET
  @CredentialTypeID_d49de17b = '3F0C13AB-EF5F-4260-A50A-D66DDEC25270' EXEC [${flyway:defaultSchema}].spCreateAIVendor @ID = @ID_d49de17b,
  @Name = @Name_d49de17b,
  @Description = @Description_d49de17b,
  @CredentialTypeID = @CredentialTypeID_d49de17b;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_a4a15626 UNIQUEIDENTIFIER,
@Name_a4a15626 NVARCHAR(50),
@Description_a4a15626 NVARCHAR(MAX),
@AIModelTypeID_a4a15626 UNIQUEIDENTIFIER,
@PowerRank_a4a15626 INT,
@IsActive_a4a15626 BIT,
@SpeedRank_a4a15626 INT,
@CostRank_a4a15626 INT,
@ModelSelectionInsights_a4a15626 NVARCHAR(MAX),
@InheritTypeModalities_a4a15626 BIT,
@PriorVersionID_a4a15626 UNIQUEIDENTIFIER,
@SupportsPrefill_a4a15626 BIT,
@PrefillFallbackText_a4a15626 NVARCHAR(MAX)
SET
  @ID_a4a15626 = '7e87b6e0-2a30-45f1-8f28-e703b5c0336a'
SET
  @Name_a4a15626 = N'DeepSeek V4 Pro'
SET
  @Description_a4a15626 = N'DeepSeek''s flagship reasoning model, released as preview April 24, 2026. Mixture-of-Experts with 1.6T total / 49B active parameters. MIT licensed open weights. Supports both thinking and non-thinking modes. 1M token context window with up to 384K output tokens. OpenAI-compatible and Anthropic-compatible API formats. Recorded cost row uses list pricing; a 75% promotional discount runs through 2026-05-31 15:59 UTC (effective $0.435/$0.87 per 1M tokens during the promo).'
SET
  @AIModelTypeID_a4a15626 = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_a4a15626 = 15
SET
  @IsActive_a4a15626 = 1
SET
  @SpeedRank_a4a15626 = 7
SET
  @CostRank_a4a15626 = 4
SET
  @InheritTypeModalities_a4a15626 = 1
EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_a4a15626,
  @Name = @Name_a4a15626,
  @Description = @Description_a4a15626,
  @AIModelTypeID = @AIModelTypeID_a4a15626,
  @PowerRank = @PowerRank_a4a15626,
  @IsActive = @IsActive_a4a15626,
  @SpeedRank = @SpeedRank_a4a15626,
  @CostRank = @CostRank_a4a15626,
  @ModelSelectionInsights = @ModelSelectionInsights_a4a15626,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_a4a15626,
  @PriorVersionID = @PriorVersionID_a4a15626,
  @PriorVersionID_Clear = 1,
  @SupportsPrefill = @SupportsPrefill_a4a15626,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_a4a15626,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_d30025fc UNIQUEIDENTIFIER,
@Name_d30025fc NVARCHAR(50),
@Description_d30025fc NVARCHAR(MAX),
@AIModelTypeID_d30025fc UNIQUEIDENTIFIER,
@PowerRank_d30025fc INT,
@IsActive_d30025fc BIT,
@SpeedRank_d30025fc INT,
@CostRank_d30025fc INT,
@ModelSelectionInsights_d30025fc NVARCHAR(MAX),
@InheritTypeModalities_d30025fc BIT,
@PriorVersionID_d30025fc UNIQUEIDENTIFIER,
@SupportsPrefill_d30025fc BIT,
@PrefillFallbackText_d30025fc NVARCHAR(MAX)
SET
  @ID_d30025fc = '4846eda1-8ba7-4ab6-9815-c51a4986468b'
SET
  @Name_d30025fc = N'DeepSeek V4 Flash'
SET
  @Description_d30025fc = N'DeepSeek''s cost-efficient counterpart to V4 Pro, released as preview April 24, 2026. Mixture-of-Experts with 284B total / 13B active parameters. MIT licensed open weights. Supports both thinking and non-thinking modes. 1M token context window with up to 384K output tokens. Same OpenAI-compatible and Anthropic-compatible API surface as V4 Pro. Designed for high-throughput, latency-sensitive workloads where V4 Pro''s reasoning depth is unnecessary.'
SET
  @AIModelTypeID_d30025fc = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_d30025fc = 30
SET
  @IsActive_d30025fc = 1
SET
  @SpeedRank_d30025fc = 9
SET
  @CostRank_d30025fc = 2
SET
  @InheritTypeModalities_d30025fc = 1
EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_d30025fc,
  @Name = @Name_d30025fc,
  @Description = @Description_d30025fc,
  @AIModelTypeID = @AIModelTypeID_d30025fc,
  @PowerRank = @PowerRank_d30025fc,
  @IsActive = @IsActive_d30025fc,
  @SpeedRank = @SpeedRank_d30025fc,
  @CostRank = @CostRank_d30025fc,
  @ModelSelectionInsights = @ModelSelectionInsights_d30025fc,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_d30025fc,
  @PriorVersionID = @PriorVersionID_d30025fc,
  @PriorVersionID_Clear = 1,
  @SupportsPrefill = @SupportsPrefill_d30025fc,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_d30025fc,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_a86d9f1e UNIQUEIDENTIFIER,
@Name_a86d9f1e NVARCHAR(50),
@Description_a86d9f1e NVARCHAR(MAX),
@AIModelTypeID_a86d9f1e UNIQUEIDENTIFIER,
@PowerRank_a86d9f1e INT,
@IsActive_a86d9f1e BIT,
@SpeedRank_a86d9f1e INT,
@CostRank_a86d9f1e INT,
@ModelSelectionInsights_a86d9f1e NVARCHAR(MAX),
@InheritTypeModalities_a86d9f1e BIT,
@PriorVersionID_a86d9f1e UNIQUEIDENTIFIER,
@SupportsPrefill_a86d9f1e BIT,
@PrefillFallbackText_a86d9f1e NVARCHAR(MAX)
SET
  @ID_a86d9f1e = '13b94510-3170-44c0-8d3f-968e8c705f2b'
SET
  @Name_a86d9f1e = N'Kimi K2.6'
SET
  @Description_a86d9f1e = N'Moonshot AI''s open-weight flagship coding and agent model, released April 20, 2026. 1-trillion-parameter Mixture-of-Experts with 32B active parameters per token, native INT4 quantization, Modified MIT License (open weights on Hugging Face). 256K (262,144) token context window with output ceiling matching the context. Multimodal (text/image/video in, text out). Top open-weights performer on the Artificial Analysis Intelligence Index (54). Provides OpenAI/Anthropic-compatible API at platform.moonshot.ai. Strong long-horizon coding and multi-agent orchestration with agent swarm scaling to hundreds of parallel sub-agents.'
SET
  @AIModelTypeID_a86d9f1e = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_a86d9f1e = 18
SET
  @IsActive_a86d9f1e = 1
SET
  @SpeedRank_a86d9f1e = 7
SET
  @CostRank_a86d9f1e = 3
SET
  @InheritTypeModalities_a86d9f1e = 1
SET
  @PriorVersionID_a86d9f1e = '1C7F940F-436D-49D2-B258-162FD535DD49' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_a86d9f1e,
  @Name = @Name_a86d9f1e,
  @Description = @Description_a86d9f1e,
  @AIModelTypeID = @AIModelTypeID_a86d9f1e,
  @PowerRank = @PowerRank_a86d9f1e,
  @IsActive = @IsActive_a86d9f1e,
  @SpeedRank = @SpeedRank_a86d9f1e,
  @CostRank = @CostRank_a86d9f1e,
  @ModelSelectionInsights = @ModelSelectionInsights_a86d9f1e,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_a86d9f1e,
  @PriorVersionID = @PriorVersionID_a86d9f1e,
  @SupportsPrefill = @SupportsPrefill_a86d9f1e,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_a86d9f1e,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_7a7440d1 UNIQUEIDENTIFIER,
@ModelID_7a7440d1 UNIQUEIDENTIFIER,
@VendorID_7a7440d1 UNIQUEIDENTIFIER,
@Priority_7a7440d1 INT,
@Status_7a7440d1 NVARCHAR(20),
@DriverClass_7a7440d1 NVARCHAR(100),
@DriverImportPath_7a7440d1 NVARCHAR(255),
@APIName_7a7440d1 NVARCHAR(100),
@MaxInputTokens_7a7440d1 INT,
@MaxOutputTokens_7a7440d1 INT,
@SupportedResponseFormats_7a7440d1 NVARCHAR(100),
@SupportsEffortLevel_7a7440d1 BIT,
@SupportsStreaming_7a7440d1 BIT,
@TypeID_7a7440d1 UNIQUEIDENTIFIER,
@SupportsPrefill_7a7440d1 BIT,
@PrefillFallbackText_7a7440d1 NVARCHAR(MAX)
SET
  @ID_7a7440d1 = '09d6b12f-fa4d-428d-a97d-0f131246b385'
SET
  @ModelID_7a7440d1 = '7E87B6E0-2A30-45F1-8F28-E703B5C0336A'
SET
  @VendorID_7a7440d1 = 'D6518557-8F8C-446C-B913-B0ABA451963F'
SET
  @Priority_7a7440d1 = 0
SET
  @Status_7a7440d1 = N'Active'
SET
  @SupportedResponseFormats_7a7440d1 = N'Any'
SET
  @SupportsEffortLevel_7a7440d1 = 0
SET
  @SupportsStreaming_7a7440d1 = 0
SET
  @TypeID_7a7440d1 = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_7a7440d1,
  @ModelID = @ModelID_7a7440d1,
  @VendorID = @VendorID_7a7440d1,
  @Priority = @Priority_7a7440d1,
  @Status = @Status_7a7440d1,
  @DriverClass = @DriverClass_7a7440d1,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_7a7440d1,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_7a7440d1,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_7a7440d1,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_7a7440d1,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_7a7440d1,
  @SupportsEffortLevel = @SupportsEffortLevel_7a7440d1,
  @SupportsStreaming = @SupportsStreaming_7a7440d1,
  @TypeID = @TypeID_7a7440d1,
  @SupportsPrefill = @SupportsPrefill_7a7440d1,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_7a7440d1,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_2ce2e7b7 UNIQUEIDENTIFIER,
@ModelID_2ce2e7b7 UNIQUEIDENTIFIER,
@VendorID_2ce2e7b7 UNIQUEIDENTIFIER,
@Priority_2ce2e7b7 INT,
@Status_2ce2e7b7 NVARCHAR(20),
@DriverClass_2ce2e7b7 NVARCHAR(100),
@DriverImportPath_2ce2e7b7 NVARCHAR(255),
@APIName_2ce2e7b7 NVARCHAR(100),
@MaxInputTokens_2ce2e7b7 INT,
@MaxOutputTokens_2ce2e7b7 INT,
@SupportedResponseFormats_2ce2e7b7 NVARCHAR(100),
@SupportsEffortLevel_2ce2e7b7 BIT,
@SupportsStreaming_2ce2e7b7 BIT,
@TypeID_2ce2e7b7 UNIQUEIDENTIFIER,
@SupportsPrefill_2ce2e7b7 BIT,
@PrefillFallbackText_2ce2e7b7 NVARCHAR(MAX)
SET
  @ID_2ce2e7b7 = '9ba46594-8aa4-4c04-8f2b-4d23214cbbaa'
SET
  @ModelID_2ce2e7b7 = '4846EDA1-8BA7-4AB6-9815-C51A4986468B'
SET
  @VendorID_2ce2e7b7 = 'D6518557-8F8C-446C-B913-B0ABA451963F'
SET
  @Priority_2ce2e7b7 = 0
SET
  @Status_2ce2e7b7 = N'Active'
SET
  @SupportedResponseFormats_2ce2e7b7 = N'Any'
SET
  @SupportsEffortLevel_2ce2e7b7 = 0
SET
  @SupportsStreaming_2ce2e7b7 = 0
SET
  @TypeID_2ce2e7b7 = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_2ce2e7b7,
  @ModelID = @ModelID_2ce2e7b7,
  @VendorID = @VendorID_2ce2e7b7,
  @Priority = @Priority_2ce2e7b7,
  @Status = @Status_2ce2e7b7,
  @DriverClass = @DriverClass_2ce2e7b7,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_2ce2e7b7,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_2ce2e7b7,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_2ce2e7b7,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_2ce2e7b7,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_2ce2e7b7,
  @SupportsEffortLevel = @SupportsEffortLevel_2ce2e7b7,
  @SupportsStreaming = @SupportsStreaming_2ce2e7b7,
  @TypeID = @TypeID_2ce2e7b7,
  @SupportsPrefill = @SupportsPrefill_2ce2e7b7,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_2ce2e7b7,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_77fb0bbe UNIQUEIDENTIFIER,
@ModelID_77fb0bbe UNIQUEIDENTIFIER,
@VendorID_77fb0bbe UNIQUEIDENTIFIER,
@Priority_77fb0bbe INT,
@Status_77fb0bbe NVARCHAR(20),
@DriverClass_77fb0bbe NVARCHAR(100),
@DriverImportPath_77fb0bbe NVARCHAR(255),
@APIName_77fb0bbe NVARCHAR(100),
@MaxInputTokens_77fb0bbe INT,
@MaxOutputTokens_77fb0bbe INT,
@SupportedResponseFormats_77fb0bbe NVARCHAR(100),
@SupportsEffortLevel_77fb0bbe BIT,
@SupportsStreaming_77fb0bbe BIT,
@TypeID_77fb0bbe UNIQUEIDENTIFIER,
@SupportsPrefill_77fb0bbe BIT,
@PrefillFallbackText_77fb0bbe NVARCHAR(MAX)
SET
  @ID_77fb0bbe = 'e528a735-8285-4ad0-b5c2-734a37d055ee'
SET
  @ModelID_77fb0bbe = '7E87B6E0-2A30-45F1-8F28-E703B5C0336A'
SET
  @VendorID_77fb0bbe = 'D6518557-8F8C-446C-B913-B0ABA451963F'
SET
  @Priority_77fb0bbe = 1
SET
  @Status_77fb0bbe = N'Active'
SET
  @DriverClass_77fb0bbe = N'DeepSeekLLM'
SET
  @APIName_77fb0bbe = N'deepseek-v4-pro'
SET
  @MaxInputTokens_77fb0bbe = 1000000
SET
  @MaxOutputTokens_77fb0bbe = 384000
SET
  @SupportedResponseFormats_77fb0bbe = N'Any, JSON'
SET
  @SupportsEffortLevel_77fb0bbe = 0
SET
  @SupportsStreaming_77fb0bbe = 1
SET
  @TypeID_77fb0bbe = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_77fb0bbe,
  @ModelID = @ModelID_77fb0bbe,
  @VendorID = @VendorID_77fb0bbe,
  @Priority = @Priority_77fb0bbe,
  @Status = @Status_77fb0bbe,
  @DriverClass = @DriverClass_77fb0bbe,
  @DriverImportPath = @DriverImportPath_77fb0bbe,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_77fb0bbe,
  @MaxInputTokens = @MaxInputTokens_77fb0bbe,
  @MaxOutputTokens = @MaxOutputTokens_77fb0bbe,
  @SupportedResponseFormats = @SupportedResponseFormats_77fb0bbe,
  @SupportsEffortLevel = @SupportsEffortLevel_77fb0bbe,
  @SupportsStreaming = @SupportsStreaming_77fb0bbe,
  @TypeID = @TypeID_77fb0bbe,
  @SupportsPrefill = @SupportsPrefill_77fb0bbe,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_77fb0bbe,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_f7a14fb9 UNIQUEIDENTIFIER,
@ModelID_f7a14fb9 UNIQUEIDENTIFIER,
@VendorID_f7a14fb9 UNIQUEIDENTIFIER,
@Priority_f7a14fb9 INT,
@Status_f7a14fb9 NVARCHAR(20),
@DriverClass_f7a14fb9 NVARCHAR(100),
@DriverImportPath_f7a14fb9 NVARCHAR(255),
@APIName_f7a14fb9 NVARCHAR(100),
@MaxInputTokens_f7a14fb9 INT,
@MaxOutputTokens_f7a14fb9 INT,
@SupportedResponseFormats_f7a14fb9 NVARCHAR(100),
@SupportsEffortLevel_f7a14fb9 BIT,
@SupportsStreaming_f7a14fb9 BIT,
@TypeID_f7a14fb9 UNIQUEIDENTIFIER,
@SupportsPrefill_f7a14fb9 BIT,
@PrefillFallbackText_f7a14fb9 NVARCHAR(MAX)
SET
  @ID_f7a14fb9 = 'bae0bbde-1ffb-4d8d-9d38-2efa78b97cf1'
SET
  @ModelID_f7a14fb9 = '4846EDA1-8BA7-4AB6-9815-C51A4986468B'
SET
  @VendorID_f7a14fb9 = 'D6518557-8F8C-446C-B913-B0ABA451963F'
SET
  @Priority_f7a14fb9 = 1
SET
  @Status_f7a14fb9 = N'Active'
SET
  @DriverClass_f7a14fb9 = N'DeepSeekLLM'
SET
  @APIName_f7a14fb9 = N'deepseek-v4-flash'
SET
  @MaxInputTokens_f7a14fb9 = 1000000
SET
  @MaxOutputTokens_f7a14fb9 = 384000
SET
  @SupportedResponseFormats_f7a14fb9 = N'Any, JSON'
SET
  @SupportsEffortLevel_f7a14fb9 = 0
SET
  @SupportsStreaming_f7a14fb9 = 1
SET
  @TypeID_f7a14fb9 = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_f7a14fb9,
  @ModelID = @ModelID_f7a14fb9,
  @VendorID = @VendorID_f7a14fb9,
  @Priority = @Priority_f7a14fb9,
  @Status = @Status_f7a14fb9,
  @DriverClass = @DriverClass_f7a14fb9,
  @DriverImportPath = @DriverImportPath_f7a14fb9,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_f7a14fb9,
  @MaxInputTokens = @MaxInputTokens_f7a14fb9,
  @MaxOutputTokens = @MaxOutputTokens_f7a14fb9,
  @SupportedResponseFormats = @SupportedResponseFormats_f7a14fb9,
  @SupportsEffortLevel = @SupportsEffortLevel_f7a14fb9,
  @SupportsStreaming = @SupportsStreaming_f7a14fb9,
  @TypeID = @TypeID_f7a14fb9,
  @SupportsPrefill = @SupportsPrefill_f7a14fb9,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_f7a14fb9,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_c5ae3ed4 UNIQUEIDENTIFIER,
@ModelID_c5ae3ed4 UNIQUEIDENTIFIER,
@VendorID_c5ae3ed4 UNIQUEIDENTIFIER,
@StartedAt_c5ae3ed4 DATETIMEOFFSET,
@EndedAt_c5ae3ed4 DATETIMEOFFSET,
@Status_c5ae3ed4 NVARCHAR(20),
@Currency_c5ae3ed4 NCHAR(3),
@PriceTypeID_c5ae3ed4 UNIQUEIDENTIFIER,
@InputPricePerUnit_c5ae3ed4 DECIMAL(18, 8),
@OutputPricePerUnit_c5ae3ed4 DECIMAL(18, 8),
@UnitTypeID_c5ae3ed4 UNIQUEIDENTIFIER,
@ProcessingType_c5ae3ed4 NVARCHAR(20),
@Comments_c5ae3ed4 NVARCHAR(MAX)
SET
  @ID_c5ae3ed4 = '233ccea7-26a4-4fb3-8afe-53f830f8181b'
SET
  @ModelID_c5ae3ed4 = '7E87B6E0-2A30-45F1-8F28-E703B5C0336A'
SET
  @VendorID_c5ae3ed4 = 'D6518557-8F8C-446C-B913-B0ABA451963F'
SET
  @StartedAt_c5ae3ed4 = '2026-04-24T00:00:00.000Z'
SET
  @Status_c5ae3ed4 = N'Active'
SET
  @Currency_c5ae3ed4 = N'USD'
SET
  @PriceTypeID_c5ae3ed4 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_c5ae3ed4 = 1.74
SET
  @OutputPricePerUnit_c5ae3ed4 = 3.48
SET
  @UnitTypeID_c5ae3ed4 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_c5ae3ed4 = N'Realtime'
SET
  @Comments_c5ae3ed4 = N'DeepSeek V4 Pro list pricing on DeepSeek direct API as of April 24, 2026 launch: $1.74/$3.48 per 1M tokens. A 75% promotional discount is in effect through 2026-05-31 15:59 UTC, bringing effective price to $0.435/$0.87 per 1M tokens. Cache-hit input pricing is 1/10 of launch price (effective from 2026-04-26). Sources: https://api-docs.deepseek.com/quick_start/pricing ; https://api-docs.deepseek.com/news/news260424' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_c5ae3ed4,
  @ModelID = @ModelID_c5ae3ed4,
  @VendorID = @VendorID_c5ae3ed4,
  @StartedAt = @StartedAt_c5ae3ed4,
  @EndedAt = @EndedAt_c5ae3ed4,
  @EndedAt_Clear = 1,
  @Status = @Status_c5ae3ed4,
  @Currency = @Currency_c5ae3ed4,
  @PriceTypeID = @PriceTypeID_c5ae3ed4,
  @InputPricePerUnit = @InputPricePerUnit_c5ae3ed4,
  @OutputPricePerUnit = @OutputPricePerUnit_c5ae3ed4,
  @UnitTypeID = @UnitTypeID_c5ae3ed4,
  @ProcessingType = @ProcessingType_c5ae3ed4,
  @Comments = @Comments_c5ae3ed4;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_10cdf056 UNIQUEIDENTIFIER,
@ModelID_10cdf056 UNIQUEIDENTIFIER,
@VendorID_10cdf056 UNIQUEIDENTIFIER,
@StartedAt_10cdf056 DATETIMEOFFSET,
@EndedAt_10cdf056 DATETIMEOFFSET,
@Status_10cdf056 NVARCHAR(20),
@Currency_10cdf056 NCHAR(3),
@PriceTypeID_10cdf056 UNIQUEIDENTIFIER,
@InputPricePerUnit_10cdf056 DECIMAL(18, 8),
@OutputPricePerUnit_10cdf056 DECIMAL(18, 8),
@UnitTypeID_10cdf056 UNIQUEIDENTIFIER,
@ProcessingType_10cdf056 NVARCHAR(20),
@Comments_10cdf056 NVARCHAR(MAX)
SET
  @ID_10cdf056 = 'c458b249-9425-4fe2-afdf-6eaf189f685f'
SET
  @ModelID_10cdf056 = '4846EDA1-8BA7-4AB6-9815-C51A4986468B'
SET
  @VendorID_10cdf056 = 'D6518557-8F8C-446C-B913-B0ABA451963F'
SET
  @StartedAt_10cdf056 = '2026-04-24T00:00:00.000Z'
SET
  @Status_10cdf056 = N'Active'
SET
  @Currency_10cdf056 = N'USD'
SET
  @PriceTypeID_10cdf056 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_10cdf056 = 0.14
SET
  @OutputPricePerUnit_10cdf056 = 0.28
SET
  @UnitTypeID_10cdf056 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_10cdf056 = N'Realtime'
SET
  @Comments_10cdf056 = N'DeepSeek V4 Flash pricing on DeepSeek direct API as of April 24, 2026 launch: $0.14/$0.28 per 1M tokens. Sources: https://api-docs.deepseek.com/quick_start/pricing ; https://api-docs.deepseek.com/news/news260424' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_10cdf056,
  @ModelID = @ModelID_10cdf056,
  @VendorID = @VendorID_10cdf056,
  @StartedAt = @StartedAt_10cdf056,
  @EndedAt = @EndedAt_10cdf056,
  @EndedAt_Clear = 1,
  @Status = @Status_10cdf056,
  @Currency = @Currency_10cdf056,
  @PriceTypeID = @PriceTypeID_10cdf056,
  @InputPricePerUnit = @InputPricePerUnit_10cdf056,
  @OutputPricePerUnit = @OutputPricePerUnit_10cdf056,
  @UnitTypeID = @UnitTypeID_10cdf056,
  @ProcessingType = @ProcessingType_10cdf056,
  @Comments = @Comments_10cdf056;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_11c3ffe7 UNIQUEIDENTIFIER,
@Name_11c3ffe7 NVARCHAR(50),
@Description_11c3ffe7 NVARCHAR(MAX),
@AIModelTypeID_11c3ffe7 UNIQUEIDENTIFIER,
@PowerRank_11c3ffe7 INT,
@IsActive_11c3ffe7 BIT,
@SpeedRank_11c3ffe7 INT,
@CostRank_11c3ffe7 INT,
@ModelSelectionInsights_11c3ffe7 NVARCHAR(MAX),
@InheritTypeModalities_11c3ffe7 BIT,
@PriorVersionID_11c3ffe7 UNIQUEIDENTIFIER,
@SupportsPrefill_11c3ffe7 BIT,
@PrefillFallbackText_11c3ffe7 NVARCHAR(MAX)
SET
  @ID_11c3ffe7 = 'dbf24be7-3925-47ce-9352-fa714f57b8e5'
SET
  @Name_11c3ffe7 = N'GPT 5.5'
SET
  @Description_11c3ffe7 = N'OpenAI''s flagship reasoning model, released April 24, 2026 (ChatGPT/Codex April 23, API April 24). Successor to GPT 5.4. Built for professional scenarios where precision, reliability, and persistence matter. 1,050,000 token context window (~1M) with 128K output capacity (Codex deployment uses a 400K context). Supports adjustable reasoning via reasoning_effort parameter (none, low, medium, high, xhigh). Available through Responses API and Chat Completions, also surfaced on Microsoft Foundry / Azure.'
SET
  @AIModelTypeID_11c3ffe7 = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_11c3ffe7 = 12
SET
  @IsActive_11c3ffe7 = 1
SET
  @SpeedRank_11c3ffe7 = 7
SET
  @CostRank_11c3ffe7 = 10
SET
  @InheritTypeModalities_11c3ffe7 = 1
SET
  @PriorVersionID_11c3ffe7 = '82081D5B-67B1-400A-ABF8-ACB1F045251F' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_11c3ffe7,
  @Name = @Name_11c3ffe7,
  @Description = @Description_11c3ffe7,
  @AIModelTypeID = @AIModelTypeID_11c3ffe7,
  @PowerRank = @PowerRank_11c3ffe7,
  @IsActive = @IsActive_11c3ffe7,
  @SpeedRank = @SpeedRank_11c3ffe7,
  @CostRank = @CostRank_11c3ffe7,
  @ModelSelectionInsights = @ModelSelectionInsights_11c3ffe7,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_11c3ffe7,
  @PriorVersionID = @PriorVersionID_11c3ffe7,
  @SupportsPrefill = @SupportsPrefill_11c3ffe7,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_11c3ffe7,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_3f29a58d UNIQUEIDENTIFIER,
@Name_3f29a58d NVARCHAR(50),
@Description_3f29a58d NVARCHAR(MAX),
@AIModelTypeID_3f29a58d UNIQUEIDENTIFIER,
@PowerRank_3f29a58d INT,
@IsActive_3f29a58d BIT,
@SpeedRank_3f29a58d INT,
@CostRank_3f29a58d INT,
@ModelSelectionInsights_3f29a58d NVARCHAR(MAX),
@InheritTypeModalities_3f29a58d BIT,
@PriorVersionID_3f29a58d UNIQUEIDENTIFIER,
@SupportsPrefill_3f29a58d BIT,
@PrefillFallbackText_3f29a58d NVARCHAR(MAX)
SET
  @ID_3f29a58d = '9d29c67c-df96-4a2d-8e08-e37a120c35a5'
SET
  @Name_3f29a58d = N'Grok 4.3'
SET
  @Description_3f29a58d = N'xAI''s new flagship reasoning model, released April 30, 2026 (beta to SuperGrok Heavy on April 17). Always-on reasoning - ''thinks'' before responding for every query. 1M token context window. Built-in code execution environment, video upload support, and native generation of downloadable PDFs, fully populated spreadsheets, and PowerPoint decks. Scores 53 on the Artificial Analysis Intelligence Index at 207 t/s output speed. Aggressively priced at 40% lower than Grok 4.20.'
SET
  @AIModelTypeID_3f29a58d = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_3f29a58d = 16
SET
  @IsActive_3f29a58d = 1
SET
  @SpeedRank_3f29a58d = 8
SET
  @CostRank_3f29a58d = 4
SET
  @InheritTypeModalities_3f29a58d = 1
SET
  @PriorVersionID_3f29a58d = '839968F1-9520-4C69-BE84-5F901D0123A6' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_3f29a58d,
  @Name = @Name_3f29a58d,
  @Description = @Description_3f29a58d,
  @AIModelTypeID = @AIModelTypeID_3f29a58d,
  @PowerRank = @PowerRank_3f29a58d,
  @IsActive = @IsActive_3f29a58d,
  @SpeedRank = @SpeedRank_3f29a58d,
  @CostRank = @CostRank_3f29a58d,
  @ModelSelectionInsights = @ModelSelectionInsights_3f29a58d,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_3f29a58d,
  @PriorVersionID = @PriorVersionID_3f29a58d,
  @SupportsPrefill = @SupportsPrefill_3f29a58d,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_3f29a58d,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_89cb9d3a UNIQUEIDENTIFIER,
@ModelID_89cb9d3a UNIQUEIDENTIFIER,
@VendorID_89cb9d3a UNIQUEIDENTIFIER,
@Priority_89cb9d3a INT,
@Status_89cb9d3a NVARCHAR(20),
@DriverClass_89cb9d3a NVARCHAR(100),
@DriverImportPath_89cb9d3a NVARCHAR(255),
@APIName_89cb9d3a NVARCHAR(100),
@MaxInputTokens_89cb9d3a INT,
@MaxOutputTokens_89cb9d3a INT,
@SupportedResponseFormats_89cb9d3a NVARCHAR(100),
@SupportsEffortLevel_89cb9d3a BIT,
@SupportsStreaming_89cb9d3a BIT,
@TypeID_89cb9d3a UNIQUEIDENTIFIER,
@SupportsPrefill_89cb9d3a BIT,
@PrefillFallbackText_89cb9d3a NVARCHAR(MAX)
SET
  @ID_89cb9d3a = 'bc99c23b-113d-4a31-a073-211c6dc0b4a7'
SET
  @ModelID_89cb9d3a = '13B94510-3170-44C0-8D3F-968E8C705F2B'
SET
  @VendorID_89cb9d3a = 'F46A85CC-2897-4FB5-B557-99A95E93A42D'
SET
  @Priority_89cb9d3a = 0
SET
  @Status_89cb9d3a = N'Active'
SET
  @SupportedResponseFormats_89cb9d3a = N'Any'
SET
  @SupportsEffortLevel_89cb9d3a = 0
SET
  @SupportsStreaming_89cb9d3a = 0
SET
  @TypeID_89cb9d3a = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_89cb9d3a,
  @ModelID = @ModelID_89cb9d3a,
  @VendorID = @VendorID_89cb9d3a,
  @Priority = @Priority_89cb9d3a,
  @Status = @Status_89cb9d3a,
  @DriverClass = @DriverClass_89cb9d3a,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_89cb9d3a,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_89cb9d3a,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_89cb9d3a,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_89cb9d3a,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_89cb9d3a,
  @SupportsEffortLevel = @SupportsEffortLevel_89cb9d3a,
  @SupportsStreaming = @SupportsStreaming_89cb9d3a,
  @TypeID = @TypeID_89cb9d3a,
  @SupportsPrefill = @SupportsPrefill_89cb9d3a,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_89cb9d3a,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_1005e1e9 UNIQUEIDENTIFIER,
@ModelID_1005e1e9 UNIQUEIDENTIFIER,
@VendorID_1005e1e9 UNIQUEIDENTIFIER,
@Priority_1005e1e9 INT,
@Status_1005e1e9 NVARCHAR(20),
@DriverClass_1005e1e9 NVARCHAR(100),
@DriverImportPath_1005e1e9 NVARCHAR(255),
@APIName_1005e1e9 NVARCHAR(100),
@MaxInputTokens_1005e1e9 INT,
@MaxOutputTokens_1005e1e9 INT,
@SupportedResponseFormats_1005e1e9 NVARCHAR(100),
@SupportsEffortLevel_1005e1e9 BIT,
@SupportsStreaming_1005e1e9 BIT,
@TypeID_1005e1e9 UNIQUEIDENTIFIER,
@SupportsPrefill_1005e1e9 BIT,
@PrefillFallbackText_1005e1e9 NVARCHAR(MAX)
SET
  @ID_1005e1e9 = '81d3eb58-f76c-4eb4-802e-429be80eb757'
SET
  @ModelID_1005e1e9 = '13B94510-3170-44C0-8D3F-968E8C705F2B'
SET
  @VendorID_1005e1e9 = 'F46A85CC-2897-4FB5-B557-99A95E93A42D'
SET
  @Priority_1005e1e9 = 1
SET
  @Status_1005e1e9 = N'Active'
SET
  @DriverClass_1005e1e9 = N'MoonshotLLM'
SET
  @APIName_1005e1e9 = N'kimi-k2.6'
SET
  @MaxInputTokens_1005e1e9 = 262144
SET
  @MaxOutputTokens_1005e1e9 = 262144
SET
  @SupportedResponseFormats_1005e1e9 = N'Any, JSON'
SET
  @SupportsEffortLevel_1005e1e9 = 0
SET
  @SupportsStreaming_1005e1e9 = 1
SET
  @TypeID_1005e1e9 = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_1005e1e9,
  @ModelID = @ModelID_1005e1e9,
  @VendorID = @VendorID_1005e1e9,
  @Priority = @Priority_1005e1e9,
  @Status = @Status_1005e1e9,
  @DriverClass = @DriverClass_1005e1e9,
  @DriverImportPath = @DriverImportPath_1005e1e9,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_1005e1e9,
  @MaxInputTokens = @MaxInputTokens_1005e1e9,
  @MaxOutputTokens = @MaxOutputTokens_1005e1e9,
  @SupportedResponseFormats = @SupportedResponseFormats_1005e1e9,
  @SupportsEffortLevel = @SupportsEffortLevel_1005e1e9,
  @SupportsStreaming = @SupportsStreaming_1005e1e9,
  @TypeID = @TypeID_1005e1e9,
  @SupportsPrefill = @SupportsPrefill_1005e1e9,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_1005e1e9,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_a9673881 UNIQUEIDENTIFIER,
@ModelID_a9673881 UNIQUEIDENTIFIER,
@VendorID_a9673881 UNIQUEIDENTIFIER,
@StartedAt_a9673881 DATETIMEOFFSET,
@EndedAt_a9673881 DATETIMEOFFSET,
@Status_a9673881 NVARCHAR(20),
@Currency_a9673881 NCHAR(3),
@PriceTypeID_a9673881 UNIQUEIDENTIFIER,
@InputPricePerUnit_a9673881 DECIMAL(18, 8),
@OutputPricePerUnit_a9673881 DECIMAL(18, 8),
@UnitTypeID_a9673881 UNIQUEIDENTIFIER,
@ProcessingType_a9673881 NVARCHAR(20),
@Comments_a9673881 NVARCHAR(MAX)
SET
  @ID_a9673881 = '45d4e11c-5891-4694-9b48-0c0ac318d4a9'
SET
  @ModelID_a9673881 = '13B94510-3170-44C0-8D3F-968E8C705F2B'
SET
  @VendorID_a9673881 = 'F46A85CC-2897-4FB5-B557-99A95E93A42D'
SET
  @StartedAt_a9673881 = '2026-04-20T00:00:00.000Z'
SET
  @Status_a9673881 = N'Active'
SET
  @Currency_a9673881 = N'USD'
SET
  @PriceTypeID_a9673881 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_a9673881 = 0.6
SET
  @OutputPricePerUnit_a9673881 = 2.5
SET
  @UnitTypeID_a9673881 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_a9673881 = N'Realtime'
SET
  @Comments_a9673881 = N'Kimi K2.6 launch pricing on Moonshot direct API as of April 20, 2026: $0.60/$2.50 per 1M tokens. Some aggregator pages quote $0.74/$3.49 (likely a different SKU/tier or post-launch adjustment) - the official launch announcement quoted $0.60/$2.50. Verify on platform.moonshot.ai before relying on this price for billing. Sources: https://www.kimi.com/blog/kimi-k2-6 ; https://huggingface.co/moonshotai/Kimi-K2.6' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_a9673881,
  @ModelID = @ModelID_a9673881,
  @VendorID = @VendorID_a9673881,
  @StartedAt = @StartedAt_a9673881,
  @EndedAt = @EndedAt_a9673881,
  @EndedAt_Clear = 1,
  @Status = @Status_a9673881,
  @Currency = @Currency_a9673881,
  @PriceTypeID = @PriceTypeID_a9673881,
  @InputPricePerUnit = @InputPricePerUnit_a9673881,
  @OutputPricePerUnit = @OutputPricePerUnit_a9673881,
  @UnitTypeID = @UnitTypeID_a9673881,
  @ProcessingType = @ProcessingType_a9673881,
  @Comments = @Comments_a9673881;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_41389688 UNIQUEIDENTIFIER,
@ModelID_41389688 UNIQUEIDENTIFIER,
@VendorID_41389688 UNIQUEIDENTIFIER,
@Priority_41389688 INT,
@Status_41389688 NVARCHAR(20),
@DriverClass_41389688 NVARCHAR(100),
@DriverImportPath_41389688 NVARCHAR(255),
@APIName_41389688 NVARCHAR(100),
@MaxInputTokens_41389688 INT,
@MaxOutputTokens_41389688 INT,
@SupportedResponseFormats_41389688 NVARCHAR(100),
@SupportsEffortLevel_41389688 BIT,
@SupportsStreaming_41389688 BIT,
@TypeID_41389688 UNIQUEIDENTIFIER,
@SupportsPrefill_41389688 BIT,
@PrefillFallbackText_41389688 NVARCHAR(MAX)
SET
  @ID_41389688 = 'fca7f5ec-aed8-422d-80ed-737e9c45f841'
SET
  @ModelID_41389688 = 'DBF24BE7-3925-47CE-9352-FA714F57B8E5'
SET
  @VendorID_41389688 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_41389688 = 0
SET
  @Status_41389688 = N'Active'
SET
  @SupportedResponseFormats_41389688 = N'Any'
SET
  @SupportsEffortLevel_41389688 = 1
SET
  @SupportsStreaming_41389688 = 0
SET
  @TypeID_41389688 = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_41389688,
  @ModelID = @ModelID_41389688,
  @VendorID = @VendorID_41389688,
  @Priority = @Priority_41389688,
  @Status = @Status_41389688,
  @DriverClass = @DriverClass_41389688,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_41389688,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_41389688,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_41389688,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_41389688,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_41389688,
  @SupportsEffortLevel = @SupportsEffortLevel_41389688,
  @SupportsStreaming = @SupportsStreaming_41389688,
  @TypeID = @TypeID_41389688,
  @SupportsPrefill = @SupportsPrefill_41389688,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_41389688,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_c11128ec UNIQUEIDENTIFIER,
@ModelID_c11128ec UNIQUEIDENTIFIER,
@VendorID_c11128ec UNIQUEIDENTIFIER,
@Priority_c11128ec INT,
@Status_c11128ec NVARCHAR(20),
@DriverClass_c11128ec NVARCHAR(100),
@DriverImportPath_c11128ec NVARCHAR(255),
@APIName_c11128ec NVARCHAR(100),
@MaxInputTokens_c11128ec INT,
@MaxOutputTokens_c11128ec INT,
@SupportedResponseFormats_c11128ec NVARCHAR(100),
@SupportsEffortLevel_c11128ec BIT,
@SupportsStreaming_c11128ec BIT,
@TypeID_c11128ec UNIQUEIDENTIFIER,
@SupportsPrefill_c11128ec BIT,
@PrefillFallbackText_c11128ec NVARCHAR(MAX)
SET
  @ID_c11128ec = '531cf1cc-a526-453b-8159-6772848f7e6a'
SET
  @ModelID_c11128ec = 'DBF24BE7-3925-47CE-9352-FA714F57B8E5'
SET
  @VendorID_c11128ec = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_c11128ec = 1
SET
  @Status_c11128ec = N'Active'
SET
  @DriverClass_c11128ec = N'OpenAILLM'
SET
  @APIName_c11128ec = N'gpt-5.5'
SET
  @MaxInputTokens_c11128ec = 1050000
SET
  @MaxOutputTokens_c11128ec = 128000
SET
  @SupportedResponseFormats_c11128ec = N'Any, JSON'
SET
  @SupportsEffortLevel_c11128ec = 1
SET
  @SupportsStreaming_c11128ec = 1
SET
  @TypeID_c11128ec = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_c11128ec,
  @ModelID = @ModelID_c11128ec,
  @VendorID = @VendorID_c11128ec,
  @Priority = @Priority_c11128ec,
  @Status = @Status_c11128ec,
  @DriverClass = @DriverClass_c11128ec,
  @DriverImportPath = @DriverImportPath_c11128ec,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_c11128ec,
  @MaxInputTokens = @MaxInputTokens_c11128ec,
  @MaxOutputTokens = @MaxOutputTokens_c11128ec,
  @SupportedResponseFormats = @SupportedResponseFormats_c11128ec,
  @SupportsEffortLevel = @SupportsEffortLevel_c11128ec,
  @SupportsStreaming = @SupportsStreaming_c11128ec,
  @TypeID = @TypeID_c11128ec,
  @SupportsPrefill = @SupportsPrefill_c11128ec,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_c11128ec,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_2b1ec36f UNIQUEIDENTIFIER,
@ModelID_2b1ec36f UNIQUEIDENTIFIER,
@VendorID_2b1ec36f UNIQUEIDENTIFIER,
@Priority_2b1ec36f INT,
@Status_2b1ec36f NVARCHAR(20),
@DriverClass_2b1ec36f NVARCHAR(100),
@DriverImportPath_2b1ec36f NVARCHAR(255),
@APIName_2b1ec36f NVARCHAR(100),
@MaxInputTokens_2b1ec36f INT,
@MaxOutputTokens_2b1ec36f INT,
@SupportedResponseFormats_2b1ec36f NVARCHAR(100),
@SupportsEffortLevel_2b1ec36f BIT,
@SupportsStreaming_2b1ec36f BIT,
@TypeID_2b1ec36f UNIQUEIDENTIFIER,
@SupportsPrefill_2b1ec36f BIT,
@PrefillFallbackText_2b1ec36f NVARCHAR(MAX)
SET
  @ID_2b1ec36f = 'f3534cc2-469d-45bf-9fd3-314d85d7b1e7'
SET
  @ModelID_2b1ec36f = 'DBF24BE7-3925-47CE-9352-FA714F57B8E5'
SET
  @VendorID_2b1ec36f = 'D75ABC84-6BDB-41B9-94C7-2FE748482193'
SET
  @Priority_2b1ec36f = 5
SET
  @Status_2b1ec36f = N'Active'
SET
  @DriverClass_2b1ec36f = N'AzureLLM'
SET
  @APIName_2b1ec36f = N'gpt-5.5'
SET
  @MaxInputTokens_2b1ec36f = 1050000
SET
  @MaxOutputTokens_2b1ec36f = 128000
SET
  @SupportedResponseFormats_2b1ec36f = N'Any, JSON'
SET
  @SupportsEffortLevel_2b1ec36f = 0
SET
  @SupportsStreaming_2b1ec36f = 1
SET
  @TypeID_2b1ec36f = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_2b1ec36f,
  @ModelID = @ModelID_2b1ec36f,
  @VendorID = @VendorID_2b1ec36f,
  @Priority = @Priority_2b1ec36f,
  @Status = @Status_2b1ec36f,
  @DriverClass = @DriverClass_2b1ec36f,
  @DriverImportPath = @DriverImportPath_2b1ec36f,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_2b1ec36f,
  @MaxInputTokens = @MaxInputTokens_2b1ec36f,
  @MaxOutputTokens = @MaxOutputTokens_2b1ec36f,
  @SupportedResponseFormats = @SupportedResponseFormats_2b1ec36f,
  @SupportsEffortLevel = @SupportsEffortLevel_2b1ec36f,
  @SupportsStreaming = @SupportsStreaming_2b1ec36f,
  @TypeID = @TypeID_2b1ec36f,
  @SupportsPrefill = @SupportsPrefill_2b1ec36f,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_2b1ec36f,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_5612556b UNIQUEIDENTIFIER,
@ModelID_5612556b UNIQUEIDENTIFIER,
@VendorID_5612556b UNIQUEIDENTIFIER,
@StartedAt_5612556b DATETIMEOFFSET,
@EndedAt_5612556b DATETIMEOFFSET,
@Status_5612556b NVARCHAR(20),
@Currency_5612556b NCHAR(3),
@PriceTypeID_5612556b UNIQUEIDENTIFIER,
@InputPricePerUnit_5612556b DECIMAL(18, 8),
@OutputPricePerUnit_5612556b DECIMAL(18, 8),
@UnitTypeID_5612556b UNIQUEIDENTIFIER,
@ProcessingType_5612556b NVARCHAR(20),
@Comments_5612556b NVARCHAR(MAX)
SET
  @ID_5612556b = 'b4c3eca2-13fb-4b6f-b794-04cc2324ba21'
SET
  @ModelID_5612556b = 'DBF24BE7-3925-47CE-9352-FA714F57B8E5'
SET
  @VendorID_5612556b = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @StartedAt_5612556b = '2026-04-24T00:00:00.000Z'
SET
  @Status_5612556b = N'Active'
SET
  @Currency_5612556b = N'USD'
SET
  @PriceTypeID_5612556b = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_5612556b = 5
SET
  @OutputPricePerUnit_5612556b = 30
SET
  @UnitTypeID_5612556b = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_5612556b = N'Realtime'
SET
  @Comments_5612556b = N'GPT 5.5 standard pricing on OpenAI as of April 24, 2026 launch. $5.00/$30.00 per 1M tokens. Prompts >272K input tokens billed at 2x input and 1.5x output for the full session (standard, batch, and flex tiers). Batch and Flex APIs at 50% off; Priority at 2.5x standard. Regional data-residency endpoints carry a 10% uplift. Source: https://openai.com/index/introducing-gpt-5-5/' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_5612556b,
  @ModelID = @ModelID_5612556b,
  @VendorID = @VendorID_5612556b,
  @StartedAt = @StartedAt_5612556b,
  @EndedAt = @EndedAt_5612556b,
  @EndedAt_Clear = 1,
  @Status = @Status_5612556b,
  @Currency = @Currency_5612556b,
  @PriceTypeID = @PriceTypeID_5612556b,
  @InputPricePerUnit = @InputPricePerUnit_5612556b,
  @OutputPricePerUnit = @OutputPricePerUnit_5612556b,
  @UnitTypeID = @UnitTypeID_5612556b,
  @ProcessingType = @ProcessingType_5612556b,
  @Comments = @Comments_5612556b;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_cf258b99 UNIQUEIDENTIFIER,
@ModelID_cf258b99 UNIQUEIDENTIFIER,
@VendorID_cf258b99 UNIQUEIDENTIFIER,
@StartedAt_cf258b99 DATETIMEOFFSET,
@EndedAt_cf258b99 DATETIMEOFFSET,
@Status_cf258b99 NVARCHAR(20),
@Currency_cf258b99 NCHAR(3),
@PriceTypeID_cf258b99 UNIQUEIDENTIFIER,
@InputPricePerUnit_cf258b99 DECIMAL(18, 8),
@OutputPricePerUnit_cf258b99 DECIMAL(18, 8),
@UnitTypeID_cf258b99 UNIQUEIDENTIFIER,
@ProcessingType_cf258b99 NVARCHAR(20),
@Comments_cf258b99 NVARCHAR(MAX)
SET
  @ID_cf258b99 = 'c5001598-46d6-438a-b957-4a50c0177461'
SET
  @ModelID_cf258b99 = 'DBF24BE7-3925-47CE-9352-FA714F57B8E5'
SET
  @VendorID_cf258b99 = 'D75ABC84-6BDB-41B9-94C7-2FE748482193'
SET
  @StartedAt_cf258b99 = '2026-04-24T00:00:00.000Z'
SET
  @Status_cf258b99 = N'Active'
SET
  @Currency_cf258b99 = N'USD'
SET
  @PriceTypeID_cf258b99 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_cf258b99 = 5
SET
  @OutputPricePerUnit_cf258b99 = 30
SET
  @UnitTypeID_cf258b99 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_cf258b99 = N'Realtime'
SET
  @Comments_cf258b99 = N'GPT 5.5 pricing on Azure OpenAI / Microsoft Foundry (Global Standard) as of April 24, 2026 launch. Source: https://azure.microsoft.com/en-us/blog/openais-gpt-5-5-in-microsoft-foundry-frontier-intelligence-on-an-enterprise-ready-platform/' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_cf258b99,
  @ModelID = @ModelID_cf258b99,
  @VendorID = @VendorID_cf258b99,
  @StartedAt = @StartedAt_cf258b99,
  @EndedAt = @EndedAt_cf258b99,
  @EndedAt_Clear = 1,
  @Status = @Status_cf258b99,
  @Currency = @Currency_cf258b99,
  @PriceTypeID = @PriceTypeID_cf258b99,
  @InputPricePerUnit = @InputPricePerUnit_cf258b99,
  @OutputPricePerUnit = @OutputPricePerUnit_cf258b99,
  @UnitTypeID = @UnitTypeID_cf258b99,
  @ProcessingType = @ProcessingType_cf258b99,
  @Comments = @Comments_cf258b99;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_baa37069 UNIQUEIDENTIFIER,
@Name_baa37069 NVARCHAR(50),
@Description_baa37069 NVARCHAR(MAX),
@AIModelTypeID_baa37069 UNIQUEIDENTIFIER,
@PowerRank_baa37069 INT,
@IsActive_baa37069 BIT,
@SpeedRank_baa37069 INT,
@CostRank_baa37069 INT,
@ModelSelectionInsights_baa37069 NVARCHAR(MAX),
@InheritTypeModalities_baa37069 BIT,
@PriorVersionID_baa37069 UNIQUEIDENTIFIER,
@SupportsPrefill_baa37069 BIT,
@PrefillFallbackText_baa37069 NVARCHAR(MAX)
SET
  @ID_baa37069 = 'c3ace0ad-bf2c-49a7-bf3b-b8f9a9d9243e'
SET
  @Name_baa37069 = N'GPT 5.5 Pro'
SET
  @Description_baa37069 = N'OpenAI''s premium variant of GPT 5.5, released April 24, 2026. Extends reasoning depth and task complexity for the most demanding enterprise workloads. Same 1M input / 128K output token window as GPT 5.5. Available through the Responses API and Batch API. Pricing reflects deeper reasoning compute: 6x the input and 6x the output cost of standard GPT 5.5.'
SET
  @AIModelTypeID_baa37069 = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_baa37069 = 8
SET
  @IsActive_baa37069 = 1
SET
  @SpeedRank_baa37069 = 5
SET
  @CostRank_baa37069 = 10
SET
  @InheritTypeModalities_baa37069 = 1
SET
  @PriorVersionID_baa37069 = 'DBF24BE7-3925-47CE-9352-FA714F57B8E5' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_baa37069,
  @Name = @Name_baa37069,
  @Description = @Description_baa37069,
  @AIModelTypeID = @AIModelTypeID_baa37069,
  @PowerRank = @PowerRank_baa37069,
  @IsActive = @IsActive_baa37069,
  @SpeedRank = @SpeedRank_baa37069,
  @CostRank = @CostRank_baa37069,
  @ModelSelectionInsights = @ModelSelectionInsights_baa37069,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_baa37069,
  @PriorVersionID = @PriorVersionID_baa37069,
  @SupportsPrefill = @SupportsPrefill_baa37069,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_baa37069,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_99e5b90e UNIQUEIDENTIFIER,
@ModelID_99e5b90e UNIQUEIDENTIFIER,
@VendorID_99e5b90e UNIQUEIDENTIFIER,
@Priority_99e5b90e INT,
@Status_99e5b90e NVARCHAR(20),
@DriverClass_99e5b90e NVARCHAR(100),
@DriverImportPath_99e5b90e NVARCHAR(255),
@APIName_99e5b90e NVARCHAR(100),
@MaxInputTokens_99e5b90e INT,
@MaxOutputTokens_99e5b90e INT,
@SupportedResponseFormats_99e5b90e NVARCHAR(100),
@SupportsEffortLevel_99e5b90e BIT,
@SupportsStreaming_99e5b90e BIT,
@TypeID_99e5b90e UNIQUEIDENTIFIER,
@SupportsPrefill_99e5b90e BIT,
@PrefillFallbackText_99e5b90e NVARCHAR(MAX)
SET
  @ID_99e5b90e = 'cf81572a-f3a5-48e6-ba1e-e68a1ae1ac23'
SET
  @ModelID_99e5b90e = '9D29C67C-DF96-4A2D-8E08-E37A120C35A5'
SET
  @VendorID_99e5b90e = '5483D98F-1F4E-40F4-91FC-EAA8EFDC90F1'
SET
  @Priority_99e5b90e = 0
SET
  @Status_99e5b90e = N'Active'
SET
  @SupportedResponseFormats_99e5b90e = N'Any'
SET
  @SupportsEffortLevel_99e5b90e = 0
SET
  @SupportsStreaming_99e5b90e = 0
SET
  @TypeID_99e5b90e = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_99e5b90e,
  @ModelID = @ModelID_99e5b90e,
  @VendorID = @VendorID_99e5b90e,
  @Priority = @Priority_99e5b90e,
  @Status = @Status_99e5b90e,
  @DriverClass = @DriverClass_99e5b90e,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_99e5b90e,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_99e5b90e,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_99e5b90e,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_99e5b90e,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_99e5b90e,
  @SupportsEffortLevel = @SupportsEffortLevel_99e5b90e,
  @SupportsStreaming = @SupportsStreaming_99e5b90e,
  @TypeID = @TypeID_99e5b90e,
  @SupportsPrefill = @SupportsPrefill_99e5b90e,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_99e5b90e,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_7045385f UNIQUEIDENTIFIER,
@ModelID_7045385f UNIQUEIDENTIFIER,
@VendorID_7045385f UNIQUEIDENTIFIER,
@Priority_7045385f INT,
@Status_7045385f NVARCHAR(20),
@DriverClass_7045385f NVARCHAR(100),
@DriverImportPath_7045385f NVARCHAR(255),
@APIName_7045385f NVARCHAR(100),
@MaxInputTokens_7045385f INT,
@MaxOutputTokens_7045385f INT,
@SupportedResponseFormats_7045385f NVARCHAR(100),
@SupportsEffortLevel_7045385f BIT,
@SupportsStreaming_7045385f BIT,
@TypeID_7045385f UNIQUEIDENTIFIER,
@SupportsPrefill_7045385f BIT,
@PrefillFallbackText_7045385f NVARCHAR(MAX)
SET
  @ID_7045385f = 'deac8af7-cac0-415d-8a96-65303baf2490'
SET
  @ModelID_7045385f = '9D29C67C-DF96-4A2D-8E08-E37A120C35A5'
SET
  @VendorID_7045385f = '5483D98F-1F4E-40F4-91FC-EAA8EFDC90F1'
SET
  @Priority_7045385f = 1
SET
  @Status_7045385f = N'Active'
SET
  @DriverClass_7045385f = N'xAILLM'
SET
  @APIName_7045385f = N'grok-4.3'
SET
  @MaxInputTokens_7045385f = 1000000
SET
  @MaxOutputTokens_7045385f = 128000
SET
  @SupportedResponseFormats_7045385f = N'Any, JSON'
SET
  @SupportsEffortLevel_7045385f = 0
SET
  @SupportsStreaming_7045385f = 1
SET
  @TypeID_7045385f = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_7045385f,
  @ModelID = @ModelID_7045385f,
  @VendorID = @VendorID_7045385f,
  @Priority = @Priority_7045385f,
  @Status = @Status_7045385f,
  @DriverClass = @DriverClass_7045385f,
  @DriverImportPath = @DriverImportPath_7045385f,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_7045385f,
  @MaxInputTokens = @MaxInputTokens_7045385f,
  @MaxOutputTokens = @MaxOutputTokens_7045385f,
  @SupportedResponseFormats = @SupportedResponseFormats_7045385f,
  @SupportsEffortLevel = @SupportsEffortLevel_7045385f,
  @SupportsStreaming = @SupportsStreaming_7045385f,
  @TypeID = @TypeID_7045385f,
  @SupportsPrefill = @SupportsPrefill_7045385f,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_7045385f,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_f5490046 UNIQUEIDENTIFIER,
@ModelID_f5490046 UNIQUEIDENTIFIER,
@VendorID_f5490046 UNIQUEIDENTIFIER,
@StartedAt_f5490046 DATETIMEOFFSET,
@EndedAt_f5490046 DATETIMEOFFSET,
@Status_f5490046 NVARCHAR(20),
@Currency_f5490046 NCHAR(3),
@PriceTypeID_f5490046 UNIQUEIDENTIFIER,
@InputPricePerUnit_f5490046 DECIMAL(18, 8),
@OutputPricePerUnit_f5490046 DECIMAL(18, 8),
@UnitTypeID_f5490046 UNIQUEIDENTIFIER,
@ProcessingType_f5490046 NVARCHAR(20),
@Comments_f5490046 NVARCHAR(MAX)
SET
  @ID_f5490046 = '19ef5b6e-ed48-4453-9051-1d1f80c593a9'
SET
  @ModelID_f5490046 = '9D29C67C-DF96-4A2D-8E08-E37A120C35A5'
SET
  @VendorID_f5490046 = '5483D98F-1F4E-40F4-91FC-EAA8EFDC90F1'
SET
  @StartedAt_f5490046 = '2026-04-30T00:00:00.000Z'
SET
  @Status_f5490046 = N'Active'
SET
  @Currency_f5490046 = N'USD'
SET
  @PriceTypeID_f5490046 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_f5490046 = 1.25
SET
  @OutputPricePerUnit_f5490046 = 2.5
SET
  @UnitTypeID_f5490046 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_f5490046 = N'Realtime'
SET
  @Comments_f5490046 = N'Grok 4.3 pricing on xAI direct API as of April 30, 2026 launch. $1.25/$2.50 per 1M tokens for requests up to 200,000 tokens; requests above 200K input billed at higher rates per xAI doc. Sources: https://docs.x.ai/developers/models/grok-4.3 ; https://venturebeat.com/technology/xai-launches-grok-4-3-at-an-aggressively-low-price-and-a-new-fast-powerful-voice-cloning-suite' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_f5490046,
  @ModelID = @ModelID_f5490046,
  @VendorID = @VendorID_f5490046,
  @StartedAt = @StartedAt_f5490046,
  @EndedAt = @EndedAt_f5490046,
  @EndedAt_Clear = 1,
  @Status = @Status_f5490046,
  @Currency = @Currency_f5490046,
  @PriceTypeID = @PriceTypeID_f5490046,
  @InputPricePerUnit = @InputPricePerUnit_f5490046,
  @OutputPricePerUnit = @OutputPricePerUnit_f5490046,
  @UnitTypeID = @UnitTypeID_f5490046,
  @ProcessingType = @ProcessingType_f5490046,
  @Comments = @Comments_f5490046;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_4fff3b24 UNIQUEIDENTIFIER,
@ModelID_4fff3b24 UNIQUEIDENTIFIER,
@VendorID_4fff3b24 UNIQUEIDENTIFIER,
@Priority_4fff3b24 INT,
@Status_4fff3b24 NVARCHAR(20),
@DriverClass_4fff3b24 NVARCHAR(100),
@DriverImportPath_4fff3b24 NVARCHAR(255),
@APIName_4fff3b24 NVARCHAR(100),
@MaxInputTokens_4fff3b24 INT,
@MaxOutputTokens_4fff3b24 INT,
@SupportedResponseFormats_4fff3b24 NVARCHAR(100),
@SupportsEffortLevel_4fff3b24 BIT,
@SupportsStreaming_4fff3b24 BIT,
@TypeID_4fff3b24 UNIQUEIDENTIFIER,
@SupportsPrefill_4fff3b24 BIT,
@PrefillFallbackText_4fff3b24 NVARCHAR(MAX)
SET
  @ID_4fff3b24 = 'a1ce1d5b-d2c1-4833-91e4-53b171fe287f'
SET
  @ModelID_4fff3b24 = 'C3ACE0AD-BF2C-49A7-BF3B-B8F9A9D9243E'
SET
  @VendorID_4fff3b24 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_4fff3b24 = 0
SET
  @Status_4fff3b24 = N'Active'
SET
  @SupportedResponseFormats_4fff3b24 = N'Any'
SET
  @SupportsEffortLevel_4fff3b24 = 1
SET
  @SupportsStreaming_4fff3b24 = 0
SET
  @TypeID_4fff3b24 = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_4fff3b24,
  @ModelID = @ModelID_4fff3b24,
  @VendorID = @VendorID_4fff3b24,
  @Priority = @Priority_4fff3b24,
  @Status = @Status_4fff3b24,
  @DriverClass = @DriverClass_4fff3b24,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_4fff3b24,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_4fff3b24,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_4fff3b24,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_4fff3b24,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_4fff3b24,
  @SupportsEffortLevel = @SupportsEffortLevel_4fff3b24,
  @SupportsStreaming = @SupportsStreaming_4fff3b24,
  @TypeID = @TypeID_4fff3b24,
  @SupportsPrefill = @SupportsPrefill_4fff3b24,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_4fff3b24,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_3bcdd0f8 UNIQUEIDENTIFIER,
@ModelID_3bcdd0f8 UNIQUEIDENTIFIER,
@VendorID_3bcdd0f8 UNIQUEIDENTIFIER,
@Priority_3bcdd0f8 INT,
@Status_3bcdd0f8 NVARCHAR(20),
@DriverClass_3bcdd0f8 NVARCHAR(100),
@DriverImportPath_3bcdd0f8 NVARCHAR(255),
@APIName_3bcdd0f8 NVARCHAR(100),
@MaxInputTokens_3bcdd0f8 INT,
@MaxOutputTokens_3bcdd0f8 INT,
@SupportedResponseFormats_3bcdd0f8 NVARCHAR(100),
@SupportsEffortLevel_3bcdd0f8 BIT,
@SupportsStreaming_3bcdd0f8 BIT,
@TypeID_3bcdd0f8 UNIQUEIDENTIFIER,
@SupportsPrefill_3bcdd0f8 BIT,
@PrefillFallbackText_3bcdd0f8 NVARCHAR(MAX)
SET
  @ID_3bcdd0f8 = '7eeabefb-3f30-4383-b453-038416c9aee1'
SET
  @ModelID_3bcdd0f8 = 'C3ACE0AD-BF2C-49A7-BF3B-B8F9A9D9243E'
SET
  @VendorID_3bcdd0f8 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_3bcdd0f8 = 1
SET
  @Status_3bcdd0f8 = N'Active'
SET
  @DriverClass_3bcdd0f8 = N'OpenAILLM'
SET
  @APIName_3bcdd0f8 = N'gpt-5.5-pro'
SET
  @MaxInputTokens_3bcdd0f8 = 1050000
SET
  @MaxOutputTokens_3bcdd0f8 = 128000
SET
  @SupportedResponseFormats_3bcdd0f8 = N'Any, JSON'
SET
  @SupportsEffortLevel_3bcdd0f8 = 1
SET
  @SupportsStreaming_3bcdd0f8 = 0
SET
  @TypeID_3bcdd0f8 = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_3bcdd0f8,
  @ModelID = @ModelID_3bcdd0f8,
  @VendorID = @VendorID_3bcdd0f8,
  @Priority = @Priority_3bcdd0f8,
  @Status = @Status_3bcdd0f8,
  @DriverClass = @DriverClass_3bcdd0f8,
  @DriverImportPath = @DriverImportPath_3bcdd0f8,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_3bcdd0f8,
  @MaxInputTokens = @MaxInputTokens_3bcdd0f8,
  @MaxOutputTokens = @MaxOutputTokens_3bcdd0f8,
  @SupportedResponseFormats = @SupportedResponseFormats_3bcdd0f8,
  @SupportsEffortLevel = @SupportsEffortLevel_3bcdd0f8,
  @SupportsStreaming = @SupportsStreaming_3bcdd0f8,
  @TypeID = @TypeID_3bcdd0f8,
  @SupportsPrefill = @SupportsPrefill_3bcdd0f8,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_3bcdd0f8,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_46f4677d UNIQUEIDENTIFIER,
@ModelID_46f4677d UNIQUEIDENTIFIER,
@VendorID_46f4677d UNIQUEIDENTIFIER,
@StartedAt_46f4677d DATETIMEOFFSET,
@EndedAt_46f4677d DATETIMEOFFSET,
@Status_46f4677d NVARCHAR(20),
@Currency_46f4677d NCHAR(3),
@PriceTypeID_46f4677d UNIQUEIDENTIFIER,
@InputPricePerUnit_46f4677d DECIMAL(18, 8),
@OutputPricePerUnit_46f4677d DECIMAL(18, 8),
@UnitTypeID_46f4677d UNIQUEIDENTIFIER,
@ProcessingType_46f4677d NVARCHAR(20),
@Comments_46f4677d NVARCHAR(MAX)
SET
  @ID_46f4677d = 'e4e0d944-2bda-4d3b-9378-a12c8a31a466'
SET
  @ModelID_46f4677d = 'C3ACE0AD-BF2C-49A7-BF3B-B8F9A9D9243E'
SET
  @VendorID_46f4677d = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @StartedAt_46f4677d = '2026-04-24T00:00:00.000Z'
SET
  @Status_46f4677d = N'Active'
SET
  @Currency_46f4677d = N'USD'
SET
  @PriceTypeID_46f4677d = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_46f4677d = 30
SET
  @OutputPricePerUnit_46f4677d = 180
SET
  @UnitTypeID_46f4677d = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_46f4677d = N'Realtime'
SET
  @Comments_46f4677d = N'GPT 5.5 Pro pricing on OpenAI as of April 24, 2026 launch. $30.00/$180.00 per 1M tokens. Available via Responses API and Batch API. Batch and Flex at 50% off. Source: https://openai.com/index/introducing-gpt-5-5/' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_46f4677d,
  @ModelID = @ModelID_46f4677d,
  @VendorID = @VendorID_46f4677d,
  @StartedAt = @StartedAt_46f4677d,
  @EndedAt = @EndedAt_46f4677d,
  @EndedAt_Clear = 1,
  @Status = @Status_46f4677d,
  @Currency = @Currency_46f4677d,
  @PriceTypeID = @PriceTypeID_46f4677d,
  @InputPricePerUnit = @InputPricePerUnit_46f4677d,
  @OutputPricePerUnit = @OutputPricePerUnit_46f4677d,
  @UnitTypeID = @UnitTypeID_46f4677d,
  @ProcessingType = @ProcessingType_46f4677d,
  @Comments = @Comments_46f4677d;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_6489fea0 UNIQUEIDENTIFIER,
@Name_6489fea0 NVARCHAR(425),
@Description_6489fea0 NVARCHAR(MAX),
@Type_6489fea0 NVARCHAR(20),
@UserPrompt_6489fea0 NVARCHAR(MAX),
@UserComments_6489fea0 NVARCHAR(MAX),
@Code_6489fea0 NVARCHAR(MAX),
@CodeComments_6489fea0 NVARCHAR(MAX),
@CodeApprovalStatus_6489fea0 NVARCHAR(20),
@CodeApprovalComments_6489fea0 NVARCHAR(MAX),
@CodeApprovedByUserID_6489fea0 UNIQUEIDENTIFIER,
@CodeApprovedAt_6489fea0 DATETIMEOFFSET,
@CodeLocked_6489fea0 BIT,
@ForceCodeGeneration_6489fea0 BIT,
@RetentionPeriod_6489fea0 INT,
@Status_6489fea0 NVARCHAR(20),
@DriverClass_6489fea0 NVARCHAR(255),
@ParentID_6489fea0 UNIQUEIDENTIFIER,
@IconClass_6489fea0 NVARCHAR(100),
@DefaultCompactPromptID_6489fea0 UNIQUEIDENTIFIER,
@Config_6489fea0 NVARCHAR(MAX),
@RuntimeActionConfiguration_6489fea0 NVARCHAR(MAX),
@MaxExecutionTimeMS_6489fea0 INT,
@CreatedByAgentID_6489fea0 UNIQUEIDENTIFIER,
@ID_6489fea0 UNIQUEIDENTIFIER
SET
  @CategoryID_6489fea0 = '22285832-93AD-427E-81BA-E332F63FC5B9'
SET
  @Name_6489fea0 = N'Entity Data Quality Report'
SET
  @Description_6489fea0 = N'Scans a sample of records for a given entity and returns a data quality report: per-field null rates, distinct value counts, and an overall completeness score (0-1) that weights non-nullable fields 2x. Useful for data stewards triaging bad data. Exercises the `md` (entity introspection) and `rv` (RunView) bridge namespaces.'
SET
  @Type_6489fea0 = N'Runtime'
SET
  @Code_6489fea0 = N'// Entity Data Quality Report — md + rv Runtime action.
//
...
'
SET
  @CodeApprovalStatus_6489fea0 = N'Approved'
SET
  @CodeLocked_6489fea0 = 0
SET
  @ForceCodeGeneration_6489fea0 = 0
SET
  @Status_6489fea0 = N'Active'
SET
  @IconClass_6489fea0 = N'fa-solid fa-magnifying-glass-chart'
SET
  @RuntimeActionConfiguration_6489fea0 = N'{
  "permissions": {
    "allowedActions": [],
    "allowedAgents": [],
    "allowedEntities": [],
...
SET
  @MaxExecutionTimeMS_6489fea0 = 60000
SET
  @ID_6489fea0 = '1FA27C4C-34A7-4E1C-8134-6736F3781C8F' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_6489fea0,
  @Name = @Name_6489fea0,
  @Description = @Description_6489fea0,
  @Type = @Type_6489fea0,
  @UserPrompt = @UserPrompt_6489fea0,
  @UserPrompt_Clear = 1,
  @UserComments = @UserComments_6489fea0,
  @UserComments_Clear = 1,
  @Code = @Code_6489fea0,
  @CodeComments = @CodeComments_6489fea0,
  @CodeComments_Clear = 1,
  @CodeApprovalStatus = @CodeApprovalStatus_6489fea0,
  @CodeApprovalComments = @CodeApprovalComments_6489fea0,
  @CodeApprovalComments_Clear = 1,
  @CodeApprovedByUserID = @CodeApprovedByUserID_6489fea0,
  @CodeApprovedByUserID_Clear = 1,
  @CodeApprovedAt = @CodeApprovedAt_6489fea0,
  @CodeApprovedAt_Clear = 1,
  @CodeLocked = @CodeLocked_6489fea0,
  @ForceCodeGeneration = @ForceCodeGeneration_6489fea0,
  @RetentionPeriod = @RetentionPeriod_6489fea0,
  @RetentionPeriod_Clear = 1,
  @Status = @Status_6489fea0,
  @DriverClass = @DriverClass_6489fea0,
  @DriverClass_Clear = 1,
  @ParentID = @ParentID_6489fea0,
  @ParentID_Clear = 1,
  @IconClass = @IconClass_6489fea0,
  @DefaultCompactPromptID = @DefaultCompactPromptID_6489fea0,
  @DefaultCompactPromptID_Clear = 1,
  @Config = @Config_6489fea0,
  @Config_Clear = 1,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_6489fea0,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_6489fea0,
  @CreatedByAgentID = @CreatedByAgentID_6489fea0,
...
-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_56a1c840 UNIQUEIDENTIFIER,
@Name_56a1c840 NVARCHAR(425),
@Description_56a1c840 NVARCHAR(MAX),
@Type_56a1c840 NVARCHAR(20),
@UserPrompt_56a1c840 NVARCHAR(MAX),
@UserComments_56a1c840 NVARCHAR(MAX),
@Code_56a1c840 NVARCHAR(MAX),
@CodeComments_56a1c840 NVARCHAR(MAX),
@CodeApprovalStatus_56a1c840 NVARCHAR(20),
@CodeApprovalComments_56a1c840 NVARCHAR(MAX),
@CodeApprovedByUserID_56a1c840 UNIQUEIDENTIFIER,
@CodeApprovedAt_56a1c840 DATETIMEOFFSET,
@CodeLocked_56a1c840 BIT,
@ForceCodeGeneration_56a1c840 BIT,
@RetentionPeriod_56a1c840 INT,
@Status_56a1c840 NVARCHAR(20),
@DriverClass_56a1c840 NVARCHAR(255),
@ParentID_56a1c840 UNIQUEIDENTIFIER,
@IconClass_56a1c840 NVARCHAR(100),
@DefaultCompactPromptID_56a1c840 UNIQUEIDENTIFIER,
@Config_56a1c840 NVARCHAR(MAX),
@RuntimeActionConfiguration_56a1c840 NVARCHAR(MAX),
@MaxExecutionTimeMS_56a1c840 INT,
@CreatedByAgentID_56a1c840 UNIQUEIDENTIFIER,
@ID_56a1c840 UNIQUEIDENTIFIER
SET
  @CategoryID_56a1c840 = '22285832-93AD-427E-81BA-E332F63FC5B9'
SET
  @Name_56a1c840 = N'Find Similar Records'
SET
  @Description_56a1c840 = N'Finds records in an entity whose text field is similar to a search string. Ranks matches by a blended score (30% containment, 70% normalized Levenshtein) so both typos and long-substring matches rank well. No AI dependency — cheap and deterministic. Validates the target field via metadata before scanning.'
SET
  @Type_56a1c840 = N'Runtime'
SET
  @Code_56a1c840 = N'// Find Similar Records — md + rv + compute Runtime action.
//
...
'
SET
  @CodeApprovalStatus_56a1c840 = N'Approved'
SET
  @CodeLocked_56a1c840 = 0
SET
  @ForceCodeGeneration_56a1c840 = 0
SET
  @Status_56a1c840 = N'Active'
SET
  @IconClass_56a1c840 = N'fa-solid fa-magnifying-glass-location'
SET
  @RuntimeActionConfiguration_56a1c840 = N'{
  "permissions": {
    "allowedActions": [],
    "allowedAgents": [],
    "allowedEntities": [],
...
SET
  @MaxExecutionTimeMS_56a1c840 = 60000
SET
  @ID_56a1c840 = '8785E9AA-AF9D-41EF-A8B8-7CA524785DA6' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_56a1c840,
  @Name = @Name_56a1c840,
  @Description = @Description_56a1c840,
  @Type = @Type_56a1c840,
  @UserPrompt = @UserPrompt_56a1c840,
  @UserPrompt_Clear = 1,
  @UserComments = @UserComments_56a1c840,
  @UserComments_Clear = 1,
  @Code = @Code_56a1c840,
  @CodeComments = @CodeComments_56a1c840,
  @CodeComments_Clear = 1,
  @CodeApprovalStatus = @CodeApprovalStatus_56a1c840,
  @CodeApprovalComments = @CodeApprovalComments_56a1c840,
  @CodeApprovalComments_Clear = 1,
  @CodeApprovedByUserID = @CodeApprovedByUserID_56a1c840,
  @CodeApprovedByUserID_Clear = 1,
  @CodeApprovedAt = @CodeApprovedAt_56a1c840,
  @CodeApprovedAt_Clear = 1,
  @CodeLocked = @CodeLocked_56a1c840,
  @ForceCodeGeneration = @ForceCodeGeneration_56a1c840,
  @RetentionPeriod = @RetentionPeriod_56a1c840,
  @RetentionPeriod_Clear = 1,
  @Status = @Status_56a1c840,
  @DriverClass = @DriverClass_56a1c840,
  @DriverClass_Clear = 1,
  @ParentID = @ParentID_56a1c840,
  @ParentID_Clear = 1,
  @IconClass = @IconClass_56a1c840,
  @DefaultCompactPromptID = @DefaultCompactPromptID_56a1c840,
  @DefaultCompactPromptID_Clear = 1,
  @Config = @Config_56a1c840,
  @Config_Clear = 1,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_56a1c840,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_56a1c840,
  @CreatedByAgentID = @CreatedByAgentID_56a1c840,
  @CreatedByAgentID_Clear = 1,
  @ID = @ID_56a1c840;
...
-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_73d2112f UNIQUEIDENTIFIER,
@Name_73d2112f NVARCHAR(425),
@Description_73d2112f NVARCHAR(MAX),
@Type_73d2112f NVARCHAR(20),
@UserPrompt_73d2112f NVARCHAR(MAX),
@UserComments_73d2112f NVARCHAR(MAX),
@Code_73d2112f NVARCHAR(MAX),
@CodeComments_73d2112f NVARCHAR(MAX),
@CodeApprovalStatus_73d2112f NVARCHAR(20),
@CodeApprovalComments_73d2112f NVARCHAR(MAX),
@CodeApprovedByUserID_73d2112f UNIQUEIDENTIFIER,
@CodeApprovedAt_73d2112f DATETIMEOFFSET,
@CodeLocked_73d2112f BIT,
@ForceCodeGeneration_73d2112f BIT,
@RetentionPeriod_73d2112f INT,
@Status_73d2112f NVARCHAR(20),
@DriverClass_73d2112f NVARCHAR(255),
@ParentID_73d2112f UNIQUEIDENTIFIER,
@IconClass_73d2112f NVARCHAR(100),
@DefaultCompactPromptID_73d2112f UNIQUEIDENTIFIER,
@Config_73d2112f NVARCHAR(MAX),
@RuntimeActionConfiguration_73d2112f NVARCHAR(MAX),
@MaxExecutionTimeMS_73d2112f INT,
@CreatedByAgentID_73d2112f UNIQUEIDENTIFIER,
@ID_73d2112f UNIQUEIDENTIFIER
SET
  @CategoryID_73d2112f = '65E048AA-5220-4E4D-920A-A3D9349902A7'
SET
  @Name_73d2112f = N'Weekly Entity Digest'
SET
  @Description_73d2112f = N'Composes a weekly markdown digest from activity across one or more entities, then emails it via the Send Single Message action. Exercises every major bridge namespace: metadata-bounded entity queries (rv), standard library helpers (libs), AI prompt rendering (ai), and downstream action invocation (actions). Supports dryRun=true to return the markdown without sending.'
SET
  @Type_73d2112f = N'Runtime'
SET
  @Code_73d2112f = N'// Weekly Entity Digest — full-stack Runtime action.
//
...
'
SET
  @CodeApprovalStatus_73d2112f = N'Approved'
SET
  @CodeLocked_73d2112f = 0
SET
  @ForceCodeGeneration_73d2112f = 0
SET
  @Status_73d2112f = N'Active'
SET
  @IconClass_73d2112f = N'fa-solid fa-newspaper'
SET
  @RuntimeActionConfiguration_73d2112f = N'{
  "permissions": {
    "allowedActions": [
      {
...
SET
  @MaxExecutionTimeMS_73d2112f = 180000
SET
  @ID_73d2112f = 'B57BE9DE-FDBA-4545-822B-32EA6C4E706A' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_73d2112f,
  @Name = @Name_73d2112f,
  @Description = @Description_73d2112f,
  @Type = @Type_73d2112f,
  @UserPrompt = @UserPrompt_73d2112f,
  @UserPrompt_Clear = 1,
  @UserComments = @UserComments_73d2112f,
  @UserComments_Clear = 1,
  @Code = @Code_73d2112f,
  @CodeComments = @CodeComments_73d2112f,
  @CodeComments_Clear = 1,
  @CodeApprovalStatus = @CodeApprovalStatus_73d2112f,
  @CodeApprovalComments = @CodeApprovalComments_73d2112f,
  @CodeApprovalComments_Clear = 1,
  @CodeApprovedByUserID = @CodeApprovedByUserID_73d2112f,
  @CodeApprovedByUserID_Clear = 1,
  @CodeApprovedAt = @CodeApprovedAt_73d2112f,
  @CodeApprovedAt_Clear = 1,
  @CodeLocked = @CodeLocked_73d2112f,
  @ForceCodeGeneration = @ForceCodeGeneration_73d2112f,
  @RetentionPeriod = @RetentionPeriod_73d2112f,
  @RetentionPeriod_Clear = 1,
  @Status = @Status_73d2112f,
  @DriverClass = @DriverClass_73d2112f,
  @DriverClass_Clear = 1,
  @ParentID = @ParentID_73d2112f,
  @ParentID_Clear = 1,
  @IconClass = @IconClass_73d2112f,
  @DefaultCompactPromptID = @DefaultCompactPromptID_73d2112f,
  @DefaultCompactPromptID_Clear = 1,
  @Config = @Config_73d2112f,
  @Config_Clear = 1,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_73d2112f,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_73d2112f,
  @CreatedByAgentID = @CreatedByAgentID_73d2112f,
  @CreatedByAgentID_Clear = 1,
  @ID = @ID_73d2112f;
...
DECLARE @TemplateID_ec4eefa0 UNIQUEIDENTIFIER,
@TypeID_ec4eefa0 UNIQUEIDENTIFIER,
@TemplateText_ec4eefa0 NVARCHAR(MAX),
@Priority_ec4eefa0 INT,
@IsActive_ec4eefa0 BIT,
@ID_ec4eefa0 UNIQUEIDENTIFIER
SET
  @TemplateID_ec4eefa0 = '29481135-7740-4265-8ADB-449946A3D895'
SET
  @TypeID_ec4eefa0 = 'E7AFCCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @TemplateText_ec4eefa0 = N'You are an expert at analyzing database entity schemas and generating Entity Document templates optimized for vector similarity search in MemberJunction.
...
SET
  @IsActive_ec4eefa0 = 1
SET
  @ID_ec4eefa0 = '8647C35B-087E-4D9A-8105-1956380C25FE' EXEC [${flyway:defaultSchema}].spUpdateTemplateContent @TemplateID = @TemplateID_ec4eefa0,
  @TypeID = @TypeID_ec4eefa0,
  @TemplateText = @TemplateText_ec4eefa0,
  @Priority = @Priority_ec4eefa0,
  @IsActive = @IsActive_ec4eefa0,
  @ID = @ID_ec4eefa0;

GO

-- Save MJ: AI Prompts (core SP call only)
DECLARE @Name_e02d35ef NVARCHAR(255),
@Description_e02d35ef NVARCHAR(MAX),
@TemplateID_e02d35ef UNIQUEIDENTIFIER,
@CategoryID_e02d35ef UNIQUEIDENTIFIER,
@TypeID_e02d35ef UNIQUEIDENTIFIER,
@Status_e02d35ef NVARCHAR(50),
@ResponseFormat_e02d35ef NVARCHAR(20),
@ModelSpecificResponseFormat_e02d35ef NVARCHAR(MAX),
@AIModelTypeID_e02d35ef UNIQUEIDENTIFIER,
@MinPowerRank_e02d35ef INT,
@SelectionStrategy_e02d35ef NVARCHAR(20),
@PowerPreference_e02d35ef NVARCHAR(20),
@ParallelizationMode_e02d35ef NVARCHAR(20),
@ParallelCount_e02d35ef INT,
@ParallelConfigParam_e02d35ef NVARCHAR(100),
@OutputType_e02d35ef NVARCHAR(50),
@OutputExample_e02d35ef NVARCHAR(MAX),
@ValidationBehavior_e02d35ef NVARCHAR(50),
@MaxRetries_e02d35ef INT,
@RetryDelayMS_e02d35ef INT,
@RetryStrategy_e02d35ef NVARCHAR(20),
@ResultSelectorPromptID_e02d35ef UNIQUEIDENTIFIER,
@EnableCaching_e02d35ef BIT,
@CacheTTLSeconds_e02d35ef INT,
@CacheMatchType_e02d35ef NVARCHAR(20),
@CacheSimilarityThreshold_e02d35ef FLOAT(53),
@CacheMustMatchModel_e02d35ef BIT,
@CacheMustMatchVendor_e02d35ef BIT,
@CacheMustMatchAgent_e02d35ef BIT,
@CacheMustMatchConfig_e02d35ef BIT,
@PromptRole_e02d35ef NVARCHAR(20),
@PromptPosition_e02d35ef NVARCHAR(20),
@Temperature_e02d35ef DECIMAL(3, 2),
@TopP_e02d35ef DECIMAL(3, 2),
@TopK_e02d35ef INT,
@MinP_e02d35ef DECIMAL(3, 2),
@FrequencyPenalty_e02d35ef DECIMAL(3, 2),
@PresencePenalty_e02d35ef DECIMAL(3, 2),
@Seed_e02d35ef INT,
@StopSequences_e02d35ef NVARCHAR(1000),
@IncludeLogProbs_e02d35ef BIT,
@TopLogProbs_e02d35ef INT,
@FailoverStrategy_e02d35ef NVARCHAR(50),
@FailoverMaxAttempts_e02d35ef INT,
@FailoverDelaySeconds_e02d35ef INT,
@FailoverModelStrategy_e02d35ef NVARCHAR(50),
@FailoverErrorScope_e02d35ef NVARCHAR(50),
@EffortLevel_e02d35ef INT,
@AssistantPrefill_e02d35ef NVARCHAR(MAX),
@PrefillFallbackMode_e02d35ef NVARCHAR(20),
@RequireSpecificModels_e02d35ef BIT,
@ID_e02d35ef UNIQUEIDENTIFIER
SET
  @Name_e02d35ef = N'Entity Document Suggestion'
SET
  @Description_e02d35ef = N'Analyzes entity schemas and suggests Entity Document templates for vector similarity search and duplicate detection. Takes entity fields, types, and relationships as input and outputs a ready-to-use Nunjucks template with threshold recommendations.'
SET
  @TemplateID_e02d35ef = '29481135-7740-4265-8ADB-449946A3D895'
SET
  @CategoryID_e02d35ef = '7D2DEF7F-138F-4620-8309-33964A97A997'
SET
  @TypeID_e02d35ef = 'A6DA423E-F36B-1410-8DAC-00021F8B792E'
SET
  @Status_e02d35ef = N'Active'
SET
  @ResponseFormat_e02d35ef = N'JSON'
SET
  @MinPowerRank_e02d35ef = 0
SET
  @SelectionStrategy_e02d35ef = N'Specific'
SET
  @PowerPreference_e02d35ef = N'Balanced'
SET
  @ParallelizationMode_e02d35ef = N'None'
SET
  @OutputType_e02d35ef = N'string'
SET
  @ValidationBehavior_e02d35ef = N'Warn'
SET
  @MaxRetries_e02d35ef = 1
SET
  @RetryDelayMS_e02d35ef = 0
SET
  @RetryStrategy_e02d35ef = N'Fixed'
SET
  @EnableCaching_e02d35ef = 0
SET
  @CacheMatchType_e02d35ef = N'Exact'
SET
  @CacheMustMatchModel_e02d35ef = 1
SET
  @CacheMustMatchVendor_e02d35ef = 1
SET
  @CacheMustMatchAgent_e02d35ef = 0
SET
  @CacheMustMatchConfig_e02d35ef = 0
SET
  @PromptRole_e02d35ef = N'System'
SET
  @PromptPosition_e02d35ef = N'First'
SET
  @IncludeLogProbs_e02d35ef = 0
SET
  @FailoverStrategy_e02d35ef = N'SameModelDifferentVendor'
SET
  @FailoverMaxAttempts_e02d35ef = 3
SET
  @FailoverDelaySeconds_e02d35ef = 5
SET
  @FailoverModelStrategy_e02d35ef = N'PreferSameModel'
SET
  @FailoverErrorScope_e02d35ef = N'All'
SET
  @PrefillFallbackMode_e02d35ef = N'Ignore'
SET
  @RequireSpecificModels_e02d35ef = 0
SET
  @ID_e02d35ef = 'F89C5890-D5CD-4824-B431-329799047372' EXEC [${flyway:defaultSchema}].spUpdateAIPrompt @Name = @Name_e02d35ef,
  @Description = @Description_e02d35ef,
  @TemplateID = @TemplateID_e02d35ef,
  @CategoryID = @CategoryID_e02d35ef,
  @TypeID = @TypeID_e02d35ef,
  @Status = @Status_e02d35ef,
  @ResponseFormat = @ResponseFormat_e02d35ef,
  @ModelSpecificResponseFormat = @ModelSpecificResponseFormat_e02d35ef,
  @ModelSpecificResponseFormat_Clear = 1,
  @AIModelTypeID = @AIModelTypeID_e02d35ef,
  @AIModelTypeID_Clear = 1,
  @MinPowerRank = @MinPowerRank_e02d35ef,
  @SelectionStrategy = @SelectionStrategy_e02d35ef,
  @PowerPreference = @PowerPreference_e02d35ef,
  @ParallelizationMode = @ParallelizationMode_e02d35ef,
  @ParallelCount = @ParallelCount_e02d35ef,
  @ParallelCount_Clear = 1,
  @ParallelConfigParam = @ParallelConfigParam_e02d35ef,
  @ParallelConfigParam_Clear = 1,
  @OutputType = @OutputType_e02d35ef,
  @OutputExample = @OutputExample_e02d35ef,
  @OutputExample_Clear = 1,
  @ValidationBehavior = @ValidationBehavior_e02d35ef,
  @MaxRetries = @MaxRetries_e02d35ef,
  @RetryDelayMS = @RetryDelayMS_e02d35ef,
  @RetryStrategy = @RetryStrategy_e02d35ef,
  @ResultSelectorPromptID = @ResultSelectorPromptID_e02d35ef,
  @ResultSelectorPromptID_Clear = 1,
  @EnableCaching = @EnableCaching_e02d35ef,
  @CacheTTLSeconds = @CacheTTLSeconds_e02d35ef,
  @CacheTTLSeconds_Clear = 1,
  @CacheMatchType = @CacheMatchType_e02d35ef,
  @CacheSimilarityThreshold = @CacheSimilarityThreshold_e02d35ef,
  @CacheSimilarityThreshold_Clear = 1,
  @CacheMustMatchModel = @CacheMustMatchModel_e02d35ef,
  @CacheMustMatchVendor = @CacheMustMatchVendor_e02d35ef,
  @CacheMustMatchAgent = @CacheMustMatchAgent_e02d35ef,
  @CacheMustMatchConfig = @CacheMustMatchConfig_e02d35ef,
  @PromptRole = @PromptRole_e02d35ef,
  @PromptPosition = @PromptPosition_e02d35ef,
  @Temperature = @Temperature_e02d35ef,
  @Temperature_Clear = 1,
  @TopP = @TopP_e02d35ef,
  @TopP_Clear = 1,
  @TopK = @TopK_e02d35ef,
...
SET
  @TechnicalDesign_192fd0da = N'## Implementation
...
'
SET
  @TechnicalDesign_08273a4a = N'## Architecture
React functional component for displaying AI-generated markdown content with built-in actions and collapsible UI.
...
'
SET
  @TechnicalDesign_c8e746a8 = N'## Architecture
React functional component with dual-mode operation (UI vs headless) supporting CSV, Excel (XLSX), and PDF exports.
...
'
SET
  @TechnicalDesign_160e374e = N'## Architecture
React functional component using Chart.js 4.4.1 for canvas-based chart rendering with NO built-in drill-down (emits events only).
...
'
SET
  @TechnicalDesign_0f72c77b = N'## Architecture
React functional component with intelligent primary key detection from MemberJunction entity metadata.
...
SET
  @DefaultSequence_d0994e37 = 999
SET
  @Status_d0994e37 = N'Active'
SET
  @NavigationStyle_d0994e37 = N'App Switcher'
SET
  @HideNavBarIconWhenActive_d0994e37 = 0
SET
  @Path_d0994e37 = N'admin'
SET
  @AutoUpdatePath_d0994e37 = 1
SET
  @ID_d0994e37 = 'DBCB423E-F36B-1410-8DAC-00021F8B792E' EXEC [${flyway:defaultSchema}].spUpdateApplication @Name = @Name_d0994e37,
  @Description = @Description_d0994e37,
  @Icon = @Icon_d0994e37,
  @DefaultForNewUser = @DefaultForNewUser_d0994e37,
  @SchemaAutoAddNewEntities = @SchemaAutoAddNewEntities_d0994e37,
  @SchemaAutoAddNewEntities_Clear = 1,
  @Color = @Color_d0994e37,
  @DefaultNavItems = @DefaultNavItems_d0994e37,
  @ClassName = @ClassName_d0994e37,
  @ClassName_Clear = 1,
  @DefaultSequence = @DefaultSequence_d0994e37,
  @Status = @Status_d0994e37,
  @NavigationStyle = @NavigationStyle_d0994e37,
  @TopNavLocation = @TopNavLocation_d0994e37,
  @TopNavLocation_Clear = 1,
  @HideNavBarIconWhenActive = @HideNavBarIconWhenActive_d0994e37,
  @Path = @Path_d0994e37,
  @AutoUpdatePath = @AutoUpdatePath_d0994e37,
  @ID = @ID_d0994e37;

GO

-- Save MJ: Integration Object Fields (core SP call only)
DECLARE @IntegrationObjectID_0ea4219f UNIQUEIDENTIFIER,
@Name_0ea4219f NVARCHAR(255),
@DisplayName_0ea4219f NVARCHAR(255),
@Description_0ea4219f NVARCHAR(MAX),
@Category_0ea4219f NVARCHAR(100),
@Type_0ea4219f NVARCHAR(100),
@Length_0ea4219f INT,
@Precision_0ea4219f INT,
@Scale_0ea4219f INT,
@AllowsNull_0ea4219f BIT,
@DefaultValue_0ea4219f NVARCHAR(255),
@IsPrimaryKey_0ea4219f BIT,
@IsUniqueKey_0ea4219f BIT,
@IsReadOnly_0ea4219f BIT,
@IsRequired_0ea4219f BIT,
@RelatedIntegrationObjectID_0ea4219f UNIQUEIDENTIFIER,
@RelatedIntegrationObjectFieldName_0ea4219f NVARCHAR(255),
@Sequence_0ea4219f INT,
@Configuration_0ea4219f NVARCHAR(MAX),
@Status_0ea4219f NVARCHAR(25),
@IsCustom_0ea4219f BIT,
@ID_0ea4219f UNIQUEIDENTIFIER
SET
  @IntegrationObjectID_0ea4219f = 'EADBCD2E-A079-42BC-B74B-85A82E16CA4A'
SET
  @Name_0ea4219f = N'InvoiceID'
SET
  @DisplayName_0ea4219f = N'InvoiceID'
SET
  @Type_0ea4219f = N'int'
SET
  @AllowsNull_0ea4219f = 0
SET
  @IsPrimaryKey_0ea4219f = 0
SET
  @IsUniqueKey_0ea4219f = 0
SET
  @IsReadOnly_0ea4219f = 1
SET
  @IsRequired_0ea4219f = 1
SET
  @Sequence_0ea4219f = 1
SET
  @Status_0ea4219f = N'Active'
SET
  @IsCustom_0ea4219f = 0
SET
  @ID_0ea4219f = 'F6AEF244-53EA-4613-BAFE-A62008F02E4D' EXEC [${flyway:defaultSchema}].spUpdateIntegrationObjectField @IntegrationObjectID = @IntegrationObjectID_0ea4219f,
  @Name = @Name_0ea4219f,
  @DisplayName = @DisplayName_0ea4219f,
  @Description = @Description_0ea4219f,
  @Description_Clear = 1,
  @Category = @Category_0ea4219f,
  @Category_Clear = 1,
  @Type = @Type_0ea4219f,
  @Length = @Length_0ea4219f,
  @Length_Clear = 1,
  @Precision = @Precision_0ea4219f,
  @Precision_Clear = 1,
  @Scale = @Scale_0ea4219f,
  @Scale_Clear = 1,
  @AllowsNull = @AllowsNull_0ea4219f,
  @DefaultValue = @DefaultValue_0ea4219f,
  @DefaultValue_Clear = 1,
  @IsPrimaryKey = @IsPrimaryKey_0ea4219f,
  @IsUniqueKey = @IsUniqueKey_0ea4219f,
  @IsReadOnly = @IsReadOnly_0ea4219f,
  @IsRequired = @IsRequired_0ea4219f,
  @RelatedIntegrationObjectID = @RelatedIntegrationObjectID_0ea4219f,
  @RelatedIntegrationObjectID_Clear = 1,
  @RelatedIntegrationObjectFieldName = @RelatedIntegrationObjectFieldName_0ea4219f,
  @RelatedIntegrationObjectFieldName_Clear = 1,
  @Sequence = @Sequence_0ea4219f,
  @Configuration = @Configuration_0ea4219f,
  @Configuration_Clear = 1,
  @Status = @Status_0ea4219f,
  @IsCustom = @IsCustom_0ea4219f,
  @ID = @ID_0ea4219f;

GO

-- Save MJ: Integration Object Fields (core SP call only)
DECLARE @IntegrationObjectID_3a440031 UNIQUEIDENTIFIER,
@Name_3a440031 NVARCHAR(255),
@DisplayName_3a440031 NVARCHAR(255),
@Description_3a440031 NVARCHAR(MAX),
@Category_3a440031 NVARCHAR(100),
@Type_3a440031 NVARCHAR(100),
@Length_3a440031 INT,
@Precision_3a440031 INT,
@Scale_3a440031 INT,
@AllowsNull_3a440031 BIT,
@DefaultValue_3a440031 NVARCHAR(255),
@IsPrimaryKey_3a440031 BIT,
@IsUniqueKey_3a440031 BIT,
@IsReadOnly_3a440031 BIT,
@IsRequired_3a440031 BIT,
@RelatedIntegrationObjectID_3a440031 UNIQUEIDENTIFIER,
@RelatedIntegrationObjectFieldName_3a440031 NVARCHAR(255),
@Sequence_3a440031 INT,
@Configuration_3a440031 NVARCHAR(MAX),
@Status_3a440031 NVARCHAR(25),
@IsCustom_3a440031 BIT,
@ID_3a440031 UNIQUEIDENTIFIER
SET
  @IntegrationObjectID_3a440031 = 'EADBCD2E-A079-42BC-B74B-85A82E16CA4A'
SET
  @Name_3a440031 = N'OrderID'
SET
  @DisplayName_3a440031 = N'Order ID'
SET
  @Type_3a440031 = N'int'
SET
  @AllowsNull_3a440031 = 0
SET
  @IsPrimaryKey_3a440031 = 1
SET
  @IsUniqueKey_3a440031 = 0
SET
  @IsReadOnly_3a440031 = 0
SET
  @IsRequired_3a440031 = 1
SET
  @Sequence_3a440031 = 18
SET
  @Status_3a440031 = N'Active'
SET
  @IsCustom_3a440031 = 0
SET
  @ID_3a440031 = 'F6AEF244-53EA-4613-BAFE-A62008F02E4D' EXEC [${flyway:defaultSchema}].spUpdateIntegrationObjectField @IntegrationObjectID = @IntegrationObjectID_3a440031,
  @Name = @Name_3a440031,
  @DisplayName = @DisplayName_3a440031,
  @Description = @Description_3a440031,
  @Description_Clear = 1,
  @Category = @Category_3a440031,
  @Category_Clear = 1,
  @Type = @Type_3a440031,
  @Length = @Length_3a440031,
  @Length_Clear = 1,
  @Precision = @Precision_3a440031,
  @Precision_Clear = 1,
  @Scale = @Scale_3a440031,
  @Scale_Clear = 1,
  @AllowsNull = @AllowsNull_3a440031,
  @DefaultValue = @DefaultValue_3a440031,
  @DefaultValue_Clear = 1,
  @IsPrimaryKey = @IsPrimaryKey_3a440031,
  @IsUniqueKey = @IsUniqueKey_3a440031,
  @IsReadOnly = @IsReadOnly_3a440031,
  @IsRequired = @IsRequired_3a440031,
  @RelatedIntegrationObjectID = @RelatedIntegrationObjectID_3a440031,
  @RelatedIntegrationObjectID_Clear = 1,
  @RelatedIntegrationObjectFieldName = @RelatedIntegrationObjectFieldName_3a440031,
  @RelatedIntegrationObjectFieldName_Clear = 1,
  @Sequence = @Sequence_3a440031,
  @Configuration = @Configuration_3a440031,
  @Configuration_Clear = 1,
  @Status = @Status_3a440031,
  @IsCustom = @IsCustom_3a440031,
  @ID = @ID_3a440031;

GO

-- Save MJ: Integration Object Fields (core SP call only)
DECLARE @IntegrationObjectID_ff5b22bb UNIQUEIDENTIFIER,
@Name_ff5b22bb NVARCHAR(255),
@DisplayName_ff5b22bb NVARCHAR(255),
@Description_ff5b22bb NVARCHAR(MAX),
@Category_ff5b22bb NVARCHAR(100),
@Type_ff5b22bb NVARCHAR(100),
@Length_ff5b22bb INT,
@Precision_ff5b22bb INT,
@Scale_ff5b22bb INT,
@AllowsNull_ff5b22bb BIT,
@DefaultValue_ff5b22bb NVARCHAR(255),
@IsPrimaryKey_ff5b22bb BIT,
@IsUniqueKey_ff5b22bb BIT,
@IsReadOnly_ff5b22bb BIT,
@IsRequired_ff5b22bb BIT,
@RelatedIntegrationObjectID_ff5b22bb UNIQUEIDENTIFIER,
@RelatedIntegrationObjectFieldName_ff5b22bb NVARCHAR(255),
@Sequence_ff5b22bb INT,
@Configuration_ff5b22bb NVARCHAR(MAX),
@Status_ff5b22bb NVARCHAR(25),
@IsCustom_ff5b22bb BIT,
@ID_ff5b22bb UNIQUEIDENTIFIER
SET
  @IntegrationObjectID_ff5b22bb = 'D9CE2F96-8F63-418F-9A46-3E2F60BA3F13'
SET
  @Name_ff5b22bb = N'Id'
SET
  @DisplayName_ff5b22bb = N'Id'
SET
  @Type_ff5b22bb = N'int'
SET
  @AllowsNull_ff5b22bb = 0
SET
  @IsPrimaryKey_ff5b22bb = 1
SET
  @IsUniqueKey_ff5b22bb = 0
SET
  @IsReadOnly_ff5b22bb = 1
SET
  @IsRequired_ff5b22bb = 1
SET
  @Sequence_ff5b22bb = 1
SET
  @Status_ff5b22bb = N'Active'
SET
  @IsCustom_ff5b22bb = 0
SET
  @ID_ff5b22bb = 'C6CB5E87-F47F-40CF-B084-92391EC27DC9' EXEC [${flyway:defaultSchema}].spUpdateIntegrationObjectField @IntegrationObjectID = @IntegrationObjectID_ff5b22bb,
  @Name = @Name_ff5b22bb,
  @DisplayName = @DisplayName_ff5b22bb,
  @Description = @Description_ff5b22bb,
  @Description_Clear = 1,
  @Category = @Category_ff5b22bb,
  @Category_Clear = 1,
  @Type = @Type_ff5b22bb,
  @Length = @Length_ff5b22bb,
  @Length_Clear = 1,
  @Precision = @Precision_ff5b22bb,
  @Precision_Clear = 1,
  @Scale = @Scale_ff5b22bb,
  @Scale_Clear = 1,
  @AllowsNull = @AllowsNull_ff5b22bb,
  @DefaultValue = @DefaultValue_ff5b22bb,
  @DefaultValue_Clear = 1,
  @IsPrimaryKey = @IsPrimaryKey_ff5b22bb,
  @IsUniqueKey = @IsUniqueKey_ff5b22bb,
  @IsReadOnly = @IsReadOnly_ff5b22bb,
  @IsRequired = @IsRequired_ff5b22bb,
  @RelatedIntegrationObjectID = @RelatedIntegrationObjectID_ff5b22bb,
  @RelatedIntegrationObjectID_Clear = 1,
  @RelatedIntegrationObjectFieldName = @RelatedIntegrationObjectFieldName_ff5b22bb,
  @RelatedIntegrationObjectFieldName_Clear = 1,
  @Sequence = @Sequence_ff5b22bb,
  @Configuration = @Configuration_ff5b22bb,
  @Configuration_Clear = 1,
  @Status = @Status_ff5b22bb,
  @IsCustom = @IsCustom_ff5b22bb,
  @ID = @ID_ff5b22bb;

GO

-- Save MJ: Integration Object Fields (core SP call only)
DECLARE @IntegrationObjectID_af534d94 UNIQUEIDENTIFIER,
@Name_af534d94 NVARCHAR(255),
@DisplayName_af534d94 NVARCHAR(255),
@Description_af534d94 NVARCHAR(MAX),
@Category_af534d94 NVARCHAR(100),
@Type_af534d94 NVARCHAR(100),
@Length_af534d94 INT,
@Precision_af534d94 INT,
@Scale_af534d94 INT,
@AllowsNull_af534d94 BIT,
@DefaultValue_af534d94 NVARCHAR(255),
@IsPrimaryKey_af534d94 BIT,
@IsUniqueKey_af534d94 BIT,
@IsReadOnly_af534d94 BIT,
@IsRequired_af534d94 BIT,
@RelatedIntegrationObjectID_af534d94 UNIQUEIDENTIFIER,
@RelatedIntegrationObjectFieldName_af534d94 NVARCHAR(255),
@Sequence_af534d94 INT,
@Configuration_af534d94 NVARCHAR(MAX),
@Status_af534d94 NVARCHAR(25),
@IsCustom_af534d94 BIT,
@ID_af534d94 UNIQUEIDENTIFIER
SET
  @IntegrationObjectID_af534d94 = 'D9CE2F96-8F63-418F-9A46-3E2F60BA3F13'
SET
  @Name_af534d94 = N'CampaignId'
SET
  @DisplayName_af534d94 = N'Campaign Id'
SET
  @Type_af534d94 = N'int'
SET
  @AllowsNull_af534d94 = 0
SET
  @IsPrimaryKey_af534d94 = 0
SET
  @IsUniqueKey_af534d94 = 0
SET
  @IsReadOnly_af534d94 = 1
SET
  @IsRequired_af534d94 = 1
SET
  @Sequence_af534d94 = 8
SET
  @Status_af534d94 = N'Active'
SET
  @IsCustom_af534d94 = 0
SET
  @ID_af534d94 = 'C6CB5E87-F47F-40CF-B084-92391EC27DC9' EXEC [${flyway:defaultSchema}].spUpdateIntegrationObjectField @IntegrationObjectID = @IntegrationObjectID_af534d94,
  @Name = @Name_af534d94,
  @DisplayName = @DisplayName_af534d94,
  @Description = @Description_af534d94,
  @Description_Clear = 1,
  @Category = @Category_af534d94,
  @Category_Clear = 1,
  @Type = @Type_af534d94,
  @Length = @Length_af534d94,
  @Length_Clear = 1,
  @Precision = @Precision_af534d94,
  @Precision_Clear = 1,
  @Scale = @Scale_af534d94,
  @Scale_Clear = 1,
  @AllowsNull = @AllowsNull_af534d94,
  @DefaultValue = @DefaultValue_af534d94,
  @DefaultValue_Clear = 1,
  @IsPrimaryKey = @IsPrimaryKey_af534d94,
  @IsUniqueKey = @IsUniqueKey_af534d94,
  @IsReadOnly = @IsReadOnly_af534d94,
  @IsRequired = @IsRequired_af534d94,
  @RelatedIntegrationObjectID = @RelatedIntegrationObjectID_af534d94,
  @RelatedIntegrationObjectID_Clear = 1,
  @RelatedIntegrationObjectFieldName = @RelatedIntegrationObjectFieldName_af534d94,
  @RelatedIntegrationObjectFieldName_Clear = 1,
  @Sequence = @Sequence_af534d94,
  @Configuration = @Configuration_af534d94,
  @Configuration_Clear = 1,
  @Status = @Status_af534d94,
  @IsCustom = @IsCustom_af534d94,
  @ID = @ID_af534d94;

GO

-- Save MJ: Integration Object Fields (core SP call only)
DECLARE @IntegrationObjectID_bd965ada UNIQUEIDENTIFIER,
@Name_bd965ada NVARCHAR(255),
@DisplayName_bd965ada NVARCHAR(255),
@Description_bd965ada NVARCHAR(MAX),
@Category_bd965ada NVARCHAR(100),
@Type_bd965ada NVARCHAR(100),
@Length_bd965ada INT,
@Precision_bd965ada INT,
@Scale_bd965ada INT,
@AllowsNull_bd965ada BIT,
@DefaultValue_bd965ada NVARCHAR(255),
@IsPrimaryKey_bd965ada BIT,
@IsUniqueKey_bd965ada BIT,
@IsReadOnly_bd965ada BIT,
@IsRequired_bd965ada BIT,
@RelatedIntegrationObjectID_bd965ada UNIQUEIDENTIFIER,
@RelatedIntegrationObjectFieldName_bd965ada NVARCHAR(255),
@Sequence_bd965ada INT,
@Configuration_bd965ada NVARCHAR(MAX),
@Status_bd965ada NVARCHAR(25),
@IsCustom_bd965ada BIT,
@ID_bd965ada UNIQUEIDENTIFIER
SET
  @IntegrationObjectID_bd965ada = 'FD22D0A7-88E6-493F-8A99-399E2B2FCEF2'
SET
  @Name_bd965ada = N'Id'
SET
  @DisplayName_bd965ada = N'Id'
SET
  @Type_bd965ada = N'int'
SET
  @AllowsNull_bd965ada = 0
SET
  @IsPrimaryKey_bd965ada = 1
SET
  @IsUniqueKey_bd965ada = 0
SET
  @IsReadOnly_bd965ada = 1
SET
  @IsRequired_bd965ada = 1
SET
  @Sequence_bd965ada = 1
SET
  @Status_bd965ada = N'Active'
SET
  @IsCustom_bd965ada = 0
SET
  @ID_bd965ada = 'B2581543-9B19-41D9-A56D-774192C94F49' EXEC [${flyway:defaultSchema}].spUpdateIntegrationObjectField @IntegrationObjectID = @IntegrationObjectID_bd965ada,
  @Name = @Name_bd965ada,
  @DisplayName = @DisplayName_bd965ada,
  @Description = @Description_bd965ada,
  @Description_Clear = 1,
  @Category = @Category_bd965ada,
  @Category_Clear = 1,
  @Type = @Type_bd965ada,
  @Length = @Length_bd965ada,
  @Length_Clear = 1,
  @Precision = @Precision_bd965ada,
  @Precision_Clear = 1,
  @Scale = @Scale_bd965ada,
  @Scale_Clear = 1,
  @AllowsNull = @AllowsNull_bd965ada,
  @DefaultValue = @DefaultValue_bd965ada,
  @DefaultValue_Clear = 1,
  @IsPrimaryKey = @IsPrimaryKey_bd965ada,
  @IsUniqueKey = @IsUniqueKey_bd965ada,
  @IsReadOnly = @IsReadOnly_bd965ada,
  @IsRequired = @IsRequired_bd965ada,
  @RelatedIntegrationObjectID = @RelatedIntegrationObjectID_bd965ada,
  @RelatedIntegrationObjectID_Clear = 1,
  @RelatedIntegrationObjectFieldName = @RelatedIntegrationObjectFieldName_bd965ada,
  @RelatedIntegrationObjectFieldName_Clear = 1,
  @Sequence = @Sequence_bd965ada,
  @Configuration = @Configuration_bd965ada,
  @Configuration_Clear = 1,
  @Status = @Status_bd965ada,
  @IsCustom = @IsCustom_bd965ada,
  @ID = @ID_bd965ada;

GO

-- Save MJ: Integration Object Fields (core SP call only)
DECLARE @IntegrationObjectID_cfffa508 UNIQUEIDENTIFIER,
@Name_cfffa508 NVARCHAR(255),
@DisplayName_cfffa508 NVARCHAR(255),
@Description_cfffa508 NVARCHAR(MAX),
@Category_cfffa508 NVARCHAR(100),
@Type_cfffa508 NVARCHAR(100),
@Length_cfffa508 INT,
@Precision_cfffa508 INT,
@Scale_cfffa508 INT,
@AllowsNull_cfffa508 BIT,
@DefaultValue_cfffa508 NVARCHAR(255),
@IsPrimaryKey_cfffa508 BIT,
@IsUniqueKey_cfffa508 BIT,
@IsReadOnly_cfffa508 BIT,
@IsRequired_cfffa508 BIT,
@RelatedIntegrationObjectID_cfffa508 UNIQUEIDENTIFIER,
@RelatedIntegrationObjectFieldName_cfffa508 NVARCHAR(255),
@Sequence_cfffa508 INT,
@Configuration_cfffa508 NVARCHAR(MAX),
@Status_cfffa508 NVARCHAR(25),
@IsCustom_cfffa508 BIT,
@ID_cfffa508 UNIQUEIDENTIFIER
SET
  @IntegrationObjectID_cfffa508 = 'FD22D0A7-88E6-493F-8A99-399E2B2FCEF2'
SET
  @Name_cfffa508 = N'CampaignId'
SET
  @DisplayName_cfffa508 = N'Campaign Id'
SET
  @Type_cfffa508 = N'int'
SET
  @AllowsNull_cfffa508 = 1
SET
  @IsPrimaryKey_cfffa508 = 0
SET
  @IsUniqueKey_cfffa508 = 0
SET
  @IsReadOnly_cfffa508 = 1
SET
  @IsRequired_cfffa508 = 0
SET
  @Sequence_cfffa508 = 10
SET
  @Status_cfffa508 = N'Active'
SET
  @IsCustom_cfffa508 = 0
SET
  @ID_cfffa508 = 'B2581543-9B19-41D9-A56D-774192C94F49' EXEC [${flyway:defaultSchema}].spUpdateIntegrationObjectField @IntegrationObjectID = @IntegrationObjectID_cfffa508,
  @Name = @Name_cfffa508,
  @DisplayName = @DisplayName_cfffa508,
  @Description = @Description_cfffa508,
  @Description_Clear = 1,
  @Category = @Category_cfffa508,
  @Category_Clear = 1,
  @Type = @Type_cfffa508,
  @Length = @Length_cfffa508,
  @Length_Clear = 1,
  @Precision = @Precision_cfffa508,
  @Precision_Clear = 1,
  @Scale = @Scale_cfffa508,
  @Scale_Clear = 1,
  @AllowsNull = @AllowsNull_cfffa508,
  @DefaultValue = @DefaultValue_cfffa508,
  @DefaultValue_Clear = 1,
  @IsPrimaryKey = @IsPrimaryKey_cfffa508,
  @IsUniqueKey = @IsUniqueKey_cfffa508,
  @IsReadOnly = @IsReadOnly_cfffa508,
  @IsRequired = @IsRequired_cfffa508,
  @RelatedIntegrationObjectID = @RelatedIntegrationObjectID_cfffa508,
  @RelatedIntegrationObjectID_Clear = 1,
  @RelatedIntegrationObjectFieldName = @RelatedIntegrationObjectFieldName_cfffa508,
  @RelatedIntegrationObjectFieldName_Clear = 1,
  @Sequence = @Sequence_cfffa508,
  @Configuration = @Configuration_cfffa508,
  @Configuration_Clear = 1,
  @Status = @Status_cfffa508,
  @IsCustom = @IsCustom_cfffa508,
  @ID = @ID_cfffa508;
...
-- Session ID: 34f3cf67-ee0e-44c0-b017-7fd7f0d6b641
-- Completed: 2026-05-06T18:05:48.033Z
-- Duration: 482008ms
-- Total Statements: 45
