...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '4ceda8d2-ce31-43e7-9236-40d4445e818e', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: Search Execution Logs for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('4ceda8d2-ce31-43e7-9236-40d4445e818e', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: Search Execution Logs for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('4ceda8d2-ce31-43e7-9236-40d4445e818e', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: Search Execution Logs for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('4ceda8d2-ce31-43e7-9236-40d4445e818e', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE())
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b0643e1a-d845-45b4-bade-ddcac9dbea63' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'ID')) BEGIN
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '2fed1195-2960-44fb-89e4-1e32b011c2b5' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'SearchScopeID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b5c50946-eff9-4dd5-948b-bb4a860b8ae4' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'UserID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3c19db93-6b2b-4c07-97a3-b21c73acf46e' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'AIAgentID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'cccc2935-1742-41f3-b5ae-f8de8bea75bf' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'Query')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'dd90fe9d-95ac-42d7-b4b5-ff302eef7c6a' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'TotalDurationMs')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'cba37db4-d488-4a92-be09-c5f614d4bf2b' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'ResultCount')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '66dec9b6-e31e-40ff-a8c0-ea763656a434' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'RerankerName')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd3b82b4e-7349-4f6a-aed8-72ed2c0c6d28' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'RerankerCostCents')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '30f1f439-432a-41c7-8d03-3fbb7c922ed2' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'Status')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '991c7288-c1e8-43f4-b72d-c3c68441f4b9' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'FailureReason')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '27dd3cc2-837b-4d8b-89a5-687ec1ff4471' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'ProvidersJSON')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '20b17dad-b04f-4ff1-902e-7108c9cbdc27' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '188a7339-d591-4ec4-b6ca-a875977ac9a1' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert entity field value with ID bda62b6d-b593-47bd-a030-a2ce4c3ed474 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('bda62b6d-b593-47bd-a030-a2ce4c3ed474', '30F1F439-432A-41C7-8D03-3FBB7C922ED2', 1, 'Failure', 'Failure', GETUTCDATE(), GETUTCDATE())

/* SQL text to insert entity field value with ID 2a156ef9-8fb5-4dad-8af7-a45fc364df40 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('2a156ef9-8fb5-4dad-8af7-a45fc364df40', '30F1F439-432A-41C7-8D03-3FBB7C922ED2', 2, 'Forbidden', 'Forbidden', GETUTCDATE(), GETUTCDATE())

/* SQL text to insert entity field value with ID 5b003e6b-0b98-4876-b87b-987b9d3f7f11 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('5b003e6b-0b98-4876-b87b-987b9d3f7f11', '30F1F439-432A-41C7-8D03-3FBB7C922ED2', 3, 'Success', 'Success', GETUTCDATE(), GETUTCDATE())

/* SQL text to update ValueListType for entity field ID 30F1F439-432A-41C7-8D03-3FBB7C922ED2 */
UPDATE [${flyway:defaultSchema}].[EntityField] SET ValueListType='List' WHERE ID='30F1F439-432A-41C7-8D03-3FBB7C922ED2'


/* Create Entity Relationship: MJ: AI Agents -> MJ: Search Execution Logs (One To Many via AIAgentID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '4659f2ca-3351-4f3e-b77f-e6fe520d25c4'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('4659f2ca-3351-4f3e-b77f-e6fe520d25c4', 'CDB135CC-6D3C-480B-90AE-25B7805F82C1', '4CEDA8D2-CE31-43E7-9236-40D4445E818E', 'AIAgentID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;
...
/* Create Entity Relationship: MJ: Users -> MJ: Search Execution Logs (One To Many via UserID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'a6961582-fb9d-4453-b6df-6e9576af585a'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('a6961582-fb9d-4453-b6df-6e9576af585a', 'E1238F34-2837-EF11-86D4-6045BDEE16E6', '4CEDA8D2-CE31-43E7-9236-40D4445E818E', 'UserID', 'One To Many', 1, 1, 2, GETUTCDATE(), GETUTCDATE())
   END;
...
/* Create Entity Relationship: MJ: Search Scopes -> MJ: Search Execution Logs (One To Many via SearchScopeID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '1c63ff71-a025-4ba4-b60e-6afd2a67318a'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('1c63ff71-a025-4ba4-b60e-6afd2a67318a', '73A3EDE8-070F-4CC8-BD5D-C6B654FAE2F6', '4CEDA8D2-CE31-43E7-9236-40D4445E818E', 'SearchScopeID', 'One To Many', 1, 1, 3, GETUTCDATE(), GETUTCDATE())
   END;
...
/* SQL text to update entity field related entity name field map for entity field ID 2FED1195-2960-44FB-89E4-1E32B011C2B5 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='2FED1195-2960-44FB-89E4-1E32B011C2B5', @RelatedEntityNameFieldMap='SearchScope'

/* SQL text to update entity field related entity name field map for entity field ID B5C50946-EFF9-4DD5-948B-BB4A860B8AE4 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='B5C50946-EFF9-4DD5-948B-BB4A860B8AE4', @RelatedEntityNameFieldMap='User'

/* SQL text to update entity field related entity name field map for entity field ID 3C19DB93-6B2B-4C07-97A3-B21C73ACF46E */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='3C19DB93-6B2B-4C07-97A3-B21C73ACF46E', @RelatedEntityNameFieldMap='AIAgent'
...
CREATE PROCEDURE [${flyway:defaultSchema}].[spCreateSearchExecutionLog]
    ...
    @RerankerName nvarchar(100),
    @RerankerCostCents decimal(10, 4),
    @Status nvarchar(20),
...
BEGIN
    ...
    SET
        ...
        [RerankerCostCents] = @RerankerCostCents,
        [Status] = @Status,
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'bbeffe02-f0ab-4dc3-82a7-771a4dc41a95' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'SearchScope')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '09a02147-9a2d-4b5b-aaf9-17efe50ebdaf' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'User')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '26507587-925b-4310-b74a-bb4b42f491ce' OR (EntityID = '4CEDA8D2-CE31-43E7-9236-40D4445E818E' AND Name = 'AIAgent')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
