...
-- -----------------------------------------------------------------------------
-- 3. New ArtifactType records for file-based artifacts
--    ContentCategory = 'File' — overrides the default of 'Text'
-- -----------------------------------------------------------------------------
INSERT INTO ${flyway:defaultSchema}.ArtifactType
    (ID, Name, Description, ContentType, IsEnabled, ContentCategory, DriverClass, Icon)
VALUES
    (
        '95B9A870-76A8-47FF-A44E-06784380490B',
        'PDF',
        'PDF document files generated by agents or uploaded by users.',
        'application/pdf',
        1,
        'File',
        'PdfArtifactViewerPlugin',
        'fa-file-pdf'
    ),
    (
        'E197541F-484B-4462-8160-70993E18CEF6',
        'Excel Spreadsheet',
        'Microsoft Excel spreadsheet files (.xlsx) generated by agents or uploaded by users.',
        'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
        1,
        'File',
        'XlsxArtifactViewerPlugin',
        'fa-file-excel'
    ),
    (
        'CDF6218A-8250-437E-9074-EC1900D093A2',
        'Word Document',
        'Microsoft Word document files (.docx) generated by agents or uploaded by users.',
        'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
        1,
        'File',
        'DocxArtifactViewerPlugin',
        'fa-file-word'
    );
