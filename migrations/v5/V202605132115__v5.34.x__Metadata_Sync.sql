...
DECLARE @ID_15130300 UNIQUEIDENTIFIER,
@Name_15130300 NVARCHAR(200),
@Description_15130300 NVARCHAR(MAX),
@DriverClass_15130300 NVARCHAR(500),
@Status_15130300 NVARCHAR(20),
@Priority_15130300 INT,
@SupportsPreview_15130300 BIT,
@MaxResultsOverride_15130300 INT,
@ProviderConfig_15130300 NVARCHAR(MAX),
@CredentialID_15130300 UNIQUEIDENTIFIER,
@DisplayName_15130300 NVARCHAR(200),
@Icon_15130300 NVARCHAR(200),
@Comments_15130300 NVARCHAR(MAX)
SET
  @ID_15130300 = 'C4F0E7B5-7BA2-4108-8405-1E41E0621065'
SET
  @Name_15130300 = N'Elasticsearch'
SET
  @Description_15130300 = N'External search provider backed by Elasticsearch. Translates the SearchScope template plus permission predicate into Elasticsearch DSL and queries the configured cluster. The optional @elastic/elasticsearch peer dependency must be installed in the host application.'
SET
  @DriverClass_15130300 = N'ElasticsearchSearchProvider'
SET
  @Status_15130300 = N'Active'
SET
  @Priority_15130300 = 10
SET
  @SupportsPreview_15130300 = 1
SET
  @DisplayName_15130300 = N'Elasticsearch'
SET
  @Icon_15130300 = N'fa-solid fa-magnifying-glass-chart'
SET
  @Comments_15130300 = N'Phase 5 external provider. Configure cluster URL, index pattern and auth via SearchScopeProvider.ProviderConfigOverride. Peer dep ''@elastic/elasticsearch'' is loaded on demand.' EXEC [${flyway:defaultSchema}].spCreateSearchProvider @ID = @ID_15130300,
  @Name = @Name_15130300,
  @Description = @Description_15130300,
  @DriverClass = @DriverClass_15130300,
  @Status = @Status_15130300,
  @Priority = @Priority_15130300,
  @SupportsPreview = @SupportsPreview_15130300,
  @MaxResultsOverride = @MaxResultsOverride_15130300,
  @MaxResultsOverride_Clear = 1,
  @ProviderConfig = @ProviderConfig_15130300,
  @ProviderConfig_Clear = 1,
  @CredentialID = @CredentialID_15130300,
  @CredentialID_Clear = 1,
  @DisplayName = @DisplayName_15130300,
  @Icon = @Icon_15130300,
  @Comments = @Comments_15130300;

GO

-- Save MJ: Search Providers (core SP call only)
DECLARE @ID_62baf635 UNIQUEIDENTIFIER,
@Name_62baf635 NVARCHAR(200),
@Description_62baf635 NVARCHAR(MAX),
@DriverClass_62baf635 NVARCHAR(500),
@Status_62baf635 NVARCHAR(20),
@Priority_62baf635 INT,
@SupportsPreview_62baf635 BIT,
@MaxResultsOverride_62baf635 INT,
@ProviderConfig_62baf635 NVARCHAR(MAX),
@CredentialID_62baf635 UNIQUEIDENTIFIER,
@DisplayName_62baf635 NVARCHAR(200),
@Icon_62baf635 NVARCHAR(200),
@Comments_62baf635 NVARCHAR(MAX)
SET
  @ID_62baf635 = '471B7C3E-ABDF-430F-B87B-647252DCA046'
SET
  @Name_62baf635 = N'Typesense'
SET
  @Description_62baf635 = N'External search provider backed by Typesense. Maps SearchScope templates onto Typesense''s typed-collection query API and pushes the permission predicate into the filter_by clause.'
SET
  @DriverClass_62baf635 = N'TypesenseSearchProvider'
SET
  @Status_62baf635 = N'Active'
SET
  @Priority_62baf635 = 11
SET
  @SupportsPreview_62baf635 = 1
SET
  @DisplayName_62baf635 = N'Typesense'
SET
  @Icon_62baf635 = N'fa-solid fa-bolt'
SET
  @Comments_62baf635 = N'Phase 5 external provider. Peer dep ''typesense'' loaded on demand. Configure host, port, protocol and API key via ProviderConfigOverride.' EXEC [${flyway:defaultSchema}].spCreateSearchProvider @ID = @ID_62baf635,
  @Name = @Name_62baf635,
  @Description = @Description_62baf635,
  @DriverClass = @DriverClass_62baf635,
  @Status = @Status_62baf635,
  @Priority = @Priority_62baf635,
  @SupportsPreview = @SupportsPreview_62baf635,
  @MaxResultsOverride = @MaxResultsOverride_62baf635,
  @MaxResultsOverride_Clear = 1,
  @ProviderConfig = @ProviderConfig_62baf635,
  @ProviderConfig_Clear = 1,
  @CredentialID = @CredentialID_62baf635,
  @CredentialID_Clear = 1,
  @DisplayName = @DisplayName_62baf635,
  @Icon = @Icon_62baf635,
  @Comments = @Comments_62baf635;

GO

-- Save MJ: Search Providers (core SP call only)
DECLARE @ID_ff45a0cd UNIQUEIDENTIFIER,
@Name_ff45a0cd NVARCHAR(200),
@Description_ff45a0cd NVARCHAR(MAX),
@DriverClass_ff45a0cd NVARCHAR(500),
@Status_ff45a0cd NVARCHAR(20),
@Priority_ff45a0cd INT,
@SupportsPreview_ff45a0cd BIT,
@MaxResultsOverride_ff45a0cd INT,
@ProviderConfig_ff45a0cd NVARCHAR(MAX),
@CredentialID_ff45a0cd UNIQUEIDENTIFIER,
@DisplayName_ff45a0cd NVARCHAR(200),
@Icon_ff45a0cd NVARCHAR(200),
@Comments_ff45a0cd NVARCHAR(MAX)
SET
  @ID_ff45a0cd = '4ACDB8D2-485B-49D9-B717-BAF5CFD09667'
SET
  @Name_ff45a0cd = N'Azure AI Search'
SET
  @Description_ff45a0cd = N'External search provider backed by Azure AI Search (formerly Azure Cognitive Search). Supports vector, semantic and hybrid queries against an Azure-managed index.'
SET
  @DriverClass_ff45a0cd = N'AzureAISearchProvider'
SET
  @Status_ff45a0cd = N'Active'
SET
  @Priority_ff45a0cd = 12
SET
  @SupportsPreview_ff45a0cd = 1
SET
  @DisplayName_ff45a0cd = N'Azure AI Search'
SET
  @Icon_ff45a0cd = N'fa-brands fa-microsoft'
SET
  @Comments_ff45a0cd = N'Phase 5 external provider. Peer dep ''@azure/search-documents'' loaded on demand. Configure endpoint, indexName and apiKey via ProviderConfigOverride.' EXEC [${flyway:defaultSchema}].spCreateSearchProvider @ID = @ID_ff45a0cd,
  @Name = @Name_ff45a0cd,
  @Description = @Description_ff45a0cd,
  @DriverClass = @DriverClass_ff45a0cd,
  @Status = @Status_ff45a0cd,
  @Priority = @Priority_ff45a0cd,
  @SupportsPreview = @SupportsPreview_ff45a0cd,
  @MaxResultsOverride = @MaxResultsOverride_ff45a0cd,
  @MaxResultsOverride_Clear = 1,
  @ProviderConfig = @ProviderConfig_ff45a0cd,
  @ProviderConfig_Clear = 1,
  @CredentialID = @CredentialID_ff45a0cd,
  @CredentialID_Clear = 1,
  @DisplayName = @DisplayName_ff45a0cd,
  @Icon = @Icon_ff45a0cd,
  @Comments = @Comments_ff45a0cd;

GO

-- Save MJ: Search Providers (core SP call only)
DECLARE @ID_ebfa0506 UNIQUEIDENTIFIER,
@Name_ebfa0506 NVARCHAR(200),
@Description_ebfa0506 NVARCHAR(MAX),
@DriverClass_ebfa0506 NVARCHAR(500),
@Status_ebfa0506 NVARCHAR(20),
@Priority_ebfa0506 INT,
@SupportsPreview_ebfa0506 BIT,
@MaxResultsOverride_ebfa0506 INT,
@ProviderConfig_ebfa0506 NVARCHAR(MAX),
@CredentialID_ebfa0506 UNIQUEIDENTIFIER,
@DisplayName_ebfa0506 NVARCHAR(200),
@Icon_ebfa0506 NVARCHAR(200),
@Comments_ebfa0506 NVARCHAR(MAX)
SET
  @ID_ebfa0506 = '65F3F0CF-53E4-4415-A8D1-BB9DD724F458'
SET
  @Name_ebfa0506 = N'OpenSearch'
SET
  @Description_ebfa0506 = N'External search provider backed by OpenSearch (the AWS-supported Elasticsearch fork). Wire-compatible with Elasticsearch 7.10 but uses the @opensearch-project/opensearch client.'
SET
  @DriverClass_ebfa0506 = N'OpenSearchSearchProvider'
SET
  @Status_ebfa0506 = N'Active'
SET
  @Priority_ebfa0506 = 13
SET
  @SupportsPreview_ebfa0506 = 1
SET
  @DisplayName_ebfa0506 = N'OpenSearch'
SET
  @Icon_ebfa0506 = N'fa-solid fa-magnifying-glass-arrow-right'
SET
  @Comments_ebfa0506 = N'Phase 5 external provider. Peer dep ''@opensearch-project/opensearch'' loaded on demand. Configure node URL, index pattern and auth via ProviderConfigOverride.' EXEC [${flyway:defaultSchema}].spCreateSearchProvider @ID = @ID_ebfa0506,
  @Name = @Name_ebfa0506,
  @Description = @Description_ebfa0506,
  @DriverClass = @DriverClass_ebfa0506,
  @Status = @Status_ebfa0506,
  @Priority = @Priority_ebfa0506,
  @SupportsPreview = @SupportsPreview_ebfa0506,
  @MaxResultsOverride = @MaxResultsOverride_ebfa0506,
  @MaxResultsOverride_Clear = 1,
  @ProviderConfig = @ProviderConfig_ebfa0506,
  @ProviderConfig_Clear = 1,
  @CredentialID = @CredentialID_ebfa0506,
  @CredentialID_Clear = 1,
  @DisplayName = @DisplayName_ebfa0506,
  @Icon = @Icon_ebfa0506,
  @Comments = @Comments_ebfa0506;

GO

-- Save MJ: Search Scopes (core SP call only)
DECLARE @ID_b592c68a UNIQUEIDENTIFIER,
@Name_b592c68a NVARCHAR(200),
@Description_b592c68a NVARCHAR(MAX),
@Icon_b592c68a NVARCHAR(200),
@IsGlobal_b592c68a BIT,
@IsDefault_b592c68a BIT,
@OwnerUserID_b592c68a UNIQUEIDENTIFIER,
@Status_b592c68a NVARCHAR(20),
@StartAt_b592c68a DATETIMEOFFSET,
@EndAt_b592c68a DATETIMEOFFSET,
@ScopeConfig_b592c68a NVARCHAR(MAX),
@SearchContextConfig_b592c68a NVARCHAR(MAX),
@RerankerBudgetCents_b592c68a INT
SET
  @ID_b592c68a = '75EE4F64-B784-402B-B6A0-041A3134ED8D'
SET
  @Name_b592c68a = N'Global'
SET
  @Description_b592c68a = N'Built-in global search scope. Includes every configured provider, external index, entity, and storage account with no filtering. This is the default scope used when no specific scope is requested, preserving the original (pre-scope) search behavior.'
SET
  @Icon_b592c68a = N'fa-solid fa-globe'
SET
  @IsGlobal_b592c68a = 1
SET
  @IsDefault_b592c68a = 1
SET
  @Status_b592c68a = N'Active' EXEC [${flyway:defaultSchema}].spCreateSearchScope @ID = @ID_b592c68a,
  @Name = @Name_b592c68a,
  @Description = @Description_b592c68a,
  @Icon = @Icon_b592c68a,
  @IsGlobal = @IsGlobal_b592c68a,
  @IsDefault = @IsDefault_b592c68a,
  @OwnerUserID = @OwnerUserID_b592c68a,
  @OwnerUserID_Clear = 1,
  @Status = @Status_b592c68a,
  @StartAt = @StartAt_b592c68a,
  @StartAt_Clear = 1,
  @EndAt = @EndAt_b592c68a,
  @EndAt_Clear = 1,
  @ScopeConfig = @ScopeConfig_b592c68a,
  @ScopeConfig_Clear = 1,
  @SearchContextConfig = @SearchContextConfig_b592c68a,
  @SearchContextConfig_Clear = 1,
  @RerankerBudgetCents = @RerankerBudgetCents_b592c68a,
  @RerankerBudgetCents_Clear = 1;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_45c9532b UNIQUEIDENTIFIER,
@Name_45c9532b NVARCHAR(50),
@Description_45c9532b NVARCHAR(MAX),
@AIModelTypeID_45c9532b UNIQUEIDENTIFIER,
@PowerRank_45c9532b INT,
@IsActive_45c9532b BIT,
@SpeedRank_45c9532b INT,
@CostRank_45c9532b INT,
@ModelSelectionInsights_45c9532b NVARCHAR(MAX),
@InheritTypeModalities_45c9532b BIT,
@PriorVersionID_45c9532b UNIQUEIDENTIFIER,
@SupportsPrefill_45c9532b BIT,
@PrefillFallbackText_45c9532b NVARCHAR(MAX)
SET
  @ID_45c9532b = '562ba6f2-9d4c-4cbf-8865-4a97eea0f14c'
SET
  @Name_45c9532b = N'GPT Realtime 2'
SET
  @Description_45c9532b = N'OpenAI''s second-generation speech-to-speech voice model (May 7, 2026). GPT-5-class reasoning surfaced through the audio modality with five reasoning effort levels (minimal/low/medium/high/xhigh, default low), parallel tool calls, spoken preambles, and recovery on failed tasks. 128K token context (4x the predecessor). Multi-channel pricing: $32/M audio input ($0.40 cached), $64/M audio output, $4/M text input, $24/M text output, $5/M image input.'
SET
  @AIModelTypeID_45c9532b = '5F75433E-F36B-1410-8D99-00021F8B792E'
SET
  @PowerRank_45c9532b = 11
SET
  @IsActive_45c9532b = 1
SET
  @SpeedRank_45c9532b = 8
SET
  @CostRank_45c9532b = 8
SET
  @InheritTypeModalities_45c9532b = 1
EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_45c9532b,
  @Name = @Name_45c9532b,
  @Description = @Description_45c9532b,
  @AIModelTypeID = @AIModelTypeID_45c9532b,
  @PowerRank = @PowerRank_45c9532b,
  @IsActive = @IsActive_45c9532b,
  @SpeedRank = @SpeedRank_45c9532b,
  @CostRank = @CostRank_45c9532b,
  @ModelSelectionInsights = @ModelSelectionInsights_45c9532b,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_45c9532b,
  @PriorVersionID = @PriorVersionID_45c9532b,
  @PriorVersionID_Clear = 1,
  @SupportsPrefill = @SupportsPrefill_45c9532b,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_45c9532b,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_b690f030 UNIQUEIDENTIFIER,
@ModelID_b690f030 UNIQUEIDENTIFIER,
@VendorID_b690f030 UNIQUEIDENTIFIER,
@Priority_b690f030 INT,
@Status_b690f030 NVARCHAR(20),
@DriverClass_b690f030 NVARCHAR(100),
@DriverImportPath_b690f030 NVARCHAR(255),
@APIName_b690f030 NVARCHAR(100),
@MaxInputTokens_b690f030 INT,
@MaxOutputTokens_b690f030 INT,
@SupportedResponseFormats_b690f030 NVARCHAR(100),
@SupportsEffortLevel_b690f030 BIT,
@SupportsStreaming_b690f030 BIT,
@TypeID_b690f030 UNIQUEIDENTIFIER,
@SupportsPrefill_b690f030 BIT,
@PrefillFallbackText_b690f030 NVARCHAR(MAX)
SET
  @ID_b690f030 = '16f82723-121f-4cfd-92ba-1ad0bfa45a93'
SET
  @ModelID_b690f030 = '562BA6F2-9D4C-4CBF-8865-4A97EEA0F14C'
SET
  @VendorID_b690f030 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_b690f030 = 0
SET
  @Status_b690f030 = N'Active'
SET
  @SupportedResponseFormats_b690f030 = N'Any'
SET
  @SupportsEffortLevel_b690f030 = 1
SET
  @SupportsStreaming_b690f030 = 1
SET
  @TypeID_b690f030 = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_b690f030,
  @ModelID = @ModelID_b690f030,
  @VendorID = @VendorID_b690f030,
  @Priority = @Priority_b690f030,
  @Status = @Status_b690f030,
  @DriverClass = @DriverClass_b690f030,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_b690f030,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_b690f030,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_b690f030,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_b690f030,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_b690f030,
  @SupportsEffortLevel = @SupportsEffortLevel_b690f030,
  @SupportsStreaming = @SupportsStreaming_b690f030,
  @TypeID = @TypeID_b690f030,
  @SupportsPrefill = @SupportsPrefill_b690f030,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_b690f030,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_cb19f778 UNIQUEIDENTIFIER,
@ModelID_cb19f778 UNIQUEIDENTIFIER,
@VendorID_cb19f778 UNIQUEIDENTIFIER,
@Priority_cb19f778 INT,
@Status_cb19f778 NVARCHAR(20),
@DriverClass_cb19f778 NVARCHAR(100),
@DriverImportPath_cb19f778 NVARCHAR(255),
@APIName_cb19f778 NVARCHAR(100),
@MaxInputTokens_cb19f778 INT,
@MaxOutputTokens_cb19f778 INT,
@SupportedResponseFormats_cb19f778 NVARCHAR(100),
@SupportsEffortLevel_cb19f778 BIT,
@SupportsStreaming_cb19f778 BIT,
@TypeID_cb19f778 UNIQUEIDENTIFIER,
@SupportsPrefill_cb19f778 BIT,
@PrefillFallbackText_cb19f778 NVARCHAR(MAX)
SET
  @ID_cb19f778 = '3393668b-a813-437e-a753-2c01bfc39c01'
SET
  @ModelID_cb19f778 = '562BA6F2-9D4C-4CBF-8865-4A97EEA0F14C'
SET
  @VendorID_cb19f778 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_cb19f778 = 1
SET
  @Status_cb19f778 = N'Active'
SET
  @DriverClass_cb19f778 = N'OpenAIRealtime'
SET
  @APIName_cb19f778 = N'gpt-realtime-2'
SET
  @MaxInputTokens_cb19f778 = 128000
SET
  @SupportedResponseFormats_cb19f778 = N'Any'
SET
  @SupportsEffortLevel_cb19f778 = 1
SET
  @SupportsStreaming_cb19f778 = 1
SET
  @TypeID_cb19f778 = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_cb19f778,
  @ModelID = @ModelID_cb19f778,
  @VendorID = @VendorID_cb19f778,
  @Priority = @Priority_cb19f778,
  @Status = @Status_cb19f778,
  @DriverClass = @DriverClass_cb19f778,
  @DriverImportPath = @DriverImportPath_cb19f778,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_cb19f778,
  @MaxInputTokens = @MaxInputTokens_cb19f778,
  @MaxOutputTokens = @MaxOutputTokens_cb19f778,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_cb19f778,
  @SupportsEffortLevel = @SupportsEffortLevel_cb19f778,
  @SupportsStreaming = @SupportsStreaming_cb19f778,
  @TypeID = @TypeID_cb19f778,
  @SupportsPrefill = @SupportsPrefill_cb19f778,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_cb19f778,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_9e68c2cb UNIQUEIDENTIFIER,
@Name_9e68c2cb NVARCHAR(50),
@Description_9e68c2cb NVARCHAR(MAX),
@AIModelTypeID_9e68c2cb UNIQUEIDENTIFIER,
@PowerRank_9e68c2cb INT,
@IsActive_9e68c2cb BIT,
@SpeedRank_9e68c2cb INT,
@CostRank_9e68c2cb INT,
@ModelSelectionInsights_9e68c2cb NVARCHAR(MAX),
@InheritTypeModalities_9e68c2cb BIT,
@PriorVersionID_9e68c2cb UNIQUEIDENTIFIER,
@SupportsPrefill_9e68c2cb BIT,
@PrefillFallbackText_9e68c2cb NVARCHAR(MAX)
SET
  @ID_9e68c2cb = 'f2a7d6be-c96b-453e-b330-1d56e5e05aad'
SET
  @Name_9e68c2cb = N'GPT Image 2'
SET
  @Description_9e68c2cb = N'OpenAI''s state-of-the-art image generation and editing model (April 2026). Generates at 1K, 2K, and 4K resolution, accepts up to 16 reference images, and renders multilingual text (including Chinese, Japanese, Korean) inside images with near-perfect accuracy. Pricing is token-based: $5/M text input, $8/M image input, $30/M image output tokens. Claimed #1 on Image Arena leaderboard at launch by a +242 point margin.'
SET
  @AIModelTypeID_9e68c2cb = 'E9A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_9e68c2cb = 19
SET
  @IsActive_9e68c2cb = 1
SET
  @SpeedRank_9e68c2cb = 7
SET
  @CostRank_9e68c2cb = 8
SET
  @InheritTypeModalities_9e68c2cb = 1
SET
  @PriorVersionID_9e68c2cb = '4B9F8E72-1C5D-4A3E-B6F8-9D2E4A7C3B1A' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_9e68c2cb,
  @Name = @Name_9e68c2cb,
  @Description = @Description_9e68c2cb,
  @AIModelTypeID = @AIModelTypeID_9e68c2cb,
  @PowerRank = @PowerRank_9e68c2cb,
  @IsActive = @IsActive_9e68c2cb,
  @SpeedRank = @SpeedRank_9e68c2cb,
  @CostRank = @CostRank_9e68c2cb,
  @ModelSelectionInsights = @ModelSelectionInsights_9e68c2cb,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_9e68c2cb,
  @PriorVersionID = @PriorVersionID_9e68c2cb,
  @SupportsPrefill = @SupportsPrefill_9e68c2cb,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_9e68c2cb,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_7b2ab696 UNIQUEIDENTIFIER,
@ModelID_7b2ab696 UNIQUEIDENTIFIER,
@VendorID_7b2ab696 UNIQUEIDENTIFIER,
@StartedAt_7b2ab696 DATETIMEOFFSET,
@EndedAt_7b2ab696 DATETIMEOFFSET,
@Status_7b2ab696 NVARCHAR(20),
@Currency_7b2ab696 NCHAR(3),
@PriceTypeID_7b2ab696 UNIQUEIDENTIFIER,
@InputPricePerUnit_7b2ab696 DECIMAL(18, 8),
@OutputPricePerUnit_7b2ab696 DECIMAL(18, 8),
@UnitTypeID_7b2ab696 UNIQUEIDENTIFIER,
@ProcessingType_7b2ab696 NVARCHAR(20),
@Comments_7b2ab696 NVARCHAR(MAX)
SET
  @ID_7b2ab696 = 'b98be63a-4f29-449e-97ff-36b4e1b342b1'
SET
  @ModelID_7b2ab696 = '562BA6F2-9D4C-4CBF-8865-4A97EEA0F14C'
SET
  @VendorID_7b2ab696 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @StartedAt_7b2ab696 = '2026-05-07T00:00:00.000Z'
SET
  @Status_7b2ab696 = N'Active'
SET
  @Currency_7b2ab696 = N'USD'
SET
  @PriceTypeID_7b2ab696 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_7b2ab696 = 4
SET
  @OutputPricePerUnit_7b2ab696 = 24
SET
  @UnitTypeID_7b2ab696 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_7b2ab696 = N'Realtime'
SET
  @Comments_7b2ab696 = N'GPT-Realtime-2 has multi-channel token pricing — the rates here ($4 input / $24 output per 1M) cover the TEXT channel only. Audio channels: $32/M audio input ($0.40 cached), $64/M audio output. Image input: $5/M. Released May 7, 2026 alongside GPT-Realtime-Translate and GPT-Realtime-Whisper (both minute-billed and flagged for human review pending Per-Minute PriceUnitType + Speech-to-Text AIModelType additions to MJ schema).' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_7b2ab696,
  @ModelID = @ModelID_7b2ab696,
  @VendorID = @VendorID_7b2ab696,
  @StartedAt = @StartedAt_7b2ab696,
  @EndedAt = @EndedAt_7b2ab696,
  @EndedAt_Clear = 1,
  @Status = @Status_7b2ab696,
  @Currency = @Currency_7b2ab696,
  @PriceTypeID = @PriceTypeID_7b2ab696,
  @InputPricePerUnit = @InputPricePerUnit_7b2ab696,
  @OutputPricePerUnit = @OutputPricePerUnit_7b2ab696,
  @UnitTypeID = @UnitTypeID_7b2ab696,
  @ProcessingType = @ProcessingType_7b2ab696,
  @Comments = @Comments_7b2ab696;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_1cf94976 UNIQUEIDENTIFIER,
@Name_1cf94976 NVARCHAR(50),
@Description_1cf94976 NVARCHAR(MAX),
@AIModelTypeID_1cf94976 UNIQUEIDENTIFIER,
@PowerRank_1cf94976 INT,
@IsActive_1cf94976 BIT,
@SpeedRank_1cf94976 INT,
@CostRank_1cf94976 INT,
@ModelSelectionInsights_1cf94976 NVARCHAR(MAX),
@InheritTypeModalities_1cf94976 BIT,
@PriorVersionID_1cf94976 UNIQUEIDENTIFIER,
@SupportsPrefill_1cf94976 BIT,
@PrefillFallbackText_1cf94976 NVARCHAR(MAX)
SET
  @ID_1cf94976 = 'c2fa8aa2-126a-4a0e-88d8-64b938ec815a'
SET
  @Name_1cf94976 = N'Mistral Medium 3.5'
SET
  @Description_1cf94976 = N'Mistral AI''s mid-tier model (May 1, 2026, public preview). 128B dense, open-weights under modified MIT license. 256K context. Unified instruction-following, reasoning, and coding capability. Vision input. Function calling, agents, conversation, structured outputs. Configurable reasoning effort. Powers Mistral remote coding agents and Work mode features. Available through Mistral API, NVIDIA endpoints, and self-hosting.'
SET
  @AIModelTypeID_1cf94976 = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_1cf94976 = 13
SET
  @IsActive_1cf94976 = 1
SET
  @SpeedRank_1cf94976 = 7
SET
  @CostRank_1cf94976 = 7
SET
  @InheritTypeModalities_1cf94976 = 1
SET
  @PriorVersionID_1cf94976 = 'A4704E68-B852-461D-9EBF-889164EB899C' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_1cf94976,
  @Name = @Name_1cf94976,
  @Description = @Description_1cf94976,
  @AIModelTypeID = @AIModelTypeID_1cf94976,
  @PowerRank = @PowerRank_1cf94976,
  @IsActive = @IsActive_1cf94976,
  @SpeedRank = @SpeedRank_1cf94976,
  @CostRank = @CostRank_1cf94976,
  @ModelSelectionInsights = @ModelSelectionInsights_1cf94976,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_1cf94976,
  @PriorVersionID = @PriorVersionID_1cf94976,
  @SupportsPrefill = @SupportsPrefill_1cf94976,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_1cf94976,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_bb226e3a UNIQUEIDENTIFIER,
@ModelID_bb226e3a UNIQUEIDENTIFIER,
@VendorID_bb226e3a UNIQUEIDENTIFIER,
@Priority_bb226e3a INT,
@Status_bb226e3a NVARCHAR(20),
@DriverClass_bb226e3a NVARCHAR(100),
@DriverImportPath_bb226e3a NVARCHAR(255),
@APIName_bb226e3a NVARCHAR(100),
@MaxInputTokens_bb226e3a INT,
@MaxOutputTokens_bb226e3a INT,
@SupportedResponseFormats_bb226e3a NVARCHAR(100),
@SupportsEffortLevel_bb226e3a BIT,
@SupportsStreaming_bb226e3a BIT,
@TypeID_bb226e3a UNIQUEIDENTIFIER,
@SupportsPrefill_bb226e3a BIT,
@PrefillFallbackText_bb226e3a NVARCHAR(MAX)
SET
  @ID_bb226e3a = '54805631-265a-46c7-b97e-bcffa7c25e38'
SET
  @ModelID_bb226e3a = 'F2A7D6BE-C96B-453E-B330-1D56E5E05AAD'
SET
  @VendorID_bb226e3a = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_bb226e3a = 0
SET
  @Status_bb226e3a = N'Active'
SET
  @SupportedResponseFormats_bb226e3a = N'Any'
SET
  @SupportsEffortLevel_bb226e3a = 0
SET
  @SupportsStreaming_bb226e3a = 0
SET
  @TypeID_bb226e3a = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_bb226e3a,
  @ModelID = @ModelID_bb226e3a,
  @VendorID = @VendorID_bb226e3a,
  @Priority = @Priority_bb226e3a,
  @Status = @Status_bb226e3a,
  @DriverClass = @DriverClass_bb226e3a,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_bb226e3a,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_bb226e3a,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_bb226e3a,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_bb226e3a,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_bb226e3a,
  @SupportsEffortLevel = @SupportsEffortLevel_bb226e3a,
  @SupportsStreaming = @SupportsStreaming_bb226e3a,
  @TypeID = @TypeID_bb226e3a,
  @SupportsPrefill = @SupportsPrefill_bb226e3a,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_bb226e3a,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_658204ea UNIQUEIDENTIFIER,
@ModelID_658204ea UNIQUEIDENTIFIER,
@VendorID_658204ea UNIQUEIDENTIFIER,
@Priority_658204ea INT,
@Status_658204ea NVARCHAR(20),
@DriverClass_658204ea NVARCHAR(100),
@DriverImportPath_658204ea NVARCHAR(255),
@APIName_658204ea NVARCHAR(100),
@MaxInputTokens_658204ea INT,
@MaxOutputTokens_658204ea INT,
@SupportedResponseFormats_658204ea NVARCHAR(100),
@SupportsEffortLevel_658204ea BIT,
@SupportsStreaming_658204ea BIT,
@TypeID_658204ea UNIQUEIDENTIFIER,
@SupportsPrefill_658204ea BIT,
@PrefillFallbackText_658204ea NVARCHAR(MAX)
SET
  @ID_658204ea = 'beac44c0-808c-4d59-b9b3-0a2afb4e2c52'
SET
  @ModelID_658204ea = 'F2A7D6BE-C96B-453E-B330-1D56E5E05AAD'
SET
  @VendorID_658204ea = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_658204ea = 1
SET
  @Status_658204ea = N'Active'
SET
  @DriverClass_658204ea = N'OpenAIImageGenerator'
SET
  @APIName_658204ea = N'gpt-image-2'
SET
  @MaxInputTokens_658204ea = 10000
SET
  @SupportedResponseFormats_658204ea = N'Any'
SET
  @SupportsEffortLevel_658204ea = 0
SET
  @SupportsStreaming_658204ea = 0
SET
  @TypeID_658204ea = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_658204ea,
  @ModelID = @ModelID_658204ea,
  @VendorID = @VendorID_658204ea,
  @Priority = @Priority_658204ea,
  @Status = @Status_658204ea,
  @DriverClass = @DriverClass_658204ea,
  @DriverImportPath = @DriverImportPath_658204ea,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_658204ea,
  @MaxInputTokens = @MaxInputTokens_658204ea,
  @MaxOutputTokens = @MaxOutputTokens_658204ea,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_658204ea,
  @SupportsEffortLevel = @SupportsEffortLevel_658204ea,
  @SupportsStreaming = @SupportsStreaming_658204ea,
  @TypeID = @TypeID_658204ea,
  @SupportsPrefill = @SupportsPrefill_658204ea,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_658204ea,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_02e5a259 UNIQUEIDENTIFIER,
@ModelID_02e5a259 UNIQUEIDENTIFIER,
@VendorID_02e5a259 UNIQUEIDENTIFIER,
@Priority_02e5a259 INT,
@Status_02e5a259 NVARCHAR(20),
@DriverClass_02e5a259 NVARCHAR(100),
@DriverImportPath_02e5a259 NVARCHAR(255),
@APIName_02e5a259 NVARCHAR(100),
@MaxInputTokens_02e5a259 INT,
@MaxOutputTokens_02e5a259 INT,
@SupportedResponseFormats_02e5a259 NVARCHAR(100),
@SupportsEffortLevel_02e5a259 BIT,
@SupportsStreaming_02e5a259 BIT,
@TypeID_02e5a259 UNIQUEIDENTIFIER,
@SupportsPrefill_02e5a259 BIT,
@PrefillFallbackText_02e5a259 NVARCHAR(MAX)
SET
  @ID_02e5a259 = '38f1d214-79cb-49af-8445-4860b9227846'
SET
  @ModelID_02e5a259 = 'C2FA8AA2-126A-4A0E-88D8-64B938EC815A'
SET
  @VendorID_02e5a259 = 'DBA5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_02e5a259 = 0
SET
  @Status_02e5a259 = N'Active'
SET
  @SupportedResponseFormats_02e5a259 = N'Any'
SET
  @SupportsEffortLevel_02e5a259 = 1
SET
  @SupportsStreaming_02e5a259 = 0
SET
  @TypeID_02e5a259 = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_02e5a259,
  @ModelID = @ModelID_02e5a259,
  @VendorID = @VendorID_02e5a259,
  @Priority = @Priority_02e5a259,
  @Status = @Status_02e5a259,
  @DriverClass = @DriverClass_02e5a259,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_02e5a259,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_02e5a259,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_02e5a259,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_02e5a259,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_02e5a259,
  @SupportsEffortLevel = @SupportsEffortLevel_02e5a259,
  @SupportsStreaming = @SupportsStreaming_02e5a259,
  @TypeID = @TypeID_02e5a259,
  @SupportsPrefill = @SupportsPrefill_02e5a259,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_02e5a259,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_87ae0b10 UNIQUEIDENTIFIER,
@ModelID_87ae0b10 UNIQUEIDENTIFIER,
@VendorID_87ae0b10 UNIQUEIDENTIFIER,
@Priority_87ae0b10 INT,
@Status_87ae0b10 NVARCHAR(20),
@DriverClass_87ae0b10 NVARCHAR(100),
@DriverImportPath_87ae0b10 NVARCHAR(255),
@APIName_87ae0b10 NVARCHAR(100),
@MaxInputTokens_87ae0b10 INT,
@MaxOutputTokens_87ae0b10 INT,
@SupportedResponseFormats_87ae0b10 NVARCHAR(100),
@SupportsEffortLevel_87ae0b10 BIT,
@SupportsStreaming_87ae0b10 BIT,
@TypeID_87ae0b10 UNIQUEIDENTIFIER,
@SupportsPrefill_87ae0b10 BIT,
@PrefillFallbackText_87ae0b10 NVARCHAR(MAX)
SET
  @ID_87ae0b10 = '15a40998-1969-4f21-b4c0-a720ccd7ce41'
SET
  @ModelID_87ae0b10 = 'C2FA8AA2-126A-4A0E-88D8-64B938EC815A'
SET
  @VendorID_87ae0b10 = 'DBA5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_87ae0b10 = 1
SET
  @Status_87ae0b10 = N'Active'
SET
  @DriverClass_87ae0b10 = N'MistralLLM'
SET
  @APIName_87ae0b10 = N'mistral-medium-3.5'
SET
  @MaxInputTokens_87ae0b10 = 256000
SET
  @SupportedResponseFormats_87ae0b10 = N'Any, JSON'
SET
  @SupportsEffortLevel_87ae0b10 = 1
SET
  @SupportsStreaming_87ae0b10 = 1
SET
  @TypeID_87ae0b10 = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_87ae0b10,
  @ModelID = @ModelID_87ae0b10,
  @VendorID = @VendorID_87ae0b10,
  @Priority = @Priority_87ae0b10,
  @Status = @Status_87ae0b10,
  @DriverClass = @DriverClass_87ae0b10,
  @DriverImportPath = @DriverImportPath_87ae0b10,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_87ae0b10,
  @MaxInputTokens = @MaxInputTokens_87ae0b10,
  @MaxOutputTokens = @MaxOutputTokens_87ae0b10,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_87ae0b10,
  @SupportsEffortLevel = @SupportsEffortLevel_87ae0b10,
  @SupportsStreaming = @SupportsStreaming_87ae0b10,
  @TypeID = @TypeID_87ae0b10,
  @SupportsPrefill = @SupportsPrefill_87ae0b10,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_87ae0b10,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_7469a619 UNIQUEIDENTIFIER,
@ModelID_7469a619 UNIQUEIDENTIFIER,
@VendorID_7469a619 UNIQUEIDENTIFIER,
@StartedAt_7469a619 DATETIMEOFFSET,
@EndedAt_7469a619 DATETIMEOFFSET,
@Status_7469a619 NVARCHAR(20),
@Currency_7469a619 NCHAR(3),
@PriceTypeID_7469a619 UNIQUEIDENTIFIER,
@InputPricePerUnit_7469a619 DECIMAL(18, 8),
@OutputPricePerUnit_7469a619 DECIMAL(18, 8),
@UnitTypeID_7469a619 UNIQUEIDENTIFIER,
@ProcessingType_7469a619 NVARCHAR(20),
@Comments_7469a619 NVARCHAR(MAX)
SET
  @ID_7469a619 = '501719ea-06ac-42aa-9090-bada50495140'
SET
  @ModelID_7469a619 = 'C2FA8AA2-126A-4A0E-88D8-64B938EC815A'
SET
  @VendorID_7469a619 = 'DBA5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @StartedAt_7469a619 = '2026-05-01T00:00:00.000Z'
SET
  @Status_7469a619 = N'Active'
SET
  @Currency_7469a619 = N'USD'
SET
  @PriceTypeID_7469a619 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_7469a619 = 1.5
SET
  @OutputPricePerUnit_7469a619 = 7.5
SET
  @UnitTypeID_7469a619 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_7469a619 = N'Realtime'
SET
  @Comments_7469a619 = N'Mistral Medium 3.5 pricing on Mistral direct API as of May 2026: $1.50/M input, $7.50/M output. Released May 1, 2026 as a public preview. Sibling of Mistral Medium 3.1 (already in inventory) — this is the new release, not a replacement.' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_7469a619,
  @ModelID = @ModelID_7469a619,
  @VendorID = @VendorID_7469a619,
  @StartedAt = @StartedAt_7469a619,
  @EndedAt = @EndedAt_7469a619,
  @EndedAt_Clear = 1,
  @Status = @Status_7469a619,
  @Currency = @Currency_7469a619,
  @PriceTypeID = @PriceTypeID_7469a619,
  @InputPricePerUnit = @InputPricePerUnit_7469a619,
  @OutputPricePerUnit = @OutputPricePerUnit_7469a619,
  @UnitTypeID = @UnitTypeID_7469a619,
  @ProcessingType = @ProcessingType_7469a619,
  @Comments = @Comments_7469a619;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_c0378226 UNIQUEIDENTIFIER,
@ModelID_c0378226 UNIQUEIDENTIFIER,
@VendorID_c0378226 UNIQUEIDENTIFIER,
@StartedAt_c0378226 DATETIMEOFFSET,
@EndedAt_c0378226 DATETIMEOFFSET,
@Status_c0378226 NVARCHAR(20),
@Currency_c0378226 NCHAR(3),
@PriceTypeID_c0378226 UNIQUEIDENTIFIER,
@InputPricePerUnit_c0378226 DECIMAL(18, 8),
@OutputPricePerUnit_c0378226 DECIMAL(18, 8),
@UnitTypeID_c0378226 UNIQUEIDENTIFIER,
@ProcessingType_c0378226 NVARCHAR(20),
@Comments_c0378226 NVARCHAR(MAX)
SET
  @ID_c0378226 = '71148a7b-e3aa-47b9-80b9-833caf56cde9'
SET
  @ModelID_c0378226 = 'F2A7D6BE-C96B-453E-B330-1D56E5E05AAD'
SET
  @VendorID_c0378226 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @StartedAt_c0378226 = '2026-04-21T00:00:00.000Z'
SET
  @Status_c0378226 = N'Active'
SET
  @Currency_c0378226 = N'USD'
SET
  @PriceTypeID_c0378226 = 'F8D3A2B1-C4E5-4F6A-9B8C-7D2E1A3F5C4D'
SET
  @InputPricePerUnit_c0378226 = 0
SET
  @OutputPricePerUnit_c0378226 = 0.053
SET
  @UnitTypeID_c0378226 = 'A1B2C3D4-E5F6-4A7B-8C9D-0E1F2A3B4C5D'
SET
  @ProcessingType_c0378226 = N'Realtime'
SET
  @Comments_c0378226 = N'GPT Image 2 (snapshot gpt-image-2-2026-04-21) pricing as of May 2026. OpenAI charges by tokens, not flat per-image: $5/M text input, $8/M image input (cached $2/M), $30/M image output. The per-image figure here ($0.053) is the representative cost for a 1024x1024 medium-quality image based on OpenAI''s calculator — low quality ~$0.006/image, high quality ~$0.211/image. Batch API offers 50% discount on all token rates with 24h latency. Released April 21, 2026; API available early May 2026.' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_c0378226,
  @ModelID = @ModelID_c0378226,
  @VendorID = @VendorID_c0378226,
  @StartedAt = @StartedAt_c0378226,
  @EndedAt = @EndedAt_c0378226,
  @EndedAt_Clear = 1,
  @Status = @Status_c0378226,
  @Currency = @Currency_c0378226,
  @PriceTypeID = @PriceTypeID_c0378226,
  @InputPricePerUnit = @InputPricePerUnit_c0378226,
  @OutputPricePerUnit = @OutputPricePerUnit_c0378226,
  @UnitTypeID = @UnitTypeID_c0378226,
  @ProcessingType = @ProcessingType_c0378226,
  @Comments = @Comments_c0378226;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_18b04004 UNIQUEIDENTIFIER,
@Name_18b04004 NVARCHAR(50),
@Description_18b04004 NVARCHAR(MAX),
@AIModelTypeID_18b04004 UNIQUEIDENTIFIER,
@PowerRank_18b04004 INT,
@IsActive_18b04004 BIT,
@SpeedRank_18b04004 INT,
@CostRank_18b04004 INT,
@ModelSelectionInsights_18b04004 NVARCHAR(MAX),
@InheritTypeModalities_18b04004 BIT,
@PriorVersionID_18b04004 UNIQUEIDENTIFIER,
@SupportsPrefill_18b04004 BIT,
@PrefillFallbackText_18b04004 NVARCHAR(MAX)
SET
  @ID_18b04004 = '7e91f18e-52cc-48c9-8457-74c810899b41'
SET
  @Name_18b04004 = N'GPT 5.5 Instant'
SET
  @Description_18b04004 = N'OpenAI''s latest low-latency default ChatGPT model (May 5, 2026). Replaces GPT-5.3 Instant as the default in ChatGPT and is exposed in the API as `chat-latest`. Headline metric: 52.5% fewer hallucinated claims than GPT-5.3 Instant on high-stakes prompts (legal, medical, financial). Inherits the GPT-5.5 family context: 1,050,000 input tokens, 128,000 output. Supports configurable reasoning_effort. PRICING NOTE: provisional rate uses the GPT-5.5 standard $5/$30 per 1M tokens; Instant SKU may carry a lower rate once OpenAI''s pricing page differentiates it.'
SET
  @AIModelTypeID_18b04004 = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_18b04004 = 13
SET
  @IsActive_18b04004 = 1
SET
  @SpeedRank_18b04004 = 9
SET
  @CostRank_18b04004 = 10
SET
  @InheritTypeModalities_18b04004 = 1
SET
  @PriorVersionID_18b04004 = '87C9417E-45E6-4C97-95B1-EC0482C7FE4D' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_18b04004,
  @Name = @Name_18b04004,
  @Description = @Description_18b04004,
  @AIModelTypeID = @AIModelTypeID_18b04004,
  @PowerRank = @PowerRank_18b04004,
  @IsActive = @IsActive_18b04004,
  @SpeedRank = @SpeedRank_18b04004,
  @CostRank = @CostRank_18b04004,
  @ModelSelectionInsights = @ModelSelectionInsights_18b04004,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_18b04004,
  @PriorVersionID = @PriorVersionID_18b04004,
  @SupportsPrefill = @SupportsPrefill_18b04004,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_18b04004,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_75c36c2d UNIQUEIDENTIFIER,
@ModelID_75c36c2d UNIQUEIDENTIFIER,
@VendorID_75c36c2d UNIQUEIDENTIFIER,
@Priority_75c36c2d INT,
@Status_75c36c2d NVARCHAR(20),
@DriverClass_75c36c2d NVARCHAR(100),
@DriverImportPath_75c36c2d NVARCHAR(255),
@APIName_75c36c2d NVARCHAR(100),
@MaxInputTokens_75c36c2d INT,
@MaxOutputTokens_75c36c2d INT,
@SupportedResponseFormats_75c36c2d NVARCHAR(100),
@SupportsEffortLevel_75c36c2d BIT,
@SupportsStreaming_75c36c2d BIT,
@TypeID_75c36c2d UNIQUEIDENTIFIER,
@SupportsPrefill_75c36c2d BIT,
@PrefillFallbackText_75c36c2d NVARCHAR(MAX)
SET
  @ID_75c36c2d = '00c49b3a-1a78-439d-a7ce-fcff755c3fa2'
SET
  @ModelID_75c36c2d = '7E91F18E-52CC-48C9-8457-74C810899B41'
SET
  @VendorID_75c36c2d = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_75c36c2d = 0
SET
  @Status_75c36c2d = N'Active'
SET
  @SupportedResponseFormats_75c36c2d = N'Any'
SET
  @SupportsEffortLevel_75c36c2d = 1
SET
  @SupportsStreaming_75c36c2d = 0
SET
  @TypeID_75c36c2d = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_75c36c2d,
  @ModelID = @ModelID_75c36c2d,
  @VendorID = @VendorID_75c36c2d,
  @Priority = @Priority_75c36c2d,
  @Status = @Status_75c36c2d,
  @DriverClass = @DriverClass_75c36c2d,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_75c36c2d,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_75c36c2d,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_75c36c2d,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_75c36c2d,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_75c36c2d,
  @SupportsEffortLevel = @SupportsEffortLevel_75c36c2d,
  @SupportsStreaming = @SupportsStreaming_75c36c2d,
  @TypeID = @TypeID_75c36c2d,
  @SupportsPrefill = @SupportsPrefill_75c36c2d,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_75c36c2d,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_b4899ae1 UNIQUEIDENTIFIER,
@ModelID_b4899ae1 UNIQUEIDENTIFIER,
@VendorID_b4899ae1 UNIQUEIDENTIFIER,
@Priority_b4899ae1 INT,
@Status_b4899ae1 NVARCHAR(20),
@DriverClass_b4899ae1 NVARCHAR(100),
@DriverImportPath_b4899ae1 NVARCHAR(255),
@APIName_b4899ae1 NVARCHAR(100),
@MaxInputTokens_b4899ae1 INT,
@MaxOutputTokens_b4899ae1 INT,
@SupportedResponseFormats_b4899ae1 NVARCHAR(100),
@SupportsEffortLevel_b4899ae1 BIT,
@SupportsStreaming_b4899ae1 BIT,
@TypeID_b4899ae1 UNIQUEIDENTIFIER,
@SupportsPrefill_b4899ae1 BIT,
@PrefillFallbackText_b4899ae1 NVARCHAR(MAX)
SET
  @ID_b4899ae1 = 'b12df96c-c415-4d00-a634-2ebca428e78c'
SET
  @ModelID_b4899ae1 = '7E91F18E-52CC-48C9-8457-74C810899B41'
SET
  @VendorID_b4899ae1 = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @Priority_b4899ae1 = 1
SET
  @Status_b4899ae1 = N'Active'
SET
  @DriverClass_b4899ae1 = N'OpenAILLM'
SET
  @APIName_b4899ae1 = N'gpt-5.5-instant'
SET
  @MaxInputTokens_b4899ae1 = 1050000
SET
  @MaxOutputTokens_b4899ae1 = 128000
SET
  @SupportedResponseFormats_b4899ae1 = N'Any, JSON'
SET
  @SupportsEffortLevel_b4899ae1 = 1
SET
  @SupportsStreaming_b4899ae1 = 1
SET
  @TypeID_b4899ae1 = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_b4899ae1,
  @ModelID = @ModelID_b4899ae1,
  @VendorID = @VendorID_b4899ae1,
  @Priority = @Priority_b4899ae1,
  @Status = @Status_b4899ae1,
  @DriverClass = @DriverClass_b4899ae1,
  @DriverImportPath = @DriverImportPath_b4899ae1,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_b4899ae1,
  @MaxInputTokens = @MaxInputTokens_b4899ae1,
  @MaxOutputTokens = @MaxOutputTokens_b4899ae1,
  @SupportedResponseFormats = @SupportedResponseFormats_b4899ae1,
  @SupportsEffortLevel = @SupportsEffortLevel_b4899ae1,
  @SupportsStreaming = @SupportsStreaming_b4899ae1,
  @TypeID = @TypeID_b4899ae1,
  @SupportsPrefill = @SupportsPrefill_b4899ae1,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_b4899ae1,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_b3bc14de UNIQUEIDENTIFIER,
@ModelID_b3bc14de UNIQUEIDENTIFIER,
@VendorID_b3bc14de UNIQUEIDENTIFIER,
@StartedAt_b3bc14de DATETIMEOFFSET,
@EndedAt_b3bc14de DATETIMEOFFSET,
@Status_b3bc14de NVARCHAR(20),
@Currency_b3bc14de NCHAR(3),
@PriceTypeID_b3bc14de UNIQUEIDENTIFIER,
@InputPricePerUnit_b3bc14de DECIMAL(18, 8),
@OutputPricePerUnit_b3bc14de DECIMAL(18, 8),
@UnitTypeID_b3bc14de UNIQUEIDENTIFIER,
@ProcessingType_b3bc14de NVARCHAR(20),
@Comments_b3bc14de NVARCHAR(MAX)
SET
  @ID_b3bc14de = 'feaa70bb-8baa-49d2-9300-b5e3ce93decc'
SET
  @ModelID_b3bc14de = '7E91F18E-52CC-48C9-8457-74C810899B41'
SET
  @VendorID_b3bc14de = 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @StartedAt_b3bc14de = '2026-05-05T00:00:00.000Z'
SET
  @Status_b3bc14de = N'Active'
SET
  @Currency_b3bc14de = N'USD'
SET
  @PriceTypeID_b3bc14de = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_b3bc14de = 5
SET
  @OutputPricePerUnit_b3bc14de = 30
SET
  @UnitTypeID_b3bc14de = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_b3bc14de = N'Realtime'
SET
  @Comments_b3bc14de = N'GPT-5.5 Instant pricing as of May 2026. Provisionally recorded at the GPT-5.5 standard family rate ($5/$30 per 1M tokens) — OpenAI''s pricing page may differentiate Instant to a lower rate; verify on next pricing-page review. Batch and Flex are 50% off; Priority is 2.5x standard. Released May 5, 2026 as the new default ChatGPT model; also surfaces in API as `chat-latest`.' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_b3bc14de,
  @ModelID = @ModelID_b3bc14de,
  @VendorID = @VendorID_b3bc14de,
  @StartedAt = @StartedAt_b3bc14de,
  @EndedAt = @EndedAt_b3bc14de,
  @EndedAt_Clear = 1,
  @Status = @Status_b3bc14de,
  @Currency = @Currency_b3bc14de,
  @PriceTypeID = @PriceTypeID_b3bc14de,
  @InputPricePerUnit = @InputPricePerUnit_b3bc14de,
  @OutputPricePerUnit = @OutputPricePerUnit_b3bc14de,
  @UnitTypeID = @UnitTypeID_b3bc14de,
  @ProcessingType = @ProcessingType_b3bc14de,
  @Comments = @Comments_b3bc14de;

GO

-- Save MJ: AI Models (core SP call only)
DECLARE @ID_52d2af99 UNIQUEIDENTIFIER,
@Name_52d2af99 NVARCHAR(50),
@Description_52d2af99 NVARCHAR(MAX),
@AIModelTypeID_52d2af99 UNIQUEIDENTIFIER,
@PowerRank_52d2af99 INT,
@IsActive_52d2af99 BIT,
@SpeedRank_52d2af99 INT,
@CostRank_52d2af99 INT,
@ModelSelectionInsights_52d2af99 NVARCHAR(MAX),
@InheritTypeModalities_52d2af99 BIT,
@PriorVersionID_52d2af99 UNIQUEIDENTIFIER,
@SupportsPrefill_52d2af99 BIT,
@PrefillFallbackText_52d2af99 NVARCHAR(MAX)
SET
  @ID_52d2af99 = 'd44acc64-291f-483c-b870-3c1d0698f335'
SET
  @Name_52d2af99 = N'GLM 5V Turbo'
SET
  @Description_52d2af99 = N'Z.AI''s first native multimodal agent foundation model (April 1, 2026). Built for vision-based coding and agent-driven tasks: turns screenshots and designs into code, debugs visually, operates GUIs autonomously. Natively handles image, video, and text inputs. Excels at long-horizon planning, complex coding, and task execution. Context window: 202,752 input tokens, up to 131,072 output tokens.'
SET
  @AIModelTypeID_52d2af99 = 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @PowerRank_52d2af99 = 12
SET
  @IsActive_52d2af99 = 1
SET
  @SpeedRank_52d2af99 = 7
SET
  @CostRank_52d2af99 = 5
SET
  @InheritTypeModalities_52d2af99 = 1
SET
  @PriorVersionID_52d2af99 = '669B84EE-0749-44DF-BE4F-C0390E25E484' EXEC [${flyway:defaultSchema}].spCreateAIModel @ID = @ID_52d2af99,
  @Name = @Name_52d2af99,
  @Description = @Description_52d2af99,
  @AIModelTypeID = @AIModelTypeID_52d2af99,
  @PowerRank = @PowerRank_52d2af99,
  @IsActive = @IsActive_52d2af99,
  @SpeedRank = @SpeedRank_52d2af99,
  @CostRank = @CostRank_52d2af99,
  @ModelSelectionInsights = @ModelSelectionInsights_52d2af99,
  @ModelSelectionInsights_Clear = 1,
  @InheritTypeModalities = @InheritTypeModalities_52d2af99,
  @PriorVersionID = @PriorVersionID_52d2af99,
  @SupportsPrefill = @SupportsPrefill_52d2af99,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_52d2af99,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_d4f35605 UNIQUEIDENTIFIER,
@ModelID_d4f35605 UNIQUEIDENTIFIER,
@VendorID_d4f35605 UNIQUEIDENTIFIER,
@Priority_d4f35605 INT,
@Status_d4f35605 NVARCHAR(20),
@DriverClass_d4f35605 NVARCHAR(100),
@DriverImportPath_d4f35605 NVARCHAR(255),
@APIName_d4f35605 NVARCHAR(100),
@MaxInputTokens_d4f35605 INT,
@MaxOutputTokens_d4f35605 INT,
@SupportedResponseFormats_d4f35605 NVARCHAR(100),
@SupportsEffortLevel_d4f35605 BIT,
@SupportsStreaming_d4f35605 BIT,
@TypeID_d4f35605 UNIQUEIDENTIFIER,
@SupportsPrefill_d4f35605 BIT,
@PrefillFallbackText_d4f35605 NVARCHAR(MAX)
SET
  @ID_d4f35605 = '92007811-328a-44b2-9033-169856fc59f7'
SET
  @ModelID_d4f35605 = 'D44ACC64-291F-483C-B870-3C1D0698F335'
SET
  @VendorID_d4f35605 = '9105874C-747B-49C6-80B2-3BBF83ABE29B'
SET
  @Priority_d4f35605 = 0
SET
  @Status_d4f35605 = N'Active'
SET
  @SupportedResponseFormats_d4f35605 = N'Any'
SET
  @SupportsEffortLevel_d4f35605 = 0
SET
  @SupportsStreaming_d4f35605 = 0
SET
  @TypeID_d4f35605 = '10DB468E-F2CE-475D-9F39-2DF2DE75D257' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_d4f35605,
  @ModelID = @ModelID_d4f35605,
  @VendorID = @VendorID_d4f35605,
  @Priority = @Priority_d4f35605,
  @Status = @Status_d4f35605,
  @DriverClass = @DriverClass_d4f35605,
  @DriverClass_Clear = 1,
  @DriverImportPath = @DriverImportPath_d4f35605,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_d4f35605,
  @APIName_Clear = 1,
  @MaxInputTokens = @MaxInputTokens_d4f35605,
  @MaxInputTokens_Clear = 1,
  @MaxOutputTokens = @MaxOutputTokens_d4f35605,
  @MaxOutputTokens_Clear = 1,
  @SupportedResponseFormats = @SupportedResponseFormats_d4f35605,
  @SupportsEffortLevel = @SupportsEffortLevel_d4f35605,
  @SupportsStreaming = @SupportsStreaming_d4f35605,
  @TypeID = @TypeID_d4f35605,
  @SupportsPrefill = @SupportsPrefill_d4f35605,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_d4f35605,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Vendors (core SP call only)
DECLARE @ID_fd322e5d UNIQUEIDENTIFIER,
@ModelID_fd322e5d UNIQUEIDENTIFIER,
@VendorID_fd322e5d UNIQUEIDENTIFIER,
@Priority_fd322e5d INT,
@Status_fd322e5d NVARCHAR(20),
@DriverClass_fd322e5d NVARCHAR(100),
@DriverImportPath_fd322e5d NVARCHAR(255),
@APIName_fd322e5d NVARCHAR(100),
@MaxInputTokens_fd322e5d INT,
@MaxOutputTokens_fd322e5d INT,
@SupportedResponseFormats_fd322e5d NVARCHAR(100),
@SupportsEffortLevel_fd322e5d BIT,
@SupportsStreaming_fd322e5d BIT,
@TypeID_fd322e5d UNIQUEIDENTIFIER,
@SupportsPrefill_fd322e5d BIT,
@PrefillFallbackText_fd322e5d NVARCHAR(MAX)
SET
  @ID_fd322e5d = '92c44c56-b93b-4a55-bb99-56604c0da939'
SET
  @ModelID_fd322e5d = 'D44ACC64-291F-483C-B870-3C1D0698F335'
SET
  @VendorID_fd322e5d = '9105874C-747B-49C6-80B2-3BBF83ABE29B'
SET
  @Priority_fd322e5d = 1
SET
  @Status_fd322e5d = N'Active'
SET
  @DriverClass_fd322e5d = N'ZAILLM'
SET
  @APIName_fd322e5d = N'glm-5v-turbo'
SET
  @MaxInputTokens_fd322e5d = 202752
SET
  @MaxOutputTokens_fd322e5d = 131072
SET
  @SupportedResponseFormats_fd322e5d = N'Any, JSON'
SET
  @SupportsEffortLevel_fd322e5d = 0
SET
  @SupportsStreaming_fd322e5d = 1
SET
  @TypeID_fd322e5d = '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3' EXEC [${flyway:defaultSchema}].spCreateAIModelVendor @ID = @ID_fd322e5d,
  @ModelID = @ModelID_fd322e5d,
  @VendorID = @VendorID_fd322e5d,
  @Priority = @Priority_fd322e5d,
  @Status = @Status_fd322e5d,
  @DriverClass = @DriverClass_fd322e5d,
  @DriverImportPath = @DriverImportPath_fd322e5d,
  @DriverImportPath_Clear = 1,
  @APIName = @APIName_fd322e5d,
  @MaxInputTokens = @MaxInputTokens_fd322e5d,
  @MaxOutputTokens = @MaxOutputTokens_fd322e5d,
  @SupportedResponseFormats = @SupportedResponseFormats_fd322e5d,
  @SupportsEffortLevel = @SupportsEffortLevel_fd322e5d,
  @SupportsStreaming = @SupportsStreaming_fd322e5d,
  @TypeID = @TypeID_fd322e5d,
  @SupportsPrefill = @SupportsPrefill_fd322e5d,
  @SupportsPrefill_Clear = 1,
  @PrefillFallbackText = @PrefillFallbackText_fd322e5d,
  @PrefillFallbackText_Clear = 1;

GO

-- Save MJ: AI Model Costs (core SP call only)
DECLARE @ID_75027fd4 UNIQUEIDENTIFIER,
@ModelID_75027fd4 UNIQUEIDENTIFIER,
@VendorID_75027fd4 UNIQUEIDENTIFIER,
@StartedAt_75027fd4 DATETIMEOFFSET,
@EndedAt_75027fd4 DATETIMEOFFSET,
@Status_75027fd4 NVARCHAR(20),
@Currency_75027fd4 NCHAR(3),
@PriceTypeID_75027fd4 UNIQUEIDENTIFIER,
@InputPricePerUnit_75027fd4 DECIMAL(18, 8),
@OutputPricePerUnit_75027fd4 DECIMAL(18, 8),
@UnitTypeID_75027fd4 UNIQUEIDENTIFIER,
@ProcessingType_75027fd4 NVARCHAR(20),
@Comments_75027fd4 NVARCHAR(MAX)
SET
  @ID_75027fd4 = '5db866b6-5f56-4c5e-90f0-ceaa3708259f'
SET
  @ModelID_75027fd4 = 'D44ACC64-291F-483C-B870-3C1D0698F335'
SET
  @VendorID_75027fd4 = '9105874C-747B-49C6-80B2-3BBF83ABE29B'
SET
  @StartedAt_75027fd4 = '2026-04-01T00:00:00.000Z'
SET
  @Status_75027fd4 = N'Active'
SET
  @Currency_75027fd4 = N'USD'
SET
  @PriceTypeID_75027fd4 = 'ECE2BCB7-C854-4BF7-A517-D72793A40652'
SET
  @InputPricePerUnit_75027fd4 = 1.2
SET
  @OutputPricePerUnit_75027fd4 = 4
SET
  @UnitTypeID_75027fd4 = '54208F7D-331C-40AB-84E8-163338EE9EA1'
SET
  @ProcessingType_75027fd4 = N'Realtime'
SET
  @Comments_75027fd4 = N'GLM-5V Turbo pricing on Z.AI direct API as of May 2026: $1.20/M input, $4.00/M output. Released April 1, 2026 — Z.AI''s first native multimodal agent model with image, video, and text input. Proprietary (not open-source) per the launch announcement.' EXEC [${flyway:defaultSchema}].spCreateAIModelCost @ID = @ID_75027fd4,
  @ModelID = @ModelID_75027fd4,
  @VendorID = @VendorID_75027fd4,
  @StartedAt = @StartedAt_75027fd4,
  @EndedAt = @EndedAt_75027fd4,
  @EndedAt_Clear = 1,
  @Status = @Status_75027fd4,
  @Currency = @Currency_75027fd4,
  @PriceTypeID = @PriceTypeID_75027fd4,
  @InputPricePerUnit = @InputPricePerUnit_75027fd4,
  @OutputPricePerUnit = @OutputPricePerUnit_75027fd4,
  @UnitTypeID = @UnitTypeID_75027fd4,
  @ProcessingType = @ProcessingType_75027fd4,
  @Comments = @Comments_75027fd4;

GO

-- Save MJ: Artifact Types (core SP call only)
DECLARE @ID_8cfe4ffa UNIQUEIDENTIFIER,
@Name_8cfe4ffa NVARCHAR(100),
@Description_8cfe4ffa NVARCHAR(MAX),
@ContentType_8cfe4ffa NVARCHAR(100),
@IsEnabled_8cfe4ffa BIT,
@ParentID_8cfe4ffa UNIQUEIDENTIFIER,
@ExtractRules_8cfe4ffa NVARCHAR(MAX),
@DriverClass_8cfe4ffa NVARCHAR(255),
@Icon_8cfe4ffa NVARCHAR(255),
@ContentCategory_8cfe4ffa NVARCHAR(10),
@ToolLibraryClass_8cfe4ffa NVARCHAR(100)
SET
  @ID_8cfe4ffa = '249B4A72-7A7A-4CBC-BAAE-91DC66853795'
SET
  @Name_8cfe4ffa = N'Search Result Set'
SET
  @Description_8cfe4ffa = N'Persisted ranked search results produced by a scoped search (pre-execution RAG or agent-invoked). Re-parented onto Data Snapshot in Phase 2B so it inherits Data Snapshot''s tabular tools (filter, sort, paginate, get-row, project-columns) plus the search-specific tools (filterByScore, groupBySourceProvider, getMatchingChunks, followSourceLink, rerankInline) supplied by SearchResultSetToolLibrary. Query, scope list, search context, and provider breakdown are stored alongside the tabular data in the artifact spec.'
SET
  @ContentType_8cfe4ffa = N'application/vnd.mj.search-result-set'
SET
  @IsEnabled_8cfe4ffa = 1
SET
  @ParentID_8cfe4ffa = '511B217C-B2BB-490D-8AC2-095893C3048B'
SET
  @DriverClass_8cfe4ffa = N'DataArtifactViewerPlugin'
SET
  @Icon_8cfe4ffa = N'fa-solid fa-magnifying-glass-plus'
SET
  @ContentCategory_8cfe4ffa = N'Text'
SET
  @ToolLibraryClass_8cfe4ffa = N'SearchResultSetToolLibrary' EXEC [${flyway:defaultSchema}].spCreateArtifactType @ID = @ID_8cfe4ffa,
  @Name = @Name_8cfe4ffa,
  @Description = @Description_8cfe4ffa,
  @ContentType = @ContentType_8cfe4ffa,
  @IsEnabled = @IsEnabled_8cfe4ffa,
  @ParentID = @ParentID_8cfe4ffa,
  @ExtractRules = @ExtractRules_8cfe4ffa,
  @ExtractRules_Clear = 1,
  @DriverClass = @DriverClass_8cfe4ffa,
  @Icon = @Icon_8cfe4ffa,
  @ContentCategory = @ContentCategory_8cfe4ffa,
  @ToolLibraryClass = @ToolLibraryClass_8cfe4ffa;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @ID_834df0c5 UNIQUEIDENTIFIER,
@CategoryID_834df0c5 UNIQUEIDENTIFIER,
@Name_834df0c5 NVARCHAR(425),
@Description_834df0c5 NVARCHAR(MAX),
@Type_834df0c5 NVARCHAR(20),
@UserPrompt_834df0c5 NVARCHAR(MAX),
@UserComments_834df0c5 NVARCHAR(MAX),
@Code_834df0c5 NVARCHAR(MAX),
@CodeComments_834df0c5 NVARCHAR(MAX),
@CodeApprovalStatus_834df0c5 NVARCHAR(20),
@CodeApprovalComments_834df0c5 NVARCHAR(MAX),
@CodeApprovedByUserID_834df0c5 UNIQUEIDENTIFIER,
@CodeApprovedAt_834df0c5 DATETIMEOFFSET,
@CodeLocked_834df0c5 BIT,
@ForceCodeGeneration_834df0c5 BIT,
@RetentionPeriod_834df0c5 INT,
@Status_834df0c5 NVARCHAR(20),
@DriverClass_834df0c5 NVARCHAR(255),
@ParentID_834df0c5 UNIQUEIDENTIFIER,
@IconClass_834df0c5 NVARCHAR(100),
@DefaultCompactPromptID_834df0c5 UNIQUEIDENTIFIER,
@Config_834df0c5 NVARCHAR(MAX),
@RuntimeActionConfiguration_834df0c5 NVARCHAR(MAX),
@MaxExecutionTimeMS_834df0c5 INT,
@CreatedByAgentID_834df0c5 UNIQUEIDENTIFIER
SET
  @ID_834df0c5 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @CategoryID_834df0c5 = '22285832-93AD-427E-81BA-E332F63FC5B9'
SET
  @Name_834df0c5 = N'Scoped Search'
SET
  @Description_834df0c5 = N'Scope-aware universal search for AI agents. Enforces the calling agent''s SearchScopeAccess (''All'' | ''Assigned'' | ''None'') and resolves the requested scope against the agent''s AIAgentSearchScope rows. Supports agent-invoked pre-rendered query templates, per-provider query transforms, multi-scope RRF fusion, and (optional) re-ranking. Returns ranked, scored, and enriched results in the same shape as the universal Search action.'
SET
  @Type_834df0c5 = N'Custom'
SET
  @CodeApprovalStatus_834df0c5 = N'Pending'
SET
  @CodeLocked_834df0c5 = 0
SET
  @ForceCodeGeneration_834df0c5 = 0
SET
  @Status_834df0c5 = N'Active'
SET
  @DriverClass_834df0c5 = N'__Scoped_Search'
SET
  @IconClass_834df0c5 = N'fa-solid fa-magnifying-glass-location' EXEC [${flyway:defaultSchema}].spCreateAction @ID = @ID_834df0c5,
  @CategoryID = @CategoryID_834df0c5,
  @Name = @Name_834df0c5,
  @Description = @Description_834df0c5,
  @Type = @Type_834df0c5,
  @UserPrompt = @UserPrompt_834df0c5,
  @UserPrompt_Clear = 1,
  @UserComments = @UserComments_834df0c5,
  @UserComments_Clear = 1,
  @Code = @Code_834df0c5,
  @Code_Clear = 1,
  @CodeComments = @CodeComments_834df0c5,
  @CodeComments_Clear = 1,
  @CodeApprovalStatus = @CodeApprovalStatus_834df0c5,
  @CodeApprovalComments = @CodeApprovalComments_834df0c5,
  @CodeApprovalComments_Clear = 1,
  @CodeApprovedByUserID = @CodeApprovedByUserID_834df0c5,
  @CodeApprovedByUserID_Clear = 1,
  @CodeApprovedAt = @CodeApprovedAt_834df0c5,
  @CodeApprovedAt_Clear = 1,
  @CodeLocked = @CodeLocked_834df0c5,
  @ForceCodeGeneration = @ForceCodeGeneration_834df0c5,
  @RetentionPeriod = @RetentionPeriod_834df0c5,
  @RetentionPeriod_Clear = 1,
  @Status = @Status_834df0c5,
  @DriverClass = @DriverClass_834df0c5,
  @ParentID = @ParentID_834df0c5,
  @ParentID_Clear = 1,
  @IconClass = @IconClass_834df0c5,
  @DefaultCompactPromptID = @DefaultCompactPromptID_834df0c5,
  @DefaultCompactPromptID_Clear = 1,
  @Config = @Config_834df0c5,
  @Config_Clear = 1,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_834df0c5,
  @RuntimeActionConfiguration_Clear = 1,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_834df0c5,
  @MaxExecutionTimeMS_Clear = 1,
  @CreatedByAgentID = @CreatedByAgentID_834df0c5,
  @CreatedByAgentID_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_c0f4e4f8 UNIQUEIDENTIFIER,
@ActionID_c0f4e4f8 UNIQUEIDENTIFIER,
@Name_c0f4e4f8 NVARCHAR(255),
@DefaultValue_c0f4e4f8 NVARCHAR(MAX),
@Type_c0f4e4f8 NCHAR(10),
@ValueType_c0f4e4f8 NVARCHAR(30),
@IsArray_c0f4e4f8 BIT,
@Description_c0f4e4f8 NVARCHAR(MAX),
@IsRequired_c0f4e4f8 BIT,
@MediaModality_c0f4e4f8 NVARCHAR(20)
SET
  @ID_c0f4e4f8 = '3d8b14dc-9d31-4f05-a0e4-895cbdbfe563'
SET
  @ActionID_c0f4e4f8 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_c0f4e4f8 = N'PrimaryScopeRecordID'
SET
  @Type_c0f4e4f8 = N'Input'
SET
  @ValueType_c0f4e4f8 = N'Scalar'
SET
  @IsArray_c0f4e4f8 = 0
SET
  @Description_c0f4e4f8 = N'Optional primary tenant identifier (e.g. OrganizationID) supplied per call. Threaded into SearchParams.SearchContext.PrimaryScopeRecordID so the engine can render `{{ context.PrimaryScopeRecordID }}` into the scope''s MetadataFilter / ExtraFilter / UserSearchString / FolderPath templates at search time. One scope definition serves many tenants when this is populated.'
SET
  @IsRequired_c0f4e4f8 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_c0f4e4f8,
  @ActionID = @ActionID_c0f4e4f8,
  @Name = @Name_c0f4e4f8,
  @DefaultValue = @DefaultValue_c0f4e4f8,
  @DefaultValue_Clear = 1,
  @Type = @Type_c0f4e4f8,
  @ValueType = @ValueType_c0f4e4f8,
  @IsArray = @IsArray_c0f4e4f8,
  @Description = @Description_c0f4e4f8,
  @IsRequired = @IsRequired_c0f4e4f8,
  @MediaModality = @MediaModality_c0f4e4f8,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_3626f076 UNIQUEIDENTIFIER,
@ActionID_3626f076 UNIQUEIDENTIFIER,
@Name_3626f076 NVARCHAR(255),
@DefaultValue_3626f076 NVARCHAR(MAX),
@Type_3626f076 NCHAR(10),
@ValueType_3626f076 NVARCHAR(30),
@IsArray_3626f076 BIT,
@Description_3626f076 NVARCHAR(MAX),
@IsRequired_3626f076 BIT,
@MediaModality_3626f076 NVARCHAR(20)
SET
  @ID_3626f076 = 'b77caa50-58a7-4e28-bb32-54789bd66bb6'
SET
  @ActionID_3626f076 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_3626f076 = N'SecondaryScopes'
SET
  @Type_3626f076 = N'Input'
SET
  @ValueType_3626f076 = N'Scalar'
SET
  @IsArray_3626f076 = 0
SET
  @Description_3626f076 = N'Optional JSON string of additional runtime dimensions as key/value pairs, e.g. `{"Department":"Finance","Region":"US","Tags":["audit"]}`. Each key becomes `{{ context.SecondaryScopes.<key> }}` available to the scope''s Nunjucks-rendered templates. Values must be string, number, boolean, or string[] — incompatible entries are skipped with a log. Dimensions are fully dynamic at this layer; the engine handles any per-scope dimension validation.'
SET
  @IsRequired_3626f076 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_3626f076,
  @ActionID = @ActionID_3626f076,
  @Name = @Name_3626f076,
  @DefaultValue = @DefaultValue_3626f076,
  @DefaultValue_Clear = 1,
  @Type = @Type_3626f076,
  @ValueType = @ValueType_3626f076,
  @IsArray = @IsArray_3626f076,
  @Description = @Description_3626f076,
  @IsRequired = @IsRequired_3626f076,
  @MediaModality = @MediaModality_3626f076,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_447b3385 UNIQUEIDENTIFIER,
@ActionID_447b3385 UNIQUEIDENTIFIER,
@Name_447b3385 NVARCHAR(255),
@DefaultValue_447b3385 NVARCHAR(MAX),
@Type_447b3385 NCHAR(10),
@ValueType_447b3385 NVARCHAR(30),
@IsArray_447b3385 BIT,
@Description_447b3385 NVARCHAR(MAX),
@IsRequired_447b3385 BIT,
@MediaModality_447b3385 NVARCHAR(20)
SET
  @ID_447b3385 = '880971F0-C630-420D-B8B4-7E92058B8E3E'
SET
  @ActionID_447b3385 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_447b3385 = N'Query'
SET
  @Type_447b3385 = N'Input'
SET
  @ValueType_447b3385 = N'Scalar'
SET
  @IsArray_447b3385 = 0
SET
  @Description_447b3385 = N'The search query text (required). Natural language query to search within the resolved scope.'
SET
  @IsRequired_447b3385 = 1
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_447b3385,
  @ActionID = @ActionID_447b3385,
  @Name = @Name_447b3385,
  @DefaultValue = @DefaultValue_447b3385,
  @DefaultValue_Clear = 1,
  @Type = @Type_447b3385,
  @ValueType = @ValueType_447b3385,
  @IsArray = @IsArray_447b3385,
  @Description = @Description_447b3385,
  @IsRequired = @IsRequired_447b3385,
  @MediaModality = @MediaModality_447b3385,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_3503cbc6 UNIQUEIDENTIFIER,
@ActionID_3503cbc6 UNIQUEIDENTIFIER,
@Name_3503cbc6 NVARCHAR(255),
@DefaultValue_3503cbc6 NVARCHAR(MAX),
@Type_3503cbc6 NCHAR(10),
@ValueType_3503cbc6 NVARCHAR(30),
@IsArray_3503cbc6 BIT,
@Description_3503cbc6 NVARCHAR(MAX),
@IsRequired_3503cbc6 BIT,
@MediaModality_3503cbc6 NVARCHAR(20)
SET
  @ID_3503cbc6 = 'D7EA4FC4-DFF6-4AD9-9584-4DB13AAA1AA8'
SET
  @ActionID_3503cbc6 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_3503cbc6 = N'ScopeID'
SET
  @Type_3503cbc6 = N'Input'
SET
  @ValueType_3503cbc6 = N'Scalar'
SET
  @IsArray_3503cbc6 = 0
SET
  @Description_3503cbc6 = N'Optional. Specific SearchScope ID to use. When omitted, the calling agent''s default scope (IsDefault=1) is used, falling back to Global when SearchScopeAccess=''All''.'
SET
  @IsRequired_3503cbc6 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_3503cbc6,
  @ActionID = @ActionID_3503cbc6,
  @Name = @Name_3503cbc6,
  @DefaultValue = @DefaultValue_3503cbc6,
  @DefaultValue_Clear = 1,
  @Type = @Type_3503cbc6,
  @ValueType = @ValueType_3503cbc6,
  @IsArray = @IsArray_3503cbc6,
  @Description = @Description_3503cbc6,
  @IsRequired = @IsRequired_3503cbc6,
  @MediaModality = @MediaModality_3503cbc6,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_16488985 UNIQUEIDENTIFIER,
@ActionID_16488985 UNIQUEIDENTIFIER,
@Name_16488985 NVARCHAR(255),
@DefaultValue_16488985 NVARCHAR(MAX),
@Type_16488985 NCHAR(10),
@ValueType_16488985 NVARCHAR(30),
@IsArray_16488985 BIT,
@Description_16488985 NVARCHAR(MAX),
@IsRequired_16488985 BIT,
@MediaModality_16488985 NVARCHAR(20)
SET
  @ID_16488985 = 'B658FFBC-8B5C-451C-8CCA-F4A97E7EA862'
SET
  @ActionID_16488985 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_16488985 = N'MaxResults'
SET
  @DefaultValue_16488985 = N'25'
SET
  @Type_16488985 = N'Input'
SET
  @ValueType_16488985 = N'Scalar'
SET
  @IsArray_16488985 = 0
SET
  @Description_16488985 = N'Maximum number of results to return. Defaults to 25. Overridden by AIAgentSearchScope.MaxResults if set and smaller.'
SET
  @IsRequired_16488985 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_16488985,
  @ActionID = @ActionID_16488985,
  @Name = @Name_16488985,
  @DefaultValue = @DefaultValue_16488985,
  @Type = @Type_16488985,
  @ValueType = @ValueType_16488985,
  @IsArray = @IsArray_16488985,
  @Description = @Description_16488985,
  @IsRequired = @IsRequired_16488985,
  @MediaModality = @MediaModality_16488985,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_d5c42364 UNIQUEIDENTIFIER,
@ActionID_d5c42364 UNIQUEIDENTIFIER,
@Name_d5c42364 NVARCHAR(255),
@DefaultValue_d5c42364 NVARCHAR(MAX),
@Type_d5c42364 NCHAR(10),
@ValueType_d5c42364 NVARCHAR(30),
@IsArray_d5c42364 BIT,
@Description_d5c42364 NVARCHAR(MAX),
@IsRequired_d5c42364 BIT,
@MediaModality_d5c42364 NVARCHAR(20)
SET
  @ID_d5c42364 = '7D890D74-EEDD-4F27-BD2C-953FB9D9CEC6'
SET
  @ActionID_d5c42364 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_d5c42364 = N'MinScore'
SET
  @DefaultValue_d5c42364 = N'0'
SET
  @Type_d5c42364 = N'Input'
SET
  @ValueType_d5c42364 = N'Scalar'
SET
  @IsArray_d5c42364 = 0
SET
  @Description_d5c42364 = N'Minimum relevance score threshold (0-1). Results below this score are excluded after RRF fusion. Overridden by AIAgentSearchScope.MinScore if set and greater.'
SET
  @IsRequired_d5c42364 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_d5c42364,
  @ActionID = @ActionID_d5c42364,
  @Name = @Name_d5c42364,
  @DefaultValue = @DefaultValue_d5c42364,
  @Type = @Type_d5c42364,
  @ValueType = @ValueType_d5c42364,
  @IsArray = @IsArray_d5c42364,
  @Description = @Description_d5c42364,
  @IsRequired = @IsRequired_d5c42364,
  @MediaModality = @MediaModality_d5c42364,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_781cf871 UNIQUEIDENTIFIER,
@ActionID_781cf871 UNIQUEIDENTIFIER,
@Name_781cf871 NVARCHAR(255),
@DefaultValue_781cf871 NVARCHAR(MAX),
@Type_781cf871 NCHAR(10),
@ValueType_781cf871 NVARCHAR(30),
@IsArray_781cf871 BIT,
@Description_781cf871 NVARCHAR(MAX),
@IsRequired_781cf871 BIT,
@MediaModality_781cf871 NVARCHAR(20)
SET
  @ID_781cf871 = 'AC303EE0-4A61-4D4E-A136-8E1C2AD2D56D'
SET
  @ActionID_781cf871 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_781cf871 = N'AgentID'
SET
  @Type_781cf871 = N'Input'
SET
  @ValueType_781cf871 = N'Scalar'
SET
  @IsArray_781cf871 = 0
SET
  @Description_781cf871 = N'ID of the AI agent invoking this action. Used to enforce SearchScopeAccess and resolve the agent''s AIAgentSearchScope rows. Typically populated automatically from the agent execution context.'
SET
  @IsRequired_781cf871 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_781cf871,
  @ActionID = @ActionID_781cf871,
  @Name = @Name_781cf871,
  @DefaultValue = @DefaultValue_781cf871,
  @DefaultValue_Clear = 1,
  @Type = @Type_781cf871,
  @ValueType = @ValueType_781cf871,
  @IsArray = @IsArray_781cf871,
  @Description = @Description_781cf871,
  @IsRequired = @IsRequired_781cf871,
  @MediaModality = @MediaModality_781cf871,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_5c88fa8a UNIQUEIDENTIFIER,
@ActionID_5c88fa8a UNIQUEIDENTIFIER,
@Name_5c88fa8a NVARCHAR(255),
@DefaultValue_5c88fa8a NVARCHAR(MAX),
@Type_5c88fa8a NCHAR(10),
@ValueType_5c88fa8a NVARCHAR(30),
@IsArray_5c88fa8a BIT,
@Description_5c88fa8a NVARCHAR(MAX),
@IsRequired_5c88fa8a BIT,
@MediaModality_5c88fa8a NVARCHAR(20)
SET
  @ID_5c88fa8a = '6D654D15-0226-4CEA-BC73-7A432812C2A0'
SET
  @ActionID_5c88fa8a = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_5c88fa8a = N'Results'
SET
  @Type_5c88fa8a = N'Output'
SET
  @ValueType_5c88fa8a = N'Simple Object'
SET
  @IsArray_5c88fa8a = 1
SET
  @Description_5c88fa8a = N'Ranked search result objects with the same shape as the universal Search action (ID, EntityName, RecordID, SourceType, ResultType, Title, Snippet, Score, ScoreBreakdown, Tags, EntityIcon, RecordName, MatchedAt, RawMetadata).'
SET
  @IsRequired_5c88fa8a = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_5c88fa8a,
  @ActionID = @ActionID_5c88fa8a,
  @Name = @Name_5c88fa8a,
  @DefaultValue = @DefaultValue_5c88fa8a,
  @DefaultValue_Clear = 1,
  @Type = @Type_5c88fa8a,
  @ValueType = @ValueType_5c88fa8a,
  @IsArray = @IsArray_5c88fa8a,
  @Description = @Description_5c88fa8a,
  @IsRequired = @IsRequired_5c88fa8a,
  @MediaModality = @MediaModality_5c88fa8a,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_a4c7e9a0 UNIQUEIDENTIFIER,
@ActionID_a4c7e9a0 UNIQUEIDENTIFIER,
@Name_a4c7e9a0 NVARCHAR(255),
@DefaultValue_a4c7e9a0 NVARCHAR(MAX),
@Type_a4c7e9a0 NCHAR(10),
@ValueType_a4c7e9a0 NVARCHAR(30),
@IsArray_a4c7e9a0 BIT,
@Description_a4c7e9a0 NVARCHAR(MAX),
@IsRequired_a4c7e9a0 BIT,
@MediaModality_a4c7e9a0 NVARCHAR(20)
SET
  @ID_a4c7e9a0 = 'BD23FF40-2094-4469-8555-6457D53EBBB2'
SET
  @ActionID_a4c7e9a0 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_a4c7e9a0 = N'TotalCount'
SET
  @Type_a4c7e9a0 = N'Output'
SET
  @ValueType_a4c7e9a0 = N'Scalar'
SET
  @IsArray_a4c7e9a0 = 0
SET
  @Description_a4c7e9a0 = N'Total number of results returned after filtering.'
SET
  @IsRequired_a4c7e9a0 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_a4c7e9a0,
  @ActionID = @ActionID_a4c7e9a0,
  @Name = @Name_a4c7e9a0,
  @DefaultValue = @DefaultValue_a4c7e9a0,
  @DefaultValue_Clear = 1,
  @Type = @Type_a4c7e9a0,
  @ValueType = @ValueType_a4c7e9a0,
  @IsArray = @IsArray_a4c7e9a0,
  @Description = @Description_a4c7e9a0,
  @IsRequired = @IsRequired_a4c7e9a0,
  @MediaModality = @MediaModality_a4c7e9a0,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_0a1bd073 UNIQUEIDENTIFIER,
@ActionID_0a1bd073 UNIQUEIDENTIFIER,
@Name_0a1bd073 NVARCHAR(255),
@DefaultValue_0a1bd073 NVARCHAR(MAX),
@Type_0a1bd073 NCHAR(10),
@ValueType_0a1bd073 NVARCHAR(30),
@IsArray_0a1bd073 BIT,
@Description_0a1bd073 NVARCHAR(MAX),
@IsRequired_0a1bd073 BIT,
@MediaModality_0a1bd073 NVARCHAR(20)
SET
  @ID_0a1bd073 = 'EF80F256-3822-46A4-A94A-5B63E0F2801D'
SET
  @ActionID_0a1bd073 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_0a1bd073 = N'ElapsedMs'
SET
  @Type_0a1bd073 = N'Output'
SET
  @ValueType_0a1bd073 = N'Scalar'
SET
  @IsArray_0a1bd073 = 0
SET
  @Description_0a1bd073 = N'Total search execution time in milliseconds.'
SET
  @IsRequired_0a1bd073 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_0a1bd073,
  @ActionID = @ActionID_0a1bd073,
  @Name = @Name_0a1bd073,
  @DefaultValue = @DefaultValue_0a1bd073,
  @DefaultValue_Clear = 1,
  @Type = @Type_0a1bd073,
  @ValueType = @ValueType_0a1bd073,
  @IsArray = @IsArray_0a1bd073,
  @Description = @Description_0a1bd073,
  @IsRequired = @IsRequired_0a1bd073,
  @MediaModality = @MediaModality_0a1bd073,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_2efdd234 UNIQUEIDENTIFIER,
@ActionID_2efdd234 UNIQUEIDENTIFIER,
@Name_2efdd234 NVARCHAR(255),
@DefaultValue_2efdd234 NVARCHAR(MAX),
@Type_2efdd234 NCHAR(10),
@ValueType_2efdd234 NVARCHAR(30),
@IsArray_2efdd234 BIT,
@Description_2efdd234 NVARCHAR(MAX),
@IsRequired_2efdd234 BIT,
@MediaModality_2efdd234 NVARCHAR(20)
SET
  @ID_2efdd234 = 'A7F72324-61B6-47E0-9711-534BE68D2247'
SET
  @ActionID_2efdd234 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_2efdd234 = N'SourceCounts'
SET
  @Type_2efdd234 = N'Output'
SET
  @ValueType_2efdd234 = N'Simple Object'
SET
  @IsArray_2efdd234 = 0
SET
  @Description_2efdd234 = N'Object with counts of results contributed by each source before fusion.'
SET
  @IsRequired_2efdd234 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_2efdd234,
  @ActionID = @ActionID_2efdd234,
  @Name = @Name_2efdd234,
  @DefaultValue = @DefaultValue_2efdd234,
  @DefaultValue_Clear = 1,
  @Type = @Type_2efdd234,
  @ValueType = @ValueType_2efdd234,
  @IsArray = @IsArray_2efdd234,
  @Description = @Description_2efdd234,
  @IsRequired = @IsRequired_2efdd234,
  @MediaModality = @MediaModality_2efdd234,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_26978b77 UNIQUEIDENTIFIER,
@ActionID_26978b77 UNIQUEIDENTIFIER,
@Name_26978b77 NVARCHAR(255),
@DefaultValue_26978b77 NVARCHAR(MAX),
@Type_26978b77 NCHAR(10),
@ValueType_26978b77 NVARCHAR(30),
@IsArray_26978b77 BIT,
@Description_26978b77 NVARCHAR(MAX),
@IsRequired_26978b77 BIT,
@MediaModality_26978b77 NVARCHAR(20)
SET
  @ID_26978b77 = '7E845413-42C7-4013-A47B-6D97A31BFF38'
SET
  @ActionID_26978b77 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_26978b77 = N'ScopeID_Resolved'
SET
  @Type_26978b77 = N'Output'
SET
  @ValueType_26978b77 = N'Scalar'
SET
  @IsArray_26978b77 = 0
SET
  @Description_26978b77 = N'The SearchScope ID that was actually used (explicit, default, or Global).'
SET
  @IsRequired_26978b77 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_26978b77,
  @ActionID = @ActionID_26978b77,
  @Name = @Name_26978b77,
  @DefaultValue = @DefaultValue_26978b77,
  @DefaultValue_Clear = 1,
  @Type = @Type_26978b77,
  @ValueType = @ValueType_26978b77,
  @IsArray = @IsArray_26978b77,
  @Description = @Description_26978b77,
  @IsRequired = @IsRequired_26978b77,
  @MediaModality = @MediaModality_26978b77,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Params (core SP call only)
DECLARE @ID_9e337632 UNIQUEIDENTIFIER,
@ActionID_9e337632 UNIQUEIDENTIFIER,
@Name_9e337632 NVARCHAR(255),
@DefaultValue_9e337632 NVARCHAR(MAX),
@Type_9e337632 NCHAR(10),
@ValueType_9e337632 NVARCHAR(30),
@IsArray_9e337632 BIT,
@Description_9e337632 NVARCHAR(MAX),
@IsRequired_9e337632 BIT,
@MediaModality_9e337632 NVARCHAR(20)
SET
  @ID_9e337632 = '8ACC909B-FC90-4E8A-802B-0D2699A229F0'
SET
  @ActionID_9e337632 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Name_9e337632 = N'ScopeName_Resolved'
SET
  @Type_9e337632 = N'Output'
SET
  @ValueType_9e337632 = N'Scalar'
SET
  @IsArray_9e337632 = 0
SET
  @Description_9e337632 = N'The SearchScope Name that was actually used.'
SET
  @IsRequired_9e337632 = 0
EXEC [${flyway:defaultSchema}].spCreateActionParam @ID = @ID_9e337632,
  @ActionID = @ActionID_9e337632,
  @Name = @Name_9e337632,
  @DefaultValue = @DefaultValue_9e337632,
  @DefaultValue_Clear = 1,
  @Type = @Type_9e337632,
  @ValueType = @ValueType_9e337632,
  @IsArray = @IsArray_9e337632,
  @Description = @Description_9e337632,
  @IsRequired = @IsRequired_9e337632,
  @MediaModality = @MediaModality_9e337632,
  @MediaModality_Clear = 1;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_e828e42e UNIQUEIDENTIFIER,
@ActionID_e828e42e UNIQUEIDENTIFIER,
@ResultCode_e828e42e NVARCHAR(255),
@IsSuccess_e828e42e BIT,
@Description_e828e42e NVARCHAR(MAX)
SET
  @ID_e828e42e = '599899E6-2F6B-4A47-B7E4-06EC75653E19'
SET
  @ActionID_e828e42e = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_e828e42e = N'SUCCESS'
SET
  @IsSuccess_e828e42e = 1
SET
  @Description_e828e42e = N'Scoped search completed successfully.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_e828e42e,
  @ActionID = @ActionID_e828e42e,
  @ResultCode = @ResultCode_e828e42e,
  @IsSuccess = @IsSuccess_e828e42e,
  @Description = @Description_e828e42e;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_91fe49b0 UNIQUEIDENTIFIER,
@ActionID_91fe49b0 UNIQUEIDENTIFIER,
@ResultCode_91fe49b0 NVARCHAR(255),
@IsSuccess_91fe49b0 BIT,
@Description_91fe49b0 NVARCHAR(MAX)
SET
  @ID_91fe49b0 = '6B21CC94-D63B-4F42-B49E-B7C26494130D'
SET
  @ActionID_91fe49b0 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_91fe49b0 = N'MISSING_QUERY'
SET
  @IsSuccess_91fe49b0 = 0
SET
  @Description_91fe49b0 = N'The required Query parameter was not provided.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_91fe49b0,
  @ActionID = @ActionID_91fe49b0,
  @ResultCode = @ResultCode_91fe49b0,
  @IsSuccess = @IsSuccess_91fe49b0,
  @Description = @Description_91fe49b0;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_cb2f84e2 UNIQUEIDENTIFIER,
@ActionID_cb2f84e2 UNIQUEIDENTIFIER,
@ResultCode_cb2f84e2 NVARCHAR(255),
@IsSuccess_cb2f84e2 BIT,
@Description_cb2f84e2 NVARCHAR(MAX)
SET
  @ID_cb2f84e2 = 'E19D2B2C-80DC-41CC-86D9-ED2CB0379236'
SET
  @ActionID_cb2f84e2 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_cb2f84e2 = N'MISSING_USER_CONTEXT'
SET
  @IsSuccess_cb2f84e2 = 0
SET
  @Description_cb2f84e2 = N'User context is required but was not provided.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_cb2f84e2,
  @ActionID = @ActionID_cb2f84e2,
  @ResultCode = @ResultCode_cb2f84e2,
  @IsSuccess = @IsSuccess_cb2f84e2,
  @Description = @Description_cb2f84e2;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_e32dc064 UNIQUEIDENTIFIER,
@ActionID_e32dc064 UNIQUEIDENTIFIER,
@ResultCode_e32dc064 NVARCHAR(255),
@IsSuccess_e32dc064 BIT,
@Description_e32dc064 NVARCHAR(MAX)
SET
  @ID_e32dc064 = '28F8193A-6105-4000-AAA9-9188A8458408'
SET
  @ActionID_e32dc064 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_e32dc064 = N'MISSING_AGENT_CONTEXT'
SET
  @IsSuccess_e32dc064 = 0
SET
  @Description_e32dc064 = N'Calling agent identity could not be resolved. Scoped search requires an AgentID (from params or execution context).' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_e32dc064,
  @ActionID = @ActionID_e32dc064,
  @ResultCode = @ResultCode_e32dc064,
  @IsSuccess = @IsSuccess_e32dc064,
  @Description = @Description_e32dc064;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_fd213497 UNIQUEIDENTIFIER,
@ActionID_fd213497 UNIQUEIDENTIFIER,
@ResultCode_fd213497 NVARCHAR(255),
@IsSuccess_fd213497 BIT,
@Description_fd213497 NVARCHAR(MAX)
SET
  @ID_fd213497 = '66CE138F-20E4-40C6-AF06-D0D9DC69CDAF'
SET
  @ActionID_fd213497 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_fd213497 = N'ACCESS_DENIED'
SET
  @IsSuccess_fd213497 = 0
SET
  @Description_fd213497 = N'The agent''s SearchScopeAccess is ''None'', or the requested scope is not in the agent''s Assigned list.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_fd213497,
  @ActionID = @ActionID_fd213497,
  @ResultCode = @ResultCode_fd213497,
  @IsSuccess = @IsSuccess_fd213497,
  @Description = @Description_fd213497;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_a8d1be0a UNIQUEIDENTIFIER,
@ActionID_a8d1be0a UNIQUEIDENTIFIER,
@ResultCode_a8d1be0a NVARCHAR(255),
@IsSuccess_a8d1be0a BIT,
@Description_a8d1be0a NVARCHAR(MAX)
SET
  @ID_a8d1be0a = '84612D67-2EB0-4F02-B7C0-D2F7F7983E5B'
SET
  @ActionID_a8d1be0a = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_a8d1be0a = N'SCOPE_NOT_FOUND'
SET
  @IsSuccess_a8d1be0a = 0
SET
  @Description_a8d1be0a = N'The requested scope does not exist or is not active/within its time window.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_a8d1be0a,
  @ActionID = @ActionID_a8d1be0a,
  @ResultCode = @ResultCode_a8d1be0a,
  @IsSuccess = @IsSuccess_a8d1be0a,
  @Description = @Description_a8d1be0a;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_2bab4567 UNIQUEIDENTIFIER,
@ActionID_2bab4567 UNIQUEIDENTIFIER,
@ResultCode_2bab4567 NVARCHAR(255),
@IsSuccess_2bab4567 BIT,
@Description_2bab4567 NVARCHAR(MAX)
SET
  @ID_2bab4567 = '3CBA6998-B351-4E71-A8FE-B5A2619BEB97'
SET
  @ActionID_2bab4567 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_2bab4567 = N'NO_DEFAULT_SCOPE'
SET
  @IsSuccess_2bab4567 = 0
SET
  @Description_2bab4567 = N'No ScopeID was provided and the agent has no default scope assigned.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_2bab4567,
  @ActionID = @ActionID_2bab4567,
  @ResultCode = @ResultCode_2bab4567,
  @IsSuccess = @IsSuccess_2bab4567,
  @Description = @Description_2bab4567;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_a02998d2 UNIQUEIDENTIFIER,
@ActionID_a02998d2 UNIQUEIDENTIFIER,
@ResultCode_a02998d2 NVARCHAR(255),
@IsSuccess_a02998d2 BIT,
@Description_a02998d2 NVARCHAR(MAX)
SET
  @ID_a02998d2 = '0085785E-AC59-491B-945E-ED49AD4A2264'
SET
  @ActionID_a02998d2 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_a02998d2 = N'SEARCH_FAILED'
SET
  @IsSuccess_a02998d2 = 0
SET
  @Description_a02998d2 = N'The search engine returned an error during execution.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_a02998d2,
  @ActionID = @ActionID_a02998d2,
  @ResultCode = @ResultCode_a02998d2,
  @IsSuccess = @IsSuccess_a02998d2,
  @Description = @Description_a02998d2;

GO

-- Save MJ: Action Result Codes (core SP call only)
DECLARE @ID_e755c339 UNIQUEIDENTIFIER,
@ActionID_e755c339 UNIQUEIDENTIFIER,
@ResultCode_e755c339 NVARCHAR(255),
@IsSuccess_e755c339 BIT,
@Description_e755c339 NVARCHAR(MAX)
SET
  @ID_e755c339 = '254CE504-2AE0-4C2E-94ED-6120BA168355'
SET
  @ActionID_e755c339 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @ResultCode_e755c339 = N'UNEXPECTED_ERROR'
SET
  @IsSuccess_e755c339 = 0
SET
  @Description_e755c339 = N'An unexpected error occurred during scoped search execution.' EXEC [${flyway:defaultSchema}].spCreateActionResultCode @ID = @ID_e755c339,
  @ActionID = @ActionID_e755c339,
  @ResultCode = @ResultCode_e755c339,
  @IsSuccess = @IsSuccess_e755c339,
  @Description = @Description_e755c339;

GO

-- Save MJ: AI Agent Actions (core SP call only)
DECLARE @ID_a810c734 UNIQUEIDENTIFIER,
@AgentID_a810c734 UNIQUEIDENTIFIER,
@ActionID_a810c734 UNIQUEIDENTIFIER,
@Status_a810c734 NVARCHAR(15),
@MinExecutionsPerRun_a810c734 INT,
@MaxExecutionsPerRun_a810c734 INT,
@ResultExpirationTurns_a810c734 INT,
@ResultExpirationMode_a810c734 NVARCHAR(20),
@CompactMode_a810c734 NVARCHAR(20),
@CompactLength_a810c734 INT,
@CompactPromptID_a810c734 UNIQUEIDENTIFIER
SET
  @ID_a810c734 = 'c2f2d516-d2f4-4513-b58b-14ed249955d3'
SET
  @AgentID_a810c734 = '746CD1E8-CB8D-49A4-BE69-D0F208A0B462'
SET
  @ActionID_a810c734 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Status_a810c734 = N'Active'
SET
  @ResultExpirationMode_a810c734 = N'None' EXEC [${flyway:defaultSchema}].spCreateAIAgentAction @ID = @ID_a810c734,
  @AgentID = @AgentID_a810c734,
  @ActionID = @ActionID_a810c734,
  @Status = @Status_a810c734,
  @MinExecutionsPerRun = @MinExecutionsPerRun_a810c734,
  @MinExecutionsPerRun_Clear = 1,
  @MaxExecutionsPerRun = @MaxExecutionsPerRun_a810c734,
  @MaxExecutionsPerRun_Clear = 1,
  @ResultExpirationTurns = @ResultExpirationTurns_a810c734,
  @ResultExpirationTurns_Clear = 1,
  @ResultExpirationMode = @ResultExpirationMode_a810c734,
  @CompactMode = @CompactMode_a810c734,
  @CompactMode_Clear = 1,
  @CompactLength = @CompactLength_a810c734,
  @CompactLength_Clear = 1,
  @CompactPromptID = @CompactPromptID_a810c734,
  @CompactPromptID_Clear = 1;

GO

-- Save MJ: AI Agent Actions (core SP call only)
DECLARE @ID_227d9512 UNIQUEIDENTIFIER,
@AgentID_227d9512 UNIQUEIDENTIFIER,
@ActionID_227d9512 UNIQUEIDENTIFIER,
@Status_227d9512 NVARCHAR(15),
@MinExecutionsPerRun_227d9512 INT,
@MaxExecutionsPerRun_227d9512 INT,
@ResultExpirationTurns_227d9512 INT,
@ResultExpirationMode_227d9512 NVARCHAR(20),
@CompactMode_227d9512 NVARCHAR(20),
@CompactLength_227d9512 INT,
@CompactPromptID_227d9512 UNIQUEIDENTIFIER
SET
  @ID_227d9512 = '7089b4c7-9192-4dff-82eb-4505d9242e64'
SET
  @AgentID_227d9512 = '63070640-7E8E-4953-B13C-9F840D6BDD81'
SET
  @ActionID_227d9512 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Status_227d9512 = N'Active'
SET
  @ResultExpirationMode_227d9512 = N'None' EXEC [${flyway:defaultSchema}].spCreateAIAgentAction @ID = @ID_227d9512,
  @AgentID = @AgentID_227d9512,
  @ActionID = @ActionID_227d9512,
  @Status = @Status_227d9512,
  @MinExecutionsPerRun = @MinExecutionsPerRun_227d9512,
  @MinExecutionsPerRun_Clear = 1,
  @MaxExecutionsPerRun = @MaxExecutionsPerRun_227d9512,
  @MaxExecutionsPerRun_Clear = 1,
  @ResultExpirationTurns = @ResultExpirationTurns_227d9512,
  @ResultExpirationTurns_Clear = 1,
  @ResultExpirationMode = @ResultExpirationMode_227d9512,
  @CompactMode = @CompactMode_227d9512,
  @CompactMode_Clear = 1,
  @CompactLength = @CompactLength_227d9512,
  @CompactLength_Clear = 1,
  @CompactPromptID = @CompactPromptID_227d9512,
  @CompactPromptID_Clear = 1;

GO

-- Save MJ: AI Agent Actions (core SP call only)
DECLARE @ID_af8f6be0 UNIQUEIDENTIFIER,
@AgentID_af8f6be0 UNIQUEIDENTIFIER,
@ActionID_af8f6be0 UNIQUEIDENTIFIER,
@Status_af8f6be0 NVARCHAR(15),
@MinExecutionsPerRun_af8f6be0 INT,
@MaxExecutionsPerRun_af8f6be0 INT,
@ResultExpirationTurns_af8f6be0 INT,
@ResultExpirationMode_af8f6be0 NVARCHAR(20),
@CompactMode_af8f6be0 NVARCHAR(20),
@CompactLength_af8f6be0 INT,
@CompactPromptID_af8f6be0 UNIQUEIDENTIFIER
SET
  @ID_af8f6be0 = '130b65ae-dc36-4d8b-92dc-653830c0ae54'
SET
  @AgentID_af8f6be0 = 'E614D2BF-7C52-4A71-B90A-8C8DBB55BCFB'
SET
  @ActionID_af8f6be0 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Status_af8f6be0 = N'Active'
SET
  @ResultExpirationMode_af8f6be0 = N'None' EXEC [${flyway:defaultSchema}].spCreateAIAgentAction @ID = @ID_af8f6be0,
  @AgentID = @AgentID_af8f6be0,
  @ActionID = @ActionID_af8f6be0,
  @Status = @Status_af8f6be0,
  @MinExecutionsPerRun = @MinExecutionsPerRun_af8f6be0,
  @MinExecutionsPerRun_Clear = 1,
  @MaxExecutionsPerRun = @MaxExecutionsPerRun_af8f6be0,
  @MaxExecutionsPerRun_Clear = 1,
  @ResultExpirationTurns = @ResultExpirationTurns_af8f6be0,
  @ResultExpirationTurns_Clear = 1,
  @ResultExpirationMode = @ResultExpirationMode_af8f6be0,
  @CompactMode = @CompactMode_af8f6be0,
  @CompactMode_Clear = 1,
  @CompactLength = @CompactLength_af8f6be0,
  @CompactLength_Clear = 1,
  @CompactPromptID = @CompactPromptID_af8f6be0,
  @CompactPromptID_Clear = 1;

GO

-- Save MJ: AI Agent Actions (core SP call only)
DECLARE @AgentID_59f02851 UNIQUEIDENTIFIER,
@ActionID_59f02851 UNIQUEIDENTIFIER,
@Status_59f02851 NVARCHAR(15),
@MinExecutionsPerRun_59f02851 INT,
@MaxExecutionsPerRun_59f02851 INT,
@ResultExpirationTurns_59f02851 INT,
@ResultExpirationMode_59f02851 NVARCHAR(20),
@CompactMode_59f02851 NVARCHAR(20),
@CompactLength_59f02851 INT,
@CompactPromptID_59f02851 UNIQUEIDENTIFIER,
@ID_59f02851 UNIQUEIDENTIFIER
SET
  @AgentID_59f02851 = '3AB78346-897F-4238-AA6A-F10A131CC691'
SET
  @ActionID_59f02851 = '3671FCE1-E4A1-4AB2-83E8-552D19E80A4F'
SET
  @Status_59f02851 = N'Active'
SET
  @ResultExpirationMode_59f02851 = N'None'
SET
  @ID_59f02851 = '67E333E0-0CC2-407B-855C-AD89EECB0CC4' EXEC [${flyway:defaultSchema}].spUpdateAIAgentAction @AgentID = @AgentID_59f02851,
  @ActionID = @ActionID_59f02851,
  @Status = @Status_59f02851,
  @MinExecutionsPerRun = @MinExecutionsPerRun_59f02851,
  @MinExecutionsPerRun_Clear = 1,
  @MaxExecutionsPerRun = @MaxExecutionsPerRun_59f02851,
  @MaxExecutionsPerRun_Clear = 1,
  @ResultExpirationTurns = @ResultExpirationTurns_59f02851,
  @ResultExpirationTurns_Clear = 1,
  @ResultExpirationMode = @ResultExpirationMode_59f02851,
  @CompactMode = @CompactMode_59f02851,
  @CompactMode_Clear = 1,
  @CompactLength = @CompactLength_59f02851,
  @CompactLength_Clear = 1,
  @CompactPromptID = @CompactPromptID_59f02851,
  @CompactPromptID_Clear = 1,
  @ID = @ID_59f02851;
...
DECLARE @JobTypeID_9c44506a UNIQUEIDENTIFIER,
@Name_9c44506a NVARCHAR(200),
@Description_9c44506a NVARCHAR(MAX),
@CronExpression_9c44506a NVARCHAR(120),
@Timezone_9c44506a NVARCHAR(64),
@StartAt_9c44506a DATETIMEOFFSET,
@EndAt_9c44506a DATETIMEOFFSET,
@Status_9c44506a NVARCHAR(20),
@Configuration_9c44506a NVARCHAR(MAX),
@OwnerUserID_9c44506a UNIQUEIDENTIFIER,
@LastRunAt_9c44506a DATETIMEOFFSET,
@NextRunAt_9c44506a DATETIMEOFFSET,
@RunCount_9c44506a INT,
@SuccessCount_9c44506a INT,
@FailureCount_9c44506a INT,
@NotifyOnSuccess_9c44506a BIT,
@NotifyOnFailure_9c44506a BIT,
@NotifyUserID_9c44506a UNIQUEIDENTIFIER,
@NotifyViaEmail_9c44506a BIT,
@NotifyViaInApp_9c44506a BIT,
@LockToken_9c44506a UNIQUEIDENTIFIER,
@LockedAt_9c44506a DATETIMEOFFSET,
@LockedByInstance_9c44506a NVARCHAR(255),
@ExpectedCompletionAt_9c44506a DATETIMEOFFSET,
@ConcurrencyMode_9c44506a NVARCHAR(20),
@ID_9c44506a UNIQUEIDENTIFIER
SET
  @JobTypeID_9c44506a = '3B94DD43-E961-4D85-B7F4-B6783D748766'
SET
  @Name_9c44506a = N'Geocoding Maintenance'
SET
  @Description_9c44506a = N'Runs on a recurring basis as a safety net for records that bypass BaseEntity.Save() (bulk SQL imports, direct DB operations). Live geocoding is handled inline during entity saves; this job finds and geocodes missing rows, retries failed attempts, and cleans up orphaned RecordGeoCode rows. Default cadence is weekly (Saturdays 2 AM UTC); administrators can adjust the CronExpression as needed.'
SET
  @CronExpression_9c44506a = N'0 0 2 * * 6'
SET
  @Timezone_9c44506a = N'UTC'
SET
  @Status_9c44506a = N'Active'
SET
  @Configuration_9c44506a = N'{
...
SET
  @TechnicalDesign_027f8063 = N'## Technical Architecture
...
SET
  @TechnicalDesign_f00c9726 = N'## Component Architecture
