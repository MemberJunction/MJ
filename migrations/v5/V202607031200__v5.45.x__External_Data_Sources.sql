...
CREATE TABLE ${flyway:defaultSchema}.ExternalDataSourceType (
    ...
    MetadataIntrospectionStrategy NVARCHAR(17)     NOT NULL CONSTRAINT DF_ExternalDataSourceType_MetadataIntrospectionStrategy DEFAULT (N'Manual'),
    FilterDialect                 NVARCHAR(9)      NOT NULL CONSTRAINT DF_ExternalDataSourceType_FilterDialect DEFAULT (N'ansi'),
    PagingStrategy                NVARCHAR(11)     NOT NULL CONSTRAINT DF_ExternalDataSourceType_PagingStrategy DEFAULT (N'LimitOffset'),
    ...
    Status                        NVARCHAR(10)     NOT NULL CONSTRAINT DF_ExternalDataSourceType_Status DEFAULT (N'Active'),
...
CREATE TABLE ${flyway:defaultSchema}.ExternalDataSource (
    ...
    Status                   NVARCHAR(10)     NOT NULL CONSTRAINT DF_ExternalDataSource_Status DEFAULT (N'Active'),
