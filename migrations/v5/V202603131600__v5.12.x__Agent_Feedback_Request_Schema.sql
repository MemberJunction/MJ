...
------------------------------------------------------------------------
CREATE TABLE ${flyway:defaultSchema}.AIAgentRequestType (
...
ALTER TABLE ${flyway:defaultSchema}.AIAgentRequest ADD
    RequestTypeID UNIQUEIDENTIFIER NULL
        CONSTRAINT FK_AIAgentRequest_RequestType
            FOREIGN KEY REFERENCES ${flyway:defaultSchema}.AIAgentRequestType(ID),
...
ALTER TABLE ${flyway:defaultSchema}.AIAgentRequest ADD
    ...
    OriginatingAgentRunStepID UNIQUEIDENTIFIER NULL
        CONSTRAINT FK_AIAgentRequest_OriginatingStep
            FOREIGN KEY REFERENCES ${flyway:defaultSchema}.AIAgentRunStep(ID),
...
WHERE ccu.TABLE_NAME = 'AIAgentRequest'
    ...
    AND ccu.TABLE_SCHEMA = '${flyway:defaultSchema}';

IF @ConstraintName IS NOT NULL
    EXEC('ALTER TABLE [${flyway:defaultSchema}].[AIAgentRequest] DROP CONSTRAINT [' + @ConstraintName + ']');

ALTER TABLE ${flyway:defaultSchema}.AIAgentRequest
    ADD CONSTRAINT CK_AIAgentRequest_Status
    CHECK (Status IN ('Requested', 'Approved', 'Rejected', 'Canceled', 'Responded', 'Expired'));
...
ALTER TABLE ${flyway:defaultSchema}.AIAgentRun
    ...
    CHECK (Status IN ('Running', 'Completed', 'Failed', 'Paused', 'Cancelled', 'AwaitingFeedback'));
...
EXEC sp_addextendedproperty
    ...
    @value = N'Lookup table categorizing the types of requests an agent can make to a human (e.g., Approval, Information, Choice, Review, Custom).',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequestType';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Primary key for the AIAgentRequestType record.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequestType',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Unique display name for the request type (e.g., Approval, Information, Choice).',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequestType',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Explains when and how this request type should be used by agents.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequestType',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Font Awesome icon class for UI rendering of this request type.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequestType',
    @level2type = N'COLUMN', @level2name = 'Icon';

-- AIAgentRequest new columns
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Foreign key to AIAgentRequestType. Categorizes the purpose of this request (Approval, Information, Choice, Review, Custom).',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
    @level2type = N'COLUMN', @level2name = 'RequestTypeID';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Foreign key to AIAgentRun. The agent run that created this request. Used to trace request origin in run chains.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
    @level2type = N'COLUMN', @level2name = 'OriginatingAgentRunID';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Foreign key to AIAgentRunStep. The specific execution step that triggered this request.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
    @level2type = N'COLUMN', @level2name = 'OriginatingAgentRunStepID';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Foreign key to AIAgentRun. The new agent run spawned after the human responds. NULL until a response triggers a resuming run.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
    @level2type = N'COLUMN', @level2name = 'ResumingAgentRunID';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'JSON-serialized AgentResponseForm defining the structured input form the agent presents to the human. Uses the same form types as ConversationDetail.ResponseForm.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
    @level2type = N'COLUMN', @level2name = 'ResponseSchema';

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'JSON structured response data provided by the human, conforming to the ResponseSchema definition.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Urgency level of the request as an integer from 1 (lowest) to 100 (highest). Default is 50. Suggested ranges: 1-25 Low, 26-50 Normal, 51-75 High, 76-100 Critical. Used for notification routing and dashboard sorting.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Optional deadline for the human to respond. After this time the request may be marked Expired by a background process.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = 'AIAgentRequest',
...
-- CODE GEN RUN
/* SQL generated to create new entity MJ: AI Agent Request Types */
...
INSERT INTO [${flyway:defaultSchema}].[ApplicationEntity]
                                       ...
                                       ('EBA5CCEC-6A37-EF11-86D4-000D3A4E707E', '359389b4-54d1-46b2-ad9a-5b84750bab0b', (SELECT COALESCE(MAX([Sequence]),0)+1 FROM [${flyway:defaultSchema}].[ApplicationEntity] WHERE [ApplicationID] = 'EBA5CCEC-6A37-EF11-86D4-000D3A4E707E'), GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Agent Request Types for role UI */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('359389b4-54d1-46b2-ad9a-5b84750bab0b', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Agent Request Types for role Developer */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('359389b4-54d1-46b2-ad9a-5b84750bab0b', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 0, GETUTCDATE(), GETUTCDATE())

/* SQL generated to add new permission for entity MJ: AI Agent Request Types for role Integration */
INSERT INTO [${flyway:defaultSchema}].[EntityPermission]
                                                   ([EntityID], [RoleID], [CanRead], [CanCreate], [CanUpdate], [CanDelete], [__mj_CreatedAt], [__mj_UpdatedAt]) VALUES
                                                   ('359389b4-54d1-46b2-ad9a-5b84750bab0b', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, GETUTCDATE(), GETUTCDATE())

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentRequestType] ADD [__mj_CreatedAt] DATETIMEOFFSET NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
UPDATE [${flyway:defaultSchema}].[AIAgentRequestType] SET [__mj_CreatedAt] = GETUTCDATE() WHERE [__mj_CreatedAt] IS NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentRequestType] ALTER COLUMN [__mj_CreatedAt] DATETIMEOFFSET NOT NULL

/* SQL text to add special date field __mj_CreatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentRequestType] ADD CONSTRAINT [DF___mj_AIAgentRequestType___mj_CreatedAt] DEFAULT GETUTCDATE() FOR [__mj_CreatedAt]

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentRequestType] ADD [__mj_UpdatedAt] DATETIMEOFFSET NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
UPDATE [${flyway:defaultSchema}].[AIAgentRequestType] SET [__mj_UpdatedAt] = GETUTCDATE() WHERE [__mj_UpdatedAt] IS NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentRequestType] ALTER COLUMN [__mj_UpdatedAt] DATETIMEOFFSET NOT NULL

/* SQL text to add special date field __mj_UpdatedAt to entity ${flyway:defaultSchema}.AIAgentRequestType */
ALTER TABLE [${flyway:defaultSchema}].[AIAgentRequestType] ADD CONSTRAINT [DF___mj_AIAgentRequestType___mj_UpdatedAt] DEFAULT GETUTCDATE() FOR [__mj_UpdatedAt]

/* SQL text to insert new entity field */

      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '0e5a2a82-c652-4a76-83b5-5fa95dce7bea' OR (EntityID = '359389B4-54D1-46B2-AD9A-5B84750BAB0B' AND Name = 'ID')) BEGIN
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'd6058f94-a6ca-45f2-8887-a8657aa0d03d' OR (EntityID = '359389B4-54D1-46B2-AD9A-5B84750BAB0B' AND Name = 'Name')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5441ec95-10ae-4c2a-bd85-a4f66012c565' OR (EntityID = '359389B4-54D1-46B2-AD9A-5B84750BAB0B' AND Name = 'Description')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '447bcc32-2000-4d69-97f8-3479ed7a2f4c' OR (EntityID = '359389B4-54D1-46B2-AD9A-5B84750BAB0B' AND Name = 'Icon')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'ffebd1a8-7a54-4412-a949-0a517a9d8830' OR (EntityID = '359389B4-54D1-46B2-AD9A-5B84750BAB0B' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '3898514f-6afe-4a20-93a2-101b3ee8fa9f' OR (EntityID = '359389B4-54D1-46B2-AD9A-5B84750BAB0B' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'a3e5ad0c-1968-467e-96ff-41d2b0d9358b' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'RequestTypeID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5810273c-6dcb-4772-b0cd-7b989b387103' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'ResponseSchema')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5f756ffd-34b0-462d-97d3-d4237fda6c73' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'ResponseData')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '4fea225c-8d62-4c2b-b8e6-db2869a59bdc' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'Priority')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '0567323b-a358-4dd9-b3f3-81c0a94c4bc6' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'ExpiresAt')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '7c9db7fc-90b2-4ecf-b82a-70a97ae1f796' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'OriginatingAgentRunID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '1529bd25-4ad9-4888-8687-a926959493d9' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'OriginatingAgentRunStepID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b78b06d4-671a-4ce5-a9b9-cabd224b2a08' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'ResumingAgentRunID')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert entity field value with ID a55208ff-c607-4949-a95a-eb3aa4fd71f2 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('a55208ff-c607-4949-a95a-eb3aa4fd71f2', '49218650-7B04-4C4C-B109-A255D6627EAB', 3, 'Expired', 'Expired', GETUTCDATE(), GETUTCDATE())

/* SQL text to insert entity field value with ID b6b2cdc5-6e5e-4205-b063-d2e68fd66b33 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('b6b2cdc5-6e5e-4205-b063-d2e68fd66b33', '49218650-7B04-4C4C-B109-A255D6627EAB', 6, 'Responded', 'Responded', GETUTCDATE(), GETUTCDATE())

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].[EntityFieldValue] SET Sequence=4 WHERE ID='9513B49C-D722-4E28-85BF-9E05A1990F85'

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].[EntityFieldValue] SET Sequence=5 WHERE ID='4207D942-832E-441D-8EEE-8EFA40BFF275'

/* SQL text to insert entity field value with ID 97ce7555-796b-4601-ae92-d86fc2e102e0 */
INSERT INTO [${flyway:defaultSchema}].[EntityFieldValue]
                                       ([ID], [EntityFieldID], [Sequence], [Value], [Code], [__mj_CreatedAt], [__mj_UpdatedAt])
                                    VALUES
                                       ('97ce7555-796b-4601-ae92-d86fc2e102e0', 'E1F5A7A4-9248-4C45-9D74-04E7B44A1DD5', 1, 'AwaitingFeedback', 'AwaitingFeedback', GETUTCDATE(), GETUTCDATE())

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].[EntityFieldValue] SET Sequence=2 WHERE ID='87BAE441-C0F4-4246-A1BE-CAAE5E4C79D8'

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].[EntityFieldValue] SET Sequence=3 WHERE ID='E8B058D3-2148-42CE-9350-F7FB13E99EF5'

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].[EntityFieldValue] SET Sequence=4 WHERE ID='75970520-CE25-46CC-BF7E-4BAE6E379CD5'

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].[EntityFieldValue] SET Sequence=5 WHERE ID='C393F41A-7889-479E-BAAD-E3556141E909'

/* SQL text to update entity field value sequence */
UPDATE [${flyway:defaultSchema}].[EntityFieldValue] SET Sequence=6 WHERE ID='8CC6137B-B688-49F1-BE9E-C31B5D8B8FFA'


/* Create Entity Relationship: MJ: AI Agent Runs -> MJ: AI Agent Requests (One To Many via OriginatingAgentRunID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '79240ba0-0b84-453a-819b-7af6637358ed'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('79240ba0-0b84-453a-819b-7af6637358ed', '5190AF93-4C39-4429-BDAA-0AEB492A0256', 'F3C49FE2-B5D9-40D4-8562-6596261772A0', 'OriginatingAgentRunID', 'One To Many', 1, 1, 1, GETUTCDATE(), GETUTCDATE())
   END;
                    
/* Create Entity Relationship: MJ: AI Agent Runs -> MJ: AI Agent Requests (One To Many via ResumingAgentRunID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '6300b4dd-47ae-4837-bf8e-f4e75d39ceb0'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('6300b4dd-47ae-4837-bf8e-f4e75d39ceb0', '5190AF93-4C39-4429-BDAA-0AEB492A0256', 'F3C49FE2-B5D9-40D4-8562-6596261772A0', 'ResumingAgentRunID', 'One To Many', 1, 1, 2, GETUTCDATE(), GETUTCDATE())
   END;
                    


/* Create Entity Relationship: MJ: AI Agent Request Types -> MJ: AI Agent Requests (One To Many via RequestTypeID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = '988e370f-6ee2-4240-9fce-2ccd40082df1'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('988e370f-6ee2-4240-9fce-2ccd40082df1', '359389B4-54D1-46B2-AD9A-5B84750BAB0B', 'F3C49FE2-B5D9-40D4-8562-6596261772A0', 'RequestTypeID', 'One To Many', 1, 1, 3, GETUTCDATE(), GETUTCDATE())
   END;
                    


/* Create Entity Relationship: MJ: AI Agent Run Steps -> MJ: AI Agent Requests (One To Many via OriginatingAgentRunStepID) */
   IF NOT EXISTS (
      SELECT 1 FROM [${flyway:defaultSchema}].[EntityRelationship] WHERE [ID] = 'c290b895-aca8-4403-96f8-86a47836be53'
   )
   BEGIN
      INSERT INTO [${flyway:defaultSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('c290b895-aca8-4403-96f8-86a47836be53', '99273DAD-560E-4ABC-8332-C97AB58B7463', 'F3C49FE2-B5D9-40D4-8562-6596261772A0', 'OriginatingAgentRunStepID', 'One To Many', 1, 1, 4, GETUTCDATE(), GETUTCDATE())
   END;
...
/* SQL text to update entity field related entity name field map for entity field ID A3E5AD0C-1968-467E-96FF-41D2B0D9358B */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='A3E5AD0C-1968-467E-96FF-41D2B0D9358B', @RelatedEntityNameFieldMap='RequestType'
...
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='7C9DB7FC-90B2-4ECF-B82A-70A97AE1F796', @RelatedEntityNameFieldMap='OriginatingAgentRun'

/* SQL text to update entity field related entity name field map for entity field ID 1529BD25-4AD9-4888-8687-A926959493D9 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='1529BD25-4AD9-4888-8687-A926959493D9', @RelatedEntityNameFieldMap='OriginatingAgentRunStep'

/* SQL text to update entity field related entity name field map for entity field ID B78B06D4-671A-4CE5-A9B9-CABD224B2A08 */
EXEC [${flyway:defaultSchema}].[spUpdateEntityFieldRelatedEntityNameFieldMap] @EntityFieldID='B78B06D4-671A-4CE5-A9B9-CABD224B2A08', @RelatedEntityNameFieldMap='ResumingAgentRun'
...
BEGIN
    ...
    DECLARE cascade_update_MJAIAgentRequests_OriginatingAgentRunStepID_cursor CURSOR FOR
        SELECT [ID], [AgentID], [RequestedAt], [RequestForUserID], [Status], [Request], [Response], [ResponseByUserID], [RespondedAt], [Comments], [RequestTypeID], [ResponseSchema], [ResponseData], [Priority], [ExpiresAt], [OriginatingAgentRunID], [OriginatingAgentRunStepID], [ResumingAgentRunID]
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'b8a7ba61-a0de-461b-af00-a83d51b7bfa3' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'RequestType')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '91461548-61c8-4d64-8e95-cf809a82e9e1' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'OriginatingAgentRun')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = '5038de6b-9e95-46fd-9784-9d95066d3135' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'OriginatingAgentRunStep')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[EntityField] WHERE ID = 'fed675fa-60fe-47ed-ac35-221cb7797ca4' OR (EntityID = 'F3C49FE2-B5D9-40D4-8562-6596261772A0' AND Name = 'ResumingAgentRun')) BEGIN
         INSERT INTO [${flyway:defaultSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
/* Insert FieldCategoryInfo setting for entity */
               ...
               VALUES ('4d5a9c81-ddc8-4bfb-8926-7c1198e23d4f', '359389B4-54D1-46B2-AD9A-5B84750BAB0B', 'FieldCategoryInfo', '{"Request Type Configuration":{"icon":"fa fa-tasks","description":"Core settings defining how the AI agent request type appears and functions"},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit fields and technical identifiers"}}', GETUTCDATE(), GETUTCDATE())
            

/* Insert FieldCategoryIcons setting (legacy) */

               INSERT INTO [${flyway:defaultSchema}].[EntitySetting] (ID, EntityID, Name, Value, __mj_CreatedAt, __mj_UpdatedAt)
               VALUES ('4f603fbc-51be-49cb-9740-e2caf08818e2', '359389B4-54D1-46B2-AD9A-5B84750BAB0B', 'FieldCategoryIcons', '{"Request Type Configuration":"fa fa-tasks","System Metadata":"fa fa-cog"}', GETUTCDATE(), GETUTCDATE())
...
/* Update FieldCategoryInfo setting for entity */
               ...
               SET Value = '{"Execution Context":{"icon":"fa fa-project-diagram","description":"Traceability details linking this request to the specific AI agent runs and execution steps that generated or resumed from it."}}', __mj_UpdatedAt = GETUTCDATE()
...
/* Update FieldCategoryIcons setting (legacy) */
               ...
               UPDATE [${flyway:defaultSchema}].[EntitySetting]
               SET Value = '{"Execution Context":"fa fa-project-diagram"}', __mj_UpdatedAt = GETUTCDATE()
...
INSERT INTO [${flyway:defaultSchema}].[GeneratedCode] (CategoryID, GeneratedByModelID, GeneratedAt, Language, Status, Source, Code, Description, Name, LinkedEntityID, LinkedRecordPrimaryKey)
                      VALUES ((SELECT ID FROM ${flyway:defaultSchema}.vwGeneratedCodeCategories WHERE Name='CodeGen: Validators'), '7B31F48E-EDA3-47B4-9602-D98B7EB1AF45', GETUTCDATE(), 'TypeScript','Approved', '([Priority]>=(1) AND [Priority]<=(100))', 'public ValidatePriorityRange(result: ValidationResult) {
