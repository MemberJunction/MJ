...
DECLARE @CategoryID_70a12cfb UNIQUEIDENTIFIER,
@Name_70a12cfb NVARCHAR(425),
@Description_70a12cfb NVARCHAR(MAX),
@Type_70a12cfb NVARCHAR(20),
@UserPrompt_70a12cfb NVARCHAR(MAX),
@UserComments_70a12cfb NVARCHAR(MAX),
@Code_70a12cfb NVARCHAR(MAX),
@CodeComments_70a12cfb NVARCHAR(MAX),
@CodeApprovalStatus_70a12cfb NVARCHAR(20),
@CodeApprovalComments_70a12cfb NVARCHAR(MAX),
@CodeApprovedByUserID_70a12cfb UNIQUEIDENTIFIER,
@CodeApprovedAt_70a12cfb DATETIMEOFFSET,
@CodeLocked_70a12cfb BIT,
@ForceCodeGeneration_70a12cfb BIT,
@RetentionPeriod_70a12cfb INT,
@Status_70a12cfb NVARCHAR(20),
@DriverClass_70a12cfb NVARCHAR(255),
@ParentID_70a12cfb UNIQUEIDENTIFIER,
@IconClass_70a12cfb NVARCHAR(100),
@DefaultCompactPromptID_70a12cfb UNIQUEIDENTIFIER,
@Config_70a12cfb NVARCHAR(MAX),
@RuntimeActionConfiguration_70a12cfb NVARCHAR(MAX),
@MaxExecutionTimeMS_70a12cfb INT,
@CreatedByAgentID_70a12cfb UNIQUEIDENTIFIER,
@ID_70a12cfb UNIQUEIDENTIFIER
SET
  @CategoryID_70a12cfb = 'AC840000-4E65-4986-BA0D-1768BC76B217'
SET
  @Name_70a12cfb = N'Create Entity'
SET
  @Description_70a12cfb = N'Creates a new MemberJunction entity from a fully-formed TableDefinition. Validates authorization then executes the SchemaEngine → RuntimeSchemaManager pipeline. Use this when an agent needs to create a new database table without going through the full conversational Database Designer flow.'
SET
  @Type_70a12cfb = N'Custom'
SET
  @CodeApprovalStatus_70a12cfb = N'Pending'
SET
  @CodeLocked_70a12cfb = 0
SET
  @ForceCodeGeneration_70a12cfb = 0
SET
  @Status_70a12cfb = N'Active'
SET
  @DriverClass_70a12cfb = N'Create Entity'
SET
  @IconClass_70a12cfb = N'fa-solid fa-table-columns'
SET
  @ID_70a12cfb = 'F4CBD4ED-C258-468B-8F50-F12E4C74A431' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_70a12cfb,
  @Name = @Name_70a12cfb,
  @Description = @Description_70a12cfb,
  @Type = @Type_70a12cfb,
  @UserPrompt = @UserPrompt_70a12cfb,
  @UserComments = @UserComments_70a12cfb,
  @Code = @Code_70a12cfb,
  @CodeComments = @CodeComments_70a12cfb,
  @CodeApprovalStatus = @CodeApprovalStatus_70a12cfb,
  @CodeApprovalComments = @CodeApprovalComments_70a12cfb,
  @CodeApprovedByUserID = @CodeApprovedByUserID_70a12cfb,
  @CodeApprovedAt = @CodeApprovedAt_70a12cfb,
  @CodeLocked = @CodeLocked_70a12cfb,
  @ForceCodeGeneration = @ForceCodeGeneration_70a12cfb,
  @RetentionPeriod = @RetentionPeriod_70a12cfb,
  @Status = @Status_70a12cfb,
  @DriverClass = @DriverClass_70a12cfb,
  @ParentID = @ParentID_70a12cfb,
  @IconClass = @IconClass_70a12cfb,
  @DefaultCompactPromptID = @DefaultCompactPromptID_70a12cfb,
  @Config = @Config_70a12cfb,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_70a12cfb,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_70a12cfb,
  @CreatedByAgentID = @CreatedByAgentID_70a12cfb,
  @ID = @ID_70a12cfb;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_8d25a44f UNIQUEIDENTIFIER,
@Name_8d25a44f NVARCHAR(425),
@Description_8d25a44f NVARCHAR(MAX),
@Type_8d25a44f NVARCHAR(20),
@UserPrompt_8d25a44f NVARCHAR(MAX),
@UserComments_8d25a44f NVARCHAR(MAX),
@Code_8d25a44f NVARCHAR(MAX),
@CodeComments_8d25a44f NVARCHAR(MAX),
@CodeApprovalStatus_8d25a44f NVARCHAR(20),
@CodeApprovalComments_8d25a44f NVARCHAR(MAX),
@CodeApprovedByUserID_8d25a44f UNIQUEIDENTIFIER,
@CodeApprovedAt_8d25a44f DATETIMEOFFSET,
@CodeLocked_8d25a44f BIT,
@ForceCodeGeneration_8d25a44f BIT,
@RetentionPeriod_8d25a44f INT,
@Status_8d25a44f NVARCHAR(20),
@DriverClass_8d25a44f NVARCHAR(255),
@ParentID_8d25a44f UNIQUEIDENTIFIER,
@IconClass_8d25a44f NVARCHAR(100),
@DefaultCompactPromptID_8d25a44f UNIQUEIDENTIFIER,
@Config_8d25a44f NVARCHAR(MAX),
@RuntimeActionConfiguration_8d25a44f NVARCHAR(MAX),
@MaxExecutionTimeMS_8d25a44f INT,
@CreatedByAgentID_8d25a44f UNIQUEIDENTIFIER,
@ID_8d25a44f UNIQUEIDENTIFIER
SET
  @CategoryID_8d25a44f = 'AC840000-4E65-4986-BA0D-1768BC76B217'
SET
  @Name_8d25a44f = N'Modify Entity'
SET
  @Description_8d25a44f = N'Applies ALTER TABLE changes to an existing MemberJunction entity based on a desired TableDefinition. Diffs the desired state against the current table, generates ALTER SQL, and executes the pipeline.'
SET
  @Type_8d25a44f = N'Custom'
SET
  @CodeApprovalStatus_8d25a44f = N'Pending'
SET
  @CodeLocked_8d25a44f = 0
SET
  @ForceCodeGeneration_8d25a44f = 0
SET
  @Status_8d25a44f = N'Active'
SET
  @DriverClass_8d25a44f = N'Modify Entity'
SET
  @IconClass_8d25a44f = N'fa-solid fa-table-list'
SET
  @ID_8d25a44f = '667901A9-8E3C-498A-9BFA-D511130ED451' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_8d25a44f,
  @Name = @Name_8d25a44f,
  @Description = @Description_8d25a44f,
  @Type = @Type_8d25a44f,
  @UserPrompt = @UserPrompt_8d25a44f,
  @UserComments = @UserComments_8d25a44f,
  @Code = @Code_8d25a44f,
  @CodeComments = @CodeComments_8d25a44f,
  @CodeApprovalStatus = @CodeApprovalStatus_8d25a44f,
  @CodeApprovalComments = @CodeApprovalComments_8d25a44f,
  @CodeApprovedByUserID = @CodeApprovedByUserID_8d25a44f,
  @CodeApprovedAt = @CodeApprovedAt_8d25a44f,
  @CodeLocked = @CodeLocked_8d25a44f,
  @ForceCodeGeneration = @ForceCodeGeneration_8d25a44f,
  @RetentionPeriod = @RetentionPeriod_8d25a44f,
  @Status = @Status_8d25a44f,
  @DriverClass = @DriverClass_8d25a44f,
  @ParentID = @ParentID_8d25a44f,
  @IconClass = @IconClass_8d25a44f,
  @DefaultCompactPromptID = @DefaultCompactPromptID_8d25a44f,
  @Config = @Config_8d25a44f,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_8d25a44f,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_8d25a44f,
  @CreatedByAgentID = @CreatedByAgentID_8d25a44f,
  @ID = @ID_8d25a44f;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_2f619905 UNIQUEIDENTIFIER,
@Name_2f619905 NVARCHAR(425),
@Description_2f619905 NVARCHAR(MAX),
@Type_2f619905 NVARCHAR(20),
@UserPrompt_2f619905 NVARCHAR(MAX),
@UserComments_2f619905 NVARCHAR(MAX),
@Code_2f619905 NVARCHAR(MAX),
@CodeComments_2f619905 NVARCHAR(MAX),
@CodeApprovalStatus_2f619905 NVARCHAR(20),
@CodeApprovalComments_2f619905 NVARCHAR(MAX),
@CodeApprovedByUserID_2f619905 UNIQUEIDENTIFIER,
@CodeApprovedAt_2f619905 DATETIMEOFFSET,
@CodeLocked_2f619905 BIT,
@ForceCodeGeneration_2f619905 BIT,
@RetentionPeriod_2f619905 INT,
@Status_2f619905 NVARCHAR(20),
@DriverClass_2f619905 NVARCHAR(255),
@ParentID_2f619905 UNIQUEIDENTIFIER,
@IconClass_2f619905 NVARCHAR(100),
@DefaultCompactPromptID_2f619905 UNIQUEIDENTIFIER,
@Config_2f619905 NVARCHAR(MAX),
@RuntimeActionConfiguration_2f619905 NVARCHAR(MAX),
@MaxExecutionTimeMS_2f619905 INT,
@CreatedByAgentID_2f619905 UNIQUEIDENTIFIER,
@ID_2f619905 UNIQUEIDENTIFIER
SET
  @CategoryID_2f619905 = 'AC840000-4E65-4986-BA0D-1768BC76B217'
SET
  @Name_2f619905 = N'List My Entities'
SET
  @Description_2f619905 = N'Returns a list of all MemberJunction entities created by the current user via the Database Designer (based on MJ:UDT:Owner EntitySettings provenance records).'
SET
  @Type_2f619905 = N'Custom'
SET
  @CodeApprovalStatus_2f619905 = N'Pending'
SET
  @CodeLocked_2f619905 = 0
SET
  @ForceCodeGeneration_2f619905 = 0
SET
  @Status_2f619905 = N'Active'
SET
  @DriverClass_2f619905 = N'List My Entities'
SET
  @IconClass_2f619905 = N'fa-solid fa-list'
SET
  @ID_2f619905 = '6AF1D93B-54F9-4360-9122-4C9D0332E327' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_2f619905,
  @Name = @Name_2f619905,
  @Description = @Description_2f619905,
  @Type = @Type_2f619905,
  @UserPrompt = @UserPrompt_2f619905,
  @UserComments = @UserComments_2f619905,
  @Code = @Code_2f619905,
  @CodeComments = @CodeComments_2f619905,
  @CodeApprovalStatus = @CodeApprovalStatus_2f619905,
  @CodeApprovalComments = @CodeApprovalComments_2f619905,
  @CodeApprovedByUserID = @CodeApprovedByUserID_2f619905,
  @CodeApprovedAt = @CodeApprovedAt_2f619905,
  @CodeLocked = @CodeLocked_2f619905,
  @ForceCodeGeneration = @ForceCodeGeneration_2f619905,
  @RetentionPeriod = @RetentionPeriod_2f619905,
  @Status = @Status_2f619905,
  @DriverClass = @DriverClass_2f619905,
  @ParentID = @ParentID_2f619905,
  @IconClass = @IconClass_2f619905,
  @DefaultCompactPromptID = @DefaultCompactPromptID_2f619905,
  @Config = @Config_2f619905,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_2f619905,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_2f619905,
  @CreatedByAgentID = @CreatedByAgentID_2f619905,
  @ID = @ID_2f619905;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_992cd071 UNIQUEIDENTIFIER,
@Name_992cd071 NVARCHAR(425),
@Description_992cd071 NVARCHAR(MAX),
@Type_992cd071 NVARCHAR(20),
@UserPrompt_992cd071 NVARCHAR(MAX),
@UserComments_992cd071 NVARCHAR(MAX),
@Code_992cd071 NVARCHAR(MAX),
@CodeComments_992cd071 NVARCHAR(MAX),
@CodeApprovalStatus_992cd071 NVARCHAR(20),
@CodeApprovalComments_992cd071 NVARCHAR(MAX),
@CodeApprovedByUserID_992cd071 UNIQUEIDENTIFIER,
@CodeApprovedAt_992cd071 DATETIMEOFFSET,
@CodeLocked_992cd071 BIT,
@ForceCodeGeneration_992cd071 BIT,
@RetentionPeriod_992cd071 INT,
@Status_992cd071 NVARCHAR(20),
@DriverClass_992cd071 NVARCHAR(255),
@ParentID_992cd071 UNIQUEIDENTIFIER,
@IconClass_992cd071 NVARCHAR(100),
@DefaultCompactPromptID_992cd071 UNIQUEIDENTIFIER,
@Config_992cd071 NVARCHAR(MAX),
@RuntimeActionConfiguration_992cd071 NVARCHAR(MAX),
@MaxExecutionTimeMS_992cd071 INT,
@CreatedByAgentID_992cd071 UNIQUEIDENTIFIER,
@ID_992cd071 UNIQUEIDENTIFIER
SET
  @CategoryID_992cd071 = 'AC840000-4E65-4986-BA0D-1768BC76B217'
SET
  @Name_992cd071 = N'Describe Entity'
SET
  @Description_992cd071 = N'Returns detailed column-level metadata for a MemberJunction entity. Useful for inspecting an entity''s current structure before deciding to modify it.'
SET
  @Type_992cd071 = N'Custom'
SET
  @CodeApprovalStatus_992cd071 = N'Pending'
SET
  @CodeLocked_992cd071 = 0
SET
  @ForceCodeGeneration_992cd071 = 0
SET
  @Status_992cd071 = N'Active'
SET
  @DriverClass_992cd071 = N'Describe Entity'
SET
  @IconClass_992cd071 = N'fa-solid fa-info-circle'
SET
  @ID_992cd071 = '0121B620-98E3-41F7-878A-F11F0756CDE2' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_992cd071,
  @Name = @Name_992cd071,
  @Description = @Description_992cd071,
  @Type = @Type_992cd071,
  @UserPrompt = @UserPrompt_992cd071,
  @UserComments = @UserComments_992cd071,
  @Code = @Code_992cd071,
  @CodeComments = @CodeComments_992cd071,
  @CodeApprovalStatus = @CodeApprovalStatus_992cd071,
  @CodeApprovalComments = @CodeApprovalComments_992cd071,
  @CodeApprovedByUserID = @CodeApprovedByUserID_992cd071,
  @CodeApprovedAt = @CodeApprovedAt_992cd071,
  @CodeLocked = @CodeLocked_992cd071,
  @ForceCodeGeneration = @ForceCodeGeneration_992cd071,
  @RetentionPeriod = @RetentionPeriod_992cd071,
  @Status = @Status_992cd071,
  @DriverClass = @DriverClass_992cd071,
  @ParentID = @ParentID_992cd071,
  @IconClass = @IconClass_992cd071,
  @DefaultCompactPromptID = @DefaultCompactPromptID_992cd071,
  @Config = @Config_992cd071,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_992cd071,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_992cd071,
  @CreatedByAgentID = @CreatedByAgentID_992cd071,
  @ID = @ID_992cd071;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_fa05bd6f UNIQUEIDENTIFIER,
@Name_fa05bd6f NVARCHAR(425),
@Description_fa05bd6f NVARCHAR(MAX),
@Type_fa05bd6f NVARCHAR(20),
@UserPrompt_fa05bd6f NVARCHAR(MAX),
@UserComments_fa05bd6f NVARCHAR(MAX),
@Code_fa05bd6f NVARCHAR(MAX),
@CodeComments_fa05bd6f NVARCHAR(MAX),
@CodeApprovalStatus_fa05bd6f NVARCHAR(20),
@CodeApprovalComments_fa05bd6f NVARCHAR(MAX),
@CodeApprovedByUserID_fa05bd6f UNIQUEIDENTIFIER,
@CodeApprovedAt_fa05bd6f DATETIMEOFFSET,
@CodeLocked_fa05bd6f BIT,
@ForceCodeGeneration_fa05bd6f BIT,
@RetentionPeriod_fa05bd6f INT,
@Status_fa05bd6f NVARCHAR(20),
@DriverClass_fa05bd6f NVARCHAR(255),
@ParentID_fa05bd6f UNIQUEIDENTIFIER,
@IconClass_fa05bd6f NVARCHAR(100),
@DefaultCompactPromptID_fa05bd6f UNIQUEIDENTIFIER,
@Config_fa05bd6f NVARCHAR(MAX),
@RuntimeActionConfiguration_fa05bd6f NVARCHAR(MAX),
@MaxExecutionTimeMS_fa05bd6f INT,
@CreatedByAgentID_fa05bd6f UNIQUEIDENTIFIER,
@ID_fa05bd6f UNIQUEIDENTIFIER
SET
  @CategoryID_fa05bd6f = '22285832-93AD-427E-81BA-E332F63FC5B9'
SET
  @Name_fa05bd6f = N'Entity Data Quality Report'
SET
  @Description_fa05bd6f = N'Scans a sample of records for a given entity and returns a data quality report: per-field null rates, distinct value counts, and an overall completeness score (0-1) that weights non-nullable fields 2x. Useful for data stewards triaging bad data. Exercises the `md` (entity introspection) and `rv` (RunView) bridge namespaces.'
SET
  @Type_fa05bd6f = N'Runtime'
SET
  @Code_fa05bd6f = N'// Entity Data Quality Report — md + rv Runtime action.
//
...
'
SET
  @CodeApprovalStatus_fa05bd6f = N'Approved'
SET
  @CodeLocked_fa05bd6f = 0
SET
  @ForceCodeGeneration_fa05bd6f = 0
SET
  @Status_fa05bd6f = N'Active'
SET
  @IconClass_fa05bd6f = N'fa-solid fa-magnifying-glass-chart'
SET
  @RuntimeActionConfiguration_fa05bd6f = N'{
  "permissions": {
    "allowedActions": [],
    "allowedAgents": [],
    "allowedEntities": [],
...
SET
  @MaxExecutionTimeMS_fa05bd6f = 60000
SET
  @ID_fa05bd6f = '1FA27C4C-34A7-4E1C-8134-6736F3781C8F' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_fa05bd6f,
  @Name = @Name_fa05bd6f,
  @Description = @Description_fa05bd6f,
  @Type = @Type_fa05bd6f,
  @UserPrompt = @UserPrompt_fa05bd6f,
  @UserComments = @UserComments_fa05bd6f,
  @Code = @Code_fa05bd6f,
  @CodeComments = @CodeComments_fa05bd6f,
  @CodeApprovalStatus = @CodeApprovalStatus_fa05bd6f,
  @CodeApprovalComments = @CodeApprovalComments_fa05bd6f,
  @CodeApprovedByUserID = @CodeApprovedByUserID_fa05bd6f,
  @CodeApprovedAt = @CodeApprovedAt_fa05bd6f,
  @CodeLocked = @CodeLocked_fa05bd6f,
  @ForceCodeGeneration = @ForceCodeGeneration_fa05bd6f,
  @RetentionPeriod = @RetentionPeriod_fa05bd6f,
  @Status = @Status_fa05bd6f,
  @DriverClass = @DriverClass_fa05bd6f,
  @ParentID = @ParentID_fa05bd6f,
  @IconClass = @IconClass_fa05bd6f,
  @DefaultCompactPromptID = @DefaultCompactPromptID_fa05bd6f,
  @Config = @Config_fa05bd6f,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_fa05bd6f,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_fa05bd6f,
  @CreatedByAgentID = @CreatedByAgentID_fa05bd6f,
  @ID = @ID_fa05bd6f;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_7d26ce00 UNIQUEIDENTIFIER,
@Name_7d26ce00 NVARCHAR(425),
@Description_7d26ce00 NVARCHAR(MAX),
@Type_7d26ce00 NVARCHAR(20),
@UserPrompt_7d26ce00 NVARCHAR(MAX),
@UserComments_7d26ce00 NVARCHAR(MAX),
@Code_7d26ce00 NVARCHAR(MAX),
@CodeComments_7d26ce00 NVARCHAR(MAX),
@CodeApprovalStatus_7d26ce00 NVARCHAR(20),
@CodeApprovalComments_7d26ce00 NVARCHAR(MAX),
@CodeApprovedByUserID_7d26ce00 UNIQUEIDENTIFIER,
@CodeApprovedAt_7d26ce00 DATETIMEOFFSET,
@CodeLocked_7d26ce00 BIT,
@ForceCodeGeneration_7d26ce00 BIT,
@RetentionPeriod_7d26ce00 INT,
@Status_7d26ce00 NVARCHAR(20),
@DriverClass_7d26ce00 NVARCHAR(255),
@ParentID_7d26ce00 UNIQUEIDENTIFIER,
@IconClass_7d26ce00 NVARCHAR(100),
@DefaultCompactPromptID_7d26ce00 UNIQUEIDENTIFIER,
@Config_7d26ce00 NVARCHAR(MAX),
@RuntimeActionConfiguration_7d26ce00 NVARCHAR(MAX),
@MaxExecutionTimeMS_7d26ce00 INT,
@CreatedByAgentID_7d26ce00 UNIQUEIDENTIFIER,
@ID_7d26ce00 UNIQUEIDENTIFIER
SET
  @CategoryID_7d26ce00 = '22285832-93AD-427E-81BA-E332F63FC5B9'
SET
  @Name_7d26ce00 = N'Find Similar Records'
SET
  @Description_7d26ce00 = N'Finds records in an entity whose text field is similar to a search string. Ranks matches by a blended score (30% containment, 70% normalized Levenshtein) so both typos and long-substring matches rank well. No AI dependency — cheap and deterministic. Validates the target field via metadata before scanning.'
SET
  @Type_7d26ce00 = N'Runtime'
SET
  @Code_7d26ce00 = N'// Find Similar Records — md + rv + compute Runtime action.
//
...
'
SET
  @CodeApprovalStatus_7d26ce00 = N'Approved'
SET
  @CodeLocked_7d26ce00 = 0
SET
  @ForceCodeGeneration_7d26ce00 = 0
SET
  @Status_7d26ce00 = N'Active'
SET
  @IconClass_7d26ce00 = N'fa-solid fa-magnifying-glass-location'
SET
  @RuntimeActionConfiguration_7d26ce00 = N'{
  "permissions": {
    "allowedActions": [],
    "allowedAgents": [],
    "allowedEntities": [],
...
SET
  @MaxExecutionTimeMS_7d26ce00 = 60000
SET
  @ID_7d26ce00 = '8785E9AA-AF9D-41EF-A8B8-7CA524785DA6' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_7d26ce00,
  @Name = @Name_7d26ce00,
  @Description = @Description_7d26ce00,
  @Type = @Type_7d26ce00,
  @UserPrompt = @UserPrompt_7d26ce00,
  @UserComments = @UserComments_7d26ce00,
  @Code = @Code_7d26ce00,
  @CodeComments = @CodeComments_7d26ce00,
  @CodeApprovalStatus = @CodeApprovalStatus_7d26ce00,
  @CodeApprovalComments = @CodeApprovalComments_7d26ce00,
  @CodeApprovedByUserID = @CodeApprovedByUserID_7d26ce00,
  @CodeApprovedAt = @CodeApprovedAt_7d26ce00,
  @CodeLocked = @CodeLocked_7d26ce00,
  @ForceCodeGeneration = @ForceCodeGeneration_7d26ce00,
  @RetentionPeriod = @RetentionPeriod_7d26ce00,
  @Status = @Status_7d26ce00,
  @DriverClass = @DriverClass_7d26ce00,
  @ParentID = @ParentID_7d26ce00,
  @IconClass = @IconClass_7d26ce00,
  @DefaultCompactPromptID = @DefaultCompactPromptID_7d26ce00,
  @Config = @Config_7d26ce00,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_7d26ce00,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_7d26ce00,
  @CreatedByAgentID = @CreatedByAgentID_7d26ce00,
  @ID = @ID_7d26ce00;

GO

-- Save MJ: Actions (core SP call only)
DECLARE @CategoryID_0bb82d7c UNIQUEIDENTIFIER,
@Name_0bb82d7c NVARCHAR(425),
@Description_0bb82d7c NVARCHAR(MAX),
@Type_0bb82d7c NVARCHAR(20),
@UserPrompt_0bb82d7c NVARCHAR(MAX),
@UserComments_0bb82d7c NVARCHAR(MAX),
@Code_0bb82d7c NVARCHAR(MAX),
@CodeComments_0bb82d7c NVARCHAR(MAX),
@CodeApprovalStatus_0bb82d7c NVARCHAR(20),
@CodeApprovalComments_0bb82d7c NVARCHAR(MAX),
@CodeApprovedByUserID_0bb82d7c UNIQUEIDENTIFIER,
@CodeApprovedAt_0bb82d7c DATETIMEOFFSET,
@CodeLocked_0bb82d7c BIT,
@ForceCodeGeneration_0bb82d7c BIT,
@RetentionPeriod_0bb82d7c INT,
@Status_0bb82d7c NVARCHAR(20),
@DriverClass_0bb82d7c NVARCHAR(255),
@ParentID_0bb82d7c UNIQUEIDENTIFIER,
@IconClass_0bb82d7c NVARCHAR(100),
@DefaultCompactPromptID_0bb82d7c UNIQUEIDENTIFIER,
@Config_0bb82d7c NVARCHAR(MAX),
@RuntimeActionConfiguration_0bb82d7c NVARCHAR(MAX),
@MaxExecutionTimeMS_0bb82d7c INT,
@CreatedByAgentID_0bb82d7c UNIQUEIDENTIFIER,
@ID_0bb82d7c UNIQUEIDENTIFIER
SET
  @CategoryID_0bb82d7c = '65E048AA-5220-4E4D-920A-A3D9349902A7'
SET
  @Name_0bb82d7c = N'Weekly Entity Digest'
SET
  @Description_0bb82d7c = N'Composes a weekly markdown digest from activity across one or more entities, then emails it via the Send Single Message action. Exercises every major bridge namespace: metadata-bounded entity queries (rv), standard library helpers (libs), AI prompt rendering (ai), and downstream action invocation (actions). Supports dryRun=true to return the markdown without sending.'
SET
  @Type_0bb82d7c = N'Runtime'
SET
  @Code_0bb82d7c = N'// Weekly Entity Digest — full-stack Runtime action.
//
...
'
SET
  @CodeApprovalStatus_0bb82d7c = N'Approved'
SET
  @CodeLocked_0bb82d7c = 0
SET
  @ForceCodeGeneration_0bb82d7c = 0
SET
  @Status_0bb82d7c = N'Active'
SET
  @IconClass_0bb82d7c = N'fa-solid fa-newspaper'
SET
  @RuntimeActionConfiguration_0bb82d7c = N'{
  "permissions": {
    "allowedActions": [
      {
...
SET
  @MaxExecutionTimeMS_0bb82d7c = 180000
SET
  @ID_0bb82d7c = 'B57BE9DE-FDBA-4545-822B-32EA6C4E706A' EXEC [${flyway:defaultSchema}].spUpdateAction @CategoryID = @CategoryID_0bb82d7c,
  @Name = @Name_0bb82d7c,
  @Description = @Description_0bb82d7c,
  @Type = @Type_0bb82d7c,
  @UserPrompt = @UserPrompt_0bb82d7c,
  @UserComments = @UserComments_0bb82d7c,
  @Code = @Code_0bb82d7c,
  @CodeComments = @CodeComments_0bb82d7c,
  @CodeApprovalStatus = @CodeApprovalStatus_0bb82d7c,
  @CodeApprovalComments = @CodeApprovalComments_0bb82d7c,
  @CodeApprovedByUserID = @CodeApprovedByUserID_0bb82d7c,
  @CodeApprovedAt = @CodeApprovedAt_0bb82d7c,
  @CodeLocked = @CodeLocked_0bb82d7c,
  @ForceCodeGeneration = @ForceCodeGeneration_0bb82d7c,
  @RetentionPeriod = @RetentionPeriod_0bb82d7c,
  @Status = @Status_0bb82d7c,
  @DriverClass = @DriverClass_0bb82d7c,
  @ParentID = @ParentID_0bb82d7c,
  @IconClass = @IconClass_0bb82d7c,
  @DefaultCompactPromptID = @DefaultCompactPromptID_0bb82d7c,
  @Config = @Config_0bb82d7c,
  @RuntimeActionConfiguration = @RuntimeActionConfiguration_0bb82d7c,
  @MaxExecutionTimeMS = @MaxExecutionTimeMS_0bb82d7c,
  @CreatedByAgentID = @CreatedByAgentID_0bb82d7c,
  @ID = @ID_0bb82d7c;

GO

-- Save MJ: AI Prompts (core SP call only)
DECLARE @Name_9c8dd800 NVARCHAR(255),
@Description_9c8dd800 NVARCHAR(MAX),
@TemplateID_9c8dd800 UNIQUEIDENTIFIER,
@CategoryID_9c8dd800 UNIQUEIDENTIFIER,
@TypeID_9c8dd800 UNIQUEIDENTIFIER,
@Status_9c8dd800 NVARCHAR(50),
@ResponseFormat_9c8dd800 NVARCHAR(20),
@ModelSpecificResponseFormat_9c8dd800 NVARCHAR(MAX),
@AIModelTypeID_9c8dd800 UNIQUEIDENTIFIER,
@MinPowerRank_9c8dd800 INT,
@SelectionStrategy_9c8dd800 NVARCHAR(20),
@PowerPreference_9c8dd800 NVARCHAR(20),
@ParallelizationMode_9c8dd800 NVARCHAR(20),
@ParallelCount_9c8dd800 INT,
@ParallelConfigParam_9c8dd800 NVARCHAR(100),
@OutputType_9c8dd800 NVARCHAR(50),
@OutputExample_9c8dd800 NVARCHAR(MAX),
@ValidationBehavior_9c8dd800 NVARCHAR(50),
@MaxRetries_9c8dd800 INT,
@RetryDelayMS_9c8dd800 INT,
@RetryStrategy_9c8dd800 NVARCHAR(20),
@ResultSelectorPromptID_9c8dd800 UNIQUEIDENTIFIER,
@EnableCaching_9c8dd800 BIT,
@CacheTTLSeconds_9c8dd800 INT,
@CacheMatchType_9c8dd800 NVARCHAR(20),
@CacheSimilarityThreshold_9c8dd800 FLOAT(53),
@CacheMustMatchModel_9c8dd800 BIT,
@CacheMustMatchVendor_9c8dd800 BIT,
@CacheMustMatchAgent_9c8dd800 BIT,
@CacheMustMatchConfig_9c8dd800 BIT,
@PromptRole_9c8dd800 NVARCHAR(20),
@PromptPosition_9c8dd800 NVARCHAR(20),
@Temperature_9c8dd800 DECIMAL(3, 2),
@TopP_9c8dd800 DECIMAL(3, 2),
@TopK_9c8dd800 INT,
@MinP_9c8dd800 DECIMAL(3, 2),
@FrequencyPenalty_9c8dd800 DECIMAL(3, 2),
@PresencePenalty_9c8dd800 DECIMAL(3, 2),
@Seed_9c8dd800 INT,
@StopSequences_9c8dd800 NVARCHAR(1000),
@IncludeLogProbs_9c8dd800 BIT,
@TopLogProbs_9c8dd800 INT,
@FailoverStrategy_9c8dd800 NVARCHAR(50),
@FailoverMaxAttempts_9c8dd800 INT,
@FailoverDelaySeconds_9c8dd800 INT,
@FailoverModelStrategy_9c8dd800 NVARCHAR(50),
@FailoverErrorScope_9c8dd800 NVARCHAR(50),
@EffortLevel_9c8dd800 INT,
@AssistantPrefill_9c8dd800 NVARCHAR(MAX),
@PrefillFallbackMode_9c8dd800 NVARCHAR(20),
@RequireSpecificModels_9c8dd800 BIT,
@ID_9c8dd800 UNIQUEIDENTIFIER
SET
  @Name_9c8dd800 = N'Database Requirements Analyst - Main Prompt'
SET
  @Description_9c8dd800 = N'System prompt for the Database Requirements Analyst sub-agent. Gathers data model requirements through conversation and writes them to FunctionalRequirements.'
SET
  @TemplateID_9c8dd800 = '03033552-C831-4C5F-9742-82631CCA230C'
SET
  @CategoryID_9c8dd800 = '1AB01F77-8EA3-4FF1-A292-0A0327A74191'
SET
  @TypeID_9c8dd800 = 'A6DA423E-F36B-1410-8DAC-00021F8B792E'
SET
  @Status_9c8dd800 = N'Active'
SET
  @ResponseFormat_9c8dd800 = N'JSON'
SET
  @MinPowerRank_9c8dd800 = 0
SET
  @SelectionStrategy_9c8dd800 = N'Specific'
SET
  @PowerPreference_9c8dd800 = N'Balanced'
SET
  @ParallelizationMode_9c8dd800 = N'None'
SET
  @OutputType_9c8dd800 = N'object'
SET
  @OutputExample_9c8dd800 = N'{"description":"Database Requirements Analyst is a sub-agent — it writes FunctionalRequirements and returns to the parent. taskComplete: true ends the sub-agent. message and payloadChangeRequest are TOP-LEVEL fields. The parent (Database Designer) handles what happens next: shows questions to user (DRAFT) or calls Schema Designer (FINAL).","example_1_draft_mode":{"description":"Not enough info — write DRAFT with up to 3 questions, return to parent.","taskComplete":true,"message":"DRAFT written. 3 questions pending.","payloadChangeRequest":{"newElements":{"FunctionalRequirements":"# DRAFT - Needs Clarification\n\n## What We Know\n\nThe user wants to track project milestones — key checkpoints for projects they manage. Each milestone has a title and a target date.\n\n## Questions for User\n\n1. Should milestones have a status (e.g. Active, Completed, Cancelled) or just a done/not-done flag?\n\n2. Should each milestone belong to a project? If so, is ''Projects'' already an entity in your system?\n\n3. Do you want to assign milestones to a specific team member (link to Users)?"}}},"example_2_final_mode":{"description":"Enough info to design — write FINAL requirements, return to parent. Parent will immediately call Schema Designer.","taskComplete":true,"message":"Requirements finalized.","payloadChangeRequest":{"newElements":{"FunctionalRequirements":"# Project Milestones — Entity Requirements\n\n## What This Entity Stores\n\nEach row represents a single milestone (key checkpoint) for a project. Milestones have a title, due date, status, and are associated with a project and optionally an assigned team member.\n\n## Required Columns\n\n| Column (Natural Name) | Type      | Always Required? | Notes / Constraints                   |\n|-----------------------|-----------|------------------|---------------------------------------|\n| Title                 | Text      | Yes              | Max 200 characters, milestone label   |\n| Status                | Text      | Yes              | Active, Completed, Cancelled          |\n\n## Optional Columns\n\n| Column (Natural Name) | Type      | Notes                                          |\n|-----------------------|-----------|------------------------------------------------|\n| Due Date              | Date      | Target completion date, can be null            |\n| Completed Date        | Date      | Actual completion date, null until done        |\n| Notes                 | Long Text | Free-text description or context               |\n\n## Relationships\n\n- **Project ID** → `Projects` entity (FK, required)\n- **Assigned User ID** → MJ `Users` entity (FK, optional)\n\n## Uniqueness\n\nNone beyond the auto-generated `ID`.\n\n## Other Notes\n\n- Status valid values: `Active`, `Completed`, `Cancelled`. Default: `Active`.\n- `ID`, `__mj_CreatedAt`, `__mj_UpdatedAt` are auto-managed by MemberJunction."}}}}'
SET
  @ValidationBehavior_9c8dd800 = N'Strict'
SET
  @MaxRetries_9c8dd800 = 2
SET
  @RetryDelayMS_9c8dd800 = 1000
SET
  @RetryStrategy_9c8dd800 = N'Fixed'
SET
  @EnableCaching_9c8dd800 = 0
SET
  @CacheMatchType_9c8dd800 = N'Exact'
SET
  @CacheMustMatchModel_9c8dd800 = 1
SET
  @CacheMustMatchVendor_9c8dd800 = 1
SET
  @CacheMustMatchAgent_9c8dd800 = 0
SET
  @CacheMustMatchConfig_9c8dd800 = 0
SET
  @PromptRole_9c8dd800 = N'System'
SET
  @PromptPosition_9c8dd800 = N'First'
SET
  @StopSequences_9c8dd800 = N'
```'
SET
  @IncludeLogProbs_9c8dd800 = 0
SET
  @FailoverStrategy_9c8dd800 = N'SameModelDifferentVendor'
SET
  @FailoverMaxAttempts_9c8dd800 = 3
SET
  @FailoverDelaySeconds_9c8dd800 = 5
SET
  @FailoverModelStrategy_9c8dd800 = N'PreferSameModel'
SET
  @FailoverErrorScope_9c8dd800 = N'All'
SET
  @EffortLevel_9c8dd800 = 80
SET
  @AssistantPrefill_9c8dd800 = N'```json'
SET
  @PrefillFallbackMode_9c8dd800 = N'SystemInstruction'
SET
  @RequireSpecificModels_9c8dd800 = 0
SET
  @ID_9c8dd800 = 'E831D8BA-91D7-4D4B-8B92-9D2A10306271' EXEC [${flyway:defaultSchema}].spUpdateAIPrompt @Name = @Name_9c8dd800,
  @Description = @Description_9c8dd800,
  @TemplateID = @TemplateID_9c8dd800,
  @CategoryID = @CategoryID_9c8dd800,
  @TypeID = @TypeID_9c8dd800,
  @Status = @Status_9c8dd800,
  @ResponseFormat = @ResponseFormat_9c8dd800,
  @ModelSpecificResponseFormat = @ModelSpecificResponseFormat_9c8dd800,
  @AIModelTypeID = @AIModelTypeID_9c8dd800,
  @MinPowerRank = @MinPowerRank_9c8dd800,
  @SelectionStrategy = @SelectionStrategy_9c8dd800,
  @PowerPreference = @PowerPreference_9c8dd800,
  @ParallelizationMode = @ParallelizationMode_9c8dd800,
  @ParallelCount = @ParallelCount_9c8dd800,
  @ParallelConfigParam = @ParallelConfigParam_9c8dd800,
  @OutputType = @OutputType_9c8dd800,
  @OutputExample = @OutputExample_9c8dd800,
  @ValidationBehavior = @ValidationBehavior_9c8dd800,
  @MaxRetries = @MaxRetries_9c8dd800,
  @RetryDelayMS = @RetryDelayMS_9c8dd800,
  @RetryStrategy = @RetryStrategy_9c8dd800,
  @ResultSelectorPromptID = @ResultSelectorPromptID_9c8dd800,
  @EnableCaching = @EnableCaching_9c8dd800,
  @CacheTTLSeconds = @CacheTTLSeconds_9c8dd800,
  @CacheMatchType = @CacheMatchType_9c8dd800,
  @CacheSimilarityThreshold = @CacheSimilarityThreshold_9c8dd800,
  @CacheMustMatchModel = @CacheMustMatchModel_9c8dd800,
  @CacheMustMatchVendor = @CacheMustMatchVendor_9c8dd800,
  @CacheMustMatchAgent = @CacheMustMatchAgent_9c8dd800,
  @CacheMustMatchConfig = @CacheMustMatchConfig_9c8dd800,
  @PromptRole = @PromptRole_9c8dd800,
  @PromptPosition = @PromptPosition_9c8dd800,
  @Temperature = @Temperature_9c8dd800,
  @TopP = @TopP_9c8dd800,
  @TopK = @TopK_9c8dd800,
  @MinP = @MinP_9c8dd800,
  @FrequencyPenalty = @FrequencyPenalty_9c8dd800,
  @PresencePenalty = @PresencePenalty_9c8dd800,
  @Seed = @Seed_9c8dd800,
  @StopSequences = @StopSequences_9c8dd800,
  @IncludeLogProbs = @IncludeLogProbs_9c8dd800,
  @TopLogProbs = @TopLogProbs_9c8dd800,
  @FailoverStrategy = @FailoverStrategy_9c8dd800,
  @FailoverMaxAttempts = @FailoverMaxAttempts_9c8dd800,
  @FailoverDelaySeconds = @FailoverDelaySeconds_9c8dd800,
  @FailoverModelStrategy = @FailoverModelStrategy_9c8dd800,
  @FailoverErrorScope = @FailoverErrorScope_9c8dd800,
  @EffortLevel = @EffortLevel_9c8dd800,
  @AssistantPrefill = @AssistantPrefill_9c8dd800,
  @PrefillFallbackMode = @PrefillFallbackMode_9c8dd800,
  @RequireSpecificModels = @RequireSpecificModels_9c8dd800,
  @ID = @ID_9c8dd800;

GO

-- Save MJ: AI Prompts (core SP call only)
DECLARE @Name_df3e0e74 NVARCHAR(255),
@Description_df3e0e74 NVARCHAR(MAX),
@TemplateID_df3e0e74 UNIQUEIDENTIFIER,
@CategoryID_df3e0e74 UNIQUEIDENTIFIER,
@TypeID_df3e0e74 UNIQUEIDENTIFIER,
@Status_df3e0e74 NVARCHAR(50),
@ResponseFormat_df3e0e74 NVARCHAR(20),
@ModelSpecificResponseFormat_df3e0e74 NVARCHAR(MAX),
@AIModelTypeID_df3e0e74 UNIQUEIDENTIFIER,
@MinPowerRank_df3e0e74 INT,
@SelectionStrategy_df3e0e74 NVARCHAR(20),
@PowerPreference_df3e0e74 NVARCHAR(20),
@ParallelizationMode_df3e0e74 NVARCHAR(20),
@ParallelCount_df3e0e74 INT,
@ParallelConfigParam_df3e0e74 NVARCHAR(100),
@OutputType_df3e0e74 NVARCHAR(50),
@OutputExample_df3e0e74 NVARCHAR(MAX),
@ValidationBehavior_df3e0e74 NVARCHAR(50),
@MaxRetries_df3e0e74 INT,
@RetryDelayMS_df3e0e74 INT,
@RetryStrategy_df3e0e74 NVARCHAR(20),
@ResultSelectorPromptID_df3e0e74 UNIQUEIDENTIFIER,
@EnableCaching_df3e0e74 BIT,
@CacheTTLSeconds_df3e0e74 INT,
@CacheMatchType_df3e0e74 NVARCHAR(20),
@CacheSimilarityThreshold_df3e0e74 FLOAT(53),
@CacheMustMatchModel_df3e0e74 BIT,
@CacheMustMatchVendor_df3e0e74 BIT,
@CacheMustMatchAgent_df3e0e74 BIT,
@CacheMustMatchConfig_df3e0e74 BIT,
@PromptRole_df3e0e74 NVARCHAR(20),
@PromptPosition_df3e0e74 NVARCHAR(20),
@Temperature_df3e0e74 DECIMAL(3, 2),
@TopP_df3e0e74 DECIMAL(3, 2),
@TopK_df3e0e74 INT,
@MinP_df3e0e74 DECIMAL(3, 2),
@FrequencyPenalty_df3e0e74 DECIMAL(3, 2),
@PresencePenalty_df3e0e74 DECIMAL(3, 2),
@Seed_df3e0e74 INT,
@StopSequences_df3e0e74 NVARCHAR(1000),
@IncludeLogProbs_df3e0e74 BIT,
@TopLogProbs_df3e0e74 INT,
@FailoverStrategy_df3e0e74 NVARCHAR(50),
@FailoverMaxAttempts_df3e0e74 INT,
@FailoverDelaySeconds_df3e0e74 INT,
@FailoverModelStrategy_df3e0e74 NVARCHAR(50),
@FailoverErrorScope_df3e0e74 NVARCHAR(50),
@EffortLevel_df3e0e74 INT,
@AssistantPrefill_df3e0e74 NVARCHAR(MAX),
@PrefillFallbackMode_df3e0e74 NVARCHAR(20),
@RequireSpecificModels_df3e0e74 BIT,
@ID_df3e0e74 UNIQUEIDENTIFIER
SET
  @Name_df3e0e74 = N'Database Schema Designer - Main Prompt'
SET
  @Description_df3e0e74 = N'System prompt for the Database Schema Designer sub-agent. Converts functional requirements into a precise TableDefinition JSON for SchemaEngine.'
SET
  @TemplateID_df3e0e74 = 'E8772ED6-DDCE-4C87-A5E5-08A4DDF1F91F'
SET
  @CategoryID_df3e0e74 = '1AB01F77-8EA3-4FF1-A292-0A0327A74191'
SET
  @TypeID_df3e0e74 = 'A6DA423E-F36B-1410-8DAC-00021F8B792E'
SET
  @Status_df3e0e74 = N'Active'
SET
  @ResponseFormat_df3e0e74 = N'JSON'
SET
  @MinPowerRank_df3e0e74 = 0
SET
  @SelectionStrategy_df3e0e74 = N'Specific'
SET
  @PowerPreference_df3e0e74 = N'Highest'
SET
  @ParallelizationMode_df3e0e74 = N'None'
SET
  @OutputType_df3e0e74 = N'object'
SET
  @OutputExample_df3e0e74 = N'{
...
'
SET
  @ValidationBehavior_df3e0e74 = N'Strict'
SET
  @MaxRetries_df3e0e74 = 3
SET
  @RetryDelayMS_df3e0e74 = 1000
SET
  @RetryStrategy_df3e0e74 = N'Fixed'
SET
  @EnableCaching_df3e0e74 = 0
SET
  @CacheMatchType_df3e0e74 = N'Exact'
SET
  @CacheMustMatchModel_df3e0e74 = 1
SET
  @CacheMustMatchVendor_df3e0e74 = 1
SET
  @CacheMustMatchAgent_df3e0e74 = 0
SET
  @CacheMustMatchConfig_df3e0e74 = 0
SET
  @PromptRole_df3e0e74 = N'System'
SET
  @PromptPosition_df3e0e74 = N'First'
SET
  @StopSequences_df3e0e74 = N'
```'
SET
  @IncludeLogProbs_df3e0e74 = 0
SET
  @FailoverStrategy_df3e0e74 = N'SameModelDifferentVendor'
SET
  @FailoverMaxAttempts_df3e0e74 = 3
SET
  @FailoverDelaySeconds_df3e0e74 = 5
SET
  @FailoverModelStrategy_df3e0e74 = N'PreferSameModel'
SET
  @FailoverErrorScope_df3e0e74 = N'All'
SET
  @EffortLevel_df3e0e74 = 100
SET
  @AssistantPrefill_df3e0e74 = N'```json'
SET
  @PrefillFallbackMode_df3e0e74 = N'SystemInstruction'
SET
  @RequireSpecificModels_df3e0e74 = 0
SET
  @ID_df3e0e74 = '4A8438F3-1DC9-4A04-8A10-79BBD61DE785' EXEC [${flyway:defaultSchema}].spUpdateAIPrompt @Name = @Name_df3e0e74,
  @Description = @Description_df3e0e74,
  @TemplateID = @TemplateID_df3e0e74,
  @CategoryID = @CategoryID_df3e0e74,
  @TypeID = @TypeID_df3e0e74,
  @Status = @Status_df3e0e74,
  @ResponseFormat = @ResponseFormat_df3e0e74,
  @ModelSpecificResponseFormat = @ModelSpecificResponseFormat_df3e0e74,
  @AIModelTypeID = @AIModelTypeID_df3e0e74,
  @MinPowerRank = @MinPowerRank_df3e0e74,
  @SelectionStrategy = @SelectionStrategy_df3e0e74,
  @PowerPreference = @PowerPreference_df3e0e74,
  @ParallelizationMode = @ParallelizationMode_df3e0e74,
  @ParallelCount = @ParallelCount_df3e0e74,
  @ParallelConfigParam = @ParallelConfigParam_df3e0e74,
  @OutputType = @OutputType_df3e0e74,
  @OutputExample = @OutputExample_df3e0e74,
  @ValidationBehavior = @ValidationBehavior_df3e0e74,
  @MaxRetries = @MaxRetries_df3e0e74,
  @RetryDelayMS = @RetryDelayMS_df3e0e74,
  @RetryStrategy = @RetryStrategy_df3e0e74,
  @ResultSelectorPromptID = @ResultSelectorPromptID_df3e0e74,
  @EnableCaching = @EnableCaching_df3e0e74,
  @CacheTTLSeconds = @CacheTTLSeconds_df3e0e74,
  @CacheMatchType = @CacheMatchType_df3e0e74,
  @CacheSimilarityThreshold = @CacheSimilarityThreshold_df3e0e74,
  @CacheMustMatchModel = @CacheMustMatchModel_df3e0e74,
  @CacheMustMatchVendor = @CacheMustMatchVendor_df3e0e74,
  @CacheMustMatchAgent = @CacheMustMatchAgent_df3e0e74,
  @CacheMustMatchConfig = @CacheMustMatchConfig_df3e0e74,
  @PromptRole = @PromptRole_df3e0e74,
  @PromptPosition = @PromptPosition_df3e0e74,
  @Temperature = @Temperature_df3e0e74,
  @TopP = @TopP_df3e0e74,
  @TopK = @TopK_df3e0e74,
  @MinP = @MinP_df3e0e74,
  @FrequencyPenalty = @FrequencyPenalty_df3e0e74,
  @PresencePenalty = @PresencePenalty_df3e0e74,
  @Seed = @Seed_df3e0e74,
  @StopSequences = @StopSequences_df3e0e74,
  @IncludeLogProbs = @IncludeLogProbs_df3e0e74,
  @TopLogProbs = @TopLogProbs_df3e0e74,
  @FailoverStrategy = @FailoverStrategy_df3e0e74,
  @FailoverMaxAttempts = @FailoverMaxAttempts_df3e0e74,
  @FailoverDelaySeconds = @FailoverDelaySeconds_df3e0e74,
  @FailoverModelStrategy = @FailoverModelStrategy_df3e0e74,
  @FailoverErrorScope = @FailoverErrorScope_df3e0e74,
  @EffortLevel = @EffortLevel_df3e0e74,
  @AssistantPrefill = @AssistantPrefill_df3e0e74,
  @PrefillFallbackMode = @PrefillFallbackMode_df3e0e74,
  @RequireSpecificModels = @RequireSpecificModels_df3e0e74,
  @ID = @ID_df3e0e74;

GO

-- Save MJ: Template Contents (core SP call only)
DECLARE @TemplateID_6ba88aa2 UNIQUEIDENTIFIER,
@TypeID_6ba88aa2 UNIQUEIDENTIFIER,
@TemplateText_6ba88aa2 NVARCHAR(MAX),
@Priority_6ba88aa2 INT,
@IsActive_6ba88aa2 BIT,
@ID_6ba88aa2 UNIQUEIDENTIFIER
SET
  @TemplateID_6ba88aa2 = '29481135-7740-4265-8ADB-449946A3D895'
SET
  @TypeID_6ba88aa2 = 'E7AFCCEC-6A37-EF11-86D4-000D3A4E707E'
SET
  @TemplateText_6ba88aa2 = N'You are an expert at analyzing database entity schemas and generating Entity Document templates optimized for vector similarity search in MemberJunction.
...
SET
  @IsActive_6ba88aa2 = 1
SET
  @ID_6ba88aa2 = '8647C35B-087E-4D9A-8105-1956380C25FE' EXEC [${flyway:defaultSchema}].spUpdateTemplateContent @TemplateID = @TemplateID_6ba88aa2,
  @TypeID = @TypeID_6ba88aa2,
  @TemplateText = @TemplateText_6ba88aa2,
  @Priority = @Priority_6ba88aa2,
  @IsActive = @IsActive_6ba88aa2,
  @ID = @ID_6ba88aa2;

GO

-- Save MJ: AI Prompts (core SP call only)
DECLARE @Name_30e14499 NVARCHAR(255),
@Description_30e14499 NVARCHAR(MAX),
@TemplateID_30e14499 UNIQUEIDENTIFIER,
@CategoryID_30e14499 UNIQUEIDENTIFIER,
@TypeID_30e14499 UNIQUEIDENTIFIER,
@Status_30e14499 NVARCHAR(50),
@ResponseFormat_30e14499 NVARCHAR(20),
@ModelSpecificResponseFormat_30e14499 NVARCHAR(MAX),
@AIModelTypeID_30e14499 UNIQUEIDENTIFIER,
@MinPowerRank_30e14499 INT,
@SelectionStrategy_30e14499 NVARCHAR(20),
@PowerPreference_30e14499 NVARCHAR(20),
@ParallelizationMode_30e14499 NVARCHAR(20),
@ParallelCount_30e14499 INT,
@ParallelConfigParam_30e14499 NVARCHAR(100),
@OutputType_30e14499 NVARCHAR(50),
@OutputExample_30e14499 NVARCHAR(MAX),
@ValidationBehavior_30e14499 NVARCHAR(50),
@MaxRetries_30e14499 INT,
@RetryDelayMS_30e14499 INT,
@RetryStrategy_30e14499 NVARCHAR(20),
@ResultSelectorPromptID_30e14499 UNIQUEIDENTIFIER,
@EnableCaching_30e14499 BIT,
@CacheTTLSeconds_30e14499 INT,
@CacheMatchType_30e14499 NVARCHAR(20),
@CacheSimilarityThreshold_30e14499 FLOAT(53),
@CacheMustMatchModel_30e14499 BIT,
@CacheMustMatchVendor_30e14499 BIT,
@CacheMustMatchAgent_30e14499 BIT,
@CacheMustMatchConfig_30e14499 BIT,
@PromptRole_30e14499 NVARCHAR(20),
@PromptPosition_30e14499 NVARCHAR(20),
@Temperature_30e14499 DECIMAL(3, 2),
@TopP_30e14499 DECIMAL(3, 2),
@TopK_30e14499 INT,
@MinP_30e14499 DECIMAL(3, 2),
@FrequencyPenalty_30e14499 DECIMAL(3, 2),
@PresencePenalty_30e14499 DECIMAL(3, 2),
@Seed_30e14499 INT,
@StopSequences_30e14499 NVARCHAR(1000),
@IncludeLogProbs_30e14499 BIT,
@TopLogProbs_30e14499 INT,
@FailoverStrategy_30e14499 NVARCHAR(50),
@FailoverMaxAttempts_30e14499 INT,
@FailoverDelaySeconds_30e14499 INT,
@FailoverModelStrategy_30e14499 NVARCHAR(50),
@FailoverErrorScope_30e14499 NVARCHAR(50),
@EffortLevel_30e14499 INT,
@AssistantPrefill_30e14499 NVARCHAR(MAX),
@PrefillFallbackMode_30e14499 NVARCHAR(20),
@RequireSpecificModels_30e14499 BIT,
@ID_30e14499 UNIQUEIDENTIFIER
SET
  @Name_30e14499 = N'Entity Document Suggestion'
SET
  @Description_30e14499 = N'Analyzes entity schemas and suggests Entity Document templates for vector similarity search and duplicate detection. Takes entity fields, types, and relationships as input and outputs a ready-to-use Nunjucks template with threshold recommendations.'
SET
  @TemplateID_30e14499 = '29481135-7740-4265-8ADB-449946A3D895'
SET
  @CategoryID_30e14499 = '7D2DEF7F-138F-4620-8309-33964A97A997'
SET
  @TypeID_30e14499 = 'A6DA423E-F36B-1410-8DAC-00021F8B792E'
SET
  @Status_30e14499 = N'Active'
SET
  @ResponseFormat_30e14499 = N'JSON'
SET
  @MinPowerRank_30e14499 = 0
SET
  @SelectionStrategy_30e14499 = N'Specific'
SET
  @PowerPreference_30e14499 = N'Balanced'
SET
  @ParallelizationMode_30e14499 = N'None'
SET
  @OutputType_30e14499 = N'string'
SET
  @ValidationBehavior_30e14499 = N'Warn'
SET
  @MaxRetries_30e14499 = 1
SET
  @RetryDelayMS_30e14499 = 0
SET
  @RetryStrategy_30e14499 = N'Fixed'
SET
  @EnableCaching_30e14499 = 0
SET
  @CacheMatchType_30e14499 = N'Exact'
SET
  @CacheMustMatchModel_30e14499 = 1
SET
  @CacheMustMatchVendor_30e14499 = 1
SET
  @CacheMustMatchAgent_30e14499 = 0
SET
  @CacheMustMatchConfig_30e14499 = 0
SET
  @PromptRole_30e14499 = N'System'
SET
  @PromptPosition_30e14499 = N'First'
SET
  @IncludeLogProbs_30e14499 = 0
SET
  @FailoverStrategy_30e14499 = N'SameModelDifferentVendor'
SET
  @FailoverMaxAttempts_30e14499 = 3
SET
  @FailoverDelaySeconds_30e14499 = 5
SET
  @FailoverModelStrategy_30e14499 = N'PreferSameModel'
SET
  @FailoverErrorScope_30e14499 = N'All'
SET
  @PrefillFallbackMode_30e14499 = N'Ignore'
SET
  @RequireSpecificModels_30e14499 = 0
SET
  @ID_30e14499 = 'F89C5890-D5CD-4824-B431-329799047372' EXEC [${flyway:defaultSchema}].spUpdateAIPrompt @Name = @Name_30e14499,
  @Description = @Description_30e14499,
  @TemplateID = @TemplateID_30e14499,
  @CategoryID = @CategoryID_30e14499,
  @TypeID = @TypeID_30e14499,
  @Status = @Status_30e14499,
  @ResponseFormat = @ResponseFormat_30e14499,
  @ModelSpecificResponseFormat = @ModelSpecificResponseFormat_30e14499,
  @AIModelTypeID = @AIModelTypeID_30e14499,
  @MinPowerRank = @MinPowerRank_30e14499,
  @SelectionStrategy = @SelectionStrategy_30e14499,
  @PowerPreference = @PowerPreference_30e14499,
  @ParallelizationMode = @ParallelizationMode_30e14499,
  @ParallelCount = @ParallelCount_30e14499,
  @ParallelConfigParam = @ParallelConfigParam_30e14499,
  @OutputType = @OutputType_30e14499,
  @OutputExample = @OutputExample_30e14499,
  @ValidationBehavior = @ValidationBehavior_30e14499,
  @MaxRetries = @MaxRetries_30e14499,
  @RetryDelayMS = @RetryDelayMS_30e14499,
  @RetryStrategy = @RetryStrategy_30e14499,
  @ResultSelectorPromptID = @ResultSelectorPromptID_30e14499,
  @EnableCaching = @EnableCaching_30e14499,
  @CacheTTLSeconds = @CacheTTLSeconds_30e14499,
  @CacheMatchType = @CacheMatchType_30e14499,
  @CacheSimilarityThreshold = @CacheSimilarityThreshold_30e14499,
  @CacheMustMatchModel = @CacheMustMatchModel_30e14499,
  @CacheMustMatchVendor = @CacheMustMatchVendor_30e14499,
  @CacheMustMatchAgent = @CacheMustMatchAgent_30e14499,
  @CacheMustMatchConfig = @CacheMustMatchConfig_30e14499,
  @PromptRole = @PromptRole_30e14499,
  @PromptPosition = @PromptPosition_30e14499,
  @Temperature = @Temperature_30e14499,
  @TopP = @TopP_30e14499,
  @TopK = @TopK_30e14499,
  @MinP = @MinP_30e14499,
  @FrequencyPenalty = @FrequencyPenalty_30e14499,
  @PresencePenalty = @PresencePenalty_30e14499,
  @Seed = @Seed_30e14499,
  @StopSequences = @StopSequences_30e14499,
  @IncludeLogProbs = @IncludeLogProbs_30e14499,
  @TopLogProbs = @TopLogProbs_30e14499,
  @FailoverStrategy = @FailoverStrategy_30e14499,
  @FailoverMaxAttempts = @FailoverMaxAttempts_30e14499,
  @FailoverDelaySeconds = @FailoverDelaySeconds_30e14499,
  @FailoverModelStrategy = @FailoverModelStrategy_30e14499,
  @FailoverErrorScope = @FailoverErrorScope_30e14499,
  @EffortLevel = @EffortLevel_30e14499,
  @AssistantPrefill = @AssistantPrefill_30e14499,
  @PrefillFallbackMode = @PrefillFallbackMode_30e14499,
  @RequireSpecificModels = @RequireSpecificModels_30e14499,
  @ID = @ID_30e14499;

GO

-- Save MJ: Queries (core SP call only)
DECLARE @ID_eee772bc UNIQUEIDENTIFIER,
@Name_eee772bc NVARCHAR(255),
@CategoryID_eee772bc UNIQUEIDENTIFIER,
@UserQuestion_eee772bc NVARCHAR(MAX),
@Description_eee772bc NVARCHAR(MAX),
@SQL_eee772bc NVARCHAR(MAX),
@TechnicalDescription_eee772bc NVARCHAR(MAX),
@OriginalSQL_eee772bc NVARCHAR(MAX),
@Feedback_eee772bc NVARCHAR(MAX),
@Status_eee772bc NVARCHAR(15),
@QualityRank_eee772bc INT,
@ExecutionCostRank_eee772bc INT,
@UsesTemplate_eee772bc BIT,
@AuditQueryRuns_eee772bc BIT,
@CacheEnabled_eee772bc BIT,
@CacheTTLMinutes_eee772bc INT,
@CacheMaxSize_eee772bc INT,
@EmbeddingVector_eee772bc NVARCHAR(MAX),
@EmbeddingModelID_eee772bc UNIQUEIDENTIFIER,
@CacheValidationSQL_eee772bc NVARCHAR(MAX),
@SQLDialectID_eee772bc UNIQUEIDENTIFIER,
@Reusable_eee772bc BIT
SET
  @ID_eee772bc = 'C0A11C4B-7C68-4A42-AC5E-F5268193CDAA'
SET
  @Name_eee772bc = N'GeoBulkLookup_RecordGeoCodesByEntity'
SET
  @CategoryID_eee772bc = 'FE1AE5B2-FC57-43B2-B560-A673713E1679'
SET
  @Description_eee772bc = N'Bulk lookup of all RecordGeoCode rows for a given entity. Returns lightweight fields (ID, RecordID, LocationType, SourceFieldHash, Status) for in-memory staleness checking and existence filtering. Used by ScheduledGeocodingAction to eliminate per-record SQL queries during batch geocoding.'
SET
  @SQL_eee772bc = N'-- T-SQL: Bulk lookup of RecordGeoCode rows for a single entity.
...
SELECT
    ...
    rgc.Status
FROM
    ${flyway:defaultSchema}.vwRecordGeoCodes rgc
WHERE
...
- Explicit height (e.g. `height: ''300px''` or `` height: `$' + N'{height}px` ``) -- without this the canvas collapses to 0px
...
SET
  @TechnicalDesign_f09a329c = N'## Implementation
...
'
SET
  @TechnicalDesign_737f4da2 = N'## Architecture
React functional component for displaying AI-generated markdown content with built-in actions and collapsible UI.
...
'
SET
  @TechnicalDesign_0a6e3dc1 = N'## Architecture
React functional component with dual-mode operation (UI vs headless) supporting CSV, Excel (XLSX), and PDF exports.
...
'
SET
  @TechnicalDesign_f2dcdeb3 = N'## Architecture
React functional component using Chart.js 4.4.1 for canvas-based chart rendering with NO built-in drill-down (emits events only).
...
'
SET
  @TechnicalDesign_0f13d3aa = N'## Architecture
React functional component with intelligent primary key detection from MemberJunction entity metadata.
