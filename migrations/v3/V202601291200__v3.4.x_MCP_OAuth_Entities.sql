...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'Stores OAuth tokens (encrypted) for MCP server connections.',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
...
EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'OAuth access token (encrypted using field-level encryption).',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'OAuthToken',
    @level2type = N'COLUMN', @level2name = N'AccessTokenEncrypted';
GO

EXEC sp_addextendedproperty
    @name = N'MS_Description',
    @value = N'OAuth refresh token (encrypted using field-level encryption).',
    @level0type = N'SCHEMA', @level0name = '${flyway:defaultSchema}',
    @level1type = N'TABLE', @level1name = N'OAuthToken',
    @level2type = N'COLUMN', @level2name = N'RefreshTokenEncrypted';
GO
