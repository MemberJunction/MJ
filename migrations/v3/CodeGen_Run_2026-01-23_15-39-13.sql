/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (
         ...
         WHERE ID = '265dc92f-b598-4b20-b125-f24a7cdd16d2'  OR 
      ...
      BEGIN
         ...
         VALUES
         (
            '265dc92f-b598-4b20-b125-f24a7cdd16d2',
...
/* SQL text to insert new entity field */
      ...
      IF NOT EXISTS (
         SELECT 1 FROM [${flyway:defaultSchema}].EntityField 
         WHERE ID = '1052e59b-8fd1-4989-9e1d-f227f87f2b3c'  OR 
      ...
      BEGIN
         ...
         VALUES
         (
            '1052e59b-8fd1-4989-9e1d-f227f87f2b3c',
...
/* Set field properties for entity */
            ...
            UPDATE [${flyway:defaultSchema}].EntityField
            SET DefaultInView = 1
            WHERE ID = '1052E59B-8FD1-4989-9E1D-F227F87F2B3C'
...
/* Set field properties for entity */
            ...
            UPDATE [${flyway:defaultSchema}].EntityField
            SET DefaultInView = 1
            WHERE ID = '265DC92F-B598-4B20-B125-F24A7CDD16D2'
            AND AutoUpdateDefaultInView = 1
