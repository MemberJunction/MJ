...
CREATE INDEX IF NOT EXISTS "IDX_CompanyIntegrationRecordMap_Identity_Covering" ON __mj."CompanyIntegrationRecordMap" ("CompanyIntegrationID", "EntityID", "ExternalSystemRecordID");
