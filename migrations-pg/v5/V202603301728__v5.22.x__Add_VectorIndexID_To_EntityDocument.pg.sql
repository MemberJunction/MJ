...
-- Add foreign key constraint DEFERRABLE INITIALLY DEFERRED;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM __mj."EntityField" WHERE "ID" = '7ec088b4-c4aa-4e8f-841b-1650720c4fd7' OR ("EntityID" = '22248F34-2837-EF11-86D4-6045BDEE16E6' AND "Name" = 'VectorIndexID')
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM __mj."EntityRelationship" WHERE "ID" = '21a7bb14-7550-40ab-b17c-771bd9e3a2aa'
    ) THEN
        ...
        VALUES ('21a7bb14-7550-40ab-b17c-771bd9e3a2aa', '1D248F34-2837-EF11-86D4-6045BDEE16E6', '22248F34-2837-EF11-86D4-6045BDEE16E6', 'VectorIndexID', 'One To Many', TRUE, TRUE, 4, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM __mj."EntityField" WHERE "ID" = 'bac4c88d-29fe-46e9-9bc4-37b473206a08' OR ("EntityID" = '22248F34-2837-EF11-86D4-6045BDEE16E6' AND "Name" = 'VectorIndex')
    ) THEN
        INSERT INTO __mj."EntityField"
        (
        "ID",
...
ALTER TABLE __mj."EntityDocument"
 ADD CONSTRAINT "FK_EntityDocument_VectorIndex"
    FOREIGN KEY ("VectorIndexID") REFERENCES __mj."VectorIndex"("ID");

-- Add extended property for documentation DEFERRABLE INITIALLY DEFERRED;
...
COMMENT ON COLUMN __mj."EntityDocument"."VectorIndexID" IS 'Optional foreign key to the specific Vector Index where this entity document';
