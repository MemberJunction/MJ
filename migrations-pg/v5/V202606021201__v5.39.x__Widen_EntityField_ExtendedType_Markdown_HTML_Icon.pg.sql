...
-- ===================== Constraint Drops/Widenings (pre-data) =====================

-- Widen the EntityField."ExtendedType" CHECK constraint to allow 'Icon'.
--
-- This lets metadata authors explicitly declare the rendered format of a long-text
-- field (TEXT, ntext, etc.). When ExtendedType is set, the form field honors
-- it directly; when it is NULL, the Angular form field falls back to lightweight,
-- client-side content auto-detection.
--
-- 'Icon' declares that a field's VALUES are icon CSS classes (e.g. Font Awesome,
-- "fa-solid fa-user") rather than ordinary text. UI surfaces (form fields, FK
-- record-link dropdowns, grids) can then render the value as a per-row icon
-- instead of a string — without any field-name guessing.
--
-- DDL only: CodeGen regenerates the EntityFieldValue list + typed unions from
-- this constraint and the extended property below.
--
-- Drop the existing constraint and re-create it with 'Icon' added (placed after
-- 'HTML', matching the alphabetical-ish ordering of the prior Markdown/HTML add).
...
ALTER TABLE __mj."EntityField"
 ADD CONSTRAINT "CK_EntityField_ExtendedType" CHECK (
    "ExtendedType" IN ('Code', 'Email', 'FaceTime', 'Geo', 'GeoLatitude', 'GeoLongitude', 'GeoCountry', 'GeoStateProvince', 'GeoCity', 'GeoPostalCode', 'GeoAddress', 'HTML', 'Icon', 'Markdown', 'MSTeams', 'Other', 'SIP', 'SMS', 'Skype', 'Tel', 'URL', 'WhatsApp', 'ZoomMtg')
) NOT VALID;
...
UPDATE __mj."EntityField"
 ...
 WHERE 
   ...
   AND "EntityID" IN (SELECT "ID" FROM __mj."Entity" WHERE "SchemaName" = '__mj');

INSERT INTO __mj."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('17a9a6b7-36e3-49a8-b3c8-7185158e0b92', '055817F0-6F36-EF11-86D4-6045BDEE16E6', 12, 'HTML', 'HTML', NOW(), NOW());

/* SQL text to insert entity field value with ID a54d1e4d-1190-4c92-b100-523c072cb878 */

INSERT INTO __mj."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('a54d1e4d-1190-4c92-b100-523c072cb878', '055817F0-6F36-EF11-86D4-6045BDEE16E6', 13, 'Icon', 'Icon', NOW(), NOW());

/* SQL text to insert entity field value with ID 5434dbd9-19f2-41c9-b8ac-3a4e2c669602 */

INSERT INTO __mj."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('5434dbd9-19f2-41c9-b8ac-3a4e2c669602', '055817F0-6F36-EF11-86D4-6045BDEE16E6', 15, 'Markdown', 'Markdown', NOW(), NOW());

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=14 WHERE "ID"='F45F1816-CAAA-434C-8239-3932D448DEB6';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=16 WHERE "ID"='68A4F7CA-B203-40C8-ABAC-A91122866B00';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=17 WHERE "ID"='DFD25989-75AD-4F5B-8F18-88E687E067E5';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=18 WHERE "ID"='7758B42A-D133-4052-9991-1869AA5DFD74';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=19 WHERE "ID"='5B3460FB-56CC-4DAB-8375-60BDCD11FE35';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=20 WHERE "ID"='E1D0D56C-10D6-4A7C-BED8-D4F7A439204D';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=21 WHERE "ID"='A5865195-4AD1-432D-8797-57D25F3741FF';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=22 WHERE "ID"='356C61B4-27B5-48F3-A240-31B0CC6CA23D';

/* SQL text to update entity field value sequence */

UPDATE __mj."EntityFieldValue" SET "Sequence"=23 WHERE "ID"='45F07992-2974-4F4B-A5C8-FAECCF86BDB9';
...
COMMENT ON COLUMN __mj."EntityField"."ExtendedType" IS 'Defines extended behaviors for a field such as Email, Web URLs, Code, Markdown, HTML, and Icon. When set to ';


-- ===================== Other =====================

-- CODE GEN RUN 
/* SQL text to insert entity field value with ID 17a9a6b7-36e3-49a8-b3c8-7185158e0b92 */
