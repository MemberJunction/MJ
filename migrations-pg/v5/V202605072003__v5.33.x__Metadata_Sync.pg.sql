...
DECLARE
  p_ID_37c13756 UUID;
  p_Name_37c13756 VARCHAR(50);
  p_Description_37c13756 TEXT;
  p_CredentialTypeID_37c13756 UUID;
BEGIN
  p_ID_37c13756 := 'd13d6306-2098-44b8-aefa-9ce3694335ec';
  p_Name_37c13756 := 'DeepSeek';
  p_Description_37c13756 := 'DeepSeek is a Chinese AI research company that develops large language models including the V-series (V4 Pro/Flash) and R-series (reasoning) families. Models are released under permissive open-source licenses (MIT) with full open weights. The DeepSeek API offers OpenAI-compatible and Anthropic-compatible interfaces.';
  p_CredentialTypeID_37c13756 := '3F0C13AB-EF5F-4260-A50A-D66DDEC25270';
  PERFORM __mj."spCreateAIVendor"(p_ID := p_ID_37c13756, p_Name := p_Name_37c13756, p_Description := p_Description_37c13756, p_CredentialTypeID := p_CredentialTypeID_37c13756);
END $mj$;
...
DECLARE
  p_ID_58476aa1 UUID;
  p_Name_58476aa1 VARCHAR(50);
  p_Description_58476aa1 TEXT;
  p_AIModelTypeID_58476aa1 UUID;
  p_PowerRank_58476aa1 INTEGER;
  p_IsActive_58476aa1 BOOLEAN;
  p_SpeedRank_58476aa1 INTEGER;
  p_CostRank_58476aa1 INTEGER;
  p_ModelSelectionInsights_58476aa1 TEXT;
  p_InheritTypeModalities_58476aa1 BOOLEAN;
  p_PriorVersionID_58476aa1 UUID;
  p_SupportsPrefill_58476aa1 BOOLEAN;
  p_PrefillFallbackText_58476aa1 TEXT;
BEGIN
  p_ID_58476aa1 := 'dcdd6683-779f-4b03-89b5-746f95bb5293';
  p_Name_58476aa1 := 'DeepSeek V4 Pro';
  p_Description_58476aa1 := 'DeepSeek''s flagship reasoning model, released as preview April 24, 2026. Mixture-of-Experts with 1.6T total / 49B active parameters. MIT licensed open weights. Supports both thinking and non-thinking modes. 1M token context window with up to 384K output tokens. OpenAI-compatible and Anthropic-compatible API formats. Recorded cost row uses list pricing; a 75% promotional discount runs through 2026-05-31 15:59 UTC (effective $0.435/$0.87 per 1M tokens during the promo).';
  p_AIModelTypeID_58476aa1 := 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_PowerRank_58476aa1 := 15;
  p_IsActive_58476aa1 := TRUE;
  p_SpeedRank_58476aa1 := 7;
  p_CostRank_58476aa1 := 4;
  p_InheritTypeModalities_58476aa1 := TRUE;
  PERFORM __mj."spCreateAIModel"(p_ID := p_ID_58476aa1, p_Name := p_Name_58476aa1, p_Description := p_Description_58476aa1, p_AIModelTypeID := p_AIModelTypeID_58476aa1, p_PowerRank := p_PowerRank_58476aa1, p_IsActive := p_IsActive_58476aa1, p_SpeedRank := p_SpeedRank_58476aa1, p_CostRank := p_CostRank_58476aa1, p_ModelSelectionInsights := p_ModelSelectionInsights_58476aa1, p_ModelSelectionInsights_Clear := TRUE, p_InheritTypeModalities := p_InheritTypeModalities_58476aa1, p_PriorVersionID := p_PriorVersionID_58476aa1, p_PriorVersionID_Clear := TRUE, p_SupportsPrefill := p_SupportsPrefill_58476aa1, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_58476aa1, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_77742e5b UUID;
  p_Name_77742e5b VARCHAR(50);
  p_Description_77742e5b TEXT;
  p_AIModelTypeID_77742e5b UUID;
  p_PowerRank_77742e5b INTEGER;
  p_IsActive_77742e5b BOOLEAN;
  p_SpeedRank_77742e5b INTEGER;
  p_CostRank_77742e5b INTEGER;
  p_ModelSelectionInsights_77742e5b TEXT;
  p_InheritTypeModalities_77742e5b BOOLEAN;
  p_PriorVersionID_77742e5b UUID;
  p_SupportsPrefill_77742e5b BOOLEAN;
  p_PrefillFallbackText_77742e5b TEXT;
BEGIN
  p_ID_77742e5b := 'f69fa7a1-b8ef-463f-956d-54a9388bb70f';
  p_Name_77742e5b := 'DeepSeek V4 Flash';
  p_Description_77742e5b := 'DeepSeek''s cost-efficient counterpart to V4 Pro, released as preview April 24, 2026. Mixture-of-Experts with 284B total / 13B active parameters. MIT licensed open weights. Supports both thinking and non-thinking modes. 1M token context window with up to 384K output tokens. Same OpenAI-compatible and Anthropic-compatible API surface as V4 Pro. Designed for high-throughput, latency-sensitive workloads where V4 Pro''s reasoning depth is unnecessary.';
  p_AIModelTypeID_77742e5b := 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_PowerRank_77742e5b := 30;
  p_IsActive_77742e5b := TRUE;
  p_SpeedRank_77742e5b := 9;
  p_CostRank_77742e5b := 2;
  p_InheritTypeModalities_77742e5b := TRUE;
  PERFORM __mj."spCreateAIModel"(p_ID := p_ID_77742e5b, p_Name := p_Name_77742e5b, p_Description := p_Description_77742e5b, p_AIModelTypeID := p_AIModelTypeID_77742e5b, p_PowerRank := p_PowerRank_77742e5b, p_IsActive := p_IsActive_77742e5b, p_SpeedRank := p_SpeedRank_77742e5b, p_CostRank := p_CostRank_77742e5b, p_ModelSelectionInsights := p_ModelSelectionInsights_77742e5b, p_ModelSelectionInsights_Clear := TRUE, p_InheritTypeModalities := p_InheritTypeModalities_77742e5b, p_PriorVersionID := p_PriorVersionID_77742e5b, p_PriorVersionID_Clear := TRUE, p_SupportsPrefill := p_SupportsPrefill_77742e5b, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_77742e5b, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_ff5de815 UUID;
  p_Name_ff5de815 VARCHAR(50);
  p_Description_ff5de815 TEXT;
  p_AIModelTypeID_ff5de815 UUID;
  p_PowerRank_ff5de815 INTEGER;
  p_IsActive_ff5de815 BOOLEAN;
  p_SpeedRank_ff5de815 INTEGER;
  p_CostRank_ff5de815 INTEGER;
  p_ModelSelectionInsights_ff5de815 TEXT;
  p_InheritTypeModalities_ff5de815 BOOLEAN;
  p_PriorVersionID_ff5de815 UUID;
  p_SupportsPrefill_ff5de815 BOOLEAN;
  p_PrefillFallbackText_ff5de815 TEXT;
BEGIN
  p_ID_ff5de815 := '90456f5d-3603-4a93-acb6-86f06a657aaa';
  p_Name_ff5de815 := 'Kimi K2.6';
  p_Description_ff5de815 := 'Moonshot AI''s open-weight flagship coding and agent model, released April 20, 2026. 1-trillion-parameter Mixture-of-Experts with 32B active parameters per token, native INT4 quantization, Modified MIT License (open weights on Hugging Face). 256K (262,144) token context window with output ceiling matching the context. Multimodal (text/image/video in, text out). Top open-weights performer on the Artificial Analysis Intelligence Index (54). Provides OpenAI/Anthropic-compatible API at platform.moonshot.ai. Strong long-horizon coding and multi-agent orchestration with agent swarm scaling to hundreds of parallel sub-agents.';
  p_AIModelTypeID_ff5de815 := 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_PowerRank_ff5de815 := 18;
  p_IsActive_ff5de815 := TRUE;
  p_SpeedRank_ff5de815 := 7;
  p_CostRank_ff5de815 := 3;
  p_InheritTypeModalities_ff5de815 := TRUE;
  p_PriorVersionID_ff5de815 := '1C7F940F-436D-49D2-B258-162FD535DD49';
  PERFORM __mj."spCreateAIModel"(p_ID := p_ID_ff5de815, p_Name := p_Name_ff5de815, p_Description := p_Description_ff5de815, p_AIModelTypeID := p_AIModelTypeID_ff5de815, p_PowerRank := p_PowerRank_ff5de815, p_IsActive := p_IsActive_ff5de815, p_SpeedRank := p_SpeedRank_ff5de815, p_CostRank := p_CostRank_ff5de815, p_ModelSelectionInsights := p_ModelSelectionInsights_ff5de815, p_ModelSelectionInsights_Clear := TRUE, p_InheritTypeModalities := p_InheritTypeModalities_ff5de815, p_PriorVersionID := p_PriorVersionID_ff5de815, p_SupportsPrefill := p_SupportsPrefill_ff5de815, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_ff5de815, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_c675202e UUID;
  p_ModelID_c675202e UUID;
  p_VendorID_c675202e UUID;
  p_Priority_c675202e INTEGER;
  p_Status_c675202e VARCHAR(20);
  p_DriverClass_c675202e VARCHAR(100);
  p_DriverImportPath_c675202e VARCHAR(255);
  p_APIName_c675202e VARCHAR(100);
  p_MaxInputTokens_c675202e INTEGER;
  p_MaxOutputTokens_c675202e INTEGER;
  p_SupportedResponseFormats_c675202e VARCHAR(100);
  p_SupportsEffortLevel_c675202e BOOLEAN;
  p_SupportsStreaming_c675202e BOOLEAN;
  p_TypeID_c675202e UUID;
  p_SupportsPrefill_c675202e BOOLEAN;
  p_PrefillFallbackText_c675202e TEXT;
BEGIN
  p_ID_c675202e := 'cca4e253-2b87-4bfe-84f0-ae5013e3f2e2';
  p_ModelID_c675202e := 'DCDD6683-779F-4B03-89B5-746F95BB5293';
  p_VendorID_c675202e := 'D13D6306-2098-44B8-AEFA-9CE3694335EC';
  p_Priority_c675202e := 0;
  p_Status_c675202e := 'Active';
  p_SupportedResponseFormats_c675202e := 'Any';
  p_SupportsEffortLevel_c675202e := FALSE;
  p_SupportsStreaming_c675202e := FALSE;
  p_TypeID_c675202e := '10DB468E-F2CE-475D-9F39-2DF2DE75D257';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_c675202e, p_ModelID := p_ModelID_c675202e, p_VendorID := p_VendorID_c675202e, p_Priority := p_Priority_c675202e, p_Status := p_Status_c675202e, p_DriverClass := p_DriverClass_c675202e, p_DriverClass_Clear := TRUE, p_DriverImportPath := p_DriverImportPath_c675202e, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_c675202e, p_APIName_Clear := TRUE, p_MaxInputTokens := p_MaxInputTokens_c675202e, p_MaxInputTokens_Clear := TRUE, p_MaxOutputTokens := p_MaxOutputTokens_c675202e, p_MaxOutputTokens_Clear := TRUE, p_SupportedResponseFormats := p_SupportedResponseFormats_c675202e, p_SupportsEffortLevel := p_SupportsEffortLevel_c675202e, p_SupportsStreaming := p_SupportsStreaming_c675202e, p_TypeID := p_TypeID_c675202e, p_SupportsPrefill := p_SupportsPrefill_c675202e, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_c675202e, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_cb4f4032 UUID;
  p_ModelID_cb4f4032 UUID;
  p_VendorID_cb4f4032 UUID;
  p_Priority_cb4f4032 INTEGER;
  p_Status_cb4f4032 VARCHAR(20);
  p_DriverClass_cb4f4032 VARCHAR(100);
  p_DriverImportPath_cb4f4032 VARCHAR(255);
  p_APIName_cb4f4032 VARCHAR(100);
  p_MaxInputTokens_cb4f4032 INTEGER;
  p_MaxOutputTokens_cb4f4032 INTEGER;
  p_SupportedResponseFormats_cb4f4032 VARCHAR(100);
  p_SupportsEffortLevel_cb4f4032 BOOLEAN;
  p_SupportsStreaming_cb4f4032 BOOLEAN;
  p_TypeID_cb4f4032 UUID;
  p_SupportsPrefill_cb4f4032 BOOLEAN;
  p_PrefillFallbackText_cb4f4032 TEXT;
BEGIN
  p_ID_cb4f4032 := 'd71d9609-4dd5-442d-bbff-76963132e5b8';
  p_ModelID_cb4f4032 := 'F69FA7A1-B8EF-463F-956D-54A9388BB70F';
  p_VendorID_cb4f4032 := 'D13D6306-2098-44B8-AEFA-9CE3694335EC';
  p_Priority_cb4f4032 := 0;
  p_Status_cb4f4032 := 'Active';
  p_SupportedResponseFormats_cb4f4032 := 'Any';
  p_SupportsEffortLevel_cb4f4032 := FALSE;
  p_SupportsStreaming_cb4f4032 := FALSE;
  p_TypeID_cb4f4032 := '10DB468E-F2CE-475D-9F39-2DF2DE75D257';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_cb4f4032, p_ModelID := p_ModelID_cb4f4032, p_VendorID := p_VendorID_cb4f4032, p_Priority := p_Priority_cb4f4032, p_Status := p_Status_cb4f4032, p_DriverClass := p_DriverClass_cb4f4032, p_DriverClass_Clear := TRUE, p_DriverImportPath := p_DriverImportPath_cb4f4032, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_cb4f4032, p_APIName_Clear := TRUE, p_MaxInputTokens := p_MaxInputTokens_cb4f4032, p_MaxInputTokens_Clear := TRUE, p_MaxOutputTokens := p_MaxOutputTokens_cb4f4032, p_MaxOutputTokens_Clear := TRUE, p_SupportedResponseFormats := p_SupportedResponseFormats_cb4f4032, p_SupportsEffortLevel := p_SupportsEffortLevel_cb4f4032, p_SupportsStreaming := p_SupportsStreaming_cb4f4032, p_TypeID := p_TypeID_cb4f4032, p_SupportsPrefill := p_SupportsPrefill_cb4f4032, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_cb4f4032, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_a2e8c873 UUID;
  p_ModelID_a2e8c873 UUID;
  p_VendorID_a2e8c873 UUID;
  p_Priority_a2e8c873 INTEGER;
  p_Status_a2e8c873 VARCHAR(20);
  p_DriverClass_a2e8c873 VARCHAR(100);
  p_DriverImportPath_a2e8c873 VARCHAR(255);
  p_APIName_a2e8c873 VARCHAR(100);
  p_MaxInputTokens_a2e8c873 INTEGER;
  p_MaxOutputTokens_a2e8c873 INTEGER;
  p_SupportedResponseFormats_a2e8c873 VARCHAR(100);
  p_SupportsEffortLevel_a2e8c873 BOOLEAN;
  p_SupportsStreaming_a2e8c873 BOOLEAN;
  p_TypeID_a2e8c873 UUID;
  p_SupportsPrefill_a2e8c873 BOOLEAN;
  p_PrefillFallbackText_a2e8c873 TEXT;
BEGIN
  p_ID_a2e8c873 := '567e9de2-008f-424c-887f-55da04873338';
  p_ModelID_a2e8c873 := 'DCDD6683-779F-4B03-89B5-746F95BB5293';
  p_VendorID_a2e8c873 := 'D13D6306-2098-44B8-AEFA-9CE3694335EC';
  p_Priority_a2e8c873 := 1;
  p_Status_a2e8c873 := 'Active';
  p_DriverClass_a2e8c873 := 'DeepSeekLLM';
  p_APIName_a2e8c873 := 'deepseek-v4-pro';
  p_MaxInputTokens_a2e8c873 := 1000000;
  p_MaxOutputTokens_a2e8c873 := 384000;
  p_SupportedResponseFormats_a2e8c873 := 'Any, JSON';
  p_SupportsEffortLevel_a2e8c873 := FALSE;
  p_SupportsStreaming_a2e8c873 := TRUE;
  p_TypeID_a2e8c873 := '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_a2e8c873, p_ModelID := p_ModelID_a2e8c873, p_VendorID := p_VendorID_a2e8c873, p_Priority := p_Priority_a2e8c873, p_Status := p_Status_a2e8c873, p_DriverClass := p_DriverClass_a2e8c873, p_DriverImportPath := p_DriverImportPath_a2e8c873, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_a2e8c873, p_MaxInputTokens := p_MaxInputTokens_a2e8c873, p_MaxOutputTokens := p_MaxOutputTokens_a2e8c873, p_SupportedResponseFormats := p_SupportedResponseFormats_a2e8c873, p_SupportsEffortLevel := p_SupportsEffortLevel_a2e8c873, p_SupportsStreaming := p_SupportsStreaming_a2e8c873, p_TypeID := p_TypeID_a2e8c873, p_SupportsPrefill := p_SupportsPrefill_a2e8c873, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_a2e8c873, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_2220c530 UUID;
  p_ModelID_2220c530 UUID;
  p_VendorID_2220c530 UUID;
  p_Priority_2220c530 INTEGER;
  p_Status_2220c530 VARCHAR(20);
  p_DriverClass_2220c530 VARCHAR(100);
  p_DriverImportPath_2220c530 VARCHAR(255);
  p_APIName_2220c530 VARCHAR(100);
  p_MaxInputTokens_2220c530 INTEGER;
  p_MaxOutputTokens_2220c530 INTEGER;
  p_SupportedResponseFormats_2220c530 VARCHAR(100);
  p_SupportsEffortLevel_2220c530 BOOLEAN;
  p_SupportsStreaming_2220c530 BOOLEAN;
  p_TypeID_2220c530 UUID;
  p_SupportsPrefill_2220c530 BOOLEAN;
  p_PrefillFallbackText_2220c530 TEXT;
BEGIN
  p_ID_2220c530 := 'f874ba7c-c6dd-4281-9300-9b71f4c11416';
  p_ModelID_2220c530 := 'F69FA7A1-B8EF-463F-956D-54A9388BB70F';
  p_VendorID_2220c530 := 'D13D6306-2098-44B8-AEFA-9CE3694335EC';
  p_Priority_2220c530 := 1;
  p_Status_2220c530 := 'Active';
  p_DriverClass_2220c530 := 'DeepSeekLLM';
  p_APIName_2220c530 := 'deepseek-v4-flash';
  p_MaxInputTokens_2220c530 := 1000000;
  p_MaxOutputTokens_2220c530 := 384000;
  p_SupportedResponseFormats_2220c530 := 'Any, JSON';
  p_SupportsEffortLevel_2220c530 := FALSE;
  p_SupportsStreaming_2220c530 := TRUE;
  p_TypeID_2220c530 := '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_2220c530, p_ModelID := p_ModelID_2220c530, p_VendorID := p_VendorID_2220c530, p_Priority := p_Priority_2220c530, p_Status := p_Status_2220c530, p_DriverClass := p_DriverClass_2220c530, p_DriverImportPath := p_DriverImportPath_2220c530, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_2220c530, p_MaxInputTokens := p_MaxInputTokens_2220c530, p_MaxOutputTokens := p_MaxOutputTokens_2220c530, p_SupportedResponseFormats := p_SupportedResponseFormats_2220c530, p_SupportsEffortLevel := p_SupportsEffortLevel_2220c530, p_SupportsStreaming := p_SupportsStreaming_2220c530, p_TypeID := p_TypeID_2220c530, p_SupportsPrefill := p_SupportsPrefill_2220c530, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_2220c530, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_d79f729a UUID;
  p_ModelID_d79f729a UUID;
  p_VendorID_d79f729a UUID;
  p_StartedAt_d79f729a TIMESTAMPTZ;
  p_EndedAt_d79f729a TIMESTAMPTZ;
  p_Status_d79f729a VARCHAR(20);
  p_Currency_d79f729a CHAR(3);
  p_PriceTypeID_d79f729a UUID;
  p_InputPricePerUnit_d79f729a NUMERIC(18,8);
  p_OutputPricePerUnit_d79f729a NUMERIC(18,8);
  p_UnitTypeID_d79f729a UUID;
  p_ProcessingType_d79f729a VARCHAR(20);
  p_Comments_d79f729a TEXT;
BEGIN
  p_ID_d79f729a := '702b44c3-0806-49ee-98dd-a457b5f0ff31';
  p_ModelID_d79f729a := 'DCDD6683-779F-4B03-89B5-746F95BB5293';
  p_VendorID_d79f729a := 'D13D6306-2098-44B8-AEFA-9CE3694335EC';
  p_StartedAt_d79f729a := '2026-04-24T00:00:00.000Z';
  p_Status_d79f729a := 'Active';
  p_Currency_d79f729a := 'USD';
  p_PriceTypeID_d79f729a := 'ECE2BCB7-C854-4BF7-A517-D72793A40652';
  p_InputPricePerUnit_d79f729a := 1.74;
  p_OutputPricePerUnit_d79f729a := 3.48;
  p_UnitTypeID_d79f729a := '54208F7D-331C-40AB-84E8-163338EE9EA1';
  p_ProcessingType_d79f729a := 'Realtime';
  p_Comments_d79f729a := 'DeepSeek V4 Pro list pricing on DeepSeek direct API as of April 24, 2026 launch: $1.74/$3.48 per 1M tokens. A 75% promotional discount is in effect through 2026-05-31 15:59 UTC, bringing effective price to $0.435/$0.87 per 1M tokens. Cache-hit input pricing is 1/10 of launch price (effective from 2026-04-26). Sources: https://api-docs.deepseek.com/quick_start/pricing ; https://api-docs.deepseek.com/news/news260424';
  PERFORM __mj."spCreateAIModelCost"(p_ID := p_ID_d79f729a, p_ModelID := p_ModelID_d79f729a, p_VendorID := p_VendorID_d79f729a, p_StartedAt := p_StartedAt_d79f729a, p_EndedAt := p_EndedAt_d79f729a, p_EndedAt_Clear := TRUE, p_Status := p_Status_d79f729a, p_Currency := p_Currency_d79f729a, p_PriceTypeID := p_PriceTypeID_d79f729a, p_InputPricePerUnit := p_InputPricePerUnit_d79f729a, p_OutputPricePerUnit := p_OutputPricePerUnit_d79f729a, p_UnitTypeID := p_UnitTypeID_d79f729a, p_ProcessingType := p_ProcessingType_d79f729a, p_Comments := p_Comments_d79f729a);
END $mj$;
...
DECLARE
  p_ID_4b3414cb UUID;
  p_ModelID_4b3414cb UUID;
  p_VendorID_4b3414cb UUID;
  p_StartedAt_4b3414cb TIMESTAMPTZ;
  p_EndedAt_4b3414cb TIMESTAMPTZ;
  p_Status_4b3414cb VARCHAR(20);
  p_Currency_4b3414cb CHAR(3);
  p_PriceTypeID_4b3414cb UUID;
  p_InputPricePerUnit_4b3414cb NUMERIC(18,8);
  p_OutputPricePerUnit_4b3414cb NUMERIC(18,8);
  p_UnitTypeID_4b3414cb UUID;
  p_ProcessingType_4b3414cb VARCHAR(20);
  p_Comments_4b3414cb TEXT;
BEGIN
  p_ID_4b3414cb := '738963ab-9706-4dd5-87f0-b424bb87cbb0';
  p_ModelID_4b3414cb := 'F69FA7A1-B8EF-463F-956D-54A9388BB70F';
  p_VendorID_4b3414cb := 'D13D6306-2098-44B8-AEFA-9CE3694335EC';
  p_StartedAt_4b3414cb := '2026-04-24T00:00:00.000Z';
  p_Status_4b3414cb := 'Active';
  p_Currency_4b3414cb := 'USD';
  p_PriceTypeID_4b3414cb := 'ECE2BCB7-C854-4BF7-A517-D72793A40652';
  p_InputPricePerUnit_4b3414cb := 0.14;
  p_OutputPricePerUnit_4b3414cb := 0.28;
  p_UnitTypeID_4b3414cb := '54208F7D-331C-40AB-84E8-163338EE9EA1';
  p_ProcessingType_4b3414cb := 'Realtime';
  p_Comments_4b3414cb := 'DeepSeek V4 Flash pricing on DeepSeek direct API as of April 24, 2026 launch: $0.14/$0.28 per 1M tokens. Sources: https://api-docs.deepseek.com/quick_start/pricing ; https://api-docs.deepseek.com/news/news260424';
  PERFORM __mj."spCreateAIModelCost"(p_ID := p_ID_4b3414cb, p_ModelID := p_ModelID_4b3414cb, p_VendorID := p_VendorID_4b3414cb, p_StartedAt := p_StartedAt_4b3414cb, p_EndedAt := p_EndedAt_4b3414cb, p_EndedAt_Clear := TRUE, p_Status := p_Status_4b3414cb, p_Currency := p_Currency_4b3414cb, p_PriceTypeID := p_PriceTypeID_4b3414cb, p_InputPricePerUnit := p_InputPricePerUnit_4b3414cb, p_OutputPricePerUnit := p_OutputPricePerUnit_4b3414cb, p_UnitTypeID := p_UnitTypeID_4b3414cb, p_ProcessingType := p_ProcessingType_4b3414cb, p_Comments := p_Comments_4b3414cb);
END $mj$;
...
DECLARE
  p_ID_3811451a UUID;
  p_Name_3811451a VARCHAR(50);
  p_Description_3811451a TEXT;
  p_AIModelTypeID_3811451a UUID;
  p_PowerRank_3811451a INTEGER;
  p_IsActive_3811451a BOOLEAN;
  p_SpeedRank_3811451a INTEGER;
  p_CostRank_3811451a INTEGER;
  p_ModelSelectionInsights_3811451a TEXT;
  p_InheritTypeModalities_3811451a BOOLEAN;
  p_PriorVersionID_3811451a UUID;
  p_SupportsPrefill_3811451a BOOLEAN;
  p_PrefillFallbackText_3811451a TEXT;
BEGIN
  p_ID_3811451a := '87c9417e-45e6-4c97-95b1-ec0482c7fe4d';
  p_Name_3811451a := 'GPT 5.5';
  p_Description_3811451a := 'OpenAI''s flagship reasoning model, released April 24, 2026 (ChatGPT/Codex April 23, API April 24). Successor to GPT 5.4. Built for professional scenarios where precision, reliability, and persistence matter. 1,050,000 token context window (~1M) with 128K output capacity (Codex deployment uses a 400K context). Supports adjustable reasoning via reasoning_effort parameter (none, low, medium, high, xhigh). Available through Responses API and Chat Completions, also surfaced on Microsoft Foundry / Azure.';
  p_AIModelTypeID_3811451a := 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_PowerRank_3811451a := 12;
  p_IsActive_3811451a := TRUE;
  p_SpeedRank_3811451a := 7;
  p_CostRank_3811451a := 10;
  p_InheritTypeModalities_3811451a := TRUE;
  p_PriorVersionID_3811451a := '82081D5B-67B1-400A-ABF8-ACB1F045251F';
  PERFORM __mj."spCreateAIModel"(p_ID := p_ID_3811451a, p_Name := p_Name_3811451a, p_Description := p_Description_3811451a, p_AIModelTypeID := p_AIModelTypeID_3811451a, p_PowerRank := p_PowerRank_3811451a, p_IsActive := p_IsActive_3811451a, p_SpeedRank := p_SpeedRank_3811451a, p_CostRank := p_CostRank_3811451a, p_ModelSelectionInsights := p_ModelSelectionInsights_3811451a, p_ModelSelectionInsights_Clear := TRUE, p_InheritTypeModalities := p_InheritTypeModalities_3811451a, p_PriorVersionID := p_PriorVersionID_3811451a, p_SupportsPrefill := p_SupportsPrefill_3811451a, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_3811451a, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_b22aa3a7 UUID;
  p_Name_b22aa3a7 VARCHAR(50);
  p_Description_b22aa3a7 TEXT;
  p_AIModelTypeID_b22aa3a7 UUID;
  p_PowerRank_b22aa3a7 INTEGER;
  p_IsActive_b22aa3a7 BOOLEAN;
  p_SpeedRank_b22aa3a7 INTEGER;
  p_CostRank_b22aa3a7 INTEGER;
  p_ModelSelectionInsights_b22aa3a7 TEXT;
  p_InheritTypeModalities_b22aa3a7 BOOLEAN;
  p_PriorVersionID_b22aa3a7 UUID;
  p_SupportsPrefill_b22aa3a7 BOOLEAN;
  p_PrefillFallbackText_b22aa3a7 TEXT;
BEGIN
  p_ID_b22aa3a7 := '0d5b7ac2-1130-4611-95d4-9a6fae129569';
  p_Name_b22aa3a7 := 'Grok 4.3';
  p_Description_b22aa3a7 := 'xAI''s new flagship reasoning model, released April 30, 2026 (beta to SuperGrok Heavy on April 17). Always-on reasoning - ''thinks'' before responding for every query. 1M token context window. Built-in code execution environment, video upload support, and native generation of downloadable PDFs, fully populated spreadsheets, and PowerPoint decks. Scores 53 on the Artificial Analysis Intelligence Index at 207 t/s output speed. Aggressively priced at 40% lower than Grok 4.20.';
  p_AIModelTypeID_b22aa3a7 := 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_PowerRank_b22aa3a7 := 16;
  p_IsActive_b22aa3a7 := TRUE;
  p_SpeedRank_b22aa3a7 := 8;
  p_CostRank_b22aa3a7 := 4;
  p_InheritTypeModalities_b22aa3a7 := TRUE;
  p_PriorVersionID_b22aa3a7 := '839968F1-9520-4C69-BE84-5F901D0123A6';
  PERFORM __mj."spCreateAIModel"(p_ID := p_ID_b22aa3a7, p_Name := p_Name_b22aa3a7, p_Description := p_Description_b22aa3a7, p_AIModelTypeID := p_AIModelTypeID_b22aa3a7, p_PowerRank := p_PowerRank_b22aa3a7, p_IsActive := p_IsActive_b22aa3a7, p_SpeedRank := p_SpeedRank_b22aa3a7, p_CostRank := p_CostRank_b22aa3a7, p_ModelSelectionInsights := p_ModelSelectionInsights_b22aa3a7, p_ModelSelectionInsights_Clear := TRUE, p_InheritTypeModalities := p_InheritTypeModalities_b22aa3a7, p_PriorVersionID := p_PriorVersionID_b22aa3a7, p_SupportsPrefill := p_SupportsPrefill_b22aa3a7, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_b22aa3a7, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_d0f43f3c UUID;
  p_ModelID_d0f43f3c UUID;
  p_VendorID_d0f43f3c UUID;
  p_Priority_d0f43f3c INTEGER;
  p_Status_d0f43f3c VARCHAR(20);
  p_DriverClass_d0f43f3c VARCHAR(100);
  p_DriverImportPath_d0f43f3c VARCHAR(255);
  p_APIName_d0f43f3c VARCHAR(100);
  p_MaxInputTokens_d0f43f3c INTEGER;
  p_MaxOutputTokens_d0f43f3c INTEGER;
  p_SupportedResponseFormats_d0f43f3c VARCHAR(100);
  p_SupportsEffortLevel_d0f43f3c BOOLEAN;
  p_SupportsStreaming_d0f43f3c BOOLEAN;
  p_TypeID_d0f43f3c UUID;
  p_SupportsPrefill_d0f43f3c BOOLEAN;
  p_PrefillFallbackText_d0f43f3c TEXT;
BEGIN
  p_ID_d0f43f3c := '73a9cf79-08e2-4182-941d-47f3473f2980';
  p_ModelID_d0f43f3c := '90456F5D-3603-4A93-ACB6-86F06A657AAA';
  p_VendorID_d0f43f3c := 'F46A85CC-2897-4FB5-B557-99A95E93A42D';
  p_Priority_d0f43f3c := 0;
  p_Status_d0f43f3c := 'Active';
  p_SupportedResponseFormats_d0f43f3c := 'Any';
  p_SupportsEffortLevel_d0f43f3c := FALSE;
  p_SupportsStreaming_d0f43f3c := FALSE;
  p_TypeID_d0f43f3c := '10DB468E-F2CE-475D-9F39-2DF2DE75D257';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_d0f43f3c, p_ModelID := p_ModelID_d0f43f3c, p_VendorID := p_VendorID_d0f43f3c, p_Priority := p_Priority_d0f43f3c, p_Status := p_Status_d0f43f3c, p_DriverClass := p_DriverClass_d0f43f3c, p_DriverClass_Clear := TRUE, p_DriverImportPath := p_DriverImportPath_d0f43f3c, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_d0f43f3c, p_APIName_Clear := TRUE, p_MaxInputTokens := p_MaxInputTokens_d0f43f3c, p_MaxInputTokens_Clear := TRUE, p_MaxOutputTokens := p_MaxOutputTokens_d0f43f3c, p_MaxOutputTokens_Clear := TRUE, p_SupportedResponseFormats := p_SupportedResponseFormats_d0f43f3c, p_SupportsEffortLevel := p_SupportsEffortLevel_d0f43f3c, p_SupportsStreaming := p_SupportsStreaming_d0f43f3c, p_TypeID := p_TypeID_d0f43f3c, p_SupportsPrefill := p_SupportsPrefill_d0f43f3c, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_d0f43f3c, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_ace63078 UUID;
  p_ModelID_ace63078 UUID;
  p_VendorID_ace63078 UUID;
  p_Priority_ace63078 INTEGER;
  p_Status_ace63078 VARCHAR(20);
  p_DriverClass_ace63078 VARCHAR(100);
  p_DriverImportPath_ace63078 VARCHAR(255);
  p_APIName_ace63078 VARCHAR(100);
  p_MaxInputTokens_ace63078 INTEGER;
  p_MaxOutputTokens_ace63078 INTEGER;
  p_SupportedResponseFormats_ace63078 VARCHAR(100);
  p_SupportsEffortLevel_ace63078 BOOLEAN;
  p_SupportsStreaming_ace63078 BOOLEAN;
  p_TypeID_ace63078 UUID;
  p_SupportsPrefill_ace63078 BOOLEAN;
  p_PrefillFallbackText_ace63078 TEXT;
BEGIN
  p_ID_ace63078 := '68fc8051-b204-4960-a113-33f448a68e66';
  p_ModelID_ace63078 := '90456F5D-3603-4A93-ACB6-86F06A657AAA';
  p_VendorID_ace63078 := 'F46A85CC-2897-4FB5-B557-99A95E93A42D';
  p_Priority_ace63078 := 1;
  p_Status_ace63078 := 'Active';
  p_DriverClass_ace63078 := 'MoonshotLLM';
  p_APIName_ace63078 := 'kimi-k2.6';
  p_MaxInputTokens_ace63078 := 262144;
  p_MaxOutputTokens_ace63078 := 262144;
  p_SupportedResponseFormats_ace63078 := 'Any, JSON';
  p_SupportsEffortLevel_ace63078 := FALSE;
  p_SupportsStreaming_ace63078 := TRUE;
  p_TypeID_ace63078 := '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_ace63078, p_ModelID := p_ModelID_ace63078, p_VendorID := p_VendorID_ace63078, p_Priority := p_Priority_ace63078, p_Status := p_Status_ace63078, p_DriverClass := p_DriverClass_ace63078, p_DriverImportPath := p_DriverImportPath_ace63078, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_ace63078, p_MaxInputTokens := p_MaxInputTokens_ace63078, p_MaxOutputTokens := p_MaxOutputTokens_ace63078, p_SupportedResponseFormats := p_SupportedResponseFormats_ace63078, p_SupportsEffortLevel := p_SupportsEffortLevel_ace63078, p_SupportsStreaming := p_SupportsStreaming_ace63078, p_TypeID := p_TypeID_ace63078, p_SupportsPrefill := p_SupportsPrefill_ace63078, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_ace63078, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_e777a1da UUID;
  p_ModelID_e777a1da UUID;
  p_VendorID_e777a1da UUID;
  p_StartedAt_e777a1da TIMESTAMPTZ;
  p_EndedAt_e777a1da TIMESTAMPTZ;
  p_Status_e777a1da VARCHAR(20);
  p_Currency_e777a1da CHAR(3);
  p_PriceTypeID_e777a1da UUID;
  p_InputPricePerUnit_e777a1da NUMERIC(18,8);
  p_OutputPricePerUnit_e777a1da NUMERIC(18,8);
  p_UnitTypeID_e777a1da UUID;
  p_ProcessingType_e777a1da VARCHAR(20);
  p_Comments_e777a1da TEXT;
BEGIN
  p_ID_e777a1da := '4afc2907-e94d-40d9-9784-9abd4604e0d7';
  p_ModelID_e777a1da := '90456F5D-3603-4A93-ACB6-86F06A657AAA';
  p_VendorID_e777a1da := 'F46A85CC-2897-4FB5-B557-99A95E93A42D';
  p_StartedAt_e777a1da := '2026-04-20T00:00:00.000Z';
  p_Status_e777a1da := 'Active';
  p_Currency_e777a1da := 'USD';
  p_PriceTypeID_e777a1da := 'ECE2BCB7-C854-4BF7-A517-D72793A40652';
  p_InputPricePerUnit_e777a1da := 0.6;
  p_OutputPricePerUnit_e777a1da := 2.5;
  p_UnitTypeID_e777a1da := '54208F7D-331C-40AB-84E8-163338EE9EA1';
  p_ProcessingType_e777a1da := 'Realtime';
  p_Comments_e777a1da := 'Kimi K2.6 launch pricing on Moonshot direct API as of April 20, 2026: $0.60/$2.50 per 1M tokens. Some aggregator pages quote $0.74/$3.49 (likely a different SKU/tier or post-launch adjustment) - the official launch announcement quoted $0.60/$2.50. Verify on platform.moonshot.ai before relying on this price for billing. Sources: https://www.kimi.com/blog/kimi-k2-6 ; https://huggingface.co/moonshotai/Kimi-K2.6';
  PERFORM __mj."spCreateAIModelCost"(p_ID := p_ID_e777a1da, p_ModelID := p_ModelID_e777a1da, p_VendorID := p_VendorID_e777a1da, p_StartedAt := p_StartedAt_e777a1da, p_EndedAt := p_EndedAt_e777a1da, p_EndedAt_Clear := TRUE, p_Status := p_Status_e777a1da, p_Currency := p_Currency_e777a1da, p_PriceTypeID := p_PriceTypeID_e777a1da, p_InputPricePerUnit := p_InputPricePerUnit_e777a1da, p_OutputPricePerUnit := p_OutputPricePerUnit_e777a1da, p_UnitTypeID := p_UnitTypeID_e777a1da, p_ProcessingType := p_ProcessingType_e777a1da, p_Comments := p_Comments_e777a1da);
END $mj$;
...
DECLARE
  p_ID_0d1fd9ef UUID;
  p_ModelID_0d1fd9ef UUID;
  p_VendorID_0d1fd9ef UUID;
  p_Priority_0d1fd9ef INTEGER;
  p_Status_0d1fd9ef VARCHAR(20);
  p_DriverClass_0d1fd9ef VARCHAR(100);
  p_DriverImportPath_0d1fd9ef VARCHAR(255);
  p_APIName_0d1fd9ef VARCHAR(100);
  p_MaxInputTokens_0d1fd9ef INTEGER;
  p_MaxOutputTokens_0d1fd9ef INTEGER;
  p_SupportedResponseFormats_0d1fd9ef VARCHAR(100);
  p_SupportsEffortLevel_0d1fd9ef BOOLEAN;
  p_SupportsStreaming_0d1fd9ef BOOLEAN;
  p_TypeID_0d1fd9ef UUID;
  p_SupportsPrefill_0d1fd9ef BOOLEAN;
  p_PrefillFallbackText_0d1fd9ef TEXT;
BEGIN
  p_ID_0d1fd9ef := 'b25b6b52-78f3-4f78-a225-87273ec811ef';
  p_ModelID_0d1fd9ef := '87C9417E-45E6-4C97-95B1-EC0482C7FE4D';
  p_VendorID_0d1fd9ef := 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_Priority_0d1fd9ef := 0;
  p_Status_0d1fd9ef := 'Active';
  p_SupportedResponseFormats_0d1fd9ef := 'Any';
  p_SupportsEffortLevel_0d1fd9ef := TRUE;
  p_SupportsStreaming_0d1fd9ef := FALSE;
  p_TypeID_0d1fd9ef := '10DB468E-F2CE-475D-9F39-2DF2DE75D257';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_0d1fd9ef, p_ModelID := p_ModelID_0d1fd9ef, p_VendorID := p_VendorID_0d1fd9ef, p_Priority := p_Priority_0d1fd9ef, p_Status := p_Status_0d1fd9ef, p_DriverClass := p_DriverClass_0d1fd9ef, p_DriverClass_Clear := TRUE, p_DriverImportPath := p_DriverImportPath_0d1fd9ef, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_0d1fd9ef, p_APIName_Clear := TRUE, p_MaxInputTokens := p_MaxInputTokens_0d1fd9ef, p_MaxInputTokens_Clear := TRUE, p_MaxOutputTokens := p_MaxOutputTokens_0d1fd9ef, p_MaxOutputTokens_Clear := TRUE, p_SupportedResponseFormats := p_SupportedResponseFormats_0d1fd9ef, p_SupportsEffortLevel := p_SupportsEffortLevel_0d1fd9ef, p_SupportsStreaming := p_SupportsStreaming_0d1fd9ef, p_TypeID := p_TypeID_0d1fd9ef, p_SupportsPrefill := p_SupportsPrefill_0d1fd9ef, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_0d1fd9ef, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_6e10789c UUID;
  p_ModelID_6e10789c UUID;
  p_VendorID_6e10789c UUID;
  p_Priority_6e10789c INTEGER;
  p_Status_6e10789c VARCHAR(20);
  p_DriverClass_6e10789c VARCHAR(100);
  p_DriverImportPath_6e10789c VARCHAR(255);
  p_APIName_6e10789c VARCHAR(100);
  p_MaxInputTokens_6e10789c INTEGER;
  p_MaxOutputTokens_6e10789c INTEGER;
  p_SupportedResponseFormats_6e10789c VARCHAR(100);
  p_SupportsEffortLevel_6e10789c BOOLEAN;
  p_SupportsStreaming_6e10789c BOOLEAN;
  p_TypeID_6e10789c UUID;
  p_SupportsPrefill_6e10789c BOOLEAN;
  p_PrefillFallbackText_6e10789c TEXT;
BEGIN
  p_ID_6e10789c := '47e05857-30c7-40b1-8a02-323a3dc6ba4f';
  p_ModelID_6e10789c := '87C9417E-45E6-4C97-95B1-EC0482C7FE4D';
  p_VendorID_6e10789c := 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_Priority_6e10789c := 1;
  p_Status_6e10789c := 'Active';
  p_DriverClass_6e10789c := 'OpenAILLM';
  p_APIName_6e10789c := 'gpt-5.5';
  p_MaxInputTokens_6e10789c := 1050000;
  p_MaxOutputTokens_6e10789c := 128000;
  p_SupportedResponseFormats_6e10789c := 'Any, JSON';
  p_SupportsEffortLevel_6e10789c := TRUE;
  p_SupportsStreaming_6e10789c := TRUE;
  p_TypeID_6e10789c := '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_6e10789c, p_ModelID := p_ModelID_6e10789c, p_VendorID := p_VendorID_6e10789c, p_Priority := p_Priority_6e10789c, p_Status := p_Status_6e10789c, p_DriverClass := p_DriverClass_6e10789c, p_DriverImportPath := p_DriverImportPath_6e10789c, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_6e10789c, p_MaxInputTokens := p_MaxInputTokens_6e10789c, p_MaxOutputTokens := p_MaxOutputTokens_6e10789c, p_SupportedResponseFormats := p_SupportedResponseFormats_6e10789c, p_SupportsEffortLevel := p_SupportsEffortLevel_6e10789c, p_SupportsStreaming := p_SupportsStreaming_6e10789c, p_TypeID := p_TypeID_6e10789c, p_SupportsPrefill := p_SupportsPrefill_6e10789c, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_6e10789c, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_7d179e68 UUID;
  p_ModelID_7d179e68 UUID;
  p_VendorID_7d179e68 UUID;
  p_Priority_7d179e68 INTEGER;
  p_Status_7d179e68 VARCHAR(20);
  p_DriverClass_7d179e68 VARCHAR(100);
  p_DriverImportPath_7d179e68 VARCHAR(255);
  p_APIName_7d179e68 VARCHAR(100);
  p_MaxInputTokens_7d179e68 INTEGER;
  p_MaxOutputTokens_7d179e68 INTEGER;
  p_SupportedResponseFormats_7d179e68 VARCHAR(100);
  p_SupportsEffortLevel_7d179e68 BOOLEAN;
  p_SupportsStreaming_7d179e68 BOOLEAN;
  p_TypeID_7d179e68 UUID;
  p_SupportsPrefill_7d179e68 BOOLEAN;
  p_PrefillFallbackText_7d179e68 TEXT;
BEGIN
  p_ID_7d179e68 := '3e9f33ff-32dc-48be-b4b2-1a34557ed77c';
  p_ModelID_7d179e68 := '87C9417E-45E6-4C97-95B1-EC0482C7FE4D';
  p_VendorID_7d179e68 := 'D75ABC84-6BDB-41B9-94C7-2FE748482193';
  p_Priority_7d179e68 := 5;
  p_Status_7d179e68 := 'Active';
  p_DriverClass_7d179e68 := 'AzureLLM';
  p_APIName_7d179e68 := 'gpt-5.5';
  p_MaxInputTokens_7d179e68 := 1050000;
  p_MaxOutputTokens_7d179e68 := 128000;
  p_SupportedResponseFormats_7d179e68 := 'Any, JSON';
  p_SupportsEffortLevel_7d179e68 := FALSE;
  p_SupportsStreaming_7d179e68 := TRUE;
  p_TypeID_7d179e68 := '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_7d179e68, p_ModelID := p_ModelID_7d179e68, p_VendorID := p_VendorID_7d179e68, p_Priority := p_Priority_7d179e68, p_Status := p_Status_7d179e68, p_DriverClass := p_DriverClass_7d179e68, p_DriverImportPath := p_DriverImportPath_7d179e68, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_7d179e68, p_MaxInputTokens := p_MaxInputTokens_7d179e68, p_MaxOutputTokens := p_MaxOutputTokens_7d179e68, p_SupportedResponseFormats := p_SupportedResponseFormats_7d179e68, p_SupportsEffortLevel := p_SupportsEffortLevel_7d179e68, p_SupportsStreaming := p_SupportsStreaming_7d179e68, p_TypeID := p_TypeID_7d179e68, p_SupportsPrefill := p_SupportsPrefill_7d179e68, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_7d179e68, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_0c08f5a0 UUID;
  p_ModelID_0c08f5a0 UUID;
  p_VendorID_0c08f5a0 UUID;
  p_StartedAt_0c08f5a0 TIMESTAMPTZ;
  p_EndedAt_0c08f5a0 TIMESTAMPTZ;
  p_Status_0c08f5a0 VARCHAR(20);
  p_Currency_0c08f5a0 CHAR(3);
  p_PriceTypeID_0c08f5a0 UUID;
  p_InputPricePerUnit_0c08f5a0 NUMERIC(18,8);
  p_OutputPricePerUnit_0c08f5a0 NUMERIC(18,8);
  p_UnitTypeID_0c08f5a0 UUID;
  p_ProcessingType_0c08f5a0 VARCHAR(20);
  p_Comments_0c08f5a0 TEXT;
BEGIN
  p_ID_0c08f5a0 := 'e049a222-e24b-4c5e-ab27-7da7fedcc44a';
  p_ModelID_0c08f5a0 := '87C9417E-45E6-4C97-95B1-EC0482C7FE4D';
  p_VendorID_0c08f5a0 := 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_StartedAt_0c08f5a0 := '2026-04-24T00:00:00.000Z';
  p_Status_0c08f5a0 := 'Active';
  p_Currency_0c08f5a0 := 'USD';
  p_PriceTypeID_0c08f5a0 := 'ECE2BCB7-C854-4BF7-A517-D72793A40652';
  p_InputPricePerUnit_0c08f5a0 := 5;
  p_OutputPricePerUnit_0c08f5a0 := 30;
  p_UnitTypeID_0c08f5a0 := '54208F7D-331C-40AB-84E8-163338EE9EA1';
  p_ProcessingType_0c08f5a0 := 'Realtime';
  p_Comments_0c08f5a0 := 'GPT 5.5 standard pricing on OpenAI as of April 24, 2026 launch. $5.00/$30.00 per 1M tokens. Prompts >272K input tokens billed at 2x input and 1.5x output for the full session (standard, batch, and flex tiers). Batch and Flex APIs at 50% off; Priority at 2.5x standard. Regional data-residency endpoints carry a 10% uplift. Source: https://openai.com/index/introducing-gpt-5-5/';
  PERFORM __mj."spCreateAIModelCost"(p_ID := p_ID_0c08f5a0, p_ModelID := p_ModelID_0c08f5a0, p_VendorID := p_VendorID_0c08f5a0, p_StartedAt := p_StartedAt_0c08f5a0, p_EndedAt := p_EndedAt_0c08f5a0, p_EndedAt_Clear := TRUE, p_Status := p_Status_0c08f5a0, p_Currency := p_Currency_0c08f5a0, p_PriceTypeID := p_PriceTypeID_0c08f5a0, p_InputPricePerUnit := p_InputPricePerUnit_0c08f5a0, p_OutputPricePerUnit := p_OutputPricePerUnit_0c08f5a0, p_UnitTypeID := p_UnitTypeID_0c08f5a0, p_ProcessingType := p_ProcessingType_0c08f5a0, p_Comments := p_Comments_0c08f5a0);
END $mj$;
...
DECLARE
  p_ID_44775e6a UUID;
  p_ModelID_44775e6a UUID;
  p_VendorID_44775e6a UUID;
  p_StartedAt_44775e6a TIMESTAMPTZ;
  p_EndedAt_44775e6a TIMESTAMPTZ;
  p_Status_44775e6a VARCHAR(20);
  p_Currency_44775e6a CHAR(3);
  p_PriceTypeID_44775e6a UUID;
  p_InputPricePerUnit_44775e6a NUMERIC(18,8);
  p_OutputPricePerUnit_44775e6a NUMERIC(18,8);
  p_UnitTypeID_44775e6a UUID;
  p_ProcessingType_44775e6a VARCHAR(20);
  p_Comments_44775e6a TEXT;
BEGIN
  p_ID_44775e6a := '60686413-8d43-47be-8c7a-401381b81cac';
  p_ModelID_44775e6a := '87C9417E-45E6-4C97-95B1-EC0482C7FE4D';
  p_VendorID_44775e6a := 'D75ABC84-6BDB-41B9-94C7-2FE748482193';
  p_StartedAt_44775e6a := '2026-04-24T00:00:00.000Z';
  p_Status_44775e6a := 'Active';
  p_Currency_44775e6a := 'USD';
  p_PriceTypeID_44775e6a := 'ECE2BCB7-C854-4BF7-A517-D72793A40652';
  p_InputPricePerUnit_44775e6a := 5;
  p_OutputPricePerUnit_44775e6a := 30;
  p_UnitTypeID_44775e6a := '54208F7D-331C-40AB-84E8-163338EE9EA1';
  p_ProcessingType_44775e6a := 'Realtime';
  p_Comments_44775e6a := 'GPT 5.5 pricing on Azure OpenAI / Microsoft Foundry (Global Standard) as of April 24, 2026 launch. Source: https://azure.microsoft.com/en-us/blog/openais-gpt-5-5-in-microsoft-foundry-frontier-intelligence-on-an-enterprise-ready-platform/';
  PERFORM __mj."spCreateAIModelCost"(p_ID := p_ID_44775e6a, p_ModelID := p_ModelID_44775e6a, p_VendorID := p_VendorID_44775e6a, p_StartedAt := p_StartedAt_44775e6a, p_EndedAt := p_EndedAt_44775e6a, p_EndedAt_Clear := TRUE, p_Status := p_Status_44775e6a, p_Currency := p_Currency_44775e6a, p_PriceTypeID := p_PriceTypeID_44775e6a, p_InputPricePerUnit := p_InputPricePerUnit_44775e6a, p_OutputPricePerUnit := p_OutputPricePerUnit_44775e6a, p_UnitTypeID := p_UnitTypeID_44775e6a, p_ProcessingType := p_ProcessingType_44775e6a, p_Comments := p_Comments_44775e6a);
END $mj$;
...
DECLARE
  p_ID_09424e94 UUID;
  p_Name_09424e94 VARCHAR(50);
  p_Description_09424e94 TEXT;
  p_AIModelTypeID_09424e94 UUID;
  p_PowerRank_09424e94 INTEGER;
  p_IsActive_09424e94 BOOLEAN;
  p_SpeedRank_09424e94 INTEGER;
  p_CostRank_09424e94 INTEGER;
  p_ModelSelectionInsights_09424e94 TEXT;
  p_InheritTypeModalities_09424e94 BOOLEAN;
  p_PriorVersionID_09424e94 UUID;
  p_SupportsPrefill_09424e94 BOOLEAN;
  p_PrefillFallbackText_09424e94 TEXT;
BEGIN
  p_ID_09424e94 := 'a19488eb-5168-4d47-bbcb-f94054e0b6a7';
  p_Name_09424e94 := 'GPT 5.5 Pro';
  p_Description_09424e94 := 'OpenAI''s premium variant of GPT 5.5, released April 24, 2026. Extends reasoning depth and task complexity for the most demanding enterprise workloads. Same 1M input / 128K output token window as GPT 5.5. Available through the Responses API and Batch API. Pricing reflects deeper reasoning compute: 6x the input and 6x the output cost of standard GPT 5.5.';
  p_AIModelTypeID_09424e94 := 'E8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_PowerRank_09424e94 := 8;
  p_IsActive_09424e94 := TRUE;
  p_SpeedRank_09424e94 := 5;
  p_CostRank_09424e94 := 10;
  p_InheritTypeModalities_09424e94 := TRUE;
  p_PriorVersionID_09424e94 := '87C9417E-45E6-4C97-95B1-EC0482C7FE4D';
  PERFORM __mj."spCreateAIModel"(p_ID := p_ID_09424e94, p_Name := p_Name_09424e94, p_Description := p_Description_09424e94, p_AIModelTypeID := p_AIModelTypeID_09424e94, p_PowerRank := p_PowerRank_09424e94, p_IsActive := p_IsActive_09424e94, p_SpeedRank := p_SpeedRank_09424e94, p_CostRank := p_CostRank_09424e94, p_ModelSelectionInsights := p_ModelSelectionInsights_09424e94, p_ModelSelectionInsights_Clear := TRUE, p_InheritTypeModalities := p_InheritTypeModalities_09424e94, p_PriorVersionID := p_PriorVersionID_09424e94, p_SupportsPrefill := p_SupportsPrefill_09424e94, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_09424e94, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_97ed1236 UUID;
  p_ModelID_97ed1236 UUID;
  p_VendorID_97ed1236 UUID;
  p_Priority_97ed1236 INTEGER;
  p_Status_97ed1236 VARCHAR(20);
  p_DriverClass_97ed1236 VARCHAR(100);
  p_DriverImportPath_97ed1236 VARCHAR(255);
  p_APIName_97ed1236 VARCHAR(100);
  p_MaxInputTokens_97ed1236 INTEGER;
  p_MaxOutputTokens_97ed1236 INTEGER;
  p_SupportedResponseFormats_97ed1236 VARCHAR(100);
  p_SupportsEffortLevel_97ed1236 BOOLEAN;
  p_SupportsStreaming_97ed1236 BOOLEAN;
  p_TypeID_97ed1236 UUID;
  p_SupportsPrefill_97ed1236 BOOLEAN;
  p_PrefillFallbackText_97ed1236 TEXT;
BEGIN
  p_ID_97ed1236 := '9ed2b6df-53b7-48d7-b528-f33431b65970';
  p_ModelID_97ed1236 := '0D5B7AC2-1130-4611-95D4-9A6FAE129569';
  p_VendorID_97ed1236 := '5483D98F-1F4E-40F4-91FC-EAA8EFDC90F1';
  p_Priority_97ed1236 := 0;
  p_Status_97ed1236 := 'Active';
  p_SupportedResponseFormats_97ed1236 := 'Any';
  p_SupportsEffortLevel_97ed1236 := FALSE;
  p_SupportsStreaming_97ed1236 := FALSE;
  p_TypeID_97ed1236 := '10DB468E-F2CE-475D-9F39-2DF2DE75D257';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_97ed1236, p_ModelID := p_ModelID_97ed1236, p_VendorID := p_VendorID_97ed1236, p_Priority := p_Priority_97ed1236, p_Status := p_Status_97ed1236, p_DriverClass := p_DriverClass_97ed1236, p_DriverClass_Clear := TRUE, p_DriverImportPath := p_DriverImportPath_97ed1236, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_97ed1236, p_APIName_Clear := TRUE, p_MaxInputTokens := p_MaxInputTokens_97ed1236, p_MaxInputTokens_Clear := TRUE, p_MaxOutputTokens := p_MaxOutputTokens_97ed1236, p_MaxOutputTokens_Clear := TRUE, p_SupportedResponseFormats := p_SupportedResponseFormats_97ed1236, p_SupportsEffortLevel := p_SupportsEffortLevel_97ed1236, p_SupportsStreaming := p_SupportsStreaming_97ed1236, p_TypeID := p_TypeID_97ed1236, p_SupportsPrefill := p_SupportsPrefill_97ed1236, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_97ed1236, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_759ee58f UUID;
  p_ModelID_759ee58f UUID;
  p_VendorID_759ee58f UUID;
  p_Priority_759ee58f INTEGER;
  p_Status_759ee58f VARCHAR(20);
  p_DriverClass_759ee58f VARCHAR(100);
  p_DriverImportPath_759ee58f VARCHAR(255);
  p_APIName_759ee58f VARCHAR(100);
  p_MaxInputTokens_759ee58f INTEGER;
  p_MaxOutputTokens_759ee58f INTEGER;
  p_SupportedResponseFormats_759ee58f VARCHAR(100);
  p_SupportsEffortLevel_759ee58f BOOLEAN;
  p_SupportsStreaming_759ee58f BOOLEAN;
  p_TypeID_759ee58f UUID;
  p_SupportsPrefill_759ee58f BOOLEAN;
  p_PrefillFallbackText_759ee58f TEXT;
BEGIN
  p_ID_759ee58f := '42dbadf5-e1e6-4d27-8cef-e20771c0b48d';
  p_ModelID_759ee58f := '0D5B7AC2-1130-4611-95D4-9A6FAE129569';
  p_VendorID_759ee58f := '5483D98F-1F4E-40F4-91FC-EAA8EFDC90F1';
  p_Priority_759ee58f := 1;
  p_Status_759ee58f := 'Active';
  p_DriverClass_759ee58f := 'xAILLM';
  p_APIName_759ee58f := 'grok-4.3';
  p_MaxInputTokens_759ee58f := 1000000;
  p_MaxOutputTokens_759ee58f := 128000;
  p_SupportedResponseFormats_759ee58f := 'Any, JSON';
  p_SupportsEffortLevel_759ee58f := FALSE;
  p_SupportsStreaming_759ee58f := TRUE;
  p_TypeID_759ee58f := '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_759ee58f, p_ModelID := p_ModelID_759ee58f, p_VendorID := p_VendorID_759ee58f, p_Priority := p_Priority_759ee58f, p_Status := p_Status_759ee58f, p_DriverClass := p_DriverClass_759ee58f, p_DriverImportPath := p_DriverImportPath_759ee58f, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_759ee58f, p_MaxInputTokens := p_MaxInputTokens_759ee58f, p_MaxOutputTokens := p_MaxOutputTokens_759ee58f, p_SupportedResponseFormats := p_SupportedResponseFormats_759ee58f, p_SupportsEffortLevel := p_SupportsEffortLevel_759ee58f, p_SupportsStreaming := p_SupportsStreaming_759ee58f, p_TypeID := p_TypeID_759ee58f, p_SupportsPrefill := p_SupportsPrefill_759ee58f, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_759ee58f, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_df216186 UUID;
  p_ModelID_df216186 UUID;
  p_VendorID_df216186 UUID;
  p_StartedAt_df216186 TIMESTAMPTZ;
  p_EndedAt_df216186 TIMESTAMPTZ;
  p_Status_df216186 VARCHAR(20);
  p_Currency_df216186 CHAR(3);
  p_PriceTypeID_df216186 UUID;
  p_InputPricePerUnit_df216186 NUMERIC(18,8);
  p_OutputPricePerUnit_df216186 NUMERIC(18,8);
  p_UnitTypeID_df216186 UUID;
  p_ProcessingType_df216186 VARCHAR(20);
  p_Comments_df216186 TEXT;
BEGIN
  p_ID_df216186 := 'b0bc5332-1dfc-4164-af29-7fa1057968e3';
  p_ModelID_df216186 := '0D5B7AC2-1130-4611-95D4-9A6FAE129569';
  p_VendorID_df216186 := '5483D98F-1F4E-40F4-91FC-EAA8EFDC90F1';
  p_StartedAt_df216186 := '2026-04-30T00:00:00.000Z';
  p_Status_df216186 := 'Active';
  p_Currency_df216186 := 'USD';
  p_PriceTypeID_df216186 := 'ECE2BCB7-C854-4BF7-A517-D72793A40652';
  p_InputPricePerUnit_df216186 := 1.25;
  p_OutputPricePerUnit_df216186 := 2.5;
  p_UnitTypeID_df216186 := '54208F7D-331C-40AB-84E8-163338EE9EA1';
  p_ProcessingType_df216186 := 'Realtime';
  p_Comments_df216186 := 'Grok 4.3 pricing on xAI direct API as of April 30, 2026 launch. $1.25/$2.50 per 1M tokens for requests up to 200,000 tokens; requests above 200K input billed at higher rates per xAI doc. Sources: https://docs.x.ai/developers/models/grok-4.3 ; https://venturebeat.com/technology/xai-launches-grok-4-3-at-an-aggressively-low-price-and-a-new-fast-powerful-voice-cloning-suite';
  PERFORM __mj."spCreateAIModelCost"(p_ID := p_ID_df216186, p_ModelID := p_ModelID_df216186, p_VendorID := p_VendorID_df216186, p_StartedAt := p_StartedAt_df216186, p_EndedAt := p_EndedAt_df216186, p_EndedAt_Clear := TRUE, p_Status := p_Status_df216186, p_Currency := p_Currency_df216186, p_PriceTypeID := p_PriceTypeID_df216186, p_InputPricePerUnit := p_InputPricePerUnit_df216186, p_OutputPricePerUnit := p_OutputPricePerUnit_df216186, p_UnitTypeID := p_UnitTypeID_df216186, p_ProcessingType := p_ProcessingType_df216186, p_Comments := p_Comments_df216186);
END $mj$;
...
DECLARE
  p_ID_caa0d078 UUID;
  p_ModelID_caa0d078 UUID;
  p_VendorID_caa0d078 UUID;
  p_Priority_caa0d078 INTEGER;
  p_Status_caa0d078 VARCHAR(20);
  p_DriverClass_caa0d078 VARCHAR(100);
  p_DriverImportPath_caa0d078 VARCHAR(255);
  p_APIName_caa0d078 VARCHAR(100);
  p_MaxInputTokens_caa0d078 INTEGER;
  p_MaxOutputTokens_caa0d078 INTEGER;
  p_SupportedResponseFormats_caa0d078 VARCHAR(100);
  p_SupportsEffortLevel_caa0d078 BOOLEAN;
  p_SupportsStreaming_caa0d078 BOOLEAN;
  p_TypeID_caa0d078 UUID;
  p_SupportsPrefill_caa0d078 BOOLEAN;
  p_PrefillFallbackText_caa0d078 TEXT;
BEGIN
  p_ID_caa0d078 := '0384dd43-314c-4dd1-81e6-fb1647d6f9f2';
  p_ModelID_caa0d078 := 'A19488EB-5168-4D47-BBCB-F94054E0B6A7';
  p_VendorID_caa0d078 := 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_Priority_caa0d078 := 0;
  p_Status_caa0d078 := 'Active';
  p_SupportedResponseFormats_caa0d078 := 'Any';
  p_SupportsEffortLevel_caa0d078 := TRUE;
  p_SupportsStreaming_caa0d078 := FALSE;
  p_TypeID_caa0d078 := '10DB468E-F2CE-475D-9F39-2DF2DE75D257';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_caa0d078, p_ModelID := p_ModelID_caa0d078, p_VendorID := p_VendorID_caa0d078, p_Priority := p_Priority_caa0d078, p_Status := p_Status_caa0d078, p_DriverClass := p_DriverClass_caa0d078, p_DriverClass_Clear := TRUE, p_DriverImportPath := p_DriverImportPath_caa0d078, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_caa0d078, p_APIName_Clear := TRUE, p_MaxInputTokens := p_MaxInputTokens_caa0d078, p_MaxInputTokens_Clear := TRUE, p_MaxOutputTokens := p_MaxOutputTokens_caa0d078, p_MaxOutputTokens_Clear := TRUE, p_SupportedResponseFormats := p_SupportedResponseFormats_caa0d078, p_SupportsEffortLevel := p_SupportsEffortLevel_caa0d078, p_SupportsStreaming := p_SupportsStreaming_caa0d078, p_TypeID := p_TypeID_caa0d078, p_SupportsPrefill := p_SupportsPrefill_caa0d078, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_caa0d078, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_3ada11b3 UUID;
  p_ModelID_3ada11b3 UUID;
  p_VendorID_3ada11b3 UUID;
  p_Priority_3ada11b3 INTEGER;
  p_Status_3ada11b3 VARCHAR(20);
  p_DriverClass_3ada11b3 VARCHAR(100);
  p_DriverImportPath_3ada11b3 VARCHAR(255);
  p_APIName_3ada11b3 VARCHAR(100);
  p_MaxInputTokens_3ada11b3 INTEGER;
  p_MaxOutputTokens_3ada11b3 INTEGER;
  p_SupportedResponseFormats_3ada11b3 VARCHAR(100);
  p_SupportsEffortLevel_3ada11b3 BOOLEAN;
  p_SupportsStreaming_3ada11b3 BOOLEAN;
  p_TypeID_3ada11b3 UUID;
  p_SupportsPrefill_3ada11b3 BOOLEAN;
  p_PrefillFallbackText_3ada11b3 TEXT;
BEGIN
  p_ID_3ada11b3 := '9117fa4a-ed22-4934-be56-5a81a9f7eb23';
  p_ModelID_3ada11b3 := 'A19488EB-5168-4D47-BBCB-F94054E0B6A7';
  p_VendorID_3ada11b3 := 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_Priority_3ada11b3 := 1;
  p_Status_3ada11b3 := 'Active';
  p_DriverClass_3ada11b3 := 'OpenAILLM';
  p_APIName_3ada11b3 := 'gpt-5.5-pro';
  p_MaxInputTokens_3ada11b3 := 1050000;
  p_MaxOutputTokens_3ada11b3 := 128000;
  p_SupportedResponseFormats_3ada11b3 := 'Any, JSON';
  p_SupportsEffortLevel_3ada11b3 := TRUE;
  p_SupportsStreaming_3ada11b3 := FALSE;
  p_TypeID_3ada11b3 := '5B043EC3-1FF2-4730-B5D2-7CFDA50979B3';
  PERFORM __mj."spCreateAIModelVendor"(p_ID := p_ID_3ada11b3, p_ModelID := p_ModelID_3ada11b3, p_VendorID := p_VendorID_3ada11b3, p_Priority := p_Priority_3ada11b3, p_Status := p_Status_3ada11b3, p_DriverClass := p_DriverClass_3ada11b3, p_DriverImportPath := p_DriverImportPath_3ada11b3, p_DriverImportPath_Clear := TRUE, p_APIName := p_APIName_3ada11b3, p_MaxInputTokens := p_MaxInputTokens_3ada11b3, p_MaxOutputTokens := p_MaxOutputTokens_3ada11b3, p_SupportedResponseFormats := p_SupportedResponseFormats_3ada11b3, p_SupportsEffortLevel := p_SupportsEffortLevel_3ada11b3, p_SupportsStreaming := p_SupportsStreaming_3ada11b3, p_TypeID := p_TypeID_3ada11b3, p_SupportsPrefill := p_SupportsPrefill_3ada11b3, p_SupportsPrefill_Clear := TRUE, p_PrefillFallbackText := p_PrefillFallbackText_3ada11b3, p_PrefillFallbackText_Clear := TRUE);
END $mj$;
...
DECLARE
  p_ID_1ba36902 UUID;
  p_ModelID_1ba36902 UUID;
  p_VendorID_1ba36902 UUID;
  p_StartedAt_1ba36902 TIMESTAMPTZ;
  p_EndedAt_1ba36902 TIMESTAMPTZ;
  p_Status_1ba36902 VARCHAR(20);
  p_Currency_1ba36902 CHAR(3);
  p_PriceTypeID_1ba36902 UUID;
  p_InputPricePerUnit_1ba36902 NUMERIC(18,8);
  p_OutputPricePerUnit_1ba36902 NUMERIC(18,8);
  p_UnitTypeID_1ba36902 UUID;
  p_ProcessingType_1ba36902 VARCHAR(20);
  p_Comments_1ba36902 TEXT;
BEGIN
  p_ID_1ba36902 := '3f248960-fdcf-4ddb-bf04-e187d5dc6ce6';
  p_ModelID_1ba36902 := 'A19488EB-5168-4D47-BBCB-F94054E0B6A7';
  p_VendorID_1ba36902 := 'D8A5CCEC-6A37-EF11-86D4-000D3A4E707E';
  p_StartedAt_1ba36902 := '2026-04-24T00:00:00.000Z';
  p_Status_1ba36902 := 'Active';
  p_Currency_1ba36902 := 'USD';
  p_PriceTypeID_1ba36902 := 'ECE2BCB7-C854-4BF7-A517-D72793A40652';
  p_InputPricePerUnit_1ba36902 := 30;
  p_OutputPricePerUnit_1ba36902 := 180;
  p_UnitTypeID_1ba36902 := '54208F7D-331C-40AB-84E8-163338EE9EA1';
  p_ProcessingType_1ba36902 := 'Realtime';
  p_Comments_1ba36902 := 'GPT 5.5 Pro pricing on OpenAI as of April 24, 2026 launch. $30.00/$180.00 per 1M tokens. Available via Responses API and Batch API. Batch and Flex at 50% off. Source: https://openai.com/index/introducing-gpt-5-5/';
  PERFORM __mj."spCreateAIModelCost"(p_ID := p_ID_1ba36902, p_ModelID := p_ModelID_1ba36902, p_VendorID := p_VendorID_1ba36902, p_StartedAt := p_StartedAt_1ba36902, p_EndedAt := p_EndedAt_1ba36902, p_EndedAt_Clear := TRUE, p_Status := p_Status_1ba36902, p_Currency := p_Currency_1ba36902, p_PriceTypeID := p_PriceTypeID_1ba36902, p_InputPricePerUnit := p_InputPricePerUnit_1ba36902, p_OutputPricePerUnit := p_OutputPricePerUnit_1ba36902, p_UnitTypeID := p_UnitTypeID_1ba36902, p_ProcessingType := p_ProcessingType_1ba36902, p_Comments := p_Comments_1ba36902);
END $mj$;

-- Save MJ: Actions (core SP call only)
DO $mj$
DECLARE
  p_CategoryID_9659c06e UUID;
  p_Name_9659c06e VARCHAR(425);
  p_Description_9659c06e TEXT;
  p_Type_9659c06e VARCHAR(20);
  p_UserPrompt_9659c06e TEXT;
  p_UserComments_9659c06e TEXT;
  p_Code_9659c06e TEXT;
  p_CodeComments_9659c06e TEXT;
  p_CodeApprovalStatus_9659c06e VARCHAR(20);
  p_CodeApprovalComments_9659c06e TEXT;
  p_CodeApprovedByUserID_9659c06e UUID;
  p_CodeApprovedAt_9659c06e TIMESTAMPTZ;
  p_CodeLocked_9659c06e BOOLEAN;
  p_ForceCodeGeneration_9659c06e BOOLEAN;
  p_RetentionPeriod_9659c06e INTEGER;
  p_Status_9659c06e VARCHAR(20);
  p_DriverClass_9659c06e VARCHAR(255);
  p_ParentID_9659c06e UUID;
  p_IconClass_9659c06e VARCHAR(100);
  p_DefaultCompactPromptID_9659c06e UUID;
  p_Config_9659c06e TEXT;
  p_RuntimeActionConfiguration_9659c06e TEXT;
  p_MaxExecutionTimeMS_9659c06e INTEGER;
  p_CreatedByAgentID_9659c06e UUID;
  p_ID_9659c06e UUID;
BEGIN
  p_CategoryID_9659c06e := '22285832-93AD-427E-81BA-E332F63FC5B9';
  p_Name_9659c06e := 'Entity Data Quality Report';
  p_Description_9659c06e := 'Scans a sample of records for a given entity and returns a data quality report: per-field null rates, distinct value counts, and an overall completeness score (0-1) that weights non-nullable fields 2x. Useful for data stewards triaging bad data. Exercises the `md` (entity introspection) and `rv` (RunView) bridge namespaces.';
  p_Type_9659c06e := 'Runtime';
  p_Code_9659c06e := '// Entity Data Quality Report — md + rv Runtime action.
//
...
if (!Array.isArray(fields) || fields.length === 0) {
    return {
        success: false,
        error: `No fields returned for entity ''$' || CAST('' AS TEXT) || '{entityName}''. Check that the entity exists and the runtime action has permission to access it.`
    };
}
...
if (!viewResult."Success") {
    return {
        success: false,
        error: `RunView failed: $' || CAST('' AS TEXT) || '{viewResult."ErrorMessage"}`,
        entityName
    };
}
...
const sampleNote = totalRows >= cappedAt && viewResult."TotalRowCount" > cappedAt
    ? `Sampled $' || CAST('' AS TEXT) || '{cappedAt} of $' || CAST('' AS TEXT) || '{viewResult."TotalRowCount"} rows — results are an estimate.`
    : `Scanned all $' || CAST('' AS TEXT) || '{totalRows} rows.`;
...
';
  p_CodeApprovalStatus_9659c06e := 'Approved';
  p_CodeLocked_9659c06e := FALSE;
  p_ForceCodeGeneration_9659c06e := FALSE;
  p_Status_9659c06e := 'Active';
  p_IconClass_9659c06e := 'fa-solid fa-magnifying-glass-chart';
  p_RuntimeActionConfiguration_9659c06e := '{
  "permissions": {
    "allowedActions": [],
    "allowedAgents": [],
    "allowedEntities": [],
  ...
  p_MaxExecutionTimeMS_9659c06e := 60000;
  p_ID_9659c06e := '1FA27C4C-34A7-4E1C-8134-6736F3781C8F';
  PERFORM __mj."spUpdateAction"(p_CategoryID := p_CategoryID_9659c06e, p_Name := p_Name_9659c06e, p_Description := p_Description_9659c06e, p_Type := p_Type_9659c06e, p_UserPrompt := p_UserPrompt_9659c06e, p_UserPrompt_Clear := TRUE, p_UserComments := p_UserComments_9659c06e, p_UserComments_Clear := TRUE, p_Code := p_Code_9659c06e, p_CodeComments := p_CodeComments_9659c06e, p_CodeComments_Clear := TRUE, p_CodeApprovalStatus := p_CodeApprovalStatus_9659c06e, p_CodeApprovalComments := p_CodeApprovalComments_9659c06e, p_CodeApprovalComments_Clear := TRUE, p_CodeApprovedByUserID := p_CodeApprovedByUserID_9659c06e, p_CodeApprovedByUserID_Clear := TRUE, p_CodeApprovedAt := p_CodeApprovedAt_9659c06e, p_CodeApprovedAt_Clear := TRUE, p_CodeLocked := p_CodeLocked_9659c06e, p_ForceCodeGeneration := p_ForceCodeGeneration_9659c06e, p_RetentionPeriod := p_RetentionPeriod_9659c06e, p_RetentionPeriod_Clear := TRUE, p_Status := p_Status_9659c06e, p_DriverClass := p_DriverClass_9659c06e, p_DriverClass_Clear := TRUE, p_ParentID := p_ParentID_9659c06e, p_ParentID_Clear := TRUE, p_IconClass := p_IconClass_9659c06e, p_DefaultCompactPromptID := p_DefaultCompactPromptID_9659c06e, p_DefaultCompactPromptID_Clear := TRUE, p_Config := p_Config_9659c06e, p_Config_Clear := TRUE, p_RuntimeActionConfiguration := p_RuntimeActionConfiguration_9659c06e, p_MaxExecutionTimeMS := p_MaxExecutionTimeMS_9659c06e, p_CreatedByAgentID := p_CreatedByAgentID_9659c06e, p_CreatedByAgentID_Clear := TRUE, p_ID := p_ID_9659c06e);
END $mj$;

-- Save MJ: Actions (core SP call only)
DO $mj$
DECLARE
  p_CategoryID_66a56bd9 UUID;
  p_Name_66a56bd9 VARCHAR(425);
  p_Description_66a56bd9 TEXT;
  p_Type_66a56bd9 VARCHAR(20);
  p_UserPrompt_66a56bd9 TEXT;
  p_UserComments_66a56bd9 TEXT;
  p_Code_66a56bd9 TEXT;
  p_CodeComments_66a56bd9 TEXT;
  p_CodeApprovalStatus_66a56bd9 VARCHAR(20);
  p_CodeApprovalComments_66a56bd9 TEXT;
  p_CodeApprovedByUserID_66a56bd9 UUID;
  p_CodeApprovedAt_66a56bd9 TIMESTAMPTZ;
  p_CodeLocked_66a56bd9 BOOLEAN;
  p_ForceCodeGeneration_66a56bd9 BOOLEAN;
  p_RetentionPeriod_66a56bd9 INTEGER;
  p_Status_66a56bd9 VARCHAR(20);
  p_DriverClass_66a56bd9 VARCHAR(255);
  p_ParentID_66a56bd9 UUID;
  p_IconClass_66a56bd9 VARCHAR(100);
  p_DefaultCompactPromptID_66a56bd9 UUID;
  p_Config_66a56bd9 TEXT;
  p_RuntimeActionConfiguration_66a56bd9 TEXT;
  p_MaxExecutionTimeMS_66a56bd9 INTEGER;
  p_CreatedByAgentID_66a56bd9 UUID;
  p_ID_66a56bd9 UUID;
BEGIN
  p_CategoryID_66a56bd9 := '22285832-93AD-427E-81BA-E332F63FC5B9';
  p_Name_66a56bd9 := 'Find Similar Records';
  p_Description_66a56bd9 := 'Finds records in an entity whose text field is similar to a search string. Ranks matches by a blended score (30% containment, 70% normalized Levenshtein) so both typos and long-substring matches rank well. No AI dependency — cheap and deterministic. Validates the target field via metadata before scanning.';
  p_Type_66a56bd9 := 'Runtime';
  p_Code_66a56bd9 := '// Find Similar Records — md + rv + compute Runtime action.
//
...
if (!Array.isArray(fields) || fields.length === 0) {
    return {
        success: false,
        error: `No fields returned for entity ''$' || CAST('' AS TEXT) || '{entityName}''. Check the entity exists and the runtime action has permission to access it.`
    };
}
...
if (!fieldInfo) {
    return {
        success: false,
        error: `Field ''$' || CAST('' AS TEXT) || '{searchField}'' does not exist on entity ''$' || CAST('' AS TEXT) || '{entityName}''. Available fields: $' || CAST('' AS TEXT) || '{fields.map((f) => f."Name").join('', '')}`
    };
}
...
if (!isTextual) {
    return {
        success: false,
        error: `Field ''$' || CAST('' AS TEXT) || '{searchField}'' is of type ''$' || CAST('' AS TEXT) || '{fieldInfo."Type"}'' — similarity matching requires a text field.`
    };
}
...
';
  p_CodeApprovalStatus_66a56bd9 := 'Approved';
  p_CodeLocked_66a56bd9 := FALSE;
  p_ForceCodeGeneration_66a56bd9 := FALSE;
  p_Status_66a56bd9 := 'Active';
  p_IconClass_66a56bd9 := 'fa-solid fa-magnifying-glass-location';
  p_RuntimeActionConfiguration_66a56bd9 := '{
  "permissions": {
    "allowedActions": [],
    "allowedAgents": [],
    "allowedEntities": [],
  ...
  p_MaxExecutionTimeMS_66a56bd9 := 60000;
  p_ID_66a56bd9 := '8785E9AA-AF9D-41EF-A8B8-7CA524785DA6';
  PERFORM __mj."spUpdateAction"(p_CategoryID := p_CategoryID_66a56bd9, p_Name := p_Name_66a56bd9, p_Description := p_Description_66a56bd9, p_Type := p_Type_66a56bd9, p_UserPrompt := p_UserPrompt_66a56bd9, p_UserPrompt_Clear := TRUE, p_UserComments := p_UserComments_66a56bd9, p_UserComments_Clear := TRUE, p_Code := p_Code_66a56bd9, p_CodeComments := p_CodeComments_66a56bd9, p_CodeComments_Clear := TRUE, p_CodeApprovalStatus := p_CodeApprovalStatus_66a56bd9, p_CodeApprovalComments := p_CodeApprovalComments_66a56bd9, p_CodeApprovalComments_Clear := TRUE, p_CodeApprovedByUserID := p_CodeApprovedByUserID_66a56bd9, p_CodeApprovedByUserID_Clear := TRUE, p_CodeApprovedAt := p_CodeApprovedAt_66a56bd9, p_CodeApprovedAt_Clear := TRUE, p_CodeLocked := p_CodeLocked_66a56bd9, p_ForceCodeGeneration := p_ForceCodeGeneration_66a56bd9, p_RetentionPeriod := p_RetentionPeriod_66a56bd9, p_RetentionPeriod_Clear := TRUE, p_Status := p_Status_66a56bd9, p_DriverClass := p_DriverClass_66a56bd9, p_DriverClass_Clear := TRUE, p_ParentID := p_ParentID_66a56bd9, p_ParentID_Clear := TRUE, p_IconClass := p_IconClass_66a56bd9, p_DefaultCompactPromptID := p_DefaultCompactPromptID_66a56bd9, p_DefaultCompactPromptID_Clear := TRUE, p_Config := p_Config_66a56bd9, p_Config_Clear := TRUE, p_RuntimeActionConfiguration := p_RuntimeActionConfiguration_66a56bd9, p_MaxExecutionTimeMS := p_MaxExecutionTimeMS_66a56bd9, p_CreatedByAgentID := p_CreatedByAgentID_66a56bd9, p_CreatedByAgentID_Clear := TRUE, p_ID := p_ID_66a56bd9);
END $mj$;

-- Save MJ: Actions (core SP call only)
DO $mj$
DECLARE
  p_CategoryID_2cca4455 UUID;
  p_Name_2cca4455 VARCHAR(425);
  p_Description_2cca4455 TEXT;
  p_Type_2cca4455 VARCHAR(20);
  p_UserPrompt_2cca4455 TEXT;
  p_UserComments_2cca4455 TEXT;
  p_Code_2cca4455 TEXT;
  p_CodeComments_2cca4455 TEXT;
  p_CodeApprovalStatus_2cca4455 VARCHAR(20);
  p_CodeApprovalComments_2cca4455 TEXT;
  p_CodeApprovedByUserID_2cca4455 UUID;
  p_CodeApprovedAt_2cca4455 TIMESTAMPTZ;
  p_CodeLocked_2cca4455 BOOLEAN;
  p_ForceCodeGeneration_2cca4455 BOOLEAN;
  p_RetentionPeriod_2cca4455 INTEGER;
  p_Status_2cca4455 VARCHAR(20);
  p_DriverClass_2cca4455 VARCHAR(255);
  p_ParentID_2cca4455 UUID;
  p_IconClass_2cca4455 VARCHAR(100);
  p_DefaultCompactPromptID_2cca4455 UUID;
  p_Config_2cca4455 TEXT;
  p_RuntimeActionConfiguration_2cca4455 TEXT;
  p_MaxExecutionTimeMS_2cca4455 INTEGER;
  p_CreatedByAgentID_2cca4455 UUID;
  p_ID_2cca4455 UUID;
BEGIN
  p_CategoryID_2cca4455 := '65E048AA-5220-4E4D-920A-A3D9349902A7';
  p_Name_2cca4455 := 'Weekly Entity Digest';
  p_Description_2cca4455 := 'Composes a weekly markdown digest from activity across one or more entities, then emails it via the Send Single Message action. Exercises every major bridge namespace: metadata-bounded entity queries (rv), standard library helpers (libs), AI prompt rendering (ai), and downstream action invocation (actions). Supports dryRun=true to return the markdown without sending.';
  p_Type_2cca4455 := 'Runtime';
  p_Code_2cca4455 := '// Weekly Entity Digest — full-stack Runtime action.
//
...
const timeRangeLabel = `$' || CAST('' AS TEXT) || '{dateFns.format(rangeStart, ''MMM d, yyyy'')} – $' || CAST('' AS TEXT) || '{dateFns.format(now, ''MMM d, yyyy'')}`;

// Step 2 — fan out RunViews in a single bridge call for efficiency.
const viewOpts = entityNames.map((name) => ({
    EntityName: name,
    ExtraFilter: `__mj_CreatedAt >= ''$' || CAST('' AS TEXT) || '{rangeStartIso}''`,
...
if (!promptResult."Success") {
    return {
        success: false,
        error: `AI prompt execution failed: $' || CAST('' AS TEXT) || '{promptResult."ErrorMessage"}`,
        recordCounts,
        errors
    };
}
...
const sendResult = await utilities.actions."Invoke"(''Send Single Message'', {
    Subject: subject || `Weekly Digest — $' || CAST('' AS TEXT) || '{timeRangeLabel}`,
    Body: digestMarkdown,
    To: recipientEmail,
    BodyFormat: ''markdown''
});
...
';
  p_CodeApprovalStatus_2cca4455 := 'Approved';
  p_CodeLocked_2cca4455 := FALSE;
  p_ForceCodeGeneration_2cca4455 := FALSE;
  p_Status_2cca4455 := 'Active';
  p_IconClass_2cca4455 := 'fa-solid fa-newspaper';
  p_RuntimeActionConfiguration_2cca4455 := '{
  "permissions": {
    "allowedActions": [
      {
  ...
  p_MaxExecutionTimeMS_2cca4455 := 180000;
  p_ID_2cca4455 := 'B57BE9DE-FDBA-4545-822B-32EA6C4E706A';
  PERFORM __mj."spUpdateAction"(p_CategoryID := p_CategoryID_2cca4455, p_Name := p_Name_2cca4455, p_Description := p_Description_2cca4455, p_Type := p_Type_2cca4455, p_UserPrompt := p_UserPrompt_2cca4455, p_UserPrompt_Clear := TRUE, p_UserComments := p_UserComments_2cca4455, p_UserComments_Clear := TRUE, p_Code := p_Code_2cca4455, p_CodeComments := p_CodeComments_2cca4455, p_CodeComments_Clear := TRUE, p_CodeApprovalStatus := p_CodeApprovalStatus_2cca4455, p_CodeApprovalComments := p_CodeApprovalComments_2cca4455, p_CodeApprovalComments_Clear := TRUE, p_CodeApprovedByUserID := p_CodeApprovedByUserID_2cca4455, p_CodeApprovedByUserID_Clear := TRUE, p_CodeApprovedAt := p_CodeApprovedAt_2cca4455, p_CodeApprovedAt_Clear := TRUE, p_CodeLocked := p_CodeLocked_2cca4455, p_ForceCodeGeneration := p_ForceCodeGeneration_2cca4455, p_RetentionPeriod := p_RetentionPeriod_2cca4455, p_RetentionPeriod_Clear := TRUE, p_Status := p_Status_2cca4455, p_DriverClass := p_DriverClass_2cca4455, p_DriverClass_Clear := TRUE, p_ParentID := p_ParentID_2cca4455, p_ParentID_Clear := TRUE, p_IconClass := p_IconClass_2cca4455, p_DefaultCompactPromptID := p_DefaultCompactPromptID_2cca4455, p_DefaultCompactPromptID_Clear := TRUE, p_Config := p_Config_2cca4455, p_Config_Clear := TRUE, p_RuntimeActionConfiguration := p_RuntimeActionConfiguration_2cca4455, p_MaxExecutionTimeMS := p_MaxExecutionTimeMS_2cca4455, p_CreatedByAgentID := p_CreatedByAgentID_2cca4455, p_CreatedByAgentID_Clear := TRUE, p_ID := p_ID_2cca4455);
END $mj$;

-- Save MJ: Template Contents (core SP call only)
DO $mj$
DECLARE
  p_TemplateID_46430ebc UUID;
  p_TypeID_46430ebc UUID;
  p_TemplateText_46430ebc TEXT;
  p_Priority_46430ebc INTEGER;
  p_IsActive_46430ebc BOOLEAN;
  p_ID_46430ebc UUID;
BEGIN
  p_TemplateID_46430ebc := '29481135-7740-4265-8ADB-449946A3D895';
  p_TypeID_46430ebc := 'E7AFCCEC-6A37-EF11-86D4-000D3A4E707E';
  p_TemplateText_46430ebc := 'You are an expert at analyzing database entity schemas and generating Entity Document templates optimized for vector similarity search in MemberJunction.
...
{% raw %}3. **Generate the template as natural language sentences**, for example:
   ...
   - For a Product: `{{ Name }} is a {{ Category."Name" }} product.{% if Description %} {{ Description }}{% endif %}{% if Price %} Priced at $' || CAST('' AS TEXT) || '{{ Price }}.{% endif %}`{% endraw %}
...
';
  p_Priority_46430ebc := 1;
  p_IsActive_46430ebc := TRUE;
  p_ID_46430ebc := '8647C35B-087E-4D9A-8105-1956380C25FE';
  PERFORM __mj."spUpdateTemplateContent"(p_TemplateID := p_TemplateID_46430ebc, p_TypeID := p_TypeID_46430ebc, p_TemplateText := p_TemplateText_46430ebc, p_Priority := p_Priority_46430ebc, p_IsActive := p_IsActive_46430ebc, p_ID := p_ID_46430ebc);
END $mj$;

-- Save MJ: AI Prompts (core SP call only)
DO $mj$
DECLARE
  p_Name_6d2fd097 VARCHAR(255);
  p_Description_6d2fd097 TEXT;
  p_TemplateID_6d2fd097 UUID;
  p_CategoryID_6d2fd097 UUID;
  p_TypeID_6d2fd097 UUID;
  p_Status_6d2fd097 VARCHAR(50);
  p_ResponseFormat_6d2fd097 VARCHAR(20);
  p_ModelSpecificResponseFormat_6d2fd097 TEXT;
  p_AIModelTypeID_6d2fd097 UUID;
  p_MinPowerRank_6d2fd097 INTEGER;
  p_SelectionStrategy_6d2fd097 VARCHAR(20);
  p_PowerPreference_6d2fd097 VARCHAR(20);
  p_ParallelizationMode_6d2fd097 VARCHAR(20);
  p_ParallelCount_6d2fd097 INTEGER;
  p_ParallelConfigParam_6d2fd097 VARCHAR(100);
  p_OutputType_6d2fd097 VARCHAR(50);
  p_OutputExample_6d2fd097 TEXT;
  p_ValidationBehavior_6d2fd097 VARCHAR(50);
  p_MaxRetries_6d2fd097 INTEGER;
  p_RetryDelayMS_6d2fd097 INTEGER;
  p_RetryStrategy_6d2fd097 VARCHAR(20);
  p_ResultSelectorPromptID_6d2fd097 UUID;
  p_EnableCaching_6d2fd097 BOOLEAN;
  p_CacheTTLSeconds_6d2fd097 INTEGER;
  p_CacheMatchType_6d2fd097 VARCHAR(20);
  p_CacheSimilarityThreshold_6d2fd097 DOUBLE PRECISION;
  p_CacheMustMatchModel_6d2fd097 BOOLEAN;
  p_CacheMustMatchVendor_6d2fd097 BOOLEAN;
  p_CacheMustMatchAgent_6d2fd097 BOOLEAN;
  p_CacheMustMatchConfig_6d2fd097 BOOLEAN;
  p_PromptRole_6d2fd097 VARCHAR(20);
  p_PromptPosition_6d2fd097 VARCHAR(20);
  p_Temperature_6d2fd097 NUMERIC(3,2);
  p_TopP_6d2fd097 NUMERIC(3,2);
  p_TopK_6d2fd097 INTEGER;
  p_MinP_6d2fd097 NUMERIC(3,2);
  p_FrequencyPenalty_6d2fd097 NUMERIC(3,2);
  p_PresencePenalty_6d2fd097 NUMERIC(3,2);
  p_Seed_6d2fd097 INTEGER;
  p_StopSequences_6d2fd097 VARCHAR(1000);
  p_IncludeLogProbs_6d2fd097 BOOLEAN;
  p_TopLogProbs_6d2fd097 INTEGER;
  p_FailoverStrategy_6d2fd097 VARCHAR(50);
  p_FailoverMaxAttempts_6d2fd097 INTEGER;
  p_FailoverDelaySeconds_6d2fd097 INTEGER;
  p_FailoverModelStrategy_6d2fd097 VARCHAR(50);
  p_FailoverErrorScope_6d2fd097 VARCHAR(50);
  p_EffortLevel_6d2fd097 INTEGER;
  p_AssistantPrefill_6d2fd097 TEXT;
  p_PrefillFallbackMode_6d2fd097 VARCHAR(20);
  p_RequireSpecificModels_6d2fd097 BOOLEAN;
  p_ID_6d2fd097 UUID;
BEGIN
  p_Name_6d2fd097 := 'Entity Document Suggestion';
  p_Description_6d2fd097 := 'Analyzes entity schemas and suggests Entity Document templates for vector similarity search and duplicate detection. Takes entity fields, types, and relationships as input and outputs a ready-to-use Nunjucks template with threshold recommendations.';
  p_TemplateID_6d2fd097 := '29481135-7740-4265-8ADB-449946A3D895';
  p_CategoryID_6d2fd097 := '7D2DEF7F-138F-4620-8309-33964A97A997';
  p_TypeID_6d2fd097 := 'A6DA423E-F36B-1410-8DAC-00021F8B792E';
  p_Status_6d2fd097 := 'Active';
  p_ResponseFormat_6d2fd097 := 'JSON';
  p_MinPowerRank_6d2fd097 := 0;
  p_SelectionStrategy_6d2fd097 := 'Specific';
  p_PowerPreference_6d2fd097 := 'Balanced';
  p_ParallelizationMode_6d2fd097 := 'None';
  p_OutputType_6d2fd097 := 'string';
  p_ValidationBehavior_6d2fd097 := 'Warn';
  p_MaxRetries_6d2fd097 := 1;
  p_RetryDelayMS_6d2fd097 := 0;
  p_RetryStrategy_6d2fd097 := 'Fixed';
  p_EnableCaching_6d2fd097 := FALSE;
  p_CacheMatchType_6d2fd097 := 'Exact';
  p_CacheMustMatchModel_6d2fd097 := TRUE;
  p_CacheMustMatchVendor_6d2fd097 := TRUE;
  p_CacheMustMatchAgent_6d2fd097 := FALSE;
  p_CacheMustMatchConfig_6d2fd097 := FALSE;
  p_PromptRole_6d2fd097 := 'System';
  p_PromptPosition_6d2fd097 := 'First';
  p_IncludeLogProbs_6d2fd097 := FALSE;
  p_FailoverStrategy_6d2fd097 := 'SameModelDifferentVendor';
  p_FailoverMaxAttempts_6d2fd097 := 3;
  p_FailoverDelaySeconds_6d2fd097 := 5;
  p_FailoverModelStrategy_6d2fd097 := 'PreferSameModel';
  p_FailoverErrorScope_6d2fd097 := 'All';
  p_PrefillFallbackMode_6d2fd097 := 'Ignore';
  p_RequireSpecificModels_6d2fd097 := FALSE;
  p_ID_6d2fd097 := 'F89C5890-D5CD-4824-B431-329799047372';
  PERFORM __mj."spUpdateAIPrompt"(p_Name := p_Name_6d2fd097, p_Description := p_Description_6d2fd097, p_TemplateID := p_TemplateID_6d2fd097, p_CategoryID := p_CategoryID_6d2fd097, p_TypeID := p_TypeID_6d2fd097, p_Status := p_Status_6d2fd097, p_ResponseFormat := p_ResponseFormat_6d2fd097, p_ModelSpecificResponseFormat := p_ModelSpecificResponseFormat_6d2fd097, p_ModelSpecificResponseFormat_Clear := TRUE, p_AIModelTypeID := p_AIModelTypeID_6d2fd097, p_AIModelTypeID_Clear := TRUE, p_MinPowerRank := p_MinPowerRank_6d2fd097, p_SelectionStrategy := p_SelectionStrategy_6d2fd097, p_PowerPreference := p_PowerPreference_6d2fd097, p_ParallelizationMode := p_ParallelizationMode_6d2fd097, p_ParallelCount := p_ParallelCount_6d2fd097, p_ParallelCount_Clear := TRUE, p_ParallelConfigParam := p_ParallelConfigParam_6d2fd097, p_ParallelConfigParam_Clear := TRUE, p_OutputType := p_OutputType_6d2fd097, p_OutputExample := p_OutputExample_6d2fd097, p_OutputExample_Clear := TRUE, p_ValidationBehavior := p_ValidationBehavior_6d2fd097, p_MaxRetries := p_MaxRetries_6d2fd097, p_RetryDelayMS := p_RetryDelayMS_6d2fd097, p_RetryStrategy := p_RetryStrategy_6d2fd097, p_ResultSelectorPromptID := p_ResultSelectorPromptID_6d2fd097, p_ResultSelectorPromptID_Clear := TRUE, p_EnableCaching := p_EnableCaching_6d2fd097, p_CacheTTLSeconds := p_CacheTTLSeconds_6d2fd097, p_CacheTTLSeconds_Clear := TRUE, p_CacheMatchType := p_CacheMatchType_6d2fd097, p_CacheSimilarityThreshold := p_CacheSimilarityThreshold_6d2fd097, p_CacheSimilarityThreshold_Clear := TRUE, p_CacheMustMatchModel := p_CacheMustMatchModel_6d2fd097, p_CacheMustMatchVendor := p_CacheMustMatchVendor_6d2fd097, p_CacheMustMatchAgent := p_CacheMustMatchAgent_6d2fd097, p_CacheMustMatchConfig := p_CacheMustMatchConfig_6d2fd097, p_PromptRole := p_PromptRole_6d2fd097, p_PromptPosition := p_PromptPosition_6d2fd097, p_Temperature := p_Temperature_6d2fd097, p_Temperature_Clear := TRUE, p_TopP := p_TopP_6d2fd097, p_TopP_Clear := TRUE, p_TopK := p_TopK_6d2fd097, p_TopK_Clear := TRUE, p_MinP := p_MinP_6d2fd097, p_MinP_Clear := TRUE, p_FrequencyPenalty := p_FrequencyPenalty_6d2fd097, p_FrequencyPenalty_Clear := TRUE, p_PresencePenalty := p_PresencePenalty_6d2fd097, p_PresencePenalty_Clear := TRUE, p_Seed := p_Seed_6d2fd097, p_Seed_Clear := TRUE, p_StopSequences := p_StopSequences_6d2fd097, p_StopSequences_Clear := TRUE, p_IncludeLogProbs := p_IncludeLogProbs_6d2fd097, p_TopLogProbs := p_TopLogProbs_6d2fd097, p_TopLogProbs_Clear := TRUE, p_FailoverStrategy := p_FailoverStrategy_6d2fd097, p_FailoverMaxAttempts := p_FailoverMaxAttempts_6d2fd097, p_FailoverDelaySeconds := p_FailoverDelaySeconds_6d2fd097, p_FailoverModelStrategy := p_FailoverModelStrategy_6d2fd097, p_FailoverErrorScope := p_FailoverErrorScope_6d2fd097, p_EffortLevel := p_EffortLevel_6d2fd097, p_EffortLevel_Clear := TRUE, p_AssistantPrefill := p_AssistantPrefill_6d2fd097, p_AssistantPrefill_Clear := TRUE, p_PrefillFallbackMode := p_PrefillFallbackMode_6d2fd097, p_RequireSpecificModels := p_RequireSpecificModels_6d2fd097, p_ID := p_ID_6d2fd097);
END $mj$;
...
- Bubble chart for volume/value analysis';
  p_TechnicalDesign_7e4a5d28 := '## Implementation
...
- No re-renders on hover states (pure CSS)
';
  p_TechnicalDesign_a1b6f05c := '## Architecture
React functional component for displaying AI-generated markdown content with built-in actions and collapsible UI.
...
- **dayjs** (1.11.10): Date formatting
';
  p_TechnicalDesign_787ccc5a := '## Architecture
React functional component with dual-mode operation (UI vs headless) supporting CSV, Excel (XLSX), and PDF exports.
...
  p_FunctionalRequirementsVectorEmbeddingModelID_00897448 := '1D45AA65-41EC-4572-9ECD-AB2826C9B059';
  p_HasRequiredCustomProps_00897448 := TRUE;
  p_ID_00897448 := '2AD46B3C-D0B2-49A7-9F0B-8DCE68A0C118';
  PERFORM __mj."spUpdateComponent"(p_Namespace := p_Namespace_00897448, p_Name := p_Name_00897448, p_Version := p_Version_00897448, p_VersionSequence := p_VersionSequence_00897448, p_Title := p_Title_00897448, p_Description := p_Description_00897448, p_Type := p_Type_00897448, p_Status := p_Status_00897448, p_DeveloperName := p_DeveloperName_00897448, p_DeveloperName_Clear := TRUE, p_DeveloperEmail := p_DeveloperEmail_00897448, p_DeveloperEmail_Clear := TRUE, p_DeveloperOrganization := p_DeveloperOrganization_00897448, p_DeveloperOrganization_Clear := TRUE, p_SourceRegistryID := p_SourceRegistryID_00897448, p_SourceRegistryID_Clear := TRUE, p_ReplicatedAt := p_ReplicatedAt_00897448, p_ReplicatedAt_Clear := TRUE, p_LastSyncedAt := p_LastSyncedAt_00897448, p_LastSyncedAt_Clear := TRUE, p_Specification := p_Specification_00897448, p_FunctionalRequirements := p_FunctionalRequirements_00897448, p_TechnicalDesign := p_TechnicalDesign_00897448, p_FunctionalRequirementsVector := p_FunctionalRequirementsVector_00897448, p_TechnicalDesignVector := p_TechnicalDesignVector_00897448, p_HasCustomProps := p_HasCustomProps_00897448, p_HasCustomEvents := p_HasCustomEvents_00897448, p_RequiresData := p_RequiresData_00897448, p_DependencyCount := p_DependencyCount_00897448, p_TechnicalDesignVectorEmbeddingModelID := p_TechnicalDesignVectorEmbeddingModelID_00897448, p_FunctionalRequirementsVectorEmbeddingModelID := p_FunctionalRequirementsVectorEmbeddingModelID_00897448, p_HasRequiredCustomProps := p_HasRequiredCustomProps_00897448, p_ID := p_ID_00897448);
END $mj$;

-- Save MJ: Applications (core SP call only)
DO $mj$
DECLARE
  p_Name_0f9b8fd0 VARCHAR(100);
  p_Description_0f9b8fd0 TEXT;
  p_Icon_0f9b8fd0 VARCHAR(500);
  p_DefaultForNewUser_0f9b8fd0 BOOLEAN;
  p_SchemaAutoAddNewEntities_0f9b8fd0 TEXT;
  p_Color_0f9b8fd0 VARCHAR(20);
  p_DefaultNavItems_0f9b8fd0 TEXT;
  p_ClassName_0f9b8fd0 VARCHAR(255);
  p_DefaultSequence_0f9b8fd0 INTEGER;
  p_Status_0f9b8fd0 VARCHAR(20);
  p_NavigationStyle_0f9b8fd0 VARCHAR(20);
  p_TopNavLocation_0f9b8fd0 VARCHAR(30);
  p_HideNavBarIconWhenActive_0f9b8fd0 BOOLEAN;
  p_Path_0f9b8fd0 VARCHAR(100);
  p_AutoUpdatePath_0f9b8fd0 BOOLEAN;
  p_ID_0f9b8fd0 UUID;
BEGIN
  p_Name_0f9b8fd0 := 'Admin';
  p_Description_0f9b8fd0 := 'MemberJunction Administration';
  p_Icon_0f9b8fd0 := 'fa-solid fa-screwdriver-wrench';
  p_DefaultForNewUser_0f9b8fd0 := FALSE;
  p_Color_0f9b8fd0 := '#4caf50';
  p_DefaultNavItems_0f9b8fd0 := '[
  {
    "Label": "Identity & Access",
    "Icon": "fa-solid fa-shield-halved",
    "ResourceType": "Custom",
    "DriverClass": "AdminIdentityAccess",
    "isDefault": true
  },
  {
    "Label": "Data & Schema",
  ...
  },
  {
    ...
    "ResourceType": "Custom",
    "DriverClass": "AdminDeveloperTools",
    "isDefault": false
  }
]';
  p_DefaultSequence_0f9b8fd0 := 999;
  p_Status_0f9b8fd0 := 'Active';
  p_NavigationStyle_0f9b8fd0 := 'App Switcher';
  p_HideNavBarIconWhenActive_0f9b8fd0 := FALSE;
  p_Path_0f9b8fd0 := 'admin';
  p_AutoUpdatePath_0f9b8fd0 := TRUE;
  p_ID_0f9b8fd0 := 'DBCB423E-F36B-1410-8DAC-00021F8B792E';
  PERFORM __mj."spUpdateApplication"(p_Name := p_Name_0f9b8fd0, p_Description := p_Description_0f9b8fd0, p_Icon := p_Icon_0f9b8fd0, p_DefaultForNewUser := p_DefaultForNewUser_0f9b8fd0, p_SchemaAutoAddNewEntities := p_SchemaAutoAddNewEntities_0f9b8fd0, p_SchemaAutoAddNewEntities_Clear := TRUE, p_Color := p_Color_0f9b8fd0, p_DefaultNavItems := p_DefaultNavItems_0f9b8fd0, p_ClassName := p_ClassName_0f9b8fd0, p_ClassName_Clear := TRUE, p_DefaultSequence := p_DefaultSequence_0f9b8fd0, p_Status := p_Status_0f9b8fd0, p_NavigationStyle := p_NavigationStyle_0f9b8fd0, p_TopNavLocation := p_TopNavLocation_0f9b8fd0, p_TopNavLocation_Clear := TRUE, p_HideNavBarIconWhenActive := p_HideNavBarIconWhenActive_0f9b8fd0, p_Path := p_Path_0f9b8fd0, p_AutoUpdatePath := p_AutoUpdatePath_0f9b8fd0, p_ID := p_ID_0f9b8fd0);
END $mj$;

-- Save MJ: Integration Object Fields (core SP call only)
DO $mj$
DECLARE
  p_IntegrationObjectID_96eed584 UUID;
  p_Name_96eed584 VARCHAR(255);
  p_DisplayName_96eed584 VARCHAR(255);
  p_Description_96eed584 TEXT;
  p_Category_96eed584 VARCHAR(100);
  p_Type_96eed584 VARCHAR(100);
  p_Length_96eed584 INTEGER;
  p_Precision_96eed584 INTEGER;
  p_Scale_96eed584 INTEGER;
  p_AllowsNull_96eed584 BOOLEAN;
  p_DefaultValue_96eed584 VARCHAR(255);
  p_IsPrimaryKey_96eed584 BOOLEAN;
  p_IsUniqueKey_96eed584 BOOLEAN;
  p_IsReadOnly_96eed584 BOOLEAN;
  p_IsRequired_96eed584 BOOLEAN;
  p_RelatedIntegrationObjectID_96eed584 UUID;
  p_RelatedIntegrationObjectFieldName_96eed584 VARCHAR(255);
  p_Sequence_96eed584 INTEGER;
  p_Configuration_96eed584 TEXT;
  p_Status_96eed584 VARCHAR(25);
  p_IsCustom_96eed584 BOOLEAN;
  p_ID_96eed584 UUID;
BEGIN
  p_IntegrationObjectID_96eed584 := 'EADBCD2E-A079-42BC-B74B-85A82E16CA4A';
  p_Name_96eed584 := 'InvoiceID';
  p_DisplayName_96eed584 := 'InvoiceID';
  p_Type_96eed584 := 'int';
  p_AllowsNull_96eed584 := FALSE;
  p_IsPrimaryKey_96eed584 := FALSE;
  p_IsUniqueKey_96eed584 := FALSE;
  p_IsReadOnly_96eed584 := TRUE;
  p_IsRequired_96eed584 := TRUE;
  p_Sequence_96eed584 := 1;
  p_Status_96eed584 := 'Active';
  p_IsCustom_96eed584 := FALSE;
  p_ID_96eed584 := 'F6AEF244-53EA-4613-BAFE-A62008F02E4D';
  PERFORM __mj."spUpdateIntegrationObjectField"(p_IntegrationObjectID := p_IntegrationObjectID_96eed584, p_Name := p_Name_96eed584, p_DisplayName := p_DisplayName_96eed584, p_Description := p_Description_96eed584, p_Description_Clear := TRUE, p_Category := p_Category_96eed584, p_Category_Clear := TRUE, p_Type := p_Type_96eed584, p_Length := p_Length_96eed584, p_Length_Clear := TRUE, p_Precision := p_Precision_96eed584, p_Precision_Clear := TRUE, p_Scale := p_Scale_96eed584, p_Scale_Clear := TRUE, p_AllowsNull := p_AllowsNull_96eed584, p_DefaultValue := p_DefaultValue_96eed584, p_DefaultValue_Clear := TRUE, p_IsPrimaryKey := p_IsPrimaryKey_96eed584, p_IsUniqueKey := p_IsUniqueKey_96eed584, p_IsReadOnly := p_IsReadOnly_96eed584, p_IsRequired := p_IsRequired_96eed584, p_RelatedIntegrationObjectID := p_RelatedIntegrationObjectID_96eed584, p_RelatedIntegrationObjectID_Clear := TRUE, p_RelatedIntegrationObjectFieldName := p_RelatedIntegrationObjectFieldName_96eed584, p_RelatedIntegrationObjectFieldName_Clear := TRUE, p_Sequence := p_Sequence_96eed584, p_Configuration := p_Configuration_96eed584, p_Configuration_Clear := TRUE, p_Status := p_Status_96eed584, p_IsCustom := p_IsCustom_96eed584, p_ID := p_ID_96eed584);
END $mj$;

-- Save MJ: Integration Object Fields (core SP call only)
DO $mj$
DECLARE
  p_IntegrationObjectID_560351f1 UUID;
  p_Name_560351f1 VARCHAR(255);
  p_DisplayName_560351f1 VARCHAR(255);
  p_Description_560351f1 TEXT;
  p_Category_560351f1 VARCHAR(100);
  p_Type_560351f1 VARCHAR(100);
  p_Length_560351f1 INTEGER;
  p_Precision_560351f1 INTEGER;
  p_Scale_560351f1 INTEGER;
  p_AllowsNull_560351f1 BOOLEAN;
  p_DefaultValue_560351f1 VARCHAR(255);
  p_IsPrimaryKey_560351f1 BOOLEAN;
  p_IsUniqueKey_560351f1 BOOLEAN;
  p_IsReadOnly_560351f1 BOOLEAN;
  p_IsRequired_560351f1 BOOLEAN;
  p_RelatedIntegrationObjectID_560351f1 UUID;
  p_RelatedIntegrationObjectFieldName_560351f1 VARCHAR(255);
  p_Sequence_560351f1 INTEGER;
  p_Configuration_560351f1 TEXT;
  p_Status_560351f1 VARCHAR(25);
  p_IsCustom_560351f1 BOOLEAN;
  p_ID_560351f1 UUID;
BEGIN
  p_IntegrationObjectID_560351f1 := 'EADBCD2E-A079-42BC-B74B-85A82E16CA4A';
  p_Name_560351f1 := 'OrderID';
  p_DisplayName_560351f1 := 'Order ID';
  p_Type_560351f1 := 'int';
  p_AllowsNull_560351f1 := FALSE;
  p_IsPrimaryKey_560351f1 := TRUE;
  p_IsUniqueKey_560351f1 := FALSE;
  p_IsReadOnly_560351f1 := FALSE;
  p_IsRequired_560351f1 := TRUE;
  p_Sequence_560351f1 := 18;
  p_Status_560351f1 := 'Active';
  p_IsCustom_560351f1 := FALSE;
  p_ID_560351f1 := 'F6AEF244-53EA-4613-BAFE-A62008F02E4D';
  PERFORM __mj."spUpdateIntegrationObjectField"(p_IntegrationObjectID := p_IntegrationObjectID_560351f1, p_Name := p_Name_560351f1, p_DisplayName := p_DisplayName_560351f1, p_Description := p_Description_560351f1, p_Description_Clear := TRUE, p_Category := p_Category_560351f1, p_Category_Clear := TRUE, p_Type := p_Type_560351f1, p_Length := p_Length_560351f1, p_Length_Clear := TRUE, p_Precision := p_Precision_560351f1, p_Precision_Clear := TRUE, p_Scale := p_Scale_560351f1, p_Scale_Clear := TRUE, p_AllowsNull := p_AllowsNull_560351f1, p_DefaultValue := p_DefaultValue_560351f1, p_DefaultValue_Clear := TRUE, p_IsPrimaryKey := p_IsPrimaryKey_560351f1, p_IsUniqueKey := p_IsUniqueKey_560351f1, p_IsReadOnly := p_IsReadOnly_560351f1, p_IsRequired := p_IsRequired_560351f1, p_RelatedIntegrationObjectID := p_RelatedIntegrationObjectID_560351f1, p_RelatedIntegrationObjectID_Clear := TRUE, p_RelatedIntegrationObjectFieldName := p_RelatedIntegrationObjectFieldName_560351f1, p_RelatedIntegrationObjectFieldName_Clear := TRUE, p_Sequence := p_Sequence_560351f1, p_Configuration := p_Configuration_560351f1, p_Configuration_Clear := TRUE, p_Status := p_Status_560351f1, p_IsCustom := p_IsCustom_560351f1, p_ID := p_ID_560351f1);
END $mj$;

-- Save MJ: Integration Object Fields (core SP call only)
DO $mj$
DECLARE
  p_IntegrationObjectID_affa3d42 UUID;
  p_Name_affa3d42 VARCHAR(255);
  p_DisplayName_affa3d42 VARCHAR(255);
  p_Description_affa3d42 TEXT;
  p_Category_affa3d42 VARCHAR(100);
  p_Type_affa3d42 VARCHAR(100);
  p_Length_affa3d42 INTEGER;
  p_Precision_affa3d42 INTEGER;
  p_Scale_affa3d42 INTEGER;
  p_AllowsNull_affa3d42 BOOLEAN;
  p_DefaultValue_affa3d42 VARCHAR(255);
  p_IsPrimaryKey_affa3d42 BOOLEAN;
  p_IsUniqueKey_affa3d42 BOOLEAN;
  p_IsReadOnly_affa3d42 BOOLEAN;
  p_IsRequired_affa3d42 BOOLEAN;
  p_RelatedIntegrationObjectID_affa3d42 UUID;
  p_RelatedIntegrationObjectFieldName_affa3d42 VARCHAR(255);
  p_Sequence_affa3d42 INTEGER;
  p_Configuration_affa3d42 TEXT;
  p_Status_affa3d42 VARCHAR(25);
  p_IsCustom_affa3d42 BOOLEAN;
  p_ID_affa3d42 UUID;
BEGIN
  p_IntegrationObjectID_affa3d42 := 'D9CE2F96-8F63-418F-9A46-3E2F60BA3F13';
  p_Name_affa3d42 := 'Id';
  p_DisplayName_affa3d42 := 'Id';
  p_Type_affa3d42 := 'int';
  p_AllowsNull_affa3d42 := FALSE;
  p_IsPrimaryKey_affa3d42 := TRUE;
  p_IsUniqueKey_affa3d42 := FALSE;
  p_IsReadOnly_affa3d42 := TRUE;
  p_IsRequired_affa3d42 := TRUE;
  p_Sequence_affa3d42 := 1;
  p_Status_affa3d42 := 'Active';
  p_IsCustom_affa3d42 := FALSE;
  p_ID_affa3d42 := 'C6CB5E87-F47F-40CF-B084-92391EC27DC9';
  PERFORM __mj."spUpdateIntegrationObjectField"(p_IntegrationObjectID := p_IntegrationObjectID_affa3d42, p_Name := p_Name_affa3d42, p_DisplayName := p_DisplayName_affa3d42, p_Description := p_Description_affa3d42, p_Description_Clear := TRUE, p_Category := p_Category_affa3d42, p_Category_Clear := TRUE, p_Type := p_Type_affa3d42, p_Length := p_Length_affa3d42, p_Length_Clear := TRUE, p_Precision := p_Precision_affa3d42, p_Precision_Clear := TRUE, p_Scale := p_Scale_affa3d42, p_Scale_Clear := TRUE, p_AllowsNull := p_AllowsNull_affa3d42, p_DefaultValue := p_DefaultValue_affa3d42, p_DefaultValue_Clear := TRUE, p_IsPrimaryKey := p_IsPrimaryKey_affa3d42, p_IsUniqueKey := p_IsUniqueKey_affa3d42, p_IsReadOnly := p_IsReadOnly_affa3d42, p_IsRequired := p_IsRequired_affa3d42, p_RelatedIntegrationObjectID := p_RelatedIntegrationObjectID_affa3d42, p_RelatedIntegrationObjectID_Clear := TRUE, p_RelatedIntegrationObjectFieldName := p_RelatedIntegrationObjectFieldName_affa3d42, p_RelatedIntegrationObjectFieldName_Clear := TRUE, p_Sequence := p_Sequence_affa3d42, p_Configuration := p_Configuration_affa3d42, p_Configuration_Clear := TRUE, p_Status := p_Status_affa3d42, p_IsCustom := p_IsCustom_affa3d42, p_ID := p_ID_affa3d42);
END $mj$;

-- Save MJ: Integration Object Fields (core SP call only)
DO $mj$
DECLARE
  p_IntegrationObjectID_23fe5e07 UUID;
  p_Name_23fe5e07 VARCHAR(255);
  p_DisplayName_23fe5e07 VARCHAR(255);
  p_Description_23fe5e07 TEXT;
  p_Category_23fe5e07 VARCHAR(100);
  p_Type_23fe5e07 VARCHAR(100);
  p_Length_23fe5e07 INTEGER;
  p_Precision_23fe5e07 INTEGER;
  p_Scale_23fe5e07 INTEGER;
  p_AllowsNull_23fe5e07 BOOLEAN;
  p_DefaultValue_23fe5e07 VARCHAR(255);
  p_IsPrimaryKey_23fe5e07 BOOLEAN;
  p_IsUniqueKey_23fe5e07 BOOLEAN;
  p_IsReadOnly_23fe5e07 BOOLEAN;
  p_IsRequired_23fe5e07 BOOLEAN;
  p_RelatedIntegrationObjectID_23fe5e07 UUID;
  p_RelatedIntegrationObjectFieldName_23fe5e07 VARCHAR(255);
  p_Sequence_23fe5e07 INTEGER;
  p_Configuration_23fe5e07 TEXT;
  p_Status_23fe5e07 VARCHAR(25);
  p_IsCustom_23fe5e07 BOOLEAN;
  p_ID_23fe5e07 UUID;
BEGIN
  p_IntegrationObjectID_23fe5e07 := 'D9CE2F96-8F63-418F-9A46-3E2F60BA3F13';
  p_Name_23fe5e07 := 'CampaignId';
  p_DisplayName_23fe5e07 := 'Campaign Id';
  p_Type_23fe5e07 := 'int';
  p_AllowsNull_23fe5e07 := FALSE;
  p_IsPrimaryKey_23fe5e07 := FALSE;
  p_IsUniqueKey_23fe5e07 := FALSE;
  p_IsReadOnly_23fe5e07 := TRUE;
  p_IsRequired_23fe5e07 := TRUE;
  p_Sequence_23fe5e07 := 8;
  p_Status_23fe5e07 := 'Active';
  p_IsCustom_23fe5e07 := FALSE;
  p_ID_23fe5e07 := 'C6CB5E87-F47F-40CF-B084-92391EC27DC9';
  PERFORM __mj."spUpdateIntegrationObjectField"(p_IntegrationObjectID := p_IntegrationObjectID_23fe5e07, p_Name := p_Name_23fe5e07, p_DisplayName := p_DisplayName_23fe5e07, p_Description := p_Description_23fe5e07, p_Description_Clear := TRUE, p_Category := p_Category_23fe5e07, p_Category_Clear := TRUE, p_Type := p_Type_23fe5e07, p_Length := p_Length_23fe5e07, p_Length_Clear := TRUE, p_Precision := p_Precision_23fe5e07, p_Precision_Clear := TRUE, p_Scale := p_Scale_23fe5e07, p_Scale_Clear := TRUE, p_AllowsNull := p_AllowsNull_23fe5e07, p_DefaultValue := p_DefaultValue_23fe5e07, p_DefaultValue_Clear := TRUE, p_IsPrimaryKey := p_IsPrimaryKey_23fe5e07, p_IsUniqueKey := p_IsUniqueKey_23fe5e07, p_IsReadOnly := p_IsReadOnly_23fe5e07, p_IsRequired := p_IsRequired_23fe5e07, p_RelatedIntegrationObjectID := p_RelatedIntegrationObjectID_23fe5e07, p_RelatedIntegrationObjectID_Clear := TRUE, p_RelatedIntegrationObjectFieldName := p_RelatedIntegrationObjectFieldName_23fe5e07, p_RelatedIntegrationObjectFieldName_Clear := TRUE, p_Sequence := p_Sequence_23fe5e07, p_Configuration := p_Configuration_23fe5e07, p_Configuration_Clear := TRUE, p_Status := p_Status_23fe5e07, p_IsCustom := p_IsCustom_23fe5e07, p_ID := p_ID_23fe5e07);
END $mj$;

-- Save MJ: Integration Object Fields (core SP call only)
DO $mj$
DECLARE
  p_IntegrationObjectID_77c44f2d UUID;
  p_Name_77c44f2d VARCHAR(255);
  p_DisplayName_77c44f2d VARCHAR(255);
  p_Description_77c44f2d TEXT;
  p_Category_77c44f2d VARCHAR(100);
  p_Type_77c44f2d VARCHAR(100);
  p_Length_77c44f2d INTEGER;
  p_Precision_77c44f2d INTEGER;
  p_Scale_77c44f2d INTEGER;
  p_AllowsNull_77c44f2d BOOLEAN;
  p_DefaultValue_77c44f2d VARCHAR(255);
  p_IsPrimaryKey_77c44f2d BOOLEAN;
  p_IsUniqueKey_77c44f2d BOOLEAN;
  p_IsReadOnly_77c44f2d BOOLEAN;
  p_IsRequired_77c44f2d BOOLEAN;
  p_RelatedIntegrationObjectID_77c44f2d UUID;
  p_RelatedIntegrationObjectFieldName_77c44f2d VARCHAR(255);
  p_Sequence_77c44f2d INTEGER;
  p_Configuration_77c44f2d TEXT;
  p_Status_77c44f2d VARCHAR(25);
  p_IsCustom_77c44f2d BOOLEAN;
  p_ID_77c44f2d UUID;
BEGIN
  p_IntegrationObjectID_77c44f2d := 'FD22D0A7-88E6-493F-8A99-399E2B2FCEF2';
  p_Name_77c44f2d := 'Id';
  p_DisplayName_77c44f2d := 'Id';
  p_Type_77c44f2d := 'int';
  p_AllowsNull_77c44f2d := FALSE;
  p_IsPrimaryKey_77c44f2d := TRUE;
  p_IsUniqueKey_77c44f2d := FALSE;
  p_IsReadOnly_77c44f2d := TRUE;
  p_IsRequired_77c44f2d := TRUE;
  p_Sequence_77c44f2d := 1;
  p_Status_77c44f2d := 'Active';
  p_IsCustom_77c44f2d := FALSE;
  p_ID_77c44f2d := 'B2581543-9B19-41D9-A56D-774192C94F49';
  PERFORM __mj."spUpdateIntegrationObjectField"(p_IntegrationObjectID := p_IntegrationObjectID_77c44f2d, p_Name := p_Name_77c44f2d, p_DisplayName := p_DisplayName_77c44f2d, p_Description := p_Description_77c44f2d, p_Description_Clear := TRUE, p_Category := p_Category_77c44f2d, p_Category_Clear := TRUE, p_Type := p_Type_77c44f2d, p_Length := p_Length_77c44f2d, p_Length_Clear := TRUE, p_Precision := p_Precision_77c44f2d, p_Precision_Clear := TRUE, p_Scale := p_Scale_77c44f2d, p_Scale_Clear := TRUE, p_AllowsNull := p_AllowsNull_77c44f2d, p_DefaultValue := p_DefaultValue_77c44f2d, p_DefaultValue_Clear := TRUE, p_IsPrimaryKey := p_IsPrimaryKey_77c44f2d, p_IsUniqueKey := p_IsUniqueKey_77c44f2d, p_IsReadOnly := p_IsReadOnly_77c44f2d, p_IsRequired := p_IsRequired_77c44f2d, p_RelatedIntegrationObjectID := p_RelatedIntegrationObjectID_77c44f2d, p_RelatedIntegrationObjectID_Clear := TRUE, p_RelatedIntegrationObjectFieldName := p_RelatedIntegrationObjectFieldName_77c44f2d, p_RelatedIntegrationObjectFieldName_Clear := TRUE, p_Sequence := p_Sequence_77c44f2d, p_Configuration := p_Configuration_77c44f2d, p_Configuration_Clear := TRUE, p_Status := p_Status_77c44f2d, p_IsCustom := p_IsCustom_77c44f2d, p_ID := p_ID_77c44f2d);
END $mj$;

-- Save MJ: Integration Object Fields (core SP call only)
DO $mj$
DECLARE
  p_IntegrationObjectID_e6b5dfbd UUID;
  p_Name_e6b5dfbd VARCHAR(255);
  p_DisplayName_e6b5dfbd VARCHAR(255);
  p_Description_e6b5dfbd TEXT;
  p_Category_e6b5dfbd VARCHAR(100);
  p_Type_e6b5dfbd VARCHAR(100);
  p_Length_e6b5dfbd INTEGER;
  p_Precision_e6b5dfbd INTEGER;
  p_Scale_e6b5dfbd INTEGER;
  p_AllowsNull_e6b5dfbd BOOLEAN;
  p_DefaultValue_e6b5dfbd VARCHAR(255);
  p_IsPrimaryKey_e6b5dfbd BOOLEAN;
  p_IsUniqueKey_e6b5dfbd BOOLEAN;
  p_IsReadOnly_e6b5dfbd BOOLEAN;
  p_IsRequired_e6b5dfbd BOOLEAN;
  p_RelatedIntegrationObjectID_e6b5dfbd UUID;
  p_RelatedIntegrationObjectFieldName_e6b5dfbd VARCHAR(255);
  p_Sequence_e6b5dfbd INTEGER;
  p_Configuration_e6b5dfbd TEXT;
  p_Status_e6b5dfbd VARCHAR(25);
  p_IsCustom_e6b5dfbd BOOLEAN;
  p_ID_e6b5dfbd UUID;
BEGIN
  p_IntegrationObjectID_e6b5dfbd := 'FD22D0A7-88E6-493F-8A99-399E2B2FCEF2';
  p_Name_e6b5dfbd := 'CampaignId';
  p_DisplayName_e6b5dfbd := 'Campaign Id';
  p_Type_e6b5dfbd := 'int';
  p_AllowsNull_e6b5dfbd := TRUE;
  p_IsPrimaryKey_e6b5dfbd := FALSE;
  p_IsUniqueKey_e6b5dfbd := FALSE;
  p_IsReadOnly_e6b5dfbd := TRUE;
  p_IsRequired_e6b5dfbd := FALSE;
  p_Sequence_e6b5dfbd := 10;
  p_Status_e6b5dfbd := 'Active';
  p_IsCustom_e6b5dfbd := FALSE;
  p_ID_e6b5dfbd := 'B2581543-9B19-41D9-A56D-774192C94F49';
  PERFORM __mj."spUpdateIntegrationObjectField"(p_IntegrationObjectID := p_IntegrationObjectID_e6b5dfbd, p_Name := p_Name_e6b5dfbd, p_DisplayName := p_DisplayName_e6b5dfbd, p_Description := p_Description_e6b5dfbd, p_Description_Clear := TRUE, p_Category := p_Category_e6b5dfbd, p_Category_Clear := TRUE, p_Type := p_Type_e6b5dfbd, p_Length := p_Length_e6b5dfbd, p_Length_Clear := TRUE, p_Precision := p_Precision_e6b5dfbd, p_Precision_Clear := TRUE, p_Scale := p_Scale_e6b5dfbd, p_Scale_Clear := TRUE, p_AllowsNull := p_AllowsNull_e6b5dfbd, p_DefaultValue := p_DefaultValue_e6b5dfbd, p_DefaultValue_Clear := TRUE, p_IsPrimaryKey := p_IsPrimaryKey_e6b5dfbd, p_IsUniqueKey := p_IsUniqueKey_e6b5dfbd, p_IsReadOnly := p_IsReadOnly_e6b5dfbd, p_IsRequired := p_IsRequired_e6b5dfbd, p_RelatedIntegrationObjectID := p_RelatedIntegrationObjectID_e6b5dfbd, p_RelatedIntegrationObjectID_Clear := TRUE, p_RelatedIntegrationObjectFieldName := p_RelatedIntegrationObjectFieldName_e6b5dfbd, p_RelatedIntegrationObjectFieldName_Clear := TRUE, p_Sequence := p_Sequence_e6b5dfbd, p_Configuration := p_Configuration_e6b5dfbd, p_Configuration_Clear := TRUE, p_Status := p_Status_e6b5dfbd, p_IsCustom := p_IsCustom_e6b5dfbd, p_ID := p_ID_e6b5dfbd);
END $mj$;
...
-- Session ID: 0e8be97c-8582-4ca7-aafd-40a0387a68bf
-- Completed: 2026-05-08T01:00:57.721Z
-- Duration: 481103ms
-- Total Statements: 47
