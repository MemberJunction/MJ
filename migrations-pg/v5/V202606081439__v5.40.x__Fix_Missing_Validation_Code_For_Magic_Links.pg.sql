-- ============================================================================
-- MemberJunction PostgreSQL Migration — V202606081439__v5.40.x__Fix_Missing_Validation_Code_For_Magic_Links.sql
...
/* Generated Validation Functions for MJ: Magic Link Invites */ /* CHECK constraint for MJ: Magic Link Invites @ Table Level was newly set or modified since the last generation of the validation function, the code was regenerated and updating the GeneratedCode table with the new generated validation function */
...
VALUES
  (
    (
      SELECT
        "ID"
      FROM __mj."vwGeneratedCodeCategories"
      WHERE
        "Name" = 'CodeGen: Validators'
    ),
    'C43229F6-4CC8-4838-9D04-03419A2DA191',
    NOW(),
    'TypeScript',
    'Approved',
    '([IdentityMode]<>''email'' OR [Email] IS NOT NULL)',
    'public ValidateEmailRequiredForEmailIdentityMode(result: ValidationResult) {
    ...
    'ValidateEmailRequiredForEmailIdentityMode',
...
VALUES
  (
    ...
    'TypeScript',
    'Approved',
    '([UseCount]>=(0) AND [UseCount]<=[MaxUses])',
    'public ValidateUseCountWithinMaxUsesLimit(result: ValidationResult) {
    ...
    'ValidateUseCountWithinMaxUsesLimit',
    'E0238F34-2837-EF11-86D4-6045BDEE16E6',
    'E41A5DEE-C259-4B6E-A3C5-BB022BD5F10A'
  );
