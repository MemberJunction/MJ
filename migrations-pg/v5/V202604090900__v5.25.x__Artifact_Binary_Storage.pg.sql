...
BEGIN
    IF NOT EXISTS (
        ...
        VALUES ('16657ed1-91ca-48b4-a532-1164d6cf8c39', '29248F34-2837-EF11-86D4-6045BDEE16E6', 'AEB408D2-162A-49AE-9DC2-DBE9A21A3C01', 'FileID', 'One To Many', 1, 1, 5, NOW(), NOW());
    END IF;
END $$;
