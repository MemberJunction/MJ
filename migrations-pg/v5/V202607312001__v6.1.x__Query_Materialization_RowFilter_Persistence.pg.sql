...
/* ============================================================================
   ...
   Note (CodeGen handles automatically — intentionally omitted): __mj_CreatedAt /
   __mj_UpdatedAt timestamp columns/triggers and FK indexes. EntityField metadata is
   regenerated from this schema by CodeGen.
   ============================================================================ */
