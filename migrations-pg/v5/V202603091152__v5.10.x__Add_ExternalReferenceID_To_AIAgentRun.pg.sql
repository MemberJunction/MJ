...
ADD ExternalReferenceID VARCHAR(200) NULL;
...
-- IF NOT EXISTS (SELECT 1 FROM __mj."EntityField" WHERE ID = '40ea5ab0-58a3-4cce-b7e1-c9bb56e7d5a4' OR (EntityID = '5190AF93-4C39-4429-BDAA-0AEB492A0256' AND Name = 'ExternalReferenceID')) BEGIN
