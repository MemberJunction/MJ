...
- **Execution progress (TDD, 2026-07-22)**:
  ...
  - ⏳ **Remaining**: 2c (surface statement-mode drops in CLI — folded into Phase 4's `ConvertedShape` change), Phase 3 (numeric `parsed`/`emitted` export + TS reconciliation + CLI gate), Phase 4 (bake-path hardening + non-bake catch), Phase 5 (validation + regression sweep).
