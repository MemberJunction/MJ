...
| `V202605071645...Force_Regen...pg-only.sql` | (didn't exist) | ~66,039 lines |
...
## 3. Issue #2552 — JSON-arg force-regen migration (V202605071645)
...
2. Run `mj codegen` with `forceRegeneration: { spCreate: true, spUpdate:
   ...
   `migrations-pg/v5/V202605071645__v5.33.x__Force_Regen_All_CRUD_Sprocs_JSON_Arg_Shape.pg-only.sql`.
...
V202605071645 is the **first PG-native codegen migration**, generated
...
- [x] All **128** PG migrations apply cleanly via `mj migrate` (127
  prior + the new V202605071645 force-regen).
