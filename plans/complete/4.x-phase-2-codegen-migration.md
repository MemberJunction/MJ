...
This document covers **Phase 2** of the MemberJunction 4.0 Minimal App Shell Architecture implementation.

**Prerequisite**: Complete [3.0 Phase 1 - Bootstrap Packages](3.0-minimal-app-shell-architecture.md) first, which includes:
...
│   │   │   ├── api/
│   │   │   │   ├── src/
│   │   │   │   │   └── index.ts.hbs      # Uses @memberjunction/server-bootstrap
│   │   │   │   ├── package.json.hbs
│   │   │   │   └── tsconfig.json.hbs
│   │   │   ├── explorer/
│   │   │   │   ├── src/
│   │   │   │   │   ├── app/
│   │   │   │   │   │   └── app.module.ts.hbs  # Uses @memberjunction/ng-bootstrap
│   │   │   │   │   ├── environments/
│   │   │   │   │   │   ├── environment.ts.hbs
...
export default class MigrateTo30 extends Command {
  ...
  async run(): Promise<void> {
    ...
    this.log('\n🔄 MemberJunction 3.0 Migration Tool\n');
...
│   │   ├── src/
│   │   │   ├── app/
│   │   │   │   └── app.module.ts      # ~15 lines (from Phase 1)
│   │   │   ├── environments/
│   │   │   │   ├── environment.ts
│   │   │   │   └── environment.prod.ts
│   │   │   ├── index.html
...
│   │   └── tsconfig.json
│   │
│   ├── generated-entities/           # Created by Phase 2 CodeGen
│   │   ├── src/
│   │   │   ├── index.ts
│   │   │   └── generated/
...
│   │   └── tsconfig.json
│   │
│   ├── generated-actions/            # Created by Phase 2 CodeGen
│   │   ├── src/
│   │   │   ├── index.ts
│   │   │   └── generated/
...
│   │   └── tsconfig.json
│   │
│   ├── generated-forms/              # Created by Phase 2 CodeGen
│   │   ├── src/
│   │   │   ├── index.ts
│   │   │   └── generated/
...
│   │   └── tsconfig.json
│   │
│   └── generated-resolvers/          # Created by Phase 2 CodeGen
│       ├── src/
│       │   ├── index.ts
│       │   └── generated/
│       │       └── generated.ts
...
2. Copy custom code to appropriate locations:
   - Custom actions → `packages/custom-actions/`
   - Custom agents → `packages/custom-agents/`
   - Custom components → appropriate Angular package
...
my-project/
├── packages/
│   ├── api/                 # New minimal shell
│   ├── explorer/            # New minimal shell
│   ├── generated-entities/  # Generated code moved here
│   ├── generated-actions/   # Generated code moved here
│   ├── generated-forms/     # New
│   └── generated-resolvers/ # New
├── mj.config.cjs
├── package.json
└── turbo.json
```
...
- [ ] Full workflow works end-to-end:
  1. `mj new project` → creates monorepo (Phase 2)
  2. `mj codegen` → generates packages (Phase 2)
  3. `npm run build` → all packages build (Phase 1 + 2)
  4. `npm start` → apps run using bootstrap packages (Phase 1)
...
- Full `mj new project` → `mj codegen` → build cycle
