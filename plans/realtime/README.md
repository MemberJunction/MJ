...
| [`video-avatar-and-screen-share.md`](video-avatar-and-screen-share.md) | Proposal: agent avatar video (native + composed renderers), user webcam with self-view, screen/window/tab/panel share — provider-agnostic. |
