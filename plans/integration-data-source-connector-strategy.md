# MJ Integration Framework — Unified External Data Access Strategy

**Status:** Proposed (design only — no code). Revised to unify with External Data Sources (#2449) per the review
request on PR #2913. Supersedes the standalone "relational connector + new `IRelationalSourceDriver`" framing.
**Intended as the design-review artifact** for the integrations/external-data alignment (rkihm-BC facilitating, with
Josue + AN).

---

## 1. Why this was revised

The first draft proposed building a dialect-pluggable **relational integration connector** from scratch (a new
...
(The earlier "sibling connector family" framing collapses into "more drivers + the materialize mode.")
...
- **This PR (#2913):** carries THIS unified version (no longer a standalone relational-connector plan).
