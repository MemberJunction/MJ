...
| 4 | Convergence — `GraphTraversalEngine`, joins + `traversalMode`, human tasks, sweep enforcement, Save as Workflow | [#3596](https://github.com/MemberJunction/MJ/pull/3596) | 🟦 In review |
...
| 6 | Track E — `WorkflowSpec`: WHAT bound to WHEN, reconciled onto existing substrates; entity-change + schedule triggers; Workflow.Save/Validate | [#3606](https://github.com/MemberJunction/MJ/pull/3606) | 🟦 In review |
| 7 | Track D — trigger layer: vocabulary normalization, one-shot scheduling, scheduler operational gaps + the Phase 6 round-trip test | — | ⬜ Not started |
| 8 | Track A — substrate correctness (the unfinished #3408 runbook) | — | ⬜ Not started |
