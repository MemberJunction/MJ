...
| 2 | Placement — `@memberjunction/task-graph`, dispatcher + claim protocol, server-side detection, client → observer | [#3574](https://github.com/MemberJunction/MJ/pull/3574) | 🟦 In review |
