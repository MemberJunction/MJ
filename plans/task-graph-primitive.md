...
| 3 | The primitive — `'Tasks'` in the Loop union, `TaskGraphSpec`, folding, continuations, opt-in metadata, prompt migration | [#3588](https://github.com/MemberJunction/MJ/pull/3588) | 🟦 In review — **manual Sage soak still outstanding** |
