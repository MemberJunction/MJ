...
| `34656c0677` | Migrations consolidated. The 6 hand-authored DDL files + 5 CodeGen-emitted regenerations now ship as a single `V202605151200__v5.34.x__Search_Scopes_And_RAG_Plus.sql` with a header banner, per-section dividers, and a hand-authored / CodeGen-output separator. Same content; one Flyway entry instead of 11 |
