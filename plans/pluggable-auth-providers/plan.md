...
Created by the migration in this PR (`migrations/v6/V202608140900__v6.1.x__Pluggable_Auth_Providers.sql`). Table `__mj.AuthenticationProvider` → CodeGen entity name **`MJ: Authentication Providers`** → generated class `MJAuthenticationProviderEntity`.
...
| Piece | Location |
|---|---|
| Migration | `migrations/v6/V202608140900__v6.1.x__Pluggable_Auth_Providers.sql` (this PR) |
...
| Piece | Where |
|---|---|
| `__mj.AuthenticationProvider` + CodeGen output | `migrations/v6/V202608140900__v6.1.x__Pluggable_Auth_Providers.sql` |
