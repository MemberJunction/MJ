...
MJ: Test Types ──▶ "Integration Test"  { DriverClass: "IntegrationTestDriver", Status: Active }
      ...
      ▼
MJ: Tests ───────▶ IT01…IT73            Configuration selects bundles + tier + transport
...
MJ: Test Suites ─▶ "Integration Tests"  (parent — 0 members; running it errors, exit 1)
                   ├─ "Integration Tests — Deterministic"   IT01–IT15, IT20–IT52, IT64–IT73  (58 members, the blocking tier;
                   │                                        ORDERING INVARIANT: server-transport members seq 1–39, client seq 40–58 —
