...
Current accepted workaround: the parent conversation does direct fanout of Phase 2a/b/c/d as a flat sequence (validated in a clean-build verification run, 2026-05-18). Architectural fix proposed: move orchestration into the `build-connector` skill.
