...
```html
<mj-page-layout>
  <mj-page-header Title="__DASHBOARD_NAME__" Icon="__ICON_CLASS__" Subtitle="__SUBTITLE__">
    <div meta>
...
<mj-page-layout>
  <mj-page-header Title="__DASHBOARD_NAME__" Icon="__ICON_CLASS__" Subtitle="__SUBTITLE__">
    ...
    <div actions>
      @switch (ActiveTab) { @case ('__FIRST_TAB_KEY__') {
    ...
    <div toolbar>
      <mj-tab-nav [Tabs]="Tabs" [ActiveKey]="ActiveTab" (TabChange)="OnTabChange($any($event))"> </mj-tab-nav>
...
```html
<mj-page-header-interior Title="__DASHBOARD_NAME__" Subtitle="__SUBTITLE__">
  <div meta>
    <!-- Optional meta -->
  </div>
...
Full token reference is in `AGENTS.md` under the "Design Token System" section.
...
Don't add a parallel mechanism — `SetAgentContext`/`SetAgentClientTools` are the single surface API. See `packages/Angular/Explorer/dashboards/AGENTS.md` for the full rule.
...
For each of those, refer to the per-area `AGENTS.md` files (`packages/Angular/Explorer/dashboards/AGENTS.md`, `packages/Angular/AGENTS.md`, `packages/Angular/Explorer/AGENTS.md`).
