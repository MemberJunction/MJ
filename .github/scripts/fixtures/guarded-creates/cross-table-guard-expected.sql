...
BEGIN
IF NOT EXISTS (SELECT 1 FROM [${flyway:defaultSchema}].[CredentialType] WHERE [ID] = 'DDDDDDDD-4444-4444-8444-444444444444')
BEGIN
...
ELSE
BEGIN
    EXEC [${flyway:defaultSchema}].spUpdateCredentialType @ID = 'DDDDDDDD-4444-4444-8444-444444444444',
  @Name = 'Cross table guard';
END
