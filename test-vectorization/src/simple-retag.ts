...
async function simpleRetag(): Promise<void> {
    try {
        console.log('🚀 Starting simple re-tagging test...');
        ...
        // Re-tag the items directly (no file re-parsing, just LLM processing)
