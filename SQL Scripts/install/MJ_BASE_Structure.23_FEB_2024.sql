...
Run this script on:
        ...
        mj-mj-prodsql.database.windows.net.MJ_EMPTY    -  This database will be modified
...
Script created by SQL Compare version 15.2.1.24235 from Red Gate Software Ltd at 2/23/2024 5:07:35 PM
...
GO
CREATE FULLTEXT CATALOG [CDP_FullTextCatalog]
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[DashboardCategory]'
GO
CREATE TABLE [admin].[DashboardCategory]
(
[ID] [int] NOT NULL,
[Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_DashboardCategory] on [admin].[DashboardCategory]'
GO
ALTER TABLE [admin].[DashboardCategory] ADD CONSTRAINT [PK_DashboardCategory] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[DataContext]'
GO
CREATE TABLE [admin].[DataContext]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[UserID] [int] NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_DataContext] on [admin].[DataContext]'
GO
ALTER TABLE [admin].[DataContext] ADD CONSTRAINT [PK_DataContext] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[DataContextItem]'
GO
CREATE TABLE [admin].[DataContextItem]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_DataContextItem] on [admin].[DataContextItem]'
GO
ALTER TABLE [admin].[DataContextItem] ADD CONSTRAINT [PK_DataContextItem] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[Query]'
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_Quey] on [admin].[Query]'
GO
ALTER TABLE [admin].[Query] ADD CONSTRAINT [PK_Quey] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[EntityDocumentType]'
GO
CREATE TABLE [admin].[EntityDocumentType]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_EntityDocumentType] on [admin].[EntityDocumentType]'
GO
ALTER TABLE [admin].[EntityDocumentType] ADD CONSTRAINT [PK_EntityDocumentType] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[EntityDocument]'
GO
CREATE TABLE [admin].[EntityDocument]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_EntityDocument] on [admin].[EntityDocument]'
GO
ALTER TABLE [admin].[EntityDocument] ADD CONSTRAINT [PK_EntityDocument] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [UQ_EntityDocument_Name] on [admin].[EntityDocument]'
GO
CREATE UNIQUE NONCLUSTERED INDEX [UQ_EntityDocument_Name] ON [admin].[EntityDocument] ([Name])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[EntityDocumentRun]'
GO
CREATE TABLE [admin].[EntityDocumentRun]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_EntityDocumentRun] on [admin].[EntityDocumentRun]'
GO
ALTER TABLE [admin].[EntityDocumentRun] ADD CONSTRAINT [PK_EntityDocumentRun] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[QueryCategory]'
GO
CREATE TABLE [admin].[QueryCategory]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[ParentID] [int] NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_QueryCategory] on [admin].[QueryCategory]'
GO
ALTER TABLE [admin].[QueryCategory] ADD CONSTRAINT [PK_QueryCategory] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[QueryField]'
GO
CREATE TABLE [admin].[QueryField]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_QueryField] on [admin].[QueryField]'
GO
ALTER TABLE [admin].[QueryField] ADD CONSTRAINT [PK_QueryField] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[QueryPermission]'
GO
CREATE TABLE [admin].[QueryPermission]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[QueryID] [int] NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_QueryPermission] on [admin].[QueryPermission]'
GO
ALTER TABLE [admin].[QueryPermission] ADD CONSTRAINT [PK_QueryPermission] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[ReportCategory]'
GO
CREATE TABLE [admin].[ReportCategory]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_ReportCategory] on [admin].[ReportCategory]'
GO
ALTER TABLE [admin].[ReportCategory] ADD CONSTRAINT [PK_ReportCategory] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[UserViewCategory]'
GO
CREATE TABLE [admin].[UserViewCategory]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_UserViewCategory] on [admin].[UserViewCategory]'
GO
ALTER TABLE [admin].[UserViewCategory] ADD CONSTRAINT [PK_UserViewCategory] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[VectorIndex]'
GO
CREATE TABLE [admin].[VectorIndex]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_VectorIndex] on [admin].[VectorIndex]'
GO
ALTER TABLE [admin].[VectorIndex] ADD CONSTRAINT [PK_VectorIndex] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[VectorDatabase]'
GO
CREATE TABLE [admin].[VectorDatabase]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_VectorDatabase] on [admin].[VectorDatabase]'
GO
ALTER TABLE [admin].[VectorDatabase] ADD CONSTRAINT [PK_VectorDatabase] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwQueryFields]'
GO


CREATE VIEW [admin].[vwQueryFields]
AS
SELECT 
    q.*,
    Query_QueryID.[Name] AS [Query]
FROM
    [admin].[QueryField] AS q
INNER JOIN
    [admin].[Query] AS Query_QueryID
  ON
    [q].[QueryID] = Query_QueryID.[ID]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateQueryField]'
GO


CREATE PROCEDURE [admin].[spCreateQueryField]
    @QueryID int,
    @Name nvarchar(255),
...
BEGIN
    ...
    SELECT * FROM [admin].[vwQueryFields] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateQueryField]'
GO


CREATE PROCEDURE [admin].[spUpdateQueryField]
    @ID int,
    @QueryID int,
    @Name nvarchar(255),
    @Description nvarchar(MAX),
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwQueryFields] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwVectorIndexes]'
GO


CREATE VIEW [admin].[vwVectorIndexes]
AS
SELECT 
    v.*,
...
FROM
    [admin].[VectorIndex] AS v
INNER JOIN
    [admin].[VectorDatabase] AS VectorDatabase_VectorDatabaseID
  ON
    [v].[VectorDatabaseID] = VectorDatabase_VectorDatabaseID.[ID]
INNER JOIN
    [admin].[AIModel] AS AIModel_EmbeddingModelID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwQueryPermissions]'
GO


CREATE VIEW [admin].[vwQueryPermissions]
AS
SELECT 
    q.*
FROM
    [admin].[QueryPermission] AS q
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwQueries]'
GO


CREATE VIEW [admin].[vwQueries]
AS
SELECT 
    q.*,
...
FROM
    [admin].[Query] AS q
INNER JOIN
    [admin].[QueryCategory] AS QueryCategory_CategoryID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwQueryCategories]'
GO


CREATE VIEW [admin].[vwQueryCategories]
AS
SELECT 
    q.*,
    QueryCategory_ParentID.[Name] AS [Parent]
FROM
    [admin].[QueryCategory] AS q
LEFT OUTER JOIN
    [admin].[QueryCategory] AS QueryCategory_ParentID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwEntityDocumentTypes]'
GO


CREATE VIEW [admin].[vwEntityDocumentTypes]
AS
SELECT 
    e.*
FROM
    [admin].[EntityDocumentType] AS e
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateQueryPermission]'
GO


CREATE PROCEDURE [admin].[spCreateQueryPermission]
    @QueryID int,
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwQueryPermissions] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateQuery]'
GO


CREATE PROCEDURE [admin].[spCreateQuery]
    @Name nvarchar(255),
    @Description nvarchar(MAX),
    @CategoryID int,
    @SQL nvarchar(MAX),
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwQueries] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateQueryCategory]'
GO


CREATE PROCEDURE [admin].[spCreateQueryCategory]
    @Name nvarchar(50),
    @ParentID int,
    @Description nvarchar(MAX)
AS
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwQueryCategories] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateVectorIndex]'
GO


CREATE PROCEDURE [admin].[spCreateVectorIndex]
    @Name nvarchar(255),
    @Description nvarchar(MAX),
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwVectorIndexes] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateEntityDocumentType]'
GO


CREATE PROCEDURE [admin].[spCreateEntityDocumentType]
    @Name nvarchar(100),
    @Description nvarchar(MAX)
AS
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwEntityDocumentTypes] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateQueryPermission]'
GO


CREATE PROCEDURE [admin].[spUpdateQueryPermission]
    @ID int,
    @QueryID int,
    @RoleName nvarchar(50)
AS
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwQueryPermissions] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateQuery]'
GO


CREATE PROCEDURE [admin].[spUpdateQuery]
    @ID int,
    @Name nvarchar(255),
    @Description nvarchar(MAX),
    @CategoryID int,
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwQueries] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateQueryCategory]'
GO


CREATE PROCEDURE [admin].[spUpdateQueryCategory]
    @ID int,
    @Name nvarchar(50),
    @ParentID int,
    @Description nvarchar(MAX)
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwQueryCategories] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateVectorIndex]'
GO


CREATE PROCEDURE [admin].[spUpdateVectorIndex]
    @ID int,
    @Name nvarchar(255),
    @Description nvarchar(MAX),
    @VectorDatabaseID int,
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwVectorIndexes] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateEntityDocumentType]'
GO


CREATE PROCEDURE [admin].[spUpdateEntityDocumentType]
    @ID int,
    @Name nvarchar(100),
    @Description nvarchar(MAX)
AS
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwEntityDocumentTypes] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwVectorDatabases]'
GO


CREATE VIEW [admin].[vwVectorDatabases]
AS
SELECT 
    v.*
FROM
    [admin].[VectorDatabase] AS v
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateExistingEntitiesFromSchema]'
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwEntityDocumentRuns]'
GO


CREATE VIEW [admin].[vwEntityDocumentRuns]
AS
SELECT 
    e.*,
    EntityDocument_EntityDocumentID.[Name] AS [EntityDocument]
FROM
    [admin].[EntityDocumentRun] AS e
INNER JOIN
    [admin].[EntityDocument] AS EntityDocument_EntityDocumentID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwDataContextItems]'
GO


CREATE VIEW [admin].[vwDataContextItems]
AS
SELECT 
    d.*,
    ...
    Query_QueryID.[Name] AS [Query]
FROM
    [admin].[DataContextItem] AS d
INNER JOIN
    [admin].[DataContext] AS DataContext_DataContextID
  ON
    [d].[DataContextID] = DataContext_DataContextID.[ID]
LEFT OUTER JOIN
    [admin].[UserView] AS UserView_ViewID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwEntityDocuments]'
GO


CREATE VIEW [admin].[vwEntityDocuments]
AS
SELECT 
    e.*,
    EntityDocumentType_TypeID.[Name] AS [Type]
FROM
    [admin].[EntityDocument] AS e
INNER JOIN
    [admin].[EntityDocumentType] AS EntityDocumentType_TypeID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[EntityRecordDocument]'
GO
CREATE TABLE [admin].[EntityRecordDocument]
(
[ID] [int] NOT NULL IDENTITY(1, 1),
[EntityID] [int] NOT NULL,
[RecordID] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating primary key [PK_EntityRecordDocument] on [admin].[EntityRecordDocument]'
GO
ALTER TABLE [admin].[EntityRecordDocument] ADD CONSTRAINT [PK_EntityRecordDocument] PRIMARY KEY CLUSTERED ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwEntityRecordDocuments]'
GO


CREATE VIEW [admin].[vwEntityRecordDocuments]
AS
SELECT 
    e.*
FROM
    [admin].[EntityRecordDocument] AS e
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateEntityDocumentRun]'
GO


CREATE PROCEDURE [admin].[spCreateEntityDocumentRun]
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwEntityDocumentRuns] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateDataContextItem]'
GO


CREATE PROCEDURE [admin].[spCreateDataContextItem]
    @DataContextID int,
    @Type nvarchar(50),
    @ViewID int,
    @QueryID int,
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwDataContextItems] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateVectorDatabase]'
GO


CREATE PROCEDURE [admin].[spCreateVectorDatabase]
    @Name nvarchar(100),
    @Description nvarchar(MAX),
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwVectorDatabases] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateEntityDocument]'
GO


CREATE PROCEDURE [admin].[spCreateEntityDocument]
    @Name nvarchar(250),
    @EntityID int,
    @TypeID int,
    @Status nvarchar(15),
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwEntityDocuments] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateEntityRecordDocument]'
GO


CREATE PROCEDURE [admin].[spCreateEntityRecordDocument]
    @EntityID int,
    @RecordID nvarchar(255),
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwEntityRecordDocuments] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateEntityDocumentRun]'
GO


CREATE PROCEDURE [admin].[spUpdateEntityDocumentRun]
    @ID int,
    @EntityDocumentID int,
    @StartedAt datetime,
    @EndedAt datetime,
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwEntityDocumentRuns] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateDataContextItem]'
GO


CREATE PROCEDURE [admin].[spUpdateDataContextItem]
    @ID int,
    @DataContextID int,
    @Type nvarchar(50),
    @ViewID int,
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwDataContextItems] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateVectorDatabase]'
GO


CREATE PROCEDURE [admin].[spUpdateVectorDatabase]
    @ID int,
    @Name nvarchar(100),
    @Description nvarchar(MAX),
    @DefaultURL nvarchar(255),
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwVectorDatabases] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateEntityDocument]'
GO


CREATE PROCEDURE [admin].[spUpdateEntityDocument]
    @ID int,
    @Name nvarchar(250),
    @EntityID int,
    @TypeID int,
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwEntityDocuments] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateEntityRecordDocument]'
GO


CREATE PROCEDURE [admin].[spUpdateEntityRecordDocument]
    @ID int,
    @EntityID int,
    @RecordID nvarchar(255),
    @DocumentText nvarchar(MAX),
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwEntityRecordDocuments] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwDataContexts]'
GO


CREATE VIEW [admin].[vwDataContexts]
AS
SELECT 
    d.*,
    User_UserID.[Name] AS [User]
FROM
    [admin].[DataContext] AS d
INNER JOIN
    [admin].[User] AS User_UserID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwDashboardCategories]'
GO


CREATE VIEW [admin].[vwDashboardCategories]
AS
SELECT 
    d.*,
    DashboardCategory_ParentID.[Name] AS [Parent]
FROM
    [admin].[DashboardCategory] AS d
LEFT OUTER JOIN
    [admin].[DashboardCategory] AS DashboardCategory_ParentID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwUserViewCategories]'
GO


CREATE VIEW [admin].[vwUserViewCategories]
AS
SELECT 
    u.*,
    UserViewCategory_ParentID.[Name] AS [Parent]
FROM
    [admin].[UserViewCategory] AS u
LEFT OUTER JOIN
    [admin].[UserViewCategory] AS UserViewCategory_ParentID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[vwReportCategories]'
GO


CREATE VIEW [admin].[vwReportCategories]
AS
SELECT 
    r.*,
    ReportCategory_ParentID.[Name] AS [Parent]
FROM
    [admin].[ReportCategory] AS r
INNER JOIN
    [admin].[ReportCategory] AS ReportCategory_ParentID
  ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateDataContext]'
GO


CREATE PROCEDURE [admin].[spCreateDataContext]
    @Name nvarchar(255),
    @UserID int,
    @Description nvarchar(MAX),
    @LastRefreshedAt datetime
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwDataContexts] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateUserViewCategory]'
GO


CREATE PROCEDURE [admin].[spCreateUserViewCategory]
    @Name nvarchar(100),
    @Description nvarchar(MAX),
    @ParentID int
AS
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwUserViewCategories] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateReportCategory]'
GO


CREATE PROCEDURE [admin].[spCreateReportCategory]
    @Name nvarchar(100),
    @Description nvarchar(MAX),
    @ParentID int
AS
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwReportCategories] WHERE [ID] = SCOPE_IDENTITY()
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spCreateDashboardCategory]'
GO


CREATE PROCEDURE [admin].[spCreateDashboardCategory]
    @ID int,
    @Name nvarchar(100),
    @Description nvarchar(MAX),
    @ParentID int
...
BEGIN
    ...
    -- return the new record from the base view, which might have some calculated fields
    SELECT * FROM [admin].[vwDashboardCategories] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateDataContext]'
GO


CREATE PROCEDURE [admin].[spUpdateDataContext]
    @ID int,
    @Name nvarchar(255),
    @UserID int,
    @Description nvarchar(MAX),
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwDataContexts] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateUserViewCategory]'
GO


CREATE PROCEDURE [admin].[spUpdateUserViewCategory]
    @ID int,
    @Name nvarchar(100),
    @Description nvarchar(MAX),
    @ParentID int
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwUserViewCategories] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateReportCategory]'
GO


CREATE PROCEDURE [admin].[spUpdateReportCategory]
    @ID int,
    @Name nvarchar(100),
    @Description nvarchar(MAX),
    @ParentID int
...
BEGIN
    ...
    -- return the updated record so the caller can see the updated values and any calculated fields
    SELECT * FROM [admin].[vwReportCategories] WHERE [ID] = @ID
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating [admin].[spUpdateDashboardCategory]'
GO


CREATE PROCEDURE [admin].[spUpdateDashboardCategory]
    @ID int,
    @Name nvarchar(100),
    @Description nvarchar(MAX),
    @ParentID int
...
LEFT OUTER JOIN
    [admin].[DashboardCategory] AS DashboardCategory_CategoryID
  ON
...
FROM
    [admin].[Report] AS r
LEFT OUTER JOIN
    [admin].[ReportCategory] AS ReportCategory_CategoryID
  ON
...
LEFT OUTER JOIN
    [admin].[Entity] AS Entity_LinkedEntityID
  ON
...
GO
ALTER TABLE [admin].[Conversation] ADD CONSTRAINT [FK_Conversation_Entity] FOREIGN KEY ([LinkedEntityID]) REFERENCES [admin].[Entity] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[DashboardCategory]'
GO
ALTER TABLE [admin].[DashboardCategory] ADD CONSTRAINT [FK_DashboardCategory_DashboardCategory] FOREIGN KEY ([ParentID]) REFERENCES [admin].[DashboardCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [admin].[Dashboard] ADD CONSTRAINT [FK_Dashboard_DashboardCategory] FOREIGN KEY ([CategoryID]) REFERENCES [admin].[DashboardCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[DataContextItem]'
GO
ALTER TABLE [admin].[DataContextItem] ADD CONSTRAINT [FK_DataContextItem_DataContext] FOREIGN KEY ([DataContextID]) REFERENCES [admin].[DataContext] ([ID])
GO
ALTER TABLE [admin].[DataContextItem] ADD CONSTRAINT [FK_DataContextItem_Query] FOREIGN KEY ([QueryID]) REFERENCES [admin].[Query] ([ID])
GO
ALTER TABLE [admin].[DataContextItem] ADD CONSTRAINT [FK_DataContextItem_UserView] FOREIGN KEY ([ViewID]) REFERENCES [admin].[UserView] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[DataContext]'
GO
ALTER TABLE [admin].[DataContext] ADD CONSTRAINT [FK_DataContext_User] FOREIGN KEY ([UserID]) REFERENCES [admin].[User] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[EntityDocumentRun]'
GO
ALTER TABLE [admin].[EntityDocumentRun] ADD CONSTRAINT [FK_EntityDocumentRun_EntityDocument] FOREIGN KEY ([EntityDocumentID]) REFERENCES [admin].[EntityDocument] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[EntityDocument]'
GO
ALTER TABLE [admin].[EntityDocument] ADD CONSTRAINT [FK_EntityDocument_EntityDocumentType] FOREIGN KEY ([TypeID]) REFERENCES [admin].[EntityDocumentType] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[QueryCategory]'
GO
ALTER TABLE [admin].[QueryCategory] ADD CONSTRAINT [FK_QueryCategory_QueryCategory] FOREIGN KEY ([ParentID]) REFERENCES [admin].[QueryCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[QueryField]'
GO
ALTER TABLE [admin].[QueryField] ADD CONSTRAINT [FK_QueryField_Query] FOREIGN KEY ([QueryID]) REFERENCES [admin].[Query] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[QueryPermission]'
GO
ALTER TABLE [admin].[QueryPermission] ADD CONSTRAINT [FK_QueryPermission_Query] FOREIGN KEY ([QueryID]) REFERENCES [admin].[Query] ([ID])
GO
ALTER TABLE [admin].[QueryPermission] ADD CONSTRAINT [FK_QueryPermission_Role] FOREIGN KEY ([RoleName]) REFERENCES [admin].[Role] ([Name])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[Query]'
GO
ALTER TABLE [admin].[Query] ADD CONSTRAINT [FK_Query_QueryCategory] FOREIGN KEY ([CategoryID]) REFERENCES [admin].[QueryCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[ReportCategory]'
GO
ALTER TABLE [admin].[ReportCategory] ADD CONSTRAINT [FK_ReportCategory_ReportCategory] FOREIGN KEY ([ParentID]) REFERENCES [admin].[ReportCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [admin].[Report] ADD CONSTRAINT [FK_Report_DataContext] FOREIGN KEY ([DataContextID]) REFERENCES [admin].[DataContext] ([ID])
GO
ALTER TABLE [admin].[Report] ADD CONSTRAINT [FK_Report_ReportCategory] FOREIGN KEY ([CategoryID]) REFERENCES [admin].[ReportCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[UserViewCategory]'
GO
ALTER TABLE [admin].[UserViewCategory] ADD CONSTRAINT [FK_UserViewCategory_UserViewCategory] FOREIGN KEY ([ParentID]) REFERENCES [admin].[UserViewCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [admin].[UserView] ADD CONSTRAINT [FK_UserView_UserViewCategory] FOREIGN KEY ([CategoryID]) REFERENCES [admin].[UserViewCategory] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [admin].[VectorIndex]'
GO
ALTER TABLE [admin].[VectorIndex] ADD CONSTRAINT [FK_VectorIndex_AIModel] FOREIGN KEY ([EmbeddingModelID]) REFERENCES [admin].[AIModel] ([ID])
GO
ALTER TABLE [admin].[VectorIndex] ADD CONSTRAINT [FK_VectorIndex_VectorDatabase] FOREIGN KEY ([VectorDatabaseID]) REFERENCES [admin].[VectorDatabase] ([ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Data Context Items store information about each item within a Data Context. Each item stores a link to a view, query, or raw sql statement and can optionally cache the JSON representing the last run of that data object as well.', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', NULL, NULL
END TRY
BEGIN CATCH
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Foreign key to the DataContext table', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'DataContextID'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Optionally used to cache results of an item. This can be used for performance optimization, and also for having snapshots of data for historical comparisons.', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'DataJSON'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Used if type=''full_entity'' or type=''single_record''', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'EntityID'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'If DataJSON is populated, this field will show the date the the data was captured', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'LastRefreshedAt'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Only used if Type=''query''', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'QueryID'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'The Primary Key value for the record, only used when Type=''single_record''', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'RecordID'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Only used when Type=sql', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'SQL'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'The type of the item, either "view", "query", "full_entity", "single_record", or "sql"', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'Type'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Only used if Type=''view''', 'SCHEMA', N'admin', 'TABLE', N'DataContextItem', 'COLUMN', N'ViewID'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Data Contexts are a primitive within the MemberJunction architecture. They store information about data contexts which are groups of data including views, queries, or raw SQL statements. Data contexts can be used in conversations, reports and more.', 'SCHEMA', N'admin', 'TABLE', N'DataContext', NULL, NULL
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'Can be Pending, In Progress, Completed, or Failed', 'SCHEMA', N'admin', 'TABLE', N'EntityDocumentRun', 'COLUMN', N'Status'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'The base type, not including parameters, in SQL. For example this field would be nvarchar or decimal, and wouldn''t include type parameters. The SQLFullType field provides that information.', 'SCHEMA', N'admin', 'TABLE', N'QueryField', 'COLUMN', N'SQLBaseType'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
GO
BEGIN TRY
	EXEC sp_addextendedproperty N'MS_Description', N'The full SQL type for the field, for example datetime or nvarchar(10) etc.', 'SCHEMA', N'admin', 'TABLE', N'QueryField', 'COLUMN', N'SQLFullType'
END TRY
BEGIN CATCH
	DECLARE @msg nvarchar(max);
	DECLARE @severity int;
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateDashboardCategory]'
GO
GRANT EXECUTE ON  [admin].[spCreateDashboardCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateDashboardCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateDataContextItem]'
GO
GRANT EXECUTE ON  [admin].[spCreateDataContextItem] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateDataContextItem] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateDataContext]'
GO
GRANT EXECUTE ON  [admin].[spCreateDataContext] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateDataContext] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateEntityDocumentRun]'
GO
GRANT EXECUTE ON  [admin].[spCreateEntityDocumentRun] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateEntityDocumentRun] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateEntityDocumentType]'
GO
GRANT EXECUTE ON  [admin].[spCreateEntityDocumentType] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateEntityDocumentType] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateEntityDocument]'
GO
GRANT EXECUTE ON  [admin].[spCreateEntityDocument] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateEntityDocument] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateEntityRecordDocument]'
GO
GRANT EXECUTE ON  [admin].[spCreateEntityRecordDocument] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateEntityRecordDocument] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateQueryCategory]'
GO
GRANT EXECUTE ON  [admin].[spCreateQueryCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateQueryCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateQueryField]'
GO
GRANT EXECUTE ON  [admin].[spCreateQueryField] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateQueryField] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateQueryPermission]'
GO
GRANT EXECUTE ON  [admin].[spCreateQueryPermission] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateQueryPermission] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateQuery]'
GO
GRANT EXECUTE ON  [admin].[spCreateQuery] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateQuery] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateReportCategory]'
GO
GRANT EXECUTE ON  [admin].[spCreateReportCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateReportCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateUserViewCategory]'
GO
GRANT EXECUTE ON  [admin].[spCreateUserViewCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateUserViewCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateVectorDatabase]'
GO
GRANT EXECUTE ON  [admin].[spCreateVectorDatabase] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateVectorDatabase] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spCreateVectorIndex]'
GO
GRANT EXECUTE ON  [admin].[spCreateVectorIndex] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spCreateVectorIndex] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateDashboardCategory]'
GO
GRANT EXECUTE ON  [admin].[spUpdateDashboardCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateDashboardCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateDataContextItem]'
GO
GRANT EXECUTE ON  [admin].[spUpdateDataContextItem] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateDataContextItem] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateDataContext]'
GO
GRANT EXECUTE ON  [admin].[spUpdateDataContext] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateDataContext] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateEntityDocumentRun]'
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityDocumentRun] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityDocumentRun] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateEntityDocumentType]'
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityDocumentType] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityDocumentType] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateEntityDocument]'
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityDocument] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityDocument] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateEntityRecordDocument]'
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityRecordDocument] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateEntityRecordDocument] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateQueryCategory]'
GO
GRANT EXECUTE ON  [admin].[spUpdateQueryCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateQueryCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateQueryField]'
GO
GRANT EXECUTE ON  [admin].[spUpdateQueryField] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateQueryField] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateQueryPermission]'
GO
GRANT EXECUTE ON  [admin].[spUpdateQueryPermission] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateQueryPermission] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateQuery]'
GO
GRANT EXECUTE ON  [admin].[spUpdateQuery] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateQuery] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateReportCategory]'
GO
GRANT EXECUTE ON  [admin].[spUpdateReportCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateReportCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateUserViewCategory]'
GO
GRANT EXECUTE ON  [admin].[spUpdateUserViewCategory] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateUserViewCategory] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateVectorDatabase]'
GO
GRANT EXECUTE ON  [admin].[spUpdateVectorDatabase] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateVectorDatabase] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[spUpdateVectorIndex]'
GO
GRANT EXECUTE ON  [admin].[spUpdateVectorIndex] TO [cdp_Developer]
GO
GRANT EXECUTE ON  [admin].[spUpdateVectorIndex] TO [cdp_Integration]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwDashboardCategories]'
GO
GRANT SELECT ON  [admin].[vwDashboardCategories] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwDashboardCategories] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwDashboardCategories] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwDataContextItems]'
GO
GRANT SELECT ON  [admin].[vwDataContextItems] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwDataContextItems] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwDataContextItems] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwDataContexts]'
GO
GRANT SELECT ON  [admin].[vwDataContexts] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwDataContexts] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwDataContexts] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwEntityDocumentRuns]'
GO
GRANT SELECT ON  [admin].[vwEntityDocumentRuns] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwEntityDocumentRuns] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwEntityDocumentRuns] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwEntityDocumentTypes]'
GO
GRANT SELECT ON  [admin].[vwEntityDocumentTypes] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwEntityDocumentTypes] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwEntityDocumentTypes] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwEntityDocuments]'
GO
GRANT SELECT ON  [admin].[vwEntityDocuments] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwEntityDocuments] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwEntityDocuments] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwEntityRecordDocuments]'
GO
GRANT SELECT ON  [admin].[vwEntityRecordDocuments] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwEntityRecordDocuments] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwEntityRecordDocuments] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwQueries]'
GO
GRANT SELECT ON  [admin].[vwQueries] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwQueries] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwQueries] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwQueryCategories]'
GO
GRANT SELECT ON  [admin].[vwQueryCategories] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwQueryCategories] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwQueryCategories] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwQueryFields]'
GO
GRANT SELECT ON  [admin].[vwQueryFields] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwQueryFields] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwQueryFields] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwQueryPermissions]'
GO
GRANT SELECT ON  [admin].[vwQueryPermissions] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwQueryPermissions] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwQueryPermissions] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwReportCategories]'
GO
GRANT SELECT ON  [admin].[vwReportCategories] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwReportCategories] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwReportCategories] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwUserViewCategories]'
GO
GRANT SELECT ON  [admin].[vwUserViewCategories] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwUserViewCategories] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwUserViewCategories] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwVectorDatabases]'
GO
GRANT SELECT ON  [admin].[vwVectorDatabases] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwVectorDatabases] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwVectorDatabases] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering permissions on  [admin].[vwVectorIndexes]'
GO
GRANT SELECT ON  [admin].[vwVectorIndexes] TO [cdp_Developer]
GO
GRANT SELECT ON  [admin].[vwVectorIndexes] TO [cdp_Integration]
GO
GRANT SELECT ON  [admin].[vwVectorIndexes] TO [cdp_UI]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
