...
INSERT INTO CRM.Deal (ID, Name, AccountID, ContactID, Stage, Amount, Probability, CloseDate, ActualCloseDate, DealSource, Competitor, LossReason, NextStep, Description, OwnerID)
